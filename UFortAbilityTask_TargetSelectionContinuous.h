...
class UFortAbilityTask_TargetSelectionContinuous : public UAbilityTask
{
	...
	// Function /Script/FortniteGame.FortAbilityTask_TargetSelectionContinuous.DoTargetSelectionContinuous (Underlying native function: DoTargetSelectionContinuous 0x7e7007c)
