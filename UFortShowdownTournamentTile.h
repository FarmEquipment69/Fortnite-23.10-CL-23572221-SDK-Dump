...
class UFortShowdownTournamentTile : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortShowdownTournamentTile.GetTournamentListEntryData (Underlying native function: GetTournamentListEntryData 0xa7f0150)
	class UTournamentListEntryData* GetTournamentListEntryData(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortShowdownTournamentTile.GetTileTournament (Underlying native function: GetTileTournament 0xa7f00b8)
