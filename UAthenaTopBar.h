...
class UAthenaTopBar : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaTopBar.HandleFeatureNavigateRequest (Underlying native function: HandleFeatureNavigateRequest 0xa698c74)
	void HandleFeatureNavigateRequest(enum EFortUIFeature& Feature); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaTopBar.HandleButtonGroupSelectionChanged (Underlying native function: HandleButtonGroupSelectionChanged 0x1d76c98)
	void HandleButtonGroupSelectionChanged(class UCommonButtonLegacy*& SelectedButton, int& ButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaTopBar.HandleActiveSeasonDataChanged (Underlying native function: HandleActiveSeasonDataChanged 0xa698990)
