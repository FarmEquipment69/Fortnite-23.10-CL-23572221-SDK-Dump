...
class UFortQuestManager : public UObject
{
	...
	// Function /Script/FortniteGame.FortQuestManager.SendCustomStatEventWithTags (Underlying native function: SendCustomStatEventWithTags 0x8bfca88)
	...
	// Function /Script/FortniteGame.FortQuestManager.SendCustomStatEventDirect (Underlying native function: SendCustomStatEventDirect 0x8bfc9a4)
	...
	// Function /Script/FortniteGame.FortQuestManager.SendCustomStatEvent (Underlying native function: SendCustomStatEvent 0x8bfc8d4)
	...
	// Function /Script/FortniteGame.FortQuestManager.SendComplexCustomStatEvent (Underlying native function: SendComplexCustomStatEvent 0x8bfc714)
	...
	// Function /Script/FortniteGame.FortQuestManager.IsQuestObjectiveActive (Underlying native function: IsQuestObjectiveActive 0x8bfc5a8)
	bool IsQuestObjectiveActive(struct FName& ObjectiveName); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestManager.IsQuestInProgress (Underlying native function: IsQuestInProgress 0x8bfbffc)
	...
	// Function /Script/FortniteGame.FortQuestManager.IsObjectiveWithNameInProgress (Underlying native function: IsObjectiveWithNameInProgress 0x8bfbf00)
	...
	// Function /Script/FortniteGame.FortQuestManager.IsObjectiveInProgress (Underlying native function: IsObjectiveInProgress 0x8bfbe20)
	...
	// Function /Script/FortniteGame.FortQuestManager.InitializeQuestAbilities (Underlying native function: InitializeQuestAbilities 0x6df70d4)
	void InitializeQuestAbilities(class APawn*& PlayerPawn); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortQuestManager.HasCompletedQuest (Underlying native function: HasCompletedQuest 0x8bfbc64)
	...
	// Function /Script/FortniteGame.FortQuestManager.HasCompletedObjectiveWithName (Underlying native function: HasCompletedObjectiveWithName 0x8bfbb8c)
	...
	// Function /Script/FortniteGame.FortQuestManager.HasCompletedObjective (Underlying native function: HasCompletedObjective 0x8bfbaac)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetSourceAndContextTags (Underlying native function: GetSourceAndContextTags 0x8bfb13c)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetQuestWithDefinition (Underlying native function: GetQuestWithDefinition 0x8bfadfc)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetQuestManagerComponent (Underlying native function: GetQuestManagerComponent 0x8bfad3c)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetPlayerControllerBP (Underlying native function: GetPlayerControllerBP 0x8bfac58)
	class AFortPlayerController* GetPlayerControllerBP(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestManager.GetObjectiveCompletionCount (Underlying native function: GetObjectiveCompletionCount 0x8bfaa04)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetNumCompletedObjectives (Underlying native function: GetNumCompletedObjectives 0x8bfa940)
	int GetNumCompletedObjectives(class UFortQuestItemDefinition*& Definition); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortQuestManager.GetCurrentQuests (Underlying native function: GetCurrentQuests 0x8bfa794)
	...
	// Function /Script/FortniteGame.FortQuestManager.GetCompletedQuests (Underlying native function: GetCompletedQuests 0x8bfa5ac)
	...
	// Function /Script/FortniteGame.FortQuestManager.ForceTriggerQuestsUpdated (Underlying native function: ForceTriggerQuestsUpdated 0x8bfa3a4)
	void ForceTriggerQuestsUpdated(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortQuestManager.CanProgressQuestInCurrentZone (Underlying native function: CanProgressQuestInCurrentZone 0x8bfa2c8)
