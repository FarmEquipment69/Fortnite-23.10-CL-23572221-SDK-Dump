...
class UDiscoWidgetBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.DiscoWidgetBase.UpdateAllUI (Underlying native function: UpdateAllUI 0xa3fcd28)
	...
	// Function /Script/FortniteUI.DiscoWidgetBase.OnMutatorObjectUpdated (Underlying native function: OnMutatorObjectUpdated 0xa3fbbf8)
	void OnMutatorObjectUpdated(struct FGameplayMutatorObjectDataArray& MutatorArray); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.DiscoWidgetBase.OnHandleSpectatingChanged (Underlying native function: OnHandleSpectatingChanged 0xa3fb5b0)
	void OnHandleSpectatingChanged(class AFortPlayerStateZone*& SpectatingTarget); // (Final | Native | Protected)

	// Function /Script/FortniteUI.DiscoWidgetBase.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0xa3fb11c)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Protected)

	// Function /Script/FortniteUI.DiscoWidgetBase.OnCountdownTimerUpdate (Underlying native function: OnCountdownTimerUpdate 0xa3faf44)
