...
class UAthenaChallengeListEntry_NpcQuest : public UAthenaChallengeListEntryBase
{
	...
	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.UpdateIconUL (Underlying native function: UpdateIconUL 0xa348b3c)
	...
	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.IsSelected (Underlying native function: IsSelected 0xa3478ec)
	bool IsSelected(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.IsChallengeRefreshingDaily (Underlying native function: IsChallengeRefreshingDaily 0xa347818)
	bool IsChallengeRefreshingDaily(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.HandleQuestSeen (Underlying native function: HandleQuestSeen 0xa346f84)
	void HandleQuestSeen(class UFortAccountItem*& AccountItem); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.HandleObjectiveUpdate (Underlying native function: HandleObjectiveUpdate 0xa3468d0)
	...
	// Function /Script/FortniteUI.AthenaChallengeListEntry_NpcQuest.GetIsCompleted (Underlying native function: GetIsCompleted 0x869e960)
