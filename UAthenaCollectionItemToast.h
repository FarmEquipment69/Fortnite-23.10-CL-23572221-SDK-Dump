...
class UAthenaCollectionItemToast : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaCollectionItemToast.ResetToast (Underlying native function: ResetToast 0x6d235d0)
	void ResetToast(); // (Native | Protected)

	// Function /Script/FortniteUI.AthenaCollectionItemToast.HandleMobileClick (Underlying native function: HandleMobileClick 0xa37585c)
	void HandleMobileClick(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaCollectionItemToast.BPCallableIsDesignTime (Underlying native function: BPCallableIsDesignTime 0x24f75e4)
