...
class UFortHeroLoadoutSlotButton : public UCommonButtonLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortHeroLoadoutSlotButton.IsContextMenuOpen (Underlying native function: IsContextMenuOpen 0x721be48)
	bool IsContextMenuOpen(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortHeroLoadoutSlotButton.HandleMenuOpenChanged (Underlying native function: HandleMenuOpenChanged 0x721bc80)
