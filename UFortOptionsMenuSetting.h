...
class UFortOptionsMenuSetting : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortOptionsMenuSetting.UpdateSetting (Underlying native function: UpdateSetting 0xa664d00)
	void UpdateSetting(class UCommonTextBlock*& TooltipTextBlock); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortOptionsMenuSetting.HandleCaptureEnd (Underlying native function: HandleCaptureEnd 0xa662e40)
	void HandleCaptureEnd(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortOptionsMenuSetting.HandleAnalogCaptureEnd (Underlying native function: HandleAnalogCaptureEnd 0xa662dac)
	void HandleAnalogCaptureEnd(float& Value); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortOptionsMenuSetting.CenterOnWidget (Underlying native function: CenterOnWidget 0xa6623ec)
