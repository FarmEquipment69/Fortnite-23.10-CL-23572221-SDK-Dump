...
class ADeployableBasePlot : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.DeployableBasePlot.SetContextComponent (Underlying native function: SetContextComponent 0x83ad764)
	void SetContextComponent(class UPrimitiveComponent*& ContextComponent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.DeployableBasePlot.OnRep_OccupantNetID (Underlying native function: OnRep_OccupantNetID 0x83acc50)
	void OnRepOccupantNetID(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.DeployableBasePlot.OnRep_CurrentBuildingState (Underlying native function: OnRep_CurrentBuildingState 0x83ac90c)
	void OnRepCurrentBuildingState(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.DeployableBasePlot.OnRep_BuildableSpaceExpansionVector (Underlying native function: OnRep_BuildableSpaceExpansionVector 0x83ac8f8)
	void OnRepBuildableSpaceExpansionVector(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.DeployableBasePlot.OnCurrentBuildingStateSet (Underlying native function: OnCurrentBuildingStateSet 0x83ac1b8)
	...
	// Function /Script/FortniteGame.DeployableBasePlot.OnBuildingStateTransition (Underlying native function: OnBuildingStateTransition 0x83ac0f0)
	...
	// Function /Script/FortniteGame.DeployableBasePlot.IsOccupied (Underlying native function: IsOccupied 0x83abbc0)
	bool IsOccupied(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.DeployableBasePlot.IsOccupant (Underlying native function: IsOccupant 0x83abad0)
	bool IsOccupant(struct FUniqueNetIdRepl& UserId); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.DeployableBasePlot.IsBuildingActorWithinBuildableSpace (Underlying native function: IsBuildingActorWithinBuildableSpace 0x83ab928)
	...
	// Function /Script/FortniteGame.DeployableBasePlot.HandleBuildingStateTransition (Underlying native function: HandleBuildingStateTransition 0x83ab548)
	...
	// Function /Script/FortniteGame.DeployableBasePlot.GetPlayerStart (Underlying native function: GetPlayerStart 0x83ab1d0)
	class AFortPlayerStart* GetPlayerStart(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.DeployableBasePlot.GetOccupantNetID (Underlying native function: GetOccupantNetID 0x83ab1b4)
	struct FUniqueNetIdRepl GetOccupantNetID(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.DeployableBasePlot.GetNumOfItemsInPlot (Underlying native function: GetNumOfItemsInPlot 0x83ab138)
