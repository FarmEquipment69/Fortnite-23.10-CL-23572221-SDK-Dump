...
class UFortLlamaStoreBase : public UFortDirectAcquisitionWidgetBase
{
	...
	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase.SetupFocus (Underlying native function: SetupFocus 0x7261998)
	void SetupFocus(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase.OnStoreStateChanged (Underlying native function: OnStoreStateChanged 0x7260fd0)
	void OnStoreStateChanged(enum EFortStoreState& NewStoreState); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase.OnStorePurchaseCompleted (Underlying native function: OnStorePurchaseCompleted 0x7260f40)
