...
class AWrapPreviewGridActor : public AInfo
{
	...
	// Function /Script/FortniteGame.WrapPreviewGridActor.SetWrap (Underlying native function: SetWrap 0x85eb910)
	void SetWrap(class UAthenaItemWrapDefinition*& NewWrap); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.WrapPreviewGridActor.GetMeshComponentNames (Underlying native function: GetMeshComponentNames 0x85e66cc)
