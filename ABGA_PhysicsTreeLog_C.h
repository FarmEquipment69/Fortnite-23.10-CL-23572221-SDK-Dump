...
class ABGA_PhysicsTreeLog_C : public ABuildingProp
{
	...
	class UNiagaraComponent* NSPhysicsTreeInWaterRipples; // 0xf00 (0x8)
	class UFortSoundIndicatorComponent* FortSoundIndicator; // 0xf08 (0x8)
	class UCapsuleComponent* WaterInteractMiddle; // 0xf10 (0x8)
	class UCapsuleComponent* WaterInteractBottom; // 0xf18 (0x8)
	class UCapsuleComponent* WaterInteractTop; // 0xf20 (0x8)
	class UNiagaraComponent* NSPhysicsTreeEnvironmentImpact; // 0xf28 (0x8)
	struct TArray<struct FScalableFloat> PlayerImpactTiers; // 0xf30 (0x10)
	struct TArray<struct FScalableFloat> PlayerImpulseTiers; // 0xf40 (0x10)
	struct FVector LastImpactNormal; // 0xf50 (0x18)
	struct FScalableFloat VerticalImpulseRatio; // 0xf68 (0x28)
	class UBuoyancyComponent* BuoyancyComponent; // 0xf90 (0x8)
	double NextImminentCollisionTime; // 0xf98 (0x8)
	double TimeBetweenImminentCollisions; // 0xfa0 (0x8)
	class UMaterialInstanceDynamic* MatReference; // 0xfa8 (0x8)
	double BreakTreeDamage; // 0xfb0 (0x8)
	double NextPotentialLaunchTime; // 0xfb8 (0x8)
	double LaunchDelay; // 0xfc0 (0x8)
	struct FGameplayTag TreeDestructionBurstCue; // 0xfc8 (0x4)
	unsigned char unreflected_fcc[0x4]; // 0xfcc (0x4) 
	struct FTransform TreeDestructionTransform; // 0xfd0 (0x60)
	int CachedDamageValue; // 0x1030 (0x4)
	unsigned char unreflected_1034[0x4]; // 0x1034 (0x4) 
	double SnowTimerValue; // 0x1038 (0x8)
	struct FTimerHandle* SnowRemovalTimerHandle; // 0x1040 (0x8)
	class UFXSystemComponent* WaterFxPhysicsTreeMiddle; // 0x1048 (0x8)
	struct TArray<class UFXSystemComponent*> FxSystemArray; // 0x1050 (0x10)
	double WaterFxPlaneDepth; // 0x1060 (0x8)
	struct FVector WaterFxPlaneLocation; // 0x1068 (0x18)
	int WaterFxIndex; // 0x1080 (0x4)
	unsigned char unreflected_1084[0x4]; // 0x1084 (0x4) 
	class UFXSystemComponent* WaterFxPhysicsTreeTop; // 0x1088 (0x8)
	class UFXSystemComponent* WaterFxPhysicsTreeBottom; // 0x1090 (0x8)
	struct FTimerHandle* WaterSurfaceInfoTimer; // 0x1098 (0x8)
	struct FVector WaterFxPlaneNormal; // 0x10a0 (0x18)
	class ABP_FluidSim_FN_C* FluidSim; // 0x10b8 (0x8)
	struct TMap<struct FName, struct FName> SocketsAndEndpoints; // 0x10c0 (0x50)
	struct FFluidForceDynamic FluidForceDynamic; // 0x1110 (0x70)
	double LogLength; // 0x1180 (0x8)
	bool CanPlayDeathEffects; // 0x1188 (0x1)
	unsigned char unreflected_1189[0x7]; // 0x1189 (0x7) 
