...
class UEndOfMatchQuestCategoryWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.EndOfMatchQuestCategoryWidget.StartMoveEntriesDown (Underlying native function: StartMoveEntriesDown 0xa348894)
	void StartMoveEntriesDown(class UEndOfMatchQuestEntryWidget*& NextWidget); // (Final | Native | Private)

	// Function /Script/FortniteUI.EndOfMatchQuestCategoryWidget.StartFirstEntryIntro (Underlying native function: StartFirstEntryIntro 0xa348880)
	void StartFirstEntryIntro(); // (Final | Native | Private)

	// Function /Script/FortniteUI.EndOfMatchQuestCategoryWidget.ShowNextUpdate (Underlying native function: ShowNextUpdate 0xa3487cc)
	void ShowNextUpdate(); // (Final | Native | Private)

	// Function /Script/FortniteUI.EndOfMatchQuestCategoryWidget.MoveAllEntriesDown (Underlying native function: MoveAllEntriesDown 0xa347b98)
