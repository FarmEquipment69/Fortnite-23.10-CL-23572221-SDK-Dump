...
class UFortControllerComponent_EndMatchPersistence : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_EndMatchPersistence.GetFromPlayerController (Underlying native function: GetFromPlayerController 0x7fbc830)
	...
	// Function /Script/FortniteGame.FortControllerComponent_EndMatchPersistence.GetEndOfMatchLoot (Underlying native function: GetEndOfMatchLoot 0x7fbc814)
	struct TArray<struct FFortItemEntry> GetEndOfMatchLoot(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortControllerComponent_EndMatchPersistence.AddEndOfMatchLoot (Underlying native function: AddEndOfMatchLoot 0x7fbac60)
