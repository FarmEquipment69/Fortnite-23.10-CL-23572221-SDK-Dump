...
class AFortAthenaMutator_WarEffort : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.SetTryBeforeYouBuyItemState (Underlying native function: SetTryBeforeYouBuyItemState 0x6f196d8)
	void SetTryBeforeYouBuyItemState(struct FGameplayTag& ItemFundingTag, bool& bIsActive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.SetItemFundedState (Underlying native function: SetItemFundedState 0x6f19614)
	void SetItemFundedState(struct FGameplayTag& ItemFundingTag, bool& bIsActive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.SetItemFundedPercent (Underlying native function: SetItemFundedPercent 0x6f1954c)
	void SetItemFundedPercent(struct FGameplayTag& ItemFundingTag, float& FundingPercent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.SetItemFundedAmount (Underlying native function: SetItemFundedAmount 0x6f19454)
	...
	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.SetFundingManagerReady (Underlying native function: SetFundingManagerReady 0x6f193d4)
	void SetFundingManagerReady(bool& bIsReady); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CorruptionGameplayCodeRuntime.FortAthenaMutator_WarEffort.OnRep_PreloadedItemList (Underlying native function: OnRep_PreloadedItemList 0x6f193c0)
