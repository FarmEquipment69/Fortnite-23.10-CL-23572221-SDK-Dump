...
class UFortAthenaMatchmakingOptions : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.IsLiveSpectateButtonEnabled (Underlying native function: IsLiveSpectateButtonEnabled 0xa55c018)
	bool IsLiveSpectateButtonEnabled(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.HandleInputTypeChanged (Underlying native function: HandleInputTypeChanged 0xa55b43c)
	void HandleInputTypeChanged(enum ECommonInputType& CurrentInputType); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.HandleButtonGroupSelectionChanged (Underlying native function: HandleButtonGroupSelectionChanged 0xa55b328)
	void HandleButtonGroupSelectionChanged(class UCommonButtonLegacy*& Button, int& Index); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.GetCurrentlyRepresentedData (Underlying native function: GetCurrentlyRepresentedData 0xa55a400)
	struct FPlaylistFrontEndData GetCurrentlyRepresentedData(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.CloseMatchmakingOptions (Underlying native function: CloseMatchmakingOptions 0x662c1a4)
	void CloseMatchmakingOptions(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.CanceledPlaylist (Underlying native function: CanceledPlaylist 0xa559a6c)
	void CanceledPlaylist(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaMatchmakingOptions.AcceptedPlaylist (Underlying native function: AcceptedPlaylist 0xa559650)
