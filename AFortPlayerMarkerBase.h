...
class AFortPlayerMarkerBase : public AActor
{
	...
	// Function /Script/FortniteGame.FortPlayerMarkerBase.StartSpawnMarkerAnim (Underlying native function: StartSpawnMarkerAnim 0x8141ee8)
	void StartSpawnMarkerAnim(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerMarkerBase.SpawnMarkerAnimTimelineProgress_SpawnVerticalScale (Underlying native function: SpawnMarkerAnimTimelineProgress_SpawnVerticalScale 0x8141de4)
	void SpawnMarkerAnimTimelineProgressSpawnVerticalScale(float& Value); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPlayerMarkerBase.SpawnMarkerAnimTimelineProgress_SpawnScale (Underlying native function: SpawnMarkerAnimTimelineProgress_SpawnScale 0x8141d60)
	void SpawnMarkerAnimTimelineProgressSpawnScale(float& Value); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPlayerMarkerBase.SpawnMarkerAnimTimelineProgress_Opacity (Underlying native function: SpawnMarkerAnimTimelineProgress_Opacity 0x8141cdc)
