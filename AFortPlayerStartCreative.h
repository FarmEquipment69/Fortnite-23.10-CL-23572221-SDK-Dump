...
class AFortPlayerStartCreative : public APlayerStart
{
	...
	// Function /Script/FortniteGame.FortPlayerStartCreative.OnMinigameStarted (Underlying native function: OnMinigameStarted 0x8744e24)
	void OnMinigameStarted(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPlayerStartCreative.IsClaimedByPlayer (Underlying native function: IsClaimedByPlayer 0x8744658)
