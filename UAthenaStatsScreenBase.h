...
class UAthenaStatsScreenBase : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.AthenaStatsScreenBase.SetDisplayName (Underlying native function: SetDisplayName 0xa3113a8)
	void SetDisplayName(struct FText& InDisplayName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaStatsScreenBase.SetAccountIdToQueryFromString (Underlying native function: SetAccountIdToQueryFromString 0xa3111d4)
	void SetAccountIdToQueryFromString(struct FString& InAccountId); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaStatsScreenBase.OnTabSelected (Underlying native function: OnTabSelected 0xa310e78)
	...
	// Function /Script/FortniteUI.AthenaStatsScreenBase.DisplayQueriedUserPlatformProfile (Underlying native function: DisplayQueriedUserPlatformProfile 0xa30fd64)
