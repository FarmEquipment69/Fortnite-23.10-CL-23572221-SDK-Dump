...
class ABattleLabDeviceGameplayActor_VendingMachine : public ABattleLabDeviceGameplayActor
{
	...
	// Function /Script/FortniteGame.BattleLabDeviceGameplayActor_VendingMachine.ServerOnAttemptInteract (Underlying native function: ServerOnAttemptInteract 0x831e3a4)
	bool ServerOnAttemptInteract(struct FInteractionType& InteractType); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.BattleLabDeviceGameplayActor_VendingMachine.PreviewImageLoadedFromItemDef (Underlying native function: PreviewImageLoadedFromItemDef 0x831e1a8)
	...
	// Function /Script/FortniteGame.BattleLabDeviceGameplayActor_VendingMachine.OnRep_DroppedIntoFunnelPickup (Underlying native function: OnRep_DroppedIntoFunnelPickup 0x8319a44)
	void OnRepDroppedIntoFunnelPickup(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BattleLabDeviceGameplayActor_VendingMachine.OnFunnelCollisionBeginOverlap (Underlying native function: OnFunnelCollisionBeginOverlap 0x831830c)
	...
	// Function /Script/FortniteGame.BattleLabDeviceGameplayActor_VendingMachine.AddStoredItemDefinitionMulti (Underlying native function: AddStoredItemDefinitionMulti 0x8317388)
