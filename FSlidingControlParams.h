...
struct FSlidingControlParams
{
	...
	struct FScalableFloat UphillGroundFriction; // 0x168 (0x28)
	struct FScalableFloat LevelGroundFriction; // 0x190 (0x28)
	struct FScalableFloat DownhillGroundFriction; // 0x1b8 (0x28)
