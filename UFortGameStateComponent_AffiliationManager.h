...
class UFortGameStateComponent_AffiliationManager : public UFortGameStateComponent
{
	...
	// Function /Script/FortniteGame.FortGameStateComponent_AffiliationManager.OnRep_FactionInfos (Underlying native function: OnRep_FactionInfos 0x305958c)
	void OnRepFactionInfos(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameStateComponent_AffiliationManager.OnPlaylistDataReady (Underlying native function: OnPlaylistDataReady 0x7fbdc88)
