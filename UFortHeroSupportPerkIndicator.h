...
class UFortHeroSupportPerkIndicator : public UFortIconWithLabel
{
	...
	// Function /Script/FortniteUI.FortHeroSupportPerkIndicator.SetSupportTypeToRepresent (Underlying native function: SetSupportTypeToRepresent 0xa70b5b8)
	void SetSupportTypeToRepresent(enum EFortSupportBonusType& SupportTypeToRepresent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHeroSupportPerkIndicator.SetItemToRepresent (Underlying native function: SetItemToRepresent 0xa70a6a8)
