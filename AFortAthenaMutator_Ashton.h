...
class AFortAthenaMutator_Ashton : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.SelectNextVillainLeader (Underlying native function: SelectNextVillainLeader 0x81d98b0)
	void SelectNextVillainLeader(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnRep_VillainLeaderLocationForSound (Underlying native function: OnRep_VillainLeaderLocationForSound 0x81d953c)
	void OnRepVillainLeaderLocationForSound(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnRep_VillainLeaderLocationForSnapSound (Underlying native function: OnRep_VillainLeaderLocationForSnapSound 0x81d9528)
	void OnRepVillainLeaderLocationForSnapSound(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnRep_VillainLeaderLocationForDeathSound (Underlying native function: OnRep_VillainLeaderLocationForDeathSound 0x81d94c4)
	void OnRepVillainLeaderLocationForDeathSound(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnRep_StoneList (Underlying native function: OnRep_StoneList 0x81d9408)
	void OnRepStoneList(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnRep_NumVillainRespawnsRemaining (Underlying native function: OnRep_NumVillainRespawnsRemaining 0x81d939c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnPickupSpawnedAndReady (Underlying native function: OnPickupSpawnedAndReady 0x6d23ca0)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnPickupDestroying (Underlying native function: OnPickupDestroying 0x81d9124)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81d8b0c)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x81d886c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.GetStoneState (Underlying native function: GetStoneState 0x81d7574)
	enum EAshtonStoneStateType GetStoneState(enum EAshtonStoneType& StoneType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_Ashton.GetNumCapturedStones (Underlying native function: GetNumCapturedStones 0x81d716c)
