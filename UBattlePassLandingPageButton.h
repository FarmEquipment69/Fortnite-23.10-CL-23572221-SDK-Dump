...
class UBattlePassLandingPageButton : public UCommonButtonBase
{
	...
	// Function /Script/BattlePassBase.BattlePassLandingPageButton.GetBattlePassDisplayDetails (Underlying native function: GetBattlePassDisplayDetails 0x18ee064)
