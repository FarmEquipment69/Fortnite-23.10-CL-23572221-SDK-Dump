...
class AFortAthenaMutator_TODOverride : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_TODOverride.GetTimeOfDaySpeedNames (Underlying native function: GetTimeOfDaySpeedNames 0x8262854)
	struct TArray<struct FText> GetTimeOfDaySpeedNames(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_TODOverride.GetTimeOfDayPhaseNames (Underlying native function: GetTimeOfDayPhaseNames 0x8262818)
	struct TArray<struct FText> GetTimeOfDayPhaseNames(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_TODOverride.GetFogStartDistance (Underlying native function: GetFogStartDistance 0x8262594)
