...
class UAthenaDanceItemDefinition : public UFortMontageItemDefinitionBase
{
	...
	// Function /Script/FortniteGame.AthenaDanceItemDefinition.GetCustomDanceAbility (Underlying native function: GetCustomDanceAbility 0x84d5320)
	struct TWeakObjectPtr<class UClass> GetCustomDanceAbility(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaDanceItemDefinition.GetChatTriggerCommandName (Underlying native function: GetChatTriggerCommandName 0x84d52ac)
