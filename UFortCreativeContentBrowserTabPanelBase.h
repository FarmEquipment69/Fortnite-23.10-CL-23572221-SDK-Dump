...
class UFortCreativeContentBrowserTabPanelBase : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativeContentBrowserTabPanelBase.GetSelectedItemIndex (Underlying native function: GetSelectedItemIndex 0xa55ac88)
	int GetSelectedItemIndex(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeContentBrowserTabPanelBase.GetItemType (Underlying native function: GetItemType 0x8cbc074)
