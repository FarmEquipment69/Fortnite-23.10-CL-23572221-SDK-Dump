...
class UFortPageNavigator : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortPageNavigator.SelectPage (Underlying native function: SelectPage 0xa761000)
	...
	// Function /Script/FortniteUI.FortPageNavigator.RequestPreviousPage (Underlying native function: RequestPreviousPage 0xa760fe8)
	void RequestPreviousPage(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortPageNavigator.RequestNextPage (Underlying native function: RequestNextPage 0xa760fd0)
	...
	// Function /Script/FortniteUI.FortPageNavigator.HandleUserScrolled (Underlying native function: HandleUserScrolled 0xa760bec)
	void HandleUserScrolled(float& ScrollAmount); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortPageNavigator.HandleScrollCompleted (Underlying native function: HandleScrollCompleted 0xa760ad4)
	void HandleScrollCompleted(float& ScrollAmount); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortPageNavigator.ClearPages (Underlying native function: ClearPages 0xa760570)
