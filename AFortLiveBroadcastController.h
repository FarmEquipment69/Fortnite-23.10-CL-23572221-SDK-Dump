...
class AFortLiveBroadcastController : public AFortLiveSpectatorController
{
	...
	// Function /Script/FortniteGame.FortLiveBroadcastController.TryBeginBusPhase (Underlying native function: TryBeginBusPhase 0x8b73fd8)
	void TryBeginBusPhase(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortLiveBroadcastController.ServerOnSpectatorCameraTypeChanged (Underlying native function: ServerOnSpectatorCameraTypeChanged 0x8b6f7e4)
	...
	// Function /Script/FortniteGame.FortLiveBroadcastController.ServerBeginBusPhase (Underlying native function: ServerBeginBusPhase 0x8b6dbbc)
	...
	// Function /Script/FortniteGame.FortLiveBroadcastController.ClientHideBusButton (Underlying native function: ClientHideBusButton 0x8b682ec)
	void ClientHideBusButton(); // (Net | NetReliable | Native | Event | Public | NetClient)

	// Function /Script/FortniteGame.FortLiveBroadcastController.CanStartBattleBus (Underlying native function: CanStartBattleBus 0x8b664cc)
