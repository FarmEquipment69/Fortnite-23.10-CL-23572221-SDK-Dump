...
class UAthenaTeamMemberDBNOState : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaTeamMemberDBNOState.SetPlayerState (Underlying native function: SetPlayerState 0x1a0ea0c)
	void SetPlayerState(class AFortPlayerStateAthena*& InPlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaTeamMemberDBNOState.RefreshVisuals (Underlying native function: RefreshVisuals 0xa376ff4)
