...
class UAnimDataModel : public UObject
{
	...
	// Function /Script/Engine.AnimDataModel.IsValidBoneTrackIndex (Underlying native function: IsValidBoneTrackIndex 0x9a9b498)
	bool IsValidBoneTrackIndex(int& TrackIndex); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetPlayLength (Underlying native function: GetPlayLength 0x7d312b8)
	float GetPlayLength(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetNumBoneTracks (Underlying native function: GetNumBoneTracks 0x9a9a900)
	int GetNumBoneTracks(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetNumberOfTransformCurves (Underlying native function: GetNumberOfTransformCurves 0x774d604)
	int GetNumberOfTransformCurves(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetNumberOfKeys (Underlying native function: GetNumberOfKeys 0x99e7b58)
	int GetNumberOfKeys(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetNumberOfFrames (Underlying native function: GetNumberOfFrames 0x9a9a914)
	int GetNumberOfFrames(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetNumberOfFloatCurves (Underlying native function: GetNumberOfFloatCurves 0x99e7b98)
	int GetNumberOfFloatCurves(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetFrameRate (Underlying native function: GetFrameRate 0x9a99728)
	struct FFrameRate* GetFrameRate(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetBoneTrackNames (Underlying native function: GetBoneTrackNames 0x9a993ec)
	...
	// Function /Script/Engine.AnimDataModel.GetBoneTrackIndexByName (Underlying native function: GetBoneTrackIndexByName 0x9a9933c)
	int GetBoneTrackIndexByName(struct FName& TrackName); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetBoneTrackIndex (Underlying native function: GetBoneTrackIndex 0x9a99214)
	...
	// Function /Script/Engine.AnimDataModel.GetBoneTrackByName (Underlying native function: GetBoneTrackByName 0x9a99160)
	...
	// Function /Script/Engine.AnimDataModel.GetBoneTrackByIndex (Underlying native function: GetBoneTrackByIndex 0x9a990bc)
	struct FBoneAnimationTrack GetBoneTrackByIndex(int& TrackIndex); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimDataModel.GetBoneAnimationTracks (Underlying native function: GetBoneAnimationTracks 0x9a99048)
	...
	// Function /Script/Engine.AnimDataModel.GetAnimationSequence (Underlying native function: GetAnimationSequence 0x9a99000)
