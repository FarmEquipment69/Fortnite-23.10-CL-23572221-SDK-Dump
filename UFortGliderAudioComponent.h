...
class UFortGliderAudioComponent : public UFortLayeredAudioComponent
{
	...
	// Function /Script/FortniteGame.FortGliderAudioComponent.UpdateGliderAudio (Underlying native function: UpdateGliderAudio 0x8c43870)
	void UpdateGliderAudio(float& ForwardDot, float& RightDot); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGliderAudioComponent.IsParachuteFullyDeployed (Underlying native function: IsParachuteFullyDeployed 0x8c41e10)
