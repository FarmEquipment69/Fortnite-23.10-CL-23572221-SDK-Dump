...
class UFortCollectionBookSectionPanel : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnUnslotItemOperationComplete (Underlying native function: OnUnslotItemOperationComplete 0x71e968c)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnUnslotItemActionExecuted (Underlying native function: OnUnslotItemActionExecuted 0x71e950c)
	void OnUnslotItemActionExecuted(bool& bPassThrough); // (Final | Native | Protected | HasOutParms)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSlottedItemOperationComplete (Underlying native function: OnSlottedItemOperationComplete 0x71e93a4)
	void OnSlottedItemOperationComplete(class UFortAccountItem*& SlottedItem, struct FName& SlotId); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSlotItemActionExecuted (Underlying native function: OnSlotItemActionExecuted 0x71e90e4)
	void OnSlotItemActionExecuted(bool& bPassThrough); // (Final | Native | Protected | HasOutParms)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSlotButtonSelected (Underlying native function: OnSlotButtonSelected 0x71e9064)
	void OnSlotButtonSelected(class UFortCollectionBookSlotButton*& SlotButton); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSlotButtonHovered (Underlying native function: OnSlotButtonHovered 0x71e8f1c)
	void OnSlotButtonHovered(int& ButtonIx); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSlotButtonContextAction (Underlying native function: OnSlotButtonContextAction 0x71e8e9c)
	void OnSlotButtonContextAction(enum EFortCollectionBookPopupButtonType& ContextAction); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnSectionChanged (Underlying native function: OnSectionChanged 0x71e8144)
	void OnSectionChanged(class UFortCollectionBookSection*& Section); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnResearchItemOperationComplete (Underlying native function: OnResearchItemOperationComplete 0x71e88e4)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnPurchaseItemActionExecuted (Underlying native function: OnPurchaseItemActionExecuted 0x71e885c)
	void OnPurchaseItemActionExecuted(bool& bPassThrough); // (Final | Native | Protected | HasOutParms)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnOpenPickerActionExecuted (Underlying native function: OnOpenPickerActionExecuted 0x71e8660)
	void OnOpenPickerActionExecuted(bool& bPassThrough); // (Final | Native | Protected | HasOutParms)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnLogAllowedItemsActionExecuted (Underlying native function: OnLogAllowedItemsActionExecuted 0x71e85ec)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnInspectActionExecuted (Underlying native function: OnInspectActionExecuted 0x71e8278)
	void OnInspectActionExecuted(bool& bPassThrough); // (Final | Native | Protected | HasOutParms)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSectionPanel.OnBackActionExecuted (Underlying native function: OnBackActionExecuted 0x71e7d14)
