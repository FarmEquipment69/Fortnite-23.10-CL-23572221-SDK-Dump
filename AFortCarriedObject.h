...
class AFortCarriedObject : public AActor
{
	...
	// Function /Script/FortniteGame.FortCarriedObject.ReturnToSpawnPoint (Underlying native function: ReturnToSpawnPoint 0x840f410)
	void ReturnToSpawnPoint(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCarriedObject.OnRep_HolderInfo (Underlying native function: OnRep_HolderInfo 0x840f2b4)
	void OnRepHolderInfo(struct FCarriedObjectAttachmentInfo& PreviousInfo); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortCarriedObject.GetHoldingActor (Underlying native function: GetHoldingActor 0x840e8e4)
