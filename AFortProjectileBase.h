...
class AFortProjectileBase : public AFortGameplayEffectDeliveryActor
{
	...
	// Function /Script/FortniteGame.FortProjectileBase.SetGravityScale (Underlying native function: SetGravityScale 0x2391b48)
	void SetGravityScale(float& InitialGravityScale); // (Final | 0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileBase.ResumeSimulation (Underlying native function: ResumeSimulation 0x8e6c2b8)
	...
	// Function /Script/FortniteGame.FortProjectileBase.OnStopCallback (Underlying native function: OnStopCallback 0x14f5ba4)
	...
	// Function /Script/FortniteGame.FortProjectileBase.OnRep_SimulationStoppingHit (Underlying native function: OnRep_SimulationStoppingHit 0x24e5374)
	void OnRepSimulationStoppingHit(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortProjectileBase.OnRep_ResumeSimulationCount (Underlying native function: OnRep_ResumeSimulationCount 0x8e6c2b8)
	void OnRepResumeSimulationCount(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortProjectileBase.OnRep_ReplicatedMaxSpeed (Underlying native function: OnRep_ReplicatedMaxSpeed 0x24d6294)
	void OnRepReplicatedMaxSpeed(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortProjectileBase.OnRep_GravityScale (Underlying native function: OnRep_GravityScale 0x2638a0c)
	void OnRepGravityScale(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortProjectileBase.OnRep_CurrentSkyTube (Underlying native function: OnRep_CurrentSkyTube 0x8e6c288)
	...
	// Function /Script/FortniteGame.FortProjectileBase.OnBounceCallback (Underlying native function: OnBounceCallback 0x229addc)
	...
	// Function /Script/FortniteGame.FortProjectileBase.GetSkyTube (Underlying native function: GetSkyTube 0x8e6be8c)
	class AFortSkyTube* GetSkyTube(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortProjectileBase.GetOwnerWeapon (Underlying native function: GetOwnerWeapon 0x8e6bdc0)
	class AFortWeapon* GetOwnerWeapon(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileBase.GetOwnerVelocity (Underlying native function: GetOwnerVelocity 0x8e6bd84)
	struct FVector GetOwnerVelocity(); // (0x00000002 | Native | Event | Public | HasDefaults | BlueprintEvent | Const)

	// Function /Script/FortniteGame.FortProjectileBase.GetOwnerPlayerController (Underlying native function: GetOwnerPlayerController 0x8e6bce8)
	class AFortPlayerController* GetOwnerPlayerController(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileBase.GetMaxLifespan (Underlying native function: GetMaxLifespan 0x8e6bcbc)
	float GetMaxLifespan(); // (0x00000002 | Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortProjectileBase.GetGravityScale (Underlying native function: GetGravityScale 0x8e6bca4)
	float GetGravityScale(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortProjectileBase.GetDummyProjectile_DEPRECATED (Underlying native function: GetDummyProjectile_DEPRECATED 0x8e6bbcc)
	bool GetDummyProjectileDEPRECATED(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortProjectileBase.GetDefaultSpeed (Underlying native function: GetDefaultSpeed 0x8e6bb38)
	float GetDefaultSpeed(float& InChargePercent); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortProjectileBase.GetDefaultGravityScale (Underlying native function: GetDefaultGravityScale 0x8e6bb10)
	float GetDefaultGravityScale(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortProjectileBase.ExitSkyTube (Underlying native function: ExitSkyTube 0x8e6ba18)
	...
	// Function /Script/FortniteGame.FortProjectileBase.EnterSkyTube (Underlying native function: EnterSkyTube 0x8e6b948)
	...
	// Function /Script/FortniteGame.FortProjectileBase.AddTagToDefaultTags (Underlying native function: AddTagToDefaultTags 0x8e6b8bc)
