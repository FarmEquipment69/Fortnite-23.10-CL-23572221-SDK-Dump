...
class AFortGameplayCueNotifyLoop_PhysicsObjectRolling : public AFortGameplayCueNotify_Loop
{
	...
	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_PhysicsObjectRolling.HandlePontoonExitedWaterBody (Underlying native function: HandlePontoonExitedWaterBody 0x7e70e90)
	void HandlePontoonExitedWaterBody(struct FSphericalPontoon& Pontoon); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_PhysicsObjectRolling.HandlePontoonEnteredWaterBody (Underlying native function: HandlePontoonEnteredWaterBody 0x7e70dcc)
	void HandlePontoonEnteredWaterBody(struct FSphericalPontoon& Pontoon); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_PhysicsObjectRolling.GetHitLocation (Underlying native function: GetHitLocation 0x7e70660)
