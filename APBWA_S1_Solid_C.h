...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x1038 (0x8)
	int GnomeWallChance; // 0x1040 (0x4)
	int GnomeWallMax; // 0x1044 (0x4)
	bool Gnomed; // 0x1048 (0x1)
	unsigned char unreflected_1049[0x7]; // 0x1049 (0x7) 
	class UMaterialInstanceConstant* GnomeMaterial; // 0x1050 (0x8)
	class UStaticMesh* GnomeWall; // 0x1058 (0x8)
