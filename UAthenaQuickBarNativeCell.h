...
class UAthenaQuickBarNativeCell : public UContentWidget
{
	...
	// Function /Script/FortniteUI.AthenaQuickBarNativeCell.UpdateItemPortrait (Underlying native function: UpdateItemPortrait 0xa78179c)
	void UpdateItemPortrait(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaQuickBarNativeCell.SetItemToRepresent (Underlying native function: SetItemToRepresent 0xa781040)
	void SetItemToRepresent(class UFortItem*& InItemToRepresent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaQuickBarNativeCell.SetIsSelected (Underlying native function: SetIsSelected 0xa780e3c)
	void SetIsSelected(bool& bInSelected); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaQuickBarNativeCell.DesiredSizeOverride (Underlying native function: DesiredSizeOverride 0xa77e1d8)
