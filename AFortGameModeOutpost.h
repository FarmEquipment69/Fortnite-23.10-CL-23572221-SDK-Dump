...
class AFortGameModeOutpost : public AFortGameModePvE
{
	...
	// Function /Script/FortniteGame.FortGameModeOutpost.DoesOutpostStatusAllowMissionStart (Underlying native function: DoesOutpostStatusAllowMissionStart 0x8c92744)
