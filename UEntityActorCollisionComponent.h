...
class UEntityActorCollisionComponent : public UEntityEnableableComponent
{
	...
	// Function /Script/EntityActor.EntityActorCollisionComponent.OnRep_PrimitiveComponent (Underlying native function: OnRep_PrimitiveComponent 0x663dcec)
	void OnRepPrimitiveComponent(); // (Final | Native | Private)

	// Function /Script/EntityActor.EntityActorCollisionComponent.OnRep_CollisionProfileName (Underlying native function: OnRep_CollisionProfileName 0x663dcec)
	void OnRepCollisionProfileName(); // (Final | Native | Private)

	// Function /Script/EntityActor.EntityActorCollisionComponent.OnNativeComponentHit (Underlying native function: OnNativeComponentHit 0x663db24)
	...
	// Function /Script/EntityActor.EntityActorCollisionComponent.OnNativeComponentEndOverlap (Underlying native function: OnNativeComponentEndOverlap 0x663d9e8)
	...
	// Function /Script/EntityActor.EntityActorCollisionComponent.OnNativeComponentBeginOverlap (Underlying native function: OnNativeComponentBeginOverlap 0x663d7e8)
	...
	// Function /Script/EntityActor.EntityActorCollisionComponent.OnEnabledChanged (Underlying native function: OnEnabledChanged 0x663d6e8)
