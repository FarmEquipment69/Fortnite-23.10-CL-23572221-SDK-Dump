...
class AFortPlayerParachute : public AActor
{
	...
	// Function /Script/FortniteGame.FortPlayerParachute.SetPlayerPawn (Underlying native function: SetPlayerPawn 0x8141ad0)
	void SetPlayerPawn(class AFortPlayerPawn*& InPlayerPawn); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerParachute.SetChuteMeshVisibility (Underlying native function: SetChuteMeshVisibility 0x81416b8)
	void SetChuteMeshVisibility(bool& bNewParachuteVisible); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerParachute.OnRep_PlayerPawn (Underlying native function: OnRep_PlayerPawn 0x8140d74)
	void OnRepPlayerPawn(class AFortPlayerPawn*& PreviousPlayerPawn); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerParachute.OnRep_ParachuteItemDef (Underlying native function: OnRep_ParachuteItemDef 0x8140d60)
	...
	// Function /Script/FortniteGame.FortPlayerParachute.OnParachuteTrailUpdated (Underlying native function: OnParachuteTrailUpdated 0x8140b64)
	...
	// Function /Script/FortniteGame.FortPlayerParachute.IsGliderFullyDeployedAccordingToAnim (Underlying native function: IsGliderFullyDeployedAccordingToAnim 0x81409b8)
	bool IsGliderFullyDeployedAccordingToAnim(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerParachute.InitalizeFromItemDef (Underlying native function: InitalizeFromItemDef 0x8140864)
	...
	// Function /Script/FortniteGame.FortPlayerParachute.GetTrailVFXComponent (Underlying native function: GetTrailVFXComponent 0x81407ec)
	class UFXSystemComponent* GetTrailVFXComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerParachute.GetTrailVFX2Component (Underlying native function: GetTrailVFX2Component 0x81407d4)
	class UFXSystemComponent* GetTrailVFX2Component(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerParachute.GetParachuteRootMesh (Underlying native function: GetParachuteRootMesh 0x71e6988)
	class USkeletalMeshComponent* GetParachuteRootMesh(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerParachute.GetFortPlayerPawn (Underlying native function: GetFortPlayerPawn 0x814077c)
	class AFortPlayerPawn* GetFortPlayerPawn(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerParachute.GetBitsMeshComponents (Underlying native function: GetBitsMeshComponents 0x81406d4)
	...
	// Function /Script/FortniteGame.FortPlayerParachute.DisableTrailParticles (Underlying native function: DisableTrailParticles 0x81405bc)
	void DisableTrailParticles(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerParachute.ApplyVariants (Underlying native function: ApplyVariants 0x814013c)
