...
class UFortPhysicsOverlapComponent : public USceneComponent
{
	...
	// Function /Script/FortniteGame.FortPhysicsOverlapComponent.SetNeverSleepWhenOverlapping (Underlying native function: SetNeverSleepWhenOverlapping 0x8b0ed48)
	void SetNeverSleepWhenOverlapping(bool& bShouldSleep); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsOverlapComponent.OnPhysicsObjectEndOverlap (Underlying native function: OnPhysicsObjectEndOverlap 0x8b0e1d0)
	...
	// Function /Script/FortniteGame.FortPhysicsOverlapComponent.OnPhysicsObjectBeginOverlap (Underlying native function: OnPhysicsObjectBeginOverlap 0x8b0dfd0)
