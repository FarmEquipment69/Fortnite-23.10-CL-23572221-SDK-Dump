...
class UFortEventLeaderboardScreen : public UFortCompetitiveLeaderboardScreen
{
	...
	// Function /Script/FortniteUI.FortEventLeaderboardScreen.HandleViewTabSelectionChanged (Underlying native function: HandleViewTabSelectionChanged 0xa55bc0c)
