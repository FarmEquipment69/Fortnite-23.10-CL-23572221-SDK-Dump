...
class UARComponent : public USceneComponent
{
	...
	// Function /Script/AugmentedReality.ARComponent.UpdateVisualization (Underlying native function: UpdateVisualization 0x8b16734)
	void UpdateVisualization(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/AugmentedReality.ARComponent.SetNativeID (Underlying native function: SetNativeID 0x95e3a88)
	...
	// Function /Script/AugmentedReality.ARComponent.OnRep_Payload (Underlying native function: OnRep_Payload 0x8b167c0)
	void OnRepPayload(); // (Native | Protected)

	// Function /Script/AugmentedReality.ARComponent.GetMRMesh (Underlying native function: GetMRMesh 0x88c35bc)
