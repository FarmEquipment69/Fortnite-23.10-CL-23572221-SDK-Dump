...
class UAthenaPlayerHitPointBarBase : public UUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaPlayerHitPointBarBase.GetLastValuePercentage (Underlying native function: GetLastValuePercentage 0xa30ff50)
	float GetLastValuePercentage(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaPlayerHitPointBarBase.GetCurrentValuePercentage (Underlying native function: GetCurrentValuePercentage 0xa30fef4)
