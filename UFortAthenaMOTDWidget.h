...
class UFortAthenaMOTDWidget : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortAthenaMOTDWidget.SelectNewsByIndex (Underlying native function: SelectNewsByIndex 0xa73377c)
	...
	// Function /Script/FortniteUI.FortAthenaMOTDWidget.PlayFirstAutoPlayVideo (Underlying native function: PlayFirstAutoPlayVideo 0xa7334b0)
	...
	// Function /Script/FortniteUI.FortAthenaMOTDWidget.NavigateToRightNews (Underlying native function: NavigateToRightNews 0xa732ec4)
	void NavigateToRightNews(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.NavigateToLeftNews (Underlying native function: NavigateToLeftNews 0xa732eb0)
	void NavigateToLeftNews(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.HandleSelectedButtonChanged (Underlying native function: HandleSelectedButtonChanged 0x26775d4)
	void HandleSelectedButtonChanged(class UCommonButtonLegacy*& SelectedButton, int& ButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.HandleImageLoaded (Underlying native function: HandleImageLoaded 0x2e42020)
	void HandleImageLoaded(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.GetNewsCount (Underlying native function: GetNewsCount 0xa731e08)
	int GetNewsCount(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.GetNewsByIndex (Underlying native function: GetNewsByIndex 0xa731d1c)
	struct FAthenaMOTDBase GetNewsByIndex(int& Index); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.BP_GetSelectedNews (Underlying native function: BP_GetSelectedNews 0xa730938)
	struct FAthenaMOTDBase BPGetSelectedNews(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMOTDWidget.AutoPlayedVideo (Underlying native function: AutoPlayedVideo 0x87f4d2c)
