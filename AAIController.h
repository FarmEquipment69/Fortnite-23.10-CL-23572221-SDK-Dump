...
class AAIController : public AController
{
	...
	// Function /Script/AIModule.AIController.UseBlackboard (Underlying native function: UseBlackboard 0x9fb18b8)
	...
	// Function /Script/AIModule.AIController.UnclaimTaskResource (Underlying native function: UnclaimTaskResource 0x9fb1838)
	void UnclaimTaskResource(class UClass*& ResourceClass); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIController.SetPathFollowingComponent (Underlying native function: SetPathFollowingComponent 0x847869c)
	void SetPathFollowingComponent(class UPathFollowingComponent*& NewPFComponent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIController.SetMoveBlockDetection (Underlying native function: SetMoveBlockDetection 0x9fb17b4)
	void SetMoveBlockDetection(bool& bEnable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIController.RunBehaviorTree (Underlying native function: RunBehaviorTree 0x9fb1720)
	...
	// Function /Script/AIModule.AIController.OnGameplayTaskResourcesClaimed (Underlying native function: OnGameplayTaskResourcesClaimed 0x9fb1594)
	...
	// Function /Script/AIModule.AIController.MoveToLocation (Underlying native function: MoveToLocation 0x9fb1308)
	...
	// Function /Script/AIModule.AIController.MoveToActor (Underlying native function: MoveToActor 0x9fb10d4)
	...
	// Function /Script/AIModule.AIController.K2_SetFocus (Underlying native function: K2_SetFocus 0x9fb104c)
	void K2SetFocus(class AActor*& NewFocus); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIController.K2_SetFocalPoint (Underlying native function: K2_SetFocalPoint 0x9fb0fb4)
	void K2SetFocalPoint(struct FVector& FP); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AIModule.AIController.K2_ClearFocus (Underlying native function: K2_ClearFocus 0x9fb0cfc)
	void K2ClearFocus(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIController.HasPartialPath (Underlying native function: HasPartialPath 0x9fb0c28)
	bool HasPartialPath(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetPathFollowingComponent (Underlying native function: GetPathFollowingComponent 0x662cb2c)
	class UPathFollowingComponent* GetPathFollowingComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetMoveStatus (Underlying native function: GetMoveStatus 0x9fb0c08)
	struct TEnumAsByte<EPathFollowingStatus> GetMoveStatus(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetImmediateMoveDestination (Underlying native function: GetImmediateMoveDestination 0x9fb0bd0)
	struct FVector GetImmediateMoveDestination(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetFocusActor (Underlying native function: GetFocusActor 0x9fb0bac)
	class AActor* GetFocusActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetFocalPointOnActor (Underlying native function: GetFocalPointOnActor 0x9fb0b04)
	struct FVector GetFocalPointOnActor(class AActor*& Actor); // (Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetFocalPoint (Underlying native function: GetFocalPoint 0x9fb0acc)
	struct FVector GetFocalPoint(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.AIController.GetAIPerceptionComponent (Underlying native function: GetAIPerceptionComponent 0x81407ec)
	class UAIPerceptionComponent* GetAIPerceptionComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/AIModule.AIController.ClaimTaskResource (Underlying native function: ClaimTaskResource 0x9fb0844)
