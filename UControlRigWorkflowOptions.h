...
class UControlRigWorkflowOptions : public URigVMUserWorkflowOptions
{
	...
	// Function /Script/ControlRig.ControlRigWorkflowOptions.EnsureAtLeastOneRigElementSelected (Underlying native function: EnsureAtLeastOneRigElementSelected 0x77e05d8)
