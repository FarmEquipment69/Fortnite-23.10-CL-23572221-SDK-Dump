...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x32e0 (0x8)
	class UFortPawnComponent_CustomDepth* FortPawnComponentCustomDepth; // 0x32e8 (0x8)
	class UCapsuleComponent* WeaponCapsuleCollision; // 0x32f0 (0x8)
	class UFortTaggedNavFiltersComponent* FortTaggedNavFilters; // 0x32f8 (0x8)
	class UFortActorComponent_Affiliation* FortActorComponentAffiliation; // 0x3300 (0x8)
	class USoundLibraryComponent* SoundLibraryComponent; // 0x3308 (0x8)
	class UAudioComponent* MovementAudioComponent; // 0x3310 (0x8)
	class UNPC_VoiceComponent_C* NPCVoiceComponent; // 0x3318 (0x8)
	class UAudioComponent* VOAudioComponent; // 0x3320 (0x8)
	class UFortWidgetComponent* NPCStatusWidget; // 0x3328 (0x8)
	float TimelineScaleMeshInOrOutMeshScaleAlpha9DAAC0B243D26E4160CEC3A458AE0E86; // 0x3330 (0x4)
	struct TEnumAsByte<ETimelineDirection> TimelineScaleMeshInOrOutDirection9DAAC0B243D26E4160CEC3A458AE0E86; // 0x3334 (0x1)
	unsigned char unreflected_3335[0x3]; // 0x3335 (0x3) 
	class UTimelineComponent* TimelineScaleMeshInOrOut; // 0x3338 (0x8)
	class UClass* GENPCRecentlyDamaged; // 0x3340 (0x8)
	struct TEnumAsByte<Enum_NPC_AlertLevel> NPCAlertLevel; // 0x3348 (0x1)
	struct TEnumAsByte<Enum_NPC_AlertLevel> NPCAlertLevelPrevious; // 0x3349 (0x1)
	unsigned char unreflected_334a[0x6]; // 0x334a (0x6) 
	struct TMap<struct TEnumAsByte<Enum_NPC_AlertLevel>, struct FGameplayTag> NPCAlertLevelToTagMap; // 0x3350 (0x50)
	bool NPCStatusWidgetHealthBarDisabled; // 0x33a0 (0x1)
	unsigned char unreflected_33a1[0x3]; // 0x33a1 (0x3) 
	struct FGameplayTag GameplayCuePickupGrabbed; // 0x33a4 (0x4)
	enum EFortRarity NPCBestLootRarityInInventory; // 0x33a8 (0x1)
	bool NPCDebugPawn; // 0x33a9 (0x1)
	bool NPCShowInventoryRarityVisuals; // 0x33aa (0x1)
	unsigned char unreflected_33ab[0x5]; // 0x33ab (0x5) 
	double InventoryGlowDelay; // 0x33b0 (0x8)
	struct FScalableFloat NPCNumberOfInventoryItemsToDeliverHF; // 0x33b8 (0x28)
	bool NPCSpawnInvisible; // 0x33e0 (0x1)
	bool NPCScaleMeshInOnSpawn; // 0x33e1 (0x1)
	unsigned char unreflected_33e2[0x6]; // 0x33e2 (0x6) 
	struct FGameplayTagContainer TCNPCSpawnAbilityTag; // 0x33e8 (0x20)
	struct FGameplayTagContainer TCNPCAlternateSpawnAbilityTag; // 0x3408 (0x20)
	bool NPCIsSpawning; // 0x3428 (0x1)
	unsigned char unreflected_3429[0x7]; // 0x3429 (0x7) 
	double NPCOriginalGravityScale; // 0x3430 (0x8)
	struct FRotator NPCOriginalRotationRate; // 0x3438 (0x18)
	bool NPCHasPawnGoal; // 0x3450 (0x1)
	unsigned char unreflected_3451[0x7]; // 0x3451 (0x7) 
	class AActor* NPCPawnGoalActor; // 0x3458 (0x8)
	struct FScalableFloat NPCNumberOfInventoryItemsToConsumeBeforeFullHF; // 0x3460 (0x28)
	bool NPCPawnIsDestroyingBuildingForNavigation; // 0x3488 (0x1)
	unsigned char unreflected_3489[0x7]; // 0x3489 (0x7) 
	struct FScalableFloat MaxIdleVODelay; // 0x3490 (0x28)
	struct FScalableFloat MinIdleVODelay; // 0x34b8 (0x28)
	struct FScalableFloat NPCDeathDropLootDelay; // 0x34e0 (0x28)
	struct FName NPCDeathDropLootTierGroupName; // 0x3508 (0x4)
	unsigned char unreflected_350c[0x4]; // 0x350c (0x4) 
	struct FGameplayTagContainer NPCDeathDropLootRequiredDamageTags; // 0x3510 (0x20)
	struct FGameplayTagContainer NPCDeathDropLootForbiddenDamageTags; // 0x3530 (0x20)
	struct FGameplayTagContainer GrantStartingItemsAbilityTC; // 0x3550 (0x20)
	bool NPCHasItemInInventory; // 0x3570 (0x1)
	unsigned char unreflected_3571[0x3]; // 0x3571 (0x3) 
	struct FGameplayTag VoiceTagFullAlertIdle; // 0x3574 (0x4)
	struct FGameplayTag VoiceTagIdle; // 0x3578 (0x4)
	struct FGameplayTag VoiceTagReturnToIdle; // 0x357c (0x4)
	struct FGameplayTag VoiceTagLostTarget; // 0x3580 (0x4)
	struct FGameplayTag VoiceTagSuspicious; // 0x3584 (0x4)
	struct FGameplayTag VoiceTagFullAlert; // 0x3588 (0x4)
	unsigned char unreflected_358c[0x4]; // 0x358c (0x4) 
	struct TArray<struct FStruct_NPC_TargetSlots> NPCTargetSlotsHF; // 0x3590 (0x10)
	bool NPCDamageCanCancelIntroPhase; // 0x35a0 (0x1)
	unsigned char unreflected_35a1[0x7]; // 0x35a1 (0x7) 
	struct FGameplayTagQuery TQNPCDamageTagsThatCanCancelIntroPhase; // 0x35a8 (0x48)
	class UClass* GENPCIntroPhaseBehaviorCooldown; // 0x35f0 (0x8)
	struct FGameplayTagContainer TCIntroBehaviorActive; // 0x35f8 (0x20)
	bool DebugNPCAlertLevelForced; // 0x3618 (0x1)
	bool NPCPawnCanInteractInternal; // 0x3619 (0x1)
	unsigned char unreflected_361a[0x6]; // 0x361a (0x6) 
	struct FScalableFloat NPCPrimtiveDataFloatSetRandomlyInRange; // 0x3620 (0x28)
	struct FScalableFloat NPCPrimtiveDataFloatIndexHF; // 0x3648 (0x28)
	struct FScalableFloat NPCPrimtiveDataFloatMinRangeHF; // 0x3670 (0x28)
	struct FScalableFloat NPCPrimtiveDataFloatMaxRangeHF; // 0x3698 (0x28)
	class AActor* NPCLeader; // 0x36c0 (0x8)
	struct FGameplayTag GameplayCueLeaderSet; // 0x36c8 (0x4)
	unsigned char unreflected_36cc[0x4]; // 0x36cc (0x4) 
	double NPCSkeletalMeshIndex; // 0x36d0 (0x8)
	class USoundBase* TamedSound; // 0x36d8 (0x8)
	class UAudioComponent* StateChangeSound; // 0x36e0 (0x8)
	struct FScalableFloat NPCShouldDespawnFromStormHF; // 0x36e8 (0x28)
	struct FScalableFloat NPCDespawnTimerHF; // 0x3710 (0x28)
	struct FGameplayTag NPCDespawnGameplayTag; // 0x3738 (0x4)
	unsigned char unreflected_373c[0x4]; // 0x373c (0x4) 
	struct FTimerHandle* NPCTestIsInSafeZoneTimer; // 0x3740 (0x8)
	struct FTimerHandle* NPCDespawnFromStormTimer; // 0x3748 (0x8)
	bool NPCisTryingToDespawn; // 0x3750 (0x1)
	unsigned char unreflected_3751[0x3]; // 0x3751 (0x3) 
	struct FGameplayTag NPCResetIntroGameplayTags; // 0x3754 (0x4)
	double SelectedPrimitiveDataFloat; // 0x3758 (0x8)
	struct FGameplayTag GameplayCueDeath; // 0x3760 (0x4)
	unsigned char unreflected_3764[0x4]; // 0x3764 (0x4) 
	struct TArray<class UMaterialInterface*> OGMaterials; // 0x3768 (0x10)
	bool NPCApplyGEforSwimming; // 0x3778 (0x1)
	unsigned char unreflected_3779[0x7]; // 0x3779 (0x7) 
	class UClass* NPCGEClassToApplyForSwimming; // 0x3780 (0x8)
	bool NPCApplyWaterEnterExitBurstGC; // 0x3788 (0x1)
	unsigned char unreflected_3789[0x3]; // 0x3789 (0x3) 
	struct FActiveGameplayEffectHandle* NPCGEAppliedForSwimming; // 0x378c (0x8)
	struct FName GoalActorBBKey; // 0x3794 (0x4)
	struct FGameplayTag GameplayCueLureInterest; // 0x3798 (0x4)
	unsigned char unreflected_379c[0x4]; // 0x379c (0x4) 
	class UObject* NPCPreviousLureGoal; // 0x37a0 (0x8)
	struct FGameplayTag ExitWater; // 0x37a8 (0x4)
	struct FGameplayTag EnterWater; // 0x37ac (0x4)
	struct FScalableFloat NPCMaxDistanceFromDamagedNPCToDrawHeallthBarHF; // 0x37b0 (0x28)
	struct FScalableFloat NPCHealthBarHideTimeAfterDeathHF; // 0x37d8 (0x28)
	struct FScalableFloat NPCPlayEffectWhenLuredHF; // 0x3800 (0x28)
	struct FScalableFloat NPCPawnCanInteractHF; // 0x3828 (0x28)
	struct FScalableFloat NPCAllowInteractOnlyWhenUnawareHF; // 0x3850 (0x28)
	struct FScalableFloat NPCAllowInteractWhenHasLeaderHF; // 0x3878 (0x28)
	struct FScalableFloat NPCAllowDrownInShallowWaterHF; // 0x38a0 (0x28)
	bool NPCIsInventoryInitialized; // 0x38c8 (0x1)
	unsigned char unreflected_38c9[0x3]; // 0x38c9 (0x3) 
	float LeaderClearedCueDelay; // 0x38cc (0x4)
	struct FGameplayTag GameplayCueLeaderCleared; // 0x38d0 (0x4)
	bool isGCForLeaderSetLooping; // 0x38d4 (0x1)
	unsigned char unreflected_38d5[0x3]; // 0x38d5 (0x3) 
	struct FGameplayTag NPCDeathByStormTag; // 0x38d8 (0x4)
	bool NPCTryDespawnAbility; // 0x38dc (0x1)
	unsigned char unreflected_38dd[0x3]; // 0x38dd (0x3) 
	struct FActiveGameplayEffectHandle* GeOutsideSafeZoneDamageHandle; // 0x38e0 (0x8)
	bool IsGEStormDamageInit; // 0x38e8 (0x1)
	bool NPCMeshScalingInProgress; // 0x38e9 (0x1)
	bool NPCDisableCapsuleOverlapsWhenScalingOut; // 0x38ea (0x1)
	unsigned char unreflected_38eb[0x5]; // 0x38eb (0x5) 
	struct FVector NPCOriginalMeshScale; // 0x38f0 (0x18)
	struct FMulticastInlineDelegate NPCScaleMeshInCompleted; // 0x3908 (0x10)
	struct FMulticastInlineDelegate NPCScaleMeshOutCompleted; // 0x3918 (0x10)
	bool NPCCanDropLoot; // 0x3928 (0x1)
	unsigned char unreflected_3929[0x7]; // 0x3929 (0x7) 
	struct FScalableFloat NPCStaleDespawnTestDistanceHF; // 0x3930 (0x28)
	struct FScalableFloat NPCStaleDespawnTimeThresholdHF; // 0x3958 (0x28)
	double NPCLastNonStaleCheckTime; // 0x3980 (0x8)
	bool bCanBeDamagedByNullInstigator; // 0x3988 (0x1)
	bool IsEnteringWater; // 0x3989 (0x1)
	unsigned char unreflected_398a[0x6]; // 0x398a (0x6) 
	struct FMulticastInlineDelegate NPCPawnInteractWithDispatcher; // 0x3990 (0x10)
	bool NPCDynamicBlockConversionOnInteract; // 0x39a0 (0x1)
	bool NPCTempInteractOverride; // 0x39a1 (0x1)
	unsigned char unreflected_39a2[0x6]; // 0x39a2 (0x6) 
	class USoundBase* HeadShotSound; // 0x39a8 (0x8)
	struct FName HeadshotFXSocket; // 0x39b0 (0x4)
	bool UseHeadShotFX; // 0x39b4 (0x1)
	unsigned char unreflected_39b5[0x3]; // 0x39b5 (0x3) 
	struct FGameplayTagContainer TCWeaponTypesAllowedForHeadshotFX; // 0x39b8 (0x20)
	bool AllowHeadshot; // 0x39d8 (0x1)
	unsigned char unreflected_39d9[0x7]; // 0x39d9 (0x7) 
	double AdditiveHitReactRetriggerDelay; // 0x39e0 (0x8)
	class UAnimMontage* AdditiveHitReactMontage; // 0x39e8 (0x8)
	class USoundBase* DeathNormalSound; // 0x39f0 (0x8)
	class UParticleSystem* HeadshotFXEmitterTemplate; // 0x39f8 (0x8)
	struct TArray<class USoundLibrary*> SoundLibsDefault; // 0x3a00 (0x10)
	struct TArray<class USoundLibrary*> SoundLibsAlert; // 0x3a10 (0x10)
	class USoundLibrary* CurrentSoundLib; // 0x3a20 (0x8)
	struct TArray<class USoundLibrary*> SoundLibsAggressive; // 0x3a28 (0x10)
	struct TArray<class USoundLibrary*> SoundLibsFoley; // 0x3a38 (0x10)
	struct TArray<class USoundLibrary*> SoundLibsFoleyWater; // 0x3a48 (0x10)
	class USoundLibrary* CurrentFoleyLib; // 0x3a58 (0x8)
	double CustomDepthUpdateRate; // 0x3a60 (0x8)
	class UClass* Class; // 0x3a68 (0x8)
	class UClass* GEConverted; // 0x3a70 (0x8)
	struct FActiveGameplayEffectHandle* GEConvertedHandle; // 0x3a78 (0x8)
	double NPCDeathTime; // 0x3a80 (0x8)
