...
class UAthenaPlayerInfoBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaPlayerInfoBase.SetPlayerState (Underlying native function: SetPlayerState 0xa3115d4)
	void SetPlayerState(class AFortPlayerStateAthena*& InPlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaPlayerInfoBase.HandlePlaylistLoaded (Underlying native function: HandlePlaylistLoaded 0xa3105e8)
	...
	// Function /Script/FortniteUI.AthenaPlayerInfoBase.HandlePlayerMutatorDataChanged (Underlying native function: HandlePlayerMutatorDataChanged 0xa310504)
	void HandlePlayerMutatorDataChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaPlayerInfoBase.HandleGamePhaseChanged (Underlying native function: HandleGamePhaseChanged 0xa310078)
