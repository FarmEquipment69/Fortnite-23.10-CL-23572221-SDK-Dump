...
class AFortAthenaMutator_BallerRace : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_BallerRace.OnRep_ServerWorldTimeToStartRace (Underlying native function: OnRep_ServerWorldTimeToStartRace 0x81d93e0)
	void OnRepServerWorldTimeToStartRace(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_BallerRace.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81d8c44)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_BallerRace.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x81d8658)
