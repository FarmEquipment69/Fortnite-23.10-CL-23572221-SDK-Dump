...
class ALobbyBeaconPlayerState : public AInfo
{
	...
	// Function /Script/Lobby.LobbyBeaconPlayerState.OnRep_UniqueId (Underlying native function: OnRep_UniqueId 0x6a44c4c)
	void OnRepUniqueId(); // (Final | Native | Protected)

	// Function /Script/Lobby.LobbyBeaconPlayerState.OnRep_PartyOwner (Underlying native function: OnRep_PartyOwner 0x6a44c14)
	void OnRepPartyOwner(); // (Final | Native | Protected)

	// Function /Script/Lobby.LobbyBeaconPlayerState.OnRep_InLobby (Underlying native function: OnRep_InLobby 0x6a44bb0)
