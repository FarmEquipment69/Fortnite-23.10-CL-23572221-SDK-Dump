...
class UAthenaLobbyBase : public UFortLobbyWidget
{
	...
	// Function /Script/FortniteUI.AthenaLobbyBase.HasUnseenQuests (Underlying native function: HasUnseenQuests 0xa31090c)
	...
	// Function /Script/FortniteUI.AthenaLobbyBase.HandleToggleFullscreenMap (Underlying native function: HandleToggleFullscreenMap 0xa31087c)
	void HandleToggleFullscreenMap(bool& bVisible); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaLobbyBase.HandlePickerOpenRequest (Underlying native function: HandlePickerOpenRequest 0x1ba5848)
	void HandlePickerOpenRequest(enum EFortPickerMode& Mode, int& InitialOption, bool& bIgnoreFirstAccept); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaLobbyBase.HandleHideLobbySeasonResources (Underlying native function: HandleHideLobbySeasonResources 0xa3100f4)
	void HandleHideLobbySeasonResources(bool& bShouldHide); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaLobbyBase.HandleActiveWidgetChanged (Underlying native function: HandleActiveWidgetChanged 0x2a3e1dc)
