...
class UFortFallTeleportSpawnerComponent : public UActorComponent
{
	...
	// Function /Script/FallTeleportationRuntime.FortFallTeleportSpawnerComponent.HandleWarmupCountdownEndTimeUpdated (Underlying native function: HandleWarmupCountdownEndTimeUpdated 0x52c9c10)
	void HandleWarmupCountdownEndTimeUpdated(float& NewEndTime); // (Final | Native | Protected)

	// Function /Script/FallTeleportationRuntime.FortFallTeleportSpawnerComponent.HandleGamePhaseChanged (Underlying native function: HandleGamePhaseChanged 0x707e290)
