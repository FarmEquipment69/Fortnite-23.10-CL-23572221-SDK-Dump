...
class UFortPlayerControllerComponent_TacticalSprint : public UControllerComponent
{
	...
	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.SetIsSprinting (Underlying native function: SetIsSprinting 0x6ef56b8)
	void SetIsSprinting(bool& bNewIsSprinting); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.OnWeaponEquipped (Underlying native function: OnWeaponEquipped 0x6ef55f4)
	void OnWeaponEquipped(class AFortWeapon*& NewWeapon, class AFortWeapon*& PreviousWeapon); // (Final | Native | Private)

	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.OnPawnChanged (Underlying native function: OnPawnChanged 0x6ef5558)
	void OnPawnChanged(class AFortPawn*& InPawn); // (Final | Native | Private)

	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.OnMovementModeChanged (Underlying native function: OnMovementModeChanged 0x6ef545c)
	...
	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.OnAutoRunChanged (Underlying native function: OnAutoRunChanged 0x6ef53dc)
	void OnAutoRunChanged(bool& bAutoRunIsOn); // (Final | Native | Private)

	// Function /Script/TacticalSprintRuntime.FortPlayerControllerComponent_TacticalSprint.LogAndVisualLog (Underlying native function: LogAndVisualLog 0x6ef5224)
