...
class UFortGameplayAbility_SpyTech_GrantItem : public UFortGameplayAbility_SpyTech
{
	...
	// Function /Script/FortniteGame.FortGameplayAbility_SpyTech_GrantItem.UpgradeTagApplied (Underlying native function: UpgradeTagApplied 0x7e4bc7c)
	void UpgradeTagApplied(struct FGameplayTag& InTag, int& NewCount); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameplayAbility_SpyTech_GrantItem.LevelUpgradeTagApplied (Underlying native function: LevelUpgradeTagApplied 0x7e4a6c4)
