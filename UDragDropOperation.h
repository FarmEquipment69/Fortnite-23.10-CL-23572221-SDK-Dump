...
class UDragDropOperation : public UObject
{
	...
	// Function /Script/UMG.DragDropOperation.Drop (Underlying native function: Drop 0x9951e7c)
	void Drop(struct FPointerEvent& PointerEvent); // (Native | Event | Public | HasOutParms | BlueprintEvent)

	// Function /Script/UMG.DragDropOperation.Dragged (Underlying native function: Dragged 0x9950dd8)
	void Dragged(struct FPointerEvent& PointerEvent); // (Native | Event | Public | HasOutParms | BlueprintEvent)

	// Function /Script/UMG.DragDropOperation.DragCancelled (Underlying native function: DragCancelled 0x9950d0c)
