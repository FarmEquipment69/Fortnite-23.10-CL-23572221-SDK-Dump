...
class UFortActivatablePanel : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/FortniteUI.FortActivatablePanel.RestoreScrollWidget (Underlying native function: RestoreScrollWidget 0xa8463fc)
	void RestoreScrollWidget(class UWidget*& FallbackWidget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatablePanel.RestoreCenterWidget (Underlying native function: RestoreCenterWidget 0xa84637c)
	void RestoreCenterWidget(class UWidget*& FallbackWidget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatablePanel.AsyncPlaySound2D (Underlying native function: AsyncPlaySound2D 0xa559664)
