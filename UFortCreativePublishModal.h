...
class UFortCreativePublishModal : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativePublishModal.HandleNameTextCommitted (Underlying native function: HandleNameTextCommitted 0xa534cd0)
	...
	// Function /Script/FortniteUI.FortCreativePublishModal.HandleNameTextChanged (Underlying native function: HandleNameTextChanged 0xa534c14)
	void HandleNameTextChanged(struct FText& Text); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortCreativePublishModal.HandleDescriptionTextCommitted (Underlying native function: HandleDescriptionTextCommitted 0xa53430c)
	...
	// Function /Script/FortniteUI.FortCreativePublishModal.HandleDescriptionTextChanged (Underlying native function: HandleDescriptionTextChanged 0xa534270)
