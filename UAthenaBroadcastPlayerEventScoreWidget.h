...
class UAthenaBroadcastPlayerEventScoreWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaBroadcastPlayerEventScoreWidget.OnRemoteClientEventScoreChanged (Underlying native function: OnRemoteClientEventScoreChanged 0xa43fcb0)
