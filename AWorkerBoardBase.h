...
class AWorkerBoardBase : public AActor
{
	...
	// Function /Script/FortniteGame.WorkerBoardBase.SetupWorkerPortraits (Underlying native function: SetupWorkerPortraits 0x87b5460)
	...
	// Function /Script/FortniteGame.WorkerBoardBase.HandlePreviewImagesLoaded (Underlying native function: HandlePreviewImagesLoaded 0x87b4378)
	void HandlePreviewImagesLoaded(); // (Final | Native | Private)

	// Function /Script/FortniteGame.WorkerBoardBase.HandleIconDefinitionsLoaded (Underlying native function: HandleIconDefinitionsLoaded 0x87b4200)
