...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x1270 (0x8)
	class UParticleSystemComponent* MeleeHeavyPSC; // 0x1278 (0x8)
	class UParticleSystem* MeleeHeavyParticleSystem; // 0x1280 (0x8)
	class UParticleSystem* WeaponDurabilityDestroyEffect; // 0x1288 (0x8)
	class UParticleSystem* WeaponDurabilityDestroyEffectIcon; // 0x1290 (0x8)
	bool UseDestroyEffect; // 0x1298 (0x1)
	unsigned char unreflected_1299[0x7]; // 0x1299 (0x7) 
	class UParticleSystemComponent* AlterationAmbientPS; // 0x12a0 (0x8)
	struct FVector EffectsColorLevel; // 0x12a8 (0x18)
	bool Equipped; // 0x12c0 (0x1)
	bool bEquipPendingInstigator; // 0x12c1 (0x1)
	bool UseTimeofDayControl; // 0x12c2 (0x1)
	bool SwingRight; // 0x12c3 (0x1)
	unsigned char unreflected_12c4[0x4]; // 0x12c4 (0x4) 
	class UFXSystemComponent* ImpactFX; // 0x12c8 (0x8)
	struct FRotator LeftSwingRotation; // 0x12d0 (0x18)
	struct FRotator RightSwingRotation; // 0x12e8 (0x18)
