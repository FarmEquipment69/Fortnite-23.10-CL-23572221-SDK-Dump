...
class UFortSimpleMaterialProgressBar : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetStartProgress (Underlying native function: SetStartProgress 0xa4b4338)
	void SetStartProgress(float& StartProgress); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetSegments (Underlying native function: SetSegments 0xa4b3f34)
	void SetSegments(int& NumSegments); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetSegmentColor (Underlying native function: SetSegmentColor 0x5ceaf70)
	void SetSegmentColor(struct FLinearColor& SegmentColor); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetProgress (Underlying native function: SetProgress 0x102b6a4)
	void SetProgress(float& Progress); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetEnableColoredSegments (Underlying native function: SetEnableColoredSegments 0x5ceaec0)
	void SetEnableColoredSegments(bool& bEnableColoredSegments); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetColorBackground (Underlying native function: SetColorBackground 0x2103bbc)
	void SetColorBackground(struct FLinearColor& ColorBackground); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetColorB (Underlying native function: SetColorB 0x201d94c)
	void SetColorB(struct FLinearColor& ColorB); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.SetColorA (Underlying native function: SetColorA 0x201d7fc)
	...
	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.AnimateProgressFromStart (Underlying native function: AnimateProgressFromStart 0xa4ad0a0)
	void AnimateProgressFromStart(float& Start, float& End, float& AnimSpeed); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSimpleMaterialProgressBar.AnimateProgressFromCurrent (Underlying native function: AnimateProgressFromCurrent 0x287cef4)
