...
class UCommonButtonGroupBase : public UCommonWidgetGroupBase
{
	...
	// Function /Script/CommonUI.CommonButtonGroupBase.SetSelectionRequired (Underlying native function: SetSelectionRequired 0x663013c)
	void SetSelectionRequired(bool& bRequireSelection); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonButtonGroupBase.SelectPreviousButton (Underlying native function: SelectPreviousButton 0x662e6d8)
	void SelectPreviousButton(bool& bAllowWrap); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonButtonGroupBase.SelectNextButton (Underlying native function: SelectNextButton 0x662e658)
	void SelectNextButton(bool& bAllowWrap); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonButtonGroupBase.SelectButtonAtIndex (Underlying native function: SelectButtonAtIndex 0x662e594)
	void SelectButtonAtIndex(int& ButtonIndex, bool& bAllowSound); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonButtonGroupBase.OnSelectionStateChangedBase (Underlying native function: OnSelectionStateChangedBase 0x1bd78cc)
	void OnSelectionStateChangedBase(class UCommonButtonBase*& BaseButton, bool& bIsSelected); // (Native | Protected)

	// Function /Script/CommonUI.CommonButtonGroupBase.OnHandleButtonBaseDoubleClicked (Underlying native function: OnHandleButtonBaseDoubleClicked 0x662e140)
	void OnHandleButtonBaseDoubleClicked(class UCommonButtonBase*& BaseButton); // (Native | Protected)

	// Function /Script/CommonUI.CommonButtonGroupBase.OnHandleButtonBaseClicked (Underlying native function: OnHandleButtonBaseClicked 0x28e7400)
	void OnHandleButtonBaseClicked(class UCommonButtonBase*& BaseButton); // (Native | Protected)

	// Function /Script/CommonUI.CommonButtonGroupBase.OnButtonBaseUnhovered (Underlying native function: OnButtonBaseUnhovered 0x1bd8fb8)
	void OnButtonBaseUnhovered(class UCommonButtonBase*& BaseButton); // (Native | Protected)

	// Function /Script/CommonUI.CommonButtonGroupBase.OnButtonBaseHovered (Underlying native function: OnButtonBaseHovered 0x27d383c)
	void OnButtonBaseHovered(class UCommonButtonBase*& BaseButton); // (Native | Protected)

	// Function /Script/CommonUI.CommonButtonGroupBase.HasAnyButtons (Underlying native function: HasAnyButtons 0x662dcc4)
	bool HasAnyButtons(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.GetSelectedButtonIndex (Underlying native function: GetSelectedButtonIndex 0x662d2e0)
	int GetSelectedButtonIndex(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.GetSelectedButtonBase (Underlying native function: GetSelectedButtonBase 0x662d2b8)
	class UCommonButtonBase* GetSelectedButtonBase(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.GetHoveredButtonIndex (Underlying native function: GetHoveredButtonIndex 0x662cd40)
	int GetHoveredButtonIndex(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.GetButtonCount (Underlying native function: GetButtonCount 0x662c7ec)
	int GetButtonCount(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.GetButtonBaseAtIndex (Underlying native function: GetButtonBaseAtIndex 0x662c760)
	class UCommonButtonBase* GetButtonBaseAtIndex(int& Index); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.FindButtonIndex (Underlying native function: FindButtonIndex 0x662c430)
	int FindButtonIndex(class UCommonButtonBase*& ButtonToFind); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonButtonGroupBase.DeselectAll (Underlying native function: DeselectAll 0x662c24c)
