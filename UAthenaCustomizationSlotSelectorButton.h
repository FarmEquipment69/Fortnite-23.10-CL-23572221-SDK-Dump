...
class UAthenaCustomizationSlotSelectorButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.SetCustomizationType (Underlying native function: SetCustomizationType 0xa2ea680)
	...
	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.SetCardDefaultImageAndWidth (Underlying native function: SetCardDefaultImageAndWidth 0xa2ea4fc)
	...
	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.IsSlotFilled (Underlying native function: IsSlotFilled 0x18c0704)
	bool IsSlotFilled(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.HandleDifferentHeroLoadoutActivated (Underlying native function: HandleDifferentHeroLoadoutActivated 0xa2e8a8c)
	void HandleDifferentHeroLoadoutActivated(class UFortMcpProfileCampaign*& Profile); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.GetCustomizationSlotActiveState (Underlying native function: GetCustomizationSlotActiveState 0x25b4f5c)
	...
	// Function /Script/FortniteUI.AthenaCustomizationSlotSelectorButton.GetCampaignHeroPartItem (Underlying native function: GetCampaignHeroPartItem 0xa2e810c)
