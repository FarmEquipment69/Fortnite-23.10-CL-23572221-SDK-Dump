...
class UAthenaTeamScoreWidgetBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaTeamScoreWidgetBase.HandleUpdate (Underlying native function: HandleUpdate 0xa3108f8)
	void HandleUpdate(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaTeamScoreWidgetBase.HandleSpectatingChanged (Underlying native function: HandleSpectatingChanged 0xa310760)
	void HandleSpectatingChanged(class AFortPlayerStateZone*& SpectatingTarget); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaTeamScoreWidgetBase.HandleScoreChanged (Underlying native function: HandleScoreChanged 0xa3106e4)
