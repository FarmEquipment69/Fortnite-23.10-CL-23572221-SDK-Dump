...
class UFortGiftingUserSearchWidget : public UCommonUserWidget
{
	...
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextEntered (Underlying native function: HandleSearchFriendsTextEntered 0x7091590)
	...
	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextChanged (Underlying native function: HandleSearchFriendsTextChanged 0x70914e4)
	void HandleSearchFriendsTextChanged(struct FText& Text); // (Final | Native | Private | HasOutParms)

	// Function /Script/GiftingUI.FortGiftingUserSearchWidget.FocusEditableText (Underlying native function: FocusEditableText 0x709137c)
