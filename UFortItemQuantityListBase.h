...
class UFortItemQuantityListBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemQuantityListBase.SetItemToCompareDefinitionsAndQuantities (Underlying native function: SetItemToCompareDefinitionsAndQuantities 0xa70a2c0)
	...
	// Function /Script/FortniteUI.FortItemQuantityListBase.SetItemInstancesAndQuantities (Underlying native function: SetItemInstancesAndQuantities 0xa70a128)
	...
	// Function /Script/FortniteUI.FortItemQuantityListBase.SetItemInspectMode (Underlying native function: SetItemInspectMode 0xa709f9c)
	void SetItemInspectMode(enum EFortItemInspectionMode& InspectMode); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemQuantityListBase.SetItemDefinitionsAndQuantities (Underlying native function: SetItemDefinitionsAndQuantities 0xa709d80)
	...
	// Function /Script/FortniteUI.FortItemQuantityListBase.IsEmptyList (Underlying native function: IsEmptyList 0xa709358)
	bool IsEmptyList(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemQuantityListBase.GetItemDefinitions (Underlying native function: GetItemDefinitions 0xa708640)
