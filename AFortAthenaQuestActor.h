...
class AFortAthenaQuestActor : public AActor
{
	...
	// Function /Script/FortniteGame.FortAthenaQuestActor.QuestLog (Underlying native function: QuestLog 0x8bdea54)
	void QuestLog(struct FString& StringToLog); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaQuestActor.OnPlaylistDataReady (Underlying native function: OnPlaylistDataReady 0x8bdd81c)
	...
	// Function /Script/FortniteGame.FortAthenaQuestActor.OnCalendarUpdated (Underlying native function: OnCalendarUpdated 0x8bdcbdc)
