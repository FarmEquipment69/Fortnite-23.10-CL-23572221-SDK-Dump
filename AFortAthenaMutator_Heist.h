...
class AFortAthenaMutator_Heist : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Heist.SendPlayerAcquiredMessage (Underlying native function: SendPlayerAcquiredMessage 0x8228074)
	void SendPlayerAcquiredMessage(class AFortPlayerStateAthena*& CarryingPlayerState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnSpecialActorRemoved (Underlying native function: OnSpecialActorRemoved 0x8227a30)
	void OnSpecialActorRemoved(struct FSpecialActorRepData& SpecialActorData); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnSpecialActorAdded (Underlying native function: OnSpecialActorAdded 0x822798c)
	void OnSpecialActorAdded(struct FSpecialActorRepData& SpecialActorData); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnMutatorGenericIntegerUpdated (Underlying native function: OnMutatorGenericIntegerUpdated 0x735ad48)
	void OnMutatorGenericIntegerUpdated(int& GenericIntegerIndex, int& NewIntegerValue); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x82271e4)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x8226bfc)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnExitCraftSpawned (Underlying native function: OnExitCraftSpawned 0x8226530)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Heist.OnExitCraftIsDestroying (Underlying native function: OnExitCraftIsDestroying 0x82264b0)
