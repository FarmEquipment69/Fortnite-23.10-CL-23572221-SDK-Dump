...
class UCreativeLowMemoryFallbackWorldSubsystem : public UWorldSubsystem
{
	...
	// Function /Script/CreativeLowMemoryFallbackRuntime.CreativeLowMemoryFallbackWorldSubsystem.OnPlaylistDataChanged (Underlying native function: OnPlaylistDataChanged 0x52bdab0)
