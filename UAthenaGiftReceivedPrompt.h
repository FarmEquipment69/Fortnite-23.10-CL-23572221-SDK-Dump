...
class UAthenaGiftReceivedPrompt : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaGiftReceivedPrompt.HandleMessageTextFiltered (Underlying native function: HandleMessageTextFiltered 0xa6c6e94)
	void HandleMessageTextFiltered(bool& bSuccess, struct FString& SanitizedMessage); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaGiftReceivedPrompt.DismissPrompt (Underlying native function: DismissPrompt 0xa6c50ec)
