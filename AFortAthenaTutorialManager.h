...
class AFortAthenaTutorialManager : public AActor
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorialManager.Server_OnTutorialScreenCompleted (Underlying native function: Server_OnTutorialScreenCompleted 0x2466474)
	void ServerOnTutorialScreenCompleted(); // (Net | NetReliable | Native | Event | Public | NetServer)

	// Function /Script/FortniteGame.FortAthenaTutorialManager.Server_OnClientReadyToStartMatch (Underlying native function: Server_OnClientReadyToStartMatch 0x1598df4)
