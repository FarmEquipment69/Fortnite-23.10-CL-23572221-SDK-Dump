...
{
	class UFortTabListWidgetBase* LeaderboardTabList; // 0x518 (0x8)
	...
	// Function /Script/FortniteUI.AthenaLeaderboardScreenBase.OnPlaylistChanged (Underlying native function: OnPlaylistChanged 0xa310cb8)
	...
	// Function /Script/FortniteUI.AthenaLeaderboardScreenBase.OnMatchTypeChanged (Underlying native function: OnMatchTypeChanged 0xa310bc4)
	void OnMatchTypeChanged(int& MatchTypeIndex); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaLeaderboardScreenBase.OnFriendsFilterChanged (Underlying native function: OnFriendsFilterChanged 0xa310a88)
	void OnFriendsFilterChanged(int& FriendsFilterIndex); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaLeaderboardScreenBase.OnActiveLeaderboardTabChanged (Underlying native function: OnActiveLeaderboardTabChanged 0xa3109f4)
	void OnActiveLeaderboardTabChanged(int& ActiveWidgetIndex); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaLeaderboardScreenBase.CanShowFriendsOnlyLeaderboard (Underlying native function: CanShowFriendsOnlyLeaderboard 0x2830cb8)
