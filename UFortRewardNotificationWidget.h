...
class UFortRewardNotificationWidget : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.ShowMulchConfirmationModal (Underlying native function: ShowMulchConfirmationModal 0x721d2a4)
	void ShowMulchConfirmationModal(); // (Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.SetPrimaryActionText (Underlying native function: SetPrimaryActionText 0x724767c)
	void SetPrimaryActionText(struct FText& Text); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.SetPrimaryActionHidden (Underlying native function: SetPrimaryActionHidden 0x7247514)
	void SetPrimaryActionHidden(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.SetPrimaryActionEnabled (Underlying native function: SetPrimaryActionEnabled 0x7247438)
	void SetPrimaryActionEnabled(bool& bEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.ResetAllRewardData (Underlying native function: ResetAllRewardData 0x72464f0)
	void ResetAllRewardData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.PopulateReward (Underlying native function: PopulateReward 0x7245cb8)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.NotifyPanelDeactivated (Underlying native function: NotifyPanelDeactivated 0x721c0b8)
	void NotifyPanelDeactivated(); // (Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.NotifyPanelActivated (Underlying native function: NotifyPanelActivated 0x721c09c)
	void NotifyPanelActivated(); // (Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.MarkDefaultItemsForMulch (Underlying native function: MarkDefaultItemsForMulch 0x7245adc)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.IsPrimaryActionHidden (Underlying native function: IsPrimaryActionHidden 0x7245890)
	void IsPrimaryActionHidden(bool& bHidden); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.IsPrimaryActionEnabled (Underlying native function: IsPrimaryActionEnabled 0x7245804)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HideMulchConfirmationModal (Underlying native function: HideMulchConfirmationModal 0x721bda0)
	void HideMulchConfirmationModal(); // (Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnQuestRewardClaimed (Underlying native function: HandleOnQuestRewardClaimed 0x7244e1c)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnNoQuestRewardsToClaim (Underlying native function: HandleOnNoQuestRewardsToClaim 0x7244d6c)
	void HandleOnNoQuestRewardsToClaim(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnMissionRewardsOpenFailed (Underlying native function: HandleOnMissionRewardsOpenFailed 0x7244d6c)
	void HandleOnMissionRewardsOpenFailed(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnMissionRewardsOpened (Underlying native function: HandleOnMissionRewardsOpened 0x7244d80)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnMissionAlertRewardsOpened (Underlying native function: HandleOnMissionAlertRewardsOpened 0x7244d80)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnItemCacheRewardsClaimFailed (Underlying native function: HandleOnItemCacheRewardsClaimFailed 0x7244d6c)
	void HandleOnItemCacheRewardsClaimFailed(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnItemCacheRewardsClaimed (Underlying native function: HandleOnItemCacheRewardsClaimed 0x7244d80)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnDifficultyIncreaseRewardsClaimFailed (Underlying native function: HandleOnDifficultyIncreaseRewardsClaimFailed 0x7244d6c)
	void HandleOnDifficultyIncreaseRewardsClaimFailed(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnDifficultyIncreaseRewardsClaimed (Underlying native function: HandleOnDifficultyIncreaseRewardsClaimed 0x7244d80)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.HandleOnCollectionBookRewardClaimed (Underlying native function: HandleOnCollectionBookRewardClaimed 0x7244bd8)
	...
	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.BeginCloseRewardsScreen (Underlying native function: BeginCloseRewardsScreen 0x7242e98)
	void BeginCloseRewardsScreen(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddQuestData (Underlying native function: AddQuestData 0x7242da4)
	void AddQuestData(class UFortQuestItem*& Quest); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddPhoenixLevelUpRewardData (Underlying native function: AddPhoenixLevelUpRewardData 0x7242d90)
	void AddPhoenixLevelUpRewardData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddMissionData (Underlying native function: AddMissionData 0x7242d1c)
	void AddMissionData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddMissionAlertData (Underlying native function: AddMissionAlertData 0x7242ca8)
	void AddMissionAlertData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddItemCacheRewardData (Underlying native function: AddItemCacheRewardData 0x7242bf0)
	void AddItemCacheRewardData(class UFortItem*& ItemCache); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddGiftBoxData (Underlying native function: AddGiftBoxData 0x7242a20)
	void AddGiftBoxData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddExpeditionData (Underlying native function: AddExpeditionData 0x7242968)
	void AddExpeditionData(class UFortExpeditionItem*& ExpeditionItem); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddEpicQuestData (Underlying native function: AddEpicQuestData 0x72428b0)
	void AddEpicQuestData(class UFortQuestItem*& Quest); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddDifficultyIncreaseRewardData (Underlying native function: AddDifficultyIncreaseRewardData 0x724283c)
	void AddDifficultyIncreaseRewardData(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardNotificationWidget.AddCollectionBookData (Underlying native function: AddCollectionBookData 0x724271c)
