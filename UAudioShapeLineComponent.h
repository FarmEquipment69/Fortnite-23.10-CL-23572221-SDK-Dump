...
class UAudioShapeLineComponent : public UAudioShapePrimitiveComponent
{
	...
	// Function /Script/AudioShapes.AudioShapeLineComponent.SetStartPoint (Underlying native function: SetStartPoint 0x7b040d8)
	void SetStartPoint(struct FVector& InStartPoint); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/AudioShapes.AudioShapeLineComponent.SetEndPoint (Underlying native function: SetEndPoint 0x7b03f28)
