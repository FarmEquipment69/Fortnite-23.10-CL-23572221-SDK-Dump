...
class AAttachableWheel : public AActor
{
	...
	// Function /Script/AttachableWheelsRuntime.AttachableWheel.OnRep_AttachData (Underlying native function: OnRep_AttachData 0x7cd0db4)
	void OnRepAttachData(struct FAttachableWheelAttachData& AttachDataPrev); // (Final | Native | Protected | HasOutParms)

	// Function /Script/AttachableWheelsRuntime.AttachableWheel.OnPhysicsStateChanged (Underlying native function: OnPhysicsStateChanged 0x7cd0cf0)
	...
	// Function /Script/AttachableWheelsRuntime.AttachableWheel.GetWorldSpaceAttachData (Underlying native function: GetWorldSpaceAttachData 0x7cd0ac0)
	...
	// Function /Script/AttachableWheelsRuntime.AttachableWheel.GetAttachedComponent (Underlying native function: GetAttachedComponent 0x7cd077c)
	class UPrimitiveComponent* GetAttachedComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AttachableWheelsRuntime.AttachableWheel.DrawDebug (Underlying native function: DrawDebug 0x273fd14)
	void DrawDebug(); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/AttachableWheelsRuntime.AttachableWheel.DetachFrom (Underlying native function: DetachFrom 0x7cd0688)
	bool DetachFrom(class UPrimitiveComponent*& InComponent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AttachableWheelsRuntime.AttachableWheel.Detach (Underlying native function: Detach 0x7cd05e4)
	void Detach(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AttachableWheelsRuntime.AttachableWheel.AttachTo (Underlying native function: AttachTo 0x7cd04bc)
	...
	// Function /Script/AttachableWheelsRuntime.AttachableWheel.AttachInPlace (Underlying native function: AttachInPlace 0x7cd042c)
