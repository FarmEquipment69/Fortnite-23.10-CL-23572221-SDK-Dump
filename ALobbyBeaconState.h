...
class ALobbyBeaconState : public AInfo
{
	...
	// Function /Script/Lobby.LobbyBeaconState.OnRep_WaitForPlayersTimeRemaining (Underlying native function: OnRep_WaitForPlayersTimeRemaining 0x6a44c84)
	void OnRepWaitForPlayersTimeRemaining(); // (Final | Native | Protected)

	// Function /Script/Lobby.LobbyBeaconState.OnRep_LobbyStarted (Underlying native function: OnRep_LobbyStarted 0x6a44be8)
