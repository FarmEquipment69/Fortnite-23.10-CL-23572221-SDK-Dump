...
class UFortEditNicknameButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortEditNicknameButton.SetKeyboardFocusOnEditableText (Underlying native function: SetKeyboardFocusOnEditableText 0xa6177e4)
	void SetKeyboardFocusOnEditableText(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortEditNicknameButton.HandleNicknameTextCommited (Underlying native function: HandleNicknameTextCommited 0xa61743c)
	...
	// Function /Script/FortniteUI.FortEditNicknameButton.HandleNicknameTextChanged (Underlying native function: HandleNicknameTextChanged 0x206e4e0)
