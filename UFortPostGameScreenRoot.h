...
class UFortPostGameScreenRoot : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortPostGameScreenRoot.HandleXPScreenFinished (Underlying native function: HandleXPScreenFinished 0xa3a1b24)
	void HandleXPScreenFinished(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPostGameScreenRoot.HandleRecoverFromPostGame (Underlying native function: HandleRecoverFromPostGame 0xa3a12d8)
