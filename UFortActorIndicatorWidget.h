...
class UFortActorIndicatorWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortActorIndicatorWidget.SetIndicatedActor (Underlying native function: SetIndicatedActor 0x71e8038)
	...
	// Function /Script/FortniteUI.FortActorIndicatorWidget.IsIndicatingActor (Underlying native function: IsIndicatingActor 0xa55bf88)
	bool IsIndicatingActor(class AActor*& OtherActor); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActorIndicatorWidget.Init (Underlying native function: Init 0xa55bf04)
	void Init(class AActor*& TargetedActor); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActorIndicatorWidget.Deinit (Underlying native function: Deinit 0xa559a94)
