...
class AFortLobbyBeaconClientRM : public AFortLobbyBeaconClient
{
	...
	// Function /Script/FortniteGame.FortLobbyBeaconClientRM.UpdateNewlyJoinedPlayer (Underlying native function: UpdateNewlyJoinedPlayer 0x8ce9f44)
	void UpdateNewlyJoinedPlayer(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortLobbyBeaconClientRM.SetLocalReadyStatus (Underlying native function: SetLocalReadyStatus 0x8ce990c)
	void SetLocalReadyStatus(bool& bIsReady); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortLobbyBeaconClientRM.ServerUpdateReadyStatus (Underlying native function: ServerUpdateReadyStatus 0x8ce953c)
	void ServerUpdateReadyStatus(bool& bIsReady); // (Net | NetReliable | Native | Event | Protected | NetServer | 0x80000000)

	// Function /Script/FortniteGame.FortLobbyBeaconClientRM.ServerUpdateNewlyJoinedPlayerInternal (Underlying native function: ServerUpdateNewlyJoinedPlayerInternal 0x8ce94f0)
	void ServerUpdateNewlyJoinedPlayerInternal(); // (Net | NetReliable | Native | Event | Protected | NetServer | 0x80000000)

	// Function /Script/FortniteGame.FortLobbyBeaconClientRM.ClientBroadcastLobbyPlayerPadTop (Underlying native function: ClientBroadcastLobbyPlayerPadTop 0x8ce57e0)
