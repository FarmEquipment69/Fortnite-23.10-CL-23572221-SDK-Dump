...
class UFortLoadingVideoPlayer : public UObject
{
	...
	// Function /Script/FortniteUI.FortLoadingVideoPlayer.RequestSuccess (Underlying native function: RequestSuccess 0xa5b1f70)
	void RequestSuccess(struct FString& URL); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLoadingVideoPlayer.RequestFailure (Underlying native function: RequestFailure 0xa5b1d70)
	void RequestFailure(struct FString& URL); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLoadingVideoPlayer.GetMediaTexture (Underlying native function: GetMediaTexture 0x735bee4)
	class UMediaTexture* GetMediaTexture(); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortLoadingVideoPlayer.GetMediaPlayer (Underlying native function: GetMediaPlayer 0x87f50ac)
