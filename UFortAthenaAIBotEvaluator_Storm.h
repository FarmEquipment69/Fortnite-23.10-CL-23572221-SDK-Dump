...
class UFortAthenaAIBotEvaluator_Storm : public UFortAthenaAIBotEvaluator_Movement
{
	...
	// Function /Script/FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafezoneStateChanged (Underlying native function: OnSafezoneStateChanged 0xa1d5aec)
	void OnSafezoneStateChanged(enum EFortSafeZoneState& NewState); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafeZonePhaseChanged (Underlying native function: OnSafeZonePhaseChanged 0xa1d5ad8)
