...
class UCustomCharacterPartAnimInstance_Whiff_Cape : public UCustomCharacterPartAnimInstance
{
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Whiff_Cape.SetCompLinearScaleForSkydiving (Underlying native function: SetCompLinearScaleForSkydiving 0x85cb4f8)
	void SetCompLinearScaleForSkydiving(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Whiff_Cape.CollectWindVector (Underlying native function: CollectWindVector 0x85caae8)
	void CollectWindVector(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Whiff_Cape.CollectFinalWindGravity (Underlying native function: CollectFinalWindGravity 0x85caad4)
	void CollectFinalWindGravity(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Whiff_Cape.CalculateDanceGravity (Underlying native function: CalculateDanceGravity 0x85ca9f0)
