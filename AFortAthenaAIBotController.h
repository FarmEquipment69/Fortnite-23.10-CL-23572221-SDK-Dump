...
class AFortAthenaAIBotController : public AAIController
{
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.UpdateLeashActorToFollowLocation (Underlying native function: UpdateLeashActorToFollowLocation 0xa0dd748)
	void UpdateLeashActorToFollowLocation(); // (Final | Native | Protected)

	// Function /Script/FortniteAI.FortAthenaAIBotController.ThankBusDriver (Underlying native function: ThankBusDriver 0xa0dd734)
	void ThankBusDriver(); // (Final | Native | Protected)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SwitchTeam (Underlying native function: SwitchTeam 0xa0dd4b4)
	void SwitchTeam(unsigned char& TeamIndex); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.StopSecondaryFire (Underlying native function: StopSecondaryFire 0xa0dd3e0)
	void StopSecondaryFire(bool& bFireWhenStopping); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.StopFire (Underlying native function: StopFire 0xa0dd3cc)
	void StopFire(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.StopEmote (Underlying native function: StopEmote 0xa0dd3b8)
	void StopEmote(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.StartSecondaryFire (Underlying native function: StartSecondaryFire 0xa0dd328)
	void StartSecondaryFire(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.StartFire (Underlying native function: StartFire 0xa0dd314)
	void StartFire(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SetSkillSet (Underlying native function: SetSkillSet 0xa0dce20)
	void SetSkillSet(class UClass*& SkillSetClass); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SetRadialLeashOuterRadius (Underlying native function: SetRadialLeashOuterRadius 0xa0dcd9c)
	void SetRadialLeashOuterRadius(float& OuterRadius); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SetRadialLeashInnerRadius (Underlying native function: SetRadialLeashInnerRadius 0xa0dcd18)
	void SetRadialLeashInnerRadius(float& InnerRadius); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SetPatrollingEnable (Underlying native function: SetPatrollingEnable 0xa0dcc98)
	void SetPatrollingEnable(bool& bEnable); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.SetLeashVolume (Underlying native function: SetLeashVolume 0xa0dcbfc)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.SetLeashReturnLocationMode (Underlying native function: SetLeashReturnLocationMode 0xa0dcb80)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.SetLeashActorToFollow (Underlying native function: SetLeashActorToFollow 0xa0dca70)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.SetBotOwner (Underlying native function: SetBotOwner 0xa0dc688)
	void SetBotOwner(class AActor*& InBotOwner); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.RequestEmote (Underlying native function: RequestEmote 0xa0dc530)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.RemoveSkillSet (Underlying native function: RemoveSkillSet 0xa0dc340)
	void RemoveSkillSet(class UClass*& SkillSetClass); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.RemoveEmoteRequest (Underlying native function: RemoveEmoteRequest 0xa0dbe40)
	void RemoveEmoteRequest(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.ReleaseBuildTool (Underlying native function: ReleaseBuildTool 0xa0dbe2c)
	void ReleaseBuildTool(); // (Final | Native | Protected)

	// Function /Script/FortniteAI.FortAthenaAIBotController.QueueStim (Underlying native function: QueueStim 0xa0dbc38)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.PlayEmote (Underlying native function: PlayEmote 0xa0dbb88)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OverrideSkill (Underlying native function: OverrideSkill 0xa0dbb04)
	void OverrideSkill(float& NewSkill); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OverrideAggressivenessPlayStyle (Underlying native function: OverrideAggressivenessPlayStyle 0xa0dba78)
	void OverrideAggressivenessPlayStyle(bool& bInIsAggressive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnTargetPawnDestroyed (Underlying native function: OnTargetPawnDestroyed 0xa0dba64)
	void OnTargetPawnDestroyed(); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnTargetPawnDead (Underlying native function: OnTargetPawnDead 0xa0db9e4)
	void OnTargetPawnDead(class AFortPawn*& FortPawn); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnTargetPawnDamaged (Underlying native function: OnTargetPawnDamaged 0xa0db7c0)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnTargetBuildingDestroyed (Underlying native function: OnTargetBuildingDestroyed 0xa0db6fc)
	void OnTargetBuildingDestroyed(class ABuildingActor*& Building, class AAthenaAIController*& AIController); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnTargetActorDestroyed (Underlying native function: OnTargetActorDestroyed 0xa0db67c)
	void OnTargetActorDestroyed(class AActor*& DestroyedActor); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnServerMarkerAdded (Underlying native function: OnServerMarkerAdded 0xa0db5c8)
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnSafeZoneUpdated (Underlying native function: OnSafeZoneUpdated 0xa0db534)
	void OnSafeZoneUpdated(); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnSafezoneStateChanged (Underlying native function: OnSafezoneStateChanged 0xa0db548)
	void OnSafezoneStateChanged(enum EFortSafeZoneState& NewState); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnPossessedPawnReceiveDamage (Underlying native function: OnPossessedPawnReceiveDamage 0xa0db238)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnPossesedPawnDied (Underlying native function: OnPossesedPawnDied 0xa0db004)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnPerceptionSensed (Underlying native function: OnPerceptionSensed 0xa0daf14)
	void OnPerceptionSensed(class AActor*& SourceActor, struct FAIStimulus& Stim); // (Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnPawnWeaponChanged (Underlying native function: OnPawnWeaponChanged 0xa0dae50)
	void OnPawnWeaponChanged(class AFortWeapon*& NewWeapon, class AFortWeapon*& OldWeapon); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnPawnDidDamage (Underlying native function: OnPawnDidDamage 0xa0dabd4)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnMovementModeChange (Underlying native function: OnMovementModeChange 0xa0daa8c)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnLaunched (Underlying native function: OnLaunched 0xa0da970)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnKnockbacked (Underlying native function: OnKnockbacked 0xa0da8f0)
	void OnKnockbacked(struct FGameplayTag& KnockbackTypeTag); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0xa0da810)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0xa0da790)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnEndSpectating (Underlying native function: OnEndSpectating 0x6df70d4)
	void OnEndSpectating(class AFortPlayerStateZone*& Spectator); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.OnCurrentHarvestableDestroyed (Underlying native function: OnCurrentHarvestableDestroyed 0xa0da564)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnBeginSpectating (Underlying native function: OnBeginSpectating 0x6df70d4)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.OnAgentDBNO (Underlying native function: OnAgentDBNO 0xa0da49c)
	void OnAgentDBNO(class AFortPawn*& InPlayer, bool& bInIsDBNO); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAthenaAIBotController.NotifyPickupsSpawnedOnDeath (Underlying native function: NotifyPickupsSpawnedOnDeath 0xa0da2f4)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.IsAnAthenaGameParticipant (Underlying native function: IsAnAthenaGameParticipant 0xa0d8f04)
	bool IsAnAthenaGameParticipant(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAIBotController.GetMarkerComponent (Underlying native function: GetMarkerComponent 0xa0d8d84)
	class UAthenaMarkerComponent* GetMarkerComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAIBotController.GetCurrentThreat (Underlying native function: GetCurrentThreat 0xa0d8cb8)
	class AActor* GetCurrentThreat(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAIBotController.GetBotOwner (Underlying native function: GetBotOwner 0xa0d8ca0)
	class AActor* GetBotOwner(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAIBotController.EquipWeaponByTag (Underlying native function: EquipWeaponByTag 0xa0d8b18)
	class AFortWeapon* EquipWeaponByTag(struct FGameplayTag& WeaponTag); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.EquipWeapon (Underlying native function: EquipWeapon 0xa0d8a88)
	class AFortWeapon* EquipWeapon(class UFortWorldItem*& Weapon); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.EquipMeleeWeapon (Underlying native function: EquipMeleeWeapon 0xa0d89f0)
	class AFortWeapon* EquipMeleeWeapon(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.EquipBestWeapon (Underlying native function: EquipBestWeapon 0xa0d89cc)
	class AFortWeapon* EquipBestWeapon(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotController.Cheat_ForceAthenaCosmeticItemInSlot (Underlying native function: Cheat_ForceAthenaCosmeticItemInSlot 0xa0d84c0)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.Cheat_ClearForcedCosmeticItems (Underlying native function: Cheat_ClearForcedCosmeticItems 0xa0d8474)
	void CheatClearForcedCosmeticItems(); // (Net | NetReliable | Native | Event | Public | NetServer | 0x80000000)

	// Function /Script/FortniteAI.FortAthenaAIBotController.ChangeActiveVariantForCosmeticItem (Underlying native function: ChangeActiveVariantForCosmeticItem 0xa0d837c)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.AddTargetInfos (Underlying native function: AddTargetInfos 0xa0d8144)
	...
	// Function /Script/FortniteAI.FortAthenaAIBotController.AddTargetInfo (Underlying native function: AddTargetInfo 0xa0d7fac)
