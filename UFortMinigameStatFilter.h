...
class UFortMinigameStatFilter : public UObject
{
	...
	// Function /Script/FortniteGame.FortMinigameStatFilter.Matches (Underlying native function: Matches 0x88c72a4)
	...
	// Function /Script/FortniteGame.FortMinigameStatFilter.FormatStat (Underlying native function: FormatStat 0x88c32c8)
	struct FText FormatStat(int& InCount); // (Native | Event | Public | BlueprintEvent | Const)

	// Function /Script/FortniteGame.FortMinigameStatFilter.Compare (Underlying native function: Compare 0x88c26c0)
	...
	// Function /Script/FortniteGame.FortMinigameStatFilter.Accumulate (Underlying native function: Accumulate 0x88c088c)
