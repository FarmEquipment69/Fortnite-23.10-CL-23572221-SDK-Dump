...
class AWarEffortMeshActor : public AInfo
{
	...
	// Function /Script/CorruptionGameplayCodeRuntime.WarEffortMeshActor.OnRep_CurrentFundingData (Underlying native function: OnRep_CurrentFundingData 0x6f193ac)
	void OnRepCurrentFundingData(); // (Final | Native | Protected)

	// Function /Script/CorruptionGameplayCodeRuntime.WarEffortMeshActor.OnRep_ActiveTryBeforeYouBuyItems (Underlying native function: OnRep_ActiveTryBeforeYouBuyItems 0x6f19398)
	void OnRepActiveTryBeforeYouBuyItems(); // (Final | Native | Protected)

	// Function /Script/CorruptionGameplayCodeRuntime.WarEffortMeshActor.OnRep_ActiveFundedItems (Underlying native function: OnRep_ActiveFundedItems 0x6f19384)
