...
class UFortCampaignHeroLoadoutItemDefinition : public UFortProfileItemDefinition
{
	...
	// Function /Script/FortniteGame.FortCampaignHeroLoadoutItemDefinition.GetSlots (Underlying native function: GetSlots 0x8ce85cc)
	struct TArray<struct FFortCrewSlotInformation> GetSlots(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCampaignHeroLoadoutItemDefinition.GetSlotIndexByName (Underlying native function: GetSlotIndexByName 0x8ce8534)
	int GetSlotIndexByName(struct FName& SlotName); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCampaignHeroLoadoutItemDefinition.GetCommanderSlot (Underlying native function: GetCommanderSlot 0x8ce6fd0)
