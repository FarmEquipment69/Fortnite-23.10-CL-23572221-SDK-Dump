...
class UAmbientAudioSubsystem : public UWorldSubsystem
{
	...
	// Function /Script/AmbientAudio.AmbientAudioSubsystem.RemoveGameplayTag (Underlying native function: RemoveGameplayTag 0x119e06c)
	void RemoveGameplayTag(struct FGameplayTag& GameplayTag); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioSubsystem.RemoveAmbientEntry (Underlying native function: RemoveAmbientEntry 0x26f088c)
	void RemoveAmbientEntry(struct FName& AmbientName, float& CrossfadeOverride); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioSubsystem.GetAudioParameterComponent (Underlying native function: GetAudioParameterComponent 0x70ca9ec)
	class UAudioParameterComponent* GetAudioParameterComponent(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioSubsystem.AddGameplayTag (Underlying native function: AddGameplayTag 0x70ca96c)
	void AddGameplayTag(struct FGameplayTag& GameplayTag); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioSubsystem.AddAmbientEntry (Underlying native function: AddAmbientEntry 0x2492494)
