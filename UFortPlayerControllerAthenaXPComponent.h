...
class UFortPlayerControllerAthenaXPComponent : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.ServerUpdateCurrentLevel (Underlying native function: ServerUpdateCurrentLevel 0x814143c)
	void ServerUpdateCurrentLevel(int& NewCurrentLevel); // (Final | Net | Native | Event | Private | NetServer)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnXpUpdated (Underlying native function: OnXpUpdated 0x8140f28)
	...
	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnXPEvent (Underlying native function: OnXPEvent 0x8140e84)
	void OnXPEvent(struct FXPEventInfo& XPEvent); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnRep_InMatchProfileVer (Underlying native function: OnRep_InMatchProfileVer 0x8140d4c)
	void OnRepInMatchProfileVer(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnRep_HasBRMatchReportCompletedProfileVer (Underlying native function: OnRep_HasBRMatchReportCompletedProfileVer 0x8140cbc)
	void OnRepHasBRMatchReportCompletedProfileVer(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnRep_bRegisteredWithQuestManager (Underlying native function: OnRep_bRegisteredWithQuestManager 0x8140e70)
	void OnRepbRegisteredWithQuestManager(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnProfileUpdated (Underlying native function: OnProfileUpdated 0x8140ca8)
	void OnProfileUpdated(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnInMatchProfileUpdate (Underlying native function: OnInMatchProfileUpdate 0x8140adc)
	void OnInMatchProfileUpdate(int64_t& ProfileRevision); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.InitRestedXp (Underlying native function: InitRestedXp 0x8140804)
	void InitRestedXp(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.ClientQuestsUpdated (Underlying native function: ClientQuestsUpdated 0x81402dc)
	...
	// Function /Script/FortniteGame.FortPlayerControllerAthenaXPComponent.ClientMedalsRecived (Underlying native function: ClientMedalsRecived 0x8140228)
