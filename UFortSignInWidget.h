...
class UFortSignInWidget : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/FortniteUI.FortSignInWidget.UpdateSignInButton (Underlying native function: UpdateSignInButton 0x1cf5194)
	void UpdateSignInButton(struct FText& Text); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.FortSignInWidget.HandleTextCommitted (Underlying native function: HandleTextCommitted 0x2793b30)
