...
class UFilterVolumeComponent : public UAudioGameplayVolumeMutator
{
	...
	// Function /Script/AudioGameplayVolume.FilterVolumeComponent.SetInteriorLPF (Underlying native function: SetInteriorLPF 0x7b0664c)
	void SetInteriorLPF(float& Volume, float& InterpolateTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF (Underlying native function: SetExteriorLPF 0x7b06578)
