...
class UFortCollisionResponseSwapperComponent : public UActorComponent
{
	...
	// Function /Script/FortniteAI.FortCollisionResponseSwapperComponent.UnregisterCallbacksForOverlap (Underlying native function: UnregisterCallbacksForOverlap 0xa233bcc)
	void UnregisterCallbacksForOverlap(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteAI.FortCollisionResponseSwapperComponent.RestoreCollisionResponses (Underlying native function: RestoreCollisionResponses 0xa233ac8)
	void RestoreCollisionResponses(); // (Final | Native | Protected)

	// Function /Script/FortniteAI.FortCollisionResponseSwapperComponent.RegisterCallbacksForOverlap (Underlying native function: RegisterCallbacksForOverlap 0xa2332b8)
	...
	// Function /Script/FortniteAI.FortCollisionResponseSwapperComponent.HandleEndOverlap (Underlying native function: HandleEndOverlap 0xa2318c4)
	...
	// Function /Script/FortniteAI.FortCollisionResponseSwapperComponent.HandleBeginOverlap (Underlying native function: HandleBeginOverlap 0xa23167c)
