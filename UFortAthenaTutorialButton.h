...
class UFortAthenaTutorialButton : public UFortAthenaTutorialBaseInteraction
{
	...
	// Function /Script/FortniteUI.FortAthenaTutorialButton.OnTutorialButtonPressed (Underlying native function: OnTutorialButtonPressed 0xa85b574)
	void OnTutorialButtonPressed(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaTutorialButton.OnTutorialButtonClicked (Underlying native function: OnTutorialButtonClicked 0xa85b548)
