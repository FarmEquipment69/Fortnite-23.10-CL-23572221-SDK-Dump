...
class AWorldDataLayers : public AInfo
{
	...
	// Function /Script/Engine.WorldDataLayers.OnRep_LoadedDataLayerNames (Underlying native function: OnRep_LoadedDataLayerNames 0x9e25350)
	void OnRepLoadedDataLayerNames(); // (Final | Native | Protected)

	// Function /Script/Engine.WorldDataLayers.OnRep_EffectiveLoadedDataLayerNames (Underlying native function: OnRep_EffectiveLoadedDataLayerNames 0x9e252e4)
	void OnRepEffectiveLoadedDataLayerNames(); // (Final | Native | Protected)

	// Function /Script/Engine.WorldDataLayers.OnRep_EffectiveActiveDataLayerNames (Underlying native function: OnRep_EffectiveActiveDataLayerNames 0x187169c)
	void OnRepEffectiveActiveDataLayerNames(); // (Final | Native | Protected)

	// Function /Script/Engine.WorldDataLayers.OnRep_ActiveDataLayerNames (Underlying native function: OnRep_ActiveDataLayerNames 0x2d81f1c)
	void OnRepActiveDataLayerNames(); // (Final | Native | Protected)

	// Function /Script/Engine.WorldDataLayers.OnDataLayerRuntimeStateChanged (Underlying native function: OnDataLayerRuntimeStateChanged 0x2934508)
