...
class UFortHeroType : public UFortWorkerType
{
	...
	// Function /Script/FortniteGame.FortHeroType.GetSubType (Underlying native function: GetSubType 0x8cbb6d4)
	struct FText GetSubType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortHeroType.GetSpecializations (Underlying native function: GetSpecializations 0x8cbb224)
	...
	// Function /Script/FortniteGame.FortHeroType.GetHeroGameplayDefinition (Underlying native function: GetHeroGameplayDefinition 0x8cb99c0)
	...
	// Function /Script/FortniteGame.FortHeroType.GetFrontendAnimMontageIdleOverride (Underlying native function: GetFrontendAnimMontageIdleOverride 0x8cb9838)
	class UAnimMontage* GetFrontendAnimMontageIdleOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortHeroType.GetFrontendAnimClass (Underlying native function: GetFrontendAnimClass 0x8cb9800)
