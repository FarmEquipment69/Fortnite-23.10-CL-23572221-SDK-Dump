...
class UFortPostGameNewQuestsWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.PlayNextNewQuestsBatch (Underlying native function: PlayNextNewQuestsBatch 0xa3a1d28)
	void PlayNextNewQuestsBatch(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.PlayNewQuestUpdates (Underlying native function: PlayNewQuestUpdates 0xa3a1d14)
	...
	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestUpdatesDelayTimerExpired (Underlying native function: HandlePlayNewQuestUpdatesDelayTimerExpired 0xa3a0f3c)
	void HandlePlayNewQuestUpdatesDelayTimerExpired(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestsIntroAnimFinished (Underlying native function: HandlePlayNewQuestsIntroAnimFinished 0xa3a0fb0)
	void HandlePlayNewQuestsIntroAnimFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestsEntryBoxTimerFinished (Underlying native function: HandlePlayNewQuestsEntryBoxTimerFinished 0xa3a0f9c)
	void HandlePlayNewQuestsEntryBoxTimerFinished(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestsEntryBoxOutroAnimFinished (Underlying native function: HandlePlayNewQuestsEntryBoxOutroAnimFinished 0xa3a0f80)
	void HandlePlayNewQuestsEntryBoxOutroAnimFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestsEntryBoxIntroFinished (Underlying native function: HandlePlayNewQuestsEntryBoxIntroFinished 0xa3a0f6c)
	void HandlePlayNewQuestsEntryBoxIntroFinished(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPostGameNewQuestsWidget.HandlePlayNewQuestsEntryBoxIntroAnimFinished (Underlying native function: HandlePlayNewQuestsEntryBoxIntroAnimFinished 0xa3a0f50)
