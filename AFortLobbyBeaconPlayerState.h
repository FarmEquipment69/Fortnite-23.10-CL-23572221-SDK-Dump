...
class AFortLobbyBeaconPlayerState : public ALobbyBeaconPlayerState
{
	...
	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_LobbyTimeRemaining (Underlying native function: OnRep_LobbyTimeRemaining 0x2466474)
	void OnRepLobbyTimeRemaining(); // (Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_HomeBaseVersion (Underlying native function: OnRep_HomeBaseVersion 0x89ab61c)
	void OnRepHomeBaseVersion(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_HeroType (Underlying native function: OnRep_HeroType 0x6a44bb0)
	void OnRepHeroType(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_HeroID (Underlying native function: OnRep_HeroID 0x6a44bb0)
	void OnRepHeroID(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_Gadgets (Underlying native function: OnRep_Gadgets 0x6a44bb0)
	void OnRepGadgets(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_CosmeticLoadout (Underlying native function: OnRep_CosmeticLoadout 0x6a44bb0)
	void OnRepCosmeticLoadout(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_ConsoleUniqueNetId (Underlying native function: OnRep_ConsoleUniqueNetId 0x89ab5dc)
	void OnRepConsoleUniqueNetId(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_CharXP (Underlying native function: OnRep_CharXP 0x6a44bb0)
	void OnRepCharXP(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconPlayerState.OnRep_CharacterGender (Underlying native function: OnRep_CharacterGender 0x6a44bb0)
