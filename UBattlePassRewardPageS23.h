...
class UBattlePassRewardPageS23 : public UBattlePassRewardPageBase
{
	...
	// Function /Script/BattlePassS23UI.BattlePassRewardPageS23.HandleRewardTracksBoundaryNavigation (Underlying native function: HandleRewardTracksBoundaryNavigation 0x6ed28f8)
	class UWidget* HandleRewardTracksBoundaryNavigation(enum EUINavigation& InNavigation); // (Final | Native | Private)

	// Function /Script/BattlePassS23UI.BattlePassRewardPageS23.GetRewardPageBackgroundData (Underlying native function: GetRewardPageBackgroundData 0x1ce4398)
