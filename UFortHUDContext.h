...
class UFortHUDContext : public UBlueprintContextBase
{
	...
	// Function /Script/FortniteUI.FortHUDContext.UpdateTrapAttachedToBuilding (Underlying native function: UpdateTrapAttachedToBuilding 0xa4d7cc4)
	void UpdateTrapAttachedToBuilding(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.TriggerCooldownUpdate (Underlying native function: TriggerCooldownUpdate 0xa4d7908)
	void TriggerCooldownUpdate(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.ToggleFullScreenMap (Underlying native function: ToggleFullScreenMap 0xa4d78dc)
	void ToggleFullScreenMap(); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteUI.FortHUDContext.ShowAerialFeedback (Underlying native function: ShowAerialFeedback 0xa4d7254)
	...
	// Function /Script/FortniteUI.FortHUDContext.ShouldOnlyShowNextPrevBuildingSlotKeybinds (Underlying native function: ShouldOnlyShowNextPrevBuildingSlotKeybinds 0xa4d71c4)
	bool ShouldOnlyShowNextPrevBuildingSlotKeybinds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.SetPreparingMgmtMenu (Underlying native function: SetPreparingMgmtMenu 0xa4d700c)
	void SetPreparingMgmtMenu(bool& bPreparing); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SetIsLocalChallengesVisible (Underlying native function: SetIsLocalChallengesVisible 0xa4d6f78)
	void SetIsLocalChallengesVisible(bool& bIsVisible); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SetIndicatorsState (Underlying native function: SetIndicatorsState 0xa4d6ef8)
	void SetIndicatorsState(enum EFortIndicatorState& NewState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SetIndicatorsAllowed (Underlying native function: SetIndicatorsAllowed 0xa4d6e7c)
	void SetIndicatorsAllowed(bool& bIndicatorsAllowed); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SetHUDElementVisibility (Underlying native function: SetHUDElementVisibility 0x2507038)
	void SetHUDElementVisibility(struct FGameplayTagContainer& HUDElementTags, bool& bHideElements); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SetCursorModeLocked (Underlying native function: SetCursorModeLocked 0xa4d6c68)
	void SetCursorModeLocked(bool& bLocked); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.SendFocusedBuildingDynamicData (Underlying native function: SendFocusedBuildingDynamicData 0xa4d67e8)
	...
	// Function /Script/FortniteUI.FortHUDContext.RequestPromptDisplay (Underlying native function: RequestPromptDisplay 0xa4d5f5c)
	...
	// Function /Script/FortniteUI.FortHUDContext.RequestMgmtMenuTab (Underlying native function: RequestMgmtMenuTab 0xa4d5edc)
	void RequestMgmtMenuTab(struct FName& TabName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.RemovePointOfInterest (Underlying native function: RemovePointOfInterest 0xa4d5e4c)
	void RemovePointOfInterest(class AActor*& PointOfInterest); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.PreviewItemPickUp (Underlying native function: PreviewItemPickUp 0xa4d58a0)
	...
	// Function /Script/FortniteUI.FortHUDContext.IsPreparingMgmtMenu (Underlying native function: IsPreparingMgmtMenu 0xa4d528c)
	bool IsPreparingMgmtMenu(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.IsLocalChallengesVisible (Underlying native function: IsLocalChallengesVisible 0xa4d522c)
	bool IsLocalChallengesVisible(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.IsInEditMode (Underlying native function: IsInEditMode 0xa4d515c)
	bool IsInEditMode(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.IsInCursorMode (Underlying native function: IsInCursorMode 0x29aa4b8)
	bool IsInCursorMode(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.IsContextTutorialActive (Underlying native function: IsContextTutorialActive 0xa4d4ffc)
	bool IsContextTutorialActive(struct FGameplayTag& TutorialType); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.HideAerialFeedback (Underlying native function: HideAerialFeedback 0xa4d4d18)
	void HideAerialFeedback(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.HandleVehicleStateChanged (Underlying native function: HandleVehicleStateChanged 0xa4d48d0)
	...
	// Function /Script/FortniteUI.FortHUDContext.HandleUIGameplayCue (Underlying native function: HandleUIGameplayCue 0xa4d4720)
	...
	// Function /Script/FortniteUI.FortHUDContext.HandleToggledBattleMapLive (Underlying native function: HandleToggledBattleMapLive 0xa4d4690)
	void HandleToggledBattleMapLive(class ABattleMapPawnLive*& NewSpectatorPawn); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleSpectatorViewTargetChanged (Underlying native function: HandleSpectatorViewTargetChanged 0xa4d467c)
	void HandleSpectatorViewTargetChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandlePersonalVehicleModeChanged (Underlying native function: HandlePersonalVehicleModeChanged 0xa4d45ec)
	void HandlePersonalVehicleModeChanged(bool& bEnteredVehicle); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPlayerViewTargetChanged (Underlying native function: HandleLocalPlayerViewTargetChanged 0xa4d45d8)
	void HandleLocalPlayerViewTargetChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPlayerPlaceChanged (Underlying native function: HandleLocalPlayerPlaceChanged 0xa4d45bc)
	void HandleLocalPlayerPlaceChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPlayerKillsChanged (Underlying native function: HandleLocalPlayerKillsChanged 0xa4d45a0)
	void HandleLocalPlayerKillsChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPlayerBuildCostChanged (Underlying native function: HandleLocalPlayerBuildCostChanged 0xa4d4588)
	void HandleLocalPlayerBuildCostChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPawnSpawned (Underlying native function: HandleLocalPawnSpawned 0xa4d456c)
	void HandleLocalPawnSpawned(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPawnRevived (Underlying native function: HandleLocalPawnRevived 0xa4d44ec)
	void HandleLocalPawnRevived(class AController*& EventInstigator); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleLocalPawnDied (Underlying native function: HandleLocalPawnDied 0xa4d443c)
	void HandleLocalPawnDied(struct FFortPlayerDeathReport& DeathReport); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortHUDContext.HandleFocusedBuildingAbilitySystemComponentInitialized (Underlying native function: HandleFocusedBuildingAbilitySystemComponentInitialized 0x5cecf90)
	void HandleFocusedBuildingAbilitySystemComponentInitialized(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleBuildingModeChanged (Underlying native function: HandleBuildingModeChanged 0xa4d43ac)
	void HandleBuildingModeChanged(bool& bEntering); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.HandleActorFocusedForCreative (Underlying native function: HandleActorFocusedForCreative 0xa4d431c)
	void HandleActorFocusedForCreative(class AActor*& NewActor); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.GetTimeToDelayEndOfDayZoneWidgetDisplay (Underlying native function: GetTimeToDelayEndOfDayZoneWidgetDisplay 0xa4d3324)
	float GetTimeToDelayEndOfDayZoneWidgetDisplay(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetScoreDisplayFactor (Underlying native function: GetScoreDisplayFactor 0xa4d2de4)
	float GetScoreDisplayFactor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetPotentialBadges (Underlying native function: GetPotentialBadges 0xa4d253c)
	struct TArray<struct FFortBadgeCount> GetPotentialBadges(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetPlayerStateZone (Underlying native function: GetPlayerStateZone 0xa4d2518)
	class AFortPlayerStateZone* GetPlayerStateZone(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetNumAllowedDifficultyIncreases (Underlying native function: GetNumAllowedDifficultyIncreases 0xa4d1f8c)
	int GetNumAllowedDifficultyIncreases(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetMissionRewards (Underlying native function: GetMissionRewards 0xa4d1e78)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetMissionOverviewObjectives (Underlying native function: GetMissionOverviewObjectives 0xa4d1e3c)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetMissionManager (Underlying native function: GetMissionManager 0xa4d1e18)
	class AFortMissionManager* GetMissionManager(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetLocalPlayerPlacement (Underlying native function: GetLocalPlayerPlacement 0xa4d1d34)
	int GetLocalPlayerPlacement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetLocalPlayerHasWinningPlacement (Underlying native function: GetLocalPlayerHasWinningPlacement 0xa4d1d08)
	bool GetLocalPlayerHasWinningPlacement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetLocalPlayerHasPlacement (Underlying native function: GetLocalPlayerHasPlacement 0xa4d1ce4)
	bool GetLocalPlayerHasPlacement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetLocalPlayerHasLosingPlacement (Underlying native function: GetLocalPlayerHasLosingPlacement 0xa4d1cb8)
	bool GetLocalPlayerHasLosingPlacement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetIndicatorsState (Underlying native function: GetIndicatorsState 0xa4d1318)
	enum EFortIndicatorState GetIndicatorsState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetHUDElementWidgetsForTags (Underlying native function: GetHUDElementWidgetsForTags 0x5cecdf0)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetGameStateZone (Underlying native function: GetGameStateZone 0xa4d1184)
	class AFortGameStateZone* GetGameStateZone(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetFocusedMission (Underlying native function: GetFocusedMission 0xa4d113c)
	class AFortMission* GetFocusedMission(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetFocusedBuildingInfo (Underlying native function: GetFocusedBuildingInfo 0xa4d1060)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetEarnedBadges (Underlying native function: GetEarnedBadges 0xa4d0f28)
	struct TArray<struct FEarnedBadgeEntry> GetEarnedBadges(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetDifficultyIncreaseRewardsTier (Underlying native function: GetDifficultyIncreaseRewardsTier 0xa4d0f04)
	int GetDifficultyIncreaseRewardsTier(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetDifficultyIncreaseRewardsDifference (Underlying native function: GetDifficultyIncreaseRewardsDifference 0xa4d0d30)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetDifficultyIncreaseRewards (Underlying native function: GetDifficultyIncreaseRewards 0xa4d0b8c)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetCurrentPrimaryMissionTags (Underlying native function: GetCurrentPrimaryMissionTags 0xa4d0700)
	struct FGameplayTagContainer GetCurrentPrimaryMissionTags(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetCurrentHUDState (Underlying native function: GetCurrentHUDState 0x8a4867c)
	struct FFortHUDState GetCurrentHUDState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetCurrentHero (Underlying native function: GetCurrentHero 0xa4d05a4)
	class UFortHero* GetCurrentHero(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetCurrentFocusedBuilding (Underlying native function: GetCurrentFocusedBuilding 0xa4d0538)
	class ABuildingActor* GetCurrentFocusedBuilding(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetCurrentBasicMissionInfo (Underlying native function: GetCurrentBasicMissionInfo 0xa4d0488)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetBuildingActorInfo (Underlying native function: GetBuildingActorInfo 0xa4cf688)
	...
	// Function /Script/FortniteUI.FortHUDContext.GetBluGloManager (Underlying native function: GetBluGloManager 0xa4cf3c4)
	class AFortBluGloManager* GetBluGloManager(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.GetAccountLevelUpRewards (Underlying native function: GetAccountLevelUpRewards 0xa4ae2cc)
	...
	// Function /Script/FortniteUI.FortHUDContext.ForwardOnWeaponUnEquipped (Underlying native function: ForwardOnWeaponUnEquipped 0xa4ce924)
	void ForwardOnWeaponUnEquipped(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.ForwardOnWeaponHudKeyActionUpdated (Underlying native function: ForwardOnWeaponHudKeyActionUpdated 0xa4ce894)
	void ForwardOnWeaponHudKeyActionUpdated(class AFortWeapon*& Weapon); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.ForwardOnWeaponEquipped (Underlying native function: ForwardOnWeaponEquipped 0x1a11ae0)
	void ForwardOnWeaponEquipped(class AFortWeapon*& NewWeapon, class AFortWeapon*& PrevWeapon); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.ForwardOnNumSurvivorsRescuedChanged (Underlying native function: ForwardOnNumSurvivorsRescuedChanged 0xa4ce808)
	void ForwardOnNumSurvivorsRescuedChanged(int& NumSurvivorsRescued); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.ForwardOnMissionsUpdated (Underlying native function: ForwardOnMissionsUpdated 0xa4ce7ec)
	void ForwardOnMissionsUpdated(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.ForwardOnAbilityDecisionWindowStackUpdated (Underlying native function: ForwardOnAbilityDecisionWindowStackUpdated 0xa4ce7d0)
	void ForwardOnAbilityDecisionWindowStackUpdated(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDContext.EnterCursorMode (Underlying native function: EnterCursorMode 0xa4ce0e8)
	void EnterCursorMode(struct FName& ActionName, class UUserWidget*& CursorModeWidget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.EnterCameraMode (Underlying native function: EnterCameraMode 0xa4ce0d4)
	void EnterCameraMode(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHUDContext.AreIndicatorsEnabled (Underlying native function: AreIndicatorsEnabled 0xa4cc654)
	bool AreIndicatorsEnabled(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHUDContext.AreHUDElementsVisible (Underlying native function: AreHUDElementsVisible 0xa4cc58c)
	...
	// Function /Script/FortniteUI.FortHUDContext.AddPointOfInterest (Underlying native function: AddPointOfInterest 0xa4cc150)
