...
class ABuildingGameplayActorSentry : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingGameplayActorSentry.SetSentryState (Underlying native function: SetSentryState 0x8358924)
	...
	// Function /Script/FortniteGame.BuildingGameplayActorSentry.SetPawnBeingTracked (Underlying native function: SetPawnBeingTracked 0x83586a0)
	...
	// Function /Script/FortniteGame.BuildingGameplayActorSentry.OnRep_ExactIdleRotation (Underlying native function: OnRep_ExactIdleRotation 0x8357780)
	void OnRepExactIdleRotation(); // (Final | Native | Public)

	// Function /Script/FortniteGame.BuildingGameplayActorSentry.OnRep_CurrentSentryState (Underlying native function: OnRep_CurrentSentryState 0x8357704)
