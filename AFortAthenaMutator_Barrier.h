...
class AFortAthenaMutator_Barrier : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Barrier.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81d8d7c)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Barrier.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x81d8a2c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Barrier.CheckHealthThreshold (Underlying native function: CheckHealthThreshold 0x81d7074)
