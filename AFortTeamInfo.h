...
class AFortTeamInfo : public AInfo
{
	...
	// Function /Script/FortniteGame.FortTeamInfo.OnSpottedActorDied (Underlying native function: OnSpottedActorDied 0x877c014)
	...
	// Function /Script/FortniteGame.FortTeamInfo.GetTeamLevel (Underlying native function: GetTeamLevel 0x877b82c)
	int GetTeamLevel(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTeamInfo.GetTeamExperience (Underlying native function: GetTeamExperience 0x877b804)
