...
{
	class UImage* ImageTimer; // 0x290 (0x8)
	unsigned char padding_298[0x10]; // 0x298 (0x10)

	/* Functions */

	// Function /Script/FortniteUI.AthenaTeamMemberDBNOCountdown.SetPlayerState (Underlying native function: SetPlayerState 0x2427bf0)
