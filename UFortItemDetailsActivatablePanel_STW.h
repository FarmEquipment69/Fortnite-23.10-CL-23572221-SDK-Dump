...
class UFortItemDetailsActivatablePanel_STW : public UCommonActivatableWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortItemDetailsActivatablePanel_STW.HandleItemToDetailTooltipAssetsLoaded (Underlying native function: HandleItemToDetailTooltipAssetsLoaded 0x71cd504)
