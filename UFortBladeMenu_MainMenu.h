...
class UFortBladeMenu_MainMenu : public UFortBladeMenu
{
	...
	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.ViewPurchaseHistory (Underlying native function: ViewPurchaseHistory 0xa664de8)
	void ViewPurchaseHistory(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.TryPushWidgetAsModalPanel (Underlying native function: TryPushWidgetAsModalPanel 0xa69a32c)
	void TryPushWidgetAsModalPanel(class UUserWidget*& InWidget); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.TryPushWidgetAsActivatablePanel (Underlying native function: TryPushWidgetAsActivatablePanel 0xa69a1cc)
	...
	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.ShowConsoleWindow (Underlying native function: ShowConsoleWindow 0x273fd14)
	void ShowConsoleWindow(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.IsInCreative (Underlying native function: IsInCreative 0xa6992d8)
	bool IsInCreative(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortBladeMenu_MainMenu.HandleMatchmakingFlowChanged (Underlying native function: HandleMatchmakingFlowChanged 0xa698ee0)
