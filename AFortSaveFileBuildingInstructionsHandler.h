...
class AFortSaveFileBuildingInstructionsHandler : public AActor
{
	...
	// Function /Script/FortniteGame.FortSaveFileBuildingInstructionsHandler.SaveBuildings (Underlying native function: SaveBuildings 0x83d8aa0)
	bool SaveBuildings(class AFortPlayerController*& FortPC); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSaveFileBuildingInstructionsHandler.ResetBuildings (Underlying native function: ResetBuildings 0x83d8794)
	bool ResetBuildings(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSaveFileBuildingInstructionsHandler.LoadBuildings (Underlying native function: LoadBuildings 0x83d7d78)
	void LoadBuildings(class AFortPlayerController*& FortPC); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSaveFileBuildingInstructionsHandler.AreBuildingsLoaded (Underlying native function: AreBuildingsLoaded 0x83d5c58)
