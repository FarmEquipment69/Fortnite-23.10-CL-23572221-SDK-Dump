...
class ACreativeDataChannelTarget : public AElectraDataChannelTarget
{
	...
	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.TestCreativeDataChannelTarget (Underlying native function: TestCreativeDataChannelTarget 0x6f971c8)
	void TestCreativeDataChannelTarget(struct FCreativeDataChannelEvents& TestEvents); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.OnRep_Events (Underlying native function: OnRep_Events 0x273fd14)
