...
class UFortActivityBrowserRowHero : public UFortActivityBrowserRow
{
	...
	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.IsShowingSeasonalContent (Underlying native function: IsShowingSeasonalContent 0x7067fc0)
	bool IsShowingSeasonalContent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.IsInOutroState (Underlying native function: IsInOutroState 0x7067f30)
	bool IsInOutroState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.IsImageLoading (Underlying native function: IsImageLoading 0x66e2054)
	bool IsImageLoading(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.HandleActivityVideoCycleStarted (Underlying native function: HandleActivityVideoCycleStarted 0x7067bd0)
	void HandleActivityVideoCycleStarted(); // (Final | Native | Private)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.HandleActivityVideoCycleEndReached (Underlying native function: HandleActivityVideoCycleEndReached 0x7067b88)
	void HandleActivityVideoCycleEndReached(); // (Final | Native | Private)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.GetKeyArtOutroAnimation (Underlying native function: GetKeyArtOutroAnimation 0x7067ad0)
	class UWidgetAnimation* GetKeyArtOutroAnimation(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.GetCurrentTexture (Underlying native function: GetCurrentTexture 0x7067970)
	class UTexture* GetCurrentTexture(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.CycleNextActivity (Underlying native function: CycleNextActivity 0x70678c8)
	void CycleNextActivity(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRowHero.CheckUpdateDetailsDelay (Underlying native function: CheckUpdateDetailsDelay 0x70678a0)
