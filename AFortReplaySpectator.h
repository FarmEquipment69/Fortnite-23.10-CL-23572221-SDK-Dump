...
class AFortReplaySpectator : public AFortPlayerControllerSpectating
{
	...
	// Function /Script/FortniteGame.FortReplaySpectator.SkipToSequencerShot (Underlying native function: SkipToSequencerShot 0x8c2bd28)
	void SkipToSequencerShot(int& ShotIndex); // (Final | Exec | Native | Public | Const)

	// Function /Script/FortniteGame.FortReplaySpectator.SkipToNextSequencerShot (Underlying native function: SkipToNextSequencerShot 0x8c2bd00)
	void SkipToNextSequencerShot(); // (Final | Exec | Native | Public | Const)

	// Function /Script/FortniteGame.FortReplaySpectator.ShouldSetupUIForRecording (Underlying native function: ShouldSetupUIForRecording 0x8c2bb2c)
	bool ShouldSetupUIForRecording(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortReplaySpectator.SetTimeOfDaySpeed (Underlying native function: SetTimeOfDaySpeed 0x8c2b940)
	bool SetTimeOfDaySpeed(float& Speed); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortReplaySpectator.SetOverrideTimeOfDay (Underlying native function: SetOverrideTimeOfDay 0x8c2b34c)
	bool SetOverrideTimeOfDay(bool& bOverride, float& Time, bool& bImmediate, float& Speed); // (Final | 0x00000002 | Native | Public)

	// Function /Script/FortniteGame.FortReplaySpectator.SetCloudAltitudes (Underlying native function: SetCloudAltitudes 0x8c2b1f4)
	void SetCloudAltitudes(float& NewCloudAltitude); // (Final | Exec | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.SetAllowTimeDilation (Underlying native function: SetAllowTimeDilation 0x8c2b118)
	void SetAllowTimeDilation(bool& bAllow); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortReplaySpectator.SequencerLoadAndPlayFile (Underlying native function: SequencerLoadAndPlayFile 0x8c2af68)
	void SequencerLoadAndPlayFile(struct FString& SequenceFileName); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortReplaySpectator.PlayThroughHightlightReel (Underlying native function: PlayThroughHightlightReel 0x8c2abd0)
	...
	// Function /Script/FortniteGame.FortReplaySpectator.OnShotStartGotoTimeComplete (Underlying native function: OnShotStartGotoTimeComplete 0x8c2a780)
	void OnShotStartGotoTimeComplete(bool& bWasSuccessful); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.OnScrubComplete (Underlying native function: OnScrubComplete 0x8c2a700)
	void OnScrubComplete(bool& bWasSuccessful); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.OnReplayExtractionPreScrubComplete (Underlying native function: OnReplayExtractionPreScrubComplete 0x8c2a5ec)
	void OnReplayExtractionPreScrubComplete(bool& bWasSuccessful); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.OnPlayerStatePlacementChanged (Underlying native function: OnPlayerStatePlacementChanged 0x8c2a1ec)
	void OnPlayerStatePlacementChanged(class AFortPlayerStateAthena*& Sender, int& InPlace); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.OnPawnForReplayRelevancyChanged (Underlying native function: OnPawnForReplayRelevancyChanged 0x8c2a0e8)
	...
	// Function /Script/FortniteGame.FortReplaySpectator.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x2fd94f4)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortReplaySpectator.OnDemoScrubComplete (Underlying native function: OnDemoScrubComplete 0x8c29fd0)
	void OnDemoScrubComplete(bool& bWasSuccessful); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortReplaySpectator.HasPermissionToViewHighlights (Underlying native function: HasPermissionToViewHighlights 0x8c296d8)
	bool HasPermissionToViewHighlights(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortReplaySpectator.GetSequencerComponent (Underlying native function: GetSequencerComponent 0x8c28774)
	class UFortReplaySequenceComponent* GetSequencerComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortReplaySpectator.AreReplayGameHighlightsAvailable (Underlying native function: AreReplayGameHighlightsAvailable 0x8c27d80)
