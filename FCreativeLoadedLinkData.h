...
struct FCreativeLoadedLinkData
{
	...
	struct FDynamicXpAggregatedStats CreativeIslandXPStats; // 0x218 (0x68)
	struct FPublicDynamicXpStats* PublicCreativeIslandXPStats; // 0x280 (0x8)
	bool bActive; // 0x288 (0x1)
	unsigned char unreflected_289[0x7]; // 0x289 (0x7) 
	struct FString LinkMode; // 0x290 (0x10)
	struct FString PlaytestGroupId; // 0x2a0 (0x10)
