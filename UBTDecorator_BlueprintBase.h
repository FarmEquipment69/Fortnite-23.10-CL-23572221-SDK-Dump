...
class UBTDecorator_BlueprintBase : public UBTDecorator
{
	...
	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorObserverActive (Underlying native function: IsDecoratorObserverActive 0x9fc8abc)
	bool IsDecoratorObserverActive(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorExecutionActive (Underlying native function: IsDecoratorExecutionActive 0x9fc8a3c)
