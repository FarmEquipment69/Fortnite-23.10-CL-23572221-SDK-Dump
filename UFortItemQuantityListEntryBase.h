...
class UFortItemQuantityListEntryBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.SetPreviewData (Underlying native function: SetPreviewData 0xa70b16c)
	void SetPreviewData(struct FFortItemEntryPreviewData*& PreviewData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.SetItemInstanceAndQuantity (Underlying native function: SetItemInstanceAndQuantity 0xa70a044)
	...
	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.SetItemDefinitionAndQuantity (Underlying native function: SetItemDefinitionAndQuantity 0xa709c20)
	...
	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.IsBeingPreviewed (Underlying native function: IsBeingPreviewed 0xa709340)
	...
	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.GetPreviewData (Underlying native function: GetPreviewData 0xa7087b8)
	...
	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.GetItemInstance (Underlying native function: GetItemInstance 0xa7086d8)
	class UFortItem* GetItemInstance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.GetItemDefinition (Underlying native function: GetItemDefinition 0xa70861c)
	class UFortItemDefinition* GetItemDefinition(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemQuantityListEntryBase.ClearPreviewData (Underlying native function: ClearPreviewData 0xa7082c8)
