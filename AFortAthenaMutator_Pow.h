...
class AFortAthenaMutator_Pow : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Pow.OnRep_RespawningCurrentlyAllowed (Underlying native function: OnRep_RespawningCurrentlyAllowed 0x824a78c)
	void OnRepRespawningCurrentlyAllowed(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Pow.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x824a490)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Final | 0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Pow.GetPlayerCurrentShield (Underlying native function: GetPlayerCurrentShield 0x8249bc4)
