...
class UAudioShapePrimitiveComponent : public UAudioShapeComponent
{
	...
	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetIsPlayerInside (Underlying native function: GetIsPlayerInside 0x7b03c8c)
	bool GetIsPlayerInside(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetInsideAudioComponent (Underlying native function: GetInsideAudioComponent 0x7b03c68)
	class UAudioComponent* GetInsideAudioComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/AudioShapes.AudioShapePrimitiveComponent.GetEdgeAudioComponent (Underlying native function: GetEdgeAudioComponent 0x7b03c44)
