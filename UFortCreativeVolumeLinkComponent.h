...
class UFortCreativeVolumeLinkComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeVolumeLinkComponent.OnRep_LinkedVolume (Underlying native function: OnRep_LinkedVolume 0x8662090)
	void OnRepLinkedVolume(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeVolumeLinkComponent.OnLinkedVolumeSettingsChanged (Underlying native function: OnLinkedVolumeSettingsChanged 0x8661fb0)
	void OnLinkedVolumeSettingsChanged(struct FPropertyOverrideData& OverrideData); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortCreativeVolumeLinkComponent.GetLinkedVolume (Underlying native function: GetLinkedVolume 0x8661dcc)
