...
class UFortInteractionIndicatorWidget : public UFortActorIndicatorWidget
{
	...
	// Function /Script/FortniteUI.FortInteractionIndicatorWidget.HandleRemoveContextOverride (Underlying native function: HandleRemoveContextOverride 0xa5859c8)
	void HandleRemoveContextOverride(class UClass*& ContextOverrideWidget, bool& bPrimary); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortInteractionIndicatorWidget.HandleImprovedDBNOStateChanged (Underlying native function: HandleImprovedDBNOStateChanged 0xa585580)
	void HandleImprovedDBNOStateChanged(bool& bImprovedDBNOEnabled); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortInteractionIndicatorWidget.HandleAddContextOverride (Underlying native function: HandleAddContextOverride 0xa585004)
	void HandleAddContextOverride(class UClass*& ContextOverrideWidget, bool& bPrimary); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortInteractionIndicatorWidget.ActivateContextOverride (Underlying native function: ActivateContextOverride 0xa582d34)
