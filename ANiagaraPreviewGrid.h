...
class ANiagaraPreviewGrid : public AActor
{
	...
	// Function /Script/Niagara.NiagaraPreviewGrid.SetPaused (Underlying native function: SetPaused 0x68eaa70)
	void SetPaused(bool& bPaused); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Niagara.NiagaraPreviewGrid.GetPreviews (Underlying native function: GetPreviews 0x68e9b90)
	void GetPreviews(struct TArray<class UNiagaraComponent*>& OutPreviews); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Niagara.NiagaraPreviewGrid.DeactivatePreviews (Underlying native function: DeactivatePreviews 0x68e959c)
	void DeactivatePreviews(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Niagara.NiagaraPreviewGrid.ActivatePreviews (Underlying native function: ActivatePreviews 0x68e92e8)
