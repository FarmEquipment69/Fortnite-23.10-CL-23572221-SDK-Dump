...
class UFortExpeditionDetailsWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortExpeditionDetailsWidget.SetData (Underlying native function: SetData 0x6ffb0fc)
	void SetData(class UFortExpeditionItem*& InItem); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortExpeditionDetailsWidget.SetCurrentSquadId (Underlying native function: SetCurrentSquadId 0x721c804)
	void SetCurrentSquadId(struct FName& SquadId); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortExpeditionDetailsWidget.RequestAbandonExpedition (Underlying native function: RequestAbandonExpedition 0x721c59c)
	void RequestAbandonExpedition(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortExpeditionDetailsWidget.HandleAbandonExpeditionCompleted (Underlying native function: HandleAbandonExpeditionCompleted 0x721b2f0)
