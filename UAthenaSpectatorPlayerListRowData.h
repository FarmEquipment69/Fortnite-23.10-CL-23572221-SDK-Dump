...
class UAthenaSpectatorPlayerListRowData : public UObject
{
	...
	// Function /Script/FortniteGame.AthenaSpectatorPlayerListRowData.SetKills (Underlying native function: SetKills 0x8c2b288)
	void SetKills(class AFortPlayerStateAthena*& PS, int& InKills); // (Final | 0x00000002 | Native | Public)

	// Function /Script/FortniteGame.AthenaSpectatorPlayerListRowData.GetPlayerState (Underlying native function: GetPlayerState 0x7d31448)
