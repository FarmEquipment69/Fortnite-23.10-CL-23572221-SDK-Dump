...
class UFortAthenaAIBotEvaluator_Heal : public UFortAthenaAIBotEvaluator
{
	...
	// Function /Script/FortniteAI.FortAthenaAIBotEvaluator_Heal.HandlePlayerHealthOrShieldChanged (Underlying native function: HandlePlayerHealthOrShieldChanged 0xa1ba444)
