...
class AFortAthenaTutorial_Ambush : public AFortAthenaTutorialBase
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Ambush.OnBeginOverlapAmbushTriggerBox (Underlying native function: OnBeginOverlapAmbushTriggerBox 0x82d30f4)
	void OnBeginOverlapAmbushTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Ambush.OnAmbushBotSpawned (Underlying native function: OnAmbushBotSpawned 0x82d2ee8)
	void OnAmbushBotSpawned(class AFortPawn*& Pawn); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaTutorial_Ambush.HandleOnPlayerDamaged (Underlying native function: HandleOnPlayerDamaged 0x81d6d18)
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Ambush.HandleOnAIDummyDied (Underlying native function: HandleOnAIDummyDied 0x81d6d18)
