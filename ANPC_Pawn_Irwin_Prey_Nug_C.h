...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x3be8 (0x8)
	class UFortCharacterPartsComponent* FortCharacterParts; // 0x3bf0 (0x8)
	class UFTP_NPC_Assignment_Loot_Herbivore_C* FTPNPCAssignmentLootHerbivore; // 0x3bf8 (0x8)
	class UFortHeldObjectComponent* FortHeldObject; // 0x3c00 (0x8)
	bool bPawnPickedUp; // 0x3c08 (0x1)
	bool bPawnThrown; // 0x3c09 (0x1)
	unsigned char unreflected_3c0a[0x2]; // 0x3c0a (0x2) 
	struct FActiveGameplayEffectHandle* HGEPickedUpChicken; // 0x3c0c (0x8)
	struct FActiveGameplayEffectHandle* HGEPickedUpPlayer; // 0x3c14 (0x8)
	unsigned char unreflected_3c1c[0x4]; // 0x3c1c (0x4) 
	class UClass* GEApplyPickupAbilityChicken; // 0x3c20 (0x8)
	class UClass* GEApplyAbilitiesPlayer; // 0x3c28 (0x8)
	struct FGameplayTagContainer TCBlockPickup; // 0x3c30 (0x20)
	bool bIsPickupEnabled; // 0x3c50 (0x1)
	unsigned char unreflected_3c51[0x7]; // 0x3c51 (0x7) 
	double PickupEnableDelay; // 0x3c58 (0x8)
	double PostLandDelay; // 0x3c60 (0x8)
	struct FGameplayTagContainer InteractionPreventingTags; // 0x3c68 (0x20)
	class USoundBase* NugJumpLandSound; // 0x3c88 (0x8)
	bool bHasJumped; // 0x3c90 (0x1)
	unsigned char unreflected_3c91[0x7]; // 0x3c91 (0x7) 
	class USoundBase* NugFloatLandSound; // 0x3c98 (0x8)
	class UClass* GERecentlyAttackedByPawn; // 0x3ca0 (0x8)
	class AFortPlayerPawn* FortPlayerPawnHoldingChicken; // 0x3ca8 (0x8)
	struct FGameplayTagContainer TCHeldBumpMeleeAbility; // 0x3cb0 (0x20)
	struct FScalableFloat ChickenTrackHeldBumpsHF; // 0x3cd0 (0x28)
	struct TSet<int> ThrownByPlayerIDs; // 0x3cf8 (0x50)
	struct FTimerHandle* ThrownHandle; // 0x3d48 (0x8)
	class UAbilityAsync_WaitGameplayTagAdded* AsyncAction; // 0x3d50 (0x8)
	struct FTimerHandle* TryStopGuildeProjectileTimer; // 0x3d58 (0x8)
