...
class APlayspace : public AInfo
{
	...
	// Function /Script/PlayspaceSystem.Playspace.OnRep_PlayspaceUsers (Underlying native function: OnRep_PlayspaceUsers 0x1d85cc0)
	void OnRepPlayspaceUsers(); // (Final | Native | Protected)

	// Function /Script/PlayspaceSystem.Playspace.OnRep_MatchStartTime (Underlying native function: OnRep_MatchStartTime 0x2e2012c)
	void OnRepMatchStartTime(); // (Native | Protected)

	// Function /Script/PlayspaceSystem.Playspace.OnRep_bMatchHasEnded (Underlying native function: OnRep_bMatchHasEnded 0x220e538)
	void OnRepbMatchHasEnded(); // (Final | Native | Protected)

	// Function /Script/PlayspaceSystem.Playspace.OnRep_bIsInitialized (Underlying native function: OnRep_bIsInitialized 0x16162d8)
