...
class UFortGameplayAbility_FormSnowball : public UFortGameplayAbility
{
	...
	// Function /Script/IceRuntime.FortGameplayAbility_FormSnowball.HandleOnMeleeWeaponSwung (Underlying native function: HandleOnMeleeWeaponSwung 0x7097fb0)
	void HandleOnMeleeWeaponSwung(); // (Final | Native | Public)

	// Function /Script/IceRuntime.FortGameplayAbility_FormSnowball.HandleOnActivatingPawnAbilityCommitted (Underlying native function: HandleOnActivatingPawnAbilityCommitted 0x7097f30)
