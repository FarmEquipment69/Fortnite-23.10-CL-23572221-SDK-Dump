...
class UFortCharacterAttrSet : public UFortAttributeSet
{
	...
	// Function /Script/FortniteGame.FortCharacterAttrSet.OnRep_Tech (Underlying native function: OnRep_Tech 0x831cdbc)
	void OnRepTech(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortCharacterAttrSet.OnRep_Resistance (Underlying native function: OnRep_Resistance 0x831c1c8)
	void OnRepResistance(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortCharacterAttrSet.OnRep_Offense (Underlying native function: OnRep_Offense 0x831b838)
	void OnRepOffense(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortCharacterAttrSet.OnRep_MaxCharacterLevel (Underlying native function: OnRep_MaxCharacterLevel 0x831aea8)
	void OnRepMaxCharacterLevel(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortCharacterAttrSet.OnRep_Fortitude (Underlying native function: OnRep_Fortitude 0x8319b88)
