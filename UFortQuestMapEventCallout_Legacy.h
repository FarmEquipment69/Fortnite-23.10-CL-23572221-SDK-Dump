...
class UFortQuestMapEventCallout_Legacy : public UFortActivatablePanel
{
	...
	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.UpdateGoButtonBangState (Underlying native function: UpdateGoButtonBangState 0x7248768)
	void UpdateGoButtonBangState(bool& bClear); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.UpdateCalloutData (Underlying native function: UpdateCalloutData 0x72486b0)
	void UpdateCalloutData(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.UpdateActiveEvents (Underlying native function: UpdateActiveEvents 0x7248480)
	void UpdateActiveEvents(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.SetIsFaded (Underlying native function: SetIsFaded 0x7247334)
	void SetIsFaded(bool& Faded); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.SetIsExpanded (Underlying native function: SetIsExpanded 0x7247234)
	void SetIsExpanded(bool& Expanded); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.ResetCallout (Underlying native function: ResetCallout 0x7246534)
	void ResetCallout(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.PlayFadeOut (Underlying native function: PlayFadeOut 0x7245c8c)
	void PlayFadeOut(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.PlayFadeIn (Underlying native function: PlayFadeIn 0x7245c34)
	...
	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.IsCurrentEventUnlocked (Underlying native function: IsCurrentEventUnlocked 0x72455e8)
	bool IsCurrentEventUnlocked(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.GetRequiredQuestForCurrentEvent (Underlying native function: GetRequiredQuestForCurrentEvent 0x72444f4)
	class UFortQuestItemDefinition* GetRequiredQuestForCurrentEvent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.GetIsFaded (Underlying native function: GetIsFaded 0x7243e84)
	bool GetIsFaded(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.GetIsExpanded (Underlying native function: GetIsExpanded 0x7243e54)
	bool GetIsExpanded(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.GetEventCount (Underlying native function: GetEventCount 0x68042a8)
	int GetEventCount(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortQuestMapEventCallout_Legacy.DeactivateCallout (Underlying native function: DeactivateCallout 0x7243390)
