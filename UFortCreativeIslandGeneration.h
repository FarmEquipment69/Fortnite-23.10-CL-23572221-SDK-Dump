...
class UFortCreativeIslandGeneration : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCreativeIslandGeneration.TemplateIslandsOnHoveredItemChanged (Underlying native function: TemplateIslandsOnHoveredItemChanged 0x6d23b2c)
	void TemplateIslandsOnHoveredItemChanged(class UObject*& Item, bool& bIsHovered); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeIslandGeneration.TemplateIslandsOnCurrentItemSelectionChanged (Underlying native function: TemplateIslandsOnCurrentItemSelectionChanged 0xa588634)
	void TemplateIslandsOnCurrentItemSelectionChanged(class UObject*& Item); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeIslandGeneration.StartingIslandsOnHoveredItemChanged (Underlying native function: StartingIslandsOnHoveredItemChanged 0x6d23b2c)
	void StartingIslandsOnHoveredItemChanged(class UObject*& Item, bool& bIsHovered); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeIslandGeneration.StartingIslandsOnCurrentItemSelectionChanged (Underlying native function: StartingIslandsOnCurrentItemSelectionChanged 0xa588528)
	void StartingIslandsOnCurrentItemSelectionChanged(class UObject*& Item); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeIslandGeneration.SetupIslandTemplateData (Underlying native function: SetupIslandTemplateData 0xa587e6c)
	...
	// Function /Script/FortniteUI.FortCreativeIslandGeneration.HandleCancelClicked (Underlying native function: HandleCancelClicked 0x6dd0d50)
	void HandleCancelClicked(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteUI.FortCreativeIslandGeneration.GetShowTemplateIslands (Underlying native function: GetShowTemplateIslands 0xa584d88)
