...
class UFortCollectionBookSlotWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.OnItemDestroyed (Underlying native function: OnItemDestroyed 0x71e8314)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.IsItemSlotted (Underlying native function: IsItemSlotted 0x71e79f0)
	bool IsItemSlotted(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.HasItemsToSlot (Underlying native function: HasItemsToSlot 0x71e7854)
	bool HasItemsToSlot(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.HandleUnslotItemComplete (Underlying native function: HandleUnslotItemComplete 0x71e75f0)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.HandleSlottedItemOperationComplete (Underlying native function: HandleSlottedItemOperationComplete 0x71e752c)
	void HandleSlottedItemOperationComplete(class UFortAccountItem*& NewItem, struct FName& TemplateId); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.HandleResearchItemComplete (Underlying native function: HandleResearchItemComplete 0x71e71c0)
	void HandleResearchItemComplete(class UFortAccountItem*& ResearchedItem, struct FString& SlotId); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.GetSlottedItemRepresentation (Underlying native function: GetSlottedItemRepresentation 0x71e6988)
	class UFortItem* GetSlottedItemRepresentation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.GetSlotRowName (Underlying native function: GetSlotRowName 0x27d4cd4)
	struct FName GetSlotRowName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotWidget.GetNumItemsToSlot (Underlying native function: GetNumItemsToSlot 0x71e67d4)
