...
class UAthenaHUDMenu : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaHUDMenu.StartPostGame (Underlying native function: StartPostGame 0xa375dd4)
	void StartPostGame(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.SetInventoryPanelOverride (Underlying native function: SetInventoryPanelOverride 0xa375870)
	void SetInventoryPanelOverride(class UUserWidget*& InInventoryPanelOverride); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.RecoverFromPostGame (Underlying native function: RecoverFromPostGame 0xa375c00)
	void RecoverFromPostGame(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.PostBindCheckConditions (Underlying native function: PostBindCheckConditions 0x1a101c8)
	...
	// Function /Script/FortniteUI.AthenaHUDMenu.NativeHandleCursorModeChanged (Underlying native function: NativeHandleCursorModeChanged 0x28ab344)
	...
	// Function /Script/FortniteUI.AthenaHUDMenu.HandleStartPostGame (Underlying native function: HandleStartPostGame 0xa375dd4)
	void HandleStartPostGame(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleRecoverFromPostGame (Underlying native function: HandleRecoverFromPostGame 0xa375c00)
	void HandleRecoverFromPostGame(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandlePreviewScreenshotCameraActivated (Underlying native function: HandlePreviewScreenshotCameraActivated 0xa375904)
	void HandlePreviewScreenshotCameraActivated(bool& bActivated); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleOverrideInventoryPanel (Underlying native function: HandleOverrideInventoryPanel 0xa375870)
	void HandleOverrideInventoryPanel(class UUserWidget*& Widget); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleMinigameStateChanged (Underlying native function: HandleMinigameStateChanged 0xa375798)
	void HandleMinigameStateChanged(class AFortMinigame*& Minigame, enum EFortMinigameState& MinigameState); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleLocalPlayerRevived (Underlying native function: HandleLocalPlayerRevived 0xa3756c4)
	void HandleLocalPlayerRevived(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleLocalPlayerOrTeamWon (Underlying native function: HandleLocalPlayerOrTeamWon 0xa3756b0)
	void HandleLocalPlayerOrTeamWon(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleLocalPlayerLost (Underlying native function: HandleLocalPlayerLost 0xa375630)
	void HandleLocalPlayerLost(enum EEndOfMatchReason& LostReason); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaHUDMenu.HandleLocalPlayerDied (Underlying native function: HandleLocalPlayerDied 0xa375580)
	void HandleLocalPlayerDied(struct FFortPlayerDeathReport& DeathReport); // (Final | Native | Private | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.CreateOrShowGameOverScreen (Underlying native function: CreateOrShowGameOverScreen 0xa374ce0)
	class UAthenaGameOverDisplay* CreateOrShowGameOverScreen(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaHUDMenu.ClearGameOverScreen (Underlying native function: ClearGameOverScreen 0xa374bdc)
