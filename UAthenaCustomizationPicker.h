...
class UAthenaCustomizationPicker : public UFortItemPickerBase
{
	...
	// Function /Script/FortniteUI.AthenaCustomizationPicker.SetFilter (Underlying native function: SetFilter 0xa2ea784)
	void SetFilter(struct FName& FilterName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaCustomizationPicker.SearchText (Underlying native function: SearchText 0xa2ea440)
	...
	// Function /Script/FortniteUI.AthenaCustomizationPicker.HandleSelectedItemHasChanged (Underlying native function: HandleSelectedItemHasChanged 0xa2e97a0)
	...
	// Function /Script/FortniteUI.AthenaCustomizationPicker.HandleArchiveFilterTooltipDismissed (Underlying native function: HandleArchiveFilterTooltipDismissed 0xa2e88e0)
	void HandleArchiveFilterTooltipDismissed(); // (Final | Native | Private | BlueprintCallable | Const)

	// Function /Script/FortniteUI.AthenaCustomizationPicker.GetQualifiedFilterDisplayName (Underlying native function: GetQualifiedFilterDisplayName 0xa2e8758)
	...
	// Function /Script/FortniteUI.AthenaCustomizationPicker.EndCustomizationCategory (Underlying native function: EndCustomizationCategory 0xa2e8028)
	...
	// Function /Script/FortniteUI.AthenaCustomizationPicker.BeginCustomizationCategory (Underlying native function: BeginCustomizationCategory 0xa2e7cd4)
