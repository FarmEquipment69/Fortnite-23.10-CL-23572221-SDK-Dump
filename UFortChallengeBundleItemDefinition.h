...
class UFortChallengeBundleItemDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.IsLinearChainQuest (Underlying native function: IsLinearChainQuest 0x840f170)
	...
	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetTotalNumberOfQuests (Underlying native function: GetTotalNumberOfQuests 0x840f064)
	int GetTotalNumberOfQuests(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetRewardCompletionThreshold (Underlying native function: GetRewardCompletionThreshold 0x840efd8)
	int GetRewardCompletionThreshold(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetQuests (Underlying native function: GetQuests 0x840edd8)
	...
	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetNumVisibleQuests (Underlying native function: GetNumVisibleQuests 0x840eac0)
	int GetNumVisibleQuests(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetNumQuests (Underlying native function: GetNumQuests 0x840eaa8)
	int GetNumQuests(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetNotificationIconOverride (Underlying native function: GetNotificationIconOverride 0x840ea14)
	struct TWeakObjectPtr<class UObject> GetNotificationIconOverride(); // (Final | Native | Public | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetLockedDisplayTextOverride (Underlying native function: GetLockedDisplayTextOverride 0x840e910)
	struct FText GetLockedDisplayTextOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetHexCodeForStyleColor (Underlying native function: GetHexCodeForStyleColor 0x840e840)
	...
	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetGoalCardPinSeasonItemTag (Underlying native function: GetGoalCardPinSeasonItemTag 0x840e828)
	struct FGameplayTag GetGoalCardPinSeasonItemTag(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetEventName (Underlying native function: GetEventName 0x840e668)
	struct FString GetEventName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetDisplayStyle (Underlying native function: GetDisplayStyle 0x840e64c)
	struct FFortChallengeSetStyle GetDisplayStyle(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetCompletionRewards (Underlying native function: GetCompletionRewards 0x840e610)
	...
	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetCalendarEventName (Underlying native function: GetCalendarEventName 0x840e304)
	struct FString GetCalendarEventName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleItemDefinition.GetBundleLevelForQuest (Underlying native function: GetBundleLevelForQuest 0x840e274)
