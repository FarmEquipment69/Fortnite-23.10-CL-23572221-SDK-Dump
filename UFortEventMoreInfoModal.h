...
class UFortEventMoreInfoModal : public UCommonActivatableWidget
{
	...
	// Function /Script/EventScreenBase.FortEventMoreInfoModal.GetEventScreenData (Underlying native function: GetEventScreenData 0x707b84c)
	class UFortEventScreenData* GetEventScreenData(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/EventScreenBase.FortEventMoreInfoModal.ExitModal (Underlying native function: ExitModal 0x182d3cc)
