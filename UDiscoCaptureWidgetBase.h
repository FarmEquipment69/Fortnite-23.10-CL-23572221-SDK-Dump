...
class UDiscoCaptureWidgetBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.DiscoCaptureWidgetBase.UpdateDiscoCaptureUI (Underlying native function: UpdateDiscoCaptureUI 0xa3fcd14)
	void UpdateDiscoCaptureUI(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.DiscoCaptureWidgetBase.UpdateAllUI (Underlying native function: UpdateAllUI 0xa3fcd14)
	...
	// Function /Script/FortniteUI.DiscoCaptureWidgetBase.OnHandleSpectatingChanged (Underlying native function: OnHandleSpectatingChanged 0xa3fb534)
	void OnHandleSpectatingChanged(class AFortPlayerStateZone*& SpectatingTarget); // (Final | Native | Protected)

	// Function /Script/FortniteUI.DiscoCaptureWidgetBase.GetClosestCapturePoint (Underlying native function: GetClosestCapturePoint 0xa3f8e0c)
