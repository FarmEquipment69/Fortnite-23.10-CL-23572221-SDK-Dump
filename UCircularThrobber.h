...
class UCircularThrobber : public UWidget
{
	...
	// Function /Script/UMG.CircularThrobber.SetRadius (Underlying native function: SetRadius 0x9920540)
	void SetRadius(float& InRadius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CircularThrobber.SetPeriod (Underlying native function: SetPeriod 0x9920294)
	void SetPeriod(float& InPeriod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CircularThrobber.SetNumberOfPieces (Underlying native function: SetNumberOfPieces 0x991ffe4)
