...
class UAthenaCharmItemDefinition : public UAthenaCosmeticItemDefinition
{
	...
	// Function /Script/FortniteGame.AthenaCharmItemDefinition.GetOverrideWeaponAnimSetPtr (Underlying native function: GetOverrideWeaponAnimSetPtr 0x84d5eb4)
	struct TWeakObjectPtr<class UClass> GetOverrideWeaponAnimSetPtr(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaCharmItemDefinition.GetOverrideSkelMeshPtr (Underlying native function: GetOverrideSkelMeshPtr 0x84d5c44)
	...
	// Function /Script/FortniteGame.AthenaCharmItemDefinition.GetOverrideAnimSetPtrForCharmSlot (Underlying native function: GetOverrideAnimSetPtrForCharmSlot 0x84d5b54)
	...
	// Function /Script/FortniteGame.AthenaCharmItemDefinition.GetOverrideAnimSetPtr (Underlying native function: GetOverrideAnimSetPtr 0x84d58e4)
	struct TWeakObjectPtr<class UClass> GetOverrideAnimSetPtr(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaCharmItemDefinition.GetCharmPrefabClass (Underlying native function: GetCharmPrefabClass 0x84d5274)
