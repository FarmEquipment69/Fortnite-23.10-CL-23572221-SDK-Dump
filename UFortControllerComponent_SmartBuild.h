...
class UFortControllerComponent_SmartBuild : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_SmartBuild.ServerSetUseSmartBuild (Underlying native function: ServerSetUseSmartBuild 0x70390d4)
	void ServerSetUseSmartBuild(bool& bInUseSmartBuild); // (Net | NetReliable | Native | Event | Public | NetServer)

	// Function /Script/FortniteGame.FortControllerComponent_SmartBuild.OnRep_UseSmartBuild (Underlying native function: OnRep_UseSmartBuild 0x845da50)
	void OnRepUseSmartBuild(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SmartBuild.ClientEquipBuildingItems (Underlying native function: ClientEquipBuildingItems 0x662da48)
