...
class AFortAthenaMutator_CustomCharacterParts : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_CustomCharacterParts.GetPartOverridesForPlayer (Underlying native function: GetPartOverridesForPlayer 0x81f85c0)
