...
class UFortRootViewportLayout : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortRootViewportLayout.PurchasingWidgetDisplayCallback (Underlying native function: PurchasingWidgetDisplayCallback 0xa8461c0)
	void PurchasingWidgetDisplayCallback(class UWidget*& WebWidget, struct FString& OfferId); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortRootViewportLayout.PurchasingWidgetDismissedCallback (Underlying native function: PurchasingWidgetDismissedCallback 0xa8461ac)
	void PurchasingWidgetDismissedCallback(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortRootViewportLayout.HandleControllerConnectionChanged (Underlying native function: HandleControllerConnectionChanged 0xa8456a8)
