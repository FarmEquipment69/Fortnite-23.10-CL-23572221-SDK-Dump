...
class UFortPlayerAnimInstance_MotorcycleRider : public UFortBaseLayerAnimInstance
{
	...
	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleStartWheelie (Underlying native function: HandleStartWheelie 0x6fbd334)
	void HandleStartWheelie(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleStartStoppie (Underlying native function: HandleStartStoppie 0x6fbd31c)
	void HandleStartStoppie(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleStartChargingJump (Underlying native function: HandleStartChargingJump 0x47ac11c)
	void HandleStartChargingJump(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleStartAirTrick (Underlying native function: HandleStartAirTrick 0x6fbd2a0)
	void HandleStartAirTrick(enum EFortMotorcycleAirTrickType& TrickType); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleReleaseWheelie (Underlying native function: HandleReleaseWheelie 0x6fbd288)
	void HandleReleaseWheelie(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleReleaseStoppie (Underlying native function: HandleReleaseStoppie 0x6fbd270)
	void HandleReleaseStoppie(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleJump (Underlying native function: HandleJump 0x2d833a8)
	void HandleJump(float& InJumpChargeFactor); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleFinishAirTrick (Underlying native function: HandleFinishAirTrick 0x6fbd258)
	void HandleFinishAirTrick(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleChargingJump (Underlying native function: HandleChargingJump 0x29e225c)
	void HandleChargingJump(float& InJumpChargeFactor); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.HandleCancelChargingJump (Underlying native function: HandleCancelChargingJump 0x6fbd240)
	void HandleCancelChargingJump(); // (Final | Native | Public)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.CollapsedAimYawSmoothed (Underlying native function: CollapsedAimYawSmoothed 0x6fbd190)
	void CollapsedAimYawSmoothed(float& DeltaSeconds); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.CalculateNoiseAlpha (Underlying native function: CalculateNoiseAlpha 0x6fbd0d4)
	void CalculateNoiseAlpha(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/MotorcycleRuntime.FortPlayerAnimInstance_MotorcycleRider.AnimNotify_JumpEntered (Underlying native function: AnimNotify_JumpEntered 0x6fbd0b4)
