...
class UCustomCharacterPartAnimInstance_Grilled_Cheese_Pack : public UCustomCharacterPartAnimInstance
{
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Grilled_Cheese_Pack.UpdateSpinSettings (Underlying native function: UpdateSpinSettings 0x85b513c)
	void UpdateSpinSettings(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Grilled_Cheese_Pack.UpdateFloatCubes (Underlying native function: UpdateFloatCubes 0x85b5064)
	void UpdateFloatCubes(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Grilled_Cheese_Pack.UpdateCrackSpinLogic (Underlying native function: UpdateCrackSpinLogic 0x85b4fcc)
	void UpdateCrackSpinLogic(float& DeltaTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Grilled_Cheese_Pack.UpdateCracks (Underlying native function: UpdateCracks 0x85b5050)
	void UpdateCracks(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_Grilled_Cheese_Pack.SpinFNC (Underlying native function: SpinFNC 0x85b4f04)
