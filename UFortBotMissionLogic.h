...
class UFortBotMissionLogic : public UObject
{
	...
	// Function /Script/FortniteAI.FortBotMissionLogic.SpawnStructureBuilder (Underlying native function: SpawnStructureBuilder 0xa172458)
	...
	// Function /Script/FortniteAI.FortBotMissionLogic.SetGoalsInvulnerable (Underlying native function: SetGoalsInvulnerable 0xa172358)
	void SetGoalsInvulnerable(bool& bGodMode); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortBotMissionLogic.SetCurrentBehavior (Underlying native function: SetCurrentBehavior 0xa1722d8)
	void SetCurrentBehavior(class UBehaviorTree*& Behavior); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortBotMissionLogic.ResetBehavior (Underlying native function: ResetBehavior 0xa1721cc)
	...
	// Function /Script/FortniteAI.FortBotMissionLogic.MarkSingleLocator (Underlying native function: MarkSingleLocator 0xa171a84)
	void MarkSingleLocator(class AActor*& LocatorActor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortBotMissionLogic.MarkAllLocated (Underlying native function: MarkAllLocated 0xa171a44)
	void MarkAllLocated(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortBotMissionLogic.ClearAllLocated (Underlying native function: ClearAllLocated 0xa1714ac)
