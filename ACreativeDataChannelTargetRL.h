...
class ACreativeDataChannelTargetRL : public AElectraDataChannelTarget
{
	...
	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.ReportServerStateStreamError (Underlying native function: ReportServerStateStreamError 0x6f96e18)
	...
	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_VersionByte (Underlying native function: OnRep_VersionByte 0x6f96de0)
	void OnRepVersionByte(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_TeamNames (Underlying native function: OnRep_TeamNames 0x6f96d64)
	void OnRepTeamNames(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_SeriesState (Underlying native function: OnRep_SeriesState 0x6f96d2c)
	void OnRepSeriesState(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTotal (Underlying native function: OnRep_ScoreTotal 0x6f96cc8)
	void OnRepScoreTotal(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTeam (Underlying native function: OnRep_ScoreTeam 0x6f96cb4)
	void OnRepScoreTeam(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardTimeLeft (Underlying native function: OnRep_ScoreboardTimeLeft 0x6f96cf0)
	void OnRepScoreboardTimeLeft(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardBestOf (Underlying native function: OnRep_ScoreboardBestOf 0x6f96cdc)
	void OnRepScoreboardBestOf(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerNames (Underlying native function: OnRep_PlayerNames 0x6f96ca0)
	void OnRepPlayerNames(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerCoords (Underlying native function: OnRep_PlayerCoords 0x6f96c8c)
	void OnRepPlayerCoords(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoostCollected (Underlying native function: OnRep_PlayerBoostCollected 0x6f96c78)
	void OnRepPlayerBoostCollected(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoost (Underlying native function: OnRep_PlayerBoost 0x6f96c64)
	void OnRepPlayerBoost(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_Overtime (Underlying native function: OnRep_Overtime 0x6f96c2c)
	void OnRepOvertime(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStop (Underlying native function: OnRep_MediaStop 0x6f96bf4)
	void OnRepMediaStop(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStart (Underlying native function: OnRep_MediaStart 0x6f96be0)
	void OnRepMediaStart(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MatchState (Underlying native function: OnRep_MatchState 0x6f96ba8)
	void OnRepMatchState(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_FinaleState (Underlying native function: OnRep_FinaleState 0x6f96b70)
	void OnRepFinaleState(); // (Final | Native | Public)

	// Function /Script/CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_BallCoords (Underlying native function: OnRep_BallCoords 0x6f96b5c)
