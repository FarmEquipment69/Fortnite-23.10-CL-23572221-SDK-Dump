...
class UFortLocalUserEntry : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortLocalUserEntry.HandleMenuOpenChanged (Underlying native function: HandleMenuOpenChanged 0xa6171f0)
	void HandleMenuOpenChanged(bool& bIsOpen); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLocalUserEntry.HandleGetMenuContent (Underlying native function: HandleGetMenuContent 0x6dd0764)
