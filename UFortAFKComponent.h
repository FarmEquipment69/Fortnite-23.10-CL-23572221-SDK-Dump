...
class UFortAFKComponent : public UPlayerStateComponent
{
	...
	// Function /Script/FortniteGame.FortAFKComponent.OnRep_bIsConfirmedAFK (Underlying native function: OnRep_bIsConfirmedAFK 0x6d235d0)
	void OnRepbIsConfirmedAFK(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAFKComponent.OnRep_bIsAFKWarningActive (Underlying native function: OnRep_bIsAFKWarningActive 0x6ffbaa4)
