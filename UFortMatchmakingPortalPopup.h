...
class UFortMatchmakingPortalPopup : public UFortPortalHUDDetails
{
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HasActivityToShow (Underlying native function: HasActivityToShow 0x70e5d94)
	bool HasActivityToShow(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleWidgetUpdate (Underlying native function: HandleWidgetUpdate 0x70e5d80)
	void HandleWidgetUpdate(); // (Final | Native | Private)

	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleStartedRespawn (Underlying native function: HandleStartedRespawn 0x70e5d00)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleLoadScreenChanged (Underlying native function: HandleLoadScreenChanged 0x70e5ba8)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleHUDShow (Underlying native function: HandleHUDShow 0x70e5ae4)
	void HandleHUDShow(bool& bShow, bool& bShouldAnimate); // (Final | Native | Private)

	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalPopup.HandleFinishedCountdown (Underlying native function: HandleFinishedCountdown 0x70e5acc)
