...
class AFortHotfixBlockingVolume : public AActor
{
	...
	// Function /Script/FortniteGame.FortHotfixBlockingVolume.OnRep_ReplicatedExtent (Underlying native function: OnRep_ReplicatedExtent 0x7dbfb30)
	void OnRepReplicatedExtent(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortHotfixBlockingVolume.CopyToClipboard (Underlying native function: CopyToClipboard 0x273fd14)
