...
class UFortQuestObjectiveInfo : public UObject
{
	...
	// Function /Script/FortniteGame.FortQuestObjectiveInfo.OnActorEndPlay (Underlying native function: OnActorEndPlay 0x8bfc650)
	void OnActorEndPlay(class AActor*& Actor, struct TEnumAsByte<EEndPlayReason>& Reason); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.IsVisibleToUser (Underlying native function: IsVisibleToUser 0x84764d0)
	bool IsVisibleToUser(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.IsInProgress (Underlying native function: IsInProgress 0x8bfbde4)
	bool IsInProgress(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.IsActive (Underlying native function: IsActive 0x8bfbd24)
	bool IsActive(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.HasCompleted (Underlying native function: HasCompleted 0x8bfba8c)
	bool HasCompleted(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.GetOwningQuest (Underlying native function: GetOwningQuest 0x8bfabec)
	class UFortQuestItem* GetOwningQuest(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestObjectiveInfo.DisplayDynamicQuestUpdate (Underlying native function: DisplayDynamicQuestUpdate 0x8bfa374)
