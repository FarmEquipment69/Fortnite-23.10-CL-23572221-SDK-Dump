...
class UFortRewardInfoButton_Legacy : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortRewardInfoButton_Legacy.SetShowDescription (Underlying native function: SetShowDescription 0xa781664)
	void SetShowDescription(bool& bInShowDescription); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoButton_Legacy.SetItemInstanceQuantityPair (Underlying native function: SetItemInstanceQuantityPair 0xa780fac)
	...
	// Function /Script/FortniteUI.FortRewardInfoButton_Legacy.GetQuantity (Underlying native function: GetQuantity 0xa77e468)
	int GetQuantity(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortRewardInfoButton_Legacy.GetItemInstance (Underlying native function: GetItemInstance 0xa77e36c)
