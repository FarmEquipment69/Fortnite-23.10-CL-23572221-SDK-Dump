...
class AFortGameplayCueNotifyAthena_AIAlertState : public AFortGameplayCueNotify_Loop
{
	...
	// Function /Script/FortniteGame.FortGameplayCueNotifyAthena_AIAlertState.OnTeamChanged (Underlying native function: OnTeamChanged 0x7f9813c)
	void OnTeamChanged(unsigned char& OldTeam); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameplayCueNotifyAthena_AIAlertState.HandleAbilitySystemComponentInitialized (Underlying native function: HandleAbilitySystemComponentInitialized 0x7f96af4)
	...
	// Function /Script/FortniteGame.FortGameplayCueNotifyAthena_AIAlertState.AlertStateHideTagCallback (Underlying native function: AlertStateHideTagCallback 0x7f95ed8)
