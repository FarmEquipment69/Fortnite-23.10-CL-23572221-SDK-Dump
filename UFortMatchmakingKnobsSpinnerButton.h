...
class UFortMatchmakingKnobsSpinnerButton : public UCommonRotator
{
	...
	// Function /Script/FortniteUI.FortMatchmakingKnobsSpinnerButton.OnSelectionRotated (Underlying native function: OnSelectionRotated 0xa5b17b8)
	...
	// Function /Script/FortniteUI.FortMatchmakingKnobsSpinnerButton.OnLocalPlayerExperienceStateChanged (Underlying native function: OnLocalPlayerExperienceStateChanged 0xa5b0da4)
	...
	// Function /Script/FortniteUI.FortMatchmakingKnobsSpinnerButton.HasMatchingTags (Underlying native function: HasMatchingTags 0xa5b02b4)
	bool HasMatchingTags(struct FGameplayTagContainer& Tags); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.FortMatchmakingKnobsSpinnerButton.GetTitleText (Underlying native function: GetTitleText 0xa5af5e0)
	struct FText GetTitleText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortMatchmakingKnobsSpinnerButton.GetDescription (Underlying native function: GetDescription 0xa5aef88)
