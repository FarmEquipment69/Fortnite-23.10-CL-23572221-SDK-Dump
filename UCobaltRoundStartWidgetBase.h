...
class UCobaltRoundStartWidgetBase : public UCobaltWidgetBase
{
	...
	// Function /Script/FortniteUI.CobaltRoundStartWidgetBase.HandleShowRoundStartWidget (Underlying native function: HandleShowRoundStartWidget 0xa3fa844)
	void HandleShowRoundStartWidget(struct FCobaltWidgetRoundData& RoundData); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.CobaltRoundStartWidgetBase.HandleHideRoundStartWidget (Underlying native function: HandleHideRoundStartWidget 0xa3fa1c0)
