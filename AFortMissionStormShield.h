...
class AFortMissionStormShield : public AActor
{
	...
	// Function /Script/FortniteGame.FortMissionStormShield.UpdateRadiusVisuals (Underlying native function: UpdateRadiusVisuals 0x2466474)
	void UpdateRadiusVisuals(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteGame.FortMissionStormShield.SpawnSafeAreaAtLocation (Underlying native function: SpawnSafeAreaAtLocation 0x88ef950)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.SetTargetRadiusSizeChangeOverGrowthRate (Underlying native function: SetTargetRadiusSizeChangeOverGrowthRate 0x88eeb78)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.SetTargetLocationToMoveTo (Underlying native function: SetTargetLocationToMoveTo 0x88eea9c)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.SetRadiusOfShield (Underlying native function: SetRadiusOfShield 0x88ee9fc)
	void SetRadiusOfShield(float& InRadius); // (Final | BlueprintAuthorityOnly | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortMissionStormShield.RemoveAndDestroySafeArea (Underlying native function: RemoveAndDestroySafeArea 0x6e9113c)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.PauseStormShield (Underlying native function: PauseStormShield 0x82aa228)
	void PauseStormShield(); // (BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMissionStormShield.OnRep_ReplicatedRadius (Underlying native function: OnRep_ReplicatedRadius 0x88ecb70)
	void OnRepReplicatedRadius(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMissionStormShield.OnRep_RadiusGrowthData (Underlying native function: OnRep_RadiusGrowthData 0x88ecb5c)
	void OnRepRadiusGrowthData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMissionStormShield.IsInStormShield (Underlying native function: IsInStormShield 0x88ec304)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.InitializeRadiusValue (Underlying native function: InitializeRadiusValue 0x88ec268)
	void InitializeRadiusValue(float& InRadius); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMissionStormShield.GetSafeZones (Underlying native function: GetSafeZones 0x88ea880)
	...
	// Function /Script/FortniteGame.FortMissionStormShield.DestroyStormShield (Underlying native function: DestroyStormShield 0x88e9128)
