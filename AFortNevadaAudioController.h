...
class AFortNevadaAudioController : public AActor
{
	...
	// Function /Script/NevadaRuntime.FortNevadaAudioController.Update (Underlying native function: Update 0x6fdba74)
	void Update(); // (Final | Native | Public)

	// Function /Script/NevadaRuntime.FortNevadaAudioController.Init (Underlying native function: Init 0x6fdb314)
	void Init(class AFortNevadaVehicle*& InVehicle); // (Final | Native | Public)

	// Function /Script/NevadaRuntime.FortNevadaAudioController.GetVehicleActor (Underlying native function: GetVehicleActor 0x6fdb2fc)
	class AFortNevadaVehicle* GetVehicleActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/NevadaRuntime.FortNevadaAudioController.CacheReferences (Underlying native function: CacheReferences 0x6fdb010)
