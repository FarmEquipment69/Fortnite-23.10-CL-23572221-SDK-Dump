...
class UFortAsyncAction_PartyDisplayManager_SetupPrefabVisuals : public UBlueprintAsyncActionBase
{
	...
	// Function /Script/FortniteGame.FortAsyncAction_PartyDisplayManager_SetupPrefabVisuals.SetupPrefabVisuals (Underlying native function: SetupPrefabVisuals 0x87b52b0)
	...
	// Function /Script/FortniteGame.FortAsyncAction_PartyDisplayManager_SetupPrefabVisuals.OnRequestedCustomizationComplete (Underlying native function: OnRequestedCustomizationComplete 0x87b4b08)
	void OnRequestedCustomizationComplete(class AFortPlayerPawn*& Pawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAsyncAction_PartyDisplayManager_SetupPrefabVisuals.OnPreviousCustomizationComplete (Underlying native function: OnPreviousCustomizationComplete 0x87b4a88)
	void OnPreviousCustomizationComplete(class AFortPlayerPawn*& Pawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAsyncAction_PartyDisplayManager_SetupPrefabVisuals.OnItemDisplayReady (Underlying native function: OnItemDisplayReady 0x87b4584)
