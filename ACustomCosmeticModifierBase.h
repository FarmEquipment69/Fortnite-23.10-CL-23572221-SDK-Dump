...
class ACustomCosmeticModifierBase : public AActor
{
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.SpawnSystemAttachedPartModifier (Underlying native function: SpawnSystemAttachedPartModifier 0x85cc3c0)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.SpawnSystemAtLocationPartModifier (Underlying native function: SpawnSystemAtLocationPartModifier 0x85cbf8c)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.SpawnEmitterAttachedPartModifier (Underlying native function: SpawnEmitterAttachedPartModifier 0x85cbb1c)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.SpawnEmitterAtLocationPartModifier (Underlying native function: SpawnEmitterAtLocationPartModifier 0x85cb798)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.SetCosmeticActiveVariant (Underlying native function: SetCosmeticActiveVariant 0x85cb5d8)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.OnPostResIn (Underlying native function: OnPostResIn 0x1598df4)
	void OnPostResIn(); // (BlueprintCosmetic | Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.OnPlayerWeaponChanged (Underlying native function: OnPlayerWeaponChanged 0x1ecff90)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.OnNativeCurieDetached (Underlying native function: OnNativeCurieDetached 0x85cb160)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.OnNativeCurieAttached (Underlying native function: OnNativeCurieAttached 0x85cb05c)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.OnExternalDependencyActorDestroyed (Underlying native function: OnExternalDependencyActorDestroyed 0x85cafdc)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.NativeWeaponFired (Underlying native function: NativeWeaponFired 0x2717d88)
	void NativeWeaponFired(class AFortWeapon*& FiringWeapon); // (Final | Native | Protected)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.NativePawnCustomizationFinished (Underlying native function: NativePawnCustomizationFinished 0x82a9ec4)
	void NativePawnCustomizationFinished(class AFortPlayerPawn*& PlayerPawn); // (Native | Protected)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.NativeOnHitPawn (Underlying native function: NativeOnHitPawn 0x85cae5c)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.NativeExitedVehicle (Underlying native function: NativeExitedVehicle 0x85cae48)
	void NativeExitedVehicle(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.NativeEnteredVehicle (Underlying native function: NativeEnteredVehicle 0x85cae34)
	void NativeEnteredVehicle(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.IsInFrontEnd (Underlying native function: IsInFrontEnd 0x2e9e0c4)
	bool IsInFrontEnd(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.HandleSetFirstPersonCameraOrPawnTargetingChanged (Underlying native function: HandleSetFirstPersonCameraOrPawnTargetingChanged 0x85cadb8)
	void HandleSetFirstPersonCameraOrPawnTargetingChanged(bool& bChanged); // (Final | Native | Private)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.HandlePawnLanded (Underlying native function: HandlePawnLanded 0x85cad24)
	void HandlePawnLanded(struct FHitResult& Hit); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.HandlePawnJumped (Underlying native function: HandlePawnJumped 0x85cad00)
	void HandlePawnJumped(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.HandleMovementModeChanged (Underlying native function: HandleMovementModeChanged 0x85cac04)
	...
	// Function /Script/FortniteGame.CustomCosmeticModifierBase.GetLoadout (Underlying native function: GetLoadout 0x1ecfe50)
	struct FFortAthenaLoadout GetLoadout(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCosmeticModifierBase.GetAssociatedPlayerPawn (Underlying native function: GetAssociatedPlayerPawn 0x1ecff68)
