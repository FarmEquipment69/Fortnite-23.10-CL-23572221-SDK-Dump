...
class ABuildingPhoenixItemCollectorActor : public ABuildingItemCollectorActor
{
	...
	// Function /Script/FortniteGame.BuildingPhoenixItemCollectorActor.GetOutputRewardRarity (Underlying native function: GetOutputRewardRarity 0x83848ac)
	enum EFortRarity GetOutputRewardRarity(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingPhoenixItemCollectorActor.GetOutputRewardLevel (Underlying native function: GetOutputRewardLevel 0x8384860)
	int GetOutputRewardLevel(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingPhoenixItemCollectorActor.GetActiveOutputRecipe (Underlying native function: GetActiveOutputRecipe 0x83838c8)
