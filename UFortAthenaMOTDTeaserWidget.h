...
class UFortAthenaMOTDTeaserWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortAthenaMOTDTeaserWidget.OpenMOTDScreen (Underlying native function: OpenMOTDScreen 0xa7333c8)
	...
	// Function /Script/FortniteUI.FortAthenaMOTDTeaserWidget.GetNewsCount (Underlying native function: GetNewsCount 0x27d4cd4)
	int GetNewsCount(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMOTDTeaserWidget.GetNewsByIndex (Underlying native function: GetNewsByIndex 0x16cf018)
