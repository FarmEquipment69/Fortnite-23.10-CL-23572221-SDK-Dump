...
class AFortAthenaMutator_CustomStormMovement : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_CustomStormMovement.OnRep_SafeZoneRouteIndex (Underlying native function: OnRep_SafeZoneRouteIndex 0x81faea0)
	void OnRepSafeZoneRouteIndex(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_CustomStormMovement.GetSafeZoneRoute (Underlying native function: GetSafeZoneRoute 0x81f88ac)
