...
class UFortAbilityTask_SpawnProjectileAndWait : public UAbilityTask
{
	...
	// Function /Script/FortniteGame.FortAbilityTask_SpawnProjectileAndWait.SpawnProjectileAndWait (Underlying native function: SpawnProjectileAndWait 0x7e72cb4)
	...
	// Function /Script/FortniteGame.FortAbilityTask_SpawnProjectileAndWait.OnProjectileDestroyed (Underlying native function: OnProjectileDestroyed 0x7e71778)
	void OnProjectileDestroyed(class AActor*& DestroyedActor); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAbilityTask_SpawnProjectileAndWait.FinishSpawningActor (Underlying native function: FinishSpawningActor 0x7e70348)
	...
	// Function /Script/FortniteGame.FortAbilityTask_SpawnProjectileAndWait.BeginSpawningActor (Underlying native function: BeginSpawningActor 0x7e6e720)
