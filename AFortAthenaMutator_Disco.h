...
class AFortAthenaMutator_Disco : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Disco.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81fa450)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Disco.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x81fa1a8)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Disco.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x81fa06c)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Disco.OnCaptureLockBroken (Underlying native function: OnCaptureLockBroken 0x81f9d88)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Disco.OnCaptureLock (Underlying native function: OnCaptureLock 0x81f9c8c)
	void OnCaptureLock(class AAthenaCapturePoint*& CapturePoint, unsigned char& LockTeam, bool& bIsNewLock); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAthenaMutator_Disco.IsRespawningAllowed (Underlying native function: IsRespawningAllowed 0x81f965c)
