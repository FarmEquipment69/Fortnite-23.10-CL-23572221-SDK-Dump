...
class UAthenaLocalPlayerViewModel : public UAthenaPlayerViewModel
{
	...
	// Function /Script/FortniteUI.AthenaLocalPlayerViewModel.HandleViewTargetPlayerStateReplicated (Underlying native function: HandleViewTargetPlayerStateReplicated 0xa45c6a8)
	void HandleViewTargetPlayerStateReplicated(class AFortPlayerPawn*& Pawn); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaLocalPlayerViewModel.HandleLocalPlayerChangedTeams (Underlying native function: HandleLocalPlayerChangedTeams 0xa45c39c)
