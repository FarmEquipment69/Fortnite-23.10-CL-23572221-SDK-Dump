...
class UFortMissionActivationWidget : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortMissionActivationWidget.RequestStartObjectiveState (Underlying native function: RequestStartObjectiveState 0xa7335e0)
	void RequestStartObjectiveState(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionActivationWidget.RequestDifficultyIncreaseState (Underlying native function: RequestDifficultyIncreaseState 0xa7335cc)
	void RequestDifficultyIncreaseState(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionActivationWidget.RequestDefaultState (Underlying native function: RequestDefaultState 0xa73357c)
	...
	// Function /Script/FortniteUI.FortMissionActivationWidget.GetCurrentState (Underlying native function: GetCurrentState 0xa731a30)
