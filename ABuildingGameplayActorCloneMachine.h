...
class ABuildingGameplayActorCloneMachine : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingGameplayActorCloneMachine.OnRep_RespawnServerEndTime (Underlying native function: OnRep_RespawnServerEndTime 0x8357a10)
	void OnRepRespawnServerEndTime(); // (Final | Native | Private)

	// Function /Script/FortniteGame.BuildingGameplayActorCloneMachine.OnRep_ActivationServerEndTime (Underlying native function: OnRep_ActivationServerEndTime 0x83576bc)
	void OnRepActivationServerEndTime(); // (Final | Native | Private)

	// Function /Script/FortniteGame.BuildingGameplayActorCloneMachine.OnCloneMachineSpawnsPlayer (Underlying native function: OnCloneMachineSpawnsPlayer 0x8317388)
	void OnCloneMachineSpawnsPlayer(class AFortPlayerPawn*& PlayerPawn); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteGame.BuildingGameplayActorCloneMachine.OnCloneMachineRespawningBegins (Underlying native function: OnCloneMachineRespawningBegins 0x835726c)
	void OnCloneMachineRespawningBegins(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteGame.BuildingGameplayActorCloneMachine.OnCloneMachineActivationBegins (Underlying native function: OnCloneMachineActivationBegins 0x7fbd6f0)
