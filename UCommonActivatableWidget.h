...
class UCommonActivatableWidget : public UCommonUserWidget
{
	...
	// Function /Script/CommonUI.CommonActivatableWidget.SetBindVisibilities (Underlying native function: SetBindVisibilities 0x662e924)
	...
	// Function /Script/CommonUI.CommonActivatableWidget.IsActivated (Underlying native function: IsActivated 0x29ebb78)
	bool IsActivated(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonActivatableWidget.GetDesiredFocusTarget (Underlying native function: GetDesiredFocusTarget 0x662cb44)
	class UWidget* GetDesiredFocusTarget(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonActivatableWidget.DeactivateWidget (Underlying native function: DeactivateWidget 0x662c1a4)
	...
	// Function /Script/CommonUI.CommonActivatableWidget.BindVisibilityToActivation (Underlying native function: BindVisibilityToActivation 0x662bfb0)
	void BindVisibilityToActivation(class UCommonActivatableWidget*& ActivatableWidget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonActivatableWidget.ActivateWidget (Underlying native function: ActivateWidget 0x662bc60)
