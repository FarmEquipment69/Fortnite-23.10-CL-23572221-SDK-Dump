...
class UFortItemInfoWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemInfoWidget.PopulateUsingItemDefinition (Underlying native function: PopulateUsingItemDefinition 0xa70943c)
	void PopulateUsingItemDefinition(class UFortItemDefinition*& NewItem); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemInfoWidget.PopulateUsingItem (Underlying native function: PopulateUsingItem 0xa709378)
