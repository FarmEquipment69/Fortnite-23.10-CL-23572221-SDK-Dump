...
class AControlRigControlActor : public AActor
{
	...
	// Function /Script/ControlRig.ControlRigControlActor.ResetControlActor (Underlying native function: ResetControlActor 0x77add3c)
	void ResetControlActor(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigControlActor.Refresh (Underlying native function: Refresh 0x77ad7dc)
	void Refresh(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigControlActor.Clear (Underlying native function: Clear 0x77aaeb4)
