...
class UFortAbilityTask_ApplyRootMotionFallingBoostForce : public UAbilityTask_ApplyRootMotion_Base
{
	...
	// Function /Script/FortniteGame.FortAbilityTask_ApplyRootMotionFallingBoostForce.OnLandedCallback (Underlying native function: OnLandedCallback 0x7e7122c)
	void OnLandedCallback(struct FHitResult& Hit); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortAbilityTask_ApplyRootMotionFallingBoostForce.ApplyRootMotionFallingBoostForce (Underlying native function: ApplyRootMotionFallingBoostForce 0x7e6dfe0)
