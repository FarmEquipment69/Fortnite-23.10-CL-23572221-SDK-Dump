...
class UFortNotificationEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortNotificationEntry.NativeStartNotificationOutro (Underlying native function: NativeStartNotificationOutro 0xa699508)
	void NativeStartNotificationOutro(); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortNotificationEntry.FinishNotificationOutro (Underlying native function: FinishNotificationOutro 0x854edfc)
	void FinishNotificationOutro(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortNotificationEntry.FinishNotificationIntro (Underlying native function: FinishNotificationIntro 0x71e6634)
