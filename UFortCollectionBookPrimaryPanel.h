...
class UFortCollectionBookPrimaryPanel : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnSummonInfoPanelExecuted (Underlying native function: OnSummonInfoPanelExecuted 0x71e947c)
	void OnSummonInfoPanelExecuted(bool& bPassThrough); // (Native | Event | Protected | HasOutParms | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnInputMethodChanged (Underlying native function: OnInputMethodChanged 0x71e81f4)
	void OnInputMethodChanged(enum ECommonInputType& CurrentInputType); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnCollectionBookSectionClicked (Underlying native function: OnCollectionBookSectionClicked 0x71e7f30)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnCollectionBookPageSelected (Underlying native function: OnCollectionBookPageSelected 0x71e7fb4)
	void OnCollectionBookPageSelected(class UFortCollectionBookPage*& SelectedPage); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnCollectionBookPageClicked (Underlying native function: OnCollectionBookPageClicked 0x71e7eac)
	void OnCollectionBookPageClicked(class UFortCollectionBookPage*& ClickedPage); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPrimaryPanel.OnBackActionExecuted (Underlying native function: OnBackActionExecuted 0x71e7c88)
