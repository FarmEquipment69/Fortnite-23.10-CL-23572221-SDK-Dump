...
class UCheckBox : public UContentWidget
{
	...
	// Function /Script/UMG.CheckBox.SetTouchMethod (Underlying native function: SetTouchMethod 0x9920ccc)
	void SetTouchMethod(struct TEnumAsByte<EButtonTouchMethod>& InTouchMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CheckBox.SetPressMethod (Underlying native function: SetPressMethod 0x9920420)
	void SetPressMethod(struct TEnumAsByte<EButtonPressMethod>& InPressMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CheckBox.SetIsChecked (Underlying native function: SetIsChecked 0x991fa08)
	void SetIsChecked(bool& InIsChecked); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CheckBox.SetClickMethod (Underlying native function: SetClickMethod 0x991f170)
	void SetClickMethod(struct TEnumAsByte<EButtonClickMethod>& InClickMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CheckBox.SetCheckedState (Underlying native function: SetCheckedState 0x991f070)
	void SetCheckedState(enum ECheckBoxState& InCheckedState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.CheckBox.IsPressed (Underlying native function: IsPressed 0x991e28c)
	bool IsPressed(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/UMG.CheckBox.IsChecked (Underlying native function: IsChecked 0x991e134)
	bool IsChecked(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/UMG.CheckBox.GetCheckedState (Underlying native function: GetCheckedState 0x991d760)
