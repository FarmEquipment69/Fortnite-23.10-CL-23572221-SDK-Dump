...
class AARDronePawn : public AHoverDronePawn
{
	...
	// Function /Script/FortniteGame.ARDronePawn.StopScaling (Underlying native function: StopScaling 0x8c673d8)
	void StopScaling(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.ARDronePawn.ScaleOut (Underlying native function: ScaleOut 0x8c66068)
	void ScaleOut(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.ARDronePawn.ScaleIn (Underlying native function: ScaleIn 0x8c66050)
