...
class ANPC_Pawn_Irwin_Prey_Burt_C : public ANPC_Pawn_Wildlife_Prey_Parent_C
{
	...
	class UFTP_NPC_Assignment_Loot_Omnivore_C* FTPNPCAssignmentLootOmnivore; // 0x3bf0 (0x8)
	class UFortAthenaCollisionReactionComponent* FortAthenaCollisionReactionRidingCharge; // 0x3bf8 (0x8)
	class UFortCharacterPartsComponent* FortCharacterParts; // 0x3c00 (0x8)
	struct FGameplayTagContainer InteractionPreventingTags; // 0x3c08 (0x20)
	struct FGameplayTag SprintImpactGameplayCueTag; // 0x3c28 (0x4)
	unsigned char unreflected_3c2c[0x4]; // 0x3c2c (0x4) 
	class UClass* GESprintImpactPawn; // 0x3c30 (0x8)
	class UClass* GESprintImpactVehicle; // 0x3c38 (0x8)
	struct FGameplayTagContainer InteractingPawnPreventingTags; // 0x3c40 (0x20)
	class UNiagaraSystem* LandingFX; // 0x3c60 (0x8)
	bool playLandingFX; // 0x3c68 (0x1)
