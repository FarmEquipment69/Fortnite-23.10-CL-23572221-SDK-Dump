...
class AFortAthenaMutator_Rounds : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.OnRep_RoundPhase (Underlying native function: OnRep_RoundPhase 0x8263678)
	void OnRepRoundPhase(enum EAthenaRoundsMutatorPhase& OldRoundPhase); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.OnRep_CurrentRoundNum (Underlying native function: OnRep_CurrentRoundNum 0x8263614)
	void OnRepCurrentRoundNum(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.OnMatchConditionTimingSatisfied (Underlying native function: OnMatchConditionTimingSatisfied 0x6f05250)
	void OnMatchConditionTimingSatisfied(enum EMatchConditionMutatorTimingType& TimingType); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x6f05250)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Final | 0x00000002 | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.GetRoundNum (Underlying native function: GetRoundNum 0x2d7b3d4)
	int GetRoundNum(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.GetPhase (Underlying native function: GetPhase 0x826275c)
	enum EAthenaRoundsMutatorPhase GetPhase(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Rounds.GetLastCompletedRoundNum (Underlying native function: GetLastCompletedRoundNum 0x82625b0)
