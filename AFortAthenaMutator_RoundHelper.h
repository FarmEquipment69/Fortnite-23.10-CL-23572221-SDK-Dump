...
class AFortAthenaMutator_RoundHelper : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_RoundHelper.StartNextRound (Underlying native function: StartNextRound 0x8263af4)
	void StartNextRound(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_RoundHelper.SetCurrentRound (Underlying native function: SetCurrentRound 0x82639d0)
	void SetCurrentRound(int& NewRound); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_RoundHelper.OnInitialTeleportComplete (Underlying native function: OnInitialTeleportComplete 0x8262e70)
	void OnInitialTeleportComplete(class AFortPlayerPawn*& PlayerPawn); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_RoundHelper.GetNumOfRounds (Underlying native function: GetNumOfRounds 0x662c63c)
	int GetNumOfRounds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_RoundHelper.GetCurrentRound (Underlying native function: GetCurrentRound 0x826257c)
