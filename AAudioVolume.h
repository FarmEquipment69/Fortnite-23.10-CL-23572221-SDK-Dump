...
class AAudioVolume : public AVolume
{
	...
	// Function /Script/Engine.AudioVolume.SetSubmixSendSettings (Underlying native function: SetSubmixSendSettings 0x9ad78e0)
	...
	// Function /Script/Engine.AudioVolume.SetSubmixOverrideSettings (Underlying native function: SetSubmixOverrideSettings 0x9ad7830)
	...
	// Function /Script/Engine.AudioVolume.SetReverbSettings (Underlying native function: SetReverbSettings 0x9ad7784)
	void SetReverbSettings(struct FReverbSettings& NewReverbSettings); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.AudioVolume.SetPriority (Underlying native function: SetPriority 0x9ad7700)
	void SetPriority(float& NewPriority); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioVolume.SetInteriorSettings (Underlying native function: SetInteriorSettings 0x9ad7664)
	void SetInteriorSettings(struct FInteriorSettings& NewInteriorSettings); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.AudioVolume.SetEnabled (Underlying native function: SetEnabled 0x9ad75bc)
	void SetEnabled(bool& bNewEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioVolume.OnRep_bEnabled (Underlying native function: OnRep_bEnabled 0x7b064c8)
