...
class UAthenaBroadcastSquadStatusWidget : public UAthenaEventMatchSquadWidgetBase
{
	...
	// Function /Script/FortniteUI.AthenaBroadcastSquadStatusWidget.HandleSquadIdChanged (Underlying native function: HandleSquadIdChanged 0xa43df08)
	void HandleSquadIdChanged(class UAthenaRemoteSquadViewData*& InSquadData, unsigned char& SquadId); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaBroadcastSquadStatusWidget.HandleFollowedPlayerChanged (Underlying native function: HandleFollowedPlayerChanged 0x1129214)
