...
class UFortLlamaStoreBase_Legacy : public UFortDirectAcquisitionWidgetBase_Legacy
{
	...
	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase_Legacy.SetupFocus (Underlying native function: SetupFocus 0x580cf20)
	void SetupFocus(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase_Legacy.OnStoreStateChanged (Underlying native function: OnStoreStateChanged 0x580ce80)
	void OnStoreStateChanged(enum EFortStoreState& NewStoreState); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortLlamaStoreBase_Legacy.OnStorePurchaseCompleted (Underlying native function: OnStorePurchaseCompleted 0x580ce00)
