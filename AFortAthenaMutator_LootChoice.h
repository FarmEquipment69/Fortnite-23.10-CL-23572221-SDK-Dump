...
class AFortAthenaMutator_LootChoice : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_LootChoice.SetLootSelection (Underlying native function: SetLootSelection 0x81fbe90)
	void SetLootSelection(enum ECustomLootSelection& NewSelection); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_LootChoice.GetLootSelection (Underlying native function: GetLootSelection 0x81f8034)
