...
class AFortLightningActor : public AFortClientOnlyActor
{
	...
	// Function /Script/FortniteGame.FortLightningActor.InitializeLightning (Underlying native function: InitializeLightning 0x85e7354)
	void InitializeLightning(class AActor*& InActorToNotify); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortLightningActor.GenerateBoltLocations (Underlying native function: GenerateBoltLocations 0x85e5c58)
	...
	// Function /Script/FortniteGame.FortLightningActor.CleanupLightning (Underlying native function: CleanupLightning 0x85e5974)
