...
class UFortGameEventNotifications : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortGameEventNotifications.HandleNotificationUpdateFinished (Underlying native function: HandleNotificationUpdateFinished 0xa698f60)
	void HandleNotificationUpdateFinished(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortGameEventNotifications.HandleDisplayDynamicQuestUpdate (Underlying native function: HandleDisplayDynamicQuestUpdate 0xa698b68)
	...
	// Function /Script/FortniteUI.FortGameEventNotifications.ActionFreedForNotifications (Underlying native function: ActionFreedForNotifications 0xa698000)
