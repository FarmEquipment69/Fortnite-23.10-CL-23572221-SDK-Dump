...
class AFortPickupsParent : public AFortPickupEffect
{
	...
	// Function /Script/FortniteGame.FortPickupsParent.SetupStretchMIDsInternal (Underlying native function: SetupStretchMIDsInternal 0x882a470)
	void SetupStretchMIDsInternal(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPickupsParent.SetupPickupMesh (Underlying native function: SetupPickupMesh 0x130c254)
	class UPrimitiveComponent* SetupPickupMesh(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPickupsParent.SetupPickupLight (Underlying native function: SetupPickupLight 0x182c504)
	...
	// Function /Script/FortniteGame.FortPickupsParent.SetRarityColor (Underlying native function: SetRarityColor 0x1658fd8)
	void SetRarityColor(struct TArray<struct FLinearColor>& RarityColors); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortPickupsParent.GetCosmeticPickupItem (Underlying native function: GetCosmeticPickupItem 0x8829264)
	class UFortItem* GetCosmeticPickupItem(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPickupsParent.GetClientCosmeticRarity (Underlying native function: GetClientCosmeticRarity 0x8829180)
