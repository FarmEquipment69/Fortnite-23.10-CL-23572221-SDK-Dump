...
class UFortProgressModal : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortProgressModal.SetTitle (Underlying native function: SetTitle 0xa735534)
	void SetTitle(struct FText& InTitle); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortProgressModal.SetIcon (Underlying native function: SetIcon 0xa733cd8)
	void SetIcon(struct FSlateBrush& InIcon); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortProgressModal.SetDescription (Underlying native function: SetDescription 0xa73398c)
	void SetDescription(struct FText& InDescription); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortProgressModal.InitializeModal (Underlying native function: InitializeModal 0xa732754)
