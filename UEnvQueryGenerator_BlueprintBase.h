...
class UEnvQueryGenerator_BlueprintBase : public UEnvQueryGenerator
{
	...
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.GetQuerier (Underlying native function: GetQuerier 0x9fee398)
	...
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedVector (Underlying native function: AddGeneratedVector 0x9fedc48)
	void AddGeneratedVector(struct FVector& GeneratedVector); // (Final | Native | Public | HasDefaults | BlueprintCallable | Const)

	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedActor (Underlying native function: AddGeneratedActor 0x9fedbc8)
