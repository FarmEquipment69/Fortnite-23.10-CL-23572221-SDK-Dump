...
class UCraftingObjectComponent : public UGameFrameworkComponent
{
	...
	// Function /Script/CraftingRuntime.CraftingObjectComponent.OnRep_CraftingObjectRepStateData (Underlying native function: OnRep_CraftingObjectRepStateData 0x6f57308)
	void OnRepCraftingObjectRepStateData(); // (Final | Native | Private)

	// Function /Script/CraftingRuntime.CraftingObjectComponent.HandlePickupCraftingItemPickedUp (Underlying native function: HandlePickupCraftingItemPickedUp 0x6f56d3c)
