...
class UFortBattlePassContext : public UBlueprintContextBase
{
	...
	// Function /Script/BattlePassBase.FortBattlePassContext.GetSeasonalCurrencies (Underlying native function: GetSeasonalCurrencies 0x6ec753c)
	...
	// Function /Script/BattlePassBase.FortBattlePassContext.GetLevelPurchaseDisclaimerText (Underlying native function: GetLevelPurchaseDisclaimerText 0x6ec74d0)
	struct FText GetLevelPurchaseDisclaimerText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassContext.GetDefaultDisclaimerText (Underlying native function: GetDefaultDisclaimerText 0x24cae3c)
	struct FText GetDefaultDisclaimerText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassContext.GetCurrentSeasonNumberAsText (Underlying native function: GetCurrentSeasonNumberAsText 0x1e096e8)
	struct FText GetCurrentSeasonNumberAsText(bool& bFullText); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassContext.GetCurrentChapterAsText (Underlying native function: GetCurrentChapterAsText 0x6ec73c0)
	struct FText GetCurrentChapterAsText(bool& bFullText); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassContext.CanPurchaseBattlePassLevel (Underlying native function: CanPurchaseBattlePassLevel 0x6ec72dc)
