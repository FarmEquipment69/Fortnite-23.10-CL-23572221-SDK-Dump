...
class UFortGameStateComponent_FrontEndFlowSTW : public UGameStateComponent
{
	...
	// Function /Script/FortniteGame.FortGameStateComponent_FrontEndFlowSTW.OnSatelliteAnnouncementEnded (Underlying native function: OnSatelliteAnnouncementEnded 0x8c64ee4)
	void OnSatelliteAnnouncementEnded(class AFortClientAnnouncement*& Announcement); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameStateComponent_FrontEndFlowSTW.OnNameHomebaseAnnouncementEnded (Underlying native function: OnNameHomebaseAnnouncementEnded 0x8c64688)
	void OnNameHomebaseAnnouncementEnded(class AFortClientAnnouncement*& Announcement); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameStateComponent_FrontEndFlowSTW.HandleClientEvent_HomebasePersonalized (Underlying native function: HandleClientEvent_HomebasePersonalized 0x8c63f3c)
