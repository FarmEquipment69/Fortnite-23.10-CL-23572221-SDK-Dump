...
class AFortAthenaMutator_MarkerUtilities : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MarkerUtilities.RestoreIndicatedActorCompassIcon (Underlying native function: RestoreIndicatedActorCompassIcon 0x8227ef0)
	void RestoreIndicatedActorCompassIcon(class AActor*& Actor); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_MarkerUtilities.OverrideIndicatedActorCompassIcon (Underlying native function: OverrideIndicatedActorCompassIcon 0x8227b50)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MarkerUtilities.GetIndicatedActorCompassIcon (Underlying native function: GetIndicatedActorCompassIcon 0x8224420)
