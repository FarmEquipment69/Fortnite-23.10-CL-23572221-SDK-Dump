...
class UFortControllerComponent_Interaction : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_Interaction.SetShouldAutoOpenSwingingDoors (Underlying native function: SetShouldAutoOpenSwingingDoors 0x845e8b0)
	void SetShouldAutoOpenSwingingDoors(bool& bOpenSwingingDoorsAutomatically); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.ServerNotifyStartLongUse (Underlying native function: ServerNotifyStartLongUse 0x845dfe8)
	void ServerNotifyStartLongUse(class AActor*& ReceivingActor); // (Net | NetReliable | Native | Event | Public | NetServer | 0x80000000)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.ServerNotifyEndLongUse (Underlying native function: ServerNotifyEndLongUse 0x845df48)
	void ServerNotifyEndLongUse(class AActor*& ReceivingActor); // (Net | NetReliable | Native | Event | Public | NetServer | 0x80000000)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.ServerAttemptInteract (Underlying native function: ServerAttemptInteract 0x845dd30)
	...
	// Function /Script/FortniteGame.FortControllerComponent_Interaction.OnExitAircraft (Underlying native function: OnExitAircraft 0x71e7eac)
	void OnExitAircraft(class AController*& ExitingController); // (Native | Public)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.OnEnterAircraft (Underlying native function: OnEnterAircraft 0x71e7f30)
	void OnEnterAircraft(class AController*& EnteringController); // (Native | Public)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.K2_GetInteractResponse (Underlying native function: K2_GetInteractResponse 0x845d2e8)
	class UFortInteractContextInfo* K2GetInteractResponse(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.GetInteractActor (Underlying native function: GetInteractActor 0x845d04c)
	class AActor* GetInteractActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.FixupInteractionWidgetsOnUnzoom (Underlying native function: FixupInteractionWidgetsOnUnzoom 0x845c990)
	void FixupInteractionWidgetsOnUnzoom(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.ClientSetInteractionDistanceOverride (Underlying native function: ClientSetInteractionDistanceOverride 0x845c7f0)
	void ClientSetInteractionDistanceOverride(float& Distance); // (Final | Net | NetReliable | Native | Event | Private | NetClient)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.ClientResetInteractionDistanceOverride (Underlying native function: ClientResetInteractionDistanceOverride 0x662da48)
	void ClientResetInteractionDistanceOverride(); // (Final | Net | NetReliable | Native | Event | Private | NetClient)

	// Function /Script/FortniteGame.FortControllerComponent_Interaction.BP_ServerAttemptInteractInternal (Underlying native function: BP_ServerAttemptInteractInternal 0x845c228)
