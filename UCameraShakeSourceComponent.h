...
class UCameraShakeSourceComponent : public USceneComponent
{
	...
	// Function /Script/Engine.CameraShakeSourceComponent.StopAllCameraShakesOfType (Underlying native function: StopAllCameraShakesOfType 0x9af2a7c)
	void StopAllCameraShakesOfType(class UClass*& InCameraShake, bool& bImmediately); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CameraShakeSourceComponent.StopAllCameraShakes (Underlying native function: StopAllCameraShakes 0x9af29fc)
	void StopAllCameraShakes(bool& bImmediately); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CameraShakeSourceComponent.StartCameraShake (Underlying native function: StartCameraShake 0x9af28a8)
	...
	// Function /Script/Engine.CameraShakeSourceComponent.Start (Underlying native function: Start 0x9af2894)
	void Start(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CameraShakeSourceComponent.GetAttenuationFactor (Underlying native function: GetAttenuationFactor 0x9aeecd4)
