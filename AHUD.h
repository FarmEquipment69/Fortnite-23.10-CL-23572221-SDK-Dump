...
class AHUD : public AActor
{
	...
	// Function /Script/Engine.HUD.ShowHUD (Underlying native function: ShowHUD 0x2466474)
	void ShowHUD(); // (Exec | Native | Public)

	// Function /Script/Engine.HUD.ShowDebugToggleSubCategory (Underlying native function: ShowDebugToggleSubCategory 0x9c08658)
	void ShowDebugToggleSubCategory(struct FName& category); // (Final | Exec | Native | Public)

	// Function /Script/Engine.HUD.ShowDebugForReticleTargetToggle (Underlying native function: ShowDebugForReticleTargetToggle 0x9c085c0)
	void ShowDebugForReticleTargetToggle(class UClass*& DesiredClass); // (Final | Exec | Native | Public)

	// Function /Script/Engine.HUD.ShowDebug (Underlying native function: ShowDebug 0x9c0853c)
	void ShowDebug(struct FName& DebugType); // (Exec | Native | Public)

	// Function /Script/Engine.HUD.RemoveDebugText (Underlying native function: RemoveDebugText 0x9c08474)
	void RemoveDebugText(class AActor*& SrcActor, bool& bLeaveDurationText); // (Final | Net | NetReliable | Native | Event | Public | NetClient)

	// Function /Script/Engine.HUD.RemoveAllDebugStrings (Underlying native function: RemoveAllDebugStrings 0x9c083dc)
	...
	// Function /Script/Engine.HUD.Project (Underlying native function: Project 0x9c082e8)
	...
	// Function /Script/Engine.HUD.PreviousDebugTarget (Underlying native function: PreviousDebugTarget 0x88ecb28)
	void PreviousDebugTarget(); // (Exec | Native | Public)

	// Function /Script/Engine.HUD.NextDebugTarget (Underlying native function: NextDebugTarget 0x2e2012c)
	void NextDebugTarget(); // (Exec | Native | Public)

	// Function /Script/Engine.HUD.GetTextSize (Underlying native function: GetTextSize 0x9c08068)
	...
	// Function /Script/Engine.HUD.GetOwningPlayerController (Underlying native function: GetOwningPlayerController 0x6f89394)
	class APlayerController* GetOwningPlayerController(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.HUD.GetOwningPawn (Underlying native function: GetOwningPawn 0x9c08048)
	class APawn* GetOwningPawn(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.HUD.GetActorsInSelectionRectangle (Underlying native function: GetActorsInSelectionRectangle 0x9c07e28)
	...
	// Function /Script/Engine.HUD.DrawTextureSimple (Underlying native function: DrawTextureSimple 0x9c07bec)
	...
	// Function /Script/Engine.HUD.DrawTexture (Underlying native function: DrawTexture 0x9c075fc)
	...
	// Function /Script/Engine.HUD.DrawText (Underlying native function: DrawText 0x9c0730c)
	...
	// Function /Script/Engine.HUD.DrawRect (Underlying native function: DrawRect 0x9c07180)
	...
	// Function /Script/Engine.HUD.DrawMaterialTriangle (Underlying native function: DrawMaterialTriangle 0x9c06de0)
	...
	// Function /Script/Engine.HUD.DrawMaterialSimple (Underlying native function: DrawMaterialSimple 0x9c06ad8)
	...
	// Function /Script/Engine.HUD.DrawMaterial (Underlying native function: DrawMaterial 0x9c06580)
	...
	// Function /Script/Engine.HUD.DrawLine (Underlying native function: DrawLine 0x9c063ac)
	...
	// Function /Script/Engine.HUD.Deproject (Underlying native function: Deproject 0x9c0624c)
	...
	// Function /Script/Engine.HUD.AddHitBox (Underlying native function: AddHitBox 0x9c060ac)
	...
	// Function /Script/Engine.HUD.AddDebugText (Underlying native function: AddDebugText 0x9c059b0)
