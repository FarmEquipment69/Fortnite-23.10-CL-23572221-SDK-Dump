...
class UFortEmotePicker : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortEmotePicker.OnControllerComponentAttached (Underlying native function: OnControllerComponentAttached 0xa3760c4)
	...
	// Function /Script/FortniteUI.FortEmotePicker.HandleExternalEmoteRemoved (Underlying native function: HandleExternalEmoteRemoved 0xa3750b8)
	void HandleExternalEmoteRemoved(struct FName& ActionName); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortEmotePicker.HandleExternalEmoteAdded (Underlying native function: HandleExternalEmoteAdded 0xa375038)
