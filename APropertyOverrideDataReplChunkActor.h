...
class APropertyOverrideDataReplChunkActor : public AInfo
{
	...
	// Function /Script/FortniteGame.PropertyOverrideDataReplChunkActor.OnRep_PartialReplOverrides (Underlying native function: OnRep_PartialReplOverrides 0x87622c0)
	void OnRepPartialReplOverrides(); // (Final | Native | Public)

	// Function /Script/FortniteGame.PropertyOverrideDataReplChunkActor.OnRep_ChunkIndex (Underlying native function: OnRep_ChunkIndex 0x8762214)
