...
class UCreativeGameStreamDeviceCoordinatorComponent : public UPlayspaceComponent
{
	...
	// Function /Script/CRD_GameStreamRuntime.CreativeGameStreamDeviceCoordinatorComponent.OnMinigameStateChanged (Underlying native function: OnMinigameStateChanged 0x6fbd4fc)
