...
class AFortAthenaMutator_WeaponSettings : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_WeaponSettings.RemoveDataSource (Underlying native function: RemoveDataSource 0x828569c)
	void RemoveDataSource(class UObject*& DataSource); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_WeaponSettings.AddDataSourceForTeam (Underlying native function: AddDataSourceForTeam 0x8283470)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_WeaponSettings.AddDataSourceForClassSlot (Underlying native function: AddDataSourceForClassSlot 0x8283274)
