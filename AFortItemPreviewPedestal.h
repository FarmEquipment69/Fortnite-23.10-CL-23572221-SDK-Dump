...
class AFortItemPreviewPedestal : public AFortItemPlacementActor
{
	...
	// Function /Script/FortniteUI.FortItemPreviewPedestal.PreviewItemBP (Underlying native function: PreviewItemBP 0xa5f6050)
	void PreviewItemBP(class UFortItem*& Item); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPreviewPedestal.ClearDisplay (Underlying native function: ClearDisplay 0xa5f470c)
