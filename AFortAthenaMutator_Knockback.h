...
class AFortAthenaMutator_Knockback : public AFortAthenaMutator
{
	...
	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.SetPlayersShouldBreakThroughStructures (Underlying native function: SetPlayersShouldBreakThroughStructures 0x70cf1cc)
	...
	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.HandleBlockedCharacterMovement (Underlying native function: HandleBlockedCharacterMovement 0x70cf058)
	...
	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.GetPercentDamageMediumMaxThreshold (Underlying native function: GetPercentDamageMediumMaxThreshold 0x70cf024)
	float GetPercentDamageMediumMaxThreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.GetPercentDamageLowMaxThreshold (Underlying native function: GetPercentDamageLowMaxThreshold 0x70ceff0)
	float GetPercentDamageLowMaxThreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.GetKnockbackMultiplierInitialValue (Underlying native function: GetKnockbackMultiplierInitialValue 0x70cefd8)
	float GetKnockbackMultiplierInitialValue(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/KnockbackRuntime.FortAthenaMutator_Knockback.GetAllPlayersKnockbackData (Underlying native function: GetAllPlayersKnockbackData 0x70cef34)
