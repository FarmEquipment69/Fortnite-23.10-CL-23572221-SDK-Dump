...
class UFortNotificationEntry_Quest : public UFortNotificationEntry
{
	...
	// Function /Script/FortniteUI.FortNotificationEntry_Quest.TrackCurrentQuest (Underlying native function: TrackCurrentQuest 0xa69a178)
	void TrackCurrentQuest(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortNotificationEntry_Quest.ShowNextStagedObjectiveInformation (Underlying native function: ShowNextStagedObjectiveInformation 0xa69a064)
