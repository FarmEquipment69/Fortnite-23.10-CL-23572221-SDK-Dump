...
class UAnimNotifyState : public UObject
{
	...
	// Function /Script/Engine.AnimNotifyState.GetNotifyName (Underlying native function: GetNotifyName 0x9aaab40)
	struct FString GetNotifyName(); // (Native | Event | Public | BlueprintEvent | Const)

	// Function /Script/Engine.AnimNotifyState.GetDefaultTriggerWeightThreshold (Underlying native function: GetDefaultTriggerWeightThreshold 0x9aaa9f4)
