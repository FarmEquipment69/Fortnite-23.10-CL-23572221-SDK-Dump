...
class UFortGameplayAbility_ReloadTracker : public UFortGameplayAbility
{
	...
	// Function /Script/FortniteGame.FortGameplayAbility_ReloadTracker.OnRep_TimesReloaded (Underlying native function: OnRep_TimesReloaded 0x8e431d4)
	void OnRepTimesReloaded(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameplayAbility_ReloadTracker.GetScourceWeaponTimesReloaded (Underlying native function: GetScourceWeaponTimesReloaded 0x8e423b0)
