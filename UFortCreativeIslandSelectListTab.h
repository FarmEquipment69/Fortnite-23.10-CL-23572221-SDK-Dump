...
class UFortCreativeIslandSelectListTab : public UFortCreativeIslandSelectTab
{
	...
	// Function /Script/FortniteUI.FortCreativeIslandSelectListTab.HandleListScrolled (Underlying native function: HandleListScrolled 0xa4fd4ac)
	void HandleListScrolled(float& ItemOffset, float& DistanceRemaining); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCreativeIslandSelectListTab.HandleIslandSelectionChanged (Underlying native function: HandleIslandSelectionChanged 0xa4fd42c)
