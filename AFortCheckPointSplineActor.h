...
class AFortCheckPointSplineActor : public AActor
{
	...
	// Function /Script/FortniteGame.FortCheckPointSplineActor.ShowSplineMeshes (Underlying native function: ShowSplineMeshes 0x82ab2bc)
	void ShowSplineMeshes(int& SplineIndexStart, int& SplineIndexEnd); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCheckPointSplineActor.ShowMapUI (Underlying native function: ShowMapUI 0x82ab1fc)
	void ShowMapUI(int& SplineIndexStart, int& SplineIndexEnd); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCheckPointSplineActor.ShowFullMapUI (Underlying native function: ShowFullMapUI 0x82ab1e8)
	void ShowFullMapUI(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCheckPointSplineActor.HideSplineMeshes (Underlying native function: HideSplineMeshes 0x82a9eac)
	void HideSplineMeshes(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCheckPointSplineActor.HideMapUI (Underlying native function: HideMapUI 0x82a9e94)
