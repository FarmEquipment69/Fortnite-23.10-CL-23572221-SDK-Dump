...
class UFortCosmeticLoadoutCard : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortCosmeticLoadoutCard.HandleDifferentHeroLoadoutActivated (Underlying native function: HandleDifferentHeroLoadoutActivated 0xa6c6190)
	void HandleDifferentHeroLoadoutActivated(class UFortMcpProfileCampaign*& Profile); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCosmeticLoadoutCard.GetCharacterPreviewImage (Underlying native function: GetCharacterPreviewImage 0xa6c5660)
