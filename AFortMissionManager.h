...
class AFortMissionManager : public AActor
{
	...
	// Function /Script/FortniteGame.FortMissionManager.ShouldShowSecondaryMissionHeaders (Underlying native function: ShouldShowSecondaryMissionHeaders 0x88eedc4)
	bool ShouldShowSecondaryMissionHeaders(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMissionManager.OnRep_MissionUIActors (Underlying native function: OnRep_MissionUIActors 0x3057b24)
	void OnRepMissionUIActors(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMissionManager.OnRep_EarnedBadgesArray (Underlying native function: OnRep_EarnedBadgesArray 0x88ecb40)
	void OnRepEarnedBadgesArray(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMissionManager.OnRep_CurrentUIFocusedMission (Underlying native function: OnRep_CurrentUIFocusedMission 0x88ecb28)
	void OnRepCurrentUIFocusedMission(); // (Native | Public)

	// Function /Script/FortniteGame.FortMissionManager.OnRep_AllMissionEnemyClasses (Underlying native function: OnRep_AllMissionEnemyClasses 0x29fce3c)
	void OnRepAllMissionEnemyClasses(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMissionManager.MissionsUpdated (Underlying native function: MissionsUpdated 0x88ec6d8)
	void MissionsUpdated(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMissionManager.GetSpawnLocationActorsThatHaveAddedTagsMatchingQuery (Underlying native function: GetSpawnLocationActorsThatHaveAddedTagsMatchingQuery 0x88eaba4)
	...
	// Function /Script/FortniteGame.FortMissionManager.GetSpawnLocationActorsMatchingEntryItemQuery (Underlying native function: GetSpawnLocationActorsMatchingEntryItemQuery 0x88ea9f0)
