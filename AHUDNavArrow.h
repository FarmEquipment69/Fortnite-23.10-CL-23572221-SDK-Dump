...
class AHUDNavArrow : public ANavArrow
{
	...
	// Function /Script/FortniteGame.HUDNavArrow.SetDepartRadius (Underlying native function: SetDepartRadius 0x82aacd8)
	void SetDepartRadius(float& InDepartRadius); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.HUDNavArrow.SetApproachRadius (Underlying native function: SetApproachRadius 0x82aac50)
	void SetApproachRadius(float& InApproachRadius); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.HUDNavArrow.InitializeTrackerComponent (Underlying native function: InitializeTrackerComponent 0x82a9ec4)
