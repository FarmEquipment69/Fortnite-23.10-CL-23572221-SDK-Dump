...
class AFortAthenaMutator_MatchConditionManager : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MatchConditionManager.OnSatisfied (Underlying native function: OnSatisfied 0x6d23b2c)
	void OnSatisfied(class AFortAthenaMutator_MatchCondition*& MatchConditionMutator, bool& bSatisfied); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_MatchConditionManager.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x6f05250)
