...
class UFortItemPickerBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemPickerBase.TryCommitSelectedItem (Underlying native function: TryCommitSelectedItem 0xa6c8b1c)
	bool TryCommitSelectedItem(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPickerBase.SetSelectedItem (Underlying native function: SetSelectedItem 0xa6c87dc)
	void SetSelectedItem(class UFortItem*& ItemToSelect); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPickerBase.SetSelectedIndex (Underlying native function: SetSelectedIndex 0xa6c8750)
	...
	// Function /Script/FortniteUI.FortItemPickerBase.IsNullItemExplicitlySelected (Underlying native function: IsNullItemExplicitlySelected 0xa6c71b8)
	bool IsNullItemExplicitlySelected(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemPickerBase.GetSelectedItem (Underlying native function: GetSelectedItem 0xa6c5d44)
	class UFortItem* GetSelectedItem(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemPickerBase.GetListViewInterface (Underlying native function: GetListViewInterface 0xa6c5c3c)
	struct TScriptInterface<class IFortItemListViewInterface> GetListViewInterface(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPickerBase.GetIndexForItem (Underlying native function: GetIndexForItem 0xa6c59fc)
	int GetIndexForItem(class UFortItem*& Item); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemPickerBase.ClearSelection (Underlying native function: ClearSelection 0xa6c4c88)
	void ClearSelection(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPickerBase.CenterSelectedItemTileWidget (Underlying native function: CenterSelectedItemTileWidget 0xa6c4c4c)
	void CenterSelectedItemTileWidget(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPickerBase.CanItemBeComitted (Underlying native function: CanItemBeComitted 0xa6c4b38)
