...
class UFortAudioToMPCComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortAudioToMPCComponent.RemoveTrackedAudioComponent (Underlying native function: RemoveTrackedAudioComponent 0x863fe2c)
	...
	// Function /Script/FortniteGame.FortAudioToMPCComponent.GetCachedMagnitudeForChannel (Underlying native function: GetCachedMagnitudeForChannel 0x863f4dc)
	float GetCachedMagnitudeForChannel(int& ChannelIndex); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAudioToMPCComponent.GetCachedAverageMagnitude (Underlying native function: GetCachedAverageMagnitude 0x863f4b4)
	float GetCachedAverageMagnitude(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAudioToMPCComponent.AddTrackedAudioComponent (Underlying native function: AddTrackedAudioComponent 0x863f154)
