...
class UFortCreativeQuestHUDWidget : public UMinigameWidgetBase
{
	...
	// Function /Script/FortniteUI.FortCreativeQuestHUDWidget.SetToQuest (Underlying native function: SetToQuest 0xa587c5c)
	void SetToQuest(int& questIndex, bool& bForceUpdate); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeQuestHUDWidget.SetQuestIndex (Underlying native function: SetQuestIndex 0xa587b60)
