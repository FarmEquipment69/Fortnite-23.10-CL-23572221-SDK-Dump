...
class UFortAthenaAISpawnerDataComponent_InventoryBase : public UFortAthenaAISpawnerDataComponent
{
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_InventoryBase.SetInventoryItems (Underlying native function: SetInventoryItems 0xa1f675c)
	void SetInventoryItems(struct TArray<struct FItemAndCount>& InItems); // (Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_InventoryBase.GetInventoryItems (Underlying native function: GetInventoryItems 0xa1f66bc)
