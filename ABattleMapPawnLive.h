...
class ABattleMapPawnLive : public AFortReplaySpectatorPawnBase
{
	...
	// Function /Script/FortniteGame.BattleMapPawnLive.ZoomIn (Underlying native function: ZoomIn 0x831e658)
	void ZoomIn(float& Val); // (Final | 0x00000002 | Exec | Native | Public)

	// Function /Script/FortniteGame.BattleMapPawnLive.HandleTimeIndicatorUpdatedSegment (Underlying native function: HandleTimeIndicatorUpdatedSegment 0x8318064)
	...
	// Function /Script/FortniteGame.BattleMapPawnLive.HandleClickReleased (Underlying native function: HandleClickReleased 0x8317cf4)
	bool HandleClickReleased(struct FKey& ButtonReleased); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BattleMapPawnLive.HandleClickPressed (Underlying native function: HandleClickPressed 0x8317c10)
	bool HandleClickPressed(struct FKey& ButtonPressed); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BattleMapPawnLive.BP_SetTimelineMode (Underlying native function: BP_SetTimelineMode 0x831743c)
	bool BPSetTimelineMode(bool& bEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BattleMapPawnLive.BP_IsOnTimelineMode (Underlying native function: BP_IsOnTimelineMode 0x831740c)
