...
class UFortProjectileMoveComp_Drunk : public UFortProjectileMovementComponent
{
	...
	// Function /Script/FortniteGame.FortProjectileMoveComp_Drunk.SetDrunkConfig (Underlying native function: SetDrunkConfig 0x849719c)
	void SetDrunkConfig(struct FProjectileMovementDrunkConfig& NewConfig); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortProjectileMoveComp_Drunk.OnRep_RandSeed (Underlying native function: OnRep_RandSeed 0x8496d0c)
