...
class AGameplayVolume : public AActor
{
	...
	// Function /Script/PlayspaceSystem.GameplayVolume.UpdateSize (Underlying native function: UpdateSize 0x6ca3518)
	void UpdateSize(struct FVector& NewScale); // (Native | Public | HasOutParms | HasDefaults)

	// Function /Script/PlayspaceSystem.GameplayVolume.OnOverlappedPawnControllerChanged (Underlying native function: OnOverlappedPawnControllerChanged 0x6ca3188)
	...
	// Function /Script/PlayspaceSystem.GameplayVolume.InitializeBoundsComponent (Underlying native function: InitializeBoundsComponent 0x6ca2dd4)
	void InitializeBoundsComponent(class UOverlapComponent*& NewBoundsComponent); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/PlayspaceSystem.GameplayVolume.GetPlayspace (Underlying native function: GetPlayspace 0x259f780)
