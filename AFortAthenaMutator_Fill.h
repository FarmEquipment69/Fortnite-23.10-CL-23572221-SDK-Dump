...
class AFortAthenaMutator_Fill : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Fill.OnPlaylistLoaded (Underlying native function: OnPlaylistLoaded 0x81fac14)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Fill.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81fa674)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Fill.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x81fa108)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | 0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Fill.GetLavaSupportLevel (Underlying native function: GetLavaSupportLevel 0x81f83fc)
	float GetLavaSupportLevel(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Fill.GetLavaFloor (Underlying native function: GetLavaFloor 0x81f83e4)
