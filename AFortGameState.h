...
class AFortGameState : public AFortGameStateBase
{
	...
	// Function /Script/FortniteGame.FortGameState.SetPlayerRespawningBlocked_Temporarily (Underlying native function: SetPlayerRespawningBlocked_Temporarily 0x86a1150)
	void SetPlayerRespawningBlockedTemporarily(bool& bBlock); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameState.RunPerfMemCheatScript (Underlying native function: RunPerfMemCheatScript 0x86a05d8)
	void RunPerfMemCheatScript(bool& bStartStatFiles); // (Net | NetReliable | Native | Event | NetMulticast | Public)

	// Function /Script/FortniteGame.FortGameState.OnRep_WorldManager (Underlying native function: OnRep_WorldManager 0x3057b3c)
	void OnRepWorldManager(); // (Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_WorldDaysElapsed (Underlying native function: OnRep_WorldDaysElapsed 0x304cfec)
	void OnRepWorldDaysElapsed(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_Teams (Underlying native function: OnRep_Teams 0x869ffcc)
	void OnRepTeams(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameState.OnRep_RecorderPlayerState (Underlying native function: OnRep_RecorderPlayerState 0x869ff1c)
	void OnRepRecorderPlayerState(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_PoiManager (Underlying native function: OnRep_PoiManager 0x2e16a00)
	void OnRepPoiManager(); // (Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_PawnForReplayRelevancy (Underlying native function: OnRep_PawnForReplayRelevancy 0x24f660c)
	void OnRepPawnForReplayRelevancy(class AFortPawn*& OldPawnForReplayRelevancy); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_MusicManagerSubclass (Underlying native function: OnRep_MusicManagerSubclass 0x869fe94)
	void OnRepMusicManagerSubclass(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_MusicManagerBank (Underlying native function: OnRep_MusicManagerBank 0x869fe2c)
	void OnRepMusicManagerBank(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_MissionManager (Underlying native function: OnRep_MissionManager 0x869fe00)
	void OnRepMissionManager(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_GameSessionID (Underlying native function: OnRep_GameSessionID 0x24b8434)
	void OnRepGameSessionID(); // (Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_GameplayState (Underlying native function: OnRep_GameplayState 0x2df23ac)
	void OnRepGameplayState(); // (Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_FeedbackManager (Underlying native function: OnRep_FeedbackManager 0x273fd14)
	void OnRepFeedbackManager(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_CurrentWUID (Underlying native function: OnRep_CurrentWUID 0x167f950)
	void OnRepCurrentWUID(); // (Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_AnnouncementManager (Underlying native function: OnRep_AnnouncementManager 0x273fd14)
	void OnRepAnnouncementManager(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.OnRep_AdditionalPlaylistLevelsStreamed (Underlying native function: OnRep_AdditionalPlaylistLevelsStreamed 0x869fcf0)
	void OnRepAdditionalPlaylistLevelsStreamed(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameState.OnFinishedStreamingAdditionalPlaylistLevel (Underlying native function: OnFinishedStreamingAdditionalPlaylistLevel 0x869fcc4)
	void OnFinishedStreamingAdditionalPlaylistLevel(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameState.OnFinishedShowingAdditionalPlaylistLevel (Underlying native function: OnFinishedShowingAdditionalPlaylistLevel 0x869fcb0)
	void OnFinishedShowingAdditionalPlaylistLevel(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortGameState.GetWorldDaysElapsed (Underlying native function: GetWorldDaysElapsed 0x2d7b224)
	int GetWorldDaysElapsed(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetPoiManager (Underlying native function: GetPoiManager 0x869ed44)
	class AFortPoiManager* GetPoiManager(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetPlayerRespawningBlocked_Temporarily (Underlying native function: GetPlayerRespawningBlocked_Temporarily 0x869ecc0)
	bool GetPlayerRespawningBlockedTemporarily(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetMiniMapInterface (Underlying native function: GetMiniMapInterface 0x869ec38)
	struct TScriptInterface<class IFortMiniMapInterface> GetMiniMapInterface(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameState.GetMatchTime (Underlying native function: GetMatchTime 0x869ec0c)
	float GetMatchTime(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetHUDElementsToShow (Underlying native function: GetHUDElementsToShow 0x869eb54)
	struct FGameplayTagContainer GetHUDElementsToShow(class APawn*& Pawn); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetHUDElementsToHide (Underlying native function: GetHUDElementsToHide 0x869ea9c)
	struct FGameplayTagContainer GetHUDElementsToHide(class APawn*& Pawn); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetGameSessionID (Underlying native function: GetGameSessionID 0x869e814)
	struct FString GetGameSessionID(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.GetGameplayState (Underlying native function: GetGameplayState 0x869e960)
	struct TEnumAsByte<EFortGameplayState> GetGameplayState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.DemoEndOfDayRecap (Underlying native function: DemoEndOfDayRecap 0x869e5cc)
	void DemoEndOfDayRecap(); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortGameState.DBNOEnabledForGameMode (Underlying native function: DBNOEnabledForGameMode 0x869dc68)
	bool DBNOEnabledForGameMode(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameState.DbgSphereSendToAllInternal_DoNotCall (Underlying native function: DbgSphereSendToAllInternal_DoNotCall 0x869e378)
	...
	// Function /Script/FortniteGame.FortGameState.DbgLineSendToAllInternal_DoNotCall (Underlying native function: DbgLineSendToAllInternal_DoNotCall 0x869e16c)
	...
	// Function /Script/FortniteGame.FortGameState.DbgCapsuleSendToAllInternal_DoNotCall (Underlying native function: DbgCapsuleSendToAllInternal_DoNotCall 0x869ded4)
	...
	// Function /Script/FortniteGame.FortGameState.DbgBoxSendToAllInternal_DoNotCall (Underlying native function: DbgBoxSendToAllInternal_DoNotCall 0x869dc84)
	...
	// Function /Script/FortniteGame.FortGameState.CopyGameSessionIdToClipboard (Underlying native function: CopyGameSessionIdToClipboard 0x869dc3c)
	void CopyGameSessionIdToClipboard(); // (Final | Exec | Native | Protected)

	// Function /Script/FortniteGame.FortGameState.Client_RefreshEventCalendar (Underlying native function: Client_RefreshEventCalendar 0x150911c)
	void ClientRefreshEventCalendar(); // (Net | NetReliable | Native | Event | NetMulticast | Protected)

	// Function /Script/FortniteGame.FortGameState.Client_InitiateEndOfDayRecap (Underlying native function: Client_InitiateEndOfDayRecap 0x869dba4)
