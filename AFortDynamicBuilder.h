...
class AFortDynamicBuilder : public ABuildingActor
{
	...
	// Function /Script/FortniteGame.FortDynamicBuilder.RemoveExistingActors (Underlying native function: RemoveExistingActors 0x83ad660)
	void RemoveExistingActors(); // (Final | BlueprintAuthorityOnly | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortDynamicBuilder.CreateBuilder (Underlying native function: CreateBuilder 0x83aa794)
