...
class ABuildingItemWeaponUpgradeActor : public ABuildingItemCollectorActor
{
	...
	// Function /Script/FortniteGame.BuildingItemWeaponUpgradeActor.OnRep_AllowSecondInteraction (Underlying native function: OnRep_AllowSecondInteraction 0x8387728)
	void OnRepAllowSecondInteraction(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingItemWeaponUpgradeActor.FloorDestroyed (Underlying native function: FloorDestroyed 0x8383410)
