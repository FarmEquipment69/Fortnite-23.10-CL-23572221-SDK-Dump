...
class AFortScriptedAction : public AActor
{
	...
	// Function /Script/FortniteGame.FortScriptedAction.GetParams (Underlying native function: GetParams 0x8760fe8)
	void GetParams(struct FFortScriptedActionParams& Params); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortScriptedAction.Execute (Underlying native function: Execute 0x8760cf4)
	void Execute(struct FFortScriptedActionParams& Params); // (0x00000002 | Native | Event | Public | HasOutParms | BlueprintEvent)

	// Function /Script/FortniteGame.FortScriptedAction.CompleteAction (Underlying native function: CompleteAction 0x8760c48)
	void CompleteAction(bool& bRegisterActionAgain); // (Final | 0x00000002 | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortScriptedAction.CanExecute (Underlying native function: CanExecute 0x87608cc)
	bool CanExecute(struct FFortScriptedActionParams& Params); // (0x00000002 | Native | Event | Public | HasOutParms | BlueprintEvent | Const)

	// Function /Script/FortniteGame.FortScriptedAction.CancelAction (Underlying native function: CancelAction 0x87609cc)
