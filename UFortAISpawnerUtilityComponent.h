...
class UFortAISpawnerUtilityComponent : public UActorComponent
{
	...
	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.StartEnvironmentQuery (Underlying native function: StartEnvironmentQuery 0xa09ff38)
	void StartEnvironmentQuery(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.SetQueryRadius (Underlying native function: SetQueryRadius 0xa09f6c4)
	void SetQueryRadius(float& Radius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.SetMinigame (Underlying native function: SetMinigame 0xa09f458)
	void SetMinigame(class AFortMinigame*& Minigame); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.SetEQSQuery (Underlying native function: SetEQSQuery 0xa09f0d8)
	void SetEQSQuery(struct TWeakObjectPtr<class UEnvQuery>& SelectedEQSQuery); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.RequestSpawn (Underlying native function: RequestSpawn 0xa09ef24)
	...
	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.OnUnownedPawnDied (Underlying native function: OnUnownedPawnDied 0xa09ea4c)
	...
	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.IsSpawnCountCapped (Underlying native function: IsSpawnCountCapped 0x24f75e4)
	bool IsSpawnCountCapped(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAISpawnerUtilityComponent.HandleUnownedPawnSpawned (Underlying native function: HandleUnownedPawnSpawned 0xa09d034)
