...
class ASpecialEventScript : public AInfo
{
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.UpdateMasterSequence (Underlying native function: UpdateMasterSequence 0x736251c)
	void UpdateMasterSequence(float& Time); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex (Underlying native function: StartEventAtIndex 0x7361980)
	void StartEventAtIndex(int& InStartingIndex); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.SetLocalPlayersSignificantForSpecialEventSequence (Underlying native function: SetLocalPlayersSignificantForSpecialEventSequence 0x7360df8)
	void SetLocalPlayersSignificantForSpecialEventSequence(bool& bIsSignificant); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.OnRep_ReplicatedActivePhaseIndex (Underlying native function: OnRep_ReplicatedActivePhaseIndex 0x735f148)
	void OnRepReplicatedActivePhaseIndex(); // (Final | Native | Protected)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.GetActivePhaseIndex (Underlying native function: GetActivePhaseIndex 0x735b994)
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.AttemptStartNextPhase (Underlying native function: AttemptStartNextPhase 0x7359fe8)
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventScript.AttemptFinishPhase (Underlying native function: AttemptFinishPhase 0x7359f68)
