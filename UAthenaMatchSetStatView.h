...
class UAthenaMatchSetStatView : public UAthenaMatchStatView
{
	...
	// Function /Script/FortniteUI.AthenaMatchSetStatView.GetOwningSeason (Underlying native function: GetOwningSeason 0xa43cdc0)
	class UAthenaSeasonStats* GetOwningSeason(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaMatchSetStatView.GetBestMatchViews (Underlying native function: GetBestMatchViews 0xa43c608)
