...
class UFortCollisionAudioComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCollisionAudioComponent.SetCollisionSoundAtIndex (Underlying native function: SetCollisionSoundAtIndex 0x2425608)
	void SetCollisionSoundAtIndex(int& Index, class USoundBase*& SoundToUse); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCollisionAudioComponent.OnCollision (Underlying native function: OnCollision 0x1f39f04)
