...
class UFortPerksWidget_NUI : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortPerksWidget_NUI.SetState (Underlying native function: SetState 0xa7f6040)
	void SetState(enum EFortPerksWidgetState& InState, class UFortHero*& InEvolutionOption); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortPerksWidget_NUI.SetHero (Underlying native function: SetHero 0xa7f5370)
	void SetHero(class UFortHero*& InHero); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortPerksWidget_NUI.ProcessPerkTiers (Underlying native function: ProcessPerkTiers 0xa7f341c)
	void ProcessPerkTiers(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortPerksWidget_NUI.ProcessPerks (Underlying native function: ProcessPerks 0xa7f3430)
	void ProcessPerks(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortPerksWidget_NUI.ProcessActiveAbilityPerksAsync (Underlying native function: ProcessActiveAbilityPerksAsync 0xa7f33f0)
