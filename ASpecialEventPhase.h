...
class ASpecialEventPhase : public AInfo
{
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventPhase.SetHUDElementVisibility (Underlying native function: SetHUDElementVisibility 0x7360b7c)
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventPhase.OnRep_PhaseState (Underlying native function: OnRep_PhaseState 0x735f124)
	void OnRepPhaseState(); // (Final | Native | Protected)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventPhase.OnPhaseFinished (Underlying native function: OnPhaseFinished 0x735ea58)
	...
	// Function /Script/SpecialEventGameplayRuntime.SpecialEventPhase.GetPhaseTag (Underlying native function: GetPhaseTag 0x72435a8)
	struct FGameplayTag GetPhaseTag(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SpecialEventGameplayRuntime.SpecialEventPhase.DebugActivatePhase (Underlying native function: DebugActivatePhase 0x273fd14)
