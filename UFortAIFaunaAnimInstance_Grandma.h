...
class UFortAIFaunaAnimInstance_Grandma : public UFortAIFaunaAnimInstance
{
	...
	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateStateVariables (Underlying native function: UpdateStateVariables 0x6e70d2c)
	void UpdateStateVariables(bool& bAccelerating); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateShouldPlayFullBodyInPlace (Underlying native function: UpdateShouldPlayFullBodyInPlace 0x6e70d04)
	void UpdateShouldPlayFullBodyInPlace(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMovingRates (Underlying native function: UpdateMovingRates 0x6e70cac)
	void UpdateMovingRates(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMeshScale (Underlying native function: UpdateMeshScale 0x6e70c88)
	void UpdateMeshScale(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateLocomotionPoseAlpha (Underlying native function: UpdateLocomotionPoseAlpha 0x6e70c5c)
	void UpdateLocomotionPoseAlpha(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateIdleStartTurn (Underlying native function: UpdateIdleStartTurn 0x6e70bb8)
	void UpdateIdleStartTurn(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableSniffAdditive (Underlying native function: UpdateEnableSniffAdditive 0x6e70b7c)
	void UpdateEnableSniffAdditive(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableAlertAdditive (Underlying native function: UpdateEnableAlertAdditive 0x6e70b34)
	void UpdateEnableAlertAdditive(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateBlinkAlpha (Underlying native function: UpdateBlinkAlpha 0x6e70ad8)
	void UpdateBlinkAlpha(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineShouldPlayFullBodyInPlace (Underlying native function: DetermineShouldPlayFullBodyInPlace 0x6e70a6c)
	bool DetermineShouldPlayFullBodyInPlace(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineIdleStartTurn (Underlying native function: DetermineIdleStartTurn 0x6e70a00)
	bool DetermineIdleStartTurn(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableSniffAdditive (Underlying native function: DetermineEnableSniffAdditive 0x6e709e0)
	bool DetermineEnableSniffAdditive(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableAlertAdditive (Underlying native function: DetermineEnableAlertAdditive 0x6e709a0)
	bool DetermineEnableAlertAdditive(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateWalkRunPlayRate (Underlying native function: CalculateWalkRunPlayRate 0x6e7097c)
	float CalculateWalkRunPlayRate(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateMeshScale (Underlying native function: CalculateMeshScale 0x6e7095c)
	float CalculateMeshScale(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateLocomotionPoseAlpha (Underlying native function: CalculateLocomotionPoseAlpha 0x6e7086c)
	float CalculateLocomotionPoseAlpha(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateBlinkAlpha (Underlying native function: CalculateBlinkAlpha 0x6e7081c)
