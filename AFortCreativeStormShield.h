...
class AFortCreativeStormShield : public AFortMissionStormShield
{
	...
	// Function /Script/FortniteGame.FortCreativeStormShield.SetGamePhaseStep (Underlying native function: SetGamePhaseStep 0x8551e60)
	void SetGamePhaseStep(enum EAthenaGamePhaseStep& NewGamePhaseStep); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeStormShield.OnRep_GamePhaseStep (Underlying native function: OnRep_GamePhaseStep 0x85510f8)
	void OnRepGamePhaseStep(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortCreativeStormShield.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x8550ac8)
	void OnGamePhaseStepChanged(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeStormShield.GetServerTime (Underlying native function: GetServerTime 0x854dc28)
