...
class UFortMainMenuLeaveButtonWrapper : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortMainMenuLeaveButtonWrapper.HandleLobbyStarted (Underlying native function: HandleLobbyStarted 0x2d8d074)
	void HandleLobbyStarted(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortMainMenuLeaveButtonWrapper.HandleLobbyDisconnected (Underlying native function: HandleLobbyDisconnected 0x2d8d074)
	void HandleLobbyDisconnected(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortMainMenuLeaveButtonWrapper.GetConfirmationMessageText (Underlying native function: GetConfirmationMessageText 0xa698588)
