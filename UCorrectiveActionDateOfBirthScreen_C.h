...
class UCorrectiveActionDateOfBirthScreen_C : public UFortCorrectiveActionDateOfBirthScreen
{
	...
	void ExecuteUbergraphCorrectiveActionDateOfBirthScreen(int& EntryPoint, bool& K2NodeEventbShowProcessing, struct FText& K2NodeEventFailureReason); // (Final | 0x00008000 | HasDefaults)
};
