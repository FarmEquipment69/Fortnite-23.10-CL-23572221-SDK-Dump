...
class AFortPlayerCameraBase : public APlayerCameraManager
{
	...
	// Function /Script/FortniteGame.FortPlayerCameraBase.RemoveCameraModeOverride (Underlying native function: RemoveCameraModeOverride 0x840f378)
	void RemoveCameraModeOverride(struct FGameplayTag& tag); // (Final | 0x00000002 | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerCameraBase.AddCameraModeOverride (Underlying native function: AddCameraModeOverride 0x840de7c)
