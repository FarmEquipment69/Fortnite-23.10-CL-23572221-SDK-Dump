...
class UEntityDynamicActivationComponent : public UEntityEnableableComponent
{
	...
	// Function /Script/EntityActor.EntityDynamicActivationComponent.OnRep_TransitionTarget (Underlying native function: OnRep_TransitionTarget 0x663dd94)
	void OnRepTransitionTarget(); // (Final | Native | Private)

	// Function /Script/EntityActor.EntityDynamicActivationComponent.OnEnabledChanged (Underlying native function: OnEnabledChanged 0x663d768)
