...
class ARockVehicleAudioController : public AFortVehicleAudioController
{
	...
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.SetSurfaceTypeParam (Underlying native function: SetSurfaceTypeParam 0x71c7a60)
	void SetSurfaceTypeParam(float& NewSurfaceParam); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.SetBoosting (Underlying native function: SetBoosting 0x71c7960)
	...
	// Function /Script/RockVehicleRuntime.RockVehicleAudioController.GetMotorSimComponent (Underlying native function: GetMotorSimComponent 0x71c6eb4)
