...
class UFortMatchmakingPortalModal : public UFortActivityView
{
	...
	unsigned char unreflected_400[0x330]; // 0x400 (0x330) 
	struct TArray<struct FString> XpTagMnemonicWhitelist; // 0x730 (0x10)
	class UCommonRichTextBlock* TextActivityOrigin; // 0x740 (0x8)
	class UCommonRichTextBlock* TextLinkCode; // 0x748 (0x8)
	class UCommonTextBlock* TextActivityName; // 0x750 (0x8)
	class UCommonTextBlock* TextActivityDescription; // 0x758 (0x8)
	class UScrollBox* ScrollBoxActivityDescription; // 0x760 (0x8)
	class UDynamicEntryBox* EntryBoxActivityTags; // 0x768 (0x8)
	class UFortSimpleMaterialProgressBar* ProgressBarContentDownload; // 0x770 (0x8)
	class UCommonButtonBase* ButtonAcceptPublic; // 0x778 (0x8)
	class UCommonButtonBase* ButtonAcceptPrivate; // 0x780 (0x8)
	class UCommonButtonBase* ButtonFavorite; // 0x788 (0x8)
	class UCommonButtonBase* ButtonCancel; // 0x790 (0x8)
	class UFortModalBackground* ModalBackground; // 0x798 (0x8)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalModal.SendLinkCodeToParty (Underlying native function: SendLinkCodeToParty 0x70e5dfc)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalModal.IsDownloadRequired (Underlying native function: IsDownloadRequired 0x70e5dc4)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalModal.GetInvalidActivityReason (Underlying native function: GetInvalidActivityReason 0x70e5a8c)
	...
	// Function /Script/MatchmakingPortalUI.FortMatchmakingPortalModal.GetContentWarningStrings (Underlying native function: GetContentWarningStrings 0x70e5a08)
