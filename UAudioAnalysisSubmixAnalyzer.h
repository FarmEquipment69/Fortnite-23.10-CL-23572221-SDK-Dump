...
class UAudioAnalysisSubmixAnalyzer : public UObject
{
	...
	// Function /Script/FortniteGame.AudioAnalysisSubmixAnalyzer.OnSubmixSpectralAnalysis (Underlying native function: OnSubmixSpectralAnalysis 0x1fe4860)
	void OnSubmixSpectralAnalysis(struct TArray<float>& Amplitudes); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.AudioAnalysisSubmixAnalyzer.OnSubmixEnvelope (Underlying native function: OnSubmixEnvelope 0x1efada0)
