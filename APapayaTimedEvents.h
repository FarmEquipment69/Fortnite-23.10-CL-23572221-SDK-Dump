...
class APapayaTimedEvents : public AActor
{
	...
	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.ShutdownTimedEvents_Native (Underlying native function: ShutdownTimedEvents_Native 0x7194704)
	void ShutdownTimedEventsNative(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.SetupTimedEvents_Native (Underlying native function: SetupTimedEvents_Native 0x71945b0)
	void SetupTimedEventsNative(struct FString& ScreenName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.ResetTimedEvents_Native (Underlying native function: ResetTimedEvents_Native 0x719459c)
	void ResetTimedEventsNative(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.OnRep_TimedEventsArray (Underlying native function: OnRep_TimedEventsArray 0x7194498)
	void OnRepTimedEventsArray(struct FMediaTimeEventArray& PreviousValue); // (Final | Native | Private | HasOutParms)

	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.OnRep_ScreenName (Underlying native function: OnRep_ScreenName 0x71942e0)
	void OnRepScreenName(struct FString& PreviousValue); // (Final | Native | Private)

	// Function /Script/PapayaTimedEvents.PapayaTimedEvents.AddTimedEvent_Native (Underlying native function: AddTimedEvent_Native 0x7194040)
