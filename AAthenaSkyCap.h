...
class AAthenaSkyCap : public AActor
{
	...
	// Function /Script/FortniteGame.AthenaSkyCap.OnStopMovement (Underlying native function: OnStopMovement 0x82637d8)
	void OnStopMovement(struct FHitResult& ImpactResult, float& Time); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.AthenaSkyCap.OnRep_SkyCapState (Underlying native function: OnRep_SkyCapState 0x8263740)
