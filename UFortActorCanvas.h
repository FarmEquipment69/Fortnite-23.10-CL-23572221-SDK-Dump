...
class UFortActorCanvas : public UPanelWidget
{
	...
	// Function /Script/FortniteUI.FortActorCanvas.OnHUDElementVisibilityChanged (Underlying native function: OnHUDElementVisibilityChanged 0x26858c0)
	void OnHUDElementVisibilityChanged(struct FGameplayTagContainer& HiddenHUDElementTags); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.FortActorCanvas.AddActorIndicator (Underlying native function: AddActorIndicator 0x280ec18)
