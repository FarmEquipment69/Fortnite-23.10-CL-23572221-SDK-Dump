...
{
	struct FVector ShadowVarScale; // 0x68 (0x18)
	unsigned char padding_80[0x8]; // 0x80 (0x8)

	/* Functions */

	// Function /Script/EntityActor.EntityActorScaleComponent.OnRootComponentChanged (Underlying native function: OnRootComponentChanged 0x663df68)
