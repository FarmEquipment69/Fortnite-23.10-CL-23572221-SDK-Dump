...
class AGameplayAbilityTargetActor : public AActor
{
	...
	// Function /Script/GameplayAbilities.GameplayAbilityTargetActor.ConfirmTargeting (Underlying native function: ConfirmTargeting 0x26b0974)
	void ConfirmTargeting(); // (Native | Public)

	// Function /Script/GameplayAbilities.GameplayAbilityTargetActor.CancelTargeting (Underlying native function: CancelTargeting 0x1598c88)
