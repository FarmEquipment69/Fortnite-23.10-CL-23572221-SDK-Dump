...
class UFortAIAnimInstance_Caretaker : public UFortAIAnimInstance
{
	...
	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.SetDelayedMaterialParameters (Underlying native function: SetDelayedMaterialParameters 0x6f01568)
	void SetDelayedMaterialParameters(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWorldStriderComponent (Underlying native function: GetWorldStriderComponent 0x6f01114)
	class UFortAnimWorldStriderComponent* GetWorldStriderComponent(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkSpeedWarpingValue (Underlying native function: GetWalkSpeedWarpingValue 0x6f010e8)
	float GetWalkSpeedWarpingValue(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkPlayRateValue (Underlying native function: GetWalkPlayRateValue 0x6f010c8)
	float GetWalkPlayRateValue(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetStartAnimPosition (Underlying native function: GetStartAnimPosition 0x6f0109c)
