...
class UAbilityAsync_WaitGameplayEffectApplied : public UAbilityAsync
{
	...
	// Function /Script/GameplayAbilities.AbilityAsync_WaitGameplayEffectApplied.WaitGameplayEffectAppliedToActor (Underlying native function: WaitGameplayEffectAppliedToActor 0x66b9eb8)
