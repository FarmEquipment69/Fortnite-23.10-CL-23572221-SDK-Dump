...
class UCurveBase : public UObject
{
	...
	// Function /Script/Engine.CurveBase.GetValueRange (Underlying native function: GetValueRange 0x9b73fb0)
	void GetValueRange(float& MinValue, float& MaxValue); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CurveBase.GetTimeRange (Underlying native function: GetTimeRange 0x26a75dc)
