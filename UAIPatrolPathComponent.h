...
class UAIPatrolPathComponent : public UActorComponent
{
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.SyncSharedUserOptions (Underlying native function: SyncSharedUserOptions 0x6f8e378)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.SetRenderPath (Underlying native function: SetRenderPath 0x6f8e2f8)
	void SetRenderPath(bool& bRenderPath); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.SetPatrolPathGroup (Underlying native function: SetPatrolPathGroup 0x6f8e1e8)
	void SetPatrolPathGroup(enum EFortCreativePatrolPathGroup& PatrolPathGroup); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.SetPatrolPathEnabled (Underlying native function: SetPatrolPathEnabled 0x6f8e164)
	void SetPatrolPathEnabled(bool& bIsEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.SetPatrollingMode (Underlying native function: SetPatrollingMode 0x6f8e268)
	void SetPatrollingMode(enum EPatrollingMode& NewMode); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.RequestRenderPath (Underlying native function: RequestRenderPath 0x6f8e0f0)
	void RequestRenderPath(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.RenderToNextPoint (Underlying native function: RenderToNextPoint 0x6f8e0dc)
	void RenderToNextPoint(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.RenderToNextAndPreviousPoint (Underlying native function: RenderToNextAndPreviousPoint 0x6f8e088)
	void RenderToNextAndPreviousPoint(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.RemovePoint (Underlying native function: RemovePoint 0x6f8e064)
	bool RemovePoint(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.PatrolPointReached (Underlying native function: PatrolPointReached 0x6f8dfa0)
	void PatrolPointReached(class AFortAthenaPatrolPoint*& PathPoint, class AAIController*& Instigator); // (Final | Native | Private)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.PatrolPointFailedToReach (Underlying native function: PatrolPointFailedToReach 0x6f8dedc)
	void PatrolPointFailedToReach(class AFortAthenaPatrolPoint*& PathPoint, class AAIController*& Instigator); // (Final | Native | Private)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.PatrolPathStopped (Underlying native function: PatrolPathStopped 0x6f8de5c)
	void PatrolPathStopped(class AAIController*& Instigator); // (Final | Native | Private)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.PatrolPathStarted (Underlying native function: PatrolPathStarted 0x6f8ddcc)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.HasValidPatrolPath (Underlying native function: HasValidPatrolPath 0x6f8dda0)
	bool HasValidPatrolPath(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GetPatrolPathPointIndex (Underlying native function: GetPatrolPathPointIndex 0x6f8dd88)
	int GetPatrolPathPointIndex(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GetPatrolPathPoint (Underlying native function: GetPatrolPathPoint 0x6f8dcc8)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GetPatrolPathIndex (Underlying native function: GetPatrolPathIndex 0x6f8dcb0)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GetNextAvailablePatrolPathIndex (Underlying native function: GetNextAvailablePatrolPathIndex 0x6f8dc18)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GetLinkedPatrolPoints (Underlying native function: GetLinkedPatrolPoints 0x6f8daa0)
	...
	// Function /Script/AIPatrolPath.AIPatrolPathComponent.GeneratePathPoints (Underlying native function: GeneratePathPoints 0x6f8da20)
	void GeneratePathPoints(enum EFortCreativePatrolPathGroup& PatrolPathGroup); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIPatrolPath.AIPatrolPathComponent.CanNextPointBeReached (Underlying native function: CanNextPointBeReached 0x6f8da00)
