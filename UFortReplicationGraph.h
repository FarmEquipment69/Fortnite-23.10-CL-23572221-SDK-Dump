...
class UFortReplicationGraph : public UReplicationGraph
{
	...
	// Function /Script/FortniteGame.FortReplicationGraph.OnVehicleDestroyed (Underlying native function: OnVehicleDestroyed 0x8a48c8c)
	void OnVehicleDestroyed(class AActor*& DestroyedVehicle); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortReplicationGraph.OnHighFrequencyPawnDestroyed (Underlying native function: OnHighFrequencyPawnDestroyed 0x8a48c0c)
	void OnHighFrequencyPawnDestroyed(class AActor*& Pawn); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortReplicationGraph.OnGameStatePlaylistLoaded (Underlying native function: OnGameStatePlaylistLoaded 0x6df7868)
