...
class AItemOnPawnPreview_C : public AFortItemPreviewOnPawnActor
{
	...
	class UArrowComponent* Arrow1; // 0x668 (0x8)
	class UDirectionalLightComponent* DirectionalLightForAtmospherePC; // 0x670 (0x8)
	class USkyLightComponent* SkyLightPC; // 0x678 (0x8)
	class UArrowComponent* Arrow; // 0x680 (0x8)
	class USkyLightComponent* SkyLightLowMobile; // 0x688 (0x8)
	class UDirectionalLightComponent* DirectionalLightMobile; // 0x690 (0x8)
	class USpotLightComponent* KeyLightStandaloneForSwitch; // 0x698 (0x8)
	class USpotLightComponent* KeyLight5; // 0x6a0 (0x8)
	class USpotLightComponent* KeyLight6; // 0x6a8 (0x8)
	class USpotLightComponent* KeyLigh3; // 0x6b0 (0x8)
	class USpotLightComponent* KeyLight2; // 0x6b8 (0x8)
	class USpotLightComponent* BounceRear1; // 0x6c0 (0x8)
	class USpotLightComponent* RimLowerRight1; // 0x6c8 (0x8)
	class USpotLightComponent* RimLeft1; // 0x6d0 (0x8)
	class USpotLightComponent* RimTopRight1; // 0x6d8 (0x8)
	class USpotLightComponent* RimBottomLeft1; // 0x6e0 (0x8)
	class USpotLightComponent* Bounce1; // 0x6e8 (0x8)
	class USceneComponent* LightTransform; // 0x6f0 (0x8)
	class UStaticMeshComponent* Plane; // 0x6f8 (0x8)
	class USkeletalMeshComponent* SampleMesh; // 0x700 (0x8)
	bool AlwaysOn; // 0x708 (0x1)
	bool IsActive; // 0x709 (0x1)
	bool debugConstructionLighting; // 0x70a (0x1)
	unsigned char unreflected_70b[0x5]; // 0x70b (0x5) 
	class UParticleSystemComponent* ObscuringLoopEmitter; // 0x710 (0x8)
	struct FRotator ToonLightRotatio; // 0x718 (0x18)
	bool bIsBattlePassReward; // 0x730 (0x1)
	unsigned char unreflected_731[0x7]; // 0x731 (0x7) 
	struct FTimerHandle* LODStreamingSafetyTimer; // 0x738 (0x8)
	double LODStreamingSafetyDuration; // 0x740 (0x8)
	class UMaterialInterface* DefaultFloorMaterial; // 0x748 (0x8)
	class UMaterialInterface* CustomFloorMaterial; // 0x750 (0x8)
