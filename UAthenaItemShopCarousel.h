...
class UAthenaItemShopCarousel : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaItemShopCarousel.SelectPrevItem (Underlying native function: SelectPrevItem 0xa3cdd30)
	void SelectPrevItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemShopCarousel.SelectNextItem (Underlying native function: SelectNextItem 0xa3cdd1c)
	void SelectNextItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemShopCarousel.SelectItemAtIndex (Underlying native function: SelectItemAtIndex 0xa3cdc9c)
	...
	// Function /Script/FortniteUI.AthenaItemShopCarousel.OnTransitionCompleted (Underlying native function: OnTransitionCompleted 0xa3cd7e4)
	...
	// Function /Script/FortniteUI.AthenaItemShopCarousel.GetSelectedIndex (Underlying native function: GetSelectedIndex 0x2d7b0bc)
