...
class UDonutChallengeIdleGame : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.DonutChallengeIdleGame.TryJump (Underlying native function: TryJump 0xa2a32a4)
	void TryJump(); // (Final | Native | Private)

	// Function /Script/FortniteUI.DonutChallengeIdleGame.StartGame (Underlying native function: StartGame 0xa2a3290)
	void StartGame(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.DonutChallengeIdleGame.EndSuperJump (Underlying native function: EndSuperJump 0xa2a2d88)
	void EndSuperJump(); // (Final | Native | Private)

	// Function /Script/FortniteUI.DonutChallengeIdleGame.EndJump (Underlying native function: EndJump 0xa2a2d70)
	void EndJump(); // (Final | Native | Private)

	// Function /Script/FortniteUI.DonutChallengeIdleGame.EndBumpyRide (Underlying native function: EndBumpyRide 0xa2a2d4c)
