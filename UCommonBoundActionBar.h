...
class UCommonBoundActionBar : public UDynamicEntryBoxBase
{
	...
	// Function /Script/CommonUI.CommonBoundActionBar.SetDisplayOwningPlayerActionsOnly (Underlying native function: SetDisplayOwningPlayerActionsOnly 0x298a70c)
