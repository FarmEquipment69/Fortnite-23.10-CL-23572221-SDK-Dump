...
class UCobaltRoundCompleteWidgetBase : public UCobaltWidgetBase
{
	...
	// Function /Script/FortniteUI.CobaltRoundCompleteWidgetBase.OnRoundComplete (Underlying native function: OnRoundComplete 0xa3fc010)
	void OnRoundComplete(struct TArray<unsigned char>& WinningTeams); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.CobaltRoundCompleteWidgetBase.HideWidget (Underlying native function: HideWidget 0xa3fa9f4)
