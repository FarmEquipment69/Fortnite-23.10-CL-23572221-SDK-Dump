...
class UAvoidanceManager : public UObject
{
	...
	// Function /Script/Engine.AvoidanceManager.RegisterMovementComponent (Underlying native function: RegisterMovementComponent 0x9a827e8)
	...
	// Function /Script/Engine.AvoidanceManager.GetObjectCount (Underlying native function: GetObjectCount 0x9a82748)
	int GetObjectCount(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AvoidanceManager.GetNewAvoidanceUID (Underlying native function: GetNewAvoidanceUID 0x9a82724)
	int GetNewAvoidanceUID(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AvoidanceManager.GetAvoidanceVelocityForComponent (Underlying native function: GetAvoidanceVelocityForComponent 0x9a82620)
