...
class UAthenaLevelEffects : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaLevelEffects.SetPlayerState (Underlying native function: SetPlayerState 0xa3770ec)
	void SetPlayerState(class AFortPlayerStateAthena*& InPSA); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaLevelEffects.OverridePlayerLevel (Underlying native function: OverridePlayerLevel 0xa376f60)
