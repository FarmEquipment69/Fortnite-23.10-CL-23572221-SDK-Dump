...
class UAthenaChallengesWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaChallengesWidget.IsXPSystemRequiredForChallenges (Underlying native function: IsXPSystemRequiredForChallenges 0xa2c70d4)
	bool IsXPSystemRequiredForChallenges(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaChallengesWidget.HandleDisplayDynamicQuestUpdate (Underlying native function: HandleDisplayDynamicQuestUpdate 0xa2c68b4)
