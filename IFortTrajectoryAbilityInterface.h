...
class IFortTrajectoryAbilityInterface : public IInterface
{
	...
	// Function /Script/FortniteGame.FortTrajectoryAbilityInterface.ShouldOnlyShowTrajectoryOnUse (Underlying native function: ShouldOnlyShowTrajectoryOnUse 0x20fb39c)
