...
class UFortControlResistanceSet : public UFortAttributeSet
{
	...
	// Function /Script/FortniteGame.FortControlResistanceSet.OnRep_MaxControlResistance (Underlying native function: OnRep_MaxControlResistance 0x831af74)
	void OnRepMaxControlResistance(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortControlResistanceSet.OnRep_ControlResistance (Underlying native function: OnRep_ControlResistance 0x8319318)
