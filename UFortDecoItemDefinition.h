...
class UFortDecoItemDefinition : public UFortWeaponItemDefinition
{
	...
	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldUseRelativeCameraRotation (Underlying native function: ShouldUseRelativeCameraRotation 0x8815034)
	bool ShouldUseRelativeCameraRotation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldSnapYawToHorizontalAxes (Underlying native function: ShouldSnapYawToHorizontalAxes 0x8815018)
	bool ShouldSnapYawToHorizontalAxes(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldIgnoreCollisionWithVehicles (Underlying native function: ShouldIgnoreCollisionWithVehicles 0x8814ffc)
	bool ShouldIgnoreCollisionWithVehicles(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldIgnoreCollisionWithStructuralGridActors (Underlying native function: ShouldIgnoreCollisionWithStructuralGridActors 0x8814fe0)
	bool ShouldIgnoreCollisionWithStructuralGridActors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldIgnoreCollisionWithPlayers (Underlying native function: ShouldIgnoreCollisionWithPlayers 0x8814fc4)
	bool ShouldIgnoreCollisionWithPlayers(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldIgnoreCollisionWithFortStaticMeshActors (Underlying native function: ShouldIgnoreCollisionWithFortStaticMeshActors 0x8814fa8)
	bool ShouldIgnoreCollisionWithFortStaticMeshActors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldIgnoreCollisionWithCriticalActors (Underlying native function: ShouldIgnoreCollisionWithCriticalActors 0x8814f8c)
	bool ShouldIgnoreCollisionWithCriticalActors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldForceIgnoreOverlapTest (Underlying native function: ShouldForceIgnoreOverlapTest 0x8814f70)
	bool ShouldForceIgnoreOverlapTest(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldForceIgnoreBuildingOverlaps (Underlying native function: ShouldForceIgnoreBuildingOverlaps 0x8814f54)
	bool ShouldForceIgnoreBuildingOverlaps(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldDisableScaleLerpWhilePlacing (Underlying native function: ShouldDisableScaleLerpWhilePlacing 0x8814f38)
	bool ShouldDisableScaleLerpWhilePlacing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldDisableRotationLerpWhilePlacing (Underlying native function: ShouldDisableRotationLerpWhilePlacing 0x8814f1c)
	bool ShouldDisableRotationLerpWhilePlacing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldDisableLocationLerpWhilePlacing (Underlying native function: ShouldDisableLocationLerpWhilePlacing 0x8814f00)
	bool ShouldDisableLocationLerpWhilePlacing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldDestroySmallObjectsWhenPlaced (Underlying native function: ShouldDestroySmallObjectsWhenPlaced 0x8814ee0)
	bool ShouldDestroySmallObjectsWhenPlaced(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldConsumeWhenPlaced (Underlying native function: ShouldConsumeWhenPlaced 0x8814e50)
	...
	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldCancelToolWhenPlaced (Underlying native function: ShouldCancelToolWhenPlaced 0x8814e34)
	bool ShouldCancelToolWhenPlaced(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldCancelAbilityOnUnequip (Underlying native function: ShouldCancelAbilityOnUnequip 0x8814e18)
	bool ShouldCancelAbilityOnUnequip(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldAttachWhenPlacing (Underlying native function: ShouldAttachWhenPlacing 0x8814dfc)
	bool ShouldAttachWhenPlacing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldAllowStairsWhenAttachingToFloors (Underlying native function: ShouldAllowStairsWhenAttachingToFloors 0x8814de0)
	bool ShouldAllowStairsWhenAttachingToFloors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldAllowPlacementOnWorldGeometry (Underlying native function: ShouldAllowPlacementOnWorldGeometry 0x8814dc4)
	bool ShouldAllowPlacementOnWorldGeometry(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldAllowPlacementOnBuildings (Underlying native function: ShouldAllowPlacementOnBuildings 0x8814da8)
	bool ShouldAllowPlacementOnBuildings(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.ShouldAllowAnyFloorPlacement (Underlying native function: ShouldAllowAnyFloorPlacement 0x8814d8c)
	bool ShouldAllowAnyFloorPlacement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.RequiresPlayerPlaceableAttachmentActors (Underlying native function: RequiresPlayerPlaceableAttachmentActors 0x8814a38)
	bool RequiresPlayerPlaceableAttachmentActors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.RequiresPermissionToEditWorld (Underlying native function: RequiresPermissionToEditWorld 0x8814a1c)
	bool RequiresPermissionToEditWorld(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetRotationAngleIncrement (Underlying native function: GetRotationAngleIncrement 0x88136b8)
	float GetRotationAngleIncrement(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetPlacementTypeOverride (Underlying native function: GetPlacementTypeOverride 0x8812e50)
	struct TEnumAsByte<EPlacementType> GetPlacementTypeOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetPlacementPreviewClass (Underlying native function: GetPlacementPreviewClass 0x8812e24)
	class UClass* GetPlacementPreviewClass(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetMaxPlacementDistance (Underlying native function: GetMaxPlacementDistance 0x8812bd0)
	int GetMaxPlacementDistance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetGridSnapSizeOverride (Underlying native function: GetGridSnapSizeOverride 0x8812330)
	float GetGridSnapSizeOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetGridPlacementOffset (Underlying native function: GetGridPlacementOffset 0x8812318)
	float GetGridPlacementOffset(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoItemDefinition.GetBlueprintClass (Underlying native function: GetBlueprintClass 0x8811bf4)
