...
class UFortFriendSearchButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortFriendSearchButton.SetKeyboardFocusOnAddFriendText (Underlying native function: SetKeyboardFocusOnAddFriendText 0xa637f58)
	void SetKeyboardFocusOnAddFriendText(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortFriendSearchButton.HandleAddFriendTextCommitted (Underlying native function: HandleAddFriendTextCommitted 0xa6379c0)
	...
	// Function /Script/FortniteUI.FortFriendSearchButton.HandleAddFriendTextChanged (Underlying native function: HandleAddFriendTextChanged 0xa637904)
