...
class UCommonLazyWidget : public UWidget
{
	...
	// Function /Script/CommonUI.CommonLazyWidget.SetLazyContent (Underlying native function: SetLazyContent 0x662f744)
	void SetLazyContent(struct TWeakObjectPtr<class UClass>& SoftWidget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonLazyWidget.IsLoading (Underlying native function: IsLoading 0x662dfd0)
	bool IsLoading(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonLazyWidget.GetContent (Underlying native function: GetContent 0x662c920)
