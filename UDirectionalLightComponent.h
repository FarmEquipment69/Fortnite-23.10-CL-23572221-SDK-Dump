...
class UDirectionalLightComponent : public ULightComponent
{
	...
	// Function /Script/Engine.DirectionalLightComponent.SetShadowSourceAngleFactor (Underlying native function: SetShadowSourceAngleFactor 0x9b3c3b8)
	void SetShadowSourceAngleFactor(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetShadowDistanceFadeoutFraction (Underlying native function: SetShadowDistanceFadeoutFraction 0x9b3c29c)
	void SetShadowDistanceFadeoutFraction(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetShadowCascadeBiasDistribution (Underlying native function: SetShadowCascadeBiasDistribution 0x9b3c204)
	void SetShadowCascadeBiasDistribution(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetShadowAmount (Underlying native function: SetShadowAmount 0x9b3c0fc)
	void SetShadowAmount(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetOcclusionMaskDarkness (Underlying native function: SetOcclusionMaskDarkness 0x9b3bc40)
	void SetOcclusionMaskDarkness(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetOcclusionDepthRange (Underlying native function: SetOcclusionDepthRange 0x9b3bbbc)
	void SetOcclusionDepthRange(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetLightSourceSoftAngle (Underlying native function: SetLightSourceSoftAngle 0x9b3b9e8)
	void SetLightSourceSoftAngle(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetLightSourceAngle (Underlying native function: SetLightSourceAngle 0x9b3b964)
	void SetLightSourceAngle(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetLightShaftOverrideDirection (Underlying native function: SetLightShaftOverrideDirection 0x9b3b8d4)
	void SetLightShaftOverrideDirection(struct FVector& NewValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetEnableLightShaftOcclusion (Underlying native function: SetEnableLightShaftOcclusion 0x9b3b09c)
	void SetEnableLightShaftOcclusion(bool& bNewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetDynamicShadowDistanceStationaryLight (Underlying native function: SetDynamicShadowDistanceStationaryLight 0x9b3ae94)
	void SetDynamicShadowDistanceStationaryLight(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetDynamicShadowDistanceMovableLight (Underlying native function: SetDynamicShadowDistanceMovableLight 0x9b3adfc)
	void SetDynamicShadowDistanceMovableLight(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetDynamicShadowCascades (Underlying native function: SetDynamicShadowCascades 0x9b3ad70)
	void SetDynamicShadowCascades(int& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetCascadeTransitionFraction (Underlying native function: SetCascadeTransitionFraction 0x9b3acd8)
	void SetCascadeTransitionFraction(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetCascadeDistributionExponent (Underlying native function: SetCascadeDistributionExponent 0x9b3ac40)
	void SetCascadeDistributionExponent(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetAtmosphereSunLightIndex (Underlying native function: SetAtmosphereSunLightIndex 0x9b3a4d8)
	void SetAtmosphereSunLightIndex(int& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DirectionalLightComponent.SetAtmosphereSunLight (Underlying native function: SetAtmosphereSunLight 0x9b3a458)
