...
class UFortRegisteredPlayerInfo : public UObject
{
	...
	// Function /Script/FortniteGame.FortRegisteredPlayerInfo.HandleDifferentHeroLoadoutActivated (Underlying native function: HandleDifferentHeroLoadoutActivated 0x87614a4)
	void HandleDifferentHeroLoadoutActivated(class UFortMcpProfileCampaign*& Profile); // (Final | 0x00000002 | Native | Private)

	// Function /Script/FortniteGame.FortRegisteredPlayerInfo.GetPlayerName (Underlying native function: GetPlayerName 0x876109c)
	struct FString GetPlayerName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortRegisteredPlayerInfo.GetAbilitySystemComponent (Underlying native function: GetAbilitySystemComponent 0x8760d94)
