...
class AFortAthenaMutator_PlayerClassSettings : public AFortAthenaMutator_PlayerSettingsBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_PlayerClassSettings.SetupGameRulesForClassContext (Underlying native function: SetupGameRulesForClassContext 0x824ad18)
	bool SetupGameRulesForClassContext(class AFortMinigame*& Minigame); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteGame.FortAthenaMutator_PlayerClassSettings.SetClassContext (Underlying native function: SetClassContext 0x824ac18)
	void SetClassContext(unsigned char& ClassSlotIndex); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_PlayerClassSettings.RemoveDataSource (Underlying native function: RemoveDataSource 0x824a8cc)
	bool RemoveDataSource(class UObject*& DataSource); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_PlayerClassSettings.GetClassContext (Underlying native function: GetClassContext 0x8249828)
	unsigned char GetClassContext(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_PlayerClassSettings.AddDataSourceForPlayerClass (Underlying native function: AddDataSourceForPlayerClass 0x8249270)
