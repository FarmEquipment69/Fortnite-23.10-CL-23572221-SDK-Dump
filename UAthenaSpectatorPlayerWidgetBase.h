...
class UAthenaSpectatorPlayerWidgetBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.SetPlayerData (Underlying native function: SetPlayerData 0x1648fdc)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleTeamColorChanged (Underlying native function: HandleTeamColorChanged 0xa43e254)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleSquadIdChanged (Underlying native function: HandleSquadIdChanged 0xa43dfcc)
	void HandleSquadIdChanged(class UAthenaRemotePlayerViewData*& InPlayerData, unsigned char& SquadId); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleShieldHealed (Underlying native function: HandleShieldHealed 0x25720b8)
	void HandleShieldHealed(class UAthenaRemotePlayerViewData*& InPlayerData, float& Shield, float& MaxShield); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleShieldDamaged (Underlying native function: HandleShieldDamaged 0x26d28f8)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandlePlayerStateChanged (Underlying native function: HandlePlayerStateChanged 0xa43ddb0)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandlePlayerNameChanged (Underlying native function: HandlePlayerNameChanged 0xa43dc14)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandlePlaceChanged (Underlying native function: HandlePlaceChanged 0x257f3d0)
	void HandlePlaceChanged(class UAthenaRemotePlayerViewData*& InPlayerData, int& Place); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleMaterialCountChanged (Underlying native function: HandleMaterialCountChanged 0xa43da54)
	void HandleMaterialCountChanged(class UAthenaRemotePlayerViewData*& InPlayerData, int& MaterialCount); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleKillScoreChanged (Underlying native function: HandleKillScoreChanged 0x25ae724)
	void HandleKillScoreChanged(class UAthenaRemotePlayerViewData*& InPlayerData, int& KillScore); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleIsReplayRelevancyPlayerChanged (Underlying native function: HandleIsReplayRelevancyPlayerChanged 0x25bca10)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleIsInRelevancyChanged (Underlying native function: HandleIsInRelevancyChanged 0x25325c0)
	void HandleIsInRelevancyChanged(class UAthenaRemotePlayerViewData*& InPlayerData, bool& bIsInRelevancy); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleIsFollowedPlayerChanged (Underlying native function: HandleIsFollowedPlayerChanged 0x252c310)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleHealthHealed (Underlying native function: HandleHealthHealed 0x24de7b0)
	void HandleHealthHealed(class UAthenaRemotePlayerViewData*& InPlayerData, float& Health, float& MaxHealth); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleHealthDamaged (Underlying native function: HandleHealthDamaged 0x2332bcc)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleDisconnectedChanged (Underlying native function: HandleDisconnectedChanged 0xa43d734)
	void HandleDisconnectedChanged(class UAthenaRemotePlayerViewData*& InPlayerData, bool& bIsDisconnected); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleDeadStateChanged (Underlying native function: HandleDeadStateChanged 0x256dc28)
	void HandleDeadStateChanged(class UAthenaRemotePlayerViewData*& InPlayerData, bool& bIsDead); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleDBNOStateChanged (Underlying native function: HandleDBNOStateChanged 0x254e794)
	void HandleDBNOStateChanged(class UAthenaRemotePlayerViewData*& InPlayerData, bool& bIsDBNO); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.HandleBeingRevivedStateChanged (Underlying native function: HandleBeingRevivedStateChanged 0xa43d654)
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayerWidgetBase.GetPlayerData (Underlying native function: GetPlayerData 0x21ebe4c)
