...
class UFireModeTile : public UCommonButtonBase
{
	...
	// Function /Script/FortniteUI.FireModeTile.UpdateDisplayedText (Underlying native function: UpdateDisplayedText 0xa55de78)
	void UpdateDisplayedText(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FireModeTile.SetIsCustomOptionsPanelOpen (Underlying native function: SetIsCustomOptionsPanelOpen 0xa55caf8)
	...
	// Function /Script/FortniteUI.FireModeTile.HandleVideoPlayerPlaybackResumed (Underlying native function: HandleVideoPlayerPlaybackResumed 0xa55bbf8)
	void HandleVideoPlayerPlaybackResumed(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FireModeTile.HandleToggleCustomOptionsClicked (Underlying native function: HandleToggleCustomOptionsClicked 0xa55bbd0)
