...
class UFortResourceFeed : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortResourceFeed.HandleWeakpointHitFinished (Underlying native function: HandleWeakpointHitFinished 0xa77fb64)
	void HandleWeakpointHitFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortResourceFeed.HandleTimedOut (Underlying native function: HandleTimedOut 0xa77fabc)
	bool HandleTimedOut(float& InDeltaTime); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortResourceFeed.HandleResourceGainedFinished (Underlying native function: HandleResourceGainedFinished 0xa77f740)
	void HandleResourceGainedFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortResourceFeed.HandlePlayerVolumeChanged (Underlying native function: HandlePlayerVolumeChanged 0xa77f4bc)
	void HandlePlayerVolumeChanged(class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortResourceFeed.HandleItemPickedUp (Underlying native function: HandleItemPickedUp 0xa77f050)
	void HandleItemPickedUp(class UFortWorldItem*& WorldItem, int& Count); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortResourceFeed.HandleGamePhaseChanged (Underlying native function: HandleGamePhaseChanged 0xa77f03c)
	void HandleGamePhaseChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortResourceFeed.HandleFadeOutFinished (Underlying native function: HandleFadeOutFinished 0xa77efdc)
	void HandleFadeOutFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortResourceFeed.HandleDamagedResourceBuilding (Underlying native function: HandleDamagedResourceBuilding 0xa77eb80)
	...
	// Function /Script/FortniteUI.FortResourceFeed.HandleDamagedResourceActor (Underlying native function: HandleDamagedResourceActor 0xa77e63c)
