...
class AFortClientAnnouncement_Conversation : public AFortClientAnnouncement
{
	...
	// Function /Script/FortniteGame.FortClientAnnouncement_Conversation.CurrentSentenceAudioTimeout (Underlying native function: CurrentSentenceAudioTimeout 0x7f967ec)
	void CurrentSentenceAudioTimeout(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortClientAnnouncement_Conversation.CurrentSentenceAudioFinished (Underlying native function: CurrentSentenceAudioFinished 0x7f967ec)
	void CurrentSentenceAudioFinished(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortClientAnnouncement_Conversation.AssetLoadTimeout (Underlying native function: AssetLoadTimeout 0x7f95fbc)
