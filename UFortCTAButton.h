...
class UFortCTAButton : public UFortHoldableButton
{
	...
	// Function /Script/FortniteUI.FortCTAButton.SetText (Underlying native function: SetText 0x22fd428)
	void SetText(struct FText& ButtonText); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortCTAButton.SetSecondaryText (Underlying native function: SetSecondaryText 0x23b2868)
