...
class AFortAthenaMutator_AdHocSquads : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.SquadUpPlayers (Underlying native function: SquadUpPlayers 0x81acbd0)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.ShouldAllowAdHocSquads (Underlying native function: ShouldAllowAdHocSquads 0x81ac858)
	static bool ShouldAllowAdHocSquads(); // (Final | Native | Static | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.PlayerSquadInviteEnded (Underlying native function: PlayerSquadInviteEnded 0x6fbd4fc)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.PlayerInitiatedSquadInvite (Underlying native function: PlayerInitiatedSquadInvite 0x6e9113c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x6f05250)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Final | 0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.IsPlayersSquadFull (Underlying native function: IsPlayersSquadFull 0x81a9ec4)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AdHocSquads.HavePlayerLeaveAdHocSquad (Underlying native function: HavePlayerLeaveAdHocSquad 0x6fbd4fc)
