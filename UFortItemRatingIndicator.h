...
class UFortItemRatingIndicator : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemRatingIndicator.SetItemViewContext (Underlying native function: SetItemViewContext 0xa70ae0c)
	...
	// Function /Script/FortniteUI.FortItemRatingIndicator.SetItemToRepresent (Underlying native function: SetItemToRepresent 0xa70a8c8)
	void SetItemToRepresent(class UFortItem*& ItemToRepresent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemRatingIndicator.SetItemToCompareWith (Underlying native function: SetItemToCompareWith 0xa70a45c)
