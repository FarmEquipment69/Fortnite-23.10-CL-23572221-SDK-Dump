...
class UAbilitySystemGlobals : public UObject
{
	...
	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ToggleIgnoreAbilitySystemCosts (Underlying native function: ToggleIgnoreAbilitySystemCosts 0x66e6c28)
	void ToggleIgnoreAbilitySystemCosts(); // (Exec | Native | Public)

	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ToggleIgnoreAbilitySystemCooldowns (Underlying native function: ToggleIgnoreAbilitySystemCooldowns 0x66e6c10)
	void ToggleIgnoreAbilitySystemCooldowns(); // (Exec | Native | Public)

	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ServerEndPlayerAbility (Underlying native function: ServerEndPlayerAbility 0x66e4ab4)
	void ServerEndPlayerAbility(struct FString& AbilityNameMatch); // (Final | Exec | Native | Public)

	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ServerCancelPlayerAbility (Underlying native function: ServerCancelPlayerAbility 0x66e4ab4)
	void ServerCancelPlayerAbility(struct FString& AbilityNameMatch); // (Final | Exec | Native | Public)

	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ServerActivatePlayerAbility (Underlying native function: ServerActivatePlayerAbility 0x66e4ab4)
	void ServerActivatePlayerAbility(struct FString& AbilityNameMatch); // (Final | Exec | Native | Public)

	// Function /Script/GameplayAbilities.AbilitySystemGlobals.ListPlayerAbilities (Underlying native function: ListPlayerAbilities 0x273fd14)
