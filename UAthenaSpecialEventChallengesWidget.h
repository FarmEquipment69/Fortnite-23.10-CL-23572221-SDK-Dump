...
class UAthenaSpecialEventChallengesWidget : public UAthenaChallengesWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpecialEventChallengesWidget.HandleUrgentQuestStarted (Underlying native function: HandleUrgentQuestStarted 0xa3a18e8)
	...
	// Function /Script/FortniteUI.AthenaSpecialEventChallengesWidget.HandleUrgentQuestEnded (Underlying native function: HandleUrgentQuestEnded 0xa3a1818)
	...
	// Function /Script/FortniteUI.AthenaSpecialEventChallengesWidget.HandleUrgentQuestDataChanged (Underlying native function: HandleUrgentQuestDataChanged 0xa3a1774)
	void HandleUrgentQuestDataChanged(struct FUrgentQuestData& InUrgentQuestData); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.AthenaSpecialEventChallengesWidget.HandleSpectatorUrgentQuestEnded (Underlying native function: HandleSpectatorUrgentQuestEnded 0xa3a1500)
	void HandleSpectatorUrgentQuestEnded(struct FGameplayTag& EventTag); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.AthenaSpecialEventChallengesWidget.HandleClearAllUrgentQuestEntries (Underlying native function: HandleClearAllUrgentQuestEntries 0xa3a04bc)
