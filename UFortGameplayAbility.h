...
class UFortGameplayAbility : public UGameplayAbility
{
	...
	// Function /Script/FortniteGame.FortGameplayAbility.TrackGroupedActor (Underlying native function: TrackGroupedActor 0x7e4ba0c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.TrackActor (Underlying native function: TrackActor 0x7e4b868)
	void TrackActor(class AActor*& ActorToTrack); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.ShouldPlayFailedMontage (Underlying native function: ShouldPlayFailedMontage 0x7e4b79c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.SetupPreviewImageOverride (Underlying native function: SetupPreviewImageOverride 0x71e7964)
	bool SetupPreviewImageOverride(); // (0x00000002 | Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortGameplayAbility.SetAIFocalPoint (Underlying native function: SetAIFocalPoint 0x7e4b2b4)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.QueryGameplayEffectContainerTargetExecutionModifiers (Underlying native function: QueryGameplayEffectContainerTargetExecutionModifiers 0x7e4af48)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.PushCameraMode (Underlying native function: PushCameraMode 0x7e4aec8)
	void PushCameraMode(class UClass*& CameraModeClass); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.PopCameraMode (Underlying native function: PopCameraMode 0x7e4aeb4)
	void PopCameraMode(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.OnWeaponEquipped (Underlying native function: OnWeaponEquipped 0x7e4adf4)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.OnGenericNotifyFromAnimation (Underlying native function: OnGenericNotifyFromAnimation 0x7e4ac28)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.MakeGameplayEffectContainerSpecs (Underlying native function: MakeGameplayEffectContainerSpecs 0x7e4aa38)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.MakeGameplayEffectContainerSpec (Underlying native function: MakeGameplayEffectContainerSpec 0x7e4a93c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.K2_OverrideFailedReason (Underlying native function: K2_OverrideFailedReason 0x7e4a580)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.K2_AbilityCompleted (Underlying native function: K2_AbilityCompleted 0x7e4a568)
	void K2AbilityCompleted(); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.IsTargetOutsideOfMaxYawRotation (Underlying native function: IsTargetOutsideOfMaxYawRotation 0x7e4a544)
	bool IsTargetOutsideOfMaxYawRotation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.IsChargeUpAbility (Underlying native function: IsChargeUpAbility 0x7e4a520)
	bool IsChargeUpAbility(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetTrackedGroupedActors (Underlying native function: GetTrackedGroupedActors 0x7e49cfc)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetTrackedActors (Underlying native function: GetTrackedActors 0x7e49c88)
	struct TArray<class AActor*> GetTrackedActors(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetTooltip (Underlying native function: GetTooltip 0x7e49bf8)
	class UClass* GetTooltip(bool& bSummaryTooltip); // (Final | 0x00000002 | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetProjectileInitialValuesAndTargetLocation (Underlying native function: GetProjectileInitialValuesAndTargetLocation 0x7e49434)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetProjectileInitialValues (Underlying native function: GetProjectileInitialValues 0x7e49184)
	void GetProjectileInitialValues(float& outProjectileSpeed, struct FRotator& outSpawnDirection, float& outProjectileGravity, class AActor*& HomingTarget, bool& bApplyInaccuracy, bool& bApplyClampedMaxYawAngleToFire, bool& bApplyLeading, float& DesiredFlightTime); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetOwningPlayerTeamPerkProgressiveActivationLevel (Underlying native function: GetOwningPlayerTeamPerkProgressiveActivationLevel 0x7e4904c)
	int GetOwningPlayerTeamPerkProgressiveActivationLevel(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetMaxNumTrackedActors (Underlying native function: GetMaxNumTrackedActors 0x7e49028)
	int GetMaxNumTrackedActors(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetFireRotation (Underlying native function: GetFireRotation 0x7e48f00)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetFireLocation (Underlying native function: GetFireLocation 0x7e48ec8)
	struct FVector GetFireLocation(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetDisplayStats (Underlying native function: GetDisplayStats 0x7e48e9c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetCurrentSourceWeapon (Underlying native function: GetCurrentSourceWeapon 0x7e48e78)
	class AFortWeapon* GetCurrentSourceWeapon(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetCurrentSourceItemDefinition (Underlying native function: GetCurrentSourceItemDefinition 0x7e48e38)
	class UFortWorldItemDefinition* GetCurrentSourceItemDefinition(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetCurrentAbilitySourceLevel (Underlying native function: GetCurrentAbilitySourceLevel 0x7e48da8)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetChargeTime (Underlying native function: GetChargeTime 0x7e48d80)
	float GetChargeTime(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetChargeState (Underlying native function: GetChargeState 0x7e48d68)
	enum EFortAbilityChargeState GetChargeState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetChargePercent (Underlying native function: GetChargePercent 0x7e48d40)
	float GetChargePercent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetAvatarAsValidFortPlayerPawn (Underlying native function: GetAvatarAsValidFortPlayerPawn 0x7e48c30)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetAvatarAsFortPlayerPawn (Underlying native function: GetAvatarAsFortPlayerPawn 0x7e48be4)
	class AFortPlayerPawn* GetAvatarAsFortPlayerPawn(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetAimLocationNearestPawn (Underlying native function: GetAimLocationNearestPawn 0x7e48828)
	struct FVector GetAimLocationNearestPawn(class AFortPawn*& Instigator); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.GetAIAbilityTarget (Underlying native function: GetAIAbilityTarget 0x7e4875c)
	class AActor* GetAIAbilityTarget(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetActivatingPawn (Underlying native function: GetActivatingPawn 0x7e487fc)
	class AFortPawn* GetActivatingPawn(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetActivatingAbilityComponent (Underlying native function: GetActivatingAbilityComponent 0x7e487d8)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.GetAbilityTargetingLevel (Underlying native function: GetAbilityTargetingLevel 0x25712d4)
	float GetAbilityTargetingLevel(); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.GetAbilityTags (Underlying native function: GetAbilityTags 0x7e48780)
	struct FGameplayTagContainer GetAbilityTags(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.ForceCameraLookDown (Underlying native function: ForceCameraLookDown 0x7e4866c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.EquipVehicleWeapon (Underlying native function: EquipVehicleWeapon 0x7e48588)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.EquipAbilityWeapon (Underlying native function: EquipAbilityWeapon 0x7e484e4)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.DoesTargetHaveTags (Underlying native function: DoesTargetHaveTags 0x7e483bc)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.DoesTargetHaveProhibitedTagsForAI (Underlying native function: DoesTargetHaveProhibitedTagsForAI 0x7e48300)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.ClearTrackedGroupedActors (Underlying native function: ClearTrackedGroupedActors 0x7e4823c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.ClearTrackedActors (Underlying native function: ClearTrackedActors 0x7e481bc)
	void ClearTrackedActors(bool& bDestroyActors); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.ClearAIFocalPoint (Underlying native function: ClearAIFocalPoint 0x7e4810c)
	void ClearAIFocalPoint(bool& bUseAttackingPriority); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.CalculateProjectileTrajectorySplineWithHitProfile (Underlying native function: CalculateProjectileTrajectorySplineWithHitProfile 0x7e47aa0)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.CalculateProjectileTrajectorySplineWithHit (Underlying native function: CalculateProjectileTrajectorySplineWithHit 0x7e47434)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.CalculateProjectileTrajectorySplineProfile (Underlying native function: CalculateProjectileTrajectorySplineProfile 0x7e46e30)
	static void CalculateProjectileTrajectorySplineProfile(struct TArray<struct FVector>& OutSplinePoints, struct TArray<struct FVector>& OutSplineTangents, class AActor*& Instigator, struct FVector& InitialLocation, struct FVector& InitialVelocity, float& MaxSpeed, float& Gravity, float& Friction, float& Bounciness, float& TimeStep, float& TraceExtent, struct FName& CollisionProfile, struct TArray<class AActor*>& ExtraActorsToIgnore, int& MaxBounces, int& MaxSteps, float& MaxDistanceBetweenSplinePoints, float& InitialDistance, float& LinearDamping, bool& bReturnPhysicalMaterial); // (Final | Native | Static | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.CalculateProjectileTrajectorySpline (Underlying native function: CalculateProjectileTrajectorySpline 0x7e4682c)
	static void CalculateProjectileTrajectorySpline(struct TArray<struct FVector>& OutSplinePoints, struct TArray<struct FVector>& OutSplineTangents, class AActor*& Instigator, struct FVector& InitialLocation, struct FVector& InitialVelocity, float& MaxSpeed, float& Gravity, float& Friction, float& Bounciness, float& TimeStep, float& TraceExtent, struct TEnumAsByte<ECollisionChannel>& TraceChannel, struct TArray<class AActor*>& ExtraActorsToIgnore, int& MaxBounces, int& MaxSteps, float& MaxDistanceBetweenSplinePoints, float& InitialDistance, float& LinearDamping, bool& bReturnPhysicalMaterial); // (Final | Native | Static | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.BP_GetGameplayEffectContainers (Underlying native function: BP_GetGameplayEffectContainers 0x7e4674c)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.BP_GetGameplayEffectContainer (Underlying native function: BP_GetGameplayEffectContainer 0x7e46694)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.BP_GetCooldownTags (Underlying native function: BP_GetCooldownTags 0x7e4662c)
	struct FGameplayTagContainer BPGetCooldownTags(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility.ApplySourcePropertyOverrides (Underlying native function: ApplySourcePropertyOverrides 0x7e464c0)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.ApplyGameplayEffectContainerWithCSVStats (Underlying native function: ApplyGameplayEffectContainerWithCSVStats 0x7e461f8)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.ApplyGameplayEffectContainer (Underlying native function: ApplyGameplayEffectContainer 0x7e46080)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.ApplyAccuracyToTargetLocation (Underlying native function: ApplyAccuracyToTargetLocation 0x7e45f28)
	...
	// Function /Script/FortniteGame.FortGameplayAbility.AllowAIMovement (Underlying native function: AllowAIMovement 0x7e45e14)
	static void AllowAIMovement(class UGameplayAbility*& OwningAbility); // (Final | Native | Static | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility.AddDynamicGameplayEffectContainer (Underlying native function: AddDynamicGameplayEffectContainer 0x7e45d0c)
