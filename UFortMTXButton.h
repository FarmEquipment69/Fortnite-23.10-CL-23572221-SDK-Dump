...
class UFortMTXButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortMTXButton.SetShowSocialName (Underlying native function: SetShowSocialName 0xa699a88)
	void SetShowSocialName(bool& bShow); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMTXButton.HandleLocalAccountInfoChanged (Underlying native function: HandleLocalAccountInfoChanged 0x11a67a0)
