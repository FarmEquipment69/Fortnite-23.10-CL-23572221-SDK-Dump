...
class UFortAthenaAIBotCosmeticLibraryData : public UPrimaryDataAsset
{
	...
	// Function /Script/FortniteAI.FortAthenaAIBotCosmeticLibraryData.RetrieveDataTables (Underlying native function: RetrieveDataTables 0xa19cfd4)
	struct TArray<class UDataTable*> RetrieveDataTables(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAIBotCosmeticLibraryData.FindDataTableFromAssetType (Underlying native function: FindDataTableFromAssetType 0xa19a9bc)
	class UDataTable* FindDataTableFromAssetType(struct FString& AssetType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAIBotCosmeticLibraryData.FillDataTableValuesFromSourceLibrary (Underlying native function: FillDataTableValuesFromSourceLibrary 0xa19a824)
