...
class UFortAIGoalProvider : public UObject
{
	...
	// Function /Script/FortniteAI.FortAIGoalProvider.UpdateGoals (Underlying native function: UpdateGoals 0x6ffbf00)
	void UpdateGoals(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAIGoalProvider.InitializeGoalProvider (Underlying native function: InitializeGoalProvider 0xa14ed20)
	bool InitializeGoalProvider(class UWorld*& ContextWorld, class UFortAIAssignment*& Assignment); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAIGoalProvider.GetEncounterInfo (Underlying native function: GetEncounterInfo 0xa14ebac)
