...
class UCreativePublishWatermark : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.CreativePublishWatermark.HandleShowPublishWatermarkChanged (Underlying native function: HandleShowPublishWatermarkChanged 0xa34712c)
	void HandleShowPublishWatermarkChanged(class AActor*& Volume, bool& bShowPublishWatermark); // (Final | Native | Private)

	// Function /Script/FortniteUI.CreativePublishWatermark.HandleCreativePlotLinkedVolumeChanged (Underlying native function: HandleCreativePlotLinkedVolumeChanged 0xa34632c)
