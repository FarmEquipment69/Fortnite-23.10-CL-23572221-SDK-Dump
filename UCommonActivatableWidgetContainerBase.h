...
class UCommonActivatableWidgetContainerBase : public UWidget
{
	...
	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.SetTransitionDuration (Underlying native function: SetTransitionDuration 0x66305dc)
	void SetTransitionDuration(float& Duration); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.RemoveWidget (Underlying native function: RemoveWidget 0x662e44c)
	void RemoveWidget(class UCommonActivatableWidget*& WidgetToRemove); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.GetTransitionDuration (Underlying native function: GetTransitionDuration 0x662d8c4)
	float GetTransitionDuration(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.GetActiveWidget (Underlying native function: GetActiveWidget 0x662c654)
	class UCommonActivatableWidget* GetActiveWidget(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.ClearWidgets (Underlying native function: ClearWidgets 0x662c178)
	void ClearWidgets(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonActivatableWidgetContainerBase.BP_AddWidget (Underlying native function: BP_AddWidget 0x662bd54)
