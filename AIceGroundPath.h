...
class AIceGroundPath : public AActor
{
	...
	// Function /Script/IceRuntime.IceGroundPath.OnRep_SplinePoints (Underlying native function: OnRep_SplinePoints 0x70982e0)
	void OnRepSplinePoints(); // (Final | Native | Private)

	// Function /Script/IceRuntime.IceGroundPath.GetLocationOnLandscape (Underlying native function: GetLocationOnLandscape 0x7097a8c)
	struct FVector GetLocationOnLandscape(struct FVector& Location); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/IceRuntime.IceGroundPath.GetLastSplinePointLocation (Underlying native function: GetLastSplinePointLocation 0x70979b4)
	...
	// Function /Script/IceRuntime.IceGroundPath.AddSplinePoint (Underlying native function: AddSplinePoint 0x70978dc)
