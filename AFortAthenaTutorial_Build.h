...
class AFortAthenaTutorial_Build : public AFortAthenaTutorialBase
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Build.OnPlayerEntersChestTrigger (Underlying native function: OnPlayerEntersChestTrigger 0x82d370c)
	void OnPlayerEntersChestTrigger(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAthenaTutorial_Build.OnBeginOverlapChestTriggerBox (Underlying native function: OnBeginOverlapChestTriggerBox 0x82d31b8)
	void OnBeginOverlapChestTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Build.HandleOnItemCountChanged (Underlying native function: HandleOnItemCountChanged 0x82d2878)
