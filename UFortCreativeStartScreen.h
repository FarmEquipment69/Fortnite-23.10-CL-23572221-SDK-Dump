...
class UFortCreativeStartScreen : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativeStartScreen.IsNewCreativeStartScreenEnabled (Underlying native function: IsNewCreativeStartScreenEnabled 0xa53597c)
	static bool IsNewCreativeStartScreenEnabled(); // (Final | Native | Static | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.FortCreativeStartScreen.HandleVolumeMinigameChanged (Underlying native function: HandleVolumeMinigameChanged 0xa53575c)
	void HandleVolumeMinigameChanged(class AFortMinigame*& Minigame); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeStartScreen.HandleMinigameStateChanged (Underlying native function: HandleMinigameStateChanged 0xa534b50)
	void HandleMinigameStateChanged(class AFortMinigame*& Minigame, enum EFortMinigameState& MinigameState); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeStartScreen.HandleInGameLoadScreenChanged (Underlying native function: HandleInGameLoadScreenChanged 0xa5348c0)
	...
	// Function /Script/FortniteUI.FortCreativeStartScreen.HandleFullscreenMapToggled (Underlying native function: HandleFullscreenMapToggled 0xa5346bc)
