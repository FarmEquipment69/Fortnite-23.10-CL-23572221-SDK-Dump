...
class UFortAccountLinkingWindow : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleSkipSignUpClicked (Underlying native function: HandleSkipSignUpClicked 0xa55bb80)
	void HandleSkipSignUpClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleSkipNoThanksClicked (Underlying native function: HandleSkipNoThanksClicked 0xa55bba8)
	void HandleSkipNoThanksClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleSkipLoginClicked (Underlying native function: HandleSkipLoginClicked 0xa55b56c)
	void HandleSkipLoginClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleSignupClicked (Underlying native function: HandleSignupClicked 0xa55bb80)
	void HandleSignupClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleNoThanksClicked (Underlying native function: HandleNoThanksClicked 0xa55bb6c)
	void HandleNoThanksClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortAccountLinkingWindow.HandleLoginClicked (Underlying native function: HandleLoginClicked 0xa55b56c)
