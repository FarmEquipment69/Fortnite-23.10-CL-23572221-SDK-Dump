...
class UFortNavSystem : public UNavigationSystemV1
{
	...
	// Function /Script/FortniteAI.FortNavSystem.OnNavDataRegistered (Underlying native function: OnNavDataRegistered 0xa12423c)
	void OnNavDataRegistered(class ANavigationData*& NavData); // (Final | Native | Protected)

	// Function /Script/FortniteAI.FortNavSystem.IsNavmeshInRadiusInitialized (Underlying native function: IsNavmeshInRadiusInitialized 0xa124128)
