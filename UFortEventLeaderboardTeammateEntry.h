...
class UFortEventLeaderboardTeammateEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortEventLeaderboardTeammateEntry.SetPlayerName (Underlying native function: SetPlayerName 0xa55d398)
	void SetPlayerName(struct FString& PlayerName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortEventLeaderboardTeammateEntry.SetPlayerFlag (Underlying native function: SetPlayerFlag 0xa55d25c)
