...
class UFortCollectionBookRewardCardWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookRewardCardWidget.SetRewards (Underlying native function: SetRewards 0x71eab48)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookRewardCardWidget.HasRewards (Underlying native function: HasRewards 0x71e7964)
	bool HasRewards(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortCollectionBookRewardCardWidget.ClearRewards (Underlying native function: ClearRewards 0x71e664c)
