...
class UFortGameData : public UPrimaryDataAsset
{
	...
	// Function /Script/FortniteGame.FortGameData.GetHighlightStencilParamNames (Underlying native function: GetHighlightStencilParamNames 0x8661d04)
	static struct TArray<struct FName> GetHighlightStencilParamNames(); // (Final | Native | Static | Public)

	// Function /Script/FortniteGame.FortGameData.GetHighlightParamProfileNames (Underlying native function: GetHighlightParamProfileNames 0x8661c90)
