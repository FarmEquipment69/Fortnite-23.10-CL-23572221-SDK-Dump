...
class UBattlePassScreenS23 : public UBattlePassScreenBase
{
	...
	// Function /Script/BattlePassS23UI.BattlePassScreenS23.OverviewShowAnimationFinished (Underlying native function: OverviewShowAnimationFinished 0x273fd14)
	...
	// Function /Script/BattlePassS23UI.BattlePassScreenS23.IsSeasonalCustomizationItemOwned (Underlying native function: IsSeasonalCustomizationItemOwned 0x6ed29b0)
	bool IsSeasonalCustomizationItemOwned(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassS23UI.BattlePassScreenS23.HandleSwitcherVisibilityShown (Underlying native function: HandleSwitcherVisibilityShown 0x6ed2988)
	void HandleSwitcherVisibilityShown(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/BattlePassS23UI.BattlePassScreenS23.HandleFullscreenMapToggled (Underlying native function: HandleFullscreenMapToggled 0x6ed2874)
	void HandleFullscreenMapToggled(bool& bMapVisible); // (Final | Native | Private)

	// Function /Script/BattlePassS23UI.BattlePassScreenS23.HandleClaimRewardComplete (Underlying native function: HandleClaimRewardComplete 0x6ed2788)
	...
	// Function /Script/BattlePassS23UI.BattlePassScreenS23.GetQuestPageDelay (Underlying native function: GetQuestPageDelay 0x6ed275c)
