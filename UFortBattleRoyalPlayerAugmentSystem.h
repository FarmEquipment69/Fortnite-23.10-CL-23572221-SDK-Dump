...
class UFortBattleRoyalPlayerAugmentSystem : public UFortControllerComponent
{
	...
	struct FScalableFloat EnableBRAugmentSystem; // 0xe0 (0x28)

	/* Functions */

	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.TryIncrementUnlockRollCount (Underlying native function: TryIncrementUnlockRollCount 0x6eeaab4)
	void TryIncrementUnlockRollCount(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.TryClaimUnlock (Underlying native function: TryClaimUnlock 0x6eeaa88)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.OnRep_ServerGrantingStartedTimestamp (Underlying native function: OnRep_ServerGrantingStartedTimestamp 0x30578ac)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.HandlePossessedPawnChanged (Underlying native function: HandlePossessedPawnChanged 0x6eea698)
	void HandlePossessedPawnChanged(class APawn*& OldPawn, class APawn*& NewPawn); // (Final | Native | Protected)

	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.GetServerGrantingStartedTimestamp (Underlying native function: GetServerGrantingStartedTimestamp 0x2e42d74)
	float GetServerGrantingStartedTimestamp(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.ChooseUnlockFromList (Underlying native function: ChooseUnlockFromList 0x6ee9524)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.BP_GetAugmmentPlayerPawn (Underlying native function: BP_GetAugmmentPlayerPawn 0x6ee92a0)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.BP_GetAugmentController (Underlying native function: BP_GetAugmentController 0x28865d4)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.BlueprintAugmentLog (Underlying native function: BlueprintAugmentLog 0x6ee93b0)
	void BlueprintAugmentLog(struct FString& message); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/PlayerAugmentsCodeRuntime.FortBattleRoyalPlayerAugmentSystem.AuthoritySetServerGrantingStartedTimestamp (Underlying native function: AuthoritySetServerGrantingStartedTimestamp 0x6ee9180)
