...
class AFortTheaterMapTile : public AFortClientOnlyActor
{
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.OnTileClicked (Underlying native function: OnTileClicked 0x8d26bc4)
	void OnTileClicked(class AActor*& ClickedActor, struct FKey& ButtonReleased); // (Final | 0x00000002 | Native | Public)

	// Function /Script/FortniteGame.FortTheaterMapTile.OnSelectWrapper (Underlying native function: OnSelectWrapper 0x8d26b40)
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.OnMouseOverEnd (Underlying native function: OnMouseOverEnd 0x8d26ac0)
	void OnMouseOverEnd(class AActor*& MousedOverActor); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortTheaterMapTile.OnMouseOverBegin (Underlying native function: OnMouseOverBegin 0x8d26a40)
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.OnDeselectWrapper (Underlying native function: OnDeselectWrapper 0x77af700)
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileValidForMarkedQuest (Underlying native function: IsTileValidForMarkedQuest 0x8d269a8)
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileSelectable (Underlying native function: IsTileSelectable 0x8d26984)
	bool IsTileSelectable(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileQuestRecommended (Underlying native function: IsTileQuestRecommended 0x8d26960)
	bool IsTileQuestRecommended(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTilePlayable (Underlying native function: IsTilePlayable 0x8d2693c)
	bool IsTilePlayable(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileLocked (Underlying native function: IsTileLocked 0x8d26918)
	bool IsTileLocked(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileInPhoenixTheater (Underlying native function: IsTileInPhoenixTheater 0x8d268f4)
	bool IsTileInPhoenixTheater(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTileHidden (Underlying native function: IsTileHidden 0x8d268d0)
	bool IsTileHidden(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsTeamRatingDataValid (Underlying native function: IsTeamRatingDataValid 0x8d26894)
	bool IsTeamRatingDataValid(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.IsMissionAlertTile (Underlying native function: IsMissionAlertTile 0x8d26870)
	bool IsMissionAlertTile(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.HasValidMissionData (Underlying native function: HasValidMissionData 0x8d26854)
	bool HasValidMissionData(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.GetZoneDifficulty (Underlying native function: GetZoneDifficulty 0x8d26768)
	struct FGameDifficultyInfo GetZoneDifficulty(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.GetMissionDefinitionIcon (Underlying native function: GetMissionDefinitionIcon 0x8d262ec)
	...
	// Function /Script/FortniteGame.FortTheaterMapTile.GetMissionContentDifficultyLevel (Underlying native function: GetMissionContentDifficultyLevel 0x8d26298)
	int GetMissionContentDifficultyLevel(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.GetMissionAlertVisualTags (Underlying native function: GetMissionAlertVisualTags 0x8d26248)
	struct FGameplayTagContainer GetMissionAlertVisualTags(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.GetMissionAlertCategoryName (Underlying native function: GetMissionAlertCategoryName 0x8d2621c)
	struct FName GetMissionAlertCategoryName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTheaterMapTile.DoesTileAllowQuickplay (Underlying native function: DoesTileAllowQuickplay 0x8d261f8)
