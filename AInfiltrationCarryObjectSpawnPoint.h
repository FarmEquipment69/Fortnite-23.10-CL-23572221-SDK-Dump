...
class AInfiltrationCarryObjectSpawnPoint : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnRep_CurrentState (Underlying native function: OnRep_CurrentState 0x81ab558)
	void OnRepCurrentState(enum ESpawnPointState& OldState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectThrownLanded (Underlying native function: OnHeldObjectThrownLanded 0x81aad98)
	void OnHeldObjectThrownLanded(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectThrown (Underlying native function: OnHeldObjectThrown 0x81aad84)
	void OnHeldObjectThrown(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectPlaced (Underlying native function: OnHeldObjectPlaced 0x81aad70)
	void OnHeldObjectPlaced(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectPickedUp (Underlying native function: OnHeldObjectPickedUp 0x81aad5c)
	void OnHeldObjectPickedUp(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectDropped (Underlying native function: OnHeldObjectDropped 0x81aad48)
	void OnHeldObjectDropped(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnHeldObjectDestroy (Underlying native function: OnHeldObjectDestroy 0x81aad34)
	void OnHeldObjectDestroy(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.OnEnterWater (Underlying native function: OnEnterWater 0x81aac38)
	...
	// Function /Script/FortniteGame.InfiltrationCarryObjectSpawnPoint.GetIntelActor (Underlying native function: GetIntelActor 0x81a96bc)
