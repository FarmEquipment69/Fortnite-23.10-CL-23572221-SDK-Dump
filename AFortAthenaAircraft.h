...
class AFortAthenaAircraft : public AFortAircraft
{
	...
	// Function /Script/FortniteGame.FortAthenaAircraft.StartFlightPath (Underlying native function: StartFlightPath 0x7fedc60)
	void StartFlightPath(float& StartTime); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaAircraft.SpawnAircraft (Underlying native function: SpawnAircraft 0x7feda90)
	...
	// Function /Script/FortniteGame.FortAthenaAircraft.OnRep_ReplicatedFlightTimestamp (Underlying native function: OnRep_ReplicatedFlightTimestamp 0x27bcc6c)
	void OnRepReplicatedFlightTimestamp(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaAircraft.GetDropStartTime (Underlying native function: GetDropStartTime 0x7feb7e8)
	float GetDropStartTime(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaAircraft.GetDropEndTime (Underlying native function: GetDropEndTime 0x7feb7d0)
	...
	// Function /Script/FortniteGame.FortAthenaAircraft.EjectPlayersInAircraft (Underlying native function: EjectPlayersInAircraft 0x273fd14)
