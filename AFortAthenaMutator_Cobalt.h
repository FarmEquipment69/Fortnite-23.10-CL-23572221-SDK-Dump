...
class AFortAthenaMutator_Cobalt : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.UpdateStormEyeVisuals (Underlying native function: UpdateStormEyeVisuals 0x81d9900)
	void UpdateStormEyeVisuals(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.TeleportPlayerLoadComplete (Underlying native function: TeleportPlayerLoadComplete 0x6df70d4)
	void TeleportPlayerLoadComplete(class AFortPlayerPawn*& FortPlayerPawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_WidgetRoundData (Underlying native function: OnRep_WidgetRoundData 0x81d9550)
	void OnRepWidgetRoundData(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_TeleportComplete (Underlying native function: OnRep_TeleportComplete 0x81d94b0)
	void OnRepTeleportComplete(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_TeamWinners (Underlying native function: OnRep_TeamWinners 0x81d949c)
	void OnRepTeamWinners(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_RoundStartWidgetSequenceRunning (Underlying native function: OnRep_RoundStartWidgetSequenceRunning 0x81d93cc)
	void OnRepRoundStartWidgetSequenceRunning(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_CombatStormShieldArray (Underlying native function: OnRep_CombatStormShieldArray 0x81d9250)
	void OnRepCombatStormShieldArray(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_bIsFinishedDisplayingRoundEndUI (Underlying native function: OnRep_bIsFinishedDisplayingRoundEndUI 0x81d9578)
	void OnRepbIsFinishedDisplayingRoundEndUI(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_bClientPlaylistTimerStarted (Underlying native function: OnRep_bClientPlaylistTimerStarted 0x81d9564)
	void OnRepbClientPlaylistTimerStarted(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.OnRep_ActiveRound (Underlying native function: OnRep_ActiveRound 0x81d921c)
	void OnRepActiveRound(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.HandleTeleportComplete (Underlying native function: HandleTeleportComplete 0x273fd14)
	void HandleTeleportComplete(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.HandlePlayerStateTeleportComplete (Underlying native function: HandlePlayerStateTeleportComplete 0x6df70d4)
	void HandlePlayerStateTeleportComplete(class AFortPlayerStateAthena*& FortPlayerState); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.GetFinalRoundIndex (Underlying native function: GetFinalRoundIndex 0x81d70f4)
	int GetFinalRoundIndex(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.ClientCobaltRoundTimerComplete (Underlying native function: ClientCobaltRoundTimerComplete 0x273fd14)
	void ClientCobaltRoundTimerComplete(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Cobalt.AudioFadeChangeEvent (Underlying native function: AudioFadeChangeEvent 0x81d6f28)
