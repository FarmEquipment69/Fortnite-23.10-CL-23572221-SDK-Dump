...
class UFortRelativeAnchorCanvas : public UPanelWidget
{
	...
	// Function /Script/FortniteUI.FortRelativeAnchorCanvas.SetZLayerOffset (Underlying native function: SetZLayerOffset 0xa4b4544)
	void SetZLayerOffset(int& Value); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRelativeAnchorCanvas.AddSlot (Underlying native function: AddSlot 0xa4acf1c)
