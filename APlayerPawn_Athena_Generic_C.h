...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x5310 (0x8)
	class UParticleSystemComponent* EffectWaterInteractionFX; // 0x5318 (0x8)
	class UParticleSystemComponent* AnimTrailPS; // 0x5320 (0x8)
	bool IsInWater; // 0x5328 (0x1)
	unsigned char unreflected_5329[0x7]; // 0x5329 (0x7) 
	struct FRotator RunWalkParticleRotation; // 0x5330 (0x18)
	int WaterCounter; // 0x5348 (0x4)
	unsigned char unreflected_534c[0x4]; // 0x534c (0x4) 
	double TickDeltaSeconds; // 0x5350 (0x8)
	class USoundBase* SoundShieldImpact; // 0x5358 (0x8)
	class USoundBase* SoundShieldDestroyed; // 0x5360 (0x8)
	class USoundBase* SoundShieldDestroyed1P; // 0x5368 (0x8)
	class USoundBase* SoundShieldFullyCharged; // 0x5370 (0x8)
	class USoundBase* SoundShieldStartRecharge; // 0x5378 (0x8)
	bool BodyValid; // 0x5380 (0x1)
	bool BackpackValid; // 0x5381 (0x1)
	bool HatValid; // 0x5382 (0x1)
	bool FaceValid; // 0x5383 (0x1)
	bool CharmValid; // 0x5384 (0x1)
	bool HeadValid; // 0x5385 (0x1)
	unsigned char unreflected_5386[0x2]; // 0x5386 (0x2) 
	struct TArray<class UMaterialInstanceDynamic*> TempArray; // 0x5388 (0x10)
	class USceneComponent* SoundPlayerHit; // 0x5398 (0x8)
	class UClass* SpeechBubbleWidgetClass; // 0x53a0 (0x8)
	struct FText LastSpeechText; // 0x53a8 (0x18)
	bool UseAnimTrailsNotifies; // 0x53c0 (0x1)
	unsigned char unreflected_53c1[0x7]; // 0x53c1 (0x7) 
	double Timewhenyoullbeabletosplashagain; // 0x53c8 (0x8)
	class AActor* CurrentWaterMeshActor; // 0x53d0 (0x8)
	struct FHitResult WaterTraceHitLocation; // 0x53d8 (0xe0)
	struct FVector StableVelocityVector; // 0x54b8 (0x18)
	class UParticleSystem* PlayerRunTemplateGround; // 0x54d0 (0x8)
	class UParticleSystem* PlayerWalkTemplateGround; // 0x54d8 (0x8)
	class UParticleSystem* PlayerRunTemplateWater; // 0x54e0 (0x8)
	class UParticleSystem* PlayerWalkTemplateWater; // 0x54e8 (0x8)
	class USkeletalMesh* PawnCharmSkeletalMesh; // 0x54f0 (0x8)
	class UParticleSystemComponent* AnimTrailsPSRef; // 0x54f8 (0x8)
	class UMaterialInterface* WeaponMaterialOverride; // 0x5500 (0x8)
	bool TickWaterLevel; // 0x5508 (0x1)
	unsigned char unreflected_5509[0x7]; // 0x5509 (0x7) 
	class UTextureRenderTarget2D* WetnessDepthTexture; // 0x5510 (0x8)
	class UMaterialInstanceDynamic* WaterLevelMID; // 0x5518 (0x8)
	class UMaterialInstanceDynamic* WaterDecayMID; // 0x5520 (0x8)
	bool WasRTTEnabledVarSet; // 0x5528 (0x1)
	bool IsRTTEnabled; // 0x5529 (0x1)
	unsigned char unreflected_552a[0x6]; // 0x552a (0x6) 
	double StartingMinCapsuleShadowVis; // 0x5530 (0x8)
	bool IsShielded; // 0x5538 (0x1)
	unsigned char unreflected_5539[0x7]; // 0x5539 (0x7) 
	double InstigatorCheckDistanceSqrd; // 0x5540 (0x8)
	double SlideDustActivateSpeed; // 0x5548 (0x8)
	bool CanSpawnSlideKickupFX; // 0x5550 (0x1)
	unsigned char unreflected_5551[0x7]; // 0x5551 (0x7) 
	class UParticleSystem* EffectPlayerShieldActivate; // 0x5558 (0x8)
	class UParticleSystem* EffectPLayerShieldBreak; // 0x5560 (0x8)
	bool GhostMode; // 0x5568 (0x1)
	unsigned char unreflected_5569[0x7]; // 0x5569 (0x7) 
	class UFXSystemComponent* OverrideAnimTrail; // 0x5570 (0x8)
	struct FMulticastInlineDelegate AnimNotifyBegin; // 0x5578 (0x10)
	struct FMulticastInlineDelegate AnimNotifyEnd; // 0x5588 (0x10)
	class USoundBase* SoundShieldDestroyed2D; // 0x5598 (0x8)
	class USoundBase* SoundShieldDestroyedCrit2D; // 0x55a0 (0x8)
	class UFXSystemComponent* AnimTrailFx; // 0x55a8 (0x8)
	struct FMulticastInlineDelegate PlayDamageEffect; // 0x55b0 (0x10)
	struct FName ComponentTagAnimTrailFXConst; // 0x55c0 (0x4)
	unsigned char unreflected_55c4[0x4]; // 0x55c4 (0x4) 
	double ReppedCapsuleExtraHalfHeight; // 0x55c8 (0x8)
	double CachedCapsuleHalfHeight; // 0x55d0 (0x8)
	struct FMulticastInlineDelegate OnCharacterPartsMIDInitialized; // 0x55d8 (0x10)
	struct FMulticastInlineDelegate OnShieldBreak; // 0x55e8 (0x10)
	class USkeletalMeshComponent* NullPartMesh; // 0x55f8 (0x8)
