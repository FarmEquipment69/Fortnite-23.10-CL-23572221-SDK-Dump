...
class UFortCharacterMovementMutatorComponent : public UActorComponent
{
	...
	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.SetBuffetBubblesIntroTargetTransform (Underlying native function: SetBuffetBubblesIntroTargetTransform 0x736070c)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.SetBuffetBubblesInitialFollowBoxOffsetPercent (Underlying native function: SetBuffetBubblesInitialFollowBoxOffsetPercent 0x7360630)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.SetBuffetBubblesFollowActor (Underlying native function: SetBuffetBubblesFollowActor 0x73604d4)
	void SetBuffetBubblesFollowActor(class AActor*& Actor); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.OverrideBuffetFlyingVelocityDirectionInterpSpeed (Underlying native function: OverrideBuffetFlyingVelocityDirectionInterpSpeed 0x735f718)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.OverrideBuffetFlyingMaxSpeed (Underlying native function: OverrideBuffetFlyingMaxSpeed 0x735f634)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.OnRep_BuffetFlyingRicochetReplicatedData (Underlying native function: OnRep_BuffetFlyingRicochetReplicatedData 0x735efdc)
	void OnRepBuffetFlyingRicochetReplicatedData(); // (Final | Native | Private)

	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.OnRep_BuffetBubblesFollowActor (Underlying native function: OnRep_BuffetBubblesFollowActor 0x735eef0)
	void OnRepBuffetBubblesFollowActor(); // (Final | Native | Protected)

	// Function /Script/SpecialEventGameplayRuntime.FortCharacterMovementMutatorComponent.OnMovementModeChanged (Underlying native function: OnMovementModeChanged 0x735e5f8)
