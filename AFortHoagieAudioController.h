...
class AFortHoagieAudioController : public AActor
{
	...
	// Function /Script/HoagieRuntime.FortHoagieAudioController.Update (Underlying native function: Update 0x6d3df28)
	void Update(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/HoagieRuntime.FortHoagieAudioController.CacheHoagieVehicle (Underlying native function: CacheHoagieVehicle 0x6d3d950)
	void CacheHoagieVehicle(class AFortHoagieVehicle*& InVehicle); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/HoagieRuntime.FortHoagieAudioController.CacheAudioComponents (Underlying native function: CacheAudioComponents 0x6d3d884)
