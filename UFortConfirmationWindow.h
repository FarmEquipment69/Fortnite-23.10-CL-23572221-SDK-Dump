...
class UFortConfirmationWindow : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortConfirmationWindow.HandleInputSuspensionChanged (Underlying native function: HandleInputSuspensionChanged 0xa732510)
	void HandleInputSuspensionChanged(bool& bIsInputSuspended); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortConfirmationWindow.HandleDeclineActionClicked (Underlying native function: HandleDeclineActionClicked 0xa7321e8)
	void HandleDeclineActionClicked(class UCommonButtonBase*& ButtonClicked); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortConfirmationWindow.HandleCancelButtonClicked (Underlying native function: HandleCancelButtonClicked 0xa7320e8)
	void HandleCancelButtonClicked(class UCommonButtonBase*& Buttton); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortConfirmationWindow.GetConfirmationDescription (Underlying native function: GetConfirmationDescription 0x227ee44)
	...
	// Function /Script/FortniteUI.FortConfirmationWindow.BotClickButton (Underlying native function: BotClickButton 0x22e7c58)
