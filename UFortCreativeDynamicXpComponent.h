...
class UFortCreativeDynamicXpComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeDynamicXpComponent.OnPlayerRemovedMinigame (Underlying native function: OnPlayerRemovedMinigame 0x84fa6c0)
	void OnPlayerRemovedMinigame(struct FUniqueNetIdRepl& UniqueNetId, bool& bIsLocalPlayer); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeDynamicXpComponent.OnPlayerAddedMinigame (Underlying native function: OnPlayerAddedMinigame 0x84fa6c0)
	void OnPlayerAddedMinigame(struct FUniqueNetIdRepl& UniqueNetId, bool& bIsLocalPlayer); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeDynamicXpComponent.OnMinigameStarted (Underlying native function: OnMinigameStarted 0x273fd14)
	void OnMinigameStarted(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeDynamicXpComponent.OnMinigameEnded (Underlying native function: OnMinigameEnded 0x273fd14)
	void OnMinigameEnded(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeDynamicXpComponent.OnEndMatchForPlayer (Underlying native function: OnEndMatchForPlayer 0x6df70d4)
