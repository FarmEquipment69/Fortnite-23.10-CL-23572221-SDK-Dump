...
class UFortAnimSet : public UDataAsset
{
	...
	// Function /Script/FortniteGame.FortAnimSet.UpdateReferencesInRandomSection (Underlying native function: UpdateReferencesInRandomSection 0x7f66bc0)
	void UpdateReferencesInRandomSection(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAnimSet.UpdateAssets (Underlying native function: UpdateAssets 0x7f66bac)
