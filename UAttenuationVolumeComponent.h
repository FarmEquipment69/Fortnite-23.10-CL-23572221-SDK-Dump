...
class UAttenuationVolumeComponent : public UAudioGameplayVolumeMutator
{
	...
	// Function /Script/AudioGameplayVolume.AttenuationVolumeComponent.SetInteriorVolume (Underlying native function: SetInteriorVolume 0x7b0664c)
	void SetInteriorVolume(float& Volume, float& InterpolateTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume (Underlying native function: SetExteriorVolume 0x7b06578)
