...
class UFortItemManagementMulchDetailsPanel : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemManagementMulchDetailsPanel.IsSpaceAvailableForMulch (Underlying native function: IsSpaceAvailableForMulch 0xa6c7200)
	...
	// Function /Script/FortniteUI.FortItemManagementMulchDetailsPanel.GetItemsToMulch (Underlying native function: GetItemsToMulch 0x71cf220)
	struct TArray<class UFortItem*> GetItemsToMulch(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemManagementMulchDetailsPanel.GetItemCountsToMulch (Underlying native function: GetItemCountsToMulch 0x71cf010)
	struct TArray<int> GetItemCountsToMulch(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemManagementMulchDetailsPanel.CommitMulch (Underlying native function: CommitMulch 0x71ce364)
