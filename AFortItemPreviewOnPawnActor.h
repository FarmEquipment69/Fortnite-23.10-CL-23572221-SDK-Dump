...
class AFortItemPreviewOnPawnActor : public AFortItemPreviewMultiAngleActor
{
	...
	unsigned char padding_5a8[0xb8]; // 0x5a8 (0xb8)

	/* Functions */

	// Function /Script/FortniteGame.FortItemPreviewOnPawnActor.OnMontageStopped (Underlying native function: OnMontageStopped 0x87b4604)
	void OnMontageStopped(class UAnimMontage*& Montage, bool& bInterrupted); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortItemPreviewOnPawnActor.HandlePawnCustomizationComplete (Underlying native function: HandlePawnCustomizationComplete 0x87b42f8)
	void HandlePawnCustomizationComplete(class AFortPlayerPawn*& Pawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortItemPreviewOnPawnActor.HandleContrailsActivated (Underlying native function: HandleContrailsActivated 0x87b41ec)
	void HandleContrailsActivated(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortItemPreviewOnPawnActor.GetPawnLocation (Underlying native function: GetPawnLocation 0x87b3440)
