...
class UAudioComponent : public USceneComponent
{
	...
	// Function /Script/Engine.AudioComponent.StopDelayed (Underlying native function: StopDelayed 0x9b254c4)
	void StopDelayed(float& DelayTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.Stop (Underlying native function: Stop 0x2828844)
	void Stop(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetWaveParameter (Underlying native function: SetWaveParameter 0x2669040)
	void SetWaveParameter(struct FName& InName, class USoundWave*& InWave); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetVolumeMultiplier (Underlying native function: SetVolumeMultiplier 0x1321bec)
	void SetVolumeMultiplier(float& NewVolumeMultiplier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetUISound (Underlying native function: SetUISound 0x9b25198)
	void SetUISound(bool& bInUISound); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetSubmixSend (Underlying native function: SetSubmixSend 0x9b25050)
	void SetSubmixSend(class USoundSubmixBase*& Submix, float& SendLevel); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetSourceBusSendPreEffect (Underlying native function: SetSourceBusSendPreEffect 0x9b24e08)
	...
	// Function /Script/Engine.AudioComponent.SetSourceBusSendPostEffect (Underlying native function: SetSourceBusSendPostEffect 0x9b24d38)
	...
	// Function /Script/Engine.AudioComponent.SetSound (Underlying native function: SetSound 0x2461930)
	void SetSound(class USoundBase*& NewSound); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetPitchMultiplier (Underlying native function: SetPitchMultiplier 0x9b24cb4)
	void SetPitchMultiplier(float& NewPitchMultiplier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetPaused (Underlying native function: SetPaused 0x9b24c34)
	void SetPaused(bool& bPause); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetOutputToBusOnly (Underlying native function: SetOutputToBusOnly 0x9b24bb4)
	void SetOutputToBusOnly(bool& bInOutputToBusOnly); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetLowPassFilterFrequency (Underlying native function: SetLowPassFilterFrequency 0x9b24aa4)
	void SetLowPassFilterFrequency(float& InLowPassFilterFrequency); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetLowPassFilterEnabled (Underlying native function: SetLowPassFilterEnabled 0x9b24a24)
	void SetLowPassFilterEnabled(bool& InLowPassFilterEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetIntParameter (Underlying native function: SetIntParameter 0x163a14c)
	void SetIntParameter(struct FName& InName, int& inInt); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetFloatParameter (Underlying native function: SetFloatParameter 0x150155c)
	void SetFloatParameter(struct FName& InName, float& InFloat); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetBoolParameter (Underlying native function: SetBoolParameter 0x1638a6c)
	void SetBoolParameter(struct FName& InName, bool& InBool); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetAudioBusSendPreEffect (Underlying native function: SetAudioBusSendPreEffect 0x9b24170)
	void SetAudioBusSendPreEffect(class UAudioBus*& AudioBus, float& AudioBusSendLevel); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.SetAudioBusSendPostEffect (Underlying native function: SetAudioBusSendPostEffect 0x9b240a0)
	void SetAudioBusSendPostEffect(class UAudioBus*& AudioBus, float& AudioBusSendLevel); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.PlayQuantized (Underlying native function: PlayQuantized 0x9b23c3c)
	...
	// Function /Script/Engine.AudioComponent.Play (Underlying native function: Play 0x24c3680)
	void Play(float& StartTime); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.IsVirtualized (Underlying native function: IsVirtualized 0x9b2386c)
	bool IsVirtualized(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AudioComponent.IsPlaying (Underlying native function: IsPlaying 0x255abdc)
	bool IsPlaying(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AudioComponent.HasCookedFFTData (Underlying native function: HasCookedFFTData 0x9b237e8)
	bool HasCookedFFTData(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AudioComponent.HasCookedAmplitudeEnvelopeData (Underlying native function: HasCookedAmplitudeEnvelopeData 0x9b237c4)
	bool HasCookedAmplitudeEnvelopeData(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AudioComponent.GetPlayState (Underlying native function: GetPlayState 0x9b2312c)
	enum EAudioComponentPlayState GetPlayState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AudioComponent.GetCookedFFTDataForAllPlayingSounds (Underlying native function: GetCookedFFTDataForAllPlayingSounds 0x9b22e70)
	...
	// Function /Script/Engine.AudioComponent.GetCookedFFTData (Underlying native function: GetCookedFFTData 0x9b22d58)
	...
	// Function /Script/Engine.AudioComponent.GetCookedEnvelopeDataForAllPlayingSounds (Underlying native function: GetCookedEnvelopeDataForAllPlayingSounds 0x9b22bec)
	...
	// Function /Script/Engine.AudioComponent.GetCookedEnvelopeData (Underlying native function: GetCookedEnvelopeData 0x9b22b50)
	bool GetCookedEnvelopeData(float& OutEnvelopeData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.FadeOut (Underlying native function: FadeOut 0x150f500)
	void FadeOut(float& FadeOutDuration, float& FadeVolumeLevel, enum EAudioFaderCurve& FadeCurve); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.AudioComponent.FadeIn (Underlying native function: FadeIn 0x1550358)
	...
	// Function /Script/Engine.AudioComponent.BP_GetAttenuationSettingsToApply (Underlying native function: BP_GetAttenuationSettingsToApply 0x9b22714)
	...
	// Function /Script/Engine.AudioComponent.AdjustVolume (Underlying native function: AdjustVolume 0x9b22618)
	...
	// Function /Script/Engine.AudioComponent.AdjustAttenuation (Underlying native function: AdjustAttenuation 0x9b22554)
