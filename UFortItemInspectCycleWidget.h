...
class UFortItemInspectCycleWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SetupActionHandlers (Underlying native function: SetupActionHandlers 0x721d1ec)
	void SetupActionHandlers(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SetOwningItemInspectScreen (Underlying native function: SetOwningItemInspectScreen 0x721cd64)
	void SetOwningItemInspectScreen(class UFortItemInspectionScreen*& ItemInspect); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SetItemToRepresent (Underlying native function: SetItemToRepresent 0x721cc64)
	void SetItemToRepresent(class UFortItem*& NewItemToRepresent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SelectPreviousItem (Underlying native function: SelectPreviousItem 0x721c6c8)
	void SelectPreviousItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SelectNextItem (Underlying native function: SelectNextItem 0x721c6b0)
	void SelectNextItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.SelectItemWithOffset (Underlying native function: SelectItemWithOffset 0x721c630)
	...
	// Function /Script/SaveTheWorldUI.FortItemInspectCycleWidget.GetItemWithOffset_BP (Underlying native function: GetItemWithOffset_BP 0x721a764)
