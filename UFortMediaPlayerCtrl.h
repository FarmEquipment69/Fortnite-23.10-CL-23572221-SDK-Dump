...
class UFortMediaPlayerCtrl : public UObject
{
	...
	// Function /Script/FortniteGame.FortMediaPlayerCtrl.SetPlayerStartTime (Underlying native function: SetPlayerStartTime 0x8c2b4a0)
	void SetPlayerStartTime(double& InRequestSentTime); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMediaPlayerCtrl.Play (Underlying native function: Play 0x8c2abac)
	bool Play(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMediaPlayerCtrl.OpenSourceWithOptions (Underlying native function: OpenSourceWithOptions 0x8c2aa6c)
	...
	// Function /Script/FortniteGame.FortMediaPlayerCtrl.GetPlayerStateIsPreparing (Underlying native function: GetPlayerStateIsPreparing 0x8c28448)
	bool GetPlayerStateIsPreparing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMediaPlayerCtrl.Close (Underlying native function: Close 0x8c27ee8)
