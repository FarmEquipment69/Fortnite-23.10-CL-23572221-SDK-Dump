...
class UAthenaGliderItemDefinition : public UAthenaCosmeticItemDefinition
{
	...
	// Function /Script/FortniteGame.AthenaGliderItemDefinition.MigrateGliderEffectDefinitions (Underlying native function: MigrateGliderEffectDefinitions 0x273fd14)
	void MigrateGliderEffectDefinitions(); // (Final | Native | Public)

	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetUserSkeletonParameterName (Underlying native function: GetUserSkeletonParameterName 0x84d6234)
	struct FName GetUserSkeletonParameterName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetTrailEffectDefinitions (Underlying native function: GetTrailEffectDefinitions 0x84d61b0)
	...
	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetPlayerAnimSetPtr (Underlying native function: GetPlayerAnimSetPtr 0x84d6050)
	...
	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetParachutePrefabClass (Underlying native function: GetParachutePrefabClass 0x84d5fec)
	class UClass* GetParachutePrefabClass(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetOverrideSkelMeshPtr (Underlying native function: GetOverrideSkelMeshPtr 0x84d5d7c)
	...
	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetOverrideAnimSetPtr (Underlying native function: GetOverrideAnimSetPtr 0x84d5a1c)
	struct TWeakObjectPtr<class UClass> GetOverrideAnimSetPtr(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetBits (Underlying native function: GetBits 0x84d5040)
	struct TArray<struct FGliderBitsDefinition> GetBits(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaGliderItemDefinition.GetAttachNiagaraEffectToPlayerPawn (Underlying native function: GetAttachNiagaraEffectToPlayerPawn 0x84d5028)
