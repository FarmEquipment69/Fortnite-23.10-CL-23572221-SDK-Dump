...
class UFortQuestUpdateEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortQuestUpdateEntry.SetQuestItem (Underlying native function: SetQuestItem 0xa761494)
	...
	// Function /Script/FortniteUI.FortQuestUpdateEntry.GetNumDisplayedObjectives (Underlying native function: GetNumDisplayedObjectives 0xa76078c)
	int GetNumDisplayedObjectives(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuestUpdateEntry.FinishQuestOutro (Underlying native function: FinishQuestOutro 0x71e6634)
	void FinishQuestOutro(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuestUpdateEntry.FinishQuestIntro (Underlying native function: FinishQuestIntro 0xa7606e8)
	void FinishQuestIntro(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuestUpdateEntry.CurrentlyDisplayedObjectiveFinished (Underlying native function: CurrentlyDisplayedObjectiveFinished 0xa7605e4)
	void CurrentlyDisplayedObjectiveFinished(class UFortQuestObjectiveEntry*& QuestObjective); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestUpdateEntry.CanAddObjective (Underlying native function: CanAddObjective 0xa760458)
