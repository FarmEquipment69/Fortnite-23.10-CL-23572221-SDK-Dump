...
class UFortShowdownScreen : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortShowdownScreen.NavigateTournamentRight (Underlying native function: NavigateTournamentRight 0xa7f2cb0)
	void NavigateTournamentRight(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortShowdownScreen.NavigateTournamentLeft (Underlying native function: NavigateTournamentLeft 0xa7f2c78)
	void NavigateTournamentLeft(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortShowdownScreen.HandleSelectedTileChanged (Underlying native function: HandleSelectedTileChanged 0xa7f1844)
	void HandleSelectedTileChanged(class UCommonButtonLegacy*& Button, int& ButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortShowdownScreen.HandlePopupStateChanged (Underlying native function: HandlePopupStateChanged 0xa7f158c)
