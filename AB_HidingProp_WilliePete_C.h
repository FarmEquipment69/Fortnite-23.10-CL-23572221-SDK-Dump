...
{
	unsigned char unreflected_13d2[0x6]; // 0x13d2 (0x6) 
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x13d8 (0x8)
	class UStaticMeshComponent* overlapCylinder; // 0x13e0 (0x8)
	class UAudioComponent* WilliePeteAmbientLoop; // 0x13e8 (0x8)
	class UStaticMeshComponent* Geyser; // 0x13f0 (0x8)
	class UStaticMeshComponent* SWhirlpool01; // 0x13f8 (0x8)
	class UParticleSystemComponent* PWilliePeteSurfaceVerticalSplash; // 0x1400 (0x8)
	class UFortProjectileMovementComponent* OverlappedFortProjectileMovementComponent; // 0x1408 (0x8)
	class UProjectileMovementComponent* OverlappedStandardProjectileMovementComponent; // 0x1410 (0x8)
	class AActor* TeleportingNonPawn; // 0x1418 (0x8)
	struct FHitResult SphereOverlapResult; // 0x1420 (0xe0)
	double ProjectileSpeedCeiling; // 0x1500 (0x8)
	struct FRotator ProjectileExitFVectorRotation; // 0x1508 (0x18)
	int WaterLevel; // 0x1520 (0x4)
	struct FGameplayTag GCExit; // 0x1524 (0x4)
	struct FGameplayTag GCEnter; // 0x1528 (0x4)
	unsigned char unreflected_152c[0x4]; // 0x152c (0x4) 
	struct FScalableFloat EnabledValue; // 0x1530 (0x28)
	struct FScalableFloat LaunchHeightValue; // 0x1558 (0x28)
	class AFortPlayerPawnAthena* LaunchPawn; // 0x1580 (0x8)
	struct FActiveGameplayEffectHandle* LaunchGrantedEffectHandle; // 0x1588 (0x8)
	struct FGameplayTagContainer TQuest; // 0x1590 (0x20)
	class UClass* SpawnedWaterBody; // 0x15b0 (0x8)
	struct FGameplayTag GCScreenFX; // 0x15b8 (0x4)
	bool isOnTestMap; // 0x15bc (0x1)
	unsigned char unreflected_15bd[0x3]; // 0x15bd (0x3) 
	class USoundBase* LaunchSound; // 0x15c0 (0x8)
	struct FVector AdjustedLocation; // 0x15c8 (0x18)
	bool skipAnimForLaunch; // 0x15e0 (0x1)
	unsigned char unreflected_15e1[0x7]; // 0x15e1 (0x7) 
	class AFortPlayerPawnAthena* ExitingPawn; // 0x15e8 (0x8)
	class UMovementComponent* OverlappedMovementComponent; // 0x15f0 (0x8)
	double ProjectileSpeedMult; // 0x15f8 (0x8)
	double PickupSpeedMult; // 0x1600 (0x8)
	bool bSetSilentDie; // 0x1608 (0x1)
	bool bSetSpawnedWaterBody; // 0x1609 (0x1)
