...
class UFortRewardInfoButton : public UCommonButtonBase
{
	...
	// Function /Script/FortniteUI.FortRewardInfoButton.SetShowDescription (Underlying native function: SetShowDescription 0xa7815c0)
	void SetShowDescription(bool& bInShowDescription); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoButton.SetItemInstanceQuantityPair (Underlying native function: SetItemInstanceQuantityPair 0xa780f18)
	...
	// Function /Script/FortniteUI.FortRewardInfoButton.GetQuantity (Underlying native function: GetQuantity 0xa77e450)
	int GetQuantity(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortRewardInfoButton.GetItemInstance (Underlying native function: GetItemInstance 0xa77e354)
