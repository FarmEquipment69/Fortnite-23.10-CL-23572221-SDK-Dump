...
class AFortUIZone : public AFortUIBaseClass
{
	...
	// Function /Script/FortniteGame.FortUIZone.ToggleTimeOfDayDebugInfo (Underlying native function: ToggleTimeOfDayDebugInfo 0x8d9811c)
	void ToggleTimeOfDayDebugInfo(); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.ToggleTargetInfoSensing (Underlying native function: ToggleTargetInfoSensing 0x8d980fc)
	void ToggleTargetInfoSensing(); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.ToggleTargetInfoPaths (Underlying native function: ToggleTargetInfoPaths 0x8d980dc)
	void ToggleTargetInfoPaths(); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.ToggleTargetInfoLock (Underlying native function: ToggleTargetInfoLock 0x8d9802c)
	void ToggleTargetInfoLock(bool& bTraceComplex); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.ToggleTargetInfoAI (Underlying native function: ToggleTargetInfoAI 0x8d98018)
	void ToggleTargetInfoAI(); // (Final | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.ToggleTargetInfo (Underlying native function: ToggleTargetInfo 0x8d97ff8)
	void ToggleTargetInfo(); // (Final | 0x00000002 | Exec | Native | Public)

	// Function /Script/FortniteGame.FortUIZone.GetCurrentCursorModeAction (Underlying native function: GetCurrentCursorModeAction 0x8d95a28)
	struct FName GetCurrentCursorModeAction(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortUIZone.CloseFullScreenMap (Underlying native function: CloseFullScreenMap 0x8d9582c)
