...
class UFortProjectileMoveComp_Slider : public UFortProjectileMovementComponent
{
	...
	// Function /Script/FortniteGame.FortProjectileMoveComp_Slider.ZeroOutSuspensionTension (Underlying native function: ZeroOutSuspensionTension 0x84986ac)
	void ZeroOutSuspensionTension(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileMoveComp_Slider.SetSuspensionEnabled (Underlying native function: SetSuspensionEnabled 0x8497cf8)
