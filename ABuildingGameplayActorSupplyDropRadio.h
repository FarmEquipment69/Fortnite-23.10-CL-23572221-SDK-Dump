...
class ABuildingGameplayActorSupplyDropRadio : public ABuildingGameplayActor
{
	...
	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.SetGravityMultiplier (Underlying native function: SetGravityMultiplier 0x6df7bc0)
	void SetGravityMultiplier(float& InGravityMultiplier); // (Final | BlueprintAuthorityOnly | Native | Protected | BlueprintCallable)

	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.SetBalloonState (Underlying native function: SetBalloonState 0x6f05250)
	...
	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.IsMoving (Underlying native function: IsMoving 0x70e0a74)
	...
	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.HandleMoveIgnoredActorEndPlay (Underlying native function: HandleMoveIgnoredActorEndPlay 0x52d0440)
	...
	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.GetHighestAttachParent (Underlying native function: GetHighestAttachParent 0x70e09e0)
	class AActor* GetHighestAttachParent(class AActor*& InActor); // (Final | Native | Protected | BlueprintCallable | Const)

	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.GetGravityZ (Underlying native function: GetGravityZ 0x2e07130)
	float GetGravityZ(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SupplyDropRadioRuntime.BuildingGameplayActorSupplyDropRadio.GetBalloonState (Underlying native function: GetBalloonState 0x304c248)
