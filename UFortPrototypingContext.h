...
class UFortPrototypingContext : public UBlueprintContextBase
{
	...
	// Function /Script/FortniteGame.FortPrototypingContext.HandleMcpProfilesInitialized (Underlying native function: HandleMcpProfilesInitialized 0x25dcdc8)
	void HandleMcpProfilesInitialized(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPrototypingContext.GetPrototypingStatus (Underlying native function: GetPrototypingStatus 0x876110c)
