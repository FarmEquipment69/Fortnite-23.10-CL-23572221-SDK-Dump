...
class UBuildingSMActorDynamicDestructionManager : public UWorldSubsystem
{
	...
	// Function /Script/FortniteGame.BuildingSMActorDynamicDestructionManager.OnBuildingSMActorEndPlay (Underlying native function: OnBuildingSMActorEndPlay 0x83abef8)
