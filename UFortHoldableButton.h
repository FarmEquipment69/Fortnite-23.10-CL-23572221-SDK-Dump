...
class UFortHoldableButton : public UCommonButtonBase
{
	...
	// Function /Script/FortniteUI.FortHoldableButton.SetEnableButtonHold (Underlying native function: SetEnableButtonHold 0xa5873c0)
	...
	// Function /Script/FortniteUI.FortHoldableButton.GetIsHoldRequired (Underlying native function: GetIsHoldRequired 0xa584748)
	bool GetIsHoldRequired(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHoldableButton.GetHoldPromptTextStyle (Underlying native function: GetHoldPromptTextStyle 0xa584724)
