...
class UAthenaAISpawner : public UAISubsystem
{
	...
	// Function /Script/FortniteAI.AthenaAISpawner.RequestSpawn (Underlying native function: RequestSpawn 0xa2338b8)
	...
	// Function /Script/FortniteAI.AthenaAISpawner.QueueForDespawn (Underlying native function: QueueForDespawn 0xa233238)
	void QueueForDespawn(class AActor*& ActorToDespawn); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.AthenaAISpawner.CancelRequest (Underlying native function: CancelRequest 0xa2311e8)
