...
class UFortHero : public UFortWorker
{
	...
	// Function /Script/FortniteGame.FortHero.IsLevelClamped (Underlying native function: IsLevelClamped 0x8cbc588)
	bool IsLevelClamped(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortHero.IsInExpeditionSquad (Underlying native function: IsInExpeditionSquad 0x8cbc564)
	bool IsInExpeditionSquad(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortHero.GetUnclampedLevel (Underlying native function: GetUnclampedLevel 0x2d7a924)
	int GetUnclampedLevel(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortHero.GetHeroTypeBP (Underlying native function: GetHeroTypeBP 0x8cb99d8)
