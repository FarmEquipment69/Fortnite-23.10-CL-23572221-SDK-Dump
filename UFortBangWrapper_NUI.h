...
class UFortBangWrapper_NUI : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortBangWrapper_NUI.UnregisterTutorialNameID (Underlying native function: UnregisterTutorialNameID 0xa55dde8)
	void UnregisterTutorialNameID(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBangWrapper_NUI.SetTutorialNameID (Underlying native function: SetTutorialNameID 0xa55d708)
	void SetTutorialNameID(struct FName& InTutorialNameID); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBangWrapper_NUI.SetBangType (Underlying native function: SetBangType 0xa55c380)
	void SetBangType(enum EFortBangType& NewBangType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBangWrapper_NUI.SetBangStateBP (Underlying native function: SetBangStateBP 0x279e3b0)
	...
	// Function /Script/FortniteUI.FortBangWrapper_NUI.AsyncPlaySound2D (Underlying native function: AsyncPlaySound2D 0xa559664)
