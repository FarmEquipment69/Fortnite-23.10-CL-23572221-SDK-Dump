...
class UFortMinigameVolumeComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortMinigameVolumeComponent.SetMinigameSettingsMachine (Underlying native function: SetMinigameSettingsMachine 0x88c9364)
	...
	// Function /Script/FortniteGame.FortMinigameVolumeComponent.OnRep_CurrentMinigame (Underlying native function: OnRep_CurrentMinigame 0x88c7ce0)
	void OnRepCurrentMinigame(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortMinigameVolumeComponent.OnRep_bShowPublishWatermark (Underlying native function: OnRep_bShowPublishWatermark 0x88c7e20)
	void OnRepbShowPublishWatermark(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortMinigameVolumeComponent.OnClientExitVolume (Underlying native function: OnClientExitVolume 0x88c7a2c)
	void OnClientExitVolume(class APlayerState*& InPlayerState, class AFortVolume*& InVolume); // (Final | 0x00000002 | Native | Public)

	// Function /Script/FortniteGame.FortMinigameVolumeComponent.OnClientEnterVolume (Underlying native function: OnClientEnterVolume 0x88c7968)
	void OnClientEnterVolume(class APlayerState*& InPlayerState, class AFortVolume*& InVolume); // (Final | 0x00000002 | Native | Public)

	// Function /Script/FortniteGame.FortMinigameVolumeComponent.HasReplicatedSettingsMachine (Underlying native function: HasReplicatedSettingsMachine 0x737d3a0)
