...
class AAthenaBarrierObjective : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.AthenaBarrierObjective.OnRep_ObjectiveDamageState (Underlying native function: OnRep_ObjectiveDamageState 0x7f97e94)
	void OnRepObjectiveDamageState(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.AthenaBarrierObjective.OnRep_HeadRotationYaw (Underlying native function: OnRep_HeadRotationYaw 0x7f97d58)
	void OnRepHeadRotationYaw(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.AthenaBarrierObjective.OnRep_FoodTeam (Underlying native function: OnRep_FoodTeam 0x7f97cd4)
	...
	// Function /Script/FortniteGame.AthenaBarrierObjective.OnGeneratorDestroyed (Underlying native function: OnGeneratorDestroyed 0x7f977d0)
	void OnGeneratorDestroyed(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.AthenaBarrierObjective.IsFriendlyTeam (Underlying native function: IsFriendlyTeam 0x7f96fa4)
	bool IsFriendlyTeam(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaBarrierObjective.GetObjectiveDamageState (Underlying native function: GetObjectiveDamageState 0x7f969b0)
	...
	// Function /Script/FortniteGame.AthenaBarrierObjective.GetFoodTeam (Underlying native function: GetFoodTeam 0x7f96818)
