...
class UFortAthenaAISpawnerDataComponent_CosmeticLibrary : public UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase
{
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryDataIndex (Underlying native function: GetAICosmeticLibraryDataIndex 0xa1f5d6c)
	int GetAICosmeticLibraryDataIndex(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryData (Underlying native function: GetAICosmeticLibraryData 0xa1f5d44)
