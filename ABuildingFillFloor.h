...
class ABuildingFillFloor : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingFillFloor.StopMovement (Underlying native function: StopMovement 0x8358b6c)
	void StopMovement(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingFillFloor.StartMovement (Underlying native function: StartMovement 0x7fbd6c0)
	...
	// Function /Script/FortniteGame.BuildingFillFloor.OnRep_StepIndex (Underlying native function: OnRep_StepIndex 0x8357ab8)
	void OnRepStepIndex(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingFillFloor.OnRep_IsMoving (Underlying native function: OnRep_IsMoving 0x83578b0)
	void OnRepIsMoving(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingFillFloor.OnRep_FloorZ (Underlying native function: OnRep_FloorZ 0x8357794)
	void OnRepFloorZ(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingFillFloor.OnLavaOverlap (Underlying native function: OnLavaOverlap 0x6df70d4)
	...
	// Function /Script/FortniteGame.BuildingFillFloor.InterpToStopCallback (Underlying native function: InterpToStopCallback 0x8356838)
	void InterpToStopCallback(struct FHitResult& ImpactResult, float& Time); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.BuildingFillFloor.GetFloorPositionFromStep (Underlying native function: GetFloorPositionFromStep 0x8356168)
