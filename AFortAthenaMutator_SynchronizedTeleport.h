...
class AFortAthenaMutator_SynchronizedTeleport : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SynchronizedTeleport.OnRep_TeleportComplete (Underlying native function: OnRep_TeleportComplete 0x82637a8)
