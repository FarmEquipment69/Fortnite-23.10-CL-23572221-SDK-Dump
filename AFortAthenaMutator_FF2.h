...
class AFortAthenaMutator_FF2 : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_FF2.UpdateHealth (Underlying native function: UpdateHealth 0x81fc61c)
	void UpdateHealth(); // (Final | 0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_FF2.OnRep_EndOfLastRoundServerTime (Underlying native function: OnRep_EndOfLastRoundServerTime 0x81fadd4)
	void OnRepEndOfLastRoundServerTime(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_FF2.OnRep_CurrentRound (Underlying native function: OnRep_CurrentRound 0x81fad4c)
