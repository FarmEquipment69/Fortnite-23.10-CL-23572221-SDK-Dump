...
class UAthenaSpectatorBuildCountBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpectatorBuildCountBase.UpdateBuildCount (Underlying native function: UpdateBuildCount 0xa441ecc)
	void UpdateBuildCount(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorBuildCountBase.OnWorldItemListChanged (Underlying native function: OnWorldItemListChanged 0xa4409dc)
	...
	// Function /Script/FortniteUI.AthenaSpectatorBuildCountBase.OnFollowedPlayerChanged (Underlying native function: OnFollowedPlayerChanged 0x16477c4)
