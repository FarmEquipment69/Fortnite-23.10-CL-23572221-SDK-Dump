...
class UFortQuestUpdatesLog : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortQuestUpdatesLog.HandleQuestUpdateFinished (Underlying native function: HandleQuestUpdateFinished 0xa77f538)
	void HandleQuestUpdateFinished(class UFortQuestUpdateEntry*& QuestEntryFinished); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestUpdatesLog.HandleDisplayDynamicQuestUpdate (Underlying native function: HandleDisplayDynamicQuestUpdate 0xa77ecd0)
