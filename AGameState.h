...
class AGameState : public AGameStateBase
{
	...
	// Function /Script/Engine.GameState.OnRep_MatchState (Underlying native function: OnRep_MatchState 0x29fce3c)
	void OnRepMatchState(); // (Native | Public)

	// Function /Script/Engine.GameState.OnRep_ElapsedTime (Underlying native function: OnRep_ElapsedTime 0x3057b24)
