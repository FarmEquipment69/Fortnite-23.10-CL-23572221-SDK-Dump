...
class UEndOfMatchQuestEntryWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.EndOfMatchQuestEntryWidget.HandleNotificationDisplayed (Underlying native function: HandleNotificationDisplayed 0xa3468bc)
	void HandleNotificationDisplayed(); // (Final | Native | Private)

	// Function /Script/FortniteUI.EndOfMatchQuestEntryWidget.HandleMoveDownFinished (Underlying native function: HandleMoveDownFinished 0xa346804)
