...
class AFortTeamMemberPedestal : public AFortItemPlacementActor
{
	...
	// Function /Script/FortniteUI.FortTeamMemberPedestal.IsValidTeamMember (Underlying native function: IsValidTeamMember 0x252b978)
	bool IsValidTeamMember(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.IsPlayingFortnite (Underlying native function: IsPlayingFortnite 0x1cf6d08)
	bool IsPlayingFortnite(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.IsInLocalSquadGroup (Underlying native function: IsInLocalSquadGroup 0x1a26694)
	bool IsInLocalSquadGroup(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.IsInFrontEnd (Underlying native function: IsInFrontEnd 0x25dbdd8)
	bool IsInFrontEnd(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.IsCurrentMemberLocal (Underlying native function: IsCurrentMemberLocal 0x18b8f20)
	bool IsCurrentMemberLocal(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.InitializePlaceholderMesh (Underlying native function: InitializePlaceholderMesh 0x1a24700)
	void InitializePlaceholderMesh(class UStaticMeshComponent*& PlaceholderMesh); // (Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.HandlePlaceholderMeshInputTouchEnd (Underlying native function: HandlePlaceholderMeshInputTouchEnd 0xa5f57b8)
	...
	// Function /Script/FortniteUI.FortTeamMemberPedestal.HandlePlaceholderMeshEndCursorOver (Underlying native function: HandlePlaceholderMeshEndCursorOver 0xa5f5a24)
	void HandlePlaceholderMeshEndCursorOver(class UPrimitiveComponent*& TouchedComponent); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.HandlePlaceholderMeshClicked (Underlying native function: HandlePlaceholderMeshClicked 0xa5f58f8)
	...
	// Function /Script/FortniteUI.FortTeamMemberPedestal.HandlePlaceholderMeshBeginCursorOver (Underlying native function: HandlePlaceholderMeshBeginCursorOver 0xa5f5878)
	void HandlePlaceholderMeshBeginCursorOver(class UPrimitiveComponent*& TouchedComponent); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.GetTeamMemberDisplayName (Underlying native function: GetTeamMemberDisplayName 0xa5f5198)
	struct FString GetTeamMemberDisplayName(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.GetCurrentTeamSize (Underlying native function: GetCurrentTeamSize 0x2501968)
	int GetCurrentTeamSize(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.ClearOverrideMaterial (Underlying native function: ClearOverrideMaterial 0xa5f473c)
	void ClearOverrideMaterial(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortTeamMemberPedestal.ApplyUniformOverrideMaterial (Underlying native function: ApplyUniformOverrideMaterial 0xa5f4530)
