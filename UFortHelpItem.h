...
class UFortHelpItem : public UDataAsset
{
	...
	// Function /Script/FortniteGame.FortHelpItem.GetSubItems (Underlying native function: GetSubItems 0x6e48e40)
	struct TArray<class UFortHelpItem*> GetSubItems(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHelpItem.GetItemWithID (Underlying native function: GetItemWithID 0x87df894)
