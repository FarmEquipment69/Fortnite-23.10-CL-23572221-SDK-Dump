...
class UFortCollectionBookPageListWidget : public UCommonButtonLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookPageListWidget.OnSlottedItemOperationComplete (Underlying native function: OnSlottedItemOperationComplete 0x71e9228)
