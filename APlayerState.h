...
class APlayerState : public AInfo
{
	...
	// Function /Script/Engine.PlayerState.OnRep_UniqueId (Underlying native function: OnRep_UniqueId 0x1598c88)
	void OnRepUniqueId(); // (Native | Public)

	// Function /Script/Engine.PlayerState.OnRep_Score (Underlying native function: OnRep_Score 0x2466474)
	void OnRepScore(); // (Native | Public)

	// Function /Script/Engine.PlayerState.OnRep_PlayerName (Underlying native function: OnRep_PlayerName 0x1598df4)
	void OnRepPlayerName(); // (Native | Public)

	// Function /Script/Engine.PlayerState.OnRep_PlayerID (Underlying native function: OnRep_PlayerID 0x26b0974)
	void OnRepPlayerID(); // (Native | Public)

	// Function /Script/Engine.PlayerState.OnRep_bIsInactive (Underlying native function: OnRep_bIsInactive 0x82aa228)
	void OnRepbIsInactive(); // (Native | Public)

	// Function /Script/Engine.PlayerState.OnPawnPrivateDestroyed (Underlying native function: OnPawnPrivateDestroyed 0x23fa4d8)
	void OnPawnPrivateDestroyed(class AActor*& InActor); // (Final | Native | Private)

	// Function /Script/Engine.PlayerState.IsSpectator (Underlying native function: IsSpectator 0x9d4b32c)
	bool IsSpectator(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.IsOnlyASpectator (Underlying native function: IsOnlyASpectator 0x9d4b310)
	bool IsOnlyASpectator(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.IsABot (Underlying native function: IsABot 0x9d4b184)
	bool IsABot(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetScore (Underlying native function: GetScore 0x80ced90)
	float GetScore(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetPlayerName (Underlying native function: GetPlayerName 0x26fba08)
	struct FString GetPlayerName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetPlayerId (Underlying native function: GetPlayerId 0x9d4ad98)
	int GetPlayerId(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetPlayerController (Underlying native function: GetPlayerController 0x9d4ad4c)
	class APlayerController* GetPlayerController(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetPingInMilliseconds (Underlying native function: GetPingInMilliseconds 0x9d4ad00)
	float GetPingInMilliseconds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetPawn (Underlying native function: GetPawn 0x9d4ace8)
	class APawn* GetPawn(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.GetCompressedPing (Underlying native function: GetCompressedPing 0x8495618)
	unsigned char GetCompressedPing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.PlayerState.BP_GetUniqueId (Underlying native function: BP_GetUniqueId 0x8bbda08)
