...
class UFortCampaignNewsWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortCampaignNewsWidget.PlayNewsTilesIntro (Underlying native function: PlayNewsTilesIntro 0xa7f3024)
	void PlayNewsTilesIntro(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCampaignNewsWidget.LogMotDLobbyNavAction (Underlying native function: LogMotDLobbyNavAction 0xa7f2c50)
	void LogMotDLobbyNavAction(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCampaignNewsWidget.LogMotDCloseAction (Underlying native function: LogMotDCloseAction 0xa7f2c3c)
