...
class UFortActivitySearchView : public UFortActivityBrowserView
{
	...
	// Function /Script/DiscoveryBrowserUI.FortActivitySearchView.HandleTextCommitted (Underlying native function: HandleTextCommitted 0x7067db0)
	void HandleTextCommitted(struct FText& InText, struct TEnumAsByte<ETextCommit>& CommitInfo); // (Final | Native | Private | HasOutParms)

	// Function /Script/DiscoveryBrowserUI.FortActivitySearchView.HandleTextChanged (Underlying native function: HandleTextChanged 0x7067cf4)
