...
class UFortJumpBoostSet : public UFortAttributeSet
{
	...
	// Function /Script/FortniteGame.FortJumpBoostSet.OnRep_ReserveFuel (Underlying native function: OnRep_ReserveFuel 0x831c0fc)
	void OnRepReserveFuel(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortJumpBoostSet.OnRep_Fuel (Underlying native function: OnRep_Fuel 0x8319eb8)
