...
class AFortTimeOfDayManager : public AInfo
{
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.UpdatePostProcessVolumesV2 (Underlying native function: UpdatePostProcessVolumesV2 0x877cc70)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.UpdatePostProcessVolumes (Underlying native function: UpdatePostProcessVolumes 0x877cbf0)
	void UpdatePostProcessVolumes(enum EFortDayPhase& InCurrentTimeOfDayEditing); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.UpdateInhibitorLastModificationDate (Underlying native function: UpdateInhibitorLastModificationDate 0x877cb50)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.TryToUpdateFogForInhibitors (Underlying native function: TryToUpdateFogForInhibitors 0x877ca78)
	void TryToUpdateFogForInhibitors(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.ToggleDebugForceStormEffects (Underlying native function: ToggleDebugForceStormEffects 0x877ca58)
	void ToggleDebugForceStormEffects(); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.SetUseSpecificTimeOfDayEditing (Underlying native function: SetUseSpecificTimeOfDayEditing 0x6df775c)
	void SetUseSpecificTimeOfDayEditing(bool& bShouldUseSpecificTimeOfDay); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.SetStormStrength (Underlying native function: SetStormStrength 0x877c690)
	void SetStormStrength(float& NewStormStrength); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.SetSpecificTimeOfDayInEditor (Underlying native function: SetSpecificTimeOfDayInEditor 0x6df7bc0)
	void SetSpecificTimeOfDayInEditor(float& NewTimeOfDayInEditor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.SetRealTimeCaptureAndUpdateSkyCapture (Underlying native function: SetRealTimeCaptureAndUpdateSkyCapture 0x877c5fc)
	void SetRealTimeCaptureAndUpdateSkyCapture(bool& bIsRealCaptureActive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.SetFogDirectionalInscatteringMultiplier (Underlying native function: SetFogDirectionalInscatteringMultiplier 0x877c578)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.SetDirectionalLightComponentRotation (Underlying native function: SetDirectionalLightComponentRotation 0x877c454)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.SetDirectionalLightColorMultiplier (Underlying native function: SetDirectionalLightColorMultiplier 0x877c3d0)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.RemoveLightAndFogPhaseSettingOverrideMulticast (Underlying native function: RemoveLightAndFogPhaseSettingOverrideMulticast 0x877c304)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.RemoveLightAndFogPhaseSettingOverride (Underlying native function: RemoveLightAndFogPhaseSettingOverride 0x877c23c)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_WeatherComponent (Underlying native function: OnRep_WeatherComponent 0x6f49804)
	void OnRepWeatherComponent(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_TimeOfDaySpeed (Underlying native function: OnRep_TimeOfDaySpeed 0x82aac50)
	void OnRepTimeOfDaySpeed(float& OldTimeOfDaySpeed); // (Native | Public)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_TimeOfDayInit (Underlying native function: OnRep_TimeOfDayInit 0x877bf8c)
	void OnRepTimeOfDayInit(float& OldTimeOfDay); // (Native | Public)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_TimeOfDay (Underlying native function: OnRep_TimeOfDay 0x82aa228)
	void OnRepTimeOfDay(); // (Native | Public)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_ServerTODIsVisible (Underlying native function: OnRep_ServerTODIsVisible 0x877bf78)
	void OnRepServerTODIsVisible(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_HeightFogEnabled (Underlying native function: OnRep_HeightFogEnabled 0x7b064c8)
	void OnRepHeightFogEnabled(); // (Native | Public)

	// Function /Script/FortniteGame.FortTimeOfDayManager.OnRep_DirectOverrides (Underlying native function: OnRep_DirectOverrides 0x877bf64)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.MakeExponentialHeightFogValues (Underlying native function: MakeExponentialHeightFogValues 0x877bbe0)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.Inhibitor_SetDefaultSettings (Underlying native function: Inhibitor_SetDefaultSettings 0x877bba8)
	void InhibitorSetDefaultSettings(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.HasInhibitors (Underlying native function: HasInhibitors 0x877bb88)
	bool HasInhibitors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetThreatClouds (Underlying native function: GetThreatClouds 0x877b854)
	struct TArray<struct FThreatLocationInfo> GetThreatClouds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetStormStrength (Underlying native function: GetStormStrength 0x877b7ec)
	float GetStormStrength(); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetSafeZoneGamePhaseTimeRemaining (Underlying native function: GetSafeZoneGamePhaseTimeRemaining 0x877b7d4)
	float GetSafeZoneGamePhaseTimeRemaining(); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetLastEnabledInhibitor (Underlying native function: GetLastEnabledInhibitor 0x877b7bc)
	class AActor* GetLastEnabledInhibitor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetDirectOverrideFogStartDistance (Underlying native function: GetDirectOverrideFogStartDistance 0x877b644)
	float GetDirectOverrideFogStartDistance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetDirectOverrideFogDensity (Underlying native function: GetDirectOverrideFogDensity 0x877b61c)
	float GetDirectOverrideFogDensity(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.GetDirectOverrideFogColor (Underlying native function: GetDirectOverrideFogColor 0x877b5ec)
	struct FLinearColor GetDirectOverrideFogColor(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortTimeOfDayManager.EndBlendLightAndFogPhaseSettingOverride (Underlying native function: EndBlendLightAndFogPhaseSettingOverride 0x877b358)
	void EndBlendLightAndFogPhaseSettingOverride(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.EnableVolumeInhibitor (Underlying native function: EnableVolumeInhibitor 0x877b2b8)
	void EnableVolumeInhibitor(struct FInhibitorData& InhibitorData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.EnableGlobalInhibitor (Underlying native function: EnableGlobalInhibitor 0x877b218)
	void EnableGlobalInhibitor(struct FInhibitorData& InhibitorData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.DisableVolumeInhibitor (Underlying native function: DisableVolumeInhibitor 0x877b178)
	void DisableVolumeInhibitor(struct FInhibitorData& InhibitorData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.DisableGlobalInhibitor (Underlying native function: DisableGlobalInhibitor 0x877b0d8)
	void DisableGlobalInhibitor(struct FInhibitorData& InhibitorData); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.BreakExponentialHeightFogValues (Underlying native function: BreakExponentialHeightFogValues 0x877ab0c)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.BlendLightAndFogPhaseSettingOverride (Underlying native function: BlendLightAndFogPhaseSettingOverride 0x877aa88)
	void BlendLightAndFogPhaseSettingOverride(float& Alpha); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortTimeOfDayManager.ApplyInhibitorFogOverrides (Underlying native function: ApplyInhibitorFogOverrides 0x877a988)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.AddLightAndFogPhaseSettingOverrideMulticast (Underlying native function: AddLightAndFogPhaseSettingOverrideMulticast 0x877a888)
	...
	// Function /Script/FortniteGame.FortTimeOfDayManager.AddLightAndFogPhaseSettingOverride (Underlying native function: AddLightAndFogPhaseSettingOverride 0x877a78c)
