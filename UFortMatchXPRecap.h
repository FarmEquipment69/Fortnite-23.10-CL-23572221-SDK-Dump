...
class UFortMatchXPRecap : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortMatchXPRecap.IsSpectating (Underlying native function: IsSpectating 0x5ce0540)
	bool IsSpectating(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortMatchXPRecap.HandleToggleFullscreenMap (Underlying native function: HandleToggleFullscreenMap 0xa3a1614)
	void HandleToggleFullscreenMap(bool& bFullscreenMapVisible); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortMatchXPRecap.HandlePostMinigameReset (Underlying native function: HandlePostMinigameReset 0xa3a0fcc)
	void HandlePostMinigameReset(); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortMatchXPRecap.FocusOnDesiredTarget (Underlying native function: FocusOnDesiredTarget 0xa3a0254)
