...
class UFortGameStateComponent_Crafting : public UFortGameStateComponent
{
	...
	// Function /Script/CraftingRuntime.FortGameStateComponent_Crafting.OnRep_CraftingResultsList (Underlying native function: OnRep_CraftingResultsList 0x6f5731c)
	void OnRepCraftingResultsList(); // (Final | Native | Protected)

	// Function /Script/CraftingRuntime.FortGameStateComponent_Crafting.OnPlaylistDataReady (Underlying native function: OnPlaylistDataReady 0x6f571ec)
