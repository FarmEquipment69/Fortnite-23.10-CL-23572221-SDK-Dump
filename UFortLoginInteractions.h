...
class UFortLoginInteractions : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortLoginInteractions.HandleDisplayWebLogin (Underlying native function: HandleDisplayWebLogin 0xa6634c4)
	void HandleDisplayWebLogin(class UWidget*& WebWidget); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLoginInteractions.HandleDisplayWebAccountCreation (Underlying native function: HandleDisplayWebAccountCreation 0xa663444)
	void HandleDisplayWebAccountCreation(class UWidget*& WebWidget); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLoginInteractions.HandleDismissWebLogin (Underlying native function: HandleDismissWebLogin 0xa663430)
	void HandleDismissWebLogin(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLoginInteractions.HandleDismissWebAccountCreation (Underlying native function: HandleDismissWebAccountCreation 0xa663430)
