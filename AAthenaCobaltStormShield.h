...
class AAthenaCobaltStormShield : public AFortMissionStormShield
{
	...
	// Function /Script/FortniteGame.AthenaCobaltStormShield.StormShieldShrinkTimerComplete (Underlying native function: StormShieldShrinkTimerComplete 0x7fbe798)
	void StormShieldShrinkTimerComplete(); // (Final | Native | Private)

	// Function /Script/FortniteGame.AthenaCobaltStormShield.OnRep_ClientStormShieldShrinkTimerValue (Underlying native function: OnRep_ClientStormShieldShrinkTimerValue 0x7fbde38)
	void OnRepClientStormShieldShrinkTimerValue(); // (Final | Native | Private)

	// Function /Script/FortniteGame.AthenaCobaltStormShield.ClientStormShieldShrinkTimerComplete (Underlying native function: ClientStormShieldShrinkTimerComplete 0x7fbc4c4)
