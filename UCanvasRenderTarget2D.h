...
class UCanvasRenderTarget2D : public UTextureRenderTarget2D
{
	...
	// Function /Script/Engine.CanvasRenderTarget2D.UpdateResource (Underlying native function: UpdateResource 0x7e70ff4)
	...
	// Function /Script/Engine.CanvasRenderTarget2D.GetSize (Underlying native function: GetSize 0x9aef034)
	void GetSize(int& Width, int& Height); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure)

	// Function /Script/Engine.CanvasRenderTarget2D.CreateCanvasRenderTarget2D (Underlying native function: CreateCanvasRenderTarget2D 0x9aeea0c)
