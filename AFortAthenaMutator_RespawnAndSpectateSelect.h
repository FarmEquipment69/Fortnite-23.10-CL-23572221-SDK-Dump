...
class AFortAthenaMutator_RespawnAndSpectateSelect : public AFortAthenaMutator_SpectateBeforeRespawn
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_RespawnAndSpectateSelect.OnSafezoneStateChanged (Underlying native function: OnSafezoneStateChanged 0x6f05250)
	void OnSafezoneStateChanged(enum EFortSafeZoneState& InSafeZoneState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnAndSpectateSelect.OnRep_RespawnTargetDataArray (Underlying native function: OnRep_RespawnTargetDataArray 0x824a778)
	void OnRepRespawnTargetDataArray(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnAndSpectateSelect.OnRep_ManagerObject (Underlying native function: OnRep_ManagerObject 0x824a6d0)
	void OnRepManagerObject(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnAndSpectateSelect.GetCanPlayerSelectRespawnTargetBeforeTheyCanRespawn (Underlying native function: GetCanPlayerSelectRespawnTargetBeforeTheyCanRespawn 0x82497ec)
