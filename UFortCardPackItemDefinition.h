...
class UFortCardPackItemDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortCardPackItemDefinition.IsLlama (Underlying native function: IsLlama 0x86e0edc)
	bool IsLlama(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.IsChoicePack (Underlying native function: IsChoicePack 0x8ce88a4)
	bool IsChoicePack(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.GetXRayImage (Underlying native function: GetXRayImage 0x8ce86b4)
	struct TWeakObjectPtr<class UTexture2D> GetXRayImage(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.GetPackPersonality (Underlying native function: GetPackPersonality 0x8ce80e8)
	class UFortPackPersonality* GetPackPersonality(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.GetPackImage (Underlying native function: GetPackImage 0x8ce80b8)
	class UTexture* GetPackImage(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.GetPackColor (Underlying native function: GetPackColor 0x8ce809c)
	struct FLinearColor GetPackColor(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCardPackItemDefinition.GetDisplayRarityLevel (Underlying native function: GetDisplayRarityLevel 0x2d7b314)
