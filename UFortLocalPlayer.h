...
class UFortLocalPlayer : public ULocalPlayer
{
	...
	// Function /Script/FortniteGame.FortLocalPlayer.GetSupervisedSettingsManager (Underlying native function: GetSupervisedSettingsManager 0x8b6af3c)
	class UFortSupervisedSettingsManager* GetSupervisedSettingsManager(); // (Final | 0x00000002 | Native | Public | Const)

	// Function /Script/FortniteGame.FortLocalPlayer.GetLocalSettings (Underlying native function: GetLocalSettings 0x2453d0c)
	class UFortGameUserSettings* GetLocalSettings(); // (Final | 0x00000002 | Native | Public | Const)

	// Function /Script/FortniteGame.FortLocalPlayer.GetContentControlsManagerEvenIfUninitialized (Underlying native function: GetContentControlsManagerEvenIfUninitialized 0x8b6a66c)
	class UFortContentControlsManager* GetContentControlsManagerEvenIfUninitialized(); // (Final | Native | Public | Const)

	// Function /Script/FortniteGame.FortLocalPlayer.GetContentControlsManager (Underlying native function: GetContentControlsManager 0x8b6a648)
	class UFortContentControlsManager* GetContentControlsManager(); // (Final | 0x00000002 | Native | Public | Const)

	// Function /Script/FortniteGame.FortLocalPlayer.GetClientSettings (Underlying native function: GetClientSettings 0x2436cf8)
