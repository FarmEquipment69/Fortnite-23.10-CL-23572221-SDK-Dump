...
class UFortActorComponent_MultiInteract : public UGameFrameworkComponent
{
	...
	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.RemoveInteractingActor (Underlying native function: RemoveInteractingActor 0x6df70d4)
	...
	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.OnRep_ServerInteractionData (Underlying native function: OnRep_ServerInteractionData 0x25460a4)
	void OnRepServerInteractionData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.OnRep_InteractingPlayers (Underlying native function: OnRep_InteractingPlayers 0x24a237c)
	void OnRepInteractingPlayers(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.OnRep_InteractingNonPlayerActorCount (Underlying native function: OnRep_InteractingNonPlayerActorCount 0x843dc60)
	void OnRepInteractingNonPlayerActorCount(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.IsMultipleInteractionEnabled (Underlying native function: IsMultipleInteractionEnabled 0x843d9ec)
	bool IsMultipleInteractionEnabled(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.HasMaxInteractingActors (Underlying native function: HasMaxInteractingActors 0x843d914)
	bool HasMaxInteractingActors(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.HandleInteractingActorDestroyed (Underlying native function: HandleInteractingActorDestroyed 0x6df70d4)
	void HandleInteractingActorDestroyed(class AActor*& DestroyedActor); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.GetServerInteractionDuration (Underlying native function: GetServerInteractionDuration 0x843d6e0)
	float GetServerInteractionDuration(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.GetMultiplier (Underlying native function: GetMultiplier 0x843d378)
	float GetMultiplier(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.GetInteractionDuration (Underlying native function: GetInteractionDuration 0x2ade2c0)
	float GetInteractionDuration(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.GetInteractingActorCount (Underlying native function: GetInteractingActorCount 0x24a2510)
	...
	// Function /Script/FortniteGame.FortActorComponent_MultiInteract.AddInteractingActor (Underlying native function: AddInteractingActor 0x6df70d4)
