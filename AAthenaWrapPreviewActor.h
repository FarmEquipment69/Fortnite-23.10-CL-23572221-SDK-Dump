...
class AAthenaWrapPreviewActor : public AFortItemPreviewMultiAngleActor
{
	...
	// Function /Script/FortniteGame.AthenaWrapPreviewActor.ShowNextPreviewMesh (Underlying native function: ShowNextPreviewMesh 0x87b5644)
	void ShowNextPreviewMesh(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.AthenaWrapPreviewActor.IsShowingVehicle (Underlying native function: IsShowingVehicle 0x87b43c8)
	bool IsShowingVehicle(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaWrapPreviewActor.GetActiveCamera (Underlying native function: GetActiveCamera 0x87b23ec)
