...
class UFortSchematicItemDefinition : public UFortAlterableItemDefinition
{
	...
	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetResultWorldItemDefinition (Underlying native function: GetResultWorldItemDefinition 0x8ce8428)
	...
	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetRecipe (Underlying native function: GetRecipe 0x8ce82c0)
	struct FRecipe GetRecipe(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetQuantityProduced (Underlying native function: GetQuantityProduced 0x8ce829c)
	int GetQuantityProduced(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetCraftingTimeForCharacter (Underlying native function: GetCraftingTimeForCharacter 0x8ce70e4)
	...
	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetCraftingTime (Underlying native function: GetCraftingTime 0x8ce7054)
	float GetCraftingTime(int& Level); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSchematicItemDefinition.GetCraftingSuccessSound (Underlying native function: GetCraftingSuccessSound 0x8ce7004)
	class USoundBase* GetCraftingSuccessSound(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSchematicItemDefinition.DoesResultWorldItemDisassembleRecipeMatchExactly (Underlying native function: DoesResultWorldItemDisassembleRecipeMatchExactly 0x8ce5f90)
