...
class UFortGameplayAbility_AIPortal : public UFortGameplayAbility_Action
{
	...
	// Function /Script/FortniteGame.FortGameplayAbility_AIPortal.ModifyCollisions (Underlying native function: ModifyCollisions 0x7e4ab4c)
	void ModifyCollisions(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbility_AIPortal.HasPortalOutPoint (Underlying native function: HasPortalOutPoint 0x7e4a504)
	bool HasPortalOutPoint(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility_AIPortal.GetPortalOutPoint (Underlying native function: GetPortalOutPoint 0x7e490cc)
	...
	// Function /Script/FortniteGame.FortGameplayAbility_AIPortal.GetPortalInPoint (Underlying native function: GetPortalInPoint 0x7e49094)
	...
	// Function /Script/FortniteGame.FortGameplayAbility_AIPortal.GetPortalBuilding (Underlying native function: GetPortalBuilding 0x7e49070)
