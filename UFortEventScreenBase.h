...
class UFortEventScreenBase : public UFortItemPreviewScreen
{
	...
	// Function /Script/EventScreenBase.FortEventScreenBase.HandleToggleFullscreenMap (Underlying native function: HandleToggleFullscreenMap 0x707bc44)
	void HandleToggleFullscreenMap(bool& bVisible); // (Final | Native | Private)

	// Function /Script/EventScreenBase.FortEventScreenBase.HandleGiftBoxClosed (Underlying native function: HandleGiftBoxClosed 0x707b990)
