...
class UFortQuestItemDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.ShouldDisplayStartingToast (Underlying native function: ShouldDisplayStartingToast 0x8bfcc80)
	bool ShouldDisplayStartingToast(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.ShouldDisplayOverallQuestInformation (Underlying native function: ShouldDisplayOverallQuestInformation 0x8bfcc64)
	bool ShouldDisplayOverallQuestInformation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.ShouldAutoLaunch (Underlying native function: ShouldAutoLaunch 0x8bfcc48)
	bool ShouldAutoLaunch(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsTutorialQuest (Underlying native function: IsTutorialQuest 0x8bfc634)
	bool IsTutorialQuest(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsPunchCardQuest (Underlying native function: IsPunchCardQuest 0x8bfbfd8)
	bool IsPunchCardQuest(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsIncludedInCategories (Underlying native function: IsIncludedInCategories 0x8bfbe04)
	bool IsIncludedInCategories(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsHidden (Underlying native function: IsHidden 0x8bfbdc8)
	bool IsHidden(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsGroupChallenge (Underlying native function: IsGroupChallenge 0x8bfbda4)
	bool IsGroupChallenge(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsGlyphQuest (Underlying native function: IsGlyphQuest 0x8bfbd80)
	bool IsGlyphQuest(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsFeatQuest (Underlying native function: IsFeatQuest 0x8bfbd58)
	bool IsFeatQuest(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.IsDeprecated (Underlying native function: IsDeprecated 0x8bfbd3c)
	bool IsDeprecated(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.HasComponentForWorldProcessingUpdates (Underlying native function: HasComponentForWorldProcessingUpdates 0x8bfbd04)
	bool HasComponentForWorldProcessingUpdates(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetWeight (Underlying native function: GetWeight 0x8bfb2e4)
	float GetWeight(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetUpdateObjectiveOncePerMatch (Underlying native function: GetUpdateObjectiveOncePerMatch 0x8bfb2ac)
	bool GetUpdateObjectiveOncePerMatch(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetSelectRewardsConversation (Underlying native function: GetSelectRewardsConversation 0x8bfaf30)
	class UFortConversation* GetSelectRewardsConversation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetSelectableRewards_BP (Underlying native function: GetSelectableRewards_BP 0x8bfaf60)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.GetRewardType (Underlying native function: GetRewardType 0x8bfaecc)
	enum EFortQuestRewardType GetRewardType(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetRewards_BP (Underlying native function: GetRewards_BP 0x8bfaef0)
	struct TArray<struct FFortItemQuantityPair> GetRewardsBP(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetRewardInfo_BP (Underlying native function: GetRewardInfo_BP 0x8bfae8c)
	struct FFortRewardInfo GetRewardInfoBP(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetRewardHeaderText (Underlying native function: GetRewardHeaderText 0x87b2a98)
	struct FText GetRewardHeaderText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetRewardDescription (Underlying native function: GetRewardDescription 0x87b2b0c)
	struct FText GetRewardDescription(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetQuestType (Underlying native function: GetQuestType 0x8bfade4)
	enum EFortQuestType GetQuestType(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetQuestHeaderToastDisplayText (Underlying native function: GetQuestHeaderToastDisplayText 0x8bfacc8)
	struct FText GetQuestHeaderToastDisplayText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetPrerequisiteQuest (Underlying native function: GetPrerequisiteQuest 0x8bfac98)
	class UFortQuestItemDefinition* GetPrerequisiteQuest(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetPrerequisiteObjective (Underlying native function: GetPrerequisiteObjective 0x8bfac7c)
	struct FDataTableRowHandle GetPrerequisiteObjective(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetPartialObjectiveCompletionCount (Underlying native function: GetPartialObjectiveCompletionCount 0x8bfac34)
	int GetPartialObjectiveCompletionCount(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetObjectives_BP (Underlying native function: GetObjectives_BP 0x8bfaaec)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.GetObjectiveNeededToComplete (Underlying native function: GetObjectiveNeededToComplete 0x8bfaac8)
	int GetObjectiveNeededToComplete(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetLockedDisplayTextOverride (Underlying native function: GetLockedDisplayTextOverride 0x8bfa8cc)
	struct FText GetLockedDisplayTextOverride(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetIntroConversation (Underlying native function: GetIntroConversation 0x8bfa89c)
	class UFortConversation* GetIntroConversation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetHiddenRewards_BP (Underlying native function: GetHiddenRewards_BP 0x8bfa834)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCompletionVideoUID (Underlying native function: GetCompletionVideoUID 0x8bfa648)
	struct FString GetCompletionVideoUID(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCompletionText (Underlying native function: GetCompletionText 0x87b3b48)
	struct FText GetCompletionText(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetClaimConversation (Underlying native function: GetClaimConversation 0x8bfa57c)
	class UFortConversation* GetClaimConversation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCharacterCompletionAudioDelay (Underlying native function: GetCharacterCompletionAudioDelay 0x2d7b3bc)
	float GetCharacterCompletionAudioDelay(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCharacterCompletionAudio (Underlying native function: GetCharacterCompletionAudio 0x8bfa4e8)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.GetChallengeChainRewardInfo (Underlying native function: GetChallengeChainRewardInfo 0x8bfa440)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCategory (Underlying native function: GetCategory 0x8bfa424)
	struct FDataTableRowHandle GetCategory(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetCanDisplayLockWidget (Underlying native function: GetCanDisplayLockWidget 0x8bfa40c)
	bool GetCanDisplayLockWidget(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetAthenaUpdateObjectiveOncePerMatch (Underlying native function: GetAthenaUpdateObjectiveOncePerMatch 0x8bfa3f0)
	bool GetAthenaUpdateObjectiveOncePerMatch(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.GetAthenaObjectiveMustBeCompletedInASingleMatch (Underlying native function: GetAthenaObjectiveMustBeCompletedInASingleMatch 0x8bfa3d4)
	bool GetAthenaObjectiveMustBeCompletedInASingleMatch(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.ExpandsStormShield (Underlying native function: ExpandsStormShield 0x8bfa388)
	bool ExpandsStormShield(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.CanShowTimer (Underlying native function: CanShowTimer 0x8bfa358)
	bool CanShowTimer(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.CanProgressInBRWarmup (Underlying native function: CanProgressInBRWarmup 0x8bfa2a4)
	bool CanProgressInBRWarmup(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.CanPartyAssist (Underlying native function: CanPartyAssist 0x8bfa280)
	bool CanPartyAssist(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.AllowsTileMatching (Underlying native function: AllowsTileMatching 0x8bfa05c)
	bool AllowsTileMatching(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition.AllowsPlayNowNavigation (Underlying native function: AllowsPlayNowNavigation 0x8bfa040)
