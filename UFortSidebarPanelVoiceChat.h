...
class UFortSidebarPanelVoiceChat : public UFortSidebarPanelWithTree
{
	...
	// Function /Script/FortniteUI.FortSidebarPanelVoiceChat.HandleNavigateUpFromSettings (Underlying native function: HandleNavigateUpFromSettings 0xa617328)
	class UWidget* HandleNavigateUpFromSettings(enum EUINavigation& InNavigation); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortSidebarPanelVoiceChat.HandleNavigateFromUserTree (Underlying native function: HandleNavigateFromUserTree 0xa617270)
