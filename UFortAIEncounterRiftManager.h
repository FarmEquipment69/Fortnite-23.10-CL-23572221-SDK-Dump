...
class UFortAIEncounterRiftManager : public UObject
{
	...
	// Function /Script/FortniteAI.FortAIEncounterRiftManager.OnRiftDestroyed (Underlying native function: OnRiftDestroyed 0xa0db4b4)
	void OnRiftDestroyed(class AActor*& Rift); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAIEncounterRiftManager.GetAssociatedMission (Underlying native function: GetAssociatedMission 0xa0d8c48)
