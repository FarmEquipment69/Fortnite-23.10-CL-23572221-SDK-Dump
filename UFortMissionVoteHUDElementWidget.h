...
class UFortMissionVoteHUDElementWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.RegisterFailsafeForVoteType (Underlying native function: RegisterFailsafeForVoteType 0xa7334fc)
	...
	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.IsMultiplayerVote (Underlying native function: IsMultiplayerVote 0xa7327ec)
	bool IsMultiplayerVote(enum EFortVoteType& VoteType); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.HasLocalPlayerVoted (Underlying native function: HasLocalPlayerVoted 0xa7326c8)
	bool HasLocalPlayerVoted(enum EFortVoteType& VoteType); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.HandleMissionActivationVoteUpdate (Underlying native function: HandleMissionActivationVoteUpdate 0xa732268)
	...
	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.HandleDifficultyIncreaseVoteUpdate (Underlying native function: HandleDifficultyIncreaseVoteUpdate 0xa732268)
	...
	// Function /Script/FortniteUI.FortMissionVoteHUDElementWidget.GetVoteTimeRemaining (Underlying native function: GetVoteTimeRemaining 0xa731fcc)
