...
class UFortCollectionBookPicker : public UFortItemPickerBase
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookPicker.ShowMulchDialogForItem (Underlying native function: ShowMulchDialogForItem 0x71eac38)
	void ShowMulchDialogForItem(class UFortItem*& ItemToMulch); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPicker.ShowMulchConfirmationModal (Underlying native function: ShowMulchConfirmationModal 0x71eac1c)
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookPicker.NotifyPanelDeactivated (Underlying native function: NotifyPanelDeactivated 0x71e7c6c)
	void NotifyPanelDeactivated(); // (Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPicker.NotifyPanelActivated (Underlying native function: NotifyPanelActivated 0x71e7c50)
	void NotifyPanelActivated(); // (Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortCollectionBookPicker.HideMulchConfirmationModal (Underlying native function: HideMulchConfirmationModal 0x71e798c)
