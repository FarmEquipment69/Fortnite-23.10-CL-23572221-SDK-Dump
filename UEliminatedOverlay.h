...
class UEliminatedOverlay : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.EliminatedOverlay.UpdateMultiwinner (Underlying native function: UpdateMultiwinner 0xa3a1e88)
	void UpdateMultiwinner(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.EliminatedOverlay.StreamingLoadingChanged (Underlying native function: StreamingLoadingChanged 0xa3a1de0)
	...
	// Function /Script/FortniteUI.EliminatedOverlay.GetPlayerState (Underlying native function: GetPlayerState 0xa3a0360)
