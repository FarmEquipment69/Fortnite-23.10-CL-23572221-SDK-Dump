...
class UDadBroHealthWidget : public ULTMWidgetBase
{
	...
	// Function /Script/FortniteUI.DadBroHealthWidget.UpdateFinalBossBattle (Underlying native function: UpdateFinalBossBattle 0xa3fce08)
	...
	// Function /Script/FortniteUI.DadBroHealthWidget.HandleMashPhaseChanged (Underlying native function: HandleMashPhaseChanged 0xa3fa1d4)
	void HandleMashPhaseChanged(int& NewPhase); // (Final | Native | Protected)

	// Function /Script/FortniteUI.DadBroHealthWidget.HandleDadBroSpawned (Underlying native function: HandleDadBroSpawned 0xa3f9d80)
