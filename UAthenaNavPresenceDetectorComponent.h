...
class UAthenaNavPresenceDetectorComponent : public UActorComponent
{
	...
	// Function /Script/FortniteAI.AthenaNavPresenceDetectorComponent.OnNavMeshTilesUpdated (Underlying native function: OnNavMeshTilesUpdated 0xa172064)
	void OnNavMeshTilesUpdated(struct FUpdatedNavMeshTiles& UpdatedNavMeshTiles); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteAI.AthenaNavPresenceDetectorComponent.HasValidNavMeshLocation (Underlying native function: HasValidNavMeshLocation 0xa171648)
