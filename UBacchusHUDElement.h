...
class UBacchusHUDElement : public UFortMobileHUDElement
{
	...
	// Function /Script/FortniteUI.BacchusHUDElement.OnHUDStateUpdate (Underlying native function: OnHUDStateUpdate 0xa423938)
	void OnHUDStateUpdate(struct FFortHUDState& NewState); // (Native | Event | Protected | HasOutParms | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusHUDElement.HandleInputMethodChanged (Underlying native function: HandleInputMethodChanged 0xa422e64)
