...
class UFortPlayerAugmentInventoryTab : public UCommonActivatableWidget
{
	...
	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentInventoryTab.HandleTimerUpdated (Underlying native function: HandleTimerUpdated 0x71aa3f0)
	void HandleTimerUpdated(float& TimeRemaining, float& TimePercentage); // (Final | Native | Private)

	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentInventoryTab.HandleNumPendingAugmentsToGrantUpdated (Underlying native function: HandleNumPendingAugmentsToGrantUpdated 0x71a9fe8)
	void HandleNumPendingAugmentsToGrantUpdated(int8_t& NumPendingAugmentsToGrant); // (Final | Native | Private)

	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentInventoryTab.HandleAugmentGrantingTimersFinishedForMatch (Underlying native function: HandleAugmentGrantingTimersFinishedForMatch 0x71a9884)
	void HandleAugmentGrantingTimersFinishedForMatch(); // (Final | Native | Private)

	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentInventoryTab.GetPendingAugmentsToGrant (Underlying native function: GetPendingAugmentsToGrant 0x71a9818)
