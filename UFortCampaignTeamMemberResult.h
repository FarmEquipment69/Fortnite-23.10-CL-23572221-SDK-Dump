...
class UFortCampaignTeamMemberResult : public UFortCampaignTeamMemberEntry
{
	...
	// Function /Script/FortniteUI.FortCampaignTeamMemberResult.UpdateMemberWithUniqueNetID (Underlying native function: UpdateMemberWithUniqueNetID 0xa822cf0)
	void UpdateMemberWithUniqueNetID(struct FUniqueNetIdRepl& MemberId); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortCampaignTeamMemberResult.Focus (Underlying native function: Focus 0xa8201d0)
