...
class UFortItemDetailsHostPanel : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.ShouldPreviewUpgradingItem (Underlying native function: ShouldPreviewUpgradingItem 0xa70b838)
	void ShouldPreviewUpgradingItem(bool& Value); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetUpgradeLevelDelta (Underlying native function: SetUpgradeLevelDelta 0xa70b7ac)
	void SetUpgradeLevelDelta(int& InDelta); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetScrollWidget (Underlying native function: SetScrollWidget 0xa70b2fc)
	void SetScrollWidget(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetQuantityOverride (Underlying native function: SetQuantityOverride 0xa70b1fc)
	void SetQuantityOverride(int& QuantityOverride); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetItemViewContext (Underlying native function: SetItemViewContext 0xa70ad7c)
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetItemToDetail (Underlying native function: SetItemToDetail 0x1ed2c40)
	void SetItemToDetail(class UFortItem*& ItemToDetail); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetItemToCompareWith (Underlying native function: SetItemToCompareWith 0xa70a35c)
	void SetItemToCompareWith(class UFortItem*& ItemToCompareWith); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetIsUpdatingSuspended (Underlying native function: SetIsUpdatingSuspended 0xa709a2c)
	void SetIsUpdatingSuspended(bool& bValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.SetInspectMode (Underlying native function: SetInspectMode 0xa7099ac)
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.HandleItemToDetailTooltipAssetsLoaded (Underlying native function: HandleItemToDetailTooltipAssetsLoaded 0x854edfc)
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.HandleItemToCompareTooltipAssetsLoaded (Underlying native function: HandleItemToCompareTooltipAssetsLoaded 0xa708e7c)
	void HandleItemToCompareTooltipAssetsLoaded(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortItemDetailsHostPanel.HandleItemRefundComplete (Underlying native function: HandleItemRefundComplete 0xa708b80)
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.HandleItemRarityUpgradeComplete (Underlying native function: HandleItemRarityUpgradeComplete 0xa708b80)
	...
	// Function /Script/FortniteUI.FortItemDetailsHostPanel.HandleItemEvolutionComplete (Underlying native function: HandleItemEvolutionComplete 0xa708b80)
