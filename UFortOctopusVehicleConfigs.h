...
class UFortOctopusVehicleConfigs : public UFortPhysicsVehicleConfigs
{
	...
	float GroundTraceLength; // 0x8d4 (0x4)
	int MaxSignificanceBudgetForFX; // 0x8d8 (0x4)
	int MaxSignificanceBudgetForAudio; // 0x8dc (0x4)
	unsigned char bDisableFXWhenInsignificant; // 0x8e0 (0x1)
	unsigned char bDisableAudioTickWhenInsignificant; // 0x8e0 (0x1)
	unsigned char bGlassIsPenetrable; // 0x8e0 (0x1)
	unsigned char padding_8e1[0x7]; // 0x8e1 (0x7)
};
