...
class UBoarRidableComponent_C : public UCreatureBaseRidableComponent_C
{
	...
	class USoundBase* BurtChargeStartSound; // 0xb50 (0x8)
	class UAudioComponent* ChargeSoundComp; // 0xb58 (0x8)
	class ANPC_Pawn_Irwin_Prey_Burt_C* BurtPawnRef; // 0xb60 (0x8)
	double SprintCooldDownTime; // 0xb68 (0x8)
	class UClass* GESprintImpactPawn; // 0xb70 (0x8)
	struct FGameplayTag SprintImpactGameplayCueTag; // 0xb78 (0x4)
	unsigned char unreflected_b7c[0x4]; // 0xb7c (0x4) 
	class UClass* GESprintImpactVehicle; // 0xb80 (0x8)
	struct FGameplayTag SprintChargeImpactDefaultCueTag; // 0xb88 (0x4)
	struct FGameplayTag SprintChargeImpactPawnCueTag; // 0xb8c (0x4)
	struct FGameplayTag SprintChargeImpactDestroyBuildCueTag; // 0xb90 (0x4)
