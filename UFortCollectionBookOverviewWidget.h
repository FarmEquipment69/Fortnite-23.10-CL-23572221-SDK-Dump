...
class UFortCollectionBookOverviewWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookOverviewWidget.OnDeactivated (Underlying native function: OnDeactivated 0x71e81dc)
	void OnDeactivated(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookOverviewWidget.OnActivated (Underlying native function: OnActivated 0x71e664c)
	void OnActivated(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortCollectionBookOverviewWidget.HandlePagesChanged (Underlying native function: HandlePagesChanged 0x71e6f40)
