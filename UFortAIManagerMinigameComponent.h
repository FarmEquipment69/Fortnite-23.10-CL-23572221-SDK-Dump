...
class UFortAIManagerMinigameComponent : public UActorComponent
{
	...
	// Function /Script/FortniteAI.FortAIManagerMinigameComponent.OnPawnSpawned (Underlying native function: OnPawnSpawned 0xa09e988)
	void OnPawnSpawned(class APawn*& Pawn, int& RequestId); // (Final | Native | Public)

	// Function /Script/FortniteAI.FortAIManagerMinigameComponent.OnPawnDied (Underlying native function: OnPawnDied 0xa09e70c)
	...
	// Function /Script/FortniteAI.FortAIManagerMinigameComponent.HandleMinigameStarted (Underlying native function: HandleMinigameStarted 0xa09d020)
