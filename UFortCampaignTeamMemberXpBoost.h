...
class UFortCampaignTeamMemberXpBoost : public UFortCampaignTeamMemberItemTracker
{
	...
	// Function /Script/FortniteUI.FortCampaignTeamMemberXpBoost.SetConsumeRequestInProgress (Underlying native function: SetConsumeRequestInProgress 0xa822950)
	...
	// Function /Script/FortniteUI.FortCampaignTeamMemberXpBoost.GetCurrentBoostAmount (Underlying native function: GetCurrentBoostAmount 0xa820474)
	int GetCurrentBoostAmount(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortCampaignTeamMemberXpBoost.GetBoostActivationButton (Underlying native function: GetBoostActivationButton 0x8609b00)
	class UCommonButtonLegacy* GetBoostActivationButton(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortCampaignTeamMemberXpBoost.CenterWidget (Underlying native function: CenterWidget 0xa8201bc)
