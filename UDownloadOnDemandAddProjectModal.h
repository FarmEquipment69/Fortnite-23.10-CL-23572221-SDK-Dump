...
class UDownloadOnDemandAddProjectModal : public UCommonActivatableWidget
{
	...
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkIdTextChanged (Underlying native function: HandleDownloadLinkIdTextChanged 0x746a44c)
