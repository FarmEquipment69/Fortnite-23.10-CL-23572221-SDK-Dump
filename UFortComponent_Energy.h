...
class UFortComponent_Energy : public UPawnComponent
{
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.UseEnergy (Underlying native function: UseEnergy 0x6ef22e4)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.StopUsingEnergy (Underlying native function: StopUsingEnergy 0x6ef220c)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.StopAddingEnergy (Underlying native function: StopAddingEnergy 0x6ef20f8)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.StartUsingEnergy (Underlying native function: StartUsingEnergy 0x6ef1f9c)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.StartAddingEnergy (Underlying native function: StartAddingEnergy 0x6ef1e80)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.SetAllEnergyUsageFree (Underlying native function: SetAllEnergyUsageFree 0x6ef1e14)
	bool SetAllEnergyUsageFree(bool& bShouldEnergyUsageBeFree); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/EnergyRuntime.FortComponent_Energy.RemoveRegenDataOverride (Underlying native function: RemoveRegenDataOverride 0x6ef1d6c)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.RegisterMutatorUpdatedDelegate (Underlying native function: RegisterMutatorUpdatedDelegate 0x6ef1aa8)
	void RegisterMutatorUpdatedDelegate(class APawn*& AffectedPawn); // (Final | Native | Private)

	// Function /Script/EnergyRuntime.FortComponent_Energy.OnPlayerStatePawnSet (Underlying native function: OnPlayerStatePawnSet 0x2437e64)
	void OnPlayerStatePawnSet(class APlayerState*& Player, class APawn*& NewPawn, class APawn*& OldPawn); // (Final | Native | Private)

	// Function /Script/EnergyRuntime.FortComponent_Energy.OnMutatorUpdated (Underlying native function: OnMutatorUpdated 0x1d68f08)
	void OnMutatorUpdated(); // (Final | Native | Private)

	// Function /Script/EnergyRuntime.FortComponent_Energy.HasSufficientEnergy (Underlying native function: HasSufficientEnergy 0x6ef1a14)
	bool HasSufficientEnergy(float& EnergyAmountToTest); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/EnergyRuntime.FortComponent_Energy.HandleControllerChanged (Underlying native function: HandleControllerChanged 0x6ef191c)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.GetCurrentEnergyPercentage (Underlying native function: GetCurrentEnergyPercentage 0x1d693bc)
	float GetCurrentEnergyPercentage(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/EnergyRuntime.FortComponent_Energy.ApplyRegenDataOverride (Underlying native function: ApplyRegenDataOverride 0x6ef17c4)
	...
	// Function /Script/EnergyRuntime.FortComponent_Energy.AddEnergy (Underlying native function: AddEnergy 0x6ef166c)
