...
class AFortGameStatePvE : public AFortGameStateZone
{
	...
	// Function /Script/FortniteGame.FortGameStatePvE.ShouldUseMoonbeamHUD (Underlying native function: ShouldUseMoonbeamHUD 0x8c95b38)
	bool ShouldUseMoonbeamHUD(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.ShouldUseMoonbeamGameplayFunctionality (Underlying native function: ShouldUseMoonbeamGameplayFunctionality 0x8c95b14)
	bool ShouldUseMoonbeamGameplayFunctionality(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.SetPickupManagementSettings (Underlying native function: SetPickupManagementSettings 0x8c958a4)
	...
	// Function /Script/FortniteGame.FortGameStatePvE.OnDefenderRemoved (Underlying native function: OnDefenderRemoved 0x8c94f64)
	void OnDefenderRemoved(class AFortAIPawn*& Defender); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStatePvE.OnDefenderDeployed (Underlying native function: OnDefenderDeployed 0x8c94e78)
	void OnDefenderDeployed(class AFortAIPawn*& Defender); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStatePvE.IsWeaponSwappingEnabled (Underlying native function: IsWeaponSwappingEnabled 0x8c94608)
	bool IsWeaponSwappingEnabled(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.IsSwappableWeaponType (Underlying native function: IsSwappableWeaponType 0x8c94544)
	...
	// Function /Script/FortniteGame.FortGameStatePvE.IsMulchingAllowed (Underlying native function: IsMulchingAllowed 0x8c9452c)
	bool IsMulchingAllowed(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.IsDefenderItemDeployed (Underlying native function: IsDefenderItemDeployed 0x8c94238)
	...
	// Function /Script/FortniteGame.FortGameStatePvE.GetPickupManagementSettings (Underlying native function: GetPickupManagementSettings 0x8c9341c)
	...
	// Function /Script/FortniteGame.FortGameStatePvE.GetAircraft (Underlying native function: GetAircraft 0x8c92900)
	class AFortAircraft* GetAircraft(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.CanSwapWeapon (Underlying native function: CanSwapWeapon 0x8c926b4)
	bool CanSwapWeapon(class UFortItemDefinition*& ItemDefinition); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStatePvE.CanSpawnDefender (Underlying native function: CanSpawnDefender 0x8c91f58)
