...
class UFortCollectionBookSlotConfirmationModal : public UFortActivatablePanel
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotConfirmationModal.HandleSlotItemComplete (Underlying native function: HandleSlotItemComplete 0x71e7468)
