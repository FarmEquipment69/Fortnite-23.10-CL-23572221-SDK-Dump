...
class UFortCommunityVotingTutorialPopup : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCommunityVotingTutorialPopup.OnSlideAnimationFinished (Underlying native function: OnSlideAnimationFinished 0xa3fc4f8)
	void OnSlideAnimationFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCommunityVotingTutorialPopup.CloseTutorial (Underlying native function: CloseTutorial 0x662c1a4)
