...
class ASmartObjectTestingActor : public AActor
{
	...
	// Function /Script/SmartObjectsModule.SmartObjectTestingActor.RunTests (Underlying native function: RunTests 0x7c387f8)
	void RunTests(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SmartObjectsModule.SmartObjectTestingActor.ResetTests (Underlying native function: ResetTests 0x7c3879c)
