...
class UFortExpeditionListViewWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortExpeditionListViewWidget.SetExpeditionListSortType (Underlying native function: SetExpeditionListSortType 0x721c9d8)
	void SetExpeditionListSortType(enum EFortExpeditionListSort& InSortType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortExpeditionListViewWidget.GetExpeditionListSortName (Underlying native function: GetExpeditionListSortName 0x721a29c)
