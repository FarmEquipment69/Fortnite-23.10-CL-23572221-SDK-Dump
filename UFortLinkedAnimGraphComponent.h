...
class UFortLinkedAnimGraphComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortLinkedAnimGraphComponent.ToggleCurveFilter (Underlying native function: ToggleCurveFilter 0x6ee971c)
	void ToggleCurveFilter(struct FString& Filter); // (Final | Exec | Native | Private)

	// Function /Script/FortniteGame.FortLinkedAnimGraphComponent.ResetCurveFilters (Underlying native function: ResetCurveFilters 0x273fd14)
	void ResetCurveFilters(); // (Final | Exec | Native | Private)

	// Function /Script/FortniteGame.FortLinkedAnimGraphComponent.RemoveCurveFilter (Underlying native function: RemoveCurveFilter 0x7db316c)
	bool RemoveCurveFilter(struct FString& Filter); // (Final | Exec | Native | Private)

	// Function /Script/FortniteGame.FortLinkedAnimGraphComponent.OnRep_WindAnimLayer (Underlying native function: OnRep_WindAnimLayer 0x2a0a738)
	void OnRepWindAnimLayer(class UClass*& AnimLayer); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortLinkedAnimGraphComponent.AddCurveFilter (Underlying native function: AddCurveFilter 0x6ee971c)
