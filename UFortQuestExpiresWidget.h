...
class UFortQuestExpiresWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortQuestExpiresWidget.SetData (Underlying native function: SetData 0x6ffb078)
	void SetData(class UFortQuestItem*& InItem); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortQuestExpiresWidget.OnQuestExpirationUpdated (Underlying native function: OnQuestExpirationUpdated 0x71e81dc)
