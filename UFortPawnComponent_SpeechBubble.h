...
class UFortPawnComponent_SpeechBubble : public UFortPawnComponent
{
	...
	// Function /Script/FortniteGame.FortPawnComponent_SpeechBubble.StopSpeech (Underlying native function: StopSpeech 0x849857c)
	void StopSpeech(); // (Final | 0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPawnComponent_SpeechBubble.StartSpeech (Underlying native function: StartSpeech 0x8498484)
	...
	// Function /Script/FortniteGame.FortPawnComponent_SpeechBubble.OnRep_SpeechBubbleInfo (Underlying native function: OnRep_SpeechBubbleInfo 0x8496d50)
	void OnRepSpeechBubbleInfo(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPawnComponent_SpeechBubble.GetSpeechBubbleText (Underlying native function: GetSpeechBubbleText 0x8495680)
