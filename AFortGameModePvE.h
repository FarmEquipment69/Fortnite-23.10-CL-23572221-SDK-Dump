...
class AFortGameModePvE : public AFortGameModeZone
{
	...
	// Function /Script/FortniteGame.FortGameModePvE.SetIdleKickEnabled (Underlying native function: SetIdleKickEnabled 0x8c957a4)
	void SetIdleKickEnabled(bool& bEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModePvE.SetIdleDetectionScoreThreshold (Underlying native function: SetIdleDetectionScoreThreshold 0x8894b54)
	...
	// Function /Script/FortniteGame.FortGameModePvE.SetIdleDetectionPenaltyTime (Underlying native function: SetIdleDetectionPenaltyTime 0x8c95720)
	void SetIdleDetectionPenaltyTime(float& InPenaltyTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModePvE.SetIdleDetectionMovementDistance (Underlying native function: SetIdleDetectionMovementDistance 0x8c95678)
	...
	// Function /Script/FortniteGame.FortGameModePvE.SetIdleDetectionMinIdleTime (Underlying native function: SetIdleDetectionMinIdleTime 0x8c95678)
	...
	// Function /Script/FortniteGame.FortGameModePvE.SetIdleDetectionMaxIdleTime (Underlying native function: SetIdleDetectionMaxIdleTime 0x8c95678)
	...
	// Function /Script/FortniteGame.FortGameModePvE.RemoveAllowIdlePlayerLocation (Underlying native function: RemoveAllowIdlePlayerLocation 0x8c95458)
	void RemoveAllowIdlePlayerLocation(class AActor*& LocationActor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModePvE.HandleOnAircraftRegistered (Underlying native function: HandleOnAircraftRegistered 0x8c94128)
	void HandleOnAircraftRegistered(class AFortAircraft*& InAircraft); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameModePvE.AddAllowIdlePlayerLocation (Underlying native function: AddAllowIdlePlayerLocation 0x8c91748)
