...
class ICreativeMoveToolTarget : public IInterface
{
	...
	// Function /Script/FortniteGame.CreativeMoveToolTarget.OnCreativeToolDeletion (Underlying native function: OnCreativeToolDeletion 0x662e248)
	...
	// Function /Script/FortniteGame.CreativeMoveToolTarget.GetScaleMin (Underlying native function: GetScaleMin 0x854db90)
	float GetScaleMin(float& DefaultScaleMin); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.CreativeMoveToolTarget.GetScaleMax (Underlying native function: GetScaleMax 0x854daf8)
