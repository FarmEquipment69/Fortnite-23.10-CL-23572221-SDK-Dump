...
class AFortBotStructureBuilder : public AActor
{
	...
	// Function /Script/FortniteAI.FortBotStructureBuilder.RunDeconstructor (Underlying native function: RunDeconstructor 0xa172244)
	void RunDeconstructor(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortBotStructureBuilder.OnBuildingDied (Underlying native function: OnBuildingDied 0xa171de8)
	...
	// Function /Script/FortniteAI.FortBotStructureBuilder.BuildAll (Underlying native function: BuildAll 0xa171498)
