...
class UFortCommunityVotingModalPopup : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCommunityVotingModalPopup.HandleVoteButtonClicked (Underlying native function: HandleVoteButtonClicked 0xa3cd43c)
	void HandleVoteButtonClicked(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCommunityVotingModalPopup.HandleButtonArgless (Underlying native function: HandleButtonArgless 0xa3cba78)
	void HandleButtonArgless(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.FortCommunityVotingModalPopup.HandleButton (Underlying native function: HandleButton 0xa3cc304)
	void HandleButton(bool& bPassThrough); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortCommunityVotingModalPopup.Dismiss (Underlying native function: Dismiss 0xa3cba78)
