...
class UFortProgressWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortProgressWidget.SetTitle (Underlying native function: SetTitle 0xa5f64b4)
	void SetTitle(struct FText& Title); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortProgressWidget.SetIcon (Underlying native function: SetIcon 0xa5f6230)
	void SetIcon(struct FSlateBrush& IconBrush); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortProgressWidget.SetDescription (Underlying native function: SetDescription 0xa5f6194)
