...
class AContentBeaconClientV2 : public AOnlineBeaconClient
{
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerRegisterClient (Underlying native function: ServerRegisterClient 0x895f950)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerOnLocalModuleStateChanged (Underlying native function: ServerOnLocalModuleStateChanged 0x895f82c)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerOnLocalModuleError (Underlying native function: ServerOnLocalModuleError 0x895f6a8)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerOnClientError (Underlying native function: ServerOnClientError 0x895f5a4)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerFinishDisconnect (Underlying native function: ServerFinishDisconnect 0x895f558)
	void ServerFinishDisconnect(); // (0x00000002 | Net | NetReliable | Native | Event | Public | NetServer | 0x80000000)

	// Function /Script/FortniteGame.ContentBeaconClientV2.ServerBeginDisconnect (Underlying native function: ServerBeginDisconnect 0x2e2012c)
	void ServerBeginDisconnect(); // (Net | NetReliable | Native | Event | Public | NetServer)

	// Function /Script/FortniteGame.ContentBeaconClientV2.OnRep_ClientAdditionalContentBundles (Underlying native function: OnRep_ClientAdditionalContentBundles 0x895f3c8)
	void OnRepClientAdditionalContentBundles(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.ContentBeaconClientV2.OnClientReadinessChanged (Underlying native function: OnClientReadinessChanged 0x895f3b4)
	void OnClientReadinessChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientSetClientReadiness (Underlying native function: ClientSetClientReadiness 0x6a01af8)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientOnRegistrationComplete (Underlying native function: ClientOnRegistrationComplete 0x895f2a4)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientOnHostError (Underlying native function: ClientOnHostError 0x895f154)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientNotifyOfServerScriptScreenLogMessage (Underlying native function: ClientNotifyOfServerScriptScreenLogMessage 0x895f0ac)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientNotifyOfServerScriptDiagnosticMessage (Underlying native function: ClientNotifyOfServerScriptDiagnosticMessage 0x895f010)
	...
	// Function /Script/FortniteGame.ContentBeaconClientV2.ClientNotifyDisconnect (Underlying native function: ClientNotifyDisconnect 0x895ef8c)
