...
class UFortMainMenu : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortMainMenu.ShouldShowLeaveExperienceButton (Underlying native function: ShouldShowLeaveExperienceButton 0xa69a040)
	bool ShouldShowLeaveExperienceButton(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortMainMenu.RequestCloseMainMenu (Underlying native function: RequestCloseMainMenu 0xa6995dc)
	...
	// Function /Script/FortniteUI.FortMainMenu.NeedsCenterWidget (Underlying native function: NeedsCenterWidget 0xa69951c)
