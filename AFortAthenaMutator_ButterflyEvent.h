...
class AFortAthenaMutator_ButterflyEvent : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_ButterflyEvent.UpdatePawnBroadcasting (Underlying native function: UpdatePawnBroadcasting 0x81d98ec)
	void UpdatePawnBroadcasting(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_ButterflyEvent.StopGatheringPawns (Underlying native function: StopGatheringPawns 0x81d98d8)
	void StopGatheringPawns(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_ButterflyEvent.StartGatheringPawns (Underlying native function: StartGatheringPawns 0x81d98c4)
