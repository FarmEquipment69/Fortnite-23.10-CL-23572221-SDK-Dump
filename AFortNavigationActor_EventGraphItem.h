...
class AFortNavigationActor_EventGraphItem : public AFortEventLevelNavigationActor
{
	...
	// Function /Script/FortniteGame.FortNavigationActor_EventGraphItem.GetNodeTag (Underlying native function: GetNodeTag 0x82a90b8)
	struct FGameplayTag GetNodeTag(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortNavigationActor_EventGraphItem.CosmeticVariantAssets_PostLoad (Underlying native function: CosmeticVariantAssets_PostLoad 0x82a8b70)
