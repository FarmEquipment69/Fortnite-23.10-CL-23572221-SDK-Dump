...
class AFortAthenaMutator_RespawnWave : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.OnWaveLaunched (Underlying native function: OnWaveLaunched 0x273fd14)
	void OnWaveLaunched(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.OnRep_WaveDataArray (Underlying native function: OnRep_WaveDataArray 0x82637c4)
	void OnRepWaveDataArray(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.GetWaveTime (Underlying native function: GetWaveTime 0x8262920)
	float GetWaveTime(unsigned char& Team); // (Native | Event | Protected | BlueprintEvent | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.GetTimeUntilNextWave (Underlying native function: GetTimeUntilNextWave 0x8262890)
	float GetTimeUntilNextWave(class AFortPlayerStateAthena*& PlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.GetNextWavePlayerStates (Underlying native function: GetNextWavePlayerStates 0x8262678)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_RespawnWave.GetNextWavePlayerCount (Underlying native function: GetNextWavePlayerCount 0x82625e0)
