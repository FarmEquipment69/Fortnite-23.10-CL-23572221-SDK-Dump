...
class AFortAthenaTutorial_Harvest : public AFortAthenaTutorialBase
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Harvest.OnBuildingDestroyed (Underlying native function: OnBuildingDestroyed 0x82d34c8)
	void OnBuildingDestroyed(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Harvest.OnBeginOverlapHarvestTriggerBox (Underlying native function: OnBeginOverlapHarvestTriggerBox 0x82d30f4)
