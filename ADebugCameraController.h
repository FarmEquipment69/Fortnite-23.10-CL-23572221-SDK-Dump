...
class ADebugCameraController : public APlayerController
{
	...
	// Function /Script/Engine.DebugCameraController.ToggleDisplay (Underlying native function: ToggleDisplay 0x9b9938c)
	void ToggleDisplay(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.DebugCameraController.ShowDebugSelectedInfo (Underlying native function: ShowDebugSelectedInfo 0x9b99374)
	void ShowDebugSelectedInfo(); // (Exec | Native | Public)

	// Function /Script/Engine.DebugCameraController.SetPawnMovementSpeedScale (Underlying native function: SetPawnMovementSpeedScale 0x9b992e4)
	...
	// Function /Script/Engine.DebugCameraController.GetSelectedActor (Underlying native function: GetSelectedActor 0x9b98fd0)
