...
class ABuildingActor : public AActor
{
	...
	unsigned char bUpgradeUsesSameClass; // 0x500 (0x1)
	...
	unsigned char bIsIndestructibleForTargetSelection; // 0x501 (0x1)
	...
	unsigned char bBeingLocallyMoved; // 0x502 (0x1)
	...
	unsigned char bCanExportNavigationObstacle; // 0x503 (0x1)
	...
	unsigned char bForceAutomationPassSmashableFlat; // 0x504 (0x1)
	...
	unsigned char bBeingTranslated; // 0x505 (0x1)
	...
	unsigned char bIsDynamic; // 0x506 (0x1)
	...
	unsigned char bDestroyFoliageWhenPlaced; // 0x507 (0x1)
	...
	unsigned char bPredictedBuildingActor; // 0x508 (0x1)
	...
	unsigned char bAllowHostileBlueprintInteraction; // 0x509 (0x1)
	...
	unsigned char bIgnoreAffiliationInteractHighlight; // 0x50a (0x1)
	...
	// Function /Script/FortniteGame.BuildingActor.UseDefaultHealthBar (Underlying native function: UseDefaultHealthBar 0x8334d80)
	bool UseDefaultHealthBar(); // (0x00000002 | Native | Event | Public | BlueprintEvent | Const)

	// Function /Script/FortniteGame.BuildingActor.UpdateCullDistance (Underlying native function: UpdateCullDistance 0x590b760)
	void UpdateCullDistance(bool& bIgnoreLODParent); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SnapDmgVisualsToCurrentHealth (Underlying native function: SnapDmgVisualsToCurrentHealth 0x237fc80)
	void SnapDmgVisualsToCurrentHealth(); // (0x00000002 | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SilentDie (Underlying native function: SilentDie 0x8334cfc)
	void SilentDie(bool& bPropagateSilentDeath); // (0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.ShouldDisplaySecondInteractPrompt (Underlying native function: ShouldDisplaySecondInteractPrompt 0x8334c30)
	...
	// Function /Script/FortniteGame.BuildingActor.ShouldDisplayMobileInteractPrompt (Underlying native function: ShouldDisplayMobileInteractPrompt 0x8334c08)
	bool ShouldDisplayMobileInteractPrompt(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.ShouldDisplayFirstInteractPrompt (Underlying native function: ShouldDisplayFirstInteractPrompt 0x8334b3c)
	...
	// Function /Script/FortniteGame.BuildingActor.ShouldDisplayDamageNumbers (Underlying native function: ShouldDisplayDamageNumbers 0x268ed8c)
	bool ShouldDisplayDamageNumbers(); // (0x00000002 | Native | Event | Public | BlueprintEvent | Const)

	// Function /Script/FortniteGame.BuildingActor.ShouldDie (Underlying native function: ShouldDie 0x8334a38)
	...
	// Function /Script/FortniteGame.BuildingActor.SetUsesDayPhaseChange (Underlying native function: SetUsesDayPhaseChange 0x8334960)
	void SetUsesDayPhaseChange(bool& bUseDayPhase); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetTeam (Underlying native function: SetTeam 0x83348dc)
	void SetTeam(unsigned char& InTeam); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetSuppressHealthBar (Underlying native function: SetSuppressHealthBar 0x8334858)
	void SetSuppressHealthBar(bool& bNewValue); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetQuestHighlight (Underlying native function: SetQuestHighlight 0x83346b8)
	void SetQuestHighlight(bool& Enabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetNavigationObstacleOverride (Underlying native function: SetNavigationObstacleOverride 0x8334614)
	void SetNavigationObstacleOverride(enum ENavigationObstacleOverride& NavOverride); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetNavigationModifier (Underlying native function: SetNavigationModifier 0x8334560)
	void SetNavigationModifier(bool& bEnableModifier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetNavigationIndestructible (Underlying native function: SetNavigationIndestructible 0x83344d4)
	void SetNavigationIndestructible(bool& bNavIndestructible); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetMaxHealth_DontCreateASC (Underlying native function: SetMaxHealth_DontCreateASC 0x8334438)
	bool SetMaxHealthDontCreateASC(float& NewMaxHealth); // (0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetIsNavigationRelevant (Underlying native function: SetIsNavigationRelevant 0x8334394)
	void SetIsNavigationRelevant(bool& bInIsNavigationRelevant); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetHealthBarIndicatorDifficultyRating (Underlying native function: SetHealthBarIndicatorDifficultyRating 0x833424c)
	...
	// Function /Script/FortniteGame.BuildingActor.SetHealth_DontCreateASC (Underlying native function: SetHealth_DontCreateASC 0x83342c8)
	void SetHealthDontCreateASC(float& NewHealth); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetHealth (Underlying native function: SetHealth 0x83341c8)
	void SetHealth(float& NewHealth); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetCustomState (Underlying native function: SetCustomState 0x8334050)
	void SetCustomState(struct FString& NewState); // (0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetCanExportNavigationObstacle (Underlying native function: SetCanExportNavigationObstacle 0x8333fa0)
	void SetCanExportNavigationObstacle(bool& InCanExportNavigationObstacle); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetCanBeSavedToCreativeVolume (Underlying native function: SetCanBeSavedToCreativeVolume 0x8333f1c)
	void SetCanBeSavedToCreativeVolume(bool& bCanBeSaved); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetBRDrawDistances (Underlying native function: SetBRDrawDistances 0x8333e40)
	void SetBRDrawDistances(float& NewBRMinDrawDistance, float& NewBRMaxDrawDistance); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.SetAlwaysExportNavRelevantComponent (Underlying native function: SetAlwaysExportNavRelevantComponent 0x8333d88)
	void SetAlwaysExportNavRelevantComponent(bool& bInAlwaysExportNavRelevantComponent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.Resave (Underlying native function: Resave 0x29e7b34)
	void Resave(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.ReplaceNavAreaClass (Underlying native function: ReplaceNavAreaClass 0x8333cfc)
	void ReplaceNavAreaClass(class UClass*& ReplacementAreaClass); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.RemoveEditorOnlyInstanceGameplayTags (Underlying native function: RemoveEditorOnlyInstanceGameplayTags 0x735fac8)
	...
	// Function /Script/FortniteGame.BuildingActor.RemoveAbilitySystemComponentAfterAutoBuildIfFullHealth (Underlying native function: RemoveAbilitySystemComponentAfterAutoBuildIfFullHealth 0x8333ce8)
	void RemoveAbilitySystemComponentAfterAutoBuildIfFullHealth(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.RefreshRemovedFoliageAroundBounds (Underlying native function: RefreshRemovedFoliageAroundBounds 0x8333c48)
	...
	// Function /Script/FortniteGame.BuildingActor.PlacedByPlacementTool (Underlying native function: PlacedByPlacementTool 0x82aa228)
	...
	// Function /Script/FortniteGame.BuildingActor.OnRep_Team (Underlying native function: OnRep_Team 0x24b8434)
	void OnRepTeam(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_InstantDeath (Underlying native function: OnRep_InstantDeath 0x19b162c)
	void OnRepInstantDeath(); // (Final | Native | Public)

	// Function /Script/FortniteGame.BuildingActor.OnRep_InitialOverlappingVehicles (Underlying native function: OnRep_InitialOverlappingVehicles 0x159a5dc)
	void OnRepInitialOverlappingVehicles(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_CustomState (Underlying native function: OnRep_CustomState 0x12ae424)
	void OnRepCustomState(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_CurrentBuildingLevel (Underlying native function: OnRep_CurrentBuildingLevel 0x8333bd0)
	void OnRepCurrentBuildingLevel(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_BuildingAttributeSet (Underlying native function: OnRep_BuildingAttributeSet 0x280c6c4)
	void OnRepBuildingAttributeSet(); // (Final | Native | Private)

	// Function /Script/FortniteGame.BuildingActor.OnRep_bDestroyed (Underlying native function: OnRep_bDestroyed 0x17fb358)
	void OnRepbDestroyed(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_bCollisionBlockedByPawns (Underlying native function: OnRep_bCollisionBlockedByPawns 0x187fd3c)
	void OnRepbCollisionBlockedByPawns(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.OnRep_AbilitySystemComponent (Underlying native function: OnRep_AbilitySystemComponent 0x2349374)
	...
	// Function /Script/FortniteGame.BuildingActor.OnDayPhaseChanged (Underlying native function: OnDayPhaseChanged 0x8333ab8)
	...
	// Function /Script/FortniteGame.BuildingActor.OnBuildingActorInitialized (Underlying native function: OnBuildingActorInitialized 0x83339f0)
	...
	// Function /Script/FortniteGame.BuildingActor.MigrateLegacyUserOptions (Underlying native function: MigrateLegacyUserOptions 0x1598df4)
	...
	// Function /Script/FortniteGame.BuildingActor.K2_SpawnBuildingActor (Underlying native function: K2_SpawnBuildingActor 0x83337a8)
	...
	// Function /Script/FortniteGame.BuildingActor.IsPreviewBuildingActor (Underlying native function: IsPreviewBuildingActor 0x833378c)
	bool IsPreviewBuildingActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.IsPlayerBuilt (Underlying native function: IsPlayerBuilt 0x833376c)
	bool IsPlayerBuilt(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.IsDamaged (Underlying native function: IsDamaged 0x8333748)
	bool IsDamaged(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.IsAcceptablePositionForPlacement (Underlying native function: IsAcceptablePositionForPlacement 0x8333544)
	...
	// Function /Script/FortniteGame.BuildingActor.InitializeKismetSpawnedBuildingActor (Underlying native function: InitializeKismetSpawnedBuildingActor 0x8333400)
	...
	// Function /Script/FortniteGame.BuildingActor.HasHealthLeft (Underlying native function: HasHealthLeft 0x2d8732c)
	bool HasHealthLeft(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.HandleDestroyed (Underlying native function: HandleDestroyed 0x2419310)
	void HandleDestroyed(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.BuildingActor.GetShieldPercent (Underlying native function: GetShieldPercent 0x83333d4)
	float GetShieldPercent(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetShieldOrHealthPercent (Underlying native function: GetShieldOrHealthPercent 0x83333ac)
	float GetShieldOrHealthPercent(); // (Final | Native | Public)

	// Function /Script/FortniteGame.BuildingActor.GetShield (Underlying native function: GetShield 0x8333380)
	float GetShield(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetPhysicsObjectComponent (Underlying native function: GetPhysicsObjectComponent 0x299b4a0)
	...
	// Function /Script/FortniteGame.BuildingActor.GetOwningPlayerState (Underlying native function: GetOwningPlayerState 0x285f5f4)
	class AFortPlayerState* GetOwningPlayerState(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetOwningController (Underlying native function: GetOwningController 0x8333344)
	class AController* GetOwningController(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetMissingHealth (Underlying native function: GetMissingHealth 0x833331c)
	float GetMissingHealth(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetMaxShield (Underlying native function: GetMaxShield 0x83332f0)
	float GetMaxShield(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetMaxHealth (Underlying native function: GetMaxHealth 0x83332c4)
	float GetMaxHealth(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetLootTierGroupOverride (Underlying native function: GetLootTierGroupOverride 0x83332a0)
	struct FName GetLootTierGroupOverride(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.GetHealthPercent (Underlying native function: GetHealthPercent 0x833325c)
	float GetHealthPercent(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetHealth (Underlying native function: GetHealth 0x8333230)
	float GetHealth(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetGameplayTags (Underlying native function: GetGameplayTags 0x8333214)
	...
	// Function /Script/FortniteGame.BuildingActor.GetEditorTestTags (Underlying native function: GetEditorTestTags 0x735fac8)
	...
	// Function /Script/FortniteGame.BuildingActor.GetDescription (Underlying native function: GetDescription 0x8332eb0)
	struct FText GetDescription(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetCustomState (Underlying native function: GetCustomState 0x8332e38)
	struct FString GetCustomState(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetCurrentBuildingLevel (Underlying native function: GetCurrentBuildingLevel 0x8332e10)
	int GetCurrentBuildingLevel(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetCurieCollisionComponentOverride (Underlying native function: GetCurieCollisionComponentOverride 0x1ecff68)
	class UPrimitiveComponent* GetCurieCollisionComponentOverride(); // (0x00000002 | Native | Event | Protected | BlueprintEvent | Const)

	// Function /Script/FortniteGame.BuildingActor.GetCentroid (Underlying native function: GetCentroid 0x8332dbc)
	struct FVector GetCentroid(); // (0x00000002 | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetBuildingAttributeSet_DontCreate (Underlying native function: GetBuildingAttributeSet_DontCreate 0x77648b0)
	class UFortBuildingActorSet* GetBuildingAttributeSetDontCreate(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GetBuildingAttributeSet (Underlying native function: GetBuildingAttributeSet 0x8332d7c)
	class UFortBuildingActorSet* GetBuildingAttributeSet(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingActor.GameplayCue_InstantDeath (Underlying native function: GameplayCue_InstantDeath 0x8332c80)
	...
	// Function /Script/FortniteGame.BuildingActor.GameplayCue_Healing (Underlying native function: GameplayCue_Healing 0x8332b84)
	...
	// Function /Script/FortniteGame.BuildingActor.GameplayCue_Damage (Underlying native function: GameplayCue_Damage 0xe7d8dc)
	...
	// Function /Script/FortniteGame.BuildingActor.ForceChangeOwnerInstigator (Underlying native function: ForceChangeOwnerInstigator 0x8332a74)
	...
	// Function /Script/FortniteGame.BuildingActor.ForceBuildingHealth (Underlying native function: ForceBuildingHealth 0x83329f0)
	void ForceBuildingHealth(float& NewHealth); // (Final | 0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.DoesMutatorBlockIncomingDamage (Underlying native function: DoesMutatorBlockIncomingDamage 0x24f75e4)
	...
	// Function /Script/FortniteGame.BuildingActor.ClearPlayedDying (Underlying native function: ClearPlayedDying 0x83329d8)
	void ClearPlayedDying(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingActor.CanDestroyBuildingActor (Underlying native function: CanDestroyBuildingActor 0x83328cc)
	...
	// Function /Script/FortniteGame.BuildingActor.BlueprintGetInteractionTime (Underlying native function: BlueprintGetInteractionTime 0x83327ac)
	...
	// Function /Script/FortniteGame.BuildingActor.BlueprintGetAllHighlightableComponents (Underlying native function: BlueprintGetAllHighlightableComponents 0x83326fc)
	...
	// Function /Script/FortniteGame.BuildingActor.BlueprintDie (Underlying native function: BlueprintDie 0x8332600)
	...
	// Function /Script/FortniteGame.BuildingActor.AddEditorOnlyInstanceGameplayTags (Underlying native function: AddEditorOnlyInstanceGameplayTags 0x735fac8)
