...
class UFortControllerComponent_FakeKillRelevancy : public UFortControllerComponent
{
	...
	// Function /Script/SpecialEventGameplayRuntime.FortControllerComponent_FakeKillRelevancy.ResetRelevancy (Underlying native function: ResetRelevancy 0x273fd14)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortControllerComponent_FakeKillRelevancy.OnRep_ResetCounter (Underlying native function: OnRep_ResetCounter 0x735f20c)
	void OnRepResetCounter(); // (Final | Native | Private)

	// Function /Script/SpecialEventGameplayRuntime.FortControllerComponent_FakeKillRelevancy.OnKillEffectsPlayed (Underlying native function: OnKillEffectsPlayed 0x735dfb8)
	...
	// Function /Script/SpecialEventGameplayRuntime.FortControllerComponent_FakeKillRelevancy.GetDeathLocation (Underlying native function: GetDeathLocation 0x735c0bc)
