...
class UControllerComponent_Quests : public UControllerComponent
{
	...
	// Function /Script/FortniteGame.ControllerComponent_Quests.OnRep_UpdatedQuestObjectives (Underlying native function: OnRep_UpdatedQuestObjectives 0x8bdd994)
	void OnRepUpdatedQuestObjectives(); // (Final | Native | Private)

	// Function /Script/FortniteGame.ControllerComponent_Quests.Client_GrantQuest (Underlying native function: Client_GrantQuest 0x81aa884)
