...
class UAthenaItemElementWidgetBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaItemElementWidgetBase.SetItemToRepresent (Underlying native function: SetItemToRepresent 0xa3a1d3c)
	...
	// Function /Script/FortniteUI.AthenaItemElementWidgetBase.HandleItemChanged (Underlying native function: HandleItemChanged 0xa3a0a0c)
	void HandleItemChanged(bool& bItemChanged, bool& bAmmoChanged, bool& bIngredientsChanged); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaItemElementWidgetBase.GetItemToRepresent (Underlying native function: GetItemToRepresent 0xa3a02bc)
