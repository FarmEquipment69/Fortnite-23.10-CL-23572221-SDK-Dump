...
class UFortItemAccessTokenType : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortItemAccessTokenType.GetUnlockDescription (Underlying native function: GetUnlockDescription 0x8813ed8)
	struct FText GetUnlockDescription(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortItemAccessTokenType.GetAccessItem (Underlying native function: GetAccessItem 0x77648b0)
