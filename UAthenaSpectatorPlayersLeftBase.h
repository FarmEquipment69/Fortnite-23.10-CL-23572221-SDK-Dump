...
class UAthenaSpectatorPlayersLeftBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpectatorPlayersLeftBase.OnGameStateSet (Underlying native function: OnGameStateSet 0xa43f544)
	void OnGameStateSet(class AFortGameState*& InGameState); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorPlayersLeftBase.OnBroadcastSpectatorInfoReplicated (Underlying native function: OnBroadcastSpectatorInfoReplicated 0xa43f29c)
