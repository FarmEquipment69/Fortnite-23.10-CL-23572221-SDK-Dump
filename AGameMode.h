...
class AGameMode : public AGameModeBase
{
	...
	// Function /Script/Engine.GameMode.StartMatch (Underlying native function: StartMatch 0x3057b3c)
	void StartMatch(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.GameMode.Say (Underlying native function: Say 0x9bd5008)
	void Say(struct FString& Msg); // (Exec | Native | Public | BlueprintCallable)

	// Function /Script/Engine.GameMode.RestartGame (Underlying native function: RestartGame 0x24b8434)
	void RestartGame(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.GameMode.ReadyToStartMatch (Underlying native function: ReadyToStartMatch 0x20e7228)
	bool ReadyToStartMatch(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/Engine.GameMode.ReadyToEndMatch (Underlying native function: ReadyToEndMatch 0x23afa94)
	...
	// Function /Script/Engine.GameMode.IsMatchInProgress (Underlying native function: IsMatchInProgress 0x9bd269c)
	bool IsMatchInProgress(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.GameMode.GetMatchState (Underlying native function: GetMatchState 0x2d7b044)
	struct FName GetMatchState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.GameMode.EndMatch (Underlying native function: EndMatch 0x2df23ac)
	void EndMatch(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.GameMode.AbortMatch (Underlying native function: AbortMatch 0x9bcbd00)
