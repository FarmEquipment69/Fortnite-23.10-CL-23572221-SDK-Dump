...
class UFortMediaCMSEventsComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortMediaCMSEventsComponent.InitializeEventPageCustomData (Underlying native function: InitializeEventPageCustomData 0x87145e4)
	...
	// Function /Script/FortniteGame.FortMediaCMSEventsComponent.InitializeEventPage (Underlying native function: InitializeEventPage 0x8714490)
	void InitializeEventPage(struct FString& InEventPageName); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMediaCMSEventsComponent.GetValidMediaEvents (Underlying native function: GetValidMediaEvents 0x8714474)
	struct TArray<class UMediaCMSEvent*> GetValidMediaEvents(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMediaCMSEventsComponent.GetAllMediaEvents (Underlying native function: GetAllMediaEvents 0x87139c0)
