...
class UFortCreativeLinearMoverComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.TranslateTo (Underlying native function: TranslateTo 0x8520890)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.Translate (Underlying native function: Translate 0x6df775c)
	void Translate(bool& bTeleport); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.StopTranslation (Underlying native function: StopTranslation 0x273fd14)
	void StopTranslation(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.StopRotation (Underlying native function: StopRotation 0x273fd14)
	void StopRotation(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.SetTranslationType (Underlying native function: SetTranslationType 0x8521f44)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.SetRotationDirection (Underlying native function: SetRotationDirection 0x8521e80)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.RotateTo (Underlying native function: RotateTo 0x8520890)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.Rotate (Underlying native function: Rotate 0x6df775c)
	void Rotate(bool& bTeleport); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.ResetTranslation (Underlying native function: ResetTranslation 0x273fd14)
	void ResetTranslation(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.ResetRotation (Underlying native function: ResetRotation 0x273fd14)
	void ResetRotation(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.ResetActorsToIgnoreDuringMovement (Underlying native function: ResetActorsToIgnoreDuringMovement 0x52909a0)
	void ResetActorsToIgnoreDuringMovement(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnRep_TranslationMovementData (Underlying native function: OnRep_TranslationMovementData 0x8520018)
	void OnRepTranslationMovementData(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnRep_Target (Underlying native function: OnRep_Target 0x851ff98)
	void OnRepTarget(struct TWeakObjectPtr<class ABuildingActor>& OldTarget); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnRep_RotationMovementData (Underlying native function: OnRep_RotationMovementData 0x851ff78)
	void OnRepRotationMovementData(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnRep_ActorsToIgnoreDuringMovement (Underlying native function: OnRep_ActorsToIgnoreDuringMovement 0x59575c0)
	void OnRepActorsToIgnoreDuringMovement(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnMinigamePlayModeChanged (Underlying native function: OnMinigamePlayModeChanged 0x6d23b2c)
	void OnMinigamePlayModeChanged(class AFortMinigame*& Minigame, bool& bIsInPlayMode); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.OnEnabledStateChanged (Underlying native function: OnEnabledStateChanged 0x6df775c)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.GetNearestOverlappingBuildingActor (Underlying native function: GetNearestOverlappingBuildingActor 0x851d550)
	class ABuildingActor* GetNearestOverlappingBuildingActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.ComponentHit (Underlying native function: ComponentHit 0x59570c0)
	...
	// Function /Script/FortniteGame.FortCreativeLinearMoverComponent.AddActorToIgnoreDuringMovement (Underlying native function: AddActorToIgnoreDuringMovement 0x5956b60)
