...
class UEndOfMatchQuestUpdateWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.TryToShowNextQuestUpdate (Underlying native function: TryToShowNextQuestUpdate 0xa3489f8)
	void TryToShowNextQuestUpdate(bool& bShouldStartShowingQuests); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.TryPlayCreatedWidgets (Underlying native function: TryPlayCreatedWidgets 0xa3489d0)
	void TryPlayCreatedWidgets(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.StartCategoryPlay (Underlying native function: StartCategoryPlay 0xa3487e0)
	...
	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.QuestUpdated (Underlying native function: QuestUpdated 0xa348314)
	void QuestUpdated(class UFortQuestItem*& InUpdateData); // (Final | Native | Public)

	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.QuestUpdateCompleted (Underlying native function: QuestUpdateCompleted 0xa347ff0)
	void QuestUpdateCompleted(class UAthenaChallengeRecapEntry*& EntryWidget); // (Final | Native | Protected)

	// Function /Script/FortniteUI.EndOfMatchQuestUpdateWidget.HandleTileFocused (Underlying native function: HandleTileFocused 0xa3474d8)
