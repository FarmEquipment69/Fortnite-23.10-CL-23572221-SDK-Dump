...
class UAthenaCreativeItemTileButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.AthenaCreativeItemTileButton.MakeFortItemEntryObjectWrapper (Underlying native function: MakeFortItemEntryObjectWrapper 0xa347a90)
	...
	// Function /Script/FortniteUI.AthenaCreativeItemTileButton.GetItemTypeCount (Underlying native function: GetItemTypeCount 0xa3460a0)
	int GetItemTypeCount(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.AthenaCreativeItemTileButton.CompareToItemEntry (Underlying native function: CompareToItemEntry 0xa345e08)
