...
class UFortNavigationVisibilityComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.MakeActorVisable (Underlying native function: MakeActorVisable 0x5900db0)
	void MakeActorVisable(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.MakeActorHidden (Underlying native function: MakeActorHidden 0x5900d90)
	void MakeActorHidden(); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.HandlePlayerChanged (Underlying native function: HandlePlayerChanged 0x82a9bc0)
	void HandlePlayerChanged(class AFortPlayerController*& NewRoomOwner); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.HandleActiveCameraChanged (Underlying native function: HandleActiveCameraChanged 0x82a946c)
	void HandleActiveCameraChanged(struct FGameplayTag& CameraTag); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.Editor_GetValidProfileStats (Underlying native function: Editor_GetValidProfileStats 0x82a8d58)
	struct TArray<struct FString> EditorGetValidProfileStats(); // (Final | Native | Private | Const)

	// Function /Script/FortniteGame.FortNavigationVisibilityComponent.Editor_GetValidObjectives (Underlying native function: Editor_GetValidObjectives 0x6f661c0)
