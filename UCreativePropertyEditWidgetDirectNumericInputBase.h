...
class UCreativePropertyEditWidgetDirectNumericInputBase : public UCreativePropertyEditWidgetUserOptionBase
{
	...
	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.TryGetCurrentOptionValue (Underlying native function: TryGetCurrentOptionValue 0xa5886b4)
	void TryGetCurrentOptionValue(struct FString& Data); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.SetNumericEntryEditable (Underlying native function: SetNumericEntryEditable 0xa5879e0)
	void SetNumericEntryEditable(bool& bIsEditable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.ParseTeamOrClassOptionsAsString (Underlying native function: ParseTeamOrClassOptionsAsString 0xa58690c)
	struct FString ParseTeamOrClassOptionsAsString(struct FString& OriginalString); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.OnRotated (Underlying native function: OnRotated 0xa58651c)
	void OnRotated(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.HandleNumericEntryCommited (Underlying native function: HandleNumericEntryCommited 0xa5856e4)
	...
	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.HandleNumericEntryChanged (Underlying native function: HandleNumericEntryChanged 0x8b10a98)
	void HandleNumericEntryChanged(float& InValue); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetDirectNumericInputBase.CheckIsNumeircValueModified (Underlying native function: CheckIsNumeircValueModified 0xa583574)
