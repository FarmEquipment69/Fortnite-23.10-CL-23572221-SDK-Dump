...
class AFortEventLevelCamera : public AFortCameraBase
{
	...
	// Function /Script/FortniteGame.FortEventLevelCamera.UpdateLevelLightSwitch (Underlying native function: UpdateLevelLightSwitch 0x840f828)
	void UpdateLevelLightSwitch(bool& bTurnOn); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortEventLevelCamera.StartLevelTransition (Underlying native function: StartLevelTransition 0x840f7a8)
