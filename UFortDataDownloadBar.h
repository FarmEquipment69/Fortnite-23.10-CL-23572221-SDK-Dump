...
class UFortDataDownloadBar : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortDataDownloadBar.SetStatusText (Underlying native function: SetStatusText 0xa85bdb0)
	void SetStatusText(struct FText& StatusText); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortDataDownloadBar.SetRemainingTimeEstimate (Underlying native function: SetRemainingTimeEstimate 0xa85bc48)
	...
	// Function /Script/FortniteUI.FortDataDownloadBar.SetProgress (Underlying native function: SetProgress 0xa85bbc4)
	...
	// Function /Script/FortniteUI.FortDataDownloadBar.ExpandClose (Underlying native function: ExpandClose 0xa85af18)
