...
class UFortMatchmakingV2 : public UObject
{
	...
	unsigned char padding_b1[0xeef]; // 0xb1 (0xeef)

	/* Functions */

	// Function /Script/FortniteGame.FortMatchmakingV2.GetMatchmakingAttemptThrottleTime (Underlying native function: GetMatchmakingAttemptThrottleTime 0x89e6180)
