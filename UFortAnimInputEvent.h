...
class UFortAnimInputEvent : public UObject
{
	...
	// Function /Script/FortniteGame.FortAnimInputEvent.IsNamed (Underlying native function: IsNamed 0x21dd644)
	bool IsNamed(struct FName& InEventName); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAnimInputEvent.CreateAnimInputEvent (Underlying native function: CreateAnimInputEvent 0xe87a58)
