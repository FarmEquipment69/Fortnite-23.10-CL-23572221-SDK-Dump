...
class AChaosSolverActor : public AActor
{
	...
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetSolverActive (Underlying native function: SetSolverActive 0x77aee00)
	void SetSolverActive(bool& bActive); // (Native | Public | BlueprintCallable)

	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver (Underlying native function: SetAsCurrentWorldSolver 0x97c8684)
