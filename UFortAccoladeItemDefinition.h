...
class UFortAccoladeItemDefinition : public UFortPersistableItemDefinition
{
	...
	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetPriority (Underlying native function: GetPriority 0x87f4d2c)
	enum EXPEventPriorityType GetPriority(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetPreviousAccoladeSmallPreviewImage (Underlying native function: GetPreviousAccoladeSmallPreviewImage 0x87f4bf4)
	...
	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetPreviousAccoladeLargePreviewImage (Underlying native function: GetPreviousAccoladeLargePreviewImage 0x87f4b54)
	...
	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAwardedSound (Underlying native function: GetAwardedSound 0x87f45e4)
	class USoundCue* GetAwardedSound(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAccoladeXpValueWithCountScalar (Underlying native function: GetAccoladeXpValueWithCountScalar 0x87f4508)
	int GetAccoladeXpValueWithCountScalar(int& Count); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAccoladeXpValue (Underlying native function: GetAccoladeXpValue 0x87f44c8)
	int GetAccoladeXpValue(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAccoladeType (Underlying native function: GetAccoladeType 0x87b43b0)
	enum EFortAccoladeType GetAccoladeType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAccoladeSubtype (Underlying native function: GetAccoladeSubtype 0x6fc513c)
	enum EFortAccoladeSubtype GetAccoladeSubtype(); // (Final | Native | Public | Const)

	// Function /Script/FortniteGame.FortAccoladeItemDefinition.GetAccoladeLevel (Underlying native function: GetAccoladeLevel 0x2d7b344)
