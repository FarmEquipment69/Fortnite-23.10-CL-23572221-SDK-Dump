...
class UFortPawnComponent_Tether : public UFortPawnComponent
{
	...
	// Function /Script/FortniteGame.FortPawnComponent_Tether.TetheredExitReleased (Underlying native function: TetheredExitReleased 0x84985d4)
	void TetheredExitReleased(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.TetheredExitPressed (Underlying native function: TetheredExitPressed 0x84985c0)
	void TetheredExitPressed(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.TetheredBoostReleased (Underlying native function: TetheredBoostReleased 0x84985a8)
	void TetheredBoostReleased(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.TetheredBoostPressed (Underlying native function: TetheredBoostPressed 0x8498590)
	void TetheredBoostPressed(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.SetViewTargetToTetherPawn (Underlying native function: SetViewTargetToTetherPawn 0x8497f68)
	void SetViewTargetToTetherPawn(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.ServerRequestTetherJump (Underlying native function: ServerRequestTetherJump 0x20eb1a0)
	void ServerRequestTetherJump(); // (Net | NetReliable | Native | Event | Public | NetServer)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.ServerReleaseTether (Underlying native function: ServerReleaseTether 0x2664ff8)
	void ServerReleaseTether(); // (Net | NetReliable | Native | Event | Public | NetServer)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.OnRep_TetherPawn (Underlying native function: OnRep_TetherPawn 0x8496d64)
	void OnRepTetherPawn(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.OnRep_TetheredWithoutWeapon (Underlying native function: OnRep_TetheredWithoutWeapon 0x8496d78)
	void OnRepTetheredWithoutWeapon(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.GamepadTetheredExitAndReloadReleased (Underlying native function: GamepadTetheredExitAndReloadReleased 0x8495558)
	void GamepadTetheredExitAndReloadReleased(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortPawnComponent_Tether.DelayedSetViewTargetToTetherPawn (Underlying native function: DelayedSetViewTargetToTetherPawn 0x8495544)
