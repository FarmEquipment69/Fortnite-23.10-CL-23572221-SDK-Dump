...
class AFortWaterBodyActor : public AWaterBody
{
	...
	// Function /Script/FortniteGame.FortWaterBodyActor.SetWaterBodyType (Underlying native function: SetWaterBodyType 0x860c348)
	void SetWaterBodyType(enum EWaterBodyType& InType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortWaterBodyActor.SetSwampLocationAndRadius (Underlying native function: SetSwampLocationAndRadius 0x860bc90)
	...
	// Function /Script/FortniteGame.FortWaterBodyActor.GetWaterSurfaceInfoStruct (Underlying native function: GetWaterSurfaceInfoStruct 0x230df88)
	...
	// Function /Script/FortniteGame.FortWaterBodyActor.GetWaterSurfaceInfo (Underlying native function: GetWaterSurfaceInfo 0x8609e58)
