...
class UFortMissionTrackerEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortMissionTrackerEntry.UpdateVisibility (Underlying native function: UpdateVisibility 0xa73258c)
	...
	// Function /Script/FortniteUI.FortMissionTrackerEntry.HandleObjectivesChanged (Underlying native function: HandleObjectivesChanged 0xa7325b4)
	void HandleObjectivesChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortMissionTrackerEntry.HandleMissionInfoSet (Underlying native function: HandleMissionInfoSet 0xa73258c)
