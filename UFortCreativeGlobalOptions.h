...
class UFortCreativeGlobalOptions : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCreativeGlobalOptions.UpdateCachedIndices (Underlying native function: UpdateCachedIndices 0xa55ddfc)
	void UpdateCachedIndices(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeGlobalOptions.SetListDataSource (Underlying native function: SetListDataSource 0xa55ced0)
	void SetListDataSource(struct TEnumAsByte<UFortMatchmakingKnobsDataSource>& ListType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeGlobalOptions.GetOptionListFromMemoryPointer (Underlying native function: GetOptionListFromMemoryPointer 0xa55ab88)
