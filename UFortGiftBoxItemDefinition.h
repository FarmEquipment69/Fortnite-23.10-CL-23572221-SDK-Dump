...
class UFortGiftBoxItemDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortGiftBoxItemDefinition.TryLoadPreMessageWidgetClass (Underlying native function: TryLoadPreMessageWidgetClass 0x881597c)
	bool TryLoadPreMessageWidgetClass(class UClass*& OutWidgetClass); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortGiftBoxItemDefinition.TryLoadHeaderSubWidgetClass (Underlying native function: TryLoadHeaderSubWidgetClass 0x88158e4)
	bool TryLoadHeaderSubWidgetClass(class UClass*& OutWidgetClass); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortGiftBoxItemDefinition.HasPreMessageWidget (Underlying native function: HasPreMessageWidget 0x8814610)
	bool HasPreMessageWidget(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGiftBoxItemDefinition.HasHeaderSubWidget (Underlying native function: HasHeaderSubWidget 0x8814484)
