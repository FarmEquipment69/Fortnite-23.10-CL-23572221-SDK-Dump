...
class UFortPlayerProfileBannerEditor : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.SetBannerIcon (Underlying native function: SetBannerIcon 0xa7611b4)
	void SetBannerIcon(struct FName& Icon); // (Final | Native | Protected | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.SetBannerColor (Underlying native function: SetBannerColor 0xa76110c)
	void SetBannerColor(struct FName& Color); // (Final | Native | Protected | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.RefreshBannerEditor (Underlying native function: RefreshBannerEditor 0x71e81dc)
	...
	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.HandleEditorDeactivated (Underlying native function: HandleEditorDeactivated 0xa76089c)
	void HandleEditorDeactivated(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.HandleEditorActivated (Underlying native function: HandleEditorActivated 0xa760888)
	void HandleEditorActivated(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortPlayerProfileBannerEditor.CommitChosenIconAndColor (Underlying native function: CommitChosenIconAndColor 0xa7605d0)
