...
class UFortControllerComponent_SpyTechPerkSystem : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_SpyTechArray (Underlying native function: OnRep_SpyTechArray 0x82aa5b0)
	void OnRepSpyTechArray(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_ServerTimeToRelease (Underlying native function: OnRep_ServerTimeToRelease 0x82aa588)
	void OnRepServerTimeToRelease(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_RerollCount (Underlying native function: OnRep_RerollCount 0x82aa564)
	void OnRepRerollCount(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_PerkSelection (Underlying native function: OnRep_PerkSelection 0x82aa530)
	void OnRepPerkSelection(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_MutatorData (Underlying native function: OnRep_MutatorData 0x82aa508)
	void OnRepMutatorData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortControllerComponent_SpyTechPerkSystem.OnRep_AllSelectedPerks (Underlying native function: OnRep_AllSelectedPerks 0x82aa41c)
