...
class AFortSpectateAFriendController : public AFortLiveSpectatorController
{
	...
	// Function /Script/FortniteGame.FortSpectateAFriendController.OnRep_TeamToFollow (Underlying native function: OnRep_TeamToFollow 0x8bbe440)
	void OnRepTeamToFollow(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortSpectateAFriendController.OnRep_TeamJoinedOnPlacement (Underlying native function: OnRep_TeamJoinedOnPlacement 0x8bbe660)
	void OnRepTeamJoinedOnPlacement(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortSpectateAFriendController.OnRep_PlayerJoinedOn (Underlying native function: OnRep_PlayerJoinedOn 0x8bbe5a0)
	void OnRepPlayerJoinedOn(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortSpectateAFriendController.OnRep_HasValidTarget (Underlying native function: OnRep_HasValidTarget 0x8bbe478)
	void OnRepHasValidTarget(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortSpectateAFriendController.OnRep_FollowAnyTeam (Underlying native function: OnRep_FollowAnyTeam 0x8bbe440)
