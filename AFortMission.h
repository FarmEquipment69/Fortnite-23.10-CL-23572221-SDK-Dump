...
class AFortMission : public AFortMissionState
{
	...
	// Function /Script/FortniteGame.FortMission.StopMissionAIEncounter (Underlying native function: StopMissionAIEncounter 0x88cb5a4)
	...
	// Function /Script/FortniteGame.FortMission.StopEncounterSequence (Underlying native function: StopEncounterSequence 0x88cb528)
	...
	// Function /Script/FortniteGame.FortMission.StartMissionAIEncounterFromGeneratedProfile (Underlying native function: StartMissionAIEncounterFromGeneratedProfile 0x88caf48)
	...
	// Function /Script/FortniteGame.FortMission.StartMissionAIEncounter (Underlying native function: StartMissionAIEncounter 0x88cac08)
	...
	// Function /Script/FortniteGame.FortMission.SpawnAtPlacementActorsAsArray (Underlying native function: SpawnAtPlacementActorsAsArray 0x88ca79c)
	...
	// Function /Script/FortniteGame.FortMission.SetUiVisibility (Underlying native function: SetUiVisibility 0x88ca370)
	void SetUiVisibility(bool& bInIsMissionVisible); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.SetToSilentDestroy (Underlying native function: SetToSilentDestroy 0x88ca124)
	void SetToSilentDestroy(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.SetTimerElapsedComponent (Underlying native function: SetTimerElapsedComponent 0x88ca0a4)
	...
	// Function /Script/FortniteGame.FortMission.SetTimerComponent (Underlying native function: SetTimerComponent 0x88ca024)
	void SetTimerComponent(class UFortMissionTimerComponent*& InTimerComponent); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.SetRespawnTextOverride (Underlying native function: SetRespawnTextOverride 0x88c9744)
	void SetRespawnTextOverride(struct FText& NewText); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.SetMissionGameDifficulty (Underlying native function: SetMissionGameDifficulty 0x88c93e4)
	void SetMissionGameDifficulty(float& GameDifficultyValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.SendBotLogicMessage (Underlying native function: SendBotLogicMessage 0x88c8c90)
	void SendBotLogicMessage(struct FString& EventName); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.RemoveParticipantAccount (Underlying native function: RemoveParticipantAccount 0x88c87f8)
	...
	// Function /Script/FortniteGame.FortMission.RemoveGoalsFromEncounterAssignment (Underlying native function: RemoveGoalsFromEncounterAssignment 0x88c14a0)
	...
	// Function /Script/FortniteGame.FortMission.RemoveGoalFromEncounterAssignment (Underlying native function: RemoveGoalFromEncounterAssignment 0x88c1174)
	...
	// Function /Script/FortniteGame.FortMission.RegisterForContainerSearchedEvent (Underlying native function: RegisterForContainerSearchedEvent 0x88c8568)
	...
	// Function /Script/FortniteGame.FortMission.RegisterForBuildingHarvestedByPlayerEvent (Underlying native function: RegisterForBuildingHarvestedByPlayerEvent 0x88c8420)
	...
	// Function /Script/FortniteGame.FortMission.RecordResourceActorSpawn (Underlying native function: RecordResourceActorSpawn 0x88c8140)
	void RecordResourceActorSpawn(class AActor*& SpawnedActor); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.ProvideAllPotentialBadges (Underlying native function: ProvideAllPotentialBadges 0x88c80a4)
	...
	// Function /Script/FortniteGame.FortMission.OnWaveCompleted (Underlying native function: OnWaveCompleted 0x88c7e34)
	...
	// Function /Script/FortniteGame.FortMission.OnRep_UIIndex (Underlying native function: OnRep_UIIndex 0x6a447a8)
	void OnRepUIIndex(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_QuestOwnerAccount (Underlying native function: OnRep_QuestOwnerAccount 0x150163c)
	void OnRepQuestOwnerAccount(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_PotentialBadgesArray (Underlying native function: OnRep_PotentialBadgesArray 0x88c7d84)
	void OnRepPotentialBadgesArray(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_MissionStatus (Underlying native function: OnRep_MissionStatus 0x29fce3c)
	void OnRepMissionStatus(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_MissionInfo (Underlying native function: OnRep_MissionInfo 0x88c7d5c)
	void OnRepMissionInfo(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_CurrentFocusDisplayData (Underlying native function: OnRep_CurrentFocusDisplayData 0x88c7cac)
	void OnRepCurrentFocusDisplayData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_bIsMissionVisible (Underlying native function: OnRep_bIsMissionVisible 0x3057b24)
	void OnRepbIsMissionVisible(); // (Native | Protected)

	// Function /Script/FortniteGame.FortMission.OnRep_ActiveObjectives (Underlying native function: OnRep_ActiveObjectives 0x88c7c7c)
	...
	// Function /Script/FortniteGame.FortMission.MissionTimerSet (Underlying native function: MissionTimerSet 0x6f4981c)
	void MissionTimerSet(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortMission.LoadPossibleMissionsManually (Underlying native function: LoadPossibleMissionsManually 0x88c6d38)
	...
	// Function /Script/FortniteGame.FortMission.LoadMissionsManually (Underlying native function: LoadMissionsManually 0x88c6ad4)
	...
	// Function /Script/FortniteGame.FortMission.IsPlayerParticipating (Underlying native function: IsPlayerParticipating 0x88c69b4)
	...
	// Function /Script/FortniteGame.FortMission.InitializeModifiersRRV (Underlying native function: InitializeModifiersRRV 0x88c688c)
	void InitializeModifiersRRV(int& Seed); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.InitializeActorsForMissionMatchingItemIdentifyingQuery (Underlying native function: InitializeActorsForMissionMatchingItemIdentifyingQuery 0x88c5ff0)
	...
	// Function /Script/FortniteGame.FortMission.InitializeActorsForMission (Underlying native function: InitializeActorsForMission 0x88c5efc)
	...
	// Function /Script/FortniteGame.FortMission.HasMissionPar (Underlying native function: HasMissionPar 0x88c5ec4)
	...
	// Function /Script/FortniteGame.FortMission.HandleEncounterEnemyAISpawned (Underlying native function: HandleEncounterEnemyAISpawned 0x88c5c30)
	...
	// Function /Script/FortniteGame.FortMission.GrantRewardsByTag (Underlying native function: GrantRewardsByTag 0x88c5b8c)
	...
	// Function /Script/FortniteGame.FortMission.GetTieredModifierSet (Underlying native function: GetTieredModifierSet 0x88c5410)
	...
	// Function /Script/FortniteGame.FortMission.GetSpawnLocationsMatchingQuery (Underlying native function: GetSpawnLocationsMatchingQuery 0x88c4cd4)
	...
	// Function /Script/FortniteGame.FortMission.GetSpawnLocationActorsMatchingQuery (Underlying native function: GetSpawnLocationActorsMatchingQuery 0x88c4b34)
	...
	// Function /Script/FortniteGame.FortMission.GetSpawningDistanceMinMaxOverrideForAIEncounter (Underlying native function: GetSpawningDistanceMinMaxOverrideForAIEncounter 0x88c4e74)
	...
	// Function /Script/FortniteGame.FortMission.GetRewardItemsByTag (Underlying native function: GetRewardItemsByTag 0x88c46c8)
	...
	// Function /Script/FortniteGame.FortMission.GetRespawnTextOverride (Underlying native function: GetRespawnTextOverride 0x88c4648)
	struct FText GetRespawnTextOverride(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | Const)

	// Function /Script/FortniteGame.FortMission.GetPawnDamageLootTier (Underlying native function: GetPawnDamageLootTier 0x88c433c)
	...
	// Function /Script/FortniteGame.FortMission.GetParticipatingMissionControllers (Underlying native function: GetParticipatingMissionControllers 0x88c42c8)
	...
	// Function /Script/FortniteGame.FortMission.GetObjectiveStatusByHandle (Underlying native function: GetObjectiveStatusByHandle 0x88c41f0)
	...
	// Function /Script/FortniteGame.FortMission.GetObjectiveHandlesWithTag (Underlying native function: GetObjectiveHandlesWithTag 0x88c4118)
	...
	// Function /Script/FortniteGame.FortMission.GetObjectiveByHandle (Underlying native function: GetObjectiveByHandle 0x88c4050)
	...
	// Function /Script/FortniteGame.FortMission.GetMissionName (Underlying native function: GetMissionName 0x88c3fb8)
	struct FText GetMissionName(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetMissionGuid (Underlying native function: GetMissionGuid 0x88c3f9c)
	struct FGuid GetMissionGuid(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetMissionCompletionResultText (Underlying native function: GetMissionCompletionResultText 0x88c3ebc)
	struct FText GetMissionCompletionResultText(enum EFortCompletionResult& Result); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortMission.GetExpectedCompletionTime (Underlying native function: GetExpectedCompletionTime 0x88c3a3c)
	float GetExpectedCompletionTime(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetDaysRemainingBeforeOverPar (Underlying native function: GetDaysRemainingBeforeOverPar 0x88c3a18)
	int GetDaysRemainingBeforeOverPar(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetCurrentFocusPercentage (Underlying native function: GetCurrentFocusPercentage 0x2df03c0)
	float GetCurrentFocusPercentage(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetCurrentFocusDisplayText (Underlying native function: GetCurrentFocusDisplayText 0x88c399c)
	struct FText GetCurrentFocusDisplayText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetCurrentBluGloRewards (Underlying native function: GetCurrentBluGloRewards 0x88c3974)
	int GetCurrentBluGloRewards(); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetConfigData (Underlying native function: GetConfigData 0x88c378c)
	...
	// Function /Script/FortniteGame.FortMission.GetBuildingDamageLootTier (Underlying native function: GetBuildingDamageLootTier 0x88c3610)
	...
	// Function /Script/FortniteGame.FortMission.GetAnnouncementClassOverride (Underlying native function: GetAnnouncementClassOverride 0x88c35bc)
	class UClass* GetAnnouncementClassOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMission.GetAllObjectives (Underlying native function: GetAllObjectives 0x88c3548)
	...
	// Function /Script/FortniteGame.FortMission.GetActorsSpawnedMatchingQuery (Underlying native function: GetActorsSpawnedMatchingQuery 0x88c33a8)
	...
	// Function /Script/FortniteGame.FortMission.FocusThisMission (Underlying native function: FocusThisMission 0x88c302c)
	...
	// Function /Script/FortniteGame.FortMission.FindGoalLocationsForEncounterAssignment (Underlying native function: FindGoalLocationsForEncounterAssignment 0x88c2e74)
	...
	// Function /Script/FortniteGame.FortMission.CreateEncounterSequenceByIndex (Underlying native function: CreateEncounterSequenceByIndex 0x88c2b70)
	...
	// Function /Script/FortniteGame.FortMission.CreateEncounterSequence (Underlying native function: CreateEncounterSequence 0x88c2aa8)
	...
	// Function /Script/FortniteGame.FortMission.CreateEncounterAssignment (Underlying native function: CreateEncounterAssignment 0x88c28e0)
	...
	// Function /Script/FortniteGame.FortMission.ChooseRandomReward (Underlying native function: ChooseRandomReward 0x88c265c)
	...
	// Function /Script/FortniteGame.FortMission.BlueprintCanPlayerParticipate (Underlying native function: BlueprintCanPlayerParticipate 0x88c2304)
	...
	// Function /Script/FortniteGame.FortMission.AttemptMissionSave (Underlying native function: AttemptMissionSave 0x88c1fe8)
	void AttemptMissionSave(struct FString& OptionalSaveName); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission.ApplyTieredModifierSet (Underlying native function: ApplyTieredModifierSet 0x88c1cb8)
	...
	// Function /Script/FortniteGame.FortMission.AddParticipantAccount (Underlying native function: AddParticipantAccount 0x88c19b4)
	...
	// Function /Script/FortniteGame.FortMission.AddOrRemoveTimerTime (Underlying native function: AddOrRemoveTimerTime 0x88c192c)
	void AddOrRemoveTimerTime(float& TimeToAdd); // (BlueprintAuthorityOnly | Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteGame.FortMission.AddGoalToEncounterAssignment (Underlying native function: AddGoalToEncounterAssignment 0x88c1174)
	...
	// Function /Script/FortniteGame.FortMission.AddGoalToAssignment (Underlying native function: AddGoalToAssignment 0x88c1090)
	...
	// Function /Script/FortniteGame.FortMission.AddGoalsToEncounterAssignment (Underlying native function: AddGoalsToEncounterAssignment 0x88c14a0)
	...
	// Function /Script/FortniteGame.FortMission.AddGoalsToAssignment (Underlying native function: AddGoalsToAssignment 0x88c12d4)
	...
	// Function /Script/FortniteGame.FortMission.AddCompletionTags (Underlying native function: AddCompletionTags 0x88c0fd4)
	...
	// Function /Script/FortniteGame.FortMission.AddCompletionTag (Underlying native function: AddCompletionTag 0x88c0f54)
