...
class UFortHeroClassGameplayDefinition : public UDataAsset
{
	...
	// Function /Script/FortniteGame.FortHeroClassGameplayDefinition.GetAbilityKitsForClassPerks (Underlying native function: GetAbilityKitsForClassPerks 0x8cb8f34)
