...
class UFortAlterationOptionsBase : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortAlterationOptionsBase.ProcessAlterationOptions (Underlying native function: ProcessAlterationOptions 0x721c3d8)
	...
	// Function /Script/SaveTheWorldUI.FortAlterationOptionsBase.IsValidAlterationSlot (Underlying native function: IsValidAlterationSlot 0x721c048)
	bool IsValidAlterationSlot(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortAlterationOptionsBase.HandleAlterationsOptionSelected (Underlying native function: HandleAlterationsOptionSelected 0x721b3a8)
	void HandleAlterationsOptionSelected(class UCommonButtonLegacy*& AlterationOptionButton, int& GroupIndex); // (Final | Native | Public)

	// Function /Script/SaveTheWorldUI.FortAlterationOptionsBase.HandleAlterationsOptionHovered (Underlying native function: HandleAlterationsOptionHovered 0x721b3a8)
	void HandleAlterationsOptionHovered(class UCommonButtonLegacy*& AlterationOptionButton, int& GroupIndex); // (Final | Native | Public)

	// Function /Script/SaveTheWorldUI.FortAlterationOptionsBase.DoAlterationOptionsExist (Underlying native function: DoAlterationOptionsExist 0x7219da8)
