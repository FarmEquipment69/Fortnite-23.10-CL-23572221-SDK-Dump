...
class UAsyncPhysicsInputComponent : public UActorComponent
{
	...
	// Function /Script/Engine.AsyncPhysicsInputComponent.ServerRPCBufferInput (Underlying native function: ServerRPCBufferInput 0x6ce33a4)
	void ServerRPCBufferInput(class UAsyncPhysicsData*& AsyncPhysicsData); // (Net | Native | Event | Public | NetServer)

	// Function /Script/Engine.AsyncPhysicsInputComponent.GetDataToWrite (Underlying native function: GetDataToWrite 0x9d0a03c)
	class UAsyncPhysicsData* GetDataToWrite(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AsyncPhysicsInputComponent.GetDataToConsume (Underlying native function: GetDataToConsume 0x9d0a018)
