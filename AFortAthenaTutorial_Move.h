...
class AFortAthenaTutorial_Move : public AFortAthenaTutorialBase
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Move.OnBeginOverlapJumpTriggerBox (Underlying native function: OnBeginOverlapJumpTriggerBox 0x82d30f4)
	void OnBeginOverlapJumpTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Move.OnBeginOverlapJumpEndTriggerBox (Underlying native function: OnBeginOverlapJumpEndTriggerBox 0x82d327c)
	void OnBeginOverlapJumpEndTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Move.OnBeginOverlapCrouchTriggerBox (Underlying native function: OnBeginOverlapCrouchTriggerBox 0x82d3404)
	void OnBeginOverlapCrouchTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Move.OnBeginOverlapCrouchEndTriggerBox (Underlying native function: OnBeginOverlapCrouchEndTriggerBox 0x82d3340)
