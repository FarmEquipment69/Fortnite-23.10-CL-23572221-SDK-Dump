...
class UFortCreativeAccoladesComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeAccoladesComponent.OnPlayModeChanged (Underlying native function: OnPlayModeChanged 0x6d23b2c)
	...
	// Function /Script/FortniteGame.FortCreativeAccoladesComponent.GrantAccolade (Underlying native function: GrantAccolade 0x6e9113c)
	bool GrantAccolade(class AFortPlayerController*& PlayerController); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeAccoladesComponent.CanGrantAccolade (Underlying native function: CanGrantAccolade 0x84f82f4)
