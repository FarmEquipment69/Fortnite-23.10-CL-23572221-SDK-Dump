...
class UFortHealthSet : public UFortAttributeSet
{
	...
	// Function /Script/FortniteGame.FortHealthSet.SetDamageDoneOverrideDelegate (Underlying native function: SetDamageDoneOverrideDelegate 0x831e47c)
	void SetDamageDoneOverrideDelegate(struct FDelegate& InOnDamageDoneOverrideDelegate); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_SignalInStorm (Underlying native function: OnRep_SignalInStorm 0x210c8a0)
	void OnRepSignalInStorm(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_Shield (Underlying native function: OnRep_Shield 0x210c5c8)
	void OnRepShield(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_MaxSignalInStorm (Underlying native function: OnRep_MaxSignalInStorm 0x831b6a0)
	void OnRepMaxSignalInStorm(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_MaxOvershield (Underlying native function: OnRep_MaxOvershield 0x831b5d4)
	void OnRepMaxOvershield(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_MaxHealth (Underlying native function: OnRep_MaxHealth 0x210c010)
	void OnRepMaxHealth(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_Health (Underlying native function: OnRep_Health 0x230eb84)
	void OnRepHealth(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_CurrentShield (Underlying native function: OnRep_CurrentShield 0x210c2e4)
	void OnRepCurrentShield(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_CurrentOvershield (Underlying native function: OnRep_CurrentOvershield 0x831957c)
	void OnRepCurrentOvershield(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.OnRep_BlockedDamage (Underlying native function: OnRep_BlockedDamage 0x831858c)
	void OnRepBlockedDamage(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortHealthSet.IsTacticalOvershieldEnabled (Underlying native function: IsTacticalOvershieldEnabled 0x83182dc)
	static bool IsTacticalOvershieldEnabled(); // (Final | Native | Static | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHealthSet.ClearDamageDoneOverrideDelegate (Underlying native function: ClearDamageDoneOverrideDelegate 0x83175e8)
