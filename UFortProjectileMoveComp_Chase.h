...
class UFortProjectileMoveComp_Chase : public UFortProjectileMovementComponent
{
	...
	// Function /Script/FortniteGame.FortProjectileMoveComp_Chase.SetChaseTarget (Underlying native function: SetChaseTarget 0x8496fcc)
	...
	// Function /Script/FortniteGame.FortProjectileMoveComp_Chase.MulticastAddExternalForce (Underlying native function: MulticastAddExternalForce 0x8495c08)
	...
	// Function /Script/FortniteGame.FortProjectileMoveComp_Chase.ClearExternalForces (Underlying native function: ClearExternalForces 0x8495204)
	void ClearExternalForces(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileMoveComp_Chase.ClearChaseTarget (Underlying native function: ClearChaseTarget 0x84951ec)
	void ClearChaseTarget(); // (Net | NetReliable | Native | Event | NetMulticast | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortProjectileMoveComp_Chase.AddExternalForce (Underlying native function: AddExternalForce 0x8494fd8)
