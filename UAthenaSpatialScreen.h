...
class UAthenaSpatialScreen : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpatialScreen.OnInputSuspensionChanged (Underlying native function: OnInputSuspensionChanged 0x182d3cc)
	void OnInputSuspensionChanged(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteUI.AthenaSpatialScreen.FireSpatialScreenAnalytic (Underlying native function: FireSpatialScreenAnalytic 0xa69831c)
	void FireSpatialScreenAnalytic(struct FString& Interaction); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaSpatialScreen.AddSpatialScreenSessionCounter (Underlying native function: AddSpatialScreenSessionCounter 0xa698080)
