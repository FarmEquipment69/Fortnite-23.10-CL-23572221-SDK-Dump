...
class UAbilityTask_ApplyRootMotionJumpForce : public UAbilityTask_ApplyRootMotion_Base
{
	...
	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionJumpForce.OnLandedCallback (Underlying native function: OnLandedCallback 0x66b814c)
	void OnLandedCallback(struct FHitResult& Hit); // (Final | Native | Public | HasOutParms)

	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionJumpForce.Finish (Underlying native function: Finish 0x66b65ac)
	void Finish(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionJumpForce.ApplyRootMotionJumpForce (Underlying native function: ApplyRootMotionJumpForce 0x66b4064)
