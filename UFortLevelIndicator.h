...
class UFortLevelIndicator : public UWidget
{
	...
	// Function /Script/FortniteUI.FortLevelIndicator.SetShouldShowMaximumLevel (Underlying native function: SetShouldShowMaximumLevel 0xa70b480)
	void SetShouldShowMaximumLevel(bool& InShouldShowMaximumLevel); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortLevelIndicator.SetItemToRepresent (Underlying native function: SetItemToRepresent 0xa70ab44)
	void SetItemToRepresent(class UFortItem*& ItemToRepresent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortLevelIndicator.SetItemForComparison (Underlying native function: SetItemForComparison 0xa709e74)
	void SetItemForComparison(class UFortItem*& ItemForComparison); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortLevelIndicator.HandleItemToRepresentChanged (Underlying native function: HandleItemToRepresentChanged 0xa708d7c)
	void HandleItemToRepresentChanged(bool& bItemChanged, bool& bAmmoChanged, bool& bIngredientsChanged); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortLevelIndicator.HandleItemForComparisonChanged (Underlying native function: HandleItemForComparisonChanged 0xa708d7c)
