...
class UAudioMeter : public UWidget
{
	...
	// Function /Script/AudioWidgets.AudioMeter.SetMeterValueColor (Underlying native function: SetMeterValueColor 0x76f050c)
	void SetMeterValueColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetMeterScaleLabelColor (Underlying native function: SetMeterScaleLabelColor 0x76f0470)
	void SetMeterScaleLabelColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetMeterScaleColor (Underlying native function: SetMeterScaleColor 0x76f03d4)
	void SetMeterScaleColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetMeterPeakColor (Underlying native function: SetMeterPeakColor 0x76f0338)
	void SetMeterPeakColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetMeterClippingColor (Underlying native function: SetMeterClippingColor 0x76f029c)
	void SetMeterClippingColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetMeterChannelInfo (Underlying native function: SetMeterChannelInfo 0x76f0200)
	...
	// Function /Script/AudioWidgets.AudioMeter.SetMeterBackgroundColor (Underlying native function: SetMeterBackgroundColor 0x76f0164)
	void SetMeterBackgroundColor(struct FLinearColor& InValue); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/AudioWidgets.AudioMeter.SetBackgroundColor (Underlying native function: SetBackgroundColor 0x76effa0)
	...
	// Function /Script/AudioWidgets.AudioMeter.GetMeterChannelInfo (Underlying native function: GetMeterChannelInfo 0x76efd1c)
