...
class UBacchusPluginContentWidget : public UBacchusHUDElement
{
	...
	// Function /Script/FortniteUI.BacchusPluginContentWidget.OnPluginHUDWidgetRemoved (Underlying native function: OnPluginHUDWidgetRemoved 0xa45d09c)
	void OnPluginHUDWidgetRemoved(struct FGameplayTag& WidgetTag); // (Final | Native | Private)

	// Function /Script/FortniteUI.BacchusPluginContentWidget.OnPluginHUDWidgetAdded (Underlying native function: OnPluginHUDWidgetAdded 0xa45cfa0)
