...
class UFortQuestCategory : public UObject
{
	...
	// Function /Script/FortniteGame.FortQuestCategory.HasUnseenQuests (Underlying native function: HasUnseenQuests 0x8c29714)
	bool HasUnseenQuests(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortQuestCategory.GetUnseenQuestCount (Underlying native function: GetUnseenQuestCount 0x8c2878c)
