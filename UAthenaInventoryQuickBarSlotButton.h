...
class UAthenaInventoryQuickBarSlotButton : public UAthenaQuickBarSlotButtonBase
{
	...
	// Function /Script/FortniteUI.AthenaInventoryQuickBarSlotButton.HandleInventorySwapStarted (Underlying native function: HandleInventorySwapStarted 0xa3cc87c)
	void HandleInventorySwapStarted(int& SwapSlotIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaInventoryQuickBarSlotButton.HandleInventorySwapComplete (Underlying native function: HandleInventorySwapComplete 0xa3cc834)
