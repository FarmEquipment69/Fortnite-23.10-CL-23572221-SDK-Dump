...
class UFortCoreGamerObjectiveRadial : public UUserWidget
{
	...
	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.UpdateCaptureState (Underlying native function: UpdateCaptureState 0xa2a486c)
	...
	void OnObjectiveOwningTeamChanged(unsigned char& NewTeam, unsigned char& OldTeam); // (Event | Public | BlueprintCallable | BlueprintEvent)
	...
	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.HandleTrackedObjectiveUpdated (Underlying native function: HandleTrackedObjectiveUpdated 0xa2a4584)
	void HandleTrackedObjectiveUpdated(int& InTrackedIndex); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.HandleTrackedObjectiveTeamUpdated (Underlying native function: HandleTrackedObjectiveTeamUpdated 0xa2a4504)
	void HandleTrackedObjectiveTeamUpdated(int& InTrackedIndex); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.GetObjectiveTracker (Underlying native function: GetObjectiveTracker 0xa2a3b08)
	...
	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.GetNormalizedDistanceFromScreenCenter (Underlying native function: GetNormalizedDistanceFromScreenCenter 0xa2a3ae0)
	float GetNormalizedDistanceFromScreenCenter(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCoreGamerObjectiveRadial.GetMinigame (Underlying native function: GetMinigame 0xa2a3ab0)
