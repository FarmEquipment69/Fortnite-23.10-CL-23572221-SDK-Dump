...
class UFortGameStateComponent_EventLevel : public UFortGameStateComponent_DynamicStreamingLevel
{
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.TryToClaimRewardGraphNode (Underlying native function: TryToClaimRewardGraphNode 0x8182144)
	void TryToClaimRewardGraphNode(struct FGameplayTag& NodeTag); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.StartRestedXpTimer (Underlying native function: StartRestedXpTimer 0x8182034)
	void StartRestedXpTimer(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.SetActiveCamera (Underlying native function: SetActiveCamera 0x8181904)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.RegisterNavigationActor (Underlying native function: RegisterNavigationActor 0x818127c)
	bool RegisterNavigationActor(class AFortEventLevelNavigationActor*& InActor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.RegisterHiddenActor (Underlying native function: RegisterHiddenActor 0x81811b8)
	void RegisterHiddenActor(class AActor*& InActor, struct FGameplayTag& EventGraphNode); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.RegisterCamera (Underlying native function: RegisterCamera 0x8181128)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.NotifyRestedXpGenAmount (Underlying native function: NotifyRestedXpGenAmount 0x8180910)
	void NotifyRestedXpGenAmount(int& RestedXp); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.LinkNavActorToCamera (Underlying native function: LinkNavActorToCamera 0x8180750)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.HoverActorUnderCursor (Underlying native function: HoverActorUnderCursor 0x58eb160)
	void HoverActorUnderCursor(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.HandlePreOpenPackageComplete (Underlying native function: HandlePreOpenPackageComplete 0x8180658)
	void HandlePreOpenPackageComplete(); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.HandleOnCameraCut (Underlying native function: HandleOnCameraCut 0x8180524)
	void HandleOnCameraCut(class UCameraComponent*& CameraComponent); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.HandleOnCameraBlendComplete (Underlying native function: HandleOnCameraBlendComplete 0x8180510)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.HandleNavigationActorUnhover (Underlying native function: HandleNavigationActorUnhover 0x58eb0c0)
	void HandleNavigationActorUnhover(class AFortEventLevelNavigationActor*& InActor); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.GoToCamera (Underlying native function: GoToCamera 0x8180404)
	void GoToCamera(struct FGameplayTag& CameraToViewFrom); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.GetRoomOwner (Underlying native function: GetRoomOwner 0x817fb74)
	class AFortPlayerController* GetRoomOwner(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.GetRandomNavIndicatorTextFromList (Underlying native function: GetRandomNavIndicatorTextFromList 0x817fa8c)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.GetLastNavObject (Underlying native function: GetLastNavObject 0x817f6cc)
	...
	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.GetActiveCameraTag (Underlying native function: GetActiveCameraTag 0x58eb0a0)
	struct FGameplayTag GetActiveCameraTag(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.EndRestXpTimer (Underlying native function: EndRestXpTimer 0x817f204)
	void EndRestXpTimer(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameStateComponent_EventLevel.CanGainRestedXp (Underlying native function: CanGainRestedXp 0x817ec08)
