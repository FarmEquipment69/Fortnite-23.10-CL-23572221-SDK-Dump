...
class UBattleLabRewardWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.BattleLabRewardWidget.OnWidgetIsFinished (Underlying native function: OnWidgetIsFinished 0xa3fc74c)
	void OnWidgetIsFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.BattleLabRewardWidget.HandleOnQuestsGranted (Underlying native function: HandleOnQuestsGranted 0xa3fa628)
	void HandleOnQuestsGranted(struct TArray<class UFortQuestItem*>& Quests); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.BattleLabRewardWidget.HandleOnQuestCompleted (Underlying native function: HandleOnQuestCompleted 0xa3fa58c)
	void HandleOnQuestCompleted(struct TArray<class UFortQuestItem*>& Quests); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.BattleLabRewardWidget.HandleDisplayDynamicQuestUpdate (Underlying native function: HandleDisplayDynamicQuestUpdate 0xa3f9e1c)
