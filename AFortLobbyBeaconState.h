...
class AFortLobbyBeaconState : public ALobbyBeaconState
{
	...
	// Function /Script/FortniteGame.FortLobbyBeaconState.OnRep_MissionGeneratorDetailsRequirement (Underlying native function: OnRep_MissionGeneratorDetailsRequirement 0x89ab6ac)
	void OnRepMissionGeneratorDetailsRequirement(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortLobbyBeaconState.OnRep_MissionGeneratorClassPath (Underlying native function: OnRep_MissionGeneratorClassPath 0x89ab63c)
