...
class UAbilityAsync_WaitGameplayEvent : public UAbilityAsync
{
	...
	// Function /Script/GameplayAbilities.AbilityAsync_WaitGameplayEvent.WaitGameplayEventToActor (Underlying native function: WaitGameplayEventToActor 0x16dd7d4)
