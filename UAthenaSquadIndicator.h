...
class UAthenaSquadIndicator : public UAthenaMarkedActorIndicator
{
	...
	// Function /Script/FortniteUI.AthenaSquadIndicator.DangerTestStart (Underlying native function: DangerTestStart 0xa30fd50)
	void DangerTestStart(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaSquadIndicator.DangerTestFinish (Underlying native function: DangerTestFinish 0xa30fd3c)
