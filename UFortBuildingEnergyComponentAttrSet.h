...
class UFortBuildingEnergyComponentAttrSet : public UFortAttributeSet
{
	...
	// Function /Script/FortniteGame.FortBuildingEnergyComponentAttrSet.OnRep_EnergyCost (Underlying native function: OnRep_EnergyCost 0x83acb84)
	void OnRepEnergyCost(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortBuildingEnergyComponentAttrSet.OnRep_EnergyCapacity (Underlying native function: OnRep_EnergyCapacity 0x83acab8)
	void OnRepEnergyCapacity(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortBuildingEnergyComponentAttrSet.OnRep_CurrentEnergyLevel (Underlying native function: OnRep_CurrentEnergyLevel 0x83ac960)
