...
class UFortAudioAnalysisSubsystem : public UWorldSubsystem
{
	...
	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.UnRegisterSubmix (Underlying native function: UnRegisterSubmix 0x8c435b8)
	void UnRegisterSubmix(class USoundSubmix*& InSubmix); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.UnRegisterDefaultSubmix (Underlying native function: UnRegisterDefaultSubmix 0x8c435a4)
	void UnRegisterDefaultSubmix(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.RegisterSubmix (Underlying native function: RegisterSubmix 0x8c42238)
	...
	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.RegisterDefaultSubmix (Underlying native function: RegisterDefaultSubmix 0x2e7c4cc)
	void RegisterDefaultSubmix(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.IsAnalysisActive (Underlying native function: IsAnalysisActive 0x8c41dc8)
	bool IsAnalysisActive(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.GetAnalyzerForSubmix (Underlying native function: GetAnalyzerForSubmix 0x8c403bc)
	class UAudioAnalysisSubmixAnalyzer* GetAnalyzerForSubmix(class USoundSubmix*& InSubmix); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAudioAnalysisSubsystem.GetAnalysisSettings (Underlying native function: GetAnalysisSettings 0x8c403a4)
