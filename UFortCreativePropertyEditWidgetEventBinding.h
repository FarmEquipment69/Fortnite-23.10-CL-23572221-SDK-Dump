...
class UFortCreativePropertyEditWidgetEventBinding : public UCreativePropertyEditWidgetUserOptionBase
{
	...
	// Function /Script/FortniteUI.FortCreativePropertyEditWidgetEventBinding.IsShowingBindings (Underlying native function: IsShowingBindings 0xa5359ac)
	bool IsShowingBindings(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortCreativePropertyEditWidgetEventBinding.GetEventReferenceType (Underlying native function: GetEventReferenceType 0xa534034)
