...
class AFortInGameMapManagerCreative : public AFortInGameMapManagerAthena
{
	...
	// Function /Script/FortniteGame.FortInGameMapManagerCreative.SetCurrentVolume (Underlying native function: SetCurrentVolume 0x80d0014)
	void SetCurrentVolume(class AFortVolume*& InVolume); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManagerCreative.OnVolumeObjectTrackingComponentChanged (Underlying native function: OnVolumeObjectTrackingComponentChanged 0x80cfd98)
	...
	// Function /Script/FortniteGame.FortInGameMapManagerCreative.OnPlayModeChanged (Underlying native function: OnPlayModeChanged 0x80cfb70)
