...
class UFortMinigameProgressComponent : public UFortMinigameLogicComponent
{
	...
	// Function /Script/FortniteGame.FortMinigameProgressComponent.StartProgress (Underlying native function: StartProgress 0x88cb298)
	void StartProgress(class APlayerState*& PlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMinigameProgressComponent.RevertProgress (Underlying native function: RevertProgress 0x88c89a8)
	void RevertProgress(class APlayerState*& PlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMinigameProgressComponent.HasActivationTime (Underlying native function: HasActivationTime 0x88c5e80)
	bool HasActivationTime(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMinigameProgressComponent.FinishProgress (Underlying native function: FinishProgress 0x88c2fac)
	void FinishProgress(class APlayerState*& PlayerState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMinigameProgressComponent.AbortProgress (Underlying native function: AbortProgress 0x88c07ec)
