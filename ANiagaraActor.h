...
class ANiagaraActor : public AActor
{
	...
	// Function /Script/Niagara.NiagaraActor.SetDestroyOnSystemFinish (Underlying native function: SetDestroyOnSystemFinish 0x67c7d78)
	void SetDestroyOnSystemFinish(bool& bShouldDestroyOnSystemFinish); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Niagara.NiagaraActor.OnNiagaraSystemFinished (Underlying native function: OnNiagaraSystemFinished 0x2bf5a60)
