...
class UAthenaChallengeListEntry_DetailedChallenge : public UAthenaChallengeListEntry_Challenge
{
	...
	// Function /Script/FortniteUI.AthenaChallengeListEntry_DetailedChallenge.HandleUpperAreaClicked (Underlying native function: HandleUpperAreaClicked 0xa3477e8)
	void HandleUpperAreaClicked(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaChallengeListEntry_DetailedChallenge.HandleCloseChallengeOptionsInputAction (Underlying native function: HandleCloseChallengeOptionsInputAction 0xa34628c)
