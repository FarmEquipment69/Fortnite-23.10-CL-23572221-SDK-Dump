...
class UFortCreativePlayerInfoIndicator : public UFortActorIndicatorWidget
{
	...
	// Function /Script/FortniteUI.FortCreativePlayerInfoIndicator.HandlePlayerExitedVolume (Underlying native function: HandlePlayerExitedVolume 0xa5352ec)
	void HandlePlayerExitedVolume(class APlayerState*& Client, class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativePlayerInfoIndicator.HandlePlayerEnteredVolume (Underlying native function: HandlePlayerEnteredVolume 0xa535228)
	void HandlePlayerEnteredVolume(class APlayerState*& Client, class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativePlayerInfoIndicator.HandleMinigameStateChanged (Underlying native function: HandleMinigameStateChanged 0xa534a94)
	void HandleMinigameStateChanged(class AFortMinigame*& Minigame, enum EFortMinigameState& MinigameState); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativePlayerInfoIndicator.HandleIndicatorRulesChanged (Underlying native function: HandleIndicatorRulesChanged 0xa534a18)
	void HandleIndicatorRulesChanged(enum EPlayerIndicatorDisplayMode& DisplayMode); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativePlayerInfoIndicator.HandleHitPointsChanged (Underlying native function: HandleHitPointsChanged 0xa53473c)
