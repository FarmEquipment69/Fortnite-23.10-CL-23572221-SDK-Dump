...
class AFortAscenderZipline : public AFortAthenaSplineZipline
{
	...
	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.SetupAscender (Underlying native function: SetupAscender 0x52ac9b0)
	void SetupAscender(bool& bFromConstruction, bool& bFromReplication); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.OnRep_TargetSplineEndLocation (Underlying native function: OnRep_TargetSplineEndLocation 0x6eb6e64)
	void OnRepTargetSplineEndLocation(); // (Final | Native | Protected)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.OnRep_PawnUsingHandle (Underlying native function: OnRep_PawnUsingHandle 0x6eb6e50)
	void OnRepPawnUsingHandle(); // (Final | Native | Protected)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.OnRep_InitialSplineEndLocation (Underlying native function: OnRep_InitialSplineEndLocation 0x6eb6de4)
	void OnRepInitialSplineEndLocation(); // (Final | Native | Protected)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.HandlePawnUsingHandleDied (Underlying native function: HandlePawnUsingHandleDied 0x6eb6d64)
	void HandlePawnUsingHandleDied(class AFortPawn*& DeadPawn); // (Final | Native | Protected)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.HandleFloorActorHealthChanged (Underlying native function: HandleFloorActorHealthChanged 0x6eb6d50)
	void HandleFloorActorHealthChanged(); // (Final | Native | Protected)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.HandleFloorActorDestroyed (Underlying native function: HandleFloorActorDestroyed 0x6eb6cd0)
	...
	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.GetPawnUsingHandle (Underlying native function: GetPawnUsingHandle 0x6eb6c64)
	class AFortPlayerPawn* GetPawnUsingHandle(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AscenderCodeRuntime.FortAscenderZipline.GetInteractComponentOverride (Underlying native function: GetInteractComponentOverride 0x6eb6b98)
