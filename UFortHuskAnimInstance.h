...
class UFortHuskAnimInstance : public UFortAIAnimInstance
{
	...
	// Function /Script/FortniteGame.FortHuskAnimInstance.SetHuskAnimType (Underlying native function: SetHuskAnimType 0x7f76bd8)
	void SetHuskAnimType(enum EFortHuskAnimType& NewHuskAnimType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHuskAnimInstance.GetHuskAnimType (Underlying native function: GetHuskAnimType 0x7f760e4)
