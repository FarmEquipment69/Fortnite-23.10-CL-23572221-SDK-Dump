...
class UFortHomebaseUIContext : public UBlueprintContextBase
{
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.SetShouldAutoSlotSurvivorSquads (Underlying native function: SetShouldAutoSlotSurvivorSquads 0xa7f5e98)
	void SetShouldAutoSlotSurvivorSquads(bool& Value); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHomebaseUIContext.SetCurrentlyViewedHeroLoadout (Underlying native function: SetCurrentlyViewedHeroLoadout 0xa7f4fc8)
	void SetCurrentlyViewedHeroLoadout(class UFortCampaignHeroLoadoutItem*& Loadout); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortHomebaseUIContext.SetCurrentlyFocusedHeroLoadoutSlotName (Underlying native function: SetCurrentlyFocusedHeroLoadoutSlotName 0xa7f4f20)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.IsHeroLoadoutSlotUnlocked (Underlying native function: IsHeroLoadoutSlotUnlocked 0xa7f1f90)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.IsAnySquadSlotUnlocked (Underlying native function: IsAnySquadSlotUnlocked 0xa7f1d6c)
	bool IsAnySquadSlotUnlocked(struct FName& SquadId); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.HandleDifferentHeroLoadoutActivated (Underlying native function: HandleDifferentHeroLoadoutActivated 0xa7f0ad4)
	void HandleDifferentHeroLoadoutActivated(class UFortMcpProfileCampaign*& Profile); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHomebaseUIContext.GetWorkerSetBonusEffectModifiers (Underlying native function: GetWorkerSetBonusEffectModifiers 0xa7f0450)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetUnlockingQuestDefinitionForSquadSlot (Underlying native function: GetUnlockingQuestDefinitionForSquadSlot 0xa7f0384)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetUnlockingQuestDefinitionForHeroLoadoutSlot (Underlying native function: GetUnlockingQuestDefinitionForHeroLoadoutSlot 0xa7f0214)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetUnlockedGadgets (Underlying native function: GetUnlockedGadgets 0xa7f0168)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetSquadIcon (Underlying native function: GetSquadIcon 0xa7eff20)
	struct FFortMultiSizeBrush GetSquadIcon(struct FName& SquadId); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.GetSlottedPrimaryHero (Underlying native function: GetSlottedPrimaryHero 0xa7efe4c)
	class UFortHero* GetSlottedPrimaryHero(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.GetShouldAutoSlotSurvivorSquads (Underlying native function: GetShouldAutoSlotSurvivorSquads 0xa7efe28)
	bool GetShouldAutoSlotSurvivorSquads(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.GetItemsInSquad (Underlying native function: GetItemsInSquad 0xa7ee790)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetItemInSquadSlot (Underlying native function: GetItemInSquadSlot 0xa7ee348)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetCurrentlyViewedHeroLoadout (Underlying native function: GetCurrentlyViewedHeroLoadout 0xa7ece4c)
	...
	// Function /Script/FortniteUI.FortHomebaseUIContext.GetCurrentlyFocusedHeroLoadoutSlotName (Underlying native function: GetCurrentlyFocusedHeroLoadoutSlotName 0xa017bc0)
	struct FName GetCurrentlyFocusedHeroLoadoutSlotName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.GetCollectionBookData (Underlying native function: GetCollectionBookData 0xa7ecb20)
	class UFortCollectionBookData* GetCollectionBookData(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortHomebaseUIContext.AutoSlotAllSurvivorSquads (Underlying native function: AutoSlotAllSurvivorSquads 0xa7ebf00)
