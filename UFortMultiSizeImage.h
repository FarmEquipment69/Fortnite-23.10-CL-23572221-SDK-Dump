...
class UFortMultiSizeImage : public UWidget
{
	...
	// Function /Script/FortniteUI.FortMultiSizeImage.SetMultiSizeBrush (Underlying native function: SetMultiSizeBrush 0xa4b3a98)
	void SetMultiSizeBrush(struct FFortMultiSizeBrush& MultiSizeBrush); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortMultiSizeImage.SetColorAndOpacity (Underlying native function: SetColorAndOpacity 0xa4b331c)
	void SetColorAndOpacity(struct FLinearColor& Color); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteUI.FortMultiSizeImage.SetBrushSize (Underlying native function: SetBrushSize 0xa4b3290)
