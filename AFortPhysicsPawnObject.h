...
class AFortPhysicsPawnObject : public AFortPhysicsPawn
{
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.WakeUpOnGroundDied (Underlying native function: WakeUpOnGroundDied 0x8041ab4)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.WakeUp (Underlying native function: WakeUp 0x1854b58)
	void WakeUp(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.UpdateClientWithPhysicsObjectTestInput (Underlying native function: UpdateClientWithPhysicsObjectTestInput 0x82ab660)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.TurnOffClientPrediction (Underlying native function: TurnOffClientPrediction 0x82ab574)
	void TurnOffClientPrediction(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.SpawnPhysicsPawnObject (Underlying native function: SpawnPhysicsPawnObject 0x82ab37c)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.SetPropDestructionParams (Underlying native function: SetPropDestructionParams 0x82ab02c)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.SetImpulseResponseZBias (Underlying native function: SetImpulseResponseZBias 0x82aaf94)
	void SetImpulseResponseZBias(float& ZBias); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.SetImpulseResponseMultiplier (Underlying native function: SetImpulseResponseMultiplier 0x82aaefc)
	void SetImpulseResponseMultiplier(float& Multiplier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.SetHealthPercent (Underlying native function: SetHealthPercent 0x82aae78)
	void SetHealthPercent(float& Percent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.SetDyingPhysics (Underlying native function: SetDyingPhysics 0x23a6530)
	void SetDyingPhysics(); // (Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.ServerBroadcastHitFromClient (Underlying native function: ServerBroadcastHitFromClient 0x82aa968)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.ServerBroadcastHit (Underlying native function: ServerBroadcastHit 0x82aa838)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.SendClientStateToServer_Helper (Underlying native function: SendClientStateToServer_Helper 0x82aa824)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_SurfaceTypePhysicsObjectOn (Underlying native function: OnRep_SurfaceTypePhysicsObjectOn 0x82aa5d0)
	void OnRepSurfaceTypePhysicsObjectOn(struct TEnumAsByte<EPhysicalSurface>& PreviousSurfaceOn); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_PendingDeath (Underlying native function: OnRep_PendingDeath 0x82aa51c)
	void OnRepPendingDeath(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_LastServerConfirmedHit (Underlying native function: OnRep_LastServerConfirmedHit 0x82aa4f4)
	void OnRepLastServerConfirmedHit(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_InitialParameters (Underlying native function: OnRep_InitialParameters 0x82aa4cc)
	void OnRepInitialParameters(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_HealthSet (Underlying native function: OnRep_HealthSet 0x273fd14)
	void OnRepHealthSet(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_CurrentServerPhysicsState (Underlying native function: OnRep_CurrentServerPhysicsState 0x82aa454)
	void OnRepCurrentServerPhysicsState(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_CorrectTargetOrientation (Underlying native function: OnRep_CorrectTargetOrientation 0x82aa43c)
	void OnRepCorrectTargetOrientation(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnRep_AbilitySystemComponent (Underlying native function: OnRep_AbilitySystemComponent 0x273fd14)
	void OnRepAbilitySystemComponent(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.OnPxComponentWake (Underlying native function: OnPxComponentWake 0x82aa360)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.ModifyIncomingDamage (Underlying native function: ModifyIncomingDamage 0x82a9ff0)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.IsScrapingSidesOrTop (Underlying native function: IsScrapingSidesOrTop 0x82a9fc8)
	bool IsScrapingSidesOrTop(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.IsInWater (Underlying native function: IsInWater 0x82a9fb0)
	bool IsInWater(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.IsInAir (Underlying native function: IsInAir 0x82a9f88)
	bool IsInAir(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.IsCorrectingOrientation (Underlying native function: IsCorrectingOrientation 0x82a9f60)
	bool IsCorrectingOrientation(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.IsAsleep (Underlying native function: IsAsleep 0x82a9f48)
	bool IsAsleep(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.HasPermissionToAlterBuildings (Underlying native function: HasPermissionToAlterBuildings 0x2830cb8)
	bool HasPermissionToAlterBuildings(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetPreviousLinearVelocity (Underlying native function: GetPreviousLinearVelocity 0x82a92a4)
	struct FVector GetPreviousLinearVelocity(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetPreviousLinearAcceleration (Underlying native function: GetPreviousLinearAcceleration 0x82a927c)
	struct FVector GetPreviousLinearAcceleration(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetPreviousForwardSpeedKmh (Underlying native function: GetPreviousForwardSpeedKmh 0x82a9250)
	float GetPreviousForwardSpeedKmh(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetPhysicsObjectVelocity (Underlying native function: GetPhysicsObjectVelocity 0x82a913c)
	struct FVector GetPhysicsObjectVelocity(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetMaxHealth (Underlying native function: GetMaxHealth 0x82a908c)
	float GetMaxHealth(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetHealth (Underlying native function: GetHealth 0x82a906c)
	float GetHealth(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetForwardSpeedKmh (Underlying native function: GetForwardSpeedKmh 0x82a9040)
	float GetForwardSpeedKmh(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GetDisplayName (Underlying native function: GetDisplayName 0x82a8fc8)
	struct FString GetDisplayName(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.GameplayCue_Damage (Underlying native function: GameplayCue_Damage 0x82a8d94)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.DrawServerAndClientBallPosition (Underlying native function: DrawServerAndClientBallPosition 0x82a8cc4)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.DestroyPhysicsObject (Underlying native function: DestroyPhysicsObject 0x82a8cb0)
	void DestroyPhysicsObject(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.DebugDrawImpactBucket (Underlying native function: DebugDrawImpactBucket 0x82a8b84)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.CanTeleport (Underlying native function: CanTeleport 0x82a8b08)
	bool CanTeleport(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.CanCorrectOrientation (Underlying native function: CanCorrectOrientation 0x82a8a74)
	bool CanCorrectOrientation(class AFortPawn*& FP); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPhysicsPawnObject.ApplyPredictedImpulseFromPawnHitClient (Underlying native function: ApplyPredictedImpulseFromPawnHitClient 0x82a8950)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.ApplyImpulseFromPawnHit (Underlying native function: ApplyImpulseFromPawnHit 0x82a882c)
	...
	// Function /Script/FortniteGame.FortPhysicsPawnObject.ApplyImpulse (Underlying native function: ApplyImpulse 0x82a872c)
