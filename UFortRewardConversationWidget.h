...
class UFortRewardConversationWidget : public UFortRewardNotificationSubWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortRewardConversationWidget.IsValidConversation (Underlying native function: IsValidConversation 0x7245a54)
	bool IsValidConversation(class UFortConversation*& Conversation); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortRewardConversationWidget.GetDataFromSentence (Underlying native function: GetDataFromSentence 0x72435f4)
