...
class AFortAthenaMutator_LoadGameFeature : public AFortAthenaMutator
{
	...
	// Function /Script/SpecialEventGameplayRuntime.FortAthenaMutator_LoadGameFeature.OnPlaylistDataReady (Underlying native function: OnPlaylistDataReady 0x735eb94)
