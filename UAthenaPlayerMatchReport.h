...
class UAthenaPlayerMatchReport : public UObject
{
	...
	// Function /Script/FortniteGame.AthenaPlayerMatchReport.GetXpRewards (Underlying native function: GetXpRewards 0x7f96a5c)
	void GetXpRewards(struct TArray<struct FAthenaMatchXpReward>& XpRewards); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.AthenaPlayerMatchReport.GetTotalSeasonalXpEarned (Underlying native function: GetTotalSeasonalXpEarned 0x7f96a34)
	int GetTotalSeasonalXpEarned(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaPlayerMatchReport.GetTotalScoreEarned (Underlying native function: GetTotalScoreEarned 0x7f969f0)
	int GetTotalScoreEarned(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaPlayerMatchReport.GetTotalBookXpEarned (Underlying native function: GetTotalBookXpEarned 0x7f969c8)
	int GetTotalBookXpEarned(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaPlayerMatchReport.GetLootRewards (Underlying native function: GetLootRewards 0x7f96864)
