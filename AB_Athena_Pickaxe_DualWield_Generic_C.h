...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x1548 (0x8)
	bool Equipped; // 0x1550 (0x1)
	unsigned char unreflected_1551[0x7]; // 0x1551 (0x7) 
	class UParticleSystemComponent* AlterationAmbientPS; // 0x1558 (0x8)
	class UParticleSystem* MeleeHeavyParticleSystem; // 0x1560 (0x8)
	class UParticleSystemComponent* MeleeHeavyPSC; // 0x1568 (0x8)
	bool UseDestroyEffect; // 0x1570 (0x1)
	unsigned char unreflected_1571[0x7]; // 0x1571 (0x7) 
	class UParticleSystem* WeaponDurabilityDestroyEffect; // 0x1578 (0x8)
	class UParticleSystem* WeaponDurabilityDestroyEffectIcon; // 0x1580 (0x8)
	class UParticleSystemComponent* OffhandAlterationAmbientPS; // 0x1588 (0x8)
	bool bEquipPendingInstigator; // 0x1590 (0x1)
	unsigned char unreflected_1591[0x3]; // 0x1591 (0x3) 
	struct FName OffhandSocketName; // 0x1594 (0x4)
	class UAnimMontage* MontageReference; // 0x1598 (0x8)
	bool UseTimeofDayControl; // 0x15a0 (0x1)
	unsigned char unreflected_15a1[0x7]; // 0x15a1 (0x7) 
	class UFXSystemComponent* ImpactFX; // 0x15a8 (0x8)
	bool SwingRight; // 0x15b0 (0x1)
	unsigned char unreflected_15b1[0x7]; // 0x15b1 (0x7) 
	struct FRotator LeftSwingRotation; // 0x15b8 (0x18)
	struct FRotator RightSwingRotation; // 0x15d0 (0x18)
	bool SwingRight; // 0x15e8 (0x1)
