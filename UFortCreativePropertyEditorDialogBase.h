...
class UFortCreativePropertyEditorDialogBase : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativePropertyEditorDialogBase.Reset (Underlying native function: Reset 0x182d3cc)
	void Reset(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePropertyEditorDialogBase.Open (Underlying native function: Open 0xa535f48)
	...
	// Function /Script/FortniteUI.FortCreativePropertyEditorDialogBase.Close (Underlying native function: Close 0xa533a10)
	void Close(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePropertyEditorDialogBase.AddOption (Underlying native function: AddOption 0xa533938)
