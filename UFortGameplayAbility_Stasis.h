...
class UFortGameplayAbility_Stasis : public UFortGameplayAbility
{
	...
	// Function /Script/FortniteGame.FortGameplayAbility_Stasis.RemoveAllowedActionTags (Underlying native function: RemoveAllowedActionTags 0x735fac8)
	...
	// Function /Script/FortniteGame.FortGameplayAbility_Stasis.IsActionAllowed (Underlying native function: IsActionAllowed 0x7e70f54)
	bool IsActionAllowed(struct FGameplayTag& InActionTag); // (Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayAbility_Stasis.AppendAllowedActionTags (Underlying native function: AppendAllowedActionTags 0x735fac8)
