...
class UAthenaCollectionPlayerProgress : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaCollectionPlayerProgress.IsLocalPlayer (Underlying native function: IsLocalPlayer 0xa34783c)
	bool IsLocalPlayer(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaCollectionPlayerProgress.GetNumCollected (Underlying native function: GetNumCollected 0x874395c)
