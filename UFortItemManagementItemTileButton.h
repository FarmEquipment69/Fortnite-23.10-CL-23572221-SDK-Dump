...
class UFortItemManagementItemTileButton : public UFortItemTileButton
{
	...
	// Function /Script/FortniteUI.FortItemManagementItemTileButton.UpdateEquipSlotOverlay (Underlying native function: UpdateEquipSlotOverlay 0xa6c8b54)
	void UpdateEquipSlotOverlay(int& CurrentSlotIndex); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemManagementItemTileButton.PopulateEquipSlotOverlay (Underlying native function: PopulateEquipSlotOverlay 0xa6c763c)
	void PopulateEquipSlotOverlay(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemManagementItemTileButton.OnSlotItemComplete (Underlying native function: OnSlotItemComplete 0xa6c73c0)
	void OnSlotItemComplete(class UFortAccountItem*& SlottedItem, struct FName& SlotId); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortItemManagementItemTileButton.IsValidEquipSlotOverlayIndex (Underlying native function: IsValidEquipSlotOverlayIndex 0xa6c7224)
	...
	// Function /Script/FortniteUI.FortItemManagementItemTileButton.GetPopupMenu (Underlying native function: GetPopupMenu 0x71cf3c4)
	class UUserWidget* GetPopupMenu(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortItemManagementItemTileButton.GetItemManagementMode (Underlying native function: GetItemManagementMode 0xa6c5acc)
	enum EFortItemManagementMode GetItemManagementMode(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortItemManagementItemTileButton.GetHomebaseSquadSlotForItem (Underlying native function: GetHomebaseSquadSlotForItem 0x71cef08)
