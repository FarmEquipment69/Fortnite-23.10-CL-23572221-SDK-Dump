...
class UFortAthenaAISpawnerDataComponent_AIBotGameplay : public UFortAthenaAISpawnerDataComponent_GameplayBase
{
	...
	struct FScalableFloat MimicBehaviorEnabled; // 0x560 (0x28)
	struct FScalableFloat MimicBehaviorRadius; // 0x588 (0x28)
	struct FScalableFloat CanDanceWithConverter; // 0x5b0 (0x28)
	struct FScalableFloat TeleportTowardsConverterDistance; // 0x5d8 (0x28)
	struct FScalableFloat MinDistanceFromConverterWhenTeleported; // 0x600 (0x28)
	struct TArray<class UClass*> ConvertedSkillSetClasses; // 0x628 (0x10)
	unsigned char padding_638[0x8]; // 0x638 (0x8)

	/* Functions */

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetNameSettings (Underlying native function: SetNameSettings 0xa1f7c04)
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashOuterRadius (Underlying native function: SetLeashOuterRadius 0xa1f7ac4)
	void SetLeashOuterRadius(float& InLeashOuterRadius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashLocation (Underlying native function: SetLeashLocation 0xa1f7a3c)
	void SetLeashLocation(struct FVector& InLeashLocation); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashInnerRadius (Underlying native function: SetLeashInnerRadius 0xa1f79b8)
	void SetLeashInnerRadius(float& InLeashInnerRadius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetAssociatedPatrolPath (Underlying native function: SetAssociatedPatrolPath 0xa1f7318)
