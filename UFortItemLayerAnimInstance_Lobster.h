...
class UFortItemLayerAnimInstance_Lobster : public UFortItemLayerAnimInstance
{
	...
	// Function /Script/FortniteGame.FortItemLayerAnimInstance_Lobster.AnimNotify_GuardLoopEntered (Underlying native function: AnimNotify_GuardLoopEntered 0x7f758ec)
	void AnimNotifyGuardLoopEntered(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortItemLayerAnimInstance_Lobster.AnimNotify_DeflectHold2Entered (Underlying native function: AnimNotify_DeflectHold2Entered 0x7f757e0)
	void AnimNotifyDeflectHold2Entered(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortItemLayerAnimInstance_Lobster.AnimNotify_DeflectHold1Entered (Underlying native function: AnimNotify_DeflectHold1Entered 0x7f757cc)
