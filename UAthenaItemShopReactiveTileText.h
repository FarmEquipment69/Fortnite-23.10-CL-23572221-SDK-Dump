...
class UAthenaItemShopReactiveTileText : public UCommonTextBlock
{
	...
	// Function /Script/FortniteUI.AthenaItemShopReactiveTileText.SetMaxCharacterCountBeforeScaling (Underlying native function: SetMaxCharacterCountBeforeScaling 0xa3fc85c)
	void SetMaxCharacterCountBeforeScaling(int& InMaxCharacterCountBeforeScaling); // (Final | Native | Private | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemShopReactiveTileText.GetMaxCharacterCountBeforeScaling (Underlying native function: GetMaxCharacterCountBeforeScaling 0xa3f9314)
