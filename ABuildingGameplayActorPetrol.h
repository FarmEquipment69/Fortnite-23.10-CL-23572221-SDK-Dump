...
class ABuildingGameplayActorPetrol : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.UpdateCurrentSize (Underlying native function: UpdateCurrentSize 0x8358c00)
	void UpdateCurrentSize(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.OnRep_ProjectileCount (Underlying native function: OnRep_ProjectileCount 0x8357994)
	void OnRepProjectileCount(int& PrevProjectileCount); // (Final | Native | Private)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.OnRep_PrevPetrol (Underlying native function: OnRep_PrevPetrol 0x8357918)
	void OnRepPrevPetrol(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.OnRep_Ignited (Underlying native function: OnRep_Ignited 0x83577a8)
	...
	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.IgniteTimerExpired (Underlying native function: IgniteTimerExpired 0x83567a4)
	void IgniteTimerExpired(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.GetTargetSize (Underlying native function: GetTargetSize 0x8356588)
	float GetTargetSize(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.GetProjectileCount (Underlying native function: GetProjectileCount 0x8356404)
	int GetProjectileCount(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingGameplayActorPetrol.GetCurrentSize (Underlying native function: GetCurrentSize 0x83560d0)
