...
class AFortPlayerCharm : public AActor
{
	...
	// Function /Script/FortniteGame.FortPlayerCharm.GetCharmSoundAssetByIndex (Underlying native function: GetCharmSoundAssetByIndex 0x811da78)
	...
	// Function /Script/FortniteGame.FortPlayerCharm.GetCharmSoundAssetByDescName (Underlying native function: GetCharmSoundAssetByDescName 0x811d9a8)
	...
	// Function /Script/FortniteGame.FortPlayerCharm.GetCharmMeshComponent (Underlying native function: GetCharmMeshComponent 0x6d69558)
	class USkeletalMeshComponentBudgeted* GetCharmMeshComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerCharm.GetCharmAttachedToSocket (Underlying native function: GetCharmAttachedToSocket 0x2d7adec)
	struct FName GetCharmAttachedToSocket(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayerCharm.GetCharmAttachedToComponent (Underlying native function: GetCharmAttachedToComponent 0x284f760)
