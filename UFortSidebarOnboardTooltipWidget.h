...
class UFortSidebarOnboardTooltipWidget : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortSidebarOnboardTooltipWidget.NotifyCloseAnimationFinished (Underlying native function: NotifyCloseAnimationFinished 0x303afa0)
