...
class UCaptureComponent : public USceneComponent
{
	...
	// Function /Script/FortniteGame.CaptureComponent.UpdateSmoothProgressStateByCaptureState (Underlying native function: UpdateSmoothProgressStateByCaptureState 0x84fc458)
	void UpdateSmoothProgressStateByCaptureState(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CaptureComponent.UpdateProgressReverseSpeed (Underlying native function: UpdateProgressReverseSpeed 0x84fc390)
	...
	// Function /Script/FortniteGame.CaptureComponent.UpdateCaptureSpeed (Underlying native function: UpdateCaptureSpeed 0x735ad48)
	...
	// Function /Script/FortniteGame.CaptureComponent.SetProgressDecaySpeed (Underlying native function: SetProgressDecaySpeed 0x6df7bc0)
	void SetProgressDecaySpeed(float& NewProgressDecaySpeed); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CaptureComponent.SetNeutralizingTime (Underlying native function: SetNeutralizingTime 0x84fbb98)
	void SetNeutralizingTime(int& NewNeutralizingSpeed); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CaptureComponent.SetCaptureTime (Underlying native function: SetCaptureTime 0x84fb558)
	void SetCaptureTime(float& NewCaptureTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CaptureComponent.SetCaptureState (Underlying native function: SetCaptureState 0x84fb4b4)
	...
	// Function /Script/FortniteGame.CaptureComponent.SetCaptureSpeedBoostEmoting (Underlying native function: SetCaptureSpeedBoostEmoting 0x6df7bc0)
	...
	// Function /Script/FortniteGame.CaptureComponent.SetCaptureSpeedBoost (Underlying native function: SetCaptureSpeedBoost 0x6df7bc0)
	void SetCaptureSpeedBoost(float& NewCaptureSpeedBoost); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CaptureComponent.OnRep_SmoothProgressState (Underlying native function: OnRep_SmoothProgressState 0x84fa95c)
	void OnRepSmoothProgressState(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CaptureComponent.OnRep_OwningTeam (Underlying native function: OnRep_OwningTeam 0x84fa884)
	void OnRepOwningTeam(unsigned char& PreviousOwningTeam); // (Final | Native | Private)

	// Function /Script/FortniteGame.CaptureComponent.OnRep_CaptureState (Underlying native function: OnRep_CaptureState 0x84fa804)
	void OnRepCaptureState(enum ECaptureState& OldCaptureState); // (Final | Native | Private)

	// Function /Script/FortniteGame.CaptureComponent.OnRep_CaptureProgress (Underlying native function: OnRep_CaptureProgress 0x84fa7f0)
	void OnRepCaptureProgress(); // (Final | Native | Private)

	// Function /Script/FortniteGame.CaptureComponent.GetCaptureStateOwner (Underlying native function: GetCaptureStateOwner 0x84f8b88)
	unsigned char GetCaptureStateOwner(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CaptureComponent.GetCaptureState (Underlying native function: GetCaptureState 0x84f8b70)
	enum ECaptureState GetCaptureState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CaptureComponent.ForceCaptureProgress (Underlying native function: ForceCaptureProgress 0x6df7bc0)
