...
class UFortActorOptionsComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.TryToLocalizeStrings (Underlying native function: TryToLocalizeStrings 0x8621a44)
	void TryToLocalizeStrings(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortActorOptionsComponent.SetPropertyOverrideValues (Underlying native function: SetPropertyOverrideValues 0x86217a8)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.SetPropertyOverrides (Underlying native function: SetPropertyOverrides 0x86217a8)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.ResolvePendingRepOverrides (Underlying native function: ResolvePendingRepOverrides 0x8621794)
	void ResolvePendingRepOverrides(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortActorOptionsComponent.RemovePropertyOverrides (Underlying native function: RemovePropertyOverrides 0x86216fc)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.RefreshPropertyOverrides (Underlying native function: RefreshPropertyOverrides 0x86216e8)
	void RefreshPropertyOverrides(); // (Final | 0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortActorOptionsComponent.OnRep_PlayerOptionData (Underlying native function: OnRep_PlayerOptionData 0x86216d4)
	void OnRepPlayerOptionData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortActorOptionsComponent.OnLocalInteract (Underlying native function: OnLocalInteract 0x8621644)
	bool OnLocalInteract(class AFortPlayerPawn*& InteractingPawn); // (Final | BlueprintCosmetic | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortActorOptionsComponent.K2_GetPlayerOptions (Underlying native function: K2_GetPlayerOptions 0x8621614)
	class UPlaylistUserOptions* K2GetPlayerOptions(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorOptionsComponent.K2_GetOptionsDisplayName (Underlying native function: K2_GetOptionsDisplayName 0x8621588)
	struct FText K2GetOptionsDisplayName(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorOptionsComponent.K2_GetOptionsDescription (Underlying native function: K2_GetOptionsDescription 0x86214fc)
	struct FText K2GetOptionsDescription(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorOptionsComponent.K2_GetInteractionText (Underlying native function: K2_GetInteractionText 0x8621470)
	struct FText K2GetInteractionText(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorOptionsComponent.K2_GetInteractionSpeed (Underlying native function: K2_GetInteractionSpeed 0x8621438)
	struct FCurveTableRowHandle K2GetInteractionSpeed(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortActorOptionsComponent.HandlePlaylistLoadedForLocalization (Underlying native function: HandlePlaylistLoadedForLocalization 0x8620dd0)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.GetPropertyOverrides (Underlying native function: GetPropertyOverrides 0x8620940)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.CanEditOptionsComponent (Underlying native function: CanEditOptionsComponent 0x862012c)
	...
	// Function /Script/FortniteGame.FortActorOptionsComponent.BlueprintGetInteractionTime (Underlying native function: BlueprintGetInteractionTime 0x8620050)
