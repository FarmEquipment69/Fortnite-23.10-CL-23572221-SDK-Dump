...
class UFortAthenaLivingWorldEncounterInstance : public UObject
{
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.StartEncounterStage (Underlying native function: StartEncounterStage 0x6e91ea8)
	void StartEncounterStage(int& StageIndex); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.ResumeEncounter (Underlying native function: ResumeEncounter 0x6e918cc)
	void ResumeEncounter(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.Reset (Underlying native function: Reset 0x273fd14)
	void Reset(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.RequestEventGeneration (Underlying native function: RequestEventGeneration 0x6e91734)
	void RequestEventGeneration(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.PauseEncounter (Underlying native function: PauseEncounter 0x6e911a8)
	void PauseEncounter(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.OwnsActor (Underlying native function: OwnsActor 0x6e9113c)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.GetTotalActorCount (Underlying native function: GetTotalActorCount 0x6e8e624)
	int GetTotalActorCount(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldEncounterInstance.AdvanceEncounterStage (Underlying native function: AdvanceEncounterStage 0x6e8dc08)
