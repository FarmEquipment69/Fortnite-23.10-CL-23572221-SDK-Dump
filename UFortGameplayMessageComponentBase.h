...
class UFortGameplayMessageComponentBase : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.SetChannelId (Underlying native function: SetChannelId 0x735fac8)
	...
	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.OnRep_ChannelIds (Underlying native function: OnRep_ChannelIds 0x8574a58)
	void OnRepChannelIds(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.IsEnabled (Underlying native function: IsEnabled 0x8574638)
	bool IsEnabled(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.IsChannelIdSet (Underlying native function: IsChannelIdSet 0x85744b4)
	bool IsChannelIdSet(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.GetMessageName (Underlying native function: GetMessageName 0x8573364)
	struct FText GetMessageName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.GetMessageDescription (Underlying native function: GetMessageDescription 0x85732f0)
	struct FText GetMessageDescription(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.GetMessageChannelIndex (Underlying native function: GetMessageChannelIndex 0x85732ac)
	int GetMessageChannelIndex(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.GetDisabledReason (Underlying native function: GetDisabledReason 0x8572d6c)
	struct FText GetDisabledReason(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayMessageComponentBase.GetChannelId (Underlying native function: GetChannelId 0x85729cc)
