...
class ABuildingGameplayActorSpawnChip : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingGameplayActorSpawnChip.PickUp (Underlying native function: PickUp 0x8357c54)
	...
	// Function /Script/FortniteGame.BuildingGameplayActorSpawnChip.OnRep_RebootCardReplicatedState (Underlying native function: OnRep_RebootCardReplicatedState 0x2e1f610)
	void OnRepRebootCardReplicatedState(); // (Final | Native | Private)

	// Function /Script/FortniteGame.BuildingGameplayActorSpawnChip.OnDestroyPickup (Underlying native function: OnDestroyPickup 0x7fbd6c0)
