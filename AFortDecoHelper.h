...
class AFortDecoHelper : public AActor
{
	...
	// Function /Script/FortniteGame.FortDecoHelper.IsInValidPlacementSpot (Underlying native function: IsInValidPlacementSpot 0x8e42b14)
	bool IsInValidPlacementSpot(bool& bTestingForVisuals); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDecoHelper.GetInFallbackPosition (Underlying native function: GetInFallbackPosition 0x8e41b40)
