...
class UFortMcpProfileAthenaStats : public UFortMcpProfile
{
	...
	// Function /Script/FortniteGame.FortMcpProfileAthenaStats.GetLifetimeStats (Underlying native function: GetLifetimeStats 0x80cee34)
	class UAthenaSeasonStats* GetLifetimeStats(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMcpProfileAthenaStats.GetLifeTimeAndSeasonList (Underlying native function: GetLifeTimeAndSeasonList 0x80cedc0)
