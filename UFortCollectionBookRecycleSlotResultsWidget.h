...
class UFortCollectionBookRecycleSlotResultsWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookRecycleSlotResultsWidget.SetCurrentItemToRecycle (Underlying native function: SetCurrentItemToRecycle 0x71ea8dc)
