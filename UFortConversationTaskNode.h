...
class UFortConversationTaskNode : public UConversationTaskNode
{
	...
	// Function /Script/FortniteGame.FortConversationTaskNode.OnPreviewedChoicePickedByUser (Underlying native function: OnPreviewedChoicePickedByUser 0x84aae00)
	...
	// Function /Script/FortniteGame.FortConversationTaskNode.GetTaskIcon (Underlying native function: GetTaskIcon 0x84aa210)
	struct TWeakObjectPtr<class UObject> GetTaskIcon(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortConversationTaskNode.GetHoverChoiceSound (Underlying native function: GetHoverChoiceSound 0x84a995c)
	struct TWeakObjectPtr<class USoundBase> GetHoverChoiceSound(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortConversationTaskNode.GetDisplayAssetForChoice (Underlying native function: GetDisplayAssetForChoice 0x84a97bc)
	...
	// Function /Script/FortniteGame.FortConversationTaskNode.GetChoiceSound (Underlying native function: GetChoiceSound 0x84a9718)
