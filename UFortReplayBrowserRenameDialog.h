...
class UFortReplayBrowserRenameDialog : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortReplayBrowserRenameDialog.HandleTextCommitted (Underlying native function: HandleTextCommitted 0xa77f8cc)
	void HandleTextCommitted(struct FText& Text, struct TEnumAsByte<ETextCommit>& CommitMethod); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortReplayBrowserRenameDialog.HandleTextChanged (Underlying native function: HandleTextChanged 0xa77f774)
