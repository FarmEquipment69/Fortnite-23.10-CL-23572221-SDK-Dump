...
class AFortSoundCameraLensEffect : public AFortEmitterCameraLensEffectDirectional
{
	...
	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetType (Underlying native function: SetType 0x87637f0)
	void SetType(enum EFortSoundIndicatorTypes& NewType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetTintOverride (Underlying native function: SetTintOverride 0x8763764)
	void SetTintOverride(struct FLinearColor& Color); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetStrengthCurve (Underlying native function: SetStrengthCurve 0x8763624)
	void SetStrengthCurve(struct FRuntimeFloatCurve& Curve); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetInstigatingActor (Underlying native function: SetInstigatingActor 0x8763208)
	void SetInstigatingActor(class AActor*& NewInstigator); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetIconOverride (Underlying native function: SetIconOverride 0x8763188)
	void SetIconOverride(class UTexture*& NewIcon); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSoundCameraLensEffect.SetIcon (Underlying native function: SetIcon 0x8763108)
