...
class UAthenaToyItemDefinition : public UAthenaDanceItemDefinition
{
	...
	// Function /Script/FortniteGame.AthenaToyItemDefinition.GetToyActorClass (Underlying native function: GetToyActorClass 0x84f9740)
	struct TWeakObjectPtr<class UClass> GetToyActorClass(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaToyItemDefinition.BakeLaunchPositions (Underlying native function: BakeLaunchPositions 0x273fd14)
