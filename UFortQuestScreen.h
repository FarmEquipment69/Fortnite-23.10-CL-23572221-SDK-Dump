...
class UFortQuestScreen : public UCommonActivatableWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortQuestScreen.TriggerClaimRewardEvent (Underlying native function: TriggerClaimRewardEvent 0x7247be0)
	void TriggerClaimRewardEvent(class UFortQuestItem*& QuestItem); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestScreen.SetInputActionStates (Underlying native function: SetInputActionStates 0x7246f90)
	...
	// Function /Script/SaveTheWorldUI.FortQuestScreen.SetDisableClaimRewardButton (Underlying native function: SetDisableClaimRewardButton 0x7246910)
	void SetDisableClaimRewardButton(bool& bToDisable); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortQuestScreen.ProcessPendingSeenQuestItems (Underlying native function: ProcessPendingSeenQuestItems 0x72461e8)
