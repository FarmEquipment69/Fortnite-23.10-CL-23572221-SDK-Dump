...
class UFortActivatableMovieWidget_Monolithic : public UFortActivatableVideoPanel
{
	...
	// Function /Script/FortniteUI.FortActivatableMovieWidget_Monolithic.StreamedVideoOnUrlSuccess (Underlying native function: StreamedVideoOnUrlSuccess 0xa735ff0)
	void StreamedVideoOnUrlSuccess(struct FString& URL); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortActivatableMovieWidget_Monolithic.StreamedVideoOnUrlFailure (Underlying native function: StreamedVideoOnUrlFailure 0xa735e90)
	...
	// Function /Script/FortniteUI.FortActivatableMovieWidget_Monolithic.Play (Underlying native function: Play 0xa73345c)
	void Play(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatableMovieWidget_Monolithic.LoadStreamingVideo (Underlying native function: LoadStreamingVideo 0xa7328f0)
	...
	// Function /Script/FortniteUI.FortActivatableMovieWidget_Monolithic.EnableFadeInFromWhite (Underlying native function: EnableFadeInFromWhite 0xa730ebc)
