...
class UFortAsyncAction_TeleportAndWaitForLevelStreaming : public UBlueprintAsyncActionBase
{
	...
	// Function /Script/FortniteGame.FortAsyncAction_TeleportAndWaitForLevelStreaming.OnPawnEndPlay (Underlying native function: OnPawnEndPlay 0x7f979a4)
	void OnPawnEndPlay(class AActor*& Actor, struct TEnumAsByte<EEndPlayReason>& Reason); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAsyncAction_TeleportAndWaitForLevelStreaming.OnLevelStreamingComplete (Underlying native function: OnLevelStreamingComplete 0x7f97990)
	void OnLevelStreamingComplete(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAsyncAction_TeleportAndWaitForLevelStreaming.CreateTeleportAndWaitForLevelStreaming (Underlying native function: CreateTeleportAndWaitForLevelStreaming 0x7f964cc)
