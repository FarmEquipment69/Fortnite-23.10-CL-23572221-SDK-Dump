...
class AFortEmoteVolume : public AVolume
{
	...
	// Function /Script/FortniteGame.FortEmoteVolume.WasPlayerGrantedEmotes (Underlying native function: WasPlayerGrantedEmotes 0x808d7d0)
	...
	// Function /Script/FortniteGame.FortEmoteVolume.IsPlayerOverlapping (Underlying native function: IsPlayerOverlapping 0x808cd6c)
	...
	// Function /Script/FortniteGame.FortEmoteVolume.GetRequiredQuest (Underlying native function: GetRequiredQuest 0x259f780)
	class UFortQuestItemDefinition* GetRequiredQuest(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortEmoteVolume.GetRequiredObjectiveName (Underlying native function: GetRequiredObjectiveName 0x27d4cd4)
	struct FName GetRequiredObjectiveName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortEmoteVolume.GetGrantedEmotes (Underlying native function: GetGrantedEmotes 0x808c7f8)
