...
class UFortRadialMenu : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortRadialMenu.GetNumEntries (Underlying native function: GetNumEntries 0xa77e408)
	int GetNumEntries(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortRadialMenu.GetDegreeOffset (Underlying native function: GetDegreeOffset 0xa77e33c)
	float GetDegreeOffset(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortRadialMenu.GetDegreeIncrements (Underlying native function: GetDegreeIncrements 0x726004c)
	float GetDegreeIncrements(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortRadialMenu.GetAngleForIndex (Underlying native function: GetAngleForIndex 0xa77e29c)
