// ScriptStruct /Script/LauncherSocialTypes.ChatMarkupStyle
// Size: 0x8b0
struct FChatMarkupStyle
{
	struct FButtonStyle MarkupButtonStyle; // 0x0 (0x3b0)
