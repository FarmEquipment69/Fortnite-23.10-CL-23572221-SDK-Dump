...
class UFortActivityCategoryView : public UFortActivityBrowserView
{
	...
	// Function /Script/DiscoveryBrowserUI.FortActivityCategoryView.NavigateFromPanel (Underlying native function: NavigateFromPanel 0x706807c)
	...
	// Function /Script/DiscoveryBrowserUI.FortActivityCategoryView.GetTopMostVisiblePanel (Underlying native function: GetTopMostVisiblePanel 0x7067b38)
	class UFortActivityCategoryTilePanel* GetTopMostVisiblePanel(); // (Native | Event | Protected | BlueprintEvent | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityCategoryView.GetCurrentSelectedPanel (Underlying native function: GetCurrentSelectedPanel 0x7067958)
