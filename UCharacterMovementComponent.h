...
class UCharacterMovementComponent : public UPawnMovementComponent
{
	...
	// Function /Script/Engine.CharacterMovementComponent.SetWalkableFloorZ (Underlying native function: SetWalkableFloorZ 0x9b25440)
	void SetWalkableFloorZ(float& InWalkableFloorZ); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetWalkableFloorAngle (Underlying native function: SetWalkableFloorAngle 0x9b253bc)
	void SetWalkableFloorAngle(float& InWalkableFloorAngle); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetMovementMode (Underlying native function: SetMovementMode 0x204fd98)
	...
	// Function /Script/Engine.CharacterMovementComponent.SetGroupsToIgnoreMask (Underlying native function: SetGroupsToIgnoreMask 0x9b24914)
	void SetGroupsToIgnoreMask(struct FNavAvoidanceMask& GroupMask); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetGroupsToIgnore (Underlying native function: SetGroupsToIgnore 0x9b24890)
	void SetGroupsToIgnore(int& GroupFlags); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetGroupsToAvoidMask (Underlying native function: SetGroupsToAvoidMask 0x9b24800)
	void SetGroupsToAvoidMask(struct FNavAvoidanceMask& GroupMask); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetGroupsToAvoid (Underlying native function: SetGroupsToAvoid 0x9b2477c)
	void SetGroupsToAvoid(int& GroupFlags); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetCrouchedHalfHeight (Underlying native function: SetCrouchedHalfHeight 0x9b246f8)
	void SetCrouchedHalfHeight(float& NewValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetAvoidanceGroupMask (Underlying native function: SetAvoidanceGroupMask 0x9b2433c)
	void SetAvoidanceGroupMask(struct FNavAvoidanceMask& GroupMask); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetAvoidanceGroup (Underlying native function: SetAvoidanceGroup 0x9b242b8)
	void SetAvoidanceGroup(int& GroupFlags); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.SetAvoidanceEnabled (Underlying native function: SetAvoidanceEnabled 0x9b24238)
	void SetAvoidanceEnabled(bool& bEnable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.K2_GetWalkableFloorZ (Underlying native function: K2_GetWalkableFloorZ 0x9b23c24)
	float K2GetWalkableFloorZ(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.K2_GetWalkableFloorAngle (Underlying native function: K2_GetWalkableFloorAngle 0x9b23c0c)
	float K2GetWalkableFloorAngle(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.K2_FindFloor (Underlying native function: K2_FindFloor 0x9b23b18)
	...
	// Function /Script/Engine.CharacterMovementComponent.K2_ComputeFloorDist (Underlying native function: K2_ComputeFloorDist 0x9b23938)
	...
	// Function /Script/Engine.CharacterMovementComponent.IsWalking (Underlying native function: IsWalking 0x26f15dc)
	bool IsWalking(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.IsWalkable (Underlying native function: IsWalkable 0x9b23888)
	bool IsWalkable(struct FHitResult& Hit); // (Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetValidPerchRadius (Underlying native function: GetValidPerchRadius 0x9b237a4)
	float GetValidPerchRadius(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetPerchRadiusThreshold (Underlying native function: GetPerchRadiusThreshold 0x9b23108)
	float GetPerchRadiusThreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMovementBase (Underlying native function: GetMovementBase 0x9b230e8)
	class UPrimitiveComponent* GetMovementBase(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMinAnalogSpeed (Underlying native function: GetMinAnalogSpeed 0x9b230bc)
	float GetMinAnalogSpeed(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMaxJumpHeightWithJumpTime (Underlying native function: GetMaxJumpHeightWithJumpTime 0x9b23090)
	float GetMaxJumpHeightWithJumpTime(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMaxJumpHeight (Underlying native function: GetMaxJumpHeight 0x9b23064)
	float GetMaxJumpHeight(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMaxBrakingDeceleration (Underlying native function: GetMaxBrakingDeceleration 0x9b23038)
	float GetMaxBrakingDeceleration(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetMaxAcceleration (Underlying native function: GetMaxAcceleration 0x9b2300c)
	float GetMaxAcceleration(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetLastUpdateVelocity (Underlying native function: GetLastUpdateVelocity 0x242105c)
	struct FVector GetLastUpdateVelocity(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetLastUpdateRotation (Underlying native function: GetLastUpdateRotation 0x9b22fcc)
	struct FRotator GetLastUpdateRotation(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetLastUpdateRequestedVelocity (Underlying native function: GetLastUpdateRequestedVelocity 0x9b22fa4)
	struct FVector GetLastUpdateRequestedVelocity(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetLastUpdateLocation (Underlying native function: GetLastUpdateLocation 0x9b22f7c)
	struct FVector GetLastUpdateLocation(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetImpartedMovementBaseVelocity (Underlying native function: GetImpartedMovementBaseVelocity 0x9b22f40)
	struct FVector GetImpartedMovementBaseVelocity(); // (Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetCurrentAcceleration (Underlying native function: GetCurrentAcceleration 0x9b22f18)
	struct FVector GetCurrentAcceleration(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetCrouchedHalfHeight (Underlying native function: GetCrouchedHalfHeight 0x86b059c)
	float GetCrouchedHalfHeight(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetCharacterOwner (Underlying native function: GetCharacterOwner 0x9b22b38)
	class ACharacter* GetCharacterOwner(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.GetAnalogInputModifier (Underlying native function: GetAnalogInputModifier 0x9b22b20)
	float GetAnalogInputModifier(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CharacterMovementComponent.DisableMovement (Underlying native function: DisableMovement 0x84951ec)
	void DisableMovement(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.ClearAccumulatedForces (Underlying native function: ClearAccumulatedForces 0x3057b24)
	void ClearAccumulatedForces(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.CapsuleTouched (Underlying native function: CapsuleTouched 0x9b22930)
	...
	// Function /Script/Engine.CharacterMovementComponent.CalcVelocity (Underlying native function: CalcVelocity 0x9b227e8)
	void CalcVelocity(float& DeltaTime, float& Friction, bool& bFluid, float& BrakingDeceleration); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.AddImpulse (Underlying native function: AddImpulse 0x9b22370)
	void AddImpulse(struct FVector& Impulse, bool& bVelocityChange); // (Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/Engine.CharacterMovementComponent.AddForce (Underlying native function: AddForce 0x9b222dc)
