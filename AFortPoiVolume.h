...
class AFortPoiVolume : public AVolume
{
	...
	// Function /Script/FortniteGame.FortPoiVolume.DoesShapeComponentOverlap (Underlying native function: DoesShapeComponentOverlap 0x815c2b8)
	bool DoesShapeComponentOverlap(class UShapeComponent*& Shape); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPoiVolume.ContainsLocationTag (Underlying native function: ContainsLocationTag 0x815c180)
	bool ContainsLocationTag(struct FGameplayTag& tag); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPoiVolume.CalendarEventsShouldBeReady (Underlying native function: CalendarEventsShouldBeReady 0x815ba30)
