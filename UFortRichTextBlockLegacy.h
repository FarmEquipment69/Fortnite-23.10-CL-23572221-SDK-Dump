...
class UFortRichTextBlockLegacy : public UWidget
{
	...
	// Function /Script/FortniteUI.FortRichTextBlockLegacy.SetText (Underlying native function: SetText 0xa5b3124)
	void SetText(struct FText& InText); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRichTextBlockLegacy.EscapeStringForRichText (Underlying native function: EscapeStringForRichText 0xa5aec94)
