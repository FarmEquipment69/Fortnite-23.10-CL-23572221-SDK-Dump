...
class AFortCreativePortalManager : public AInfo
{
	...
	// Function /Script/FortniteGame.FortCreativePortalManager.ReleasePortal (Underlying native function: ReleasePortal 0x8067c60)
	void ReleasePortal(class AFortAthenaCreativePortal*& PortalToRelease); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativePortalManager.OnPendingReservationPartyLeaderSet (Underlying native function: OnPendingReservationPartyLeaderSet 0x8067680)
	void OnPendingReservationPartyLeaderSet(class AFortPlayerController*& PlayerController); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortCreativePortalManager.GetCreativePortalManager (Underlying native function: GetCreativePortalManager 0x8066a5c)
