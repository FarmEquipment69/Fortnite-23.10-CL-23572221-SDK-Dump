...
class UFortMissionTrackerList : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortMissionTrackerList.UpdateVisibleMissionCategories (Underlying native function: UpdateVisibleMissionCategories 0xa736404)
	void UpdateVisibleMissionCategories(int& InVisibleMissionCategories); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionTrackerList.UpdateVisibility (Underlying native function: UpdateVisibility 0xa7363f0)
	void UpdateVisibility(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortMissionTrackerList.HandleSizeEstimateChanged (Underlying native function: HandleSizeEstimateChanged 0xa732648)
	void HandleSizeEstimateChanged(class UObject*& ChangedElement); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortMissionTrackerList.HandleMissionsUpdated (Underlying native function: HandleMissionsUpdated 0xa7325a0)
