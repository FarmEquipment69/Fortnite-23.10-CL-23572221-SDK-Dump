...
class UFortItemCraftingOptionsActivatablePanel_STW : public UFortActivatablePanel
{
	...
	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.UpdateTierImages (Underlying native function: UpdateTierImages 0x71cdf54)
	void UpdateTierImages(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SetTargetCraftingTierIndex (Underlying native function: SetTargetCraftingTierIndex 0x71cddb0)
	void SetTargetCraftingTierIndex(int& NewTierIndex); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SetSelectedQuantity_BP (Underlying native function: SetSelectedQuantity_BP 0x71cdc88)
	void SetSelectedQuantityBP(int& NewQuantity); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SetItemManagementScreen (Underlying native function: SetItemManagementScreen 0x71cdb80)
	...
	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SetBaseSchematicItem (Underlying native function: SetBaseSchematicItem 0x71cd978)
	void SetBaseSchematicItem(class UFortSchematicItem*& InBaseItem); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SelectPreviousTier (Underlying native function: SelectPreviousTier 0x71cd940)
	void SelectPreviousTier(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.SelectNextTier (Underlying native function: SelectNextTier 0x71cd900)
	...
	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.IncreaseSelectedQuantity (Underlying native function: IncreaseSelectedQuantity 0x71cd618)
	void IncreaseSelectedQuantity(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.DecreaseSelectedQuantity (Underlying native function: DecreaseSelectedQuantity 0x71ccec4)
	void DecreaseSelectedQuantity(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.CraftTargetItem (Underlying native function: CraftTargetItem 0x71cce9c)
	void CraftTargetItem(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemCraftingOptionsActivatablePanel_STW.CraftAndSlotTargetItem (Underlying native function: CraftAndSlotTargetItem 0x71cce88)
