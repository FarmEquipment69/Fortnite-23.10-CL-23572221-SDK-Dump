...
class UFocusButton : public UBacchusActionButton
{
	...
	// Function /Script/EventModeUI.FocusButton.HandleEventModeFocusingChanged (Underlying native function: HandleEventModeFocusingChanged 0x706dfa8)
	void HandleEventModeFocusingChanged(bool& bIsEventModeFocusing); // (Final | Native | Private)

	// Function /Script/EventModeUI.FocusButton.HandleCanUseEventModeFocusChanged (Underlying native function: HandleCanUseEventModeFocusChanged 0x706deac)
