...
class UFortAthenaAISpawnerDataComponent_AIBotBehavior : public UFortAthenaAISpawnerDataComponent_Behavior
{
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.IsBehaviorTreeBranchActive (Underlying native function: IsBehaviorTreeBranchActive 0xa1f7020)
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.EnableBehaviorTreeBranch (Underlying native function: EnableBehaviorTreeBranch 0xa1f5c94)
	void EnableBehaviorTreeBranch(enum EBehaviorTreeBranches& Behavior); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.DisableBehaviorTreeBranch (Underlying native function: DisableBehaviorTreeBranch 0xa1f5b90)
