...
class UFortCreativeDeviceButtonComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeDeviceButtonComponent.SetButtonName (Underlying native function: SetButtonName 0x8551dc4)
	void SetButtonName(struct FText& InButtonName); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeDeviceButtonComponent.SetButtonLabel (Underlying native function: SetButtonLabel 0x8551cc8)
	void SetButtonLabel(struct FText& InButtonLabel); // (Final | 0x00000002 | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeDeviceButtonComponent.SetButtonDescription (Underlying native function: SetButtonDescription 0x8551bcc)
	void SetButtonDescription(struct FText& InButtonDesciription); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortCreativeDeviceButtonComponent.RequestButtonRefresh (Underlying native function: RequestButtonRefresh 0x8551550)
