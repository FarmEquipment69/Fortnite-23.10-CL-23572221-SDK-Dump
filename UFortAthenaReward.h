...
class UFortAthenaReward : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortAthenaReward.UpdateRewardState (Underlying native function: UpdateRewardState 0xa5f6b58)
	void UpdateRewardState(enum EFortAthenaRewardState& StateToSetup, bool& bEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaReward.SetViewOnHovered (Underlying native function: SetViewOnHovered 0xa5f6584)
	void SetViewOnHovered(bool& bShouldViewOnHovered); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaReward.SetupRewardItem (Underlying native function: SetupRewardItem 0xa5f6664)
