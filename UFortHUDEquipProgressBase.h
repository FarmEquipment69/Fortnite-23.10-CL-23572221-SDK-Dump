...
class UFortHUDEquipProgressBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortHUDEquipProgressBase.HandleUIGameplayCueEvent (Underlying native function: HandleUIGameplayCueEvent 0xa585ba4)
	...
	// Function /Script/FortniteUI.FortHUDEquipProgressBase.HandleReplayScrubComplete (Underlying native function: HandleReplayScrubComplete 0xa585a90)
	void HandleReplayScrubComplete(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDEquipProgressBase.HandleFollowedPlayerChanged (Underlying native function: HandleFollowedPlayerChanged 0x2842240)
