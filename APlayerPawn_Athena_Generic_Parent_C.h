...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x5220 (0x8)
	class UMotionWarpingComponent* MotionWarping; // 0x5228 (0x8)
	class UMultiInteractActorComponent_C* MultiInteractActorComponent; // 0x5230 (0x8)
	struct TArray<class UMaterialInterface*> DefaultWeaponMaterials; // 0x5238 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnBackpackMaterials; // 0x5248 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnHatMaterials; // 0x5258 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnHeadMaterials; // 0x5268 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnBodyMaterials; // 0x5278 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnCharmMaterials; // 0x5288 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnFaceMaterials; // 0x5298 (0x10)
	class UPostProcessComponent* PlayerPostProcessFX; // 0x52a8 (0x8)
	struct TArray<class USkeletalMeshComponent*> SkeletalMeshes; // 0x52b0 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnMaterialsALL; // 0x52c0 (0x10)
	struct FMulticastInlineDelegate ShootingTargetReactToJump; // 0x52d0 (0x10)
	struct FMulticastInlineDelegate OnPlayHit; // 0x52e0 (0x10)
	struct FMulticastInlineDelegate OnEnteredVehicleDispatcher; // 0x52f0 (0x10)
	struct FMulticastInlineDelegate OnExitedVehicleDispatcher; // 0x5300 (0x10)
