...
class UFortChallengeBundleScheduleDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.GetSortPriority (Underlying native function: GetSortPriority 0x840f04c)
	int GetSortPriority(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.GetNumBundles (Underlying native function: GetNumBundles 0x2d7b254)
	int GetNumBundles(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.GetEventName (Underlying native function: GetEventName 0x840e6dc)
	struct FString GetEventName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.GetCalendarEventName (Underlying native function: GetCalendarEventName 0x840e378)
	struct FString GetCalendarEventName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.GetBundleDefinitions (Underlying native function: GetBundleDefinitions 0x840e208)
	...
	// Function /Script/FortniteGame.FortChallengeBundleScheduleDefinition.DoesChallengeBundleScheduleExpire (Underlying native function: DoesChallengeBundleScheduleExpire 0x840dfac)
