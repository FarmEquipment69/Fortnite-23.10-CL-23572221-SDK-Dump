...
class UAthenaSprayItemDefinition : public UAthenaDanceItemDefinition
{
	...
	// Function /Script/FortniteGame.AthenaSprayItemDefinition.ShouldUseBannerAsTexture (Underlying native function: ShouldUseBannerAsTexture 0x84fc270)
	bool ShouldUseBannerAsTexture(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.AthenaSprayItemDefinition.GetDecalTexture (Underlying native function: GetDecalTexture 0x84f8fa0)
	...
	// Function /Script/FortniteGame.AthenaSprayItemDefinition.GetDecalMaterial (Underlying native function: GetDecalMaterial 0x84f8e68)
