...
class UAIPerceptionSystem : public UAISubsystem
{
	...
	// Function /Script/AIModule.AIPerceptionSystem.ReportPerceptionEvent (Underlying native function: ReportPerceptionEvent 0xa00f204)
	...
	// Function /Script/AIModule.AIPerceptionSystem.ReportEvent (Underlying native function: ReportEvent 0xa00f144)
	void ReportEvent(class UAISenseEvent*& PerceptionEvent); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AIModule.AIPerceptionSystem.RegisterPerceptionStimuliSource (Underlying native function: RegisterPerceptionStimuliSource 0xa00eeb4)
	...
	// Function /Script/AIModule.AIPerceptionSystem.OnPerceptionStimuliSourceEndPlay (Underlying native function: OnPerceptionStimuliSourceEndPlay 0x17fd8e8)
	...
	// Function /Script/AIModule.AIPerceptionSystem.GetSenseClassForStimulus (Underlying native function: GetSenseClassForStimulus 0xa00e8dc)
