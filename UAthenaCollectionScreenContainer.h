...
class UAthenaCollectionScreenContainer : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaCollectionScreenContainer.EnableTabActions (Underlying native function: EnableTabActions 0xa2c66fc)
	void EnableTabActions(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaCollectionScreenContainer.DisableTabActions (Underlying native function: DisableTabActions 0xa2c66c8)
