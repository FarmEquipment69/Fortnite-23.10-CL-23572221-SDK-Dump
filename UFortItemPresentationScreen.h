...
class UFortItemPresentationScreen : public UFortItemPreviewScreen
{
	...
	// Function /Script/FortniteUI.FortItemPresentationScreen.SetGiftBoxItem (Underlying native function: SetGiftBoxItem 0xa6c7dbc)
	...
	// Function /Script/FortniteUI.FortItemPresentationScreen.HandleHoldToClose (Underlying native function: HandleHoldToClose 0xa6c6228)
	void HandleHoldToClose(bool& bPassThrough); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortItemPresentationScreen.HandleExitBattlePassPurchaseFlow (Underlying native function: HandleExitBattlePassPurchaseFlow 0xa6c6214)
	void HandleExitBattlePassPurchaseFlow(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortItemPresentationScreen.HandleBack (Underlying native function: HandleBack 0x1eb0764)
	void HandleBack(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPresentationScreen.FinishSwitchingToPaidItems (Underlying native function: FinishSwitchingToPaidItems 0xa6c54c8)
	void FinishSwitchingToPaidItems(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPresentationScreen.EnableUserControlOnPaidItems (Underlying native function: EnableUserControlOnPaidItems 0xa6c51a4)
	void EnableUserControlOnPaidItems(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemPresentationScreen.ClearItemPreview (Underlying native function: ClearItemPreview 0x4838e30)
