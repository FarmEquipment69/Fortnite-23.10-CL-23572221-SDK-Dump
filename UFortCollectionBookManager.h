...
class UFortCollectionBookManager : public UObject
{
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.UnSlotItem (Underlying native function: UnSlotItem 0x8c67528)
	bool UnSlotItem(class UFortAccountItem*& Item); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCollectionBookManager.SlotItem (Underlying native function: SlotItem 0x8c66f30)
	bool SlotItem(class UFortAccountItem*& Item, struct FName& SlotId); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCollectionBookManager.PurchaseItem (Underlying native function: PurchaseItem 0x8c65d08)
	bool PurchaseItem(class UFortAccountItem*& Item); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortCollectionBookManager.PopulateCollectionBookRewards (Underlying native function: PopulateCollectionBookRewards 0x8c65bf0)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.IsItemMissingFromCollectionBook (Underlying native function: IsItemMissingFromCollectionBook 0x8c64520)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.GetItemInSlot (Underlying native function: GetItemInSlot 0x8c63900)
	class UFortItem* GetItemInSlot(struct FName& SlotId); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCollectionBookManager.GetBookXPPercentToNextLevel (Underlying native function: GetBookXPPercentToNextLevel 0x8c632ec)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.GetBookTotalXPToNextLevel (Underlying native function: GetBookTotalXPToNextLevel 0x8c63260)
	int GetBookTotalXPToNextLevel(int& CurrentLevel); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCollectionBookManager.DoesItemSlotExistInCollectionBook (Underlying native function: DoesItemSlotExistInCollectionBook 0x8c630a0)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.ClaimReward (Underlying native function: ClaimReward 0x8c62c1c)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.CanSlotItem (Underlying native function: CanSlotItem 0x8c623e8)
	...
	// Function /Script/FortniteGame.FortCollectionBookManager.CalculatePageXp (Underlying native function: CalculatePageXp 0x8c6233c)
	int CalculatePageXp(struct FName& PageId); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCollectionBookManager.CalculateBookXp (Underlying native function: CalculateBookXp 0x8c62318)
