...
class UFortInteractContextInfo : public UObject
{
	...
	// Function /Script/FortniteGame.FortInteractContextInfo.HasValidSecondContextOverride (Underlying native function: HasValidSecondContextOverride 0x86e0580)
	bool HasValidSecondContextOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortInteractContextInfo.HasValidContextOverride (Underlying native function: HasValidContextOverride 0x86e0518)
