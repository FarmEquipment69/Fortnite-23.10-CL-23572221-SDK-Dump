...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x6098 (0x8)
	class UFortWidgetComponent* NPCStatusWidget; // 0x60a0 (0x8)
	bool IsConverted; // 0x60a8 (0x1)
	unsigned char LeaderTeam; // 0x60a9 (0x1)
	unsigned char unreflected_60aa[0x6]; // 0x60aa (0x6) 
	struct FStruct_NPC_HealthInfo HealthInfo; // 0x60b0 (0x20)
	bool NPCStatusWidgetHealthBarDisabled; // 0x60d0 (0x1)
	unsigned char unreflected_60d1[0x7]; // 0x60d1 (0x7) 
	struct FScalableFloat ShowHealth; // 0x60d8 (0x28)
	double NPCHealthBarHideTimeAfterDeath; // 0x6100 (0x8)
	double NPCMaxDistanceFromDamageINstigatorToDrawHealthBar; // 0x6108 (0x8)
	bool IsHealthCheatEnabled; // 0x6110 (0x1)
