...
class AQosBeaconClient : public AOnlineBeaconClient
{
	...
	// Function /Script/Qos.QosBeaconClient.ServerQosRequest (Underlying native function: ServerQosRequest 0x6a01b7c)
	void ServerQosRequest(struct FString& InSessionId); // (Net | NetReliable | Native | Event | Protected | NetServer | 0x80000000)

	// Function /Script/Qos.QosBeaconClient.ClientQosResponse (Underlying native function: ClientQosResponse 0x6a01af8)
