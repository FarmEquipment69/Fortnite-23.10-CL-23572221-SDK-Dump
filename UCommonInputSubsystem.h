...
class UCommonInputSubsystem : public ULocalPlayerSubsystem
{
	...
	// Function /Script/CommonInput.CommonInputSubsystem.ShouldShowInputKeys (Underlying native function: ShouldShowInputKeys 0x28b4fb0)
	bool ShouldShowInputKeys(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonInput.CommonInputSubsystem.SetGamepadInputType (Underlying native function: SetGamepadInputType 0x6632cf8)
	void SetGamepadInputType(struct FName& InGamepadInputType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonInput.CommonInputSubsystem.SetCurrentInputType (Underlying native function: SetCurrentInputType 0x6632c78)
	void SetCurrentInputType(enum ECommonInputType& NewInputType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonInput.CommonInputSubsystem.IsUsingPointerInput (Underlying native function: IsUsingPointerInput 0x6632c48)
	bool IsUsingPointerInput(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonInput.CommonInputSubsystem.IsInputMethodActive (Underlying native function: IsInputMethodActive 0x6632bb8)
	bool IsInputMethodActive(enum ECommonInputType& InputMethod); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonInput.CommonInputSubsystem.GetDefaultInputType (Underlying native function: GetDefaultInputType 0x6632b68)
	enum ECommonInputType GetDefaultInputType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonInput.CommonInputSubsystem.GetCurrentInputType (Underlying native function: GetCurrentInputType 0x2492068)
	enum ECommonInputType GetCurrentInputType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonInput.CommonInputSubsystem.GetCurrentGamepadName (Underlying native function: GetCurrentGamepadName 0x2e42d44)
