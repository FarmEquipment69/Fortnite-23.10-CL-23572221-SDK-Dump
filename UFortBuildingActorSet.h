...
class UFortBuildingActorSet : public UFortHealthSet
{
	...
	// Function /Script/FortniteGame.FortBuildingActorSet.OnRep_RepairTime (Underlying native function: OnRep_RepairTime 0x831bf64)
	void OnRepRepairTime(struct FFortGameplayAttributeData& OldValue); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteGame.FortBuildingActorSet.OnRep_BuildTime (Underlying native function: OnRep_BuildTime 0x8318a54)
