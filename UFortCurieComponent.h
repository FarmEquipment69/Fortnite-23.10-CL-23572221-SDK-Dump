...
class UFortCurieComponent : public UCurieComponent
{
	...
	// Function /Script/FortniteGame.FortCurieComponent.OnRep_ActiveVoxelReplicationData (Underlying native function: OnRep_ActiveVoxelReplicationData 0x264cc10)
	void OnRepActiveVoxelReplicationData(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCurieComponent.OnRep_ActiveStateBitfield (Underlying native function: OnRep_ActiveStateBitfield 0x269ce78)
