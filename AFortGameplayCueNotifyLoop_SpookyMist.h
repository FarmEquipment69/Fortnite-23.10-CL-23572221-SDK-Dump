...
class AFortGameplayCueNotifyLoop_SpookyMist : public AFortGameplayCueNotify_Loop
{
	...
	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_SpookyMist.ExpireWarningTick (Underlying native function: ExpireWarningTick 0x7e70320)
	void ExpireWarningTick(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_SpookyMist.ClearExpireTell (Underlying native function: ClearExpireTell 0x7e6efd4)
	void ClearExpireTell(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameplayCueNotifyLoop_SpookyMist.BeginExpireTell (Underlying native function: BeginExpireTell 0x7e6e70c)
