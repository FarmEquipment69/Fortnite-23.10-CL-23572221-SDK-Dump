...
class UFortShowdownRegionButton : public UCommonPopupButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortShowdownRegionButton.HandleRegionSelectedChanged (Underlying native function: HandleRegionSelectedChanged 0xa7f1700)
	void HandleRegionSelectedChanged(int& SelectedButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortShowdownRegionButton.HandlePopupChanged (Underlying native function: HandlePopupChanged 0xa7f14fc)
	void HandlePopupChanged(bool& bIsOpen); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortShowdownRegionButton.ClosePopup (Underlying native function: ClosePopup 0xa7ec03c)
