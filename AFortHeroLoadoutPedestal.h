...
class AFortHeroLoadoutPedestal : public AFortItemPreviewPedestal
{
	...
	// Function /Script/FortniteUI.FortHeroLoadoutPedestal.HandleMcpProfilesInitialized (Underlying native function: HandleMcpProfilesInitialized 0xa8217b0)
	void HandleMcpProfilesInitialized(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHeroLoadoutPedestal.HandleDifferentLoadoutViewed (Underlying native function: HandleDifferentLoadoutViewed 0xa8216ec)
	...
	// Function /Script/FortniteUI.FortHeroLoadoutPedestal.HandleDifferentHeroLoadoutSlotFocused (Underlying native function: HandleDifferentHeroLoadoutSlotFocused 0xa82166c)
