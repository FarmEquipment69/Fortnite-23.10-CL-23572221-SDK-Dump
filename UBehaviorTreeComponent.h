...
class UBehaviorTreeComponent : public UBrainComponent
{
	...
	// Function /Script/AIModule.BehaviorTreeComponent.SetDynamicSubtree (Underlying native function: SetDynamicSubtree 0x9fc9a64)
	void SetDynamicSubtree(struct FGameplayTag& InjectTag, class UBehaviorTree*& BehaviorAsset); // (Native | Public | BlueprintCallable)

	// Function /Script/AIModule.BehaviorTreeComponent.GetTagCooldownEndTime (Underlying native function: GetTagCooldownEndTime 0x9fc8218)
	float GetTagCooldownEndTime(struct FGameplayTag& CooldownTag); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.BehaviorTreeComponent.AddCooldownTagDuration (Underlying native function: AddCooldownTagDuration 0x9fc6f30)
