...
class AFortVolume : public AGameplayVolume
{
	...
	// Function /Script/FortniteGame.FortVolume.ServerClearVolume (Underlying native function: ServerClearVolume 0x6f49804)
	void ServerClearVolume(); // (Net | NetReliable | Native | Event | Public | NetServer | BlueprintCallable)

	// Function /Script/FortniteGame.FortVolume.RemoveAthenaPawnWhenDied (Underlying native function: RemoveAthenaPawnWhenDied 0x83d8464)
	void RemoveAthenaPawnWhenDied(class AFortPlayerPawnAthena*& FortPlayerPawnAthena); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.RemoveActorWhenEndPlay (Underlying native function: RemoveActorWhenEndPlay 0x83d83a0)
	void RemoveActorWhenEndPlay(class AActor*& Actor, struct TEnumAsByte<EEndPlayReason>& EndPlayReason); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.RemoveActorWhenDied (Underlying native function: RemoveActorWhenDied 0x83d8184)
	...
	// Function /Script/FortniteGame.FortVolume.OnRep_VolumeState (Underlying native function: OnRep_VolumeState 0x83d8170)
	void OnRepVolumeState(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.OnRep_UserGeneratedContentRestrictions (Underlying native function: OnRep_UserGeneratedContentRestrictions 0x83d813c)
	void OnRepUserGeneratedContentRestrictions(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.OnRep_ObjectTrackingComponent (Underlying native function: OnRep_ObjectTrackingComponent 0x83d8128)
	void OnRepObjectTrackingComponent(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.OnRep_CurrentPlayset (Underlying native function: OnRep_CurrentPlayset 0x83d8114)
	void OnRepCurrentPlayset(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.IsReady (Underlying native function: IsReady 0x83d7d5c)
	bool IsReady(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.IsReadOnly (Underlying native function: IsReadOnly 0x83d7d2c)
	bool IsReadOnly(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.IsPlayerAllowedInVolume (Underlying native function: IsPlayerAllowedInVolume 0x83d7cb8)
	bool IsPlayerAllowedInVolume(class AFortPlayerController*& NewUser); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortVolume.HasVolumeBoundsBlocked (Underlying native function: HasVolumeBoundsBlocked 0x2830cb8)
	bool HasVolumeBoundsBlocked(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetUserGeneratedContentRestricted (Underlying native function: GetUserGeneratedContentRestricted 0x83d6f74)
	bool GetUserGeneratedContentRestricted(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetStaticMesh (Underlying native function: GetStaticMesh 0x83d6f44)
	class UStaticMeshComponent* GetStaticMesh(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetObjectTrackingComponent (Underlying native function: GetObjectTrackingComponent 0x83d6e54)
	...
	// Function /Script/FortniteGame.FortVolume.GetNumPlayersInVolume (Underlying native function: GetNumPlayersInVolume 0x83d6e30)
	int GetNumPlayersInVolume(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetMinigame (Underlying native function: GetMinigame 0x83d6b2c)
	class AFortMinigame* GetMinigame(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetFortVolumeType (Underlying native function: GetFortVolumeType 0x83d6b08)
	enum EFortVolumeType GetFortVolumeType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetFortVolumePersistenceOptions (Underlying native function: GetFortVolumePersistenceOptions 0x83d6af0)
	...
	// Function /Script/FortniteGame.FortVolume.GetCurrentPlayset (Underlying native function: GetCurrentPlayset 0x83d6ac4)
	class UFortPlaysetItemDefinition* GetCurrentPlayset(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.GetActorsWithinVolumeByClass (Underlying native function: GetActorsWithinVolumeByClass 0x83d6738)
	...
	// Function /Script/FortniteGame.FortVolume.GetAccountIdOwnerOfIsland (Underlying native function: GetAccountIdOwnerOfIsland 0x83d65b4)
	struct FString GetAccountIdOwnerOfIsland(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortVolume.DestroyVolume (Underlying native function: DestroyVolume 0x83d6328)
	void DestroyVolume(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortVolume.AddSelfToVolumeManager (Underlying native function: AddSelfToVolumeManager 0x83d5c44)
	void AddSelfToVolumeManager(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVolume.AddOrRemovePawnAfterVehicleChange (Underlying native function: AddOrRemovePawnAfterVehicleChange 0x83d5a54)
	...
	// Function /Script/FortniteGame.FortVolume.AddActor (Underlying native function: AddActor 0x83d55f4)
