...
class UAthenaAIKillsBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaAIKillsBase.SetKillsSourcePlayerState (Underlying native function: SetKillsSourcePlayerState 0xa2c76fc)
	void SetKillsSourcePlayerState(class AFortPlayerStateAthena*& InPlayerState); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaAIKillsBase.SetKillsSourcePlayerController (Underlying native function: SetKillsSourcePlayerController 0xa2c76fc)
