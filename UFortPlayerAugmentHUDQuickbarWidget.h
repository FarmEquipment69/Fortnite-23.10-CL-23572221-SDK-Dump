...
class UFortPlayerAugmentHUDQuickbarWidget : public UCommonUserWidget
{
	...
	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentHUDQuickbarWidget.GetNumAugmentGrantRoundsForPlaylist (Underlying native function: GetNumAugmentGrantRoundsForPlaylist 0x71a9788)
