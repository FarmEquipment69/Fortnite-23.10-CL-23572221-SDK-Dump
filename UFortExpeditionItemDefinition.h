...
class UFortExpeditionItemDefinition : public UFortAccountItemDefinition
{
	...
	// Function /Script/FortniteGame.FortExpeditionItemDefinition.GetRequiredTags (Underlying native function: GetRequiredTags 0x8c9378c)
	struct FGameplayTagContainer GetRequiredTags(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortExpeditionItemDefinition.GetExpeditionCosts (Underlying native function: GetExpeditionCosts 0x8c92f18)
	...
	// Function /Script/FortniteGame.FortExpeditionItemDefinition.GetAllRewards (Underlying native function: GetAllRewards 0x8c929b8)
