...
class AFortAthenaMutator_SpecialRelevancy : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.StartSquadRelevancy (Underlying native function: StartSquadRelevancy 0x8285ee8)
	void StartSquadRelevancy(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.StartSoloRelevancy (Underlying native function: StartSoloRelevancy 0x8285ec4)
	void StartSoloRelevancy(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.StartNormalRelevancy (Underlying native function: StartNormalRelevancy 0x8285ea0)
	void StartNormalRelevancy(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.StartMultiSquadRelevancy (Underlying native function: StartMultiSquadRelevancy 0x8285e20)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.SpawnActorPerRelevancyGroup (Underlying native function: SpawnActorPerRelevancyGroup 0x8285cb8)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.SetClientAuthoritativePhysics (Underlying native function: SetClientAuthoritativePhysics 0x8285aec)
	void SetClientAuthoritativePhysics(bool& bEnabled); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.PlacePawnOnPlayerStart (Underlying native function: PlacePawnOnPlayerStart 0x828561c)
	void PlacePawnOnPlayerStart(class AFortPlayerController*& PlayerController); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.OnRep_CurrentRelevancyMode (Underlying native function: OnRep_CurrentRelevancyMode 0x8285360)
	void OnRepCurrentRelevancyMode(struct FSpecialRelevancyModeData*& PrevMode); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.GetRelevantPawnGroups (Underlying native function: GetRelevantPawnGroups 0x82846c8)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.GetPlayerPawns (Underlying native function: GetPlayerPawns 0x8284384)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.GetNumRelevancyGroups (Underlying native function: GetNumRelevancyGroups 0x82842bc)
	int GetNumRelevancyGroups(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.GetMaxSquadSize (Underlying native function: GetMaxSquadSize 0x828427c)
	int GetMaxSquadSize(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.GetActors (Underlying native function: GetActors 0x8283d4c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.FindRelevancyGroupIndex (Underlying native function: FindRelevancyGroupIndex 0x8283cbc)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpecialRelevancy.AreActorsInSameRelvancyGroup (Underlying native function: AreActorsInSameRelvancyGroup 0x828379c)
