...
class UContentBrowserFilterEntry : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.ContentBrowserFilterEntry.UpdateButtonText (Underlying native function: UpdateButtonText 0xa4b58ec)
	void UpdateButtonText(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.ContentBrowserFilterEntry.SetIsFilterActive (Underlying native function: SetIsFilterActive 0xa4b3714)
	void SetIsFilterActive(bool& bInFilterActive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.ContentBrowserFilterEntry.IsFilterActive (Underlying native function: IsFilterActive 0xa4b1fac)
