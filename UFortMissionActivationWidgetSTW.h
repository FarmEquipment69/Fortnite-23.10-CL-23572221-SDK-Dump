...
class UFortMissionActivationWidgetSTW : public UCommonActivatableWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortMissionActivationWidgetSTW.RequestStartObjectiveState (Underlying native function: RequestStartObjectiveState 0x71d0534)
	void RequestStartObjectiveState(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortMissionActivationWidgetSTW.RequestDifficultyIncreaseState (Underlying native function: RequestDifficultyIncreaseState 0x71d0504)
	void RequestDifficultyIncreaseState(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortMissionActivationWidgetSTW.RequestDefaultState (Underlying native function: RequestDefaultState 0x71d04b4)
	...
	// Function /Script/SaveTheWorldUI.FortMissionActivationWidgetSTW.GetCurrentState (Underlying native function: GetCurrentState 0x71ced1c)
