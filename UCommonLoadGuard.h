...
class UCommonLoadGuard : public UContentWidget
{
	...
	// Function /Script/CommonUI.CommonLoadGuard.SetLoadingText (Underlying native function: SetLoadingText 0x662f9f4)
	void SetLoadingText(struct FText& InLoadingText); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/CommonUI.CommonLoadGuard.SetIsLoading (Underlying native function: SetIsLoading 0x662f43c)
	...
	// Function /Script/CommonUI.CommonLoadGuard.IsLoading (Underlying native function: IsLoading 0x662e000)
	bool IsLoading(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonLoadGuard.BP_GuardAndLoadAsset (Underlying native function: BP_GuardAndLoadAsset 0x662bdfc)
