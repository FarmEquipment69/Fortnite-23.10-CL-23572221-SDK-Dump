...
class UFortShowdownRegionPopupMenu : public UCommonPopupMenuLegacy
{
	...
	// Function /Script/FortniteUI.FortShowdownRegionPopupMenu.HandleSelectedButtonClicked (Underlying native function: HandleSelectedButtonClicked 0xa7f1780)
	void HandleSelectedButtonClicked(class UCommonButtonBase*& SelectedButton, int& SelectedButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortShowdownRegionPopupMenu.HandleMenuOpenChanged (Underlying native function: HandleMenuOpenChanged 0xa7f10e0)
