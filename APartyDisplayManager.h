...
class APartyDisplayManager : public AActor
{
	...
	// Function /Script/FortniteGame.PartyDisplayManager.OnPawnTouchReleased (Underlying native function: OnPawnTouchReleased 0x87b49c4)
	void OnPawnTouchReleased(struct TEnumAsByte<ETouchIndex>& FingerIndex, class AActor*& TouchedActor); // (Final | Native | Protected)

	// Function /Script/FortniteGame.PartyDisplayManager.OnPawnEndCursorOver (Underlying native function: OnPawnEndCursorOver 0x87b4904)
	void OnPawnEndCursorOver(class AActor*& TouchedActor); // (Final | Native | Protected)

	// Function /Script/FortniteGame.PartyDisplayManager.OnPawnClicked (Underlying native function: OnPawnClicked 0x87b478c)
	void OnPawnClicked(class AActor*& TouchedActor, struct FKey& ButtonPressed); // (Final | 0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.PartyDisplayManager.OnPawnBeginCursorOver (Underlying native function: OnPawnBeginCursorOver 0x87b46cc)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.NotifyPrefabChanged (Underlying native function: NotifyPrefabChanged 0x87b44ac)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.HandleItemsShown (Underlying native function: HandleItemsShown 0x87b4214)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.HandleCharacterCustomizationFinished (Underlying native function: HandleCharacterCustomizationFinished 0x87b416c)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.GetPlayerIdFromPartyMemberIndex (Underlying native function: GetPlayerIdFromPartyMemberIndex 0x87b3654)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.GetPartyMemberIndexByPlayerPawn (Underlying native function: GetPartyMemberIndexByPlayerPawn 0x87b3370)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.GetHeroPlayerPawnForCurrentDisplayedItem (Underlying native function: GetHeroPlayerPawnForCurrentDisplayedItem 0x87b3020)
	class AFortPlayerPawn* GetHeroPlayerPawnForCurrentDisplayedItem(); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.PartyDisplayManager.GetCosmeticLoadoutForCurrentDisplayedItem (Underlying native function: GetCosmeticLoadoutForCurrentDisplayedItem 0x87b2738)
	...
	// Function /Script/FortniteGame.PartyDisplayManager.BeginLoadingAssetsForItem (Underlying native function: BeginLoadingAssetsForItem 0x87b2160)
