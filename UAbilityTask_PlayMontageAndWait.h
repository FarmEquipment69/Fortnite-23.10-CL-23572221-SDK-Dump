...
class UAbilityTask_PlayMontageAndWait : public UAbilityTask
{
	...
	// Function /Script/GameplayAbilities.AbilityTask_PlayMontageAndWait.OnMontageInterrupted (Underlying native function: OnMontageInterrupted 0x66b8374)
	void OnMontageInterrupted(); // (Final | Native | Public)

	// Function /Script/GameplayAbilities.AbilityTask_PlayMontageAndWait.OnMontageEnded (Underlying native function: OnMontageEnded 0x66b82ac)
	void OnMontageEnded(class UAnimMontage*& Montage, bool& bInterrupted); // (Final | Native | Public)

	// Function /Script/GameplayAbilities.AbilityTask_PlayMontageAndWait.OnMontageBlendingOut (Underlying native function: OnMontageBlendingOut 0x66b81e4)
	void OnMontageBlendingOut(class UAnimMontage*& Montage, bool& bInterrupted); // (Final | Native | Public)

	// Function /Script/GameplayAbilities.AbilityTask_PlayMontageAndWait.CreatePlayMontageAndWaitProxy (Underlying native function: CreatePlayMontageAndWaitProxy 0x66b61cc)
