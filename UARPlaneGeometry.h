...
class UARPlaneGeometry : public UARTrackedGeometry
{
	...
	// Function /Script/AugmentedReality.ARPlaneGeometry.GetSubsumedBy (Underlying native function: GetSubsumedBy 0x95e0e90)
	class UARPlaneGeometry* GetSubsumedBy(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AugmentedReality.ARPlaneGeometry.GetOrientation (Underlying native function: GetOrientation 0x95e0d40)
	enum EARPlaneOrientation GetOrientation(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AugmentedReality.ARPlaneGeometry.GetExtent (Underlying native function: GetExtent 0x95df8b8)
	struct FVector GetExtent(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AugmentedReality.ARPlaneGeometry.GetCenter (Underlying native function: GetCenter 0x95df6e0)
	struct FVector GetCenter(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AugmentedReality.ARPlaneGeometry.GetBoundaryPolygonInLocalSpace (Underlying native function: GetBoundaryPolygonInLocalSpace 0x95df458)
