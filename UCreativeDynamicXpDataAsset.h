...
class UCreativeDynamicXpDataAsset : public UPrimaryDataAsset
{
	...
	// Function /Script/FortniteGame.CreativeDynamicXpDataAsset.GetXpBudgetPerMinute (Underlying native function: GetXpBudgetPerMinute 0x851da7c)
	float GetXpBudgetPerMinute(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CreativeDynamicXpDataAsset.GetCappedSessionLength (Underlying native function: GetCappedSessionLength 0x2d7a924)
	float GetCappedSessionLength(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CreativeDynamicXpDataAsset.GetAfkMinRewardMult (Underlying native function: GetAfkMinRewardMult 0x662c7ec)
	float GetAfkMinRewardMult(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CreativeDynamicXpDataAsset.GetAFKDetectionParameters (Underlying native function: GetAFKDetectionParameters 0x851c664)
