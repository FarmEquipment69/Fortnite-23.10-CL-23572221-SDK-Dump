...
class UAthenaDiscoverabilityBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaDiscoverabilityBase.CommonVisitedEvent (Underlying native function: CommonVisitedEvent 0xa2e7f98)
	void CommonVisitedEvent(struct FGameplayTag& NewTag); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.AthenaDiscoverabilityBase.CommonDiscoveredEvent (Underlying native function: CommonDiscoveredEvent 0xa2e7f08)
	void CommonDiscoveredEvent(struct FGameplayTag& NewTag); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.AthenaDiscoverabilityBase.CommonArrivalEvent (Underlying native function: CommonArrivalEvent 0xa2e7e78)
