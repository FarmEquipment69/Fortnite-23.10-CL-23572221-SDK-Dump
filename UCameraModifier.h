...
class UCameraModifier : public UObject
{
	...
	// Function /Script/Engine.CameraModifier.OnCameraOwnerDestroyed (Underlying native function: OnCameraOwnerDestroyed 0x27a6d00)
	void OnCameraOwnerDestroyed(class AActor*& InOwner); // (Final | Native | Protected)

	// Function /Script/Engine.CameraModifier.IsDisabled (Underlying native function: IsDisabled 0x881445c)
	bool IsDisabled(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CameraModifier.GetViewTarget (Underlying native function: GetViewTarget 0x2e1dabc)
	class AActor* GetViewTarget(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.CameraModifier.EnableModifier (Underlying native function: EnableModifier 0x66e6c10)
	void EnableModifier(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.CameraModifier.DisableModifier (Underlying native function: DisableModifier 0x9aeec50)
