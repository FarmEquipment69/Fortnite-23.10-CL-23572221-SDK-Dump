...
class UFortGameplayAbilityAthena_PeriodicItemGrant : public UFortGameplayAbility
{
	...
	// Function /Script/FortniteGame.FortGameplayAbilityAthena_PeriodicItemGrant.StopItemAwardTimers (Underlying native function: StopItemAwardTimers 0x273fd14)
	void StopItemAwardTimers(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayAbilityAthena_PeriodicItemGrant.StartItemAwardTimers (Underlying native function: StartItemAwardTimers 0x273fd14)
