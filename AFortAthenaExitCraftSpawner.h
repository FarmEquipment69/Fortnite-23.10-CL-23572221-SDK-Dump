...
class AFortAthenaExitCraftSpawner : public AActor
{
	...
	// Function /Script/FortniteGame.FortAthenaExitCraftSpawner.StartExitCraftSpawnTimer (Underlying native function: StartExitCraftSpawnTimer 0x7fedc4c)
	void StartExitCraftSpawnTimer(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaExitCraftSpawner.DestroyBlockingActors (Underlying native function: DestroyBlockingActors 0x7feb510)
