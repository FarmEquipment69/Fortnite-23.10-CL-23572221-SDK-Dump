...
class UFortCreativeLevelManagementTabPanel : public UFortCreativeContentBrowserTabPanelBase
{
	...
	// Function /Script/FortniteUI.FortCreativeLevelManagementTabPanel.LevelListUpdated (Underlying native function: LevelListUpdated 0xa586028)
	void LevelListUpdated(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeLevelManagementTabPanel.HandleLevelDeleteClicked (Underlying native function: HandleLevelDeleteClicked 0xa585614)
	...
	// Function /Script/FortniteUI.FortCreativeLevelManagementTabPanel.ClearAllItems (Underlying native function: ClearAllItems 0xa58369c)
