...
class UFortAthenaAISpawnerDataComponent_AIBotAffiliation : public UFortAthenaAISpawnerDataComponent_AffiliationBase
{
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.SetOverrideTeamIndex (Underlying native function: SetOverrideTeamIndex 0xa1f7df8)
	void SetOverrideTeamIndex(int& InOverrideTeamIdx); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetTeamID (Underlying native function: GetTeamID 0xa1f6dd4)
	bool GetTeamID(int& OutTeamId); // (Native | Event | Public | HasOutParms | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetSquadID (Underlying native function: GetSquadID 0xa1f6d34)
