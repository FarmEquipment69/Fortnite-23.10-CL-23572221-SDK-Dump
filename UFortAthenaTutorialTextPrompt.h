...
class UFortAthenaTutorialTextPrompt : public UUserWidget
{
	...
	// Function /Script/FortniteUI.FortAthenaTutorialTextPrompt.NextButtonPressed (Underlying native function: NextButtonPressed 0xa85ae18)
	void NextButtonPressed(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortAthenaTutorialTextPrompt.DisplayTarget (Underlying native function: DisplayTarget 0x71e664c)
	void DisplayTarget(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteUI.FortAthenaTutorialTextPrompt.DisplayNextButton (Underlying native function: DisplayNextButton 0x71e6634)
	void DisplayNextButton(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteUI.FortAthenaTutorialTextPrompt.ActivateTextPrompt (Underlying native function: ActivateTextPrompt 0x71e81dc)
