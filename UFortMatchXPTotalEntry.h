...
class UFortMatchXPTotalEntry : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortMatchXPTotalEntry.InitializeXPCounter (Underlying native function: InitializeXPCounter 0xa3a1b40)
	void InitializeXPCounter(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortMatchXPTotalEntry.GetXPTarget (Underlying native function: GetXPTarget 0xa3a0384)
