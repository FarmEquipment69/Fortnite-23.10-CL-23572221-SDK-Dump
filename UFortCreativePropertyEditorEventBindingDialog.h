...
class UFortCreativePropertyEditorEventBindingDialog : public UFortCreativePropertyEditorDialogBase
{
	...
	// Function /Script/FortniteUI.FortCreativePropertyEditorEventBindingDialog.IsSearchEnabled (Underlying native function: IsSearchEnabled 0xa535994)
	static bool IsSearchEnabled(); // (Final | Native | Static | Protected | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.FortCreativePropertyEditorEventBindingDialog.HandleSearchTextChanged (Underlying native function: HandleSearchTextChanged 0xa53545c)
