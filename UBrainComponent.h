...
class UBrainComponent : public UActorComponent
{
	...
	// Function /Script/AIModule.BrainComponent.StopLogic (Underlying native function: StopLogic 0x9fef5f4)
	void StopLogic(struct FString& Reason); // (Native | Public | BlueprintCallable)

	// Function /Script/AIModule.BrainComponent.StartLogic (Underlying native function: StartLogic 0x2664ff8)
	void StartLogic(); // (Native | Public | BlueprintCallable)

	// Function /Script/AIModule.BrainComponent.RestartLogic (Underlying native function: RestartLogic 0x14211f8)
	void RestartLogic(); // (Native | Public | BlueprintCallable)

	// Function /Script/AIModule.BrainComponent.IsRunning (Underlying native function: IsRunning 0x71e7964)
	bool IsRunning(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/AIModule.BrainComponent.IsPaused (Underlying native function: IsPaused 0x71e793c)
