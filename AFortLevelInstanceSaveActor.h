...
class AFortLevelInstanceSaveActor : public AInfo
{
	...
	// Function /Script/FortniteGame.FortLevelInstanceSaveActor.Resave (Underlying native function: Resave 0x29e7b34)
	void Resave(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortLevelInstanceSaveActor.GetSize (Underlying native function: GetSize 0x8573898)
	...
	// Function /Script/FortniteGame.FortLevelInstanceSaveActor.GetLevelInstanceGuid (Underlying native function: GetLevelInstanceGuid 0x857323c)
	struct FGuid GetLevelInstanceGuid(); // (Final | 0x00000002 | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortLevelInstanceSaveActor.GetContentCollection (Underlying native function: GetContentCollection 0x8572a24)
	...
	// Function /Script/FortniteGame.FortLevelInstanceSaveActor.GetCachedActorCost (Underlying native function: GetCachedActorCost 0x2af7234)
