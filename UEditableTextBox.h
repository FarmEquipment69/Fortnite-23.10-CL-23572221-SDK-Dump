...
class UEditableTextBox : public UWidget
{
	...
	// Function /Script/UMG.EditableTextBox.SetTextOverflowPolicy (Underlying native function: SetTextOverflowPolicy 0x9920bcc)
	void SetTextOverflowPolicy(enum ETextOverflowPolicy& InOverflowPolicy); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetText (Underlying native function: SetText 0x9920ab0)
	void SetText(struct FText& InText); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetJustification (Underlying native function: SetJustification 0x991fc88)
	void SetJustification(struct TEnumAsByte<ETextJustify>& InJustification); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetIsReadOnly (Underlying native function: SetIsReadOnly 0x991fc08)
	void SetIsReadOnly(bool& bReadOnly); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetIsPassword (Underlying native function: SetIsPassword 0x991fb08)
	void SetIsPassword(bool& bIsPassword); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetHintText (Underlying native function: SetHintText 0x991f768)
	void SetHintText(struct FText& InText); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetForegroundColor (Underlying native function: SetForegroundColor 0x991f6b8)
	void SetForegroundColor(struct FLinearColor& Color); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/UMG.EditableTextBox.SetError (Underlying native function: SetError 0x991f4c0)
	...
	// Function /Script/UMG.EditableTextBox.HasError (Underlying native function: HasError 0x991e0e4)
	bool HasError(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/UMG.EditableTextBox.GetText (Underlying native function: GetText 0x991ddac)
	struct FText GetText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/UMG.EditableTextBox.ClearError (Underlying native function: ClearError 0x991ce98)
