...
class UARDependencyHandler : public UObject
{
	...
	// Function /Script/AugmentedReality.ARDependencyHandler.StartARSessionLatent (Underlying native function: StartARSessionLatent 0x95e431c)
	...
	// Function /Script/AugmentedReality.ARDependencyHandler.RequestARSessionPermission (Underlying native function: RequestARSessionPermission 0x95e2084)
	...
	// Function /Script/AugmentedReality.ARDependencyHandler.InstallARService (Underlying native function: InstallARService 0x95e1354)
	...
	// Function /Script/AugmentedReality.ARDependencyHandler.GetARDependencyHandler (Underlying native function: GetARDependencyHandler 0x95deac4)
	static class UARDependencyHandler* GetARDependencyHandler(); // (Final | Native | Static | Public | BlueprintCallable)

	// Function /Script/AugmentedReality.ARDependencyHandler.CheckARServiceAvailability (Underlying native function: CheckARServiceAvailability 0x95ddee4)
