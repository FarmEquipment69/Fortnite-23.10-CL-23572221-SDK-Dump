...
class AFortAthenaMutator_Bagel : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.RetrievePlayerFriendsLeaderBoard (Underlying native function: RetrievePlayerFriendsLeaderBoard 0x81d9830)
	void RetrievePlayerFriendsLeaderBoard(class AFortPlayerControllerAthena*& AthenaPC); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.ResetStreakScoreMultiplier (Underlying native function: ResetStreakScoreMultiplier 0x81d97b0)
	void ResetStreakScoreMultiplier(class AFortPlayerStateAthena*& PlayerState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OverrideStormMaterial (Underlying native function: OverrideStormMaterial 0x81d979c)
	void OverrideStormMaterial(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnScoreMultiplierInteractionCompleted (Underlying native function: OnScoreMultiplierInteractionCompleted 0x81d9614)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnSafeZoneUpdated (Underlying native function: OnSafeZoneUpdated 0x81d9600)
	void OnSafeZoneUpdated(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnRep_TeamScoreMultiplier (Underlying native function: OnRep_TeamScoreMultiplier 0x81d941c)
	void OnRepTeamScoreMultiplier(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnRep_PlayerData (Underlying native function: OnRep_PlayerData 0x81d939c)
	void OnRepPlayerData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnRep_CurrentPhase (Underlying native function: OnRep_CurrentPhase 0x81d9284)
	void OnRepCurrentPhase(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x81d894c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleRiftSpawned (Underlying native function: HandleRiftSpawned 0x81d8480)
	void HandleRiftSpawned(class UFortAIEncounterInfo*& Encounter, class ABuildingRift*& Rift); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleRiftDying (Underlying native function: HandleRiftDying 0x81d81cc)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleRiftDamaged (Underlying native function: HandleRiftDamaged 0x81d7f50)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleFinalPhaseAISpawned (Underlying native function: HandleFinalPhaseAISpawned 0x81d7e8c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleFinalPhaseAIDied (Underlying native function: HandleFinalPhaseAIDied 0x81d7c10)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleAISpawned (Underlying native function: HandleAISpawned 0x81d7a84)
	void HandleAISpawned(class UFortAIEncounterInfo*& Encounter, class AFortAIPawn*& SpawnedEnemy); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.HandleAIDied (Underlying native function: HandleAIDied 0x81d763c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.GetPlayerScore (Underlying native function: GetPlayerScore 0x81d7420)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bagel.GetPlayerBestScore (Underlying native function: GetPlayerBestScore 0x81d7208)
