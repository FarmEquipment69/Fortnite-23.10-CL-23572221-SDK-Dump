...
class UFortAthenaAIBotEvaluator_Movement : public UFortAthenaAIBotEvaluator
{
	...
	// Function /Script/FortniteAI.FortAthenaAIBotEvaluator_Movement.OnCurrentUnstuckSteeringAttemptFinished (Underlying native function: OnCurrentUnstuckSteeringAttemptFinished 0xa1ba5d8)
	void OnCurrentUnstuckSteeringAttemptFinished(enum EBotUnstuckSteeringReason& UnstuckSteeringReason); // (Final | Native | Private)

	// Function /Script/FortniteAI.FortAthenaAIBotEvaluator_Movement.EvaluateIsolatedIslandSteering (Underlying native function: EvaluateIsolatedIslandSteering 0xa1ba430)
