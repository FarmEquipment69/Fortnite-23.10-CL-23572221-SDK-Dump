...
class UFortMobileActionButtonBehavior_CreativeScaleAxis : public UFortMobileActionButtonBehavior
{
	...
	// Function /Script/FortniteUI.FortMobileActionButtonBehavior_CreativeScaleAxis.HandleWeaponEquipped (Underlying native function: HandleWeaponEquipped 0xa45c8b0)
	void HandleWeaponEquipped(class AFortWeapon*& NewWeapon, class AFortWeapon*& PreviousWeapon); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortMobileActionButtonBehavior_CreativeScaleAxis.HandleMoveToolScaleAxisChanged (Underlying native function: HandleMoveToolScaleAxisChanged 0xa45c4cc)
