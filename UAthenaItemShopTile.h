...
class UAthenaItemShopTile : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.AthenaItemShopTile.ShowNextPresentation (Underlying native function: ShowNextPresentation 0xa3ce750)
	...
	// Function /Script/FortniteUI.AthenaItemShopTile.IsUsingLargeLayout (Underlying native function: IsUsingLargeLayout 0xa3cd5e4)
	bool IsUsingLargeLayout(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaItemShopTile.HandleLocalAccountInfoChanged (Underlying native function: HandleLocalAccountInfoChanged 0xa3ccc74)
	void HandleLocalAccountInfoChanged(struct FFortPrivateAccountInfo& NewInfo); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaItemShopTile.GetLegacyDisplayAsset (Underlying native function: GetLegacyDisplayAsset 0xa3cbcac)
