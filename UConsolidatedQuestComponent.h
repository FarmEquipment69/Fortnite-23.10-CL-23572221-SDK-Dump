...
class UConsolidatedQuestComponent : public USceneComponent
{
	...
	// Function /Script/FortniteGame.ConsolidatedQuestComponent.UpdateCompletedForPlayer (Underlying native function: UpdateCompletedForPlayer 0x843e284)
	...
	// Function /Script/FortniteGame.ConsolidatedQuestComponent.SetQuestItemDefinition (Underlying native function: SetQuestItemDefinition 0x843e204)
	void SetQuestItemDefinition(class UFortQuestItemDefinition*& InQuestItemDefinition); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.ConsolidatedQuestComponent.SetObjectiveBackendName (Underlying native function: SetObjectiveBackendName 0x843e178)
	...
	// Function /Script/FortniteGame.ConsolidatedQuestComponent.OnPlaylistDataReady (Underlying native function: OnPlaylistDataReady 0x843db30)
	...
	// Function /Script/FortniteGame.ConsolidatedQuestComponent.OnCalendarUpdated (Underlying native function: OnCalendarUpdated 0x843db1c)
	void OnCalendarUpdated(); // (Final | Native | Private)

	// Function /Script/FortniteGame.ConsolidatedQuestComponent.IsInteractable (Underlying native function: IsInteractable 0x843d93c)
	bool IsInteractable(class AFortPlayerController*& InteractingController); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.ConsolidatedQuestComponent.GetQuestItemDefinition (Underlying native function: GetQuestItemDefinition 0x66b6cf0)
	class UFortQuestItemDefinition* GetQuestItemDefinition(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.ConsolidatedQuestComponent.Editor_GetValidObjectives (Underlying native function: Editor_GetValidObjectives 0x6f661c0)
