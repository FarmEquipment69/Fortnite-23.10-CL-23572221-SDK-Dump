...
class UFortAthenaMatchmakingWidgetLegacy : public UFortMatchmakingWidgetBase
{
	...
	bool bRetryDownloadLinkDataBeforeDisabling; // 0x4d1 (0x1)
	unsigned char padding_4d2[0x6]; // 0x4d2 (0x6)
	...
	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.IsSquadFillEnabled (Underlying native function: IsSquadFillEnabled 0xa55c0c8)
	bool IsSquadFillEnabled(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.IsPrivateMatchEnabled (Underlying native function: IsPrivateMatchEnabled 0xa55c04c)
	bool IsPrivateMatchEnabled(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.HandleMatchMakingModeCalled (Underlying native function: HandleMatchMakingModeCalled 0xa55b588)
	void HandleMatchMakingModeCalled(struct FString& IslandMnemonic, struct FName& InPlaylistName); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.GetPrivateMatchText (Underlying native function: GetPrivateMatchText 0xa55abe0)
	struct FText GetPrivateMatchText(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.GetFillStatusText (Underlying native function: GetFillStatusText 0x2771038)
	struct FText GetFillStatusText(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.GetButtonPublicMatchText (Underlying native function: GetButtonPublicMatchText 0xa55a148)
	struct FText GetButtonPublicMatchText(); // (Native | Event | Protected | BlueprintEvent | Const)

	// Function /Script/FortniteUI.FortAthenaMatchmakingWidgetLegacy.GetButtonPrivateMatchText (Underlying native function: GetButtonPrivateMatchText 0xa55a0c8)
