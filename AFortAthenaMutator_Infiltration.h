...
class AFortAthenaMutator_Infiltration : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Infiltration.OnRep_ModeState (Underlying native function: OnRep_ModeState 0x82275d0)
	void OnRepModeState(struct FInfiltrationModeState& OldState); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Infiltration.GetDefendingTeam (Underlying native function: GetDefendingTeam 0x822438c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Infiltration.GetAttackingTeam (Underlying native function: GetAttackingTeam 0x8224240)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Infiltration.FinishRoundIntro (Underlying native function: FinishRoundIntro 0x82241c0)
