...
class ADefaultPawn : public APawn
{
	...
	// Function /Script/Engine.DefaultPawn.TurnAtRate (Underlying native function: TurnAtRate 0x9b993a0)
	void TurnAtRate(float& Rate); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.DefaultPawn.MoveUp_World (Underlying native function: MoveUp_World 0x9b991d4)
	void MoveUpWorld(float& Val); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.DefaultPawn.MoveRight (Underlying native function: MoveRight 0x9b9914c)
	void MoveRight(float& Val); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.DefaultPawn.MoveForward (Underlying native function: MoveForward 0x9b990c4)
	void MoveForward(float& Val); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.DefaultPawn.LookUpAtRate (Underlying native function: LookUpAtRate 0x9b9903c)
