...
class UBuildingEditModeSupport : public UObject
{
	...
	// Function /Script/FortniteGame.BuildingEditModeSupport.OnSuccessfulMatchInteractParamUpdate (Underlying native function: OnSuccessfulMatchInteractParamUpdate 0x68ea320)
	void OnSuccessfulMatchInteractParamUpdate(float& NewInteractParamVal); // (Native | Public)

	// Function /Script/FortniteGame.BuildingEditModeSupport.OnSuccessfulMatchInteractComplete (Underlying native function: OnSuccessfulMatchInteractComplete 0x6ffbf00)
