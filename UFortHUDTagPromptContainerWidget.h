...
class UFortHUDTagPromptContainerWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortHUDTagPromptContainerWidget.RequestPromptDataActivation (Underlying native function: RequestPromptDataActivation 0xa586ff4)
	...
	// Function /Script/FortniteUI.FortHUDTagPromptContainerWidget.OpenWidget (Underlying native function: OpenWidget 0xa586768)
	void OpenWidget(struct FFortHUDTagPromptData& PrompData); // (Final | Native | Public | HasOutParms)

	// Function /Script/FortniteUI.FortHUDTagPromptContainerWidget.OnWidgetBaseOpenedOrClosed (Underlying native function: OnWidgetBaseOpenedOrClosed 0xa5866c8)
	void OnWidgetBaseOpenedOrClosed(bool& bNewlyOpened); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortHUDTagPromptContainerWidget.CloseWidget (Underlying native function: CloseWidget 0xa58376c)
