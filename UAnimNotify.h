...
class UAnimNotify : public UObject
{
	...
	// Function /Script/Engine.AnimNotify.GetNotifyName (Underlying native function: GetNotifyName 0x9aaab40)
	struct FString GetNotifyName(); // (Native | Event | Public | BlueprintEvent | Const)

	// Function /Script/Engine.AnimNotify.GetDefaultTriggerWeightThreshold (Underlying native function: GetDefaultTriggerWeightThreshold 0x9aaa9f4)
