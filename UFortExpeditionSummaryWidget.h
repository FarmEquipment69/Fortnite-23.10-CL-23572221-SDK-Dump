...
class UFortExpeditionSummaryWidget : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortExpeditionSummaryWidget.UnbindInventoryDelegates (Underlying native function: UnbindInventoryDelegates 0x721d564)
	void UnbindInventoryDelegates(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortExpeditionSummaryWidget.OnRefreshSummaryWidget (Underlying native function: OnRefreshSummaryWidget 0x71e81dc)
	void OnRefreshSummaryWidget(); // (Native | Event | Protected | BlueprintEvent)

	// Function /Script/SaveTheWorldUI.FortExpeditionSummaryWidget.BindInventoryDelegates (Underlying native function: BindInventoryDelegates 0x72198e0)
