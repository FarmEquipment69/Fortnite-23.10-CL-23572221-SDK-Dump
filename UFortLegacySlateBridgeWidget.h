...
class UFortLegacySlateBridgeWidget : public UNativeWidgetHost
{
	...
	// Function /Script/FortniteUI.FortLegacySlateBridgeWidget.UpdateSlateWidget (Underlying native function: UpdateSlateWidget 0xa5b3614)
	void UpdateSlateWidget(enum EFortLegacySlateWidget& SlateWidgetType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortLegacySlateBridgeWidget.SetOnCloseHandler (Underlying native function: SetOnCloseHandler 0xa5b2ddc)
