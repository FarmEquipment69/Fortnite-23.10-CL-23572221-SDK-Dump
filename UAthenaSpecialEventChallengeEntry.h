...
class UAthenaSpecialEventChallengeEntry : public UAthenaChallengeEntry
{
	...
	// Function /Script/FortniteUI.AthenaSpecialEventChallengeEntry.HandleOnPlayerBountyThreatLevelUpdated (Underlying native function: HandleOnPlayerBountyThreatLevelUpdated 0xa3a0e3c)
	void HandleOnPlayerBountyThreatLevelUpdated(enum EPlayerBountyThreatLevel& NewPlayerBountyThreatLeve); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpecialEventChallengeEntry.HandleOnPlayerBountyThreatLevelEnded (Underlying native function: HandleOnPlayerBountyThreatLevelEnded 0xa3a0e28)
