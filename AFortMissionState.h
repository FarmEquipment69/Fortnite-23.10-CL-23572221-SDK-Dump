...
class AFortMissionState : public AActor
{
	...
	// Function /Script/FortniteGame.FortMissionState.UpdateUI (Underlying native function: UpdateUI 0x2466474)
	void UpdateUI(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMissionState.SetTimerForOnAllPlayersLoadedIn (Underlying native function: SetTimerForOnAllPlayersLoadedIn 0x88eec74)
	void SetTimerForOnAllPlayersLoadedIn(float& Timer); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortMissionState.SendMissionUIEvent (Underlying native function: SendMissionUIEvent 0x88ed4b0)
	...
	// Function /Script/FortniteGame.FortMissionState.OnAllPlayersLoadedInWrapper (Underlying native function: OnAllPlayersLoadedInWrapper 0x88ec8c0)
