...
class AFortAthenaMutator_GenerateOverlapEventsOverride : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GenerateOverlapEventsOverride.SetRadius (Underlying native function: SetRadius 0x822817c)
	void SetRadius(float& NewRadius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_GenerateOverlapEventsOverride.SetCenterLocation (Underlying native function: SetCenterLocation 0x82280f4)
