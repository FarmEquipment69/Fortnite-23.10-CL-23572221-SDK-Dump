...
class ABuildingItemCollectorActor : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.SetLootSpawnWorldTransformOverride (Underlying native function: SetLootSpawnWorldTransformOverride 0x8388ab0)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.SetItemCollectorState (Underlying native function: SetItemCollectorState 0x838892c)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.ServerSpawnItem (Underlying native function: ServerSpawnItem 0x8388348)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.RefreshCollectorsActiveItem (Underlying native function: RefreshCollectorsActiveItem 0x83552a0)
	void RefreshCollectorsActiveItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.OnRep_TrackedInteractionData (Underlying native function: OnRep_TrackedInteractionData 0x83552a0)
	void OnRepTrackedInteractionData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.OnRep_ItemCollectorState (Underlying native function: OnRep_ItemCollectorState 0x838783c)
	void OnRepItemCollectorState(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.OnRep_ControllingPlayer (Underlying native function: OnRep_ControllingPlayer 0x8387768)
	void OnRepControllingPlayer(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.OnRep_ActiveInputItem (Underlying native function: OnRep_ActiveInputItem 0x83552a0)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.HasEnoughDepositItems (Underlying native function: HasEnoughDepositItems 0x8385990)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetTeamReachedGoalCount (Underlying native function: GetTeamReachedGoalCount 0x8384a5c)
	int GetTeamReachedGoalCount(unsigned char& InTeam); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetOverrideRarity (Underlying native function: GetOverrideRarity 0x8384914)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetNumberOfCaptures (Underlying native function: GetNumberOfCaptures 0x838461c)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetDepositGoal (Underlying native function: GetDepositGoal 0x838403c)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetDepositAmount (Underlying native function: GetDepositAmount 0x8383f60)
	...
	// Function /Script/FortniteGame.BuildingItemCollectorActor.GetCurrentActiveItem (Underlying native function: GetCurrentActiveItem 0x8383ea0)
	class UFortWorldItemDefinition* GetCurrentActiveItem(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.BuildingItemCollectorActor.ClearLootSpawnWorldTransformOverride (Underlying native function: ClearLootSpawnWorldTransformOverride 0x8382f8c)
