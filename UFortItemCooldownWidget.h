...
class UFortItemCooldownWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortItemCooldownWidget.TryStartUpdateCooldown_BP (Underlying native function: TryStartUpdateCooldown_BP 0xa5b34ac)
	void TryStartUpdateCooldownBP(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemCooldownWidget.SetItem (Underlying native function: SetItem 0xa5b28b8)
	void SetItem(class UFortWorldItem*& InWorldItem); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemCooldownWidget.OnWorldItemDestroyed (Underlying native function: OnWorldItemDestroyed 0xa5b187c)
	...
	// Function /Script/FortniteUI.FortItemCooldownWidget.HandleLocalPlayerRevived (Underlying native function: HandleLocalPlayerRevived 0xa5afaf8)
	void HandleLocalPlayerRevived(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortItemCooldownWidget.HandleLocalPlayerDied (Underlying native function: HandleLocalPlayerDied 0xa5afa48)
