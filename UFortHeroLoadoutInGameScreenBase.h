...
class UFortHeroLoadoutInGameScreenBase : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortHeroLoadoutInGameScreenBase.GetGadgetDefinitionBySlot (Underlying native function: GetGadgetDefinitionBySlot 0x721a548)
