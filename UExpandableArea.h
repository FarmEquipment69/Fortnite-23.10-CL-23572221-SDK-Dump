...
class UExpandableArea : public UWidget
{
	...
	// Function /Script/UMG.ExpandableArea.SetIsExpanded_Animated (Underlying native function: SetIsExpanded_Animated 0x9940660)
	void SetIsExpandedAnimated(bool& IsExpanded); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.ExpandableArea.SetIsExpanded (Underlying native function: SetIsExpanded 0x99405d4)
	void SetIsExpanded(bool& IsExpanded); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.ExpandableArea.GetIsExpanded (Underlying native function: GetIsExpanded 0x993c350)
