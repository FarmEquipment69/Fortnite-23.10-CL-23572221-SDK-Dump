...
class AFortAthenaMutator_LoadoutSwap : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_LoadoutSwap.OnRep_ServerWorldTimeOfNextSwap (Underlying native function: OnRep_ServerWorldTimeOfNextSwap 0x82276f0)
	void OnRepServerWorldTimeOfNextSwap(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_LoadoutSwap.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x82269d0)
