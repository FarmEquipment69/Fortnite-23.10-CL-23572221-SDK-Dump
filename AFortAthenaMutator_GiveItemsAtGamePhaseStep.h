...
class AFortAthenaMutator_GiveItemsAtGamePhaseStep : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GiveItemsAtGamePhaseStep.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x8226b34)
