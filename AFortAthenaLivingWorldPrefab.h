...
class AFortAthenaLivingWorldPrefab : public ABuildingLevelInstance
{
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.RemoveFoliageInsideLevelBound (Underlying native function: RemoveFoliageInsideLevelBound 0x298fcec)
	void RemoveFoliageInsideLevelBound(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.OnRep_ShouldLevelBeVisible (Underlying native function: OnRep_ShouldLevelBeVisible 0x1871800)
	void OnRepShouldLevelBeVisible(); // (Final | Native | Protected)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.OnLevelShown (Underlying native function: OnLevelShown 0x6e90a3c)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.MakeLevelVisible (Underlying native function: MakeLevelVisible 0x6e8f758)
	void MakeLevelVisible(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.GetOwningLivingWorldPrefab (Underlying native function: GetOwningLivingWorldPrefab 0x6e8e500)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.GetLevelBounds (Underlying native function: GetLevelBounds 0x6e8e250)
	struct FBox GetLevelBounds(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.DestroyBuildingsInLevelBounds (Underlying native function: DestroyBuildingsInLevelBounds 0x6e8df2c)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.CallWhenAllActorHaveSpawned (Underlying native function: CallWhenAllActorHaveSpawned 0x6e8ddf8)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefab.AllowSpawnerToSpawn (Underlying native function: AllowSpawnerToSpawn 0x6e8dc1c)
