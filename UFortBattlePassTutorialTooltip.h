...
class UFortBattlePassTutorialTooltip : public UCommonUserWidget
{
	...
	// Function /Script/BattlePassBase.FortBattlePassTutorialTooltip.SetTooltipEnabled (Underlying native function: SetTooltipEnabled 0x6ec7ec8)
	void SetTooltipEnabled(bool& bEnable); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/BattlePassBase.FortBattlePassTutorialTooltip.SetText (Underlying native function: SetText 0x6ec7dbc)
