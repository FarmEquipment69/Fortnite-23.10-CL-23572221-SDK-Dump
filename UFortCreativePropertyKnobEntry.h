...
class UFortCreativePropertyKnobEntry : public UCommonButtonBase
{
	...
	// Function /Script/FortniteUI.FortCreativePropertyKnobEntry.SetIsModified (Underlying native function: SetIsModified 0xa5363ec)
	...
	// Function /Script/FortniteUI.FortCreativePropertyKnobEntry.GetIsModified (Underlying native function: GetIsModified 0xa5340d4)
	bool GetIsModified(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.FortCreativePropertyKnobEntry.ForceFocusWidget (Underlying native function: ForceFocusWidget 0xa533d38)
	void ForceFocusWidget(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePropertyKnobEntry.ClearModified (Underlying native function: ClearModified 0xa5339fc)
