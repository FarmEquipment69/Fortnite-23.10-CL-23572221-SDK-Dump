...
class UFortSidebarButtons : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortSidebarButtons.HandleSettingsSavedTabChanged (Underlying native function: HandleSettingsSavedTabChanged 0xa6175d0)
	void HandleSettingsSavedTabChanged(bool& IsTabSaved); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortSidebarButtons.HandlePrevTabAction_STW (Underlying native function: HandlePrevTabAction_STW 0xa61754c)
	void HandlePrevTabActionSTW(bool& bPassThrough); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortSidebarButtons.HandleNextTabAction_STW (Underlying native function: HandleNextTabAction_STW 0xa6173b8)
	void HandleNextTabActionSTW(bool& bPassThrough); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortSidebarButtons.HandleButtonGroupOnHoveredChanged (Underlying native function: HandleButtonGroupOnHoveredChanged 0x27849c4)
	void HandleButtonGroupOnHoveredChanged(class UCommonButtonLegacy*& HoveredButton, int& ButtonIdx); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortSidebarButtons.GetSelectedSidebarButton (Underlying native function: GetSelectedSidebarButton 0xa616f84)
	class UWidget* GetSelectedSidebarButton(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortSidebarButtons.GetHoveredSidebarButton (Underlying native function: GetHoveredSidebarButton 0x6e5d6e8)
	class UWidget* GetHoveredSidebarButton(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortSidebarButtons.GetFocusedSidebarButton (Underlying native function: GetFocusedSidebarButton 0x8c63a30)
