...
class UAthenaIndicatorLayerBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaIndicatorLayerBase.OnTargetChangedNative (Underlying native function: OnTargetChangedNative 0x26d27b8)
	void OnTargetChangedNative(bool& bTargeting); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaIndicatorLayerBase.HandleIndicatorModeChanged (Underlying native function: HandleIndicatorModeChanged 0xa2c6e18)
