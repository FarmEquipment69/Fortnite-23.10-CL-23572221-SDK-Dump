...
class AFortAthenaMutator_StreamDistanceOverride : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_StreamDistanceOverride.HandleGamePhaseChanged (Underlying native function: HandleGamePhaseChanged 0x81d85d4)
