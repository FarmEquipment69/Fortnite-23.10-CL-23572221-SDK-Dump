...
class UFortGameActivity : public UObject
{
	...
	// Function /Script/FortniteGame.FortGameActivity.GetPreviewPath (Underlying native function: GetPreviewPath 0x8661de4)
	...
	// Function /Script/FortniteGame.FortGameActivity.GetIsFavorite (Underlying native function: GetIsFavorite 0x8661db4)
	bool GetIsFavorite(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameActivity.GetActivityDescriptionTags (Underlying native function: GetActivityDescriptionTags 0x8661c54)
