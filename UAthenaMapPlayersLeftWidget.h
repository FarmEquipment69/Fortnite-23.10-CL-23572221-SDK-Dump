...
class UAthenaMapPlayersLeftWidget : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaMapPlayersLeftWidget.HandleTeamsLeftChanged (Underlying native function: HandleTeamsLeftChanged 0xa423408)
	void HandleTeamsLeftChanged(int& NumTeamsLeft); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaMapPlayersLeftWidget.HandlePlayersLeftChanged (Underlying native function: HandlePlayersLeftChanged 0xa422f34)
