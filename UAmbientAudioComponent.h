...
class UAmbientAudioComponent : public UAudioGameplayComponent
{
	...
	// Function /Script/AmbientAudio.AmbientAudioComponent.SetPriority (Underlying native function: SetPriority 0x70cab28)
	void SetPriority(int& InPriority); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioComponent.SetCrossfadeTime (Underlying native function: SetCrossfadeTime 0x70caaa4)
	void SetCrossfadeTime(float& InCrossfadeTime); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AmbientAudio.AmbientAudioComponent.SetAmbientAsset (Underlying native function: SetAmbientAsset 0x70caa14)
