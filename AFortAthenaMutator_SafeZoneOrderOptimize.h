...
class AFortAthenaMutator_SafeZoneOrderOptimize : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SafeZoneOrderOptimize.OnRep_ChosenRouteOrder (Underlying native function: OnRep_ChosenRouteOrder 0x8263600)
