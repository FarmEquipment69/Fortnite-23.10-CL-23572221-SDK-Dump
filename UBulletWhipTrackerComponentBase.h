...
class UBulletWhipTrackerComponentBase : public UActorComponent
{
	...
	// Function /Script/FortniteGame.BulletWhipTrackerComponentBase.UpdateVelocity (Underlying native function: UpdateVelocity 0x8c43934)
	...
	// Function /Script/FortniteGame.BulletWhipTrackerComponentBase.Reset (Underlying native function: Reset 0x8c425bc)
	void Reset(struct FVector& StartLocationIn); // (Final | BlueprintAuthorityOnly | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.BulletWhipTrackerComponentBase.Disable (Underlying native function: Disable 0x8c4021c)
