...
class ACustomCosmeticCharmModifier : public ACustomCosmeticModifierBase
{
	...
	// Function /Script/FortniteGame.CustomCosmeticCharmModifier.GetSkeletalMeshForAssociatedPlayerPawnCharmType (Underlying native function: GetSkeletalMeshForAssociatedPlayerPawnCharmType 0x85cab24)
	...
	// Function /Script/FortniteGame.CustomCosmeticCharmModifier.GetCharmOwner (Underlying native function: GetCharmOwner 0x2c8ae8c)
	class AFortPlayerCharm* GetCharmOwner(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCosmeticCharmModifier.GetCharacterCharmType (Underlying native function: GetCharacterCharmType 0x6e5d700)
	struct TEnumAsByte<EFortCustomCharmType> GetCharacterCharmType(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCosmeticCharmModifier.ForceResetParticleSystems (Underlying native function: ForceResetParticleSystems 0x85cab10)
