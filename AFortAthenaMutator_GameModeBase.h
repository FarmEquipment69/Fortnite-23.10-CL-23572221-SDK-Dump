...
class AFortAthenaMutator_GameModeBase : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.OnPlaylistLoaded (Underlying native function: OnPlaylistLoaded 0x8227420)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x82270a8)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x8226a50)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x822684c)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.HandleEndMatchStingerWaitingOnPlacement_Local (Underlying native function: HandleEndMatchStingerWaitingOnPlacement_Local 0x822557c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_GameModeBase.GetPOINameForTag (Underlying native function: GetPOINameForTag 0x8224560)
