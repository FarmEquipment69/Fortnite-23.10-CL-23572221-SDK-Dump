...
class UFortQuestTrackerSubEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortQuestTrackerSubEntry.NotifyCompletionAnimationFinished (Underlying native function: NotifyCompletionAnimationFinished 0xa760d18)
	void NotifyCompletionAnimationFinished(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuestTrackerSubEntry.HandleQuestsUpdated (Underlying native function: HandleQuestsUpdated 0xa760ac0)
