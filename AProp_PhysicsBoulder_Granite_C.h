...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0xf78 (0x8)
	class UNiagaraSystem* NSRollingEffects; // 0xf80 (0x8)
	struct FName RollingEffectsVector3VarName; // 0xf88 (0x4)
