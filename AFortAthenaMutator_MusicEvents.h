...
class AFortAthenaMutator_MusicEvents : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MusicEvents.OnGamePhaseStepChanged (Underlying native function: OnGamePhaseStepChanged 0x824a510)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MusicEvents.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x81d85d4)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_MusicEvents.HandleWaitingOnPlacement_Spectate (Underlying native function: HandleWaitingOnPlacement_Spectate 0x824a014)
	void HandleWaitingOnPlacementSpectate(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_MusicEvents.HandleWaitingOnPlacement_Local (Underlying native function: HandleWaitingOnPlacement_Local 0x8249f58)
