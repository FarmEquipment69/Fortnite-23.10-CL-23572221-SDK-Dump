...
class AControlRigShapeActor : public AActor
{
	...
	// Function /Script/ControlRig.ControlRigShapeActor.SetSelected (Underlying native function: SetSelected 0x77af784)
	void SetSelected(bool& bInSelected); // (Native | Public | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigShapeActor.SetSelectable (Underlying native function: SetSelectable 0x77af700)
	void SetSelectable(bool& bInSelectable); // (Native | Public | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigShapeActor.SetHovered (Underlying native function: SetHovered 0x77af014)
	void SetHovered(bool& bInHovered); // (Native | Public | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigShapeActor.SetGlobalTransform (Underlying native function: SetGlobalTransform 0x77aee84)
	void SetGlobalTransform(struct FTransform& InTransform); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/ControlRig.ControlRigShapeActor.SetEnabled (Underlying native function: SetEnabled 0x77aee00)
	...
	// Function /Script/ControlRig.ControlRigShapeActor.IsSelectedInEditor (Underlying native function: IsSelectedInEditor 0x77ad00c)
	bool IsSelectedInEditor(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/ControlRig.ControlRigShapeActor.IsHovered (Underlying native function: IsHovered 0x77acfe4)
	bool IsHovered(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/ControlRig.ControlRigShapeActor.IsEnabled (Underlying native function: IsEnabled 0x77acfbc)
	bool IsEnabled(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/ControlRig.ControlRigShapeActor.GetGlobalTransform (Underlying native function: GetGlobalTransform 0x77abebc)
