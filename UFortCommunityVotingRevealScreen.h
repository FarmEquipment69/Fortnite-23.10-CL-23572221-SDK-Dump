...
class UFortCommunityVotingRevealScreen : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCommunityVotingRevealScreen.HandleDetailButtonClicked (Underlying native function: HandleDetailButtonClicked 0xa3f9e00)
	void HandleDetailButtonClicked(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCommunityVotingRevealScreen.HandleCloseButtonClicked (Underlying native function: HandleCloseButtonClicked 0xa3f9a5c)
	void HandleCloseButtonClicked(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCommunityVotingRevealScreen.Dismiss (Underlying native function: Dismiss 0xa3f8c94)
