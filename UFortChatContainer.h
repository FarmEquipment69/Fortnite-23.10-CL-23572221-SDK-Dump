...
class UFortChatContainer : public USocialChatContainer
{
	...
	// Function /Script/FortniteUI.FortChatContainer.IsTextChatRestricted (Underlying native function: IsTextChatRestricted 0xa55c148)
	bool IsTextChatRestricted(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortChatContainer.HandleGetMenuContentForAnchor (Underlying native function: HandleGetMenuContentForAnchor 0x88c35bc)
	class UUserWidget* HandleGetMenuContentForAnchor(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortChatContainer.GetTextChatDisabledText (Underlying native function: GetTextChatDisabledText 0xa55afb0)
