...
class UFortActivityDetailsModal : public UFortActivityView
{
	...
	// Function /Script/FortniteUI.FortActivityDetailsModal.IsModeSetActivity (Underlying native function: IsModeSetActivity 0xa535958)
	bool IsModeSetActivity(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsModal.IsLocalPlayerPartyLeader (Underlying native function: IsLocalPlayerPartyLeader 0xa5358d0)
	bool IsLocalPlayerPartyLeader(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsModal.GetInvalidActivityReason (Underlying native function: GetInvalidActivityReason 0xa5340a8)
