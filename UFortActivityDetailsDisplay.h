...
class UFortActivityDetailsDisplay : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortActivityDetailsDisplay.ToggleFavorite (Underlying native function: ToggleFavorite 0xa53698c)
	...
	// Function /Script/FortniteUI.FortActivityDetailsDisplay.OnOutroAnimationFinished (Underlying native function: OnOutroAnimationFinished 0xa535b44)
	...
	// Function /Script/FortniteUI.FortActivityDetailsDisplay.IsDownloadRequired (Underlying native function: IsDownloadRequired 0xa5358ac)
	bool IsDownloadRequired(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.IsDisplayingCategory (Underlying native function: IsDisplayingCategory 0xa535894)
	bool IsDisplayingCategory(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.IsActivityEpicOriginal (Underlying native function: IsActivityEpicOriginal 0xa535870)
	bool IsActivityEpicOriginal(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.GetInvalidActivityReason (Underlying native function: GetInvalidActivityReason 0xa534084)
	enum EFortInvalidActivityReason GetInvalidActivityReason(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.GetCreatorTextFormat (Underlying native function: GetCreatorTextFormat 0xa533e20)
	struct FText GetCreatorTextFormat(struct FText& CreatorName); // (Native | Event | Protected | HasOutParms | BlueprintEvent)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.GetContentWarningStrings (Underlying native function: GetContentWarningStrings 0xa533d70)
	struct TArray<struct FString> GetContentWarningStrings(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivityDetailsDisplay.AcceptActivity (Underlying native function: AcceptActivity 0xa347e80)
