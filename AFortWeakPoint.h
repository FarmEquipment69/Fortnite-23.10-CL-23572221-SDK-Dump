...
class AFortWeakPoint : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.FortWeakPoint.OnRep_WeakPointState (Underlying native function: OnRep_WeakPointState 0x8e0ec04)
	void OnRepWeakPointState(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortWeakPoint.GetWeakPointState (Underlying native function: GetWeakPointState 0x8e0d2e4)
	enum EFortWeakPointState GetWeakPointState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortWeakPoint.GetWeakPointAttachmentSocketName (Underlying native function: GetWeakPointAttachmentSocketName 0x8e0d2cc)
	struct FName GetWeakPointAttachmentSocketName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortWeakPoint.GetAimAssistTargetComponent (Underlying native function: GetAimAssistTargetComponent 0x7f96988)
