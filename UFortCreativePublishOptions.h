...
class UFortCreativePublishOptions : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativePublishOptions.UpdateTimeSinceLastBackup (Underlying native function: UpdateTimeSinceLastBackup 0xa588ba0)
	void UpdateTimeSinceLastBackup(struct FDateTime*& LastBackup); // (Final | Native | Public | HasDefaults)

	// Function /Script/FortniteUI.FortCreativePublishOptions.UpdatePermissions (Underlying native function: UpdatePermissions 0xa588a60)
	void UpdatePermissions(enum EFortCreativePlotPermission& Permissions); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteUI.FortCreativePublishOptions.RestoreMyIslandFromBackup (Underlying native function: RestoreMyIslandFromBackup 0xa5872fc)
	void RestoreMyIslandFromBackup(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePublishOptions.ResetMyCurrentCreativePlot (Underlying native function: ResetMyCurrentCreativePlot 0xa58727c)
	void ResetMyCurrentCreativePlot(); // (Final | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteUI.FortCreativePublishOptions.OptInForDeviceUpgrades (Underlying native function: OptInForDeviceUpgrades 0xa5868f8)
	...
	// Function /Script/FortniteUI.FortCreativePublishOptions.InitializeData (Underlying native function: InitializeData 0x182d3cc)
	void InitializeData(); // (Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePublishOptions.ConvertToEvents (Underlying native function: ConvertToEvents 0xa583780)
	void ConvertToEvents(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativePublishOptions.CheckpointSaveStateChanged (Underlying native function: CheckpointSaveStateChanged 0xa583608)
	void CheckpointSaveStateChanged(enum EBackupSaveState& SaveState); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortCreativePublishOptions.CheckpointRestoreStateChanged (Underlying native function: CheckpointRestoreStateChanged 0xa583588)
	void CheckpointRestoreStateChanged(enum EBackupSaveState& SaveState); // (Final | Native | Public)

	// Function /Script/FortniteUI.FortCreativePublishOptions.BackupMyIsland (Underlying native function: BackupMyIsland 0xa5831bc)
