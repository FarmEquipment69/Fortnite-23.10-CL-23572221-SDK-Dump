...
class UFortCreativeRichTextEditorWidget : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.ShowConfirmationDialog (Underlying native function: ShowConfirmationDialog 0xa536818)
	void ShowConfirmationDialog(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.SetEntryCharLimit (Underlying native function: SetEntryCharLimit 0xa536270)
	void SetEntryCharLimit(int& InCharLimit); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.SetAllowStyleEditing (Underlying native function: SetAllowStyleEditing 0xa19d0d8)
	void SetAllowStyleEditing(bool& InAllowStyleEditing); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.SetAllowLineBreaks (Underlying native function: SetAllowLineBreaks 0xa536170)
	...
	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.IsStyleEditorEnabled (Underlying native function: IsStyleEditorEnabled 0xa5359d0)
	static bool IsStyleEditorEnabled(); // (Final | Native | Static | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.HandleWordButtonClicked (Underlying native function: HandleWordButtonClicked 0xa5357dc)
	void HandleWordButtonClicked(class UFortCreativeRichTextWordButton*& Button); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.HandleTextChanged (Underlying native function: HandleTextChanged 0xa5356a0)
	void HandleTextChanged(struct FText& Text); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.HandleTabButtonSelected (Underlying native function: HandleTabButtonSelected 0xa5355dc)
	void HandleTabButtonSelected(class UCommonButtonBase*& AssociatedButton, int& ButtonIndex); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.HandleStyleButtonClicked (Underlying native function: HandleStyleButtonClicked 0xa535518)
	void HandleStyleButtonClicked(class UCommonButtonBase*& Button, int& Index); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.GetConfirmationDialogWidget (Underlying native function: GetConfirmationDialogWidget 0xa533d4c)
	class UAthenaConfirmationWindow* GetConfirmationDialogWidget(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeRichTextEditorWidget.CanShowStyleEditor (Underlying native function: CanShowStyleEditor 0xa5339bc)
