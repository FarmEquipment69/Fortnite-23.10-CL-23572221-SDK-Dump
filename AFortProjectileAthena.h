...
class AFortProjectileAthena : public AFortProjectileBase
{
	...
	// Function /Script/FortniteGame.FortProjectileAthena.ServerNotifyPawnHit (Underlying native function: ServerNotifyPawnHit 0x81815ec)
	...
	// Function /Script/FortniteGame.FortProjectileAthena.ServerNotifyEndOverlap (Underlying native function: ServerNotifyEndOverlap 0x8181500)
	...
	// Function /Script/FortniteGame.FortProjectileAthena.OnRep_PawnHitResult (Underlying native function: OnRep_PawnHitResult 0x150911c)
	void OnRepPawnHitResult(); // (0x00000002 | Native | Protected)

	// Function /Script/FortniteGame.FortProjectileAthena.OnRep_FireStart (Underlying native function: OnRep_FireStart 0x167a010)
	void OnRepFireStart(); // (0x00000002 | Native | Public)

	// Function /Script/FortniteGame.FortProjectileAthena.OnOwnerDestroyed (Underlying native function: OnOwnerDestroyed 0x252b9e4)
	void OnOwnerDestroyed(class AActor*& DestroyedOwner); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortProjectileAthena.KillAfterNoPawnHit (Underlying native function: KillAfterNoPawnHit 0x23b27f4)
