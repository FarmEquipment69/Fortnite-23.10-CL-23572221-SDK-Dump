...
class AFortCurieGrassFireReplicator : public AFortStaticReplicatedActor
{
	...
	// Function /Script/FortniteGame.FortCurieGrassFireReplicator.OnRep_PackedDataArray (Underlying native function: OnRep_PackedDataArray 0x22d06c8)
	void OnRepPackedDataArray(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCurieGrassFireReplicator.OnRep_MinGrassGridIndex (Underlying native function: OnRep_MinGrassGridIndex 0x2c8aec0)
	void OnRepMinGrassGridIndex(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCurieGrassFireReplicator.OnRep_MaxGrassGridIndex (Underlying native function: OnRep_MaxGrassGridIndex 0x2c8aedc)
	void OnRepMaxGrassGridIndex(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCurieGrassFireReplicator.OnRep_GrassGridOrigin (Underlying native function: OnRep_GrassGridOrigin 0x2c8aef8)
	void OnRepGrassGridOrigin(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortCurieGrassFireReplicator.OnRep_GrassGridCellSize (Underlying native function: OnRep_GrassGridCellSize 0x2c8af14)
