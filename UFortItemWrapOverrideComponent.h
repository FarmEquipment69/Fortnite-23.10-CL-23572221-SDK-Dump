...
class UFortItemWrapOverrideComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortItemWrapOverrideComponent.RemoveWrapFromOwner (Underlying native function: RemoveWrapFromOwner 0x84781bc)
	void RemoveWrapFromOwner(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortItemWrapOverrideComponent.OverrideWrapOnActor (Underlying native function: OverrideWrapOnActor 0x8477c50)
	...
	// Function /Script/FortniteGame.FortItemWrapOverrideComponent.OnRep_VariantData (Underlying native function: OnRep_VariantData 0x8477bf0)
	void OnRepVariantData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortItemWrapOverrideComponent.OnRep_SoftOverride (Underlying native function: OnRep_SoftOverride 0x8477bf0)
