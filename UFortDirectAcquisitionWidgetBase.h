...
class UFortDirectAcquisitionWidgetBase : public UFortMtxStoreRootBase
{
	...
	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase.HandleAffiliateButtonClicked (Underlying native function: HandleAffiliateButtonClicked 0x71e6b24)
	void HandleAffiliateButtonClicked(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase.GetWeeklyStoreEndDate (Underlying native function: GetWeeklyStoreEndDate 0x71e6a38)
	struct FDateTime* GetWeeklyStoreEndDate(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase.GetStoreCurrencies (Underlying native function: GetStoreCurrencies 0x71e69a0)
	...
	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase.GetSeasonStoreEndDate (Underlying native function: GetSeasonStoreEndDate 0x71e695c)
	struct FDateTime* GetSeasonStoreEndDate(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase.GetDailyStoreEndDate (Underlying native function: GetDailyStoreEndDate 0x71e670c)
