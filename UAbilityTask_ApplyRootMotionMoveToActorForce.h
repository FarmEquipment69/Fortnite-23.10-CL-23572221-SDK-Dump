...
class UAbilityTask_ApplyRootMotionMoveToActorForce : public UAbilityTask_ApplyRootMotion_Base
{
	...
	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionMoveToActorForce.OnTargetActorSwapped (Underlying native function: OnTargetActorSwapped 0x66b83c0)
	void OnTargetActorSwapped(class AActor*& OriginalTarget, class AActor*& NewTarget); // (Final | Native | Public)

	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionMoveToActorForce.OnRep_TargetLocation (Underlying native function: OnRep_TargetLocation 0x66b8388)
	void OnRepTargetLocation(); // (Final | Native | Protected)

	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionMoveToActorForce.ApplyRootMotionMoveToTargetDataActorForce (Underlying native function: ApplyRootMotionMoveToTargetDataActorForce 0x66b4c8c)
	...
	// Function /Script/GameplayAbilities.AbilityTask_ApplyRootMotionMoveToActorForce.ApplyRootMotionMoveToActorForce (Underlying native function: ApplyRootMotionMoveToActorForce 0x66b443c)
