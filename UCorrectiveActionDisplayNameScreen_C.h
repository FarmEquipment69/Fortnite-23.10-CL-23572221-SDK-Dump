...
class UCorrectiveActionDisplayNameScreen_C : public UFortCorrectiveActionDisplayNameScreen
{
	...
	void ExecuteUbergraphCorrectiveActionDisplayNameScreen(int& EntryPoint, bool& K2NodeEventbShowDownloading, struct FText& K2NodeEventFailureReason, bool& K2NodeEventbShowProcessing); // (Final | 0x00008000 | HasDefaults)
};
