...
class UFortDefenderItemDefinition : public UFortCharacterType
{
	...
	// Function /Script/FortniteGame.FortDefenderItemDefinition.GetDefenderSubtypeTag (Underlying native function: GetDefenderSubtypeTag 0x8ce72e4)
	struct FGameplayTag GetDefenderSubtypeTag(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortDefenderItemDefinition.GetDefenderSubtype (Underlying native function: GetDefenderSubtype 0x8ce72c0)
