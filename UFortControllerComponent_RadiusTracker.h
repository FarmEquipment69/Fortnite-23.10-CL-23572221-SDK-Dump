...
class UFortControllerComponent_RadiusTracker : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_RadiusTracker.UpdateTrackingDisplayIndicators (Underlying native function: UpdateTrackingDisplayIndicators 0x7fbbf50)
	void UpdateTrackingDisplayIndicators(); // (Native | Public)

	// Function /Script/FortniteGame.FortControllerComponent_RadiusTracker.OnRep_TrackingDisplayInfos (Underlying native function: OnRep_TrackingDisplayInfos 0x662da48)
