...
class UFortSkeletalAudioComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortSkeletalAudioComponent.SetVolumeMultiplier (Underlying native function: SetVolumeMultiplier 0x8c43434)
	void SetVolumeMultiplier(float& Multiplier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSkeletalAudioComponent.SetSkeletalMesh (Underlying native function: SetSkeletalMesh 0x8c4329c)
	void SetSkeletalMesh(class USkeletalMeshComponent*& NewSkeletalMesh); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortSkeletalAudioComponent.SetCustomTrackedTransform (Underlying native function: SetCustomTrackedTransform 0x8c42b38)
	...
	// Function /Script/FortniteGame.FortSkeletalAudioComponent.SetCanPlay (Underlying native function: SetCanPlay 0x8c42ab8)
