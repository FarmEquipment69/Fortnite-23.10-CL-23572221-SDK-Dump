...
class UFortCollectionBookSlotView : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotView.OnSlotButtonHovered (Underlying native function: OnSlotButtonHovered 0x71e8f9c)
	void OnSlotButtonHovered(class UCommonButtonLegacy*& HoveredButton, int& ButtonIdx); // (Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotView.OnSlotButtonClicked (Underlying native function: OnSlotButtonClicked 0x71e8dd4)
	void OnSlotButtonClicked(class UCommonButtonLegacy*& ClickedButton, int& ButtonIdx); // (Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookSlotView.OnSelectedSlotButtonChanged (Underlying native function: OnSelectedSlotButtonChanged 0x71e8d0c)
