...
class UContextualAnimManager : public UObject
{
	...
	// Function /Script/ContextualAnimation.ContextualAnimManager.TryStopSceneWithActor (Underlying native function: TryStopSceneWithActor 0x7c693ec)
	bool TryStopSceneWithActor(class AActor*& Actor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/ContextualAnimation.ContextualAnimManager.OnSceneInstanceEnded (Underlying native function: OnSceneInstanceEnded 0x7c69064)
	void OnSceneInstanceEnded(class UContextualAnimSceneInstance*& SceneInstance); // (Final | Native | Protected)

	// Function /Script/ContextualAnimation.ContextualAnimManager.IsActorInAnyScene (Underlying native function: IsActorInAnyScene 0x7c68c40)
	bool IsActorInAnyScene(class AActor*& Actor); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/ContextualAnimation.ContextualAnimManager.GetSceneWithActor (Underlying native function: GetSceneWithActor 0x7c68b7c)
	class UContextualAnimSceneInstance* GetSceneWithActor(class AActor*& Actor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/ContextualAnimation.ContextualAnimManager.GetContextualAnimManager (Underlying native function: GetContextualAnimManager 0x7c68844)
	...
	// Function /Script/ContextualAnimation.ContextualAnimManager.BP_TryStartScene (Underlying native function: BP_TryStartScene 0x7c68014)
