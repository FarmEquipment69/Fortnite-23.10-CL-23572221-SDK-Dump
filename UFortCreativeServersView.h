...
class UFortCreativeServersView : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortCreativeServersView.RefreshServerList (Underlying native function: RefreshServerList 0xa535fd0)
	...
	// Function /Script/FortniteUI.FortCreativeServersView.NavigateServerRight (Underlying native function: NavigateServerRight 0xa535a2c)
	void NavigateServerRight(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeServersView.NavigateServerLeft (Underlying native function: NavigateServerLeft 0xa535a18)
