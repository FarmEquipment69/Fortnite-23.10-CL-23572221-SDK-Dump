...
class UBacchusQuickbarSlotBase : public UAthenaQuickBarSlot
{
	...
	// Function /Script/FortniteUI.BacchusQuickbarSlotBase.StopUseSlot (Underlying native function: StopUseSlot 0xa424338)
	...
	// Function /Script/FortniteUI.BacchusQuickbarSlotBase.SlotSelected (Underlying native function: SlotSelected 0xa4242b8)
	void SlotSelected(bool& bStopUseImmediately); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.BacchusQuickbarSlotBase.ResetSlot (Underlying native function: ResetSlot 0xa423dd4)
