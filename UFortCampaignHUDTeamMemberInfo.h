...
class UFortCampaignHUDTeamMemberInfo : public UFortCampaignTeamMemberEntry
{
	...
	// Function /Script/FortniteUI.FortCampaignHUDTeamMemberInfo.HandlePlayerPawnChanged (Underlying native function: HandlePlayerPawnChanged 0xa821854)
	void HandlePlayerPawnChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCampaignHUDTeamMemberInfo.HandleDBNOChanged (Underlying native function: HandleDBNOChanged 0xa8215a4)
	void HandleDBNOChanged(class AFortPawn*& Pawn, bool& bInIsDBNO); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortCampaignHUDTeamMemberInfo.HandleAccumulatedItemsChanged (Underlying native function: HandleAccumulatedItemsChanged 0xa82157c)
