...
class AFortAthenaMutator_Bison : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bison.OnMutatorGameplayEvent (Underlying native function: OnMutatorGameplayEvent 0x81d8eb4)
	void OnMutatorGameplayEvent(int& EventId, int& EventParam1, int& EventParam2, int& EventParam3); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Bison.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x81d8734)
