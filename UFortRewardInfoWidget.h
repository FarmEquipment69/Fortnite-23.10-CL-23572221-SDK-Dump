...
class UFortRewardInfoWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortRewardInfoWidget.SetRewards (Underlying native function: SetRewards 0xa781420)
	void SetRewards(struct FFortRewardInfo& RewardsIn); // (Final | 0x00000002 | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget.SetReward (Underlying native function: SetReward 0xa781308)
	void SetReward(struct FFortItemQuantityPair& RewardIn); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget.SetButtonGroup (Underlying native function: SetButtonGroup 0xa780dbc)
	void SetButtonGroup(class UCommonButtonGroupBase*& InButtonGroup); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget.ContainsReward (Underlying native function: ContainsReward 0xa77e068)
