...
class UFortCosmeticVariant : public UObject
{
	...
	// Function /Script/FortniteGame.FortCosmeticVariant.GetVariantUnlockRequirement (Underlying native function: GetVariantUnlockRequirement 0x87f4fcc)
	...
	// Function /Script/FortniteGame.FortCosmeticVariant.GetVariantText (Underlying native function: GetVariantText 0x87f4eec)
	...
	// Function /Script/FortniteGame.FortCosmeticVariant.GetVariantChannelText (Underlying native function: GetVariantChannelText 0x87f4e54)
	struct FText GetVariantChannelText(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortCosmeticVariant.GetAllVariantTags (Underlying native function: GetAllVariantTags 0x87f4594)
