...
class UCustomCharacterPartAnimInstance : public UFortAnimInstance
{
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.PickaxeItemDefinitionHasAnyMetaTag (Underlying native function: PickaxeItemDefinitionHasAnyMetaTag 0x85b4dd4)
	...
	void OnCharacterCustomizationLoaded(); // (Event | Public | BlueprintEvent)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.MakeWaveVector (Underlying native function: MakeWaveVector 0x85b4b6c)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.MakeWaveScalar (Underlying native function: MakeWaveScalar 0x85b49cc)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.MakeWaveRotator (Underlying native function: MakeWaveRotator 0x85b4764)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GliderItemDefinitionHasAnyMetaTag (Underlying native function: GliderItemDefinitionHasAnyMetaTag 0x85b4650)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetPartSkeletalMeshComponent (Underlying native function: GetPartSkeletalMeshComponent 0x210890c)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerZVelocity (Underlying native function: GetOwnerZVelocity 0x2d7b3bc)
	float GetOwnerZVelocity(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerSkeletalMeshComponent (Underlying native function: GetOwnerSkeletalMeshComponent 0x11d0ad4)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerGender (Underlying native function: GetOwnerGender 0x85b45f8)
	struct TEnumAsByte<EFortCustomGender> GetOwnerGender(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerFrontEndAnimInstance (Underlying native function: GetOwnerFrontEndAnimInstance 0x85b45a0)
	class UFrontendAnimInstance* GetOwnerFrontEndAnimInstance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerFortPlayerAnimInstance (Underlying native function: GetOwnerFortPlayerAnimInstance 0x2d142a4)
	class UFortPlayerAnimInstance* GetOwnerFortPlayerAnimInstance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetOwnerDirection (Underlying native function: GetOwnerDirection 0x85b4578)
	float GetOwnerDirection(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetCharacterPartType (Underlying native function: GetCharacterPartType 0x85b4228)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.GetAssociatedPlayerPawn (Underlying native function: GetAssociatedPlayerPawn 0x85b41ec)
	class AFortPlayerPawn* GetAssociatedPlayerPawn(); // (0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.FindChildCommponentFromAttachSocket (Underlying native function: FindChildCommponentFromAttachSocket 0x85b4054)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.CheckForTail (Underlying native function: CheckForTail 0x85b3f24)
	void CheckForTail(bool& bHasTail); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.CheckForBackbling (Underlying native function: CheckForBackbling 0x85b3d9c)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.CharacterItemDefinitionHasAnyMetaTag (Underlying native function: CharacterItemDefinitionHasAnyMetaTag 0x85b3cf0)
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance.BackpackItemDefinitionHasAnyMetaTag (Underlying native function: BackpackItemDefinitionHasAnyMetaTag 0x85b3c44)
