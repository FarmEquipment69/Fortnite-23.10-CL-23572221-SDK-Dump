...
class UFortProfileGo : public UObject
{
	...
	// Function /Script/FortniteGame.FortProfileGo.WaitForCommandComplete (Underlying native function: WaitForCommandComplete 0x8d75d2c)
	void WaitForCommandComplete(float& MaxWaitSeconds); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortProfileGo.ReceiveOnFinishedCharacterCustomization (Underlying native function: ReceiveOnFinishedCharacterCustomization 0x8d75774)
	void ReceiveOnFinishedCharacterCustomization(class AFortPlayerPawn*& FortPlayerPawn); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortProfileGo.MarkCommandComplete (Underlying native function: MarkCommandComplete 0x8d75594)
