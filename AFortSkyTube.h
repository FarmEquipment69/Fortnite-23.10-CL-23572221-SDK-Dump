...
class AFortSkyTube : public AActor
{
	...
	// Function /Script/FortniteGame.FortSkyTube.IsSkyTubeEnabled (Underlying native function: IsSkyTubeEnabled 0x860a4d4)
	bool IsSkyTubeEnabled(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSkyTube.IsShuttingDown (Underlying native function: IsShuttingDown 0x860a4bc)
	bool IsShuttingDown(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSkyTube.IsMeshComponentPartOfSkyTube (Underlying native function: IsMeshComponentPartOfSkyTube 0x860a40c)
	...
	// Function /Script/FortniteGame.FortSkyTube.IsExemptFromShutdown (Underlying native function: IsExemptFromShutdown 0x860a3a8)
	...
	// Function /Script/FortniteGame.FortSkyTube.GetDelayUntilDisabled (Underlying native function: GetDelayUntilDisabled 0x86089d4)
	float GetDelayUntilDisabled(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSkyTube.DeferredEnableOverlaps (Underlying native function: DeferredEnableOverlaps 0x2466474)
	void DeferredEnableOverlaps(); // (Native | Public)

	// Function /Script/FortniteGame.FortSkyTube.AddNonSkyTubeMeshComponent (Underlying native function: AddNonSkyTubeMeshComponent 0x8607220)
