...
class UFortAthenaLeashComponent : public UActorComponent
{
	...
	// Function /Script/FortniteAI.FortAthenaLeashComponent.SetLeashRadius (Underlying native function: SetLeashRadius 0xa20fb94)
	void SetLeashRadius(float& NewRadius); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaLeashComponent.IsInsideLeash (Underlying native function: IsInsideLeash 0xa20f4c0)
	...
	// Function /Script/FortniteAI.FortAthenaLeashComponent.GetLeashRadius (Underlying native function: GetLeashRadius 0xa20f268)
	float GetLeashRadius(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaLeashComponent.GetLeashCenter (Underlying native function: GetLeashCenter 0xa20f240)
