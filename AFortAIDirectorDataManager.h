...
class AFortAIDirectorDataManager : public AActor
{
	...
	// Function /Script/FortniteAI.FortAIDirectorDataManager.TriggerEvent (Underlying native function: TriggerEvent 0xa09ff4c)
	void TriggerEvent(struct FFortAIDirectorEvent& TriggeredEvent); // (Native | Public | HasOutParms)

	// Function /Script/FortniteAI.FortAIDirectorDataManager.GetAIDirectorFactorValue (Underlying native function: GetAIDirectorFactorValue 0xa09c648)
