...
class UAbilityAsync_WaitAttributeChanged : public UAbilityAsync
{
	...
	// Function /Script/GameplayAbilities.AbilityAsync_WaitAttributeChanged.WaitForAttributeChanged (Underlying native function: WaitForAttributeChanged 0x66b9d50)
