...
class ANPC_Pawn_Irwin_Predator_Grandma_C : public ANPC_Pawn_Wildlife_Predator_Parent_C
{
	...
	class UFTP_NPC_Assignment_Loot_Carnivore_C* FTPNPCAssignmentLootCarnivore; // 0x3bf8 (0x8)
	class UNiagaraComponent* NSIrwinGrandmaIdleEye; // 0x3c00 (0x8)
	struct FGameplayTagContainer InteractionPreventingTags; // 0x3c08 (0x20)
	struct FGameplayTagContainer InteractingPawnPreventingTags; // 0x3c28 (0x20)
	class UNiagaraSystem* LandingFX; // 0x3c48 (0x8)
	bool playLandingFX; // 0x3c50 (0x1)
