...
class UAnimMontage : public UAnimCompositeBase
{
	...
	// Function /Script/Engine.AnimMontage.IsValidSectionName (Underlying native function: IsValidSectionName 0x9aab2d8)
	bool IsValidSectionName(struct FName& InSectionName); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetSectionName (Underlying native function: GetSectionName 0x9aaac44)
	struct FName GetSectionName(int& SectionIndex); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetSectionIndex (Underlying native function: GetSectionIndex 0x9aaabb8)
	int GetSectionIndex(struct FName& InSectionName); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetNumSections (Underlying native function: GetNumSections 0x735bbd8)
	int GetNumSections(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetDefaultBlendOutTime (Underlying native function: GetDefaultBlendOutTime 0x98b2150)
	float GetDefaultBlendOutTime(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetDefaultBlendInTime (Underlying native function: GetDefaultBlendInTime 0x6e205f4)
	float GetDefaultBlendInTime(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetBlendOutArgs (Underlying native function: GetBlendOutArgs 0x9aaa9b0)
	struct FAlphaBlendArgs GetBlendOutArgs(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.GetBlendInArgs (Underlying native function: GetBlendInArgs 0x9aaa96c)
	struct FAlphaBlendArgs GetBlendInArgs(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/Engine.AnimMontage.CreateSlotAnimationAsDynamicMontage_WithBlendSettings (Underlying native function: CreateSlotAnimationAsDynamicMontage_WithBlendSettings 0x9aaa71c)
