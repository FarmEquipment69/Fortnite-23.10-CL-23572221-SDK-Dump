...
class UAthenaConfirmationWindow : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaConfirmationWindow.HandleTapToCloseZoneMouseButtonDown (Underlying native function: HandleTapToCloseZoneMouseButtonDown 0xa2c6ea8)
