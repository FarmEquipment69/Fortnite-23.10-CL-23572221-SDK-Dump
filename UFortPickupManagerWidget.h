...
class UFortPickupManagerWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortPickupManagerWidget.HandleWorldItemsChanged (Underlying native function: HandleWorldItemsChanged 0xa6992ac)
	void HandleWorldItemsChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPickupManagerWidget.HandleWorldItemListChanged (Underlying native function: HandleWorldItemListChanged 0xa6991c0)
	...
	// Function /Script/FortniteUI.FortPickupManagerWidget.HandleSetWorldResourceWidgetVisibility (Underlying native function: HandleSetWorldResourceWidgetVisibility 0xa6990f8)
	...
	// Function /Script/FortniteUI.FortPickupManagerWidget.HandleHUDElementVisibilityRefreshed (Underlying native function: HandleHUDElementVisibilityRefreshed 0xa698d74)
