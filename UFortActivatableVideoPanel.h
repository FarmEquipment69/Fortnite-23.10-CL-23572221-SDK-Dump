...
class UFortActivatableVideoPanel : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortActivatableVideoPanel.StreamVideoFromSource (Underlying native function: StreamVideoFromSource 0xa735ca0)
	bool StreamVideoFromSource(class UStreamMediaSource*& StreamSource); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatableVideoPanel.StreamVideo (Underlying native function: StreamVideo 0xa735ae8)
	bool StreamVideo(struct FString& VideoURL); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatableVideoPanel.StartVideo (Underlying native function: StartVideo 0xa735a08)
	void StartVideo(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortActivatableVideoPanel.ShowThrobber (Underlying native function: ShowThrobber 0xa7359f4)
	...
	// Function /Script/FortniteUI.FortActivatableVideoPanel.ShouldAutoPlayVideo (Underlying native function: ShouldAutoPlayVideo 0xa73583c)
	...
	// Function /Script/FortniteUI.FortActivatableVideoPanel.LoadVideo (Underlying native function: LoadVideo 0xa732cf4)
	...
	// Function /Script/FortniteUI.FortActivatableVideoPanel.GetMediaPlayer (Underlying native function: GetMediaPlayer 0xa731ccc)
	class UMediaPlayer* GetMediaPlayer(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortActivatableVideoPanel.EnableSkipButton (Underlying native function: EnableSkipButton 0xa730f44)
