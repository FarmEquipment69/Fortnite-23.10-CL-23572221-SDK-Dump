...
class UBacchusQuickbarComboSlot : public UBacchusQuickbarBase
{
	...
	// Function /Script/FortniteUI.BacchusQuickbarComboSlot.SetSize (Underlying native function: SetSize 0xa423fac)
	void SetSize(float& NewButtonSize); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusQuickbarComboSlot.SetQuickbarType (Underlying native function: SetQuickbarType 0xa424130)
	void SetQuickbarType(int& NewType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.BacchusQuickbarComboSlot.Refresh (Underlying native function: Refresh 0x8520ee4)
	void Refresh(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusQuickbarComboSlot.GetQuickbarType (Underlying native function: GetQuickbarType 0xa4229fc)
