...
class UAthenaInventoryPanel : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaInventoryPanel.HandleInventoryItemSelected (Underlying native function: HandleInventoryItemSelected 0xa3cc70c)
	void HandleInventoryItemSelected(class UFortItem*& SelectedInventoryItem); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaInventoryPanel.GetExtensionRowHeight (Underlying native function: GetExtensionRowHeight 0xa3cbc4c)
