...
class AFortAthenaTutorial_Clambering : public AFortAthenaTutorialBase
{
	...
	// Function /Script/FortniteGame.FortAthenaTutorial_Clambering.OnBeginOverlapClamberTriggerBox (Underlying native function: OnBeginOverlapClamberTriggerBox 0x82d30f4)
	void OnBeginOverlapClamberTriggerBox(class AActor*& OverlappedActor, class AActor*& OtherActor); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaTutorial_Clambering.OnBeginOverlapClamberEndTriggerBox (Underlying native function: OnBeginOverlapClamberEndTriggerBox 0x82d327c)
