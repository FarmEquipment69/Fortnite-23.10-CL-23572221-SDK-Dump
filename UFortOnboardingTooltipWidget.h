...
class UFortOnboardingTooltipWidget : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortOnboardingTooltipWidget.NotifyCloseAnimationFinished (Underlying native function: NotifyCloseAnimationFinished 0x662da60)
	void NotifyCloseAnimationFinished(); // (Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortOnboardingTooltipWidget.GetSecondsBeforeClosing (Underlying native function: GetSecondsBeforeClosing 0xa5f5170)
