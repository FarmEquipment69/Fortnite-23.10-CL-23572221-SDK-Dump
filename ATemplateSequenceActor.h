...
class ATemplateSequenceActor : public AActor
{
	...
	// Function /Script/TemplateSequence.TemplateSequenceActor.SetSequence (Underlying native function: SetSequence 0x6e447c4)
	void SetSequence(class UTemplateSequence*& InSequence); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/TemplateSequence.TemplateSequenceActor.SetBinding (Underlying native function: SetBinding 0x6e44630)
	void SetBinding(class AActor*& Actor, bool& bOverridesDefault); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/TemplateSequence.TemplateSequenceActor.LoadSequence (Underlying native function: LoadSequence 0x6e445d8)
	class UTemplateSequence* LoadSequence(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/TemplateSequence.TemplateSequenceActor.GetSequencePlayer (Underlying native function: GetSequencePlayer 0x6e445ac)
	class UTemplateSequencePlayer* GetSequencePlayer(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/TemplateSequence.TemplateSequenceActor.GetSequence (Underlying native function: GetSequence 0x6e44588)
