...
class UFortInteriorAudioSubsystem : public UWorldSubsystem
{
	...
	// Function /Script/FortniteGame.FortInteriorAudioSubsystem.SetEnabled (Underlying native function: SetEnabled 0x8c669d4)
	void SetEnabled(bool& bNewEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortInteriorAudioSubsystem.GetPlayerInfo (Underlying native function: GetPlayerInfo 0x141e394)
