...
class UFortControllerComponent_RechargeWeapons : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_RechargeWeapons.ServerSetPreventRecharging (Underlying native function: ServerSetPreventRecharging 0x82859e4)
	void ServerSetPreventRecharging(bool& bInPreventRecharging); // (Net | NetReliable | Native | Event | Protected | NetServer)

	// Function /Script/FortniteGame.FortControllerComponent_RechargeWeapons.ClientItemStartedRecharging (Underlying native function: ClientItemStartedRecharging 0x845c660)
