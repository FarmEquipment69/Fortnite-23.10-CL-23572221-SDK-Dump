...
class UFortDirectAcquisitionWidgetBase_Legacy : public UFortMtxStoreRootBase_Legacy
{
	...
	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase_Legacy.HandleAffiliateButtonClicked (Underlying native function: HandleAffiliateButtonClicked 0x580bc10)
	void HandleAffiliateButtonClicked(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase_Legacy.GetWeeklyStoreEndDate (Underlying native function: GetWeeklyStoreEndDate 0x580bbd0)
	struct FDateTime* GetWeeklyStoreEndDate(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase_Legacy.GetStoreCurrencies (Underlying native function: GetStoreCurrencies 0x580bb80)
	...
	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase_Legacy.GetSeasonStoreEndDate (Underlying native function: GetSeasonStoreEndDate 0x580bb40)
	struct FDateTime* GetSeasonStoreEndDate(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortDirectAcquisitionWidgetBase_Legacy.GetDailyStoreEndDate (Underlying native function: GetDailyStoreEndDate 0x580bb00)
