...
class UDonutChallengeScreen : public UAthenaSpatialScreen
{
	...
	// Function /Script/FortniteUI.DonutChallengeScreen.SetStyledCursorEnabled (Underlying native function: SetStyledCursorEnabled 0xa699b98)
	void SetStyledCursorEnabled(bool& bEnableStyledCursor); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.DonutChallengeScreen.SetEntryFocus (Underlying native function: SetEntryFocus 0xa6997cc)
	void SetEntryFocus(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.DonutChallengeScreen.ScrollToEndOfChallenges (Underlying native function: ScrollToEndOfChallenges 0xa699658)
