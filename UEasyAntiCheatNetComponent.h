...
class UEasyAntiCheatNetComponent : public UActorComponent
{
	...
	// Function /Script/EasyAntiCheatCommon.EasyAntiCheatNetComponent.ServerMessage (Underlying native function: ServerMessage 0xa27e4e8)
	void ServerMessage(struct TArray<unsigned char>& message); // (Net | NetReliable | Native | Event | Public | NetServer | 0x80000000)

	// Function /Script/EasyAntiCheatCommon.EasyAntiCheatNetComponent.ClientMessage (Underlying native function: ClientMessage 0xa27e454)
