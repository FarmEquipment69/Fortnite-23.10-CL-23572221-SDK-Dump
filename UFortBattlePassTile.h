...
class UFortBattlePassTile : public UFortBattlePassTileBase
{
	...
	// Function /Script/BattlePassBase.FortBattlePassTile.IsAffordable (Underlying native function: IsAffordable 0x6ec7aa0)
	bool IsAffordable(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassTile.HasPrerequisites (Underlying native function: HasPrerequisites 0x6ec7a7c)
