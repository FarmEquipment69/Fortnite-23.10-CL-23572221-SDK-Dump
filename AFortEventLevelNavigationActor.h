...
class AFortEventLevelNavigationActor : public AActor
{
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.UpdateBangState (Underlying native function: UpdateBangState 0x82ab59c)
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HasPurchasedSeasonBook (Underlying native function: HasPurchasedSeasonBook 0x82a9e24)
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HandleMCPInventoryChanged (Underlying native function: HandleMCPInventoryChanged 0x82a9a84)
	void HandleMCPInventoryChanged(struct TSet<struct FString>& TypesChanged, int64_t& ProfileRvn); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HandleDisplayMeshInputTouchEnd (Underlying native function: HandleDisplayMeshInputTouchEnd 0x82a993c)
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HandleDisplayMeshEndCursorOver (Underlying native function: HandleDisplayMeshEndCursorOver 0x82a98b8)
	void HandleDisplayMeshEndCursorOver(class UPrimitiveComponent*& TouchedComponent); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HandleDisplayMeshClicked (Underlying native function: HandleDisplayMeshClicked 0x82a9798)
	void HandleDisplayMeshClicked(class UPrimitiveComponent*& TouchedComponent, struct FKey& ButtonPressed); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortEventLevelNavigationActor.HandleDisplayMeshBeginCursorOver (Underlying native function: HandleDisplayMeshBeginCursorOver 0x82a9714)
	void HandleDisplayMeshBeginCursorOver(class UPrimitiveComponent*& TouchedComponent); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortEventLevelNavigationActor.GetOwningGameStateComp (Underlying native function: GetOwningGameStateComp 0x82a90d0)
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.GetDisplayDetails (Underlying native function: GetDisplayDetails 0x82a8f54)
	...
	// Function /Script/FortniteGame.FortEventLevelNavigationActor.CanCommitNavigationRequest (Underlying native function: CanCommitNavigationRequest 0x6d69464)
