...
class AFortAthenaMutator_Chrome : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Chrome.OnTraversePointTouched (Underlying native function: OnTraversePointTouched 0x81d96d8)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Chrome.OnRep_RaceStarted (Underlying native function: OnRep_RaceStarted 0x81d93b8)
	void OnRepRaceStarted(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Chrome.OnRep_FinishTraversePoint (Underlying native function: OnRep_FinishTraversePoint 0x81d9308)
	void OnRepFinishTraversePoint(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Chrome.HandleTeleportComplete (Underlying native function: HandleTeleportComplete 0x273fd14)
