...
class UFortItemView : public UObject
{
	...
	// Function /Script/FortniteUI.FortItemView.UnregisterInputActions (Underlying native function: UnregisterInputActions 0xa70b8c8)
	void UnregisterInputActions(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemView.SetSettings (Underlying native function: SetSettings 0xa70b3b8)
	void SetSettings(struct FFortItemViewSettings& Settings); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemView.SetSceneComponentToAffect (Underlying native function: SetSceneComponentToAffect 0xa70b27c)
	void SetSceneComponentToAffect(class USceneComponent*& Component); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemView.SetOwningWidget (Underlying native function: SetOwningWidget 0xa70b0ec)
	void SetOwningWidget(class UCommonActivatableWidget*& Widget); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemView.RestoreInitialTransform (Underlying native function: RestoreInitialTransform 0xa70957c)
	void RestoreInitialTransform(bool& bKeepCurrentRotation); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortItemView.RegisterInputActions (Underlying native function: RegisterInputActions 0xa709568)
	...
	// Function /Script/FortniteUI.FortItemView.GetSettings (Underlying native function: GetSettings 0xa708894)
