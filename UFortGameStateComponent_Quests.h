...
class UFortGameStateComponent_Quests : public UFortGameStateComponent
{
	...
	// Function /Script/FortniteGame.FortGameStateComponent_Quests.OnRep_UpdatedWorldQuestObjectives (Underlying native function: OnRep_UpdatedWorldQuestObjectives 0x8477c14)
	void OnRepUpdatedWorldQuestObjectives(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortGameStateComponent_Quests.Multicast_GrantWorldQuest (Underlying native function: Multicast_GrantWorldQuest 0x6ce3320)
