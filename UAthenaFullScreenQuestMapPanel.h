...
class UAthenaFullScreenQuestMapPanel : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaFullScreenQuestMapPanel.HandleScrollCompleted (Underlying native function: HandleScrollCompleted 0xa423084)
	void HandleScrollCompleted(float& ScrollAmount); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaFullScreenQuestMapPanel.HandleRequestPrevious (Underlying native function: HandleRequestPrevious 0xa42305c)
	void HandleRequestPrevious(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaFullScreenQuestMapPanel.HandleQuestMapNavigateLeft (Underlying native function: HandleQuestMapNavigateLeft 0xa422fb8)
	class UWidget* HandleQuestMapNavigateLeft(enum EUINavigation& InNavigation); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaFullScreenQuestMapPanel.HandleCategoryNavigateRight (Underlying native function: HandleCategoryNavigateRight 0xa422ad8)
