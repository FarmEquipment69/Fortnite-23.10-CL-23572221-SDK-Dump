...
class UAthenaInventoryPanelContainer : public UCommonActivatableWidget
{
	...
	class UFortTabListWidgetBase* TabList; // 0x578 (0x8)
	...
	// Function /Script/FortniteUI.AthenaInventoryPanelContainer.HandleInventoryTabChanged (Underlying native function: HandleInventoryTabChanged 0x1ebf2e0)
