...
class UFortMovementComp_GroundSpline : public UMovementComponent
{
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.TeleportToDistanceOnSpline (Underlying native function: TeleportToDistanceOnSpline 0x8895524)
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.SetTargetSpeeds (Underlying native function: SetTargetSpeeds 0x8928230)
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.SetSpline (Underlying native function: SetSpline 0x8895524)
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.SetAbilitySystemComponent (Underlying native function: SetAbilitySystemComponent 0x8927fb0)
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.OnRep_ReplicatedTargetSpeeds (Underlying native function: OnRep_ReplicatedTargetSpeeds 0x8927c18)
	void OnRepReplicatedTargetSpeeds(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.OnRep_ReplicatedSplineLocationData (Underlying native function: OnRep_ReplicatedSplineLocationData 0x8927c04)
	void OnRepReplicatedSplineLocationData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.GetTransformAtDistanceOnSpline (Underlying native function: GetTransformAtDistanceOnSpline 0x8927578)
	...
	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.GetTargetSpeeds (Underlying native function: GetTargetSpeeds 0x89274f8)
	struct FGroundSplineSpeedData GetTargetSpeeds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.GetSplineDistance (Underlying native function: GetSplineDistance 0x2889050)
	float GetSplineDistance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.GetSpline (Underlying native function: GetSpline 0x81a997c)
	class USplineComponent* GetSpline(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.GetCurrentSpeeds (Underlying native function: GetCurrentSpeeds 0x8927188)
	struct FGroundSplineSpeedData GetCurrentSpeeds(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMovementComp_GroundSpline.ClientOnlySnapToServerLocationAndSpeed (Underlying native function: ClientOnlySnapToServerLocationAndSpeed 0x89270a8)
