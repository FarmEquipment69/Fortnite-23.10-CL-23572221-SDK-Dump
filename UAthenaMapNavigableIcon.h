...
class UAthenaMapNavigableIcon : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaMapNavigableIcon.IsIconSelected (Underlying native function: IsIconSelected 0xa4236bc)
	bool IsIconSelected(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaMapNavigableIcon.IsIconHovered (Underlying native function: IsIconHovered 0xa4236a4)
