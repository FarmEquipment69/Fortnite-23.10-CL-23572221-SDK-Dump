...
class UFortBaseButton : public UFortUserWidget
{
	...
	// Function /Script/FortniteUI.FortBaseButton.SetStyle (Underlying native function: SetStyle 0xa55d614)
	void SetStyle(class UClass*& InStyle); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetSelectionGroup (Underlying native function: SetSelectionGroup 0xa55d588)
	void SetSelectionGroup(struct FName& InSelectionGroup); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetSelected (Underlying native function: SetSelected 0xa55d508)
	void SetSelected(bool& InSelected); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetHovered (Underlying native function: SetHovered 0xa55ca64)
	void SetHovered(bool& InHovered); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetClickMethod (Underlying native function: SetClickMethod 0xa55c590)
	void SetClickMethod(struct TEnumAsByte<EButtonClickMethod>& InClickMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetClickable (Underlying native function: SetClickable 0xa55c668)
	void SetClickable(bool& InClickable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetBrushSize (Underlying native function: SetBrushSize 0xa55c500)
	void SetBrushSize(struct TEnumAsByte<EFortBrushSize>& InSize); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.SetBangVisibility (Underlying native function: SetBangVisibility 0xa55c480)
	void SetBangVisibility(bool& bVisible); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.OnButtonClicked (Underlying native function: OnButtonClicked 0xa559c0c)
	void OnButtonClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortBaseButton.GetStyle (Underlying native function: GetStyle 0xa55acd4)
	class UFortButtonStyle* GetStyle(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.GetSelectionGroupIndex (Underlying native function: GetSelectionGroupIndex 0xa55acb0)
	int GetSelectionGroupIndex(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortBaseButton.GetSelected (Underlying native function: GetSelected 0xa55ac70)
	bool GetSelected(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.GetCurrentStateStyle (Underlying native function: GetCurrentStateStyle 0xa55a350)
	struct FFortStateStyle GetCurrentStateStyle(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.GetCurrentFont (Underlying native function: GetCurrentFont 0xa55a270)
	struct FSlateFontInfo GetCurrentFont(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.GetCurrentCustomPadding (Underlying native function: GetCurrentCustomPadding 0xa55a21c)
	struct Fmargin GetCurrentCustomPadding(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.GetCurrentButtonPadding (Underlying native function: GetCurrentButtonPadding 0xa55a1c8)
	struct Fmargin GetCurrentButtonPadding(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortBaseButton.ForceClick (Underlying native function: ForceClick 0xa559c0c)
