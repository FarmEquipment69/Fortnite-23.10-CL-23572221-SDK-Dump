...
class UFortShowdownPin : public UFortShowdownDetailView
{
	...
	// Function /Script/FortniteUI.FortShowdownPin.ShouldUseAlternativeScore (Underlying native function: ShouldUseAlternativeScore 0xa7f68b0)
	bool ShouldUseAlternativeScore(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortShowdownPin.GetScoreToDisplay (Underlying native function: GetScoreToDisplay 0xa7efcc8)
	int GetScoreToDisplay(bool& bUseBestPin); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortShowdownPin.GetAlternativeScoreToDisplay (Underlying native function: GetAlternativeScoreToDisplay 0xa7c5144)
