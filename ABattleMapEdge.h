...
class ABattleMapEdge : public AActor
{
	...
	// Function /Script/FortniteGame.BattleMapEdge.OnNextNextSet (Underlying native function: OnNextNextSet 0x831850c)
	void OnNextNextSet(class ABattleMapNode*& NextNextNode); // (Final | Native | Protected)

	// Function /Script/FortniteGame.BattleMapEdge.HandeResizedBattleNode (Underlying native function: HandeResizedBattleNode 0x8317880)
