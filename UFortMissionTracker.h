...
class UFortMissionTracker : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortMissionTracker.SetEnablePinnedQuestList (Underlying native function: SetEnablePinnedQuestList 0xa733ba4)
	void SetEnablePinnedQuestList(bool& bEnable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionTracker.SetEnableMainQuestList (Underlying native function: SetEnableMainQuestList 0xa733af4)
	void SetEnableMainQuestList(bool& bEnable); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMissionTracker.RefreshSizeEstimate (Underlying native function: RefreshSizeEstimate 0xa7334e8)
	void RefreshSizeEstimate(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortMissionTracker.HandleSizeEstimateChanged (Underlying native function: HandleSizeEstimateChanged 0xa7325c8)
	void HandleSizeEstimateChanged(class UObject*& ChangedElement); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortMissionTracker.HandleDebugHUDObjectiveHeightChanged (Underlying native function: HandleDebugHUDObjectiveHeightChanged 0xa732168)
