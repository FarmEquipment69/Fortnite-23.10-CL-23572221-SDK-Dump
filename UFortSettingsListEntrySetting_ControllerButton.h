...
class UFortSettingsListEntrySetting_ControllerButton : public UFortSettingsListEntry_Setting
{
	...
	// Function /Script/FortniteUI.FortSettingsListEntrySetting_ControllerButton.HandleActionButtonClicked (Underlying native function: HandleActionButtonClicked 0xa7c64dc)
	void HandleActionButtonClicked(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortSettingsListEntrySetting_ControllerButton.GetPopupMenu (Underlying native function: GetPopupMenu 0xa7c5b48)
