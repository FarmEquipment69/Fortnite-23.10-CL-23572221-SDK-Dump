...
class UCampaignPurchaseScreen_C : public UFortCampaignPurchaseScreen
{
	...
	void OnStoreScreenCreated(class UFortMtxStoreRootBase*& StoreScreen); // (Event | Protected | BlueprintEvent)
