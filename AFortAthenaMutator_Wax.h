...
class AFortAthenaMutator_Wax : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.ShouldBeUI_Visible (Underlying native function: ShouldBeUI_Visible 0x8285b60)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.SendTokenStats (Underlying native function: SendTokenStats 0x273fd14)
	void SendTokenStats(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.OnRep_Leaders (Underlying native function: OnRep_Leaders 0x82853fc)
	void OnRepLeaders(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.OnNewGamePhase (Underlying native function: OnNewGamePhase 0x8285188)
	void OnNewGamePhase(enum EAthenaGamePhase& NewPhase); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.IsPlayerTeamLeader (Underlying native function: IsPlayerTeamLeader 0x8284f30)
	bool IsPlayerTeamLeader(class AFortPlayerStateAthena*& Player); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.IsPlayerMovingOrShooting (Underlying native function: IsPlayerMovingOrShooting 0x8284ea0)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.IsPlayerInPodium (Underlying native function: IsPlayerInPodium 0x8284e10)
	bool IsPlayerInPodium(class AFortPlayerStateAthena*& Player); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetWaxUI_Info (Underlying native function: GetWaxUI_Info 0x82849e0)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetTokensToWinBP (Underlying native function: GetTokensToWinBP 0x82849bc)
	int GetTokensToWinBP(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetTokensForPlayer (Underlying native function: GetTokensForPlayer 0x8284914)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetPlayerTeamScore (Underlying native function: GetPlayerTeamScore 0x82845b4)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetPlayerTeamPlacement (Underlying native function: GetPlayerTeamPlacement 0x828451c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetPlayerPlacement (Underlying native function: GetPlayerPlacement 0x828448c)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetPlayerLives (Underlying native function: GetPlayerLives 0x82842dc)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.GetCurrentWaxState (Underlying native function: GetCurrentWaxState 0x82841c4)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Wax.CommonDeadPawn (Underlying native function: CommonDeadPawn 0x8283c38)
