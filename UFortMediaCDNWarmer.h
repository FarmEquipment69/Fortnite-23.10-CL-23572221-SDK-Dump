...
class UFortMediaCDNWarmer : public UObject
{
	...
	// Function /Script/FortniteGame.FortMediaCDNWarmer.Stop (Underlying native function: Stop 0x8718378)
	void Stop(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMediaCDNWarmer.Start (Underlying native function: Start 0x8718364)
