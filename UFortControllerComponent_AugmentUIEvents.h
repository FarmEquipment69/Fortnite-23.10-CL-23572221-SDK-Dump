...
class UFortControllerComponent_AugmentUIEvents : public UFortControllerComponent
{
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortControllerComponent_AugmentUIEvents.UpdatedTimerProgress (Underlying native function: UpdatedTimerProgress 0x6eeaac8)
	void UpdatedTimerProgress(float& TimeRemaining, float& TimePercentage); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/PlayerAugmentsCodeRuntime.FortControllerComponent_AugmentUIEvents.SetNumGrantableAugmentsForPlaylist (Underlying native function: SetNumGrantableAugmentsForPlaylist 0x6eea9f8)
	...
	// Function /Script/PlayerAugmentsCodeRuntime.FortControllerComponent_AugmentUIEvents.NotifyGrantingTimersFinished (Underlying native function: NotifyGrantingTimersFinished 0x6eea84c)
	void NotifyGrantingTimersFinished(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/PlayerAugmentsCodeRuntime.FortControllerComponent_AugmentUIEvents.HandleAugmentSelectorOpenedStatusChanged (Underlying native function: HandleAugmentSelectorOpenedStatusChanged 0x6eea3d8)
