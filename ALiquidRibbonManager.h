...
class ALiquidRibbonManager : public AActor
{
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.SetNiagaraData (Underlying native function: SetNiagaraData 0x745a738)
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.RunSplineCollisionTestOnProjectiles (Underlying native function: RunSplineCollisionTestOnProjectiles 0x745a670)
	void RunSplineCollisionTestOnProjectiles(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.GetPointOnSegment (Underlying native function: GetPointOnSegment 0x745a554)
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.GetOrAddDetachment (Underlying native function: GetOrAddDetachment 0x745a448)
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.GetFirstVisiblePointIndex (Underlying native function: GetFirstVisiblePointIndex 0x745a420)
	int GetFirstVisiblePointIndex(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.CalculateSplinePointsAndSetNiagaraData (Underlying native function: CalculateSplinePointsAndSetNiagaraData 0x7459fd0)
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.CalculateSegments (Underlying native function: CalculateSegments 0x7459ec0)
	...
	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.CalculatePointSize (Underlying native function: CalculatePointSize 0x7459e04)
	float CalculatePointSize(int& SegmentIndex, int& PointIndex); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/UnstableLiquidGunRuntime.LiquidRibbonManager.CalculatePointFlashIntensity (Underlying native function: CalculatePointFlashIntensity 0x7459d74)
