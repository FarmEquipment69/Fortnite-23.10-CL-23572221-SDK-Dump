...
class UFortRewardInfoWidget_Legacy : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortRewardInfoWidget_Legacy.SetRewards (Underlying native function: SetRewards 0xa7814f0)
	void SetRewards(struct FFortRewardInfo& RewardsIn); // (Final | 0x00000002 | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget_Legacy.SetReward (Underlying native function: SetReward 0xa781394)
	void SetReward(struct FFortItemQuantityPair& RewardIn); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget_Legacy.SetButtonGroup (Underlying native function: SetButtonGroup 0xa780dbc)
	void SetButtonGroup(class UCommonButtonGroupLegacy*& InButtonGroup); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortRewardInfoWidget_Legacy.ContainsReward (Underlying native function: ContainsReward 0xa77e068)
