...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0xe10 (0x8)
	double DecalFadeoutTime; // 0xe18 (0x8)
	class UDecalComponent* EmissiveDecal; // 0xe20 (0x8)
	class UMaterialInstanceDynamic* EmissiveDecalMID; // 0xe28 (0x8)
	double DecalSize; // 0xe30 (0x8)
	class UMaterialInterface* EmissiveMatSource; // 0xe38 (0x8)
	double DecalDepth; // 0xe40 (0x8)
	class UAthenaSprayItemDefinition* SprayAsset; // 0xe48 (0x8)
	int LoadsOutstanding; // 0xe50 (0x4)
	unsigned char unreflected_e54[0x4]; // 0xe54 (0x4) 
	struct TWeakObjectPtr<class UTexture2D> DecalTextureOverrideSoft; // 0xe58 (0x28)
	class UTexture2D* DecalTextureOverride; // 0xe80 (0x8)
	struct FLinearColor BannerPrimaryColor; // 0xe88 (0x10)
	struct FLinearColor BannerSecondaryColor; // 0xe98 (0x10)
	class AFortPlayerController* SpawningPlayerController; // 0xea8 (0x8)
	struct TArray<class AActor*> NearbyBuildingActors; // 0xeb0 (0x10)
	double SpawnStartTimeDelay; // 0xec0 (0x8)
	bool bIsFrontEndPreview; // 0xec8 (0x1)
	bool bDestroyOnTrapPlaced; // 0xec9 (0x1)
