...
class UFortCreativeObjectTrackingComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCreativeObjectTrackingComponent.ServerSetPreviewLocation (Underlying native function: ServerSetPreviewLocation 0x8551af8)
