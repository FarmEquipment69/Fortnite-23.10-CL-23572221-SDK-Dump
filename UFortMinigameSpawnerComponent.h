...
class UFortMinigameSpawnerComponent : public UFortMinigameItemContainerComponent
{
	...
	// Function /Script/FortniteGame.FortMinigameSpawnerComponent.SpawnPickupFromSpawnParams (Underlying native function: SpawnPickupFromSpawnParams 0x88ca884)
	...
	// Function /Script/FortniteGame.FortMinigameSpawnerComponent.OnRep_ToSpawnList (Underlying native function: OnRep_ToSpawnList 0x8551178)
	void OnRepToSpawnList(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMinigameSpawnerComponent.MakeSpawnParamsFromItemEntry (Underlying native function: MakeSpawnParamsFromItemEntry 0x88c6f6c)
