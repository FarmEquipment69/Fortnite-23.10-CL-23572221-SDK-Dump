...
class UFortCorrectiveActionDateOfBirthScreen : public UFortCorrectiveActionScreen
{
	...
	// Function /Script/FortniteUI.FortCorrectiveActionDateOfBirthScreen.HandleYearChanged (Underlying native function: HandleYearChanged 0xa2a4604)
	void HandleYearChanged(struct FText& Text, struct TEnumAsByte<ETextCommit>& CommitMethod); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortCorrectiveActionDateOfBirthScreen.HandleMonthChanged (Underlying native function: HandleMonthChanged 0xa2a4258)
