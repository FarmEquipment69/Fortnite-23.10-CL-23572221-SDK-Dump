...
class UFortCollectionBookProgressionRewardsModalWidget : public UFortActivatablePanel
{
	...
	// Function /Script/SaveTheWorldUI.FortCollectionBookProgressionRewardsModalWidget.OnSelectedButtonChanged (Underlying native function: OnSelectedButtonChanged 0x71e8c0c)
	void OnSelectedButtonChanged(class UCommonButtonLegacy*& SelectedButton, int& ButtonIndex); // (Final | Native | Protected)

	// Function /Script/SaveTheWorldUI.FortCollectionBookProgressionRewardsModalWidget.OnLevelProgressionSet (Underlying native function: OnLevelProgressionSet 0x71e84ec)
