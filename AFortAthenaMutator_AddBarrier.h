...
class AFortAthenaMutator_AddBarrier : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_AddBarrier.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x6f05250)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Final | 0x00000002 | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_AddBarrier.IsBarrierUp (Underlying native function: IsBarrierUp 0x81a9acc)
	bool IsBarrierUp(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMutator_AddBarrier.GetBigBaseWall (Underlying native function: GetBigBaseWall 0x81a9318)
