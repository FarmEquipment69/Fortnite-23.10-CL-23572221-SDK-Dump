...
class UFortAlterationModOptinScreenBase : public UCommonActivatablePanelLegacy
{
	...
	// Function /Script/SaveTheWorldUI.FortAlterationModOptinScreenBase.SetupItem (Underlying native function: SetupItem 0x721d200)
	void SetupItem(class UFortItem*& Item); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortAlterationModOptinScreenBase.RequestClose (Underlying native function: RequestClose 0x721c5b0)
	...
	// Function /Script/SaveTheWorldUI.FortAlterationModOptinScreenBase.ConvertItemAlterations (Underlying native function: ConvertItemAlterations 0x7219d80)
