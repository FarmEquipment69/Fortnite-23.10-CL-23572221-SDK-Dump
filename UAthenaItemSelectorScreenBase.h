...
class UAthenaItemSelectorScreenBase : public UFortItemPreviewScreen
{
	...
	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.StartItemCustomization (Underlying native function: StartItemCustomization 0xa2eab18)
	void StartItemCustomization(struct FAthenaCustomizationParams& Params); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.SaveAndExit_ApplyToAllSlots (Underlying native function: SaveAndExit_ApplyToAllSlots 0xa2ea42c)
	void SaveAndExitApplyToAllSlots(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.SaveAndExit (Underlying native function: SaveAndExit 0xa2ea3ac)
	...
	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.OnItemSelectionCommited (Underlying native function: OnItemSelectionCommited 0xa2ea208)
	void OnItemSelectionCommited(class UFortItem*& SelectedItem); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.OnItemSelectedChanged (Underlying native function: OnItemSelectedChanged 0xa2ea188)
	...
	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.IsItemOwned (Underlying native function: IsItemOwned 0xa2e9e54)
	bool IsItemOwned(class UFortItem*& Item); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.IsAlternateActionHovered (Underlying native function: IsAlternateActionHovered 0xa2e9da0)
	void IsAlternateActionHovered(bool& bAlternateActionHovered); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleShowArchivedItemsTooltipDismissed (Underlying native function: HandleShowArchivedItemsTooltipDismissed 0xa2e98ac)
	void HandleShowArchivedItemsTooltipDismissed(); // (Final | Native | Private | BlueprintCallable | Const)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleSearchTextChanged (Underlying native function: HandleSearchTextChanged 0xa2e95b4)
	void HandleSearchTextChanged(struct FText& NewText); // (Final | Native | Protected | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleScreenAnalytics (Underlying native function: HandleScreenAnalytics 0xa2e9538)
	...
	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleLockerArchivingCleanupTooltipDismissed (Underlying native function: HandleLockerArchivingCleanupTooltipDismissed 0xa2e8e84)
	void HandleLockerArchivingCleanupTooltipDismissed(); // (Final | Native | Private | BlueprintCallable | Const)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleCommitArchiveChangeClicked (Underlying native function: HandleCommitArchiveChangeClicked 0xa2e89f8)
	void HandleCommitArchiveChangeClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleArchiveModeTooltipDismissed (Underlying native function: HandleArchiveModeTooltipDismissed 0xa2e891c)
	void HandleArchiveModeTooltipDismissed(); // (Final | Native | Private | BlueprintCallable | Const)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.HandleAboutToClose (Underlying native function: HandleAboutToClose 0xa2e88a4)
	void HandleAboutToClose(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.GetCurrentItem (Underlying native function: GetCurrentItem 0xa2e82dc)
	class UFortItem* GetCurrentItem(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.ExitEditStyle (Underlying native function: ExitEditStyle 0xa2e8050)
	void ExitEditStyle(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemSelectorScreenBase.EnterEditStyle (Underlying native function: EnterEditStyle 0xa2e803c)
