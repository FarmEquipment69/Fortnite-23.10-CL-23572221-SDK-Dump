...
class AFortAthenaMutator_Bismuth : public AFortAthenaMutator_GameModeBase
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_Bismuth.ReflectEliminatePlayer (Underlying native function: ReflectEliminatePlayer 0x6df70d4)
	void ReflectEliminatePlayer(class AFortPlayerPawnAthena*& PlayerPawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMutator_Bismuth.AIBotPawnDeath (Underlying native function: AIBotPawnDeath 0x81d6d18)
