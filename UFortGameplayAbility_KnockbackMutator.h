...
class UFortGameplayAbility_KnockbackMutator : public UFortGameplayAbility
{
	...
	// Function /Script/KnockbackRuntime.FortGameplayAbility_KnockbackMutator.SaveKnockbackData (Underlying native function: SaveKnockbackData 0x70cf14c)
	void SaveKnockbackData(struct FKnockbackMutatorData& InKnockbackData); // (Final | Native | Protected | HasOutParms | BlueprintCallable)

	// Function /Script/KnockbackRuntime.FortGameplayAbility_KnockbackMutator.GetCachedMutator (Underlying native function: GetCachedMutator 0x70cefb4)
