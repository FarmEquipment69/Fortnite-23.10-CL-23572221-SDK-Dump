...
class UFortPlaceableActorItemDefinition : public UFortItemDefinition
{
	...
	// Function /Script/FortniteGame.FortPlaceableActorItemDefinition.GetActorName (Underlying native function: GetActorName 0x83d6720)
	struct FName GetActorName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlaceableActorItemDefinition.CreatePlaceableActorItemDefinitionFromActor (Underlying native function: CreatePlaceableActorItemDefinitionFromActor 0x83d604c)
