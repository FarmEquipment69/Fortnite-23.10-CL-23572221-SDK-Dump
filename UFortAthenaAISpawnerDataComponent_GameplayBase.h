...
class UFortAthenaAISpawnerDataComponent_GameplayBase : public UFortAthenaAISpawnerDataComponent
{
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.ShouldOverrideGlobalSpeedMultiplier (Underlying native function: ShouldOverrideGlobalSpeedMultiplier 0x881445c)
	bool ShouldOverrideGlobalSpeedMultiplier(); // (Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCopyConverterSpecificRelations (Underlying native function: SetCopyConverterSpecificRelations 0xa1f7648)
	void SetCopyConverterSpecificRelations(bool& bInCopyConverterSpecificRelations); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCanBeConverted (Underlying native function: SetCanBeConverted 0xa1f74a0)
	...
	// Function /Script/FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.GetGlobalSpeedMultiplier (Underlying native function: GetGlobalSpeedMultiplier 0xa1f65fc)
