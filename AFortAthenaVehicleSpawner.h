...
class AFortAthenaVehicleSpawner : public AActor
{
	...
	// Function /Script/FortniteGame.FortAthenaVehicleSpawner.SpawnVehicleWithConstruction (Underlying native function: SpawnVehicleWithConstruction 0x8068500)
	...
	// Function /Script/FortniteGame.FortAthenaVehicleSpawner.SpawnVehicle (Underlying native function: SpawnVehicle 0x1598df4)
	void SpawnVehicle(); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteGame.FortAthenaVehicleSpawner.OnConstructVehicle (Underlying native function: OnConstructVehicle 0x6e5d728)
	void OnConstructVehicle(class AFortAthenaVehicle*& Vehicle); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortAthenaVehicleSpawner.GetVehicleClass (Underlying native function: GetVehicleClass 0x8066d50)
	class UClass* GetVehicleClass(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaVehicleSpawner.GetForceSpawnAlways (Underlying native function: GetForceSpawnAlways 0x8066be4)
