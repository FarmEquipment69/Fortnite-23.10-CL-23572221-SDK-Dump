...
class UFortCurieToggleComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortCurieToggleComponent.OnInactive (Underlying native function: OnInactive 0x20eb1a0)
	void OnInactive(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortCurieToggleComponent.OnElementDetached (Underlying native function: OnElementDetached 0x85971fc)
	...
	// Function /Script/FortniteGame.FortCurieToggleComponent.OnElementAttached (Underlying native function: OnElementAttached 0x8597100)
	...
	// Function /Script/FortniteGame.FortCurieToggleComponent.OnElementApplied (Underlying native function: OnElementApplied 0x8597004)
	...
	// Function /Script/FortniteGame.FortCurieToggleComponent.OnActive (Underlying native function: OnActive 0x2664ff8)
