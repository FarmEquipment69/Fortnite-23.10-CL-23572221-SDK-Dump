...
class UFortHUDScoringAlert : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.FortHUDScoringAlert.OnTournamentStatUpdate (Underlying native function: OnTournamentStatUpdate 0xa8223f4)
	void OnTournamentStatUpdate(struct FFortTournamentStatInfo& TournamentStatInfo); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.FortHUDScoringAlert.OnTeamPlacementChanged (Underlying native function: OnTeamPlacementChanged 0xa822374)
	...
	// Function /Script/FortniteUI.FortHUDScoringAlert.OnPlayerPlacementChanged (Underlying native function: OnPlayerPlacementChanged 0xa822220)
	void OnPlayerPlacementChanged(class AFortPlayerStateAthena*& Sender, int& NewPlayerPlacement); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortHUDScoringAlert.OnPlayerMatchAbandonStateChanged (Underlying native function: OnPlayerMatchAbandonStateChanged 0xa82215c)
	...
	// Function /Script/FortniteUI.FortHUDScoringAlert.OnMinigameCurrentRoundChanged (Underlying native function: OnMinigameCurrentRoundChanged 0xa822098)
	void OnMinigameCurrentRoundChanged(class AFortMinigame*& Minigame, int& CurrentRound); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortHUDScoringAlert.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0xa822018)
	void OnGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortHUDScoringAlert.HandlePointAnimationFinished (Underlying native function: HandlePointAnimationFinished 0xa821868)
