...
class AFortAthenaMapInfo : public AActor
{
	...
	// Function /Script/FortniteGame.FortAthenaMapInfo.SetAircraftSpeed (Underlying native function: SetAircraftSpeed 0x801f8b8)
	...
	// Function /Script/FortniteGame.FortAthenaMapInfo.PickSupplyDropLocation (Underlying native function: PickSupplyDropLocation 0x801f348)
	...
	// Function /Script/FortniteGame.FortAthenaMapInfo.PickSafeZoneLocation (Underlying native function: PickSafeZoneLocation 0x801f1ec)
	...
	// Function /Script/FortniteGame.FortAthenaMapInfo.HandleStormEffectsPlayerOptionEnabledChanged (Underlying native function: HandleStormEffectsPlayerOptionEnabledChanged 0x801e6a8)
	void HandleStormEffectsPlayerOptionEnabledChanged(bool& bInEnabled); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortAthenaMapInfo.GetMapCenter (Underlying native function: GetMapCenter 0x801e264)
	struct FVector GetMapCenter(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAthenaMapInfo.DrawSafeZoneVolumeDefinitions (Underlying native function: DrawSafeZoneVolumeDefinitions 0x273fd14)
	void DrawSafeZoneVolumeDefinitions(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMapInfo.ConstructSafeZoneLocationParams (Underlying native function: ConstructSafeZoneLocationParams 0x801d8bc)
	...
	// Function /Script/FortniteGame.FortAthenaMapInfo.CalcAircraftFlightPath (Underlying native function: CalcAircraftFlightPath 0x801d35c)
