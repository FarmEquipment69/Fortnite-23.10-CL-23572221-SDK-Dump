...
class AFortPoiManager : public AActor
{
	...
	// Function /Script/FortniteGame.FortPoiManager.UnbindOnPoiExited (Underlying native function: UnbindOnPoiExited 0x815fef0)
	void UnbindOnPoiExited(struct FGameplayTag& POITag, struct FDelegate& Event); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPoiManager.UnbindOnPoiEntered (Underlying native function: UnbindOnPoiEntered 0x815fe14)
	void UnbindOnPoiEntered(struct FGameplayTag& POITag, struct FDelegate& Event); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPoiManager.OnRep_PoiTagContainerTable (Underlying native function: OnRep_PoiTagContainerTable 0x1a636b8)
	void OnRepPoiTagContainerTable(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPoiManager.OnRep_PoiGridForDebugDisplay (Underlying native function: OnRep_PoiGridForDebugDisplay 0x273fd14)
	void OnRepPoiGridForDebugDisplay(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPoiManager.OnRep_FortPoiGridInfo (Underlying native function: OnRep_FortPoiGridInfo 0x273fd14)
	void OnRepFortPoiGridInfo(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPoiManager.GetVolumeWithTag (Underlying native function: GetVolumeWithTag 0x815d1fc)
	...
	// Function /Script/FortniteGame.FortPoiManager.GetNamedOnMapPoiVolumes (Underlying native function: GetNamedOnMapPoiVolumes 0x815cbb0)
	struct TArray<class AFortPoiVolume*> GetNamedOnMapPoiVolumes(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPoiManager.GetAllPoiVolumes (Underlying native function: GetAllPoiVolumes 0x815c57c)
	struct TArray<class AFortPoiVolume*> GetAllPoiVolumes(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPoiManager.ClientsideMinimalInitPostEventsReady (Underlying native function: ClientsideMinimalInitPostEventsReady 0x815c0e8)
	void ClientsideMinimalInitPostEventsReady(struct TArray<struct FString>& NewEvents); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.FortPoiManager.BindOnPoiExited (Underlying native function: BindOnPoiExited 0x815b954)
	void BindOnPoiExited(struct FGameplayTag& POITag, struct FDelegate& Event); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPoiManager.BindOnPoiEntered (Underlying native function: BindOnPoiEntered 0x815b780)
