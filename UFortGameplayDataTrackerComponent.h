...
class UFortGameplayDataTrackerComponent : public UGameFrameworkComponent
{
	...
	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.TriggerEvent (Underlying native function: TriggerEvent 0x87ca5c8)
	void TriggerEvent(struct FGameplayTag& EventTag, float& Value); // (Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.RegisterForEventValueRange (Underlying native function: RegisterForEventValueRange 0x87c9efc)
	...
	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.RegisterForAccumulationRangeEvents (Underlying native function: RegisterForAccumulationRangeEvents 0x87c9db8)
	...
	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.OnRep_EventValues (Underlying native function: OnRep_EventValues 0x87c9c2c)
	void OnRepEventValues(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.HandlePlaylistLoaded (Underlying native function: HandlePlaylistLoaded 0x87c9578)
	...
	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.GetEventValue (Underlying native function: GetEventValue 0x87c8d50)
	float GetEventValue(struct FGameplayTag& EventTag); // (Final | Native | Public | HasOutParms | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.GetAccumulationValue (Underlying native function: GetAccumulationValue 0x87c8cb4)
	...
	// Function /Script/FortniteGame.FortGameplayDataTrackerComponent.AddDataAccumulation (Underlying native function: AddDataAccumulation 0x87c8b6c)
