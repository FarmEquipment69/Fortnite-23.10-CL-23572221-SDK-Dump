...
class UFortCompetitiveLeaderboardScreen : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCompetitiveLeaderboardScreen.SetEvent (Underlying native function: SetEvent 0xa55c7f4)
	void SetEvent(struct FString& EventId, struct FString& EventWindowId); // (Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCompetitiveLeaderboardScreen.RequestNextPage (Underlying native function: RequestNextPage 0xa55c364)
	...
	// Function /Script/FortniteUI.FortCompetitiveLeaderboardScreen.HandleLeaderboardSetInView (Underlying native function: HandleLeaderboardSetInView 0xa55b520)
	void HandleLeaderboardSetInView(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCompetitiveLeaderboardScreen.GetMyLeaderboardEntry (Underlying native function: GetMyLeaderboardEntry 0x81a9318)
