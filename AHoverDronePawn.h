...
class AHoverDronePawn : public AFortReplaySpectatorPawnBase
{
	...
	// Function /Script/FortniteGame.HoverDronePawn.IsMaintainingConstantAltitude (Underlying native function: IsMaintainingConstantAltitude 0x8c41de4)
	bool IsMaintainingConstantAltitude(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.HoverDronePawn.GetAltitude (Underlying native function: GetAltitude 0x8c402cc)
