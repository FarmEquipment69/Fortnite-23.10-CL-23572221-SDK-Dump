...
class UFortQuestMapNodeLayout : public UUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortQuestMapNodeLayout.HandleQuestIndexSelectionModelIndexChanged (Underlying native function: HandleQuestIndexSelectionModelIndexChanged 0x724525c)
	void HandleQuestIndexSelectionModelIndexChanged(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortQuestMapNodeLayout.HandleQuestButtonSelected (Underlying native function: HandleQuestButtonSelected 0x724507c)
