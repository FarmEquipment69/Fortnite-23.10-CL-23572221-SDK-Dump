...
class UFortEventPlayerStatProfileSelector : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortEventPlayerStatProfileSelector.SetProfilesByLeaderboardData (Underlying native function: SetProfilesByLeaderboardData 0xa76125c)
