...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x4330 (0x8)
	struct TArray<class UMaterialInterface*> DefaultWeaponMaterials; // 0x4338 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnBackpackMaterials; // 0x4348 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnHatMaterials; // 0x4358 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnHeadMaterials; // 0x4368 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnBodyMaterials; // 0x4378 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnCharmMaterials; // 0x4388 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnFaceMaterials; // 0x4398 (0x10)
	class UPostProcessComponent* PlayerPostProcessFX; // 0x43a8 (0x8)
	struct TArray<class USkeletalMeshComponent*> SkeletalMeshes; // 0x43b0 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> PawnMaterialsALL; // 0x43c0 (0x10)
	int WaterCounter; // 0x43d0 (0x4)
	unsigned char unreflected_43d4[0x4]; // 0x43d4 (0x4) 
	class AActor* CurrentWaterMeshActor; // 0x43d8 (0x8)
	bool IsInWater; // 0x43e0 (0x1)
	unsigned char unreflected_43e1[0x7]; // 0x43e1 (0x7) 
	double Timewhenyoullbeabletosplashagain; // 0x43e8 (0x8)
	struct FMulticastInlineDelegate OnOverlapWaterVolume; // 0x43f0 (0x10)
	struct TArray<struct FCharacterPartMidArrayStruct> PawnPartMaterials; // 0x4400 (0x10)
