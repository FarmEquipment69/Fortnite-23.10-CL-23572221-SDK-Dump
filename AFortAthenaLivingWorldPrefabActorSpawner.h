...
class AFortAthenaLivingWorldPrefabActorSpawner : public AActor
{
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefabActorSpawner.OnSnapCompleted (Underlying native function: OnSnapCompleted 0x6e90ad0)
	...
	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefabActorSpawner.GetSpawnedActor (Underlying native function: GetSpawnedActor 0x6e8e5b8)
	class AActor* GetSpawnedActor(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/LagerRuntime.FortAthenaLivingWorldPrefabActorSpawner.CallWhenActorSpawned (Underlying native function: CallWhenActorSpawned 0x6e8dd54)
