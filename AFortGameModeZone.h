...
class AFortGameModeZone : public AFortGameMode_InGame
{
	...
	// Function /Script/FortniteGame.FortGameModeZone.SetZoneLootNamedWeightsMapOverride (Underlying native function: SetZoneLootNamedWeightsMapOverride 0x86a13a4)
	...
	// Function /Script/FortniteGame.FortGameModeZone.SetSpawnWithinStormShield (Underlying native function: SetSpawnWithinStormShield 0x86a12a8)
	void SetSpawnWithinStormShield(bool& bSpawnInStormShield); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModeZone.SetPlayerStartLocationOverrides (Underlying native function: SetPlayerStartLocationOverrides 0x86a11d0)
	...
	// Function /Script/FortniteGame.FortGameModeZone.SetJoinability (Underlying native function: SetJoinability 0x86a0f8c)
	void SetJoinability(bool& bMatchJoinable); // (BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModeZone.SetEnemyAIItemCacheLootDrops (Underlying native function: SetEnemyAIItemCacheLootDrops 0x86a0e80)
	void SetEnemyAIItemCacheLootDrops(bool& bValue); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModeZone.SetActiveSpawnPad (Underlying native function: SetActiveSpawnPad 0x86a0c9c)
	void SetActiveSpawnPad(class ABuildingSMActor*& InActiveSpawnPad); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModeZone.ReplicateHealthAndShield (Underlying native function: ReplicateHealthAndShield 0x86a05c0)
	void ReplicateHealthAndShield(); // (Native | Public)

	// Function /Script/FortniteGame.FortGameModeZone.OnMorningReached (Underlying native function: OnMorningReached 0x869fcd8)
	void OnMorningReached(); // (Native | Public)

	// Function /Script/FortniteGame.FortGameModeZone.OnEveningReached (Underlying native function: OnEveningReached 0x869fc98)
	void OnEveningReached(); // (Native | Public)

	// Function /Script/FortniteGame.FortGameModeZone.IsSpectatingAllowedAfterDeath (Underlying native function: IsSpectatingAllowedAfterDeath 0x869f9f8)
	bool IsSpectatingAllowedAfterDeath(); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGameModeZone.IsGameReadyToSelectLoot (Underlying native function: IsGameReadyToSelectLoot 0x869f770)
	bool IsGameReadyToSelectLoot(); // (Native | Public | Const)

	// Function /Script/FortniteGame.FortGameModeZone.GetTeammateReviveGameplayEffectOverride (Underlying native function: GetTeammateReviveGameplayEffectOverride 0x869eddc)
	class UClass* GetTeammateReviveGameplayEffectOverride(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.FortGameModeZone.GetPlayerStartupController (Underlying native function: GetPlayerStartupController 0x869ecd8)
	class AFortPlayerStartupController* GetPlayerStartupController(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortGameModeZone.ClearPlayerStartLocationOverrides (Underlying native function: ClearPlayerStartLocationOverrides 0x273fd14)
