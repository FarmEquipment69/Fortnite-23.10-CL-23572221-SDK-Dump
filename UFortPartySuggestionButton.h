...
class UFortPartySuggestionButton : public UCommonButtonLegacy
{
	...
	// Function /Script/FortniteUI.FortPartySuggestionButton.UpdateDisplayInfo (Underlying native function: UpdateDisplayInfo 0xa5f68e4)
	...
	// Function /Script/FortniteUI.FortPartySuggestionButton.HandleSuggestionAccepted (Underlying native function: HandleSuggestionAccepted 0xa5f5b38)
	void HandleSuggestionAccepted(int& PlayerId); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortPartySuggestionButton.HandleLobbyStarted (Underlying native function: HandleLobbyStarted 0xa5f54f4)
