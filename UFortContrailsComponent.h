...
class UFortContrailsComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortContrailsComponent.SetContrailFXOverride (Underlying native function: SetContrailFXOverride 0x8067ec8)
	...
	// Function /Script/FortniteGame.FortContrailsComponent.RefreshContrailVisibility (Underlying native function: RefreshContrailVisibility 0x2899984)
	void RefreshContrailVisibility(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortContrailsComponent.HasContrailFXOverrde (Underlying native function: HasContrailFXOverrde 0x80670f4)
	bool HasContrailFXOverrde(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleParachuteSpawned (Underlying native function: HandleParachuteSpawned 0x2899984)
	void HandleParachuteSpawned(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleLanded (Underlying native function: HandleLanded 0x184c2f8)
	void HandleLanded(struct FHitResult& Hit); // (Final | Native | Protected | HasOutParms)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleEndSkydiving (Underlying native function: HandleEndSkydiving 0x2899984)
	void HandleEndSkydiving(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleEndParachuteMovement (Underlying native function: HandleEndParachuteMovement 0x2899984)
	void HandleEndParachuteMovement(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleBeginSkydiving (Underlying native function: HandleBeginSkydiving 0x2899984)
	void HandleBeginSkydiving(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortContrailsComponent.HandleBeginParachuteMovement (Underlying native function: HandleBeginParachuteMovement 0x2899984)
	void HandleBeginParachuteMovement(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortContrailsComponent.GetContrailsState (Underlying native function: GetContrailsState 0x8066a44)
	enum EFortContrailsState GetContrailsState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortContrailsComponent.GetContrailFXOverride (Underlying native function: GetContrailFXOverride 0x806690c)
	struct TWeakObjectPtr<class UFXSystemAsset> GetContrailFXOverride(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortContrailsComponent.GetContrailFXComponent (Underlying native function: GetContrailFXComponent 0x80668a0)
	class UFXSystemComponent* GetContrailFXComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortContrailsComponent.AreContrailsLoaded (Underlying native function: AreContrailsLoaded 0x8065fbc)
