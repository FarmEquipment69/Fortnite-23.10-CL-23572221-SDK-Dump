...
class UFortPawnComponent_PassiveHealer : public UFortPawnComponent
{
	...
	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.Stop (Underlying native function: Stop 0x273fd14)
	void Stop(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.Start (Underlying native function: Start 0x273fd14)
	void Start(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.OnRep_PassiveHealingRunning (Underlying native function: OnRep_PassiveHealingRunning 0x8496cf8)
	void OnRepPassiveHealingRunning(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.OnHealedPlayerStoppedEmote (Underlying native function: OnHealedPlayerStoppedEmote 0x84961e4)
	...
	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.OnHealedPlayerStartedEmote (Underlying native function: OnHealedPlayerStartedEmote 0x8495f40)
	...
	// Function /Script/FortniteGame.FortPawnComponent_PassiveHealer.GetGreetingPassiveHealingText (Underlying native function: GetGreetingPassiveHealingText 0x2920aac)
