...
class UAthenaIGMPartyMemberWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaIGMPartyMemberWidget.IsPlayingFortnite (Underlying native function: IsPlayingFortnite 0xa3a1b84)
	bool IsPlayingFortnite(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaIGMPartyMemberWidget.IsEmptySlot (Underlying native function: IsEmptySlot 0x2aa7320)
	bool IsEmptySlot(); // (Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaIGMPartyMemberWidget.GetIsLocalPlayerSlot (Underlying native function: GetIsLocalPlayerSlot 0xa3a02a4)
	bool GetIsLocalPlayerSlot(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaIGMPartyMemberWidget.GetIsInGameSlot (Underlying native function: GetIsInGameSlot 0xa3a028c)
