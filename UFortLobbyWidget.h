...
class UFortLobbyWidget : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortLobbyWidget.HandleEmoteClicked (Underlying native function: HandleEmoteClicked 0x1f89c2c)
	void HandleEmoteClicked(bool& bPassThrough); // (Native | Protected | HasOutParms)

	// Function /Script/FortniteUI.FortLobbyWidget.DynamicHandleLoadingScreenVisibilityChanged (Underlying native function: DynamicHandleLoadingScreenVisibilityChanged 0x25e34ac)
