...
class AFortAthenaMutator_SpyRumble : public AFortAthenaMutator_TDM
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_SpyRumble.OnRep_NumKillsForNextPerkUnlock (Underlying native function: OnRep_NumKillsForNextPerkUnlock 0x8263644)
