...
class UFortQuestTrackerList : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortQuestTrackerList.HandleSizeEstimateChanged (Underlying native function: HandleSizeEstimateChanged 0xa760b58)
	void HandleSizeEstimateChanged(class UObject*& ChangedElement); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestTrackerList.HandleQuestsUpdated (Underlying native function: HandleQuestsUpdated 0xa760a9c)
	void HandleQuestsUpdated(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestTrackerList.HandlePinnedQuestsChanged (Underlying native function: HandlePinnedQuestsChanged 0xa7609c4)
	void HandlePinnedQuestsChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestTrackerList.HandleHUDFinalObjectiveHidden (Underlying native function: HandleHUDFinalObjectiveHidden 0xa7608b0)
	void HandleHUDFinalObjectiveHidden(class UFortQuestItem*& QuestItem); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuestTrackerList.GetVisibleQuestsToDisplay (Underlying native function: GetVisibleQuestsToDisplay 0xa760800)
