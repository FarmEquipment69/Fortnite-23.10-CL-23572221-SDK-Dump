...
class UAthenaEquippedItemBase : public UBacchusHUDElement
{
	...
	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWorldItemsChanged (Underlying native function: HandleWorldItemsChanged 0xa2e9d00)
	void HandleWorldItemsChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWeaponTargetingChanged (Underlying native function: HandleWeaponTargetingChanged 0xa2e9c5c)
	void HandleWeaponTargetingChanged(bool& bIsTargeting); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWeaponReloadStarted (Underlying native function: HandleWeaponReloadStarted 0xa2e9b94)
	void HandleWeaponReloadStarted(float& ReloadTime, enum EFortWeaponReloadType& ReloadType); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWeaponReloadCancelled (Underlying native function: HandleWeaponReloadCancelled 0xa2e9b80)
	void HandleWeaponReloadCancelled(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWeaponOverheatValueChanged (Underlying native function: HandleWeaponOverheatValueChanged 0xa2e9a40)
	...
	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleWeaponEquipped (Underlying native function: HandleWeaponEquipped 0xa2e997c)
	void HandleWeaponEquipped(class AFortWeapon*& NewWeapon, class AFortWeapon*& PrevWeapon); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleViewTargetChanged (Underlying native function: HandleViewTargetChanged 0xa2e9968)
	void HandleViewTargetChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleSecondaryFireReleased (Underlying native function: HandleSecondaryFireReleased 0xa2e9708)
	void HandleSecondaryFireReleased(class AFortWeapon*& Weapon); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleSecondaryFirePressed (Underlying native function: HandleSecondaryFirePressed 0xa2e9670)
	void HandleSecondaryFirePressed(class AFortWeapon*& Weapon); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleLocalAmmoChanged (Underlying native function: HandleLocalAmmoChanged 0xa2e8d1c)
	void HandleLocalAmmoChanged(int& LocalCount, int& LocalRemaining); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaEquippedItemBase.HandleBuildingMaterialChanged (Underlying native function: HandleBuildingMaterialChanged 0xa2e8990)
