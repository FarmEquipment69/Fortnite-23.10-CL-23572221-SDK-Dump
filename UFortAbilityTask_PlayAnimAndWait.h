...
class UFortAbilityTask_PlayAnimAndWait : public UAbilityTask
{
	...
	// Function /Script/FortniteGame.FortAbilityTask_PlayAnimAndWait.OnAnimInterrupted (Underlying native function: OnAnimInterrupted 0x7e710f4)
	void OnAnimInterrupted(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAbilityTask_PlayAnimAndWait.OnAnimBlendingOut (Underlying native function: OnAnimBlendingOut 0x7e7100c)
	void OnAnimBlendingOut(class UAnimMontage*& Montage, bool& bInterrupted); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAbilityTask_PlayAnimAndWait.CreatePlayAnimAndWaitProxy (Underlying native function: CreatePlayAnimAndWaitProxy 0x7e6f618)
