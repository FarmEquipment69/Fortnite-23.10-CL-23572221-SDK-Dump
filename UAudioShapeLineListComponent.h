...
class UAudioShapeLineListComponent : public UAudioShapePrimitiveComponent
{
	...
	// Function /Script/AudioShapes.AudioShapeLineListComponent.UpdatePoint (Underlying native function: UpdatePoint 0x7b0420c)
	bool UpdatePoint(int& InIndex, struct FVector& InPoint); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/AudioShapes.AudioShapeLineListComponent.RemovePoint (Underlying native function: RemovePoint 0x7b03d4c)
	bool RemovePoint(int& InIndex); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/AudioShapes.AudioShapeLineListComponent.GetPoints (Underlying native function: GetPoints 0x7b03ca8)
	...
	// Function /Script/AudioShapes.AudioShapeLineListComponent.AddPoint (Underlying native function: AddPoint 0x7b03b70)
