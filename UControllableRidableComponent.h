...
class UControllableRidableComponent : public URidableComponent
{
	...
	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.ServerDoJumpExit (Underlying native function: ServerDoJumpExit 0x6ffbaa4)
	void ServerDoJumpExit(); // (Net | NetReliable | Native | Event | Protected | NetServer | BlueprintCallable)

	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.OnRep_IsBeingControlled (Underlying native function: OnRep_IsBeingControlled 0x204fb58)
	void OnRepIsBeingControlled(); // (Final | Native | Protected)

	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.OnCapsuleBeginOverlap (Underlying native function: OnCapsuleBeginOverlap 0x6ffb260)
	...
	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.IsSprintToggleable (Underlying native function: IsSprintToggleable 0x6ffb1c4)
	...
	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.GetAbilityDisplayText (Underlying native function: GetAbilityDisplayText 0x6ffa338)
	struct FText GetAbilityDisplayText(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.CanStartSprinting (Underlying native function: CanStartSprinting 0x6ffa048)
	bool CanStartSprinting(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.CancelBuildBar (Underlying native function: CancelBuildBar 0x6ffa06c)
	void CancelBuildBar(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/RidingCodeRuntime.ControllableRidableComponent.CanBeControlled (Underlying native function: CanBeControlled 0x6ff9df8)
