...
class UFortCMSInfoCarousel : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCMSInfoCarousel.NavigatePageRight (Underlying native function: NavigatePageRight 0xa55c1bc)
	void NavigatePageRight(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCMSInfoCarousel.NavigatePageLeft (Underlying native function: NavigatePageLeft 0xa55c188)
