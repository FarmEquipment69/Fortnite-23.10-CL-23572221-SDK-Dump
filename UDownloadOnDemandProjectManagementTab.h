...
class UDownloadOnDemandProjectManagementTab : public UUserWidget
{
	...
	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.UpdateProjectConfirmed (Underlying native function: UpdateProjectConfirmed 0x746a5ac)
	void UpdateProjectConfirmed(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed (Underlying native function: RemoveProjectConfirmed 0x746a508)
