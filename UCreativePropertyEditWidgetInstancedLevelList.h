...
class UCreativePropertyEditWidgetInstancedLevelList : public UCreativePropertyEditWidgetLevelListBase
{
	...
	// Function /Script/FortniteUI.CreativePropertyEditWidgetInstancedLevelList.HandleNewLevelButtonClicked (Underlying native function: HandleNewLevelButtonClicked 0xa5856d0)
	void HandleNewLevelButtonClicked(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.CreativePropertyEditWidgetInstancedLevelList.ClientLevelListUpdated (Underlying native function: ClientLevelListUpdated 0xa5836d8)
