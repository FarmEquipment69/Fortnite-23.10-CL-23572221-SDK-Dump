...
class AAthenaHoldingArea : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.AthenaHoldingArea.OnRep_IgnoredPlayerPawns (Underlying native function: OnRep_IgnoredPlayerPawns 0x7fbde78)
	void OnRepIgnoredPlayerPawns(); // (Final | Native | Private)

	// Function /Script/FortniteGame.AthenaHoldingArea.OnRep_bHoldingAreaActive (Underlying native function: OnRep_bHoldingAreaActive 0x7fbdec4)
