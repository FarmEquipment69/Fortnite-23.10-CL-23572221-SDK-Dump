...
class UFortQuestMapNodeLayout_Legacy : public UUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortQuestMapNodeLayout_Legacy.HandleQuestIndexSelectionModelIndexChanged (Underlying native function: HandleQuestIndexSelectionModelIndexChanged 0x7245270)
	void HandleQuestIndexSelectionModelIndexChanged(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortQuestMapNodeLayout_Legacy.HandleQuestButtonSelected (Underlying native function: HandleQuestButtonSelected 0x7245140)
