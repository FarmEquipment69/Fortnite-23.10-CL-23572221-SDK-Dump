...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x3a88 (0x8)
	class UNiagaraComponent* WildlifeFootDust; // 0x3a90 (0x8)
	class UFortPawnComponent_Convert* ConvertComponent; // 0x3a98 (0x8)
	struct TWeakObjectPtr<class UClass> LayerIdle; // 0x3aa0 (0x28)
	struct TWeakObjectPtr<class UClass> LayerLocomotion; // 0x3ac8 (0x28)
	struct TWeakObjectPtr<class UClass> LayerJump; // 0x3af0 (0x28)
	unsigned char LeaderTeam; // 0x3b18 (0x1)
	unsigned char unreflected_3b19[0x7]; // 0x3b19 (0x7) 
	class USoundEffectSourcePresetChain* VocalSourceEffectChainOverride; // 0x3b20 (0x8)
	bool bTamingEnabled; // 0x3b28 (0x1)
	unsigned char unreflected_3b29[0x7]; // 0x3b29 (0x7) 
	struct FMulticastInlineDelegate OnPickupGrabbedDestroyed; // 0x3b30 (0x10)
	bool bCanBeInteractedWithWhileTamed; // 0x3b40 (0x1)
	unsigned char unreflected_3b41[0x3]; // 0x3b41 (0x3) 
	struct FActiveGameplayEffectHandle* GEQuestConvertedHandle; // 0x3b44 (0x8)
	unsigned char unreflected_3b4c[0x4]; // 0x3b4c (0x4) 
	class UClass* GEQuestConvertedIrwin; // 0x3b50 (0x8)
	struct FMulticastInlineDelegate ConvertedDispatcher; // 0x3b58 (0x10)
	bool bIsBeingRidden; // 0x3b68 (0x1)
	bool NPCStatusWidgetShouldDisplayDamage; // 0x3b69 (0x1)
	unsigned char unreflected_3b6a[0x6]; // 0x3b6a (0x6) 
	class UClass* GEGoalSelectionWhileTamed; // 0x3b70 (0x8)
	struct FGameplayTagContainer TGoalSelectionWhileTamed; // 0x3b78 (0x20)
	double CurrentEnergy; // 0x3b98 (0x8)
	struct FGameplayTag IrwinSlidingGC; // 0x3ba0 (0x4)
	bool bLeaderSetSuccess; // 0x3ba4 (0x1)
	unsigned char unreflected_3ba5[0x3]; // 0x3ba5 (0x3) 
	struct FGameplayTag JumpLandSoundLibTag; // 0x3ba8 (0x4)
	struct FGameplayTag TameSoundLibTag; // 0x3bac (0x4)
	class USoundBase* SoundIndicatorSoundUnridden; // 0x3bb0 (0x8)
	class USoundBase* SoundIndicatorSoundRidden; // 0x3bb8 (0x8)
	bool OverrideIncomingDmg; // 0x3bc0 (0x1)
	unsigned char unreflected_3bc1[0x7]; // 0x3bc1 (0x7) 
	double OverridenIncomingDmgAmount; // 0x3bc8 (0x8)
	struct FMulticastInlineDelegate OnModifiedDamageReceived; // 0x3bd0 (0x10)
	double ColorVariation; // 0x3be0 (0x8)
