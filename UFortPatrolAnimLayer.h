...
class UFortPatrolAnimLayer : public UFortBaseLayerAnimInstance
{
	...
	// Function /Script/FortniteGame.FortPatrolAnimLayer.SetPatrolAnimAsset (Underlying native function: SetPatrolAnimAsset 0x7f76ce0)
	void SetPatrolAnimAsset(class UFortPatrolAnimAsset*& NewAnimAsset); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPatrolAnimLayer.GetPatrolAnimSetFromWeapon (Underlying native function: GetPatrolAnimSetFromWeapon 0x7f76148)
