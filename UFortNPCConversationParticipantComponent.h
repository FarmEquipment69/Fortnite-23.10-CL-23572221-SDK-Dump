...
class UFortNPCConversationParticipantComponent : public UFortNonPlayerConversationParticipantComponent
{
	...
	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.OnRep_ConversationModeActive (Underlying native function: OnRep_ConversationModeActive 0x84aaf30)
	void OnRepConversationModeActive(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.OnRep_CanStartConversation (Underlying native function: OnRep_CanStartConversation 0x2855cfc)
	void OnRepCanStartConversation(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.OnPlayerPawnOwnerDied (Underlying native function: OnPlayerPawnOwnerDied 0x84aaa58)
	...
	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.OnBotControllerDBNOStatusChanged (Underlying native function: OnBotControllerDBNOStatusChanged 0x84aa78c)
	void OnBotControllerDBNOStatusChanged(class AFortAthenaAIBotController*& BotController, bool& bIsDBNO); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.OnBotControllerAlertLevelChanged (Underlying native function: OnBotControllerAlertLevelChanged 0x84aa694)
	...
	// Function /Script/FortniteGame.FortNPCConversationParticipantComponent.GetCharacterData (Underlying native function: GetCharacterData 0x84a9700)
