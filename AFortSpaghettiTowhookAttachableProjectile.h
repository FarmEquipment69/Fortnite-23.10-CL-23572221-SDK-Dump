...
class AFortSpaghettiTowhookAttachableProjectile : public AFortAttachableProjectileDeprecated
{
	...
	// Function /Script/FortniteGame.FortSpaghettiTowhookAttachableProjectile.GetRopeAttachLocation (Underlying native function: GetRopeAttachLocation 0x8e6bde4)
	struct FVector GetRopeAttachLocation(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortSpaghettiTowhookAttachableProjectile.DestroyProjectile (Underlying native function: DestroyProjectile 0x6ca340c)
