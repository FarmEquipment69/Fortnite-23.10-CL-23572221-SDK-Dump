...
class UAthenaInventoryScreenContainer : public UCommonActivatableWidget
{
	...
	class UFortTabListWidgetBase* TabListInventory; // 0x520 (0x8)
	...
	// Function /Script/FortniteUI.AthenaInventoryScreenContainer.GetPlayerInventoryWidget (Underlying native function: GetPlayerInventoryWidget 0xa3cbf74)
	class UAthenaInventoryPanelContainer* GetPlayerInventoryWidget(); // (Native | Event | Protected | BlueprintEvent | Const)

	// Function /Script/FortniteUI.AthenaInventoryScreenContainer.GetActiveTabWidget (Underlying native function: GetActiveTabWidget 0xa3cbc28)
