...
class UFortQuickBarSlotBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.UpdateKeyBindingVisibility (Underlying native function: UpdateKeyBindingVisibility 0xa7817c4)
	void UpdateKeyBindingVisibility(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.UpdateKeyBindingText (Underlying native function: UpdateKeyBindingText 0xa7817b0)
	void UpdateKeyBindingText(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.UpdateItemCardsVisibility (Underlying native function: UpdateItemCardsVisibility 0xa781788)
	void UpdateItemCardsVisibility(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.SetTopComboSwitcherVisibility (Underlying native function: SetTopComboSwitcherVisibility 0xa781708)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.SetQuickbarTypeRuntime (Underlying native function: SetQuickbarTypeRuntime 0xa7811a0)
	void SetQuickbarTypeRuntime(enum EFortQuickBars& NewQuickBarType, bool& bRefresh); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.SetQuickbarIndexRuntime (Underlying native function: SetQuickbarIndexRuntime 0xa7810c0)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.SetBottomComboSwitcherVisibility (Underlying native function: SetBottomComboSwitcherVisibility 0xa780d3c)
	void SetBottomComboSwitcherVisibility(enum ESlateVisibility& InVisibility); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.Resize (Underlying native function: Resize 0xa780ca8)
	void Resize(enum EFortItemCardSize& CardSize); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.RefreshItemIfSlotChanged (Underlying native function: RefreshItemIfSlotChanged 0xa780bac)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.RefreshItem (Underlying native function: RefreshItem 0xa780b98)
	void RefreshItem(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.RefreshInventoryCapacity (Underlying native function: RefreshInventoryCapacity 0xa7802d8)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.OnMinigameStarted (Underlying native function: OnMinigameStarted 0xa7802d8)
	void OnMinigameStarted(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.OnMinigameEnded (Underlying native function: OnMinigameEnded 0xa7802c0)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.GetSlotSizeForItem (Underlying native function: GetSlotSizeForItem 0xa77e480)
	...
	// Function /Script/FortniteUI.FortQuickBarSlotBase.GetKeyBindingActionKeyboard (Underlying native function: GetKeyBindingActionKeyboard 0xa77e3dc)
	struct FName GetKeyBindingActionKeyboard(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.GetKeyBindingActionGamepad (Underlying native function: GetKeyBindingActionGamepad 0xa77e3b0)
	struct FName GetKeyBindingActionGamepad(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortQuickBarSlotBase.GetKeyBindingAction (Underlying native function: GetKeyBindingAction 0xa77e384)
