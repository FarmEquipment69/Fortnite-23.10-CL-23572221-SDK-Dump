...
class UButton : public UContentWidget
{
	...
	// Function /Script/UMG.Button.SetTouchMethod (Underlying native function: SetTouchMethod 0x9920c4c)
	void SetTouchMethod(struct TEnumAsByte<EButtonTouchMethod>& InTouchMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.Button.SetStyle (Underlying native function: SetStyle 0x9920970)
	void SetStyle(struct FButtonStyle& InStyle); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/UMG.Button.SetPressMethod (Underlying native function: SetPressMethod 0x99203a0)
	void SetPressMethod(struct TEnumAsByte<EButtonPressMethod>& InPressMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.Button.SetColorAndOpacity (Underlying native function: SetColorAndOpacity 0x991f1f0)
	void SetColorAndOpacity(struct FLinearColor& InColorAndOpacity); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/UMG.Button.SetClickMethod (Underlying native function: SetClickMethod 0x991f0f0)
	void SetClickMethod(struct TEnumAsByte<EButtonClickMethod>& InClickMethod); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.Button.SetBackgroundColor (Underlying native function: SetBackgroundColor 0x991ed9c)
	void SetBackgroundColor(struct FLinearColor& InBackgroundColor); // (Final | Native | Public | HasDefaults | BlueprintCallable)

	// Function /Script/UMG.Button.IsPressed (Underlying native function: IsPressed 0x991e258)
