...
class UFortBattlePassPurchaseResourcesWidget : public UCommonActivatableWidget
{
	...
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.IsReloadMtxEnabled (Underlying native function: IsReloadMtxEnabled 0x6ec7b90)
	bool IsReloadMtxEnabled(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.HandlePurchaseMultiComplete (Underlying native function: HandlePurchaseMultiComplete 0x6ec78a8)
	...
	// Function /Script/BattlePassBase.FortBattlePassPurchaseResourcesWidget.HandlePurchaseComplete (Underlying native function: HandlePurchaseComplete 0x6ec75f4)
