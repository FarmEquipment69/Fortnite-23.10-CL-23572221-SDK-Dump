...
class UFortItemManagementItemTileButton_STW : public UFortItemTileButton
{
	...
	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.UpdateEquipSlotOverlay (Underlying native function: UpdateEquipSlotOverlay 0x71d0c1c)
	void UpdateEquipSlotOverlay(int& CurrentSlotIndex); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.PopulateEquipSlotOverlay (Underlying native function: PopulateEquipSlotOverlay 0x71d04a0)
	void PopulateEquipSlotOverlay(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.OnSlotItemComplete (Underlying native function: OnSlotItemComplete 0x71d0238)
	void OnSlotItemComplete(class UFortAccountItem*& SlottedItem, struct FName& SlotId); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.IsValidEquipSlotOverlayIndex (Underlying native function: IsValidEquipSlotOverlayIndex 0x71cff3c)
	...
	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.GetPopupMenu (Underlying native function: GetPopupMenu 0x71cf3c4)
	class UUserWidget* GetPopupMenu(); // (Final | Native | Private)

	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.GetItemManagementMode (Underlying native function: GetItemManagementMode 0x71cf0b0)
	enum EFortItemManagementMode GetItemManagementMode(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortItemManagementItemTileButton_STW.GetHomebaseSquadSlotForItem (Underlying native function: GetHomebaseSquadSlotForItem 0x71cef08)
