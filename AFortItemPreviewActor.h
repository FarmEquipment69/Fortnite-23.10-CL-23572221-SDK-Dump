...
class AFortItemPreviewActor : public AActor
{
	...
	// Function /Script/FortniteGame.FortItemPreviewActor.IsSceneTransitioning (Underlying native function: IsSceneTransitioning 0x87b43b0)
	bool IsSceneTransitioning(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortItemPreviewActor.ArePreviewVisualsReady (Underlying native function: ArePreviewVisualsReady 0x87b2138)
