...
class UAthenaEventMatchTeamWidgetBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaEventMatchTeamWidgetBase.OnPlayerDisconnectedChanged (Underlying native function: OnPlayerDisconnectedChanged 0x22ebcc4)
	...
	// Function /Script/FortniteUI.AthenaEventMatchTeamWidgetBase.OnPlayerDeadStateChanged (Underlying native function: OnPlayerDeadStateChanged 0x22ebdb8)
	void OnPlayerDeadStateChanged(class UAthenaRemotePlayerViewData*& InPlayerData, bool& bInIsDead); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaEventMatchTeamWidgetBase.IsTeamDead (Underlying native function: IsTeamDead 0xa43eeb4)
	bool IsTeamDead(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaEventMatchTeamWidgetBase.GetTeamKills (Underlying native function: GetTeamKills 0xa43d2a0)
