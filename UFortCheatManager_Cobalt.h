...
class UFortCheatManager_Cobalt : public UFortCheatManager_Coupled
{
	...
	// Function /Script/FortniteGame.FortCheatManager_Cobalt.SimulateFullCobaltMatch (Underlying native function: SimulateFullCobaltMatch 0x6df775c)
	void SimulateFullCobaltMatch(bool& bSimulate); // (Final | BlueprintAuthorityOnly | Exec | Native | Public)

	// Function /Script/FortniteGame.FortCheatManager_Cobalt.EndCobaltRound (Underlying native function: EndCobaltRound 0x273fd14)
	void EndCobaltRound(); // (Final | BlueprintAuthorityOnly | Exec | Native | Public)

	// Function /Script/FortniteGame.FortCheatManager_Cobalt.AwardCobaltTeamPoints (Underlying native function: AwardCobaltTeamPoints 0x81d6fd0)
