...
class AFortVehicleManager : public AActor
{
	...
	// Function /Script/FortniteGame.FortVehicleManager.OnNavSystemLockReleased (Underlying native function: OnNavSystemLockReleased 0x273fd14)
	void OnNavSystemLockReleased(); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortVehicleManager.GetVehicleManager (Underlying native function: GetVehicleManager 0x8794844)
	...
	// Function /Script/FortniteGame.FortVehicleManager.GetVehicleCountByTag (Underlying native function: GetVehicleCountByTag 0x87946d4)
