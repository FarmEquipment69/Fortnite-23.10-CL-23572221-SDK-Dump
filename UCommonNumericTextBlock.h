...
class UCommonNumericTextBlock : public UCommonTextBlock
{
	...
	// Function /Script/CommonUI.CommonNumericTextBlock.SetNumericType (Underlying native function: SetNumericType 0x662fcf0)
	void SetNumericType(enum ECommonNumericType& InNumericType); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/CommonUI.CommonNumericTextBlock.SetCurrentValue (Underlying native function: SetCurrentValue 0x1e22bf4)
	...
	// Function /Script/CommonUI.CommonNumericTextBlock.IsInterpolatingNumericValue (Underlying native function: IsInterpolatingNumericValue 0x662df84)
	bool IsInterpolatingNumericValue(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/CommonUI.CommonNumericTextBlock.InterpolateToValue (Underlying native function: InterpolateToValue 0x662dd7c)
	...
	// Function /Script/CommonUI.CommonNumericTextBlock.GetTargetValue (Underlying native function: GetTargetValue 0x662d894)
