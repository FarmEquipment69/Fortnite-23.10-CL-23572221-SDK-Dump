...
class AFortMissionStormSafeZone : public AActor
{
	...
	// Function /Script/FortniteGame.FortMissionStormSafeZone.SetSafeZoneRadius (Underlying native function: SetSafeZoneRadius 0x6df7bc0)
	...
	// Function /Script/FortniteGame.FortMissionStormSafeZone.OnRep_ZoneRadius (Underlying native function: OnRep_ZoneRadius 0x88ecbb8)
	void OnRepZoneRadius(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMissionStormSafeZone.OnRep_SafeZoneInStormStateChanged (Underlying native function: OnRep_SafeZoneInStormStateChanged 0x88ecb84)
	...
	// Function /Script/FortniteGame.FortMissionStormSafeZone.GetSafeZoneRadius (Underlying native function: GetSafeZoneRadius 0x88ea868)
	float GetSafeZoneRadius(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMissionStormSafeZone.GetConvertedSafeZoneRadius (Underlying native function: GetConvertedSafeZoneRadius 0x88e9e10)
