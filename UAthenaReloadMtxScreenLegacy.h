...
class UAthenaReloadMtxScreenLegacy : public UAthenaReloadMtxScreenBaseLegacy
{
	...
	// Function /Script/FortniteUI.AthenaReloadMtxScreenLegacy.GetWidgetToFocusFromOfferList (Underlying native function: GetWidgetToFocusFromOfferList 0xa3f98c8)
