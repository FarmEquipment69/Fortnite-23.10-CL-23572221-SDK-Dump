...
class UBacchusButton : public UBacchusHUDElement
{
	...
	// Function /Script/FortniteUI.BacchusButton.SetIconPressed (Underlying native function: SetIconPressed 0xa4240b0)
	void SetIconPressed(bool& bIsPressed); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.BacchusButton.SetDefaultIcon (Underlying native function: SetDefaultIcon 0xa424034)
	void SetDefaultIcon(class UPaperSprite*& Icon); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.BacchusButton.SetButtonSprite (Underlying native function: SetButtonSprite 0x6eea8f4)
	void SetButtonSprite(class UPaperSprite*& NewSprite); // (0x00000002 | Native | Event | Protected | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusButton.SetButtonSize (Underlying native function: SetButtonSize 0xa423fac)
	void SetButtonSize(float& NewButtonSize); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusButton.SetButtonDisplayScale (Underlying native function: SetButtonDisplayScale 0xa423f24)
	void SetButtonDisplayScale(float& NewDisplayScale); // (0x00000002 | Native | Event | Public | BlueprintCallable | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusButton.OnClicked (Underlying native function: OnClicked 0x8b1231c)
	void OnClicked(); // (0x00000002 | Native | Event | Protected | BlueprintEvent)

	// Function /Script/FortniteUI.BacchusButton.HandleCursorModeChanged (Underlying native function: HandleCursorModeChanged 0xa422c60)
