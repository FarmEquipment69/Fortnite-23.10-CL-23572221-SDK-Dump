...
class UFortSidebarExitPopup : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortSidebarExitPopup.ShowConfirmationView (Underlying native function: ShowConfirmationView 0x2b2651c)
	void ShowConfirmationView(enum ESidebarExitActions& ActionToConfirm); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSidebarExitPopup.Show (Underlying native function: Show 0xa6179a8)
	void Show(bool& bTakeFocus); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSidebarExitPopup.Hide (Underlying native function: Hide 0xa6176d0)
	void Hide(bool& bDoImmediately); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSidebarExitPopup.HandleTransitioningChanged (Underlying native function: HandleTransitioningChanged 0xa617650)
	void HandleTransitioningChanged(bool& bTransitioning); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortSidebarExitPopup.HandleShowPopupAnimFinished (Underlying native function: HandleShowPopupAnimFinished 0x2bec080)
	void HandleShowPopupAnimFinished(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortSidebarExitPopup.HandleHidePopupAnimFinished (Underlying native function: HandleHidePopupAnimFinished 0x2c0b178)
	void HandleHidePopupAnimFinished(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortSidebarExitPopup.HandleActiveWidgetIndexChanged (Underlying native function: HandleActiveWidgetIndexChanged 0xa61706c)
	void HandleActiveWidgetIndexChanged(class UWidget*& ActiveWidget, int& ActiveWidgetIndex); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortSidebarExitPopup.ConfirmSelectedAction (Underlying native function: ConfirmSelectedAction 0x27aeabc)
	void ConfirmSelectedAction(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortSidebarExitPopup.CancelConfirmationView (Underlying native function: CancelConfirmationView 0xa616f14)
