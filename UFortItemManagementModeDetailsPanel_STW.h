...
class UFortItemManagementModeDetailsPanel_STW : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortItemManagementModeDetailsPanel_STW.GetItemManagementMode (Underlying native function: GetItemManagementMode 0x71cf0d4)
