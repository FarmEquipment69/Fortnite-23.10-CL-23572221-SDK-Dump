...
class UChildActorComponent : public USceneComponent
{
	...
	// Function /Script/Engine.ChildActorComponent.SetChildActorClass (Underlying native function: SetChildActorClass 0x2651254)
	void SetChildActorClass(class UClass*& InClass); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.ChildActorComponent.OnChildActorDestroyed (Underlying native function: OnChildActorDestroyed 0x150ca48)
