...
class APlayspaceLogic : public AActor
{
	...
	// Function /Script/PlayspaceSystem.PlayspaceLogic.OnRep_MatchStartTime (Underlying native function: OnRep_MatchStartTime 0x6ca340c)
	void OnRepMatchStartTime(); // (Native | Protected)

	// Function /Script/PlayspaceSystem.PlayspaceLogic.OnRep_bMatchHasEnded (Underlying native function: OnRep_bMatchHasEnded 0x1598c88)
