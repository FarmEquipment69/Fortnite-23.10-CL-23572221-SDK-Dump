...
class UFortMinigameObjectiveComponent : public UFortMinigameLogicComponent
{
	...
	// Function /Script/FortniteGame.FortMinigameObjectiveComponent.StopTracking (Underlying native function: StopTracking 0x88cb624)
	void StopTracking(bool& bPurgeHistory, float& Percentage); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMinigameObjectiveComponent.StartTracking (Underlying native function: StartTracking 0x88cb360)
	...
	// Function /Script/FortniteGame.FortMinigameObjectiveComponent.SetTrackedState (Underlying native function: SetTrackedState 0x88ca1e0)
	...
	// Function /Script/FortniteGame.FortMinigameObjectiveComponent.SetTrackedProgress (Underlying native function: SetTrackedProgress 0x88ca138)
	void SetTrackedProgress(float& Percentage); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMinigameObjectiveComponent.SetIsInteractionAllowed (Underlying native function: SetIsInteractionAllowed 0x88c92c0)
