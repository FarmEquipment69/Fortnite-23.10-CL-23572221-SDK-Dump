...
class UFortEditableFilteredCountedTextBox : public UUserWidget
{
	...
	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.SetTextWithForcedSanitization (Underlying native function: SetTextWithForcedSanitization 0xa5b31f4)
	void SetTextWithForcedSanitization(struct FText& Text); // (Final | Native | Public | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.SetEntryCharLimit (Underlying native function: SetEntryCharLimit 0x854b230)
	...
	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.HandleTextCommitted (Underlying native function: HandleTextCommitted 0xa5b0030)
	void HandleTextCommitted(struct FText& Text, struct TEnumAsByte<ETextCommit>& CommitMethod); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.HandleTextChanged (Underlying native function: HandleTextChanged 0xa5aff74)
	void HandleTextChanged(struct FText& Text); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.GetEntryCharLimit (Underlying native function: GetEntryCharLimit 0xa5af09c)
	int GetEntryCharLimit(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.GetAllowStyleEditing (Underlying native function: GetAllowStyleEditing 0xa5aee5c)
	bool GetAllowStyleEditing(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.FortEditableFilteredCountedTextBox.GetAllowLineBreaks (Underlying native function: GetAllowLineBreaks 0xa5aee44)
