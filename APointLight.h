...
class APointLight : public ALight
{
	...
	// Function /Script/Engine.PointLight.SetRadius (Underlying native function: SetRadius 0x9a54d04)
	void SetRadius(float& NewRadius); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/Engine.PointLight.SetLightFalloffExponent (Underlying native function: SetLightFalloffExponent 0x9a540d0)
