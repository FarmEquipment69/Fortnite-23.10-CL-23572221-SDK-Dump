...
class AFortAthenaMutator_MatchCondition : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_MatchCondition.OnRep_bSatisfied (Underlying native function: OnRep_bSatisfied 0x824a7d0)
	void OnRepbSatisfied(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortAthenaMutator_MatchCondition.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0x824a3c8)
