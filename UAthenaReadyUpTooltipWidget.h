...
class UAthenaReadyUpTooltipWidget : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaReadyUpTooltipWidget.HandlePartyWidgetReadinessChanged (Underlying native function: HandlePartyWidgetReadinessChanged 0xa3a0ebc)
