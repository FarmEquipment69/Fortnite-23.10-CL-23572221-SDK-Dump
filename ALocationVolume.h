...
class ALocationVolume : public AVolume
{
	...
	// Function /Script/Engine.LocationVolume.Unload (Underlying native function: Unload 0x273fd14)
	void Unload(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.LocationVolume.Load (Underlying native function: Load 0x273fd14)
	void Load(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.LocationVolume.IsLoaded (Underlying native function: IsLoaded 0x24f75e4)
