...
class AFortPlayerPet : public AActor
{
	...
	// Function /Script/FortniteGame.FortPlayerPet.ResetPetMaterials (Underlying native function: ResetPetMaterials 0x815f3d0)
	void ResetPetMaterials(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerPet.ReInitPetDisplay (Underlying native function: ReInitPetDisplay 0x815f300)
	...
	// Function /Script/FortniteGame.FortPlayerPet.OnRequestedCustomizationComplete (Underlying native function: OnRequestedCustomizationComplete 0x815f070)
	void OnRequestedCustomizationComplete(class AFortPlayerPawn*& Pawn); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortPlayerPet.InitalizeFromItemDef (Underlying native function: InitalizeFromItemDef 0x815d5ec)
	void InitalizeFromItemDef(class UAthenaPetItemDefinition*& InPetItemDef); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortPlayerPet.GetFortPlayerPawn (Underlying native function: GetFortPlayerPawn 0x815c7b8)
