...
class UAthenaAerialFeedback : public UFortAerialFeedback
{
	...
	// Function /Script/FortniteUI.AthenaAerialFeedback.HandleSkydiveLeaderChanged (Underlying native function: HandleSkydiveLeaderChanged 0xa375c14)
	void HandleSkydiveLeaderChanged(bool& bEnabled, bool& bLocal, class AFortPlayerState*& LeaderPlayerState); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaAerialFeedback.HandleKeybindsChanged (Underlying native function: HandleKeybindsChanged 0xa3753cc)
	void HandleKeybindsChanged(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaAerialFeedback.HandleBalloonMovementChanged (Underlying native function: HandleBalloonMovementChanged 0xa374ea0)
