...
class UFortCreativePropertyEditorColorPickerDialog : public UFortCreativePropertyEditorDialogBase
{
	...
	// Function /Script/FortniteUI.FortCreativePropertyEditorColorPickerDialog.HandleSearchTextChanged (Underlying native function: HandleSearchTextChanged 0xa5353b0)
	void HandleSearchTextChanged(struct FText& SearchText); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.FortCreativePropertyEditorColorPickerDialog.GetItemIndexFromUnfilteredItemList (Underlying native function: GetItemIndexFromUnfilteredItemList 0xa53410c)
