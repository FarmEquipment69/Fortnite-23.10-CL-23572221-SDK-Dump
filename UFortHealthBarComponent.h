...
class UFortHealthBarComponent : public USceneComponent
{
	...
	// Function /Script/FortniteGame.FortHealthBarComponent.SetHealthBarWidgetVisibility (Underlying native function: SetHealthBarWidgetVisibility 0x86eb5dc)
	void SetHealthBarWidgetVisibility(bool& bIsVisible); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHealthBarComponent.SetHealthBarVisibility (Underlying native function: SetHealthBarVisibility 0x86eb518)
	void SetHealthBarVisibility(bool& bNewVisibleState); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHealthBarComponent.SetHealthBarDisplayText (Underlying native function: SetHealthBarDisplayText 0x86eb47c)
	void SetHealthBarDisplayText(struct FText& NewDisplayText); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortHealthBarComponent.OnRep_IsVisible (Underlying native function: OnRep_IsVisible 0x86e7134)
	void OnRepIsVisible(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortHealthBarComponent.OnRep_DisplayText (Underlying native function: OnRep_DisplayText 0x86e7120)
	void OnRepDisplayText(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortHealthBarComponent.GetHealthBarDisplayText (Underlying native function: GetHealthBarDisplayText 0x86db290)
