...
class UFortQuestItemDefinition_Athena : public UFortQuestItemDefinition
{
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition_Athena.GetTandemCharacterData (Underlying native function: GetTandemCharacterData 0x8bfb27c)
	...
	// Function /Script/FortniteGame.FortQuestItemDefinition_Athena.GetSoftTandemCharacterData (Underlying native function: GetSoftTandemCharacterData 0x8bfb004)
	struct TWeakObjectPtr<class UFortTandemCharacterData> GetSoftTandemCharacterData(); // (Final | 0x00000002 | Native | Public | Const)

	// Function /Script/FortniteGame.FortQuestItemDefinition_Athena.GetQuestSubtype (Underlying native function: GetQuestSubtype 0x8bfadcc)
