...
class UFortControllerComponent_Aircraft : public UFortControllerComponent
{
	...
	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.ServerAttemptAircraftJump (Underlying native function: ServerAttemptAircraftJump 0x845dc9c)
	...
	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.PlacePlayerInAircraft (Underlying native function: PlacePlayerInAircraft 0x6d23b2c)
	...
	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.OnCurrentAircraftEnterDropZone (Underlying native function: OnCurrentAircraftEnterDropZone 0x845d314)
	...
	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.KickFromAircraft (Underlying native function: KickFromAircraft 0x845d300)
	void KickFromAircraft(); // (Final | 0x00000002 | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.IsInAircraft (Underlying native function: IsInAircraft 0x845d290)
	bool IsInAircraft(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.ClientExitAircraft (Underlying native function: ClientExitAircraft 0x662da48)
	void ClientExitAircraft(); // (Net | NetReliable | Native | Event | Protected | NetClient)

	// Function /Script/FortniteGame.FortControllerComponent_Aircraft.ClientEnterAircraft (Underlying native function: ClientEnterAircraft 0x6eea8f4)
