...
class UAthenaMatchXPScreenWidget : public UFortPostGameScreen
{
	...
	// Function /Script/FortniteUI.AthenaMatchXPScreenWidget.UpdateElementsVisibility (Underlying native function: UpdateElementsVisibility 0xa3a1e74)
	void UpdateElementsVisibility(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaMatchXPScreenWidget.SpectatorStreamingChanged (Underlying native function: SpectatorStreamingChanged 0xa3a12f8)
	...
	// Function /Script/FortniteUI.AthenaMatchXPScreenWidget.OnGamePhaseChanged (Underlying native function: OnGamePhaseChanged 0xa3a1be0)
	void OnGamePhaseChanged(enum EAthenaGamePhase& NewPhase); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AthenaMatchXPScreenWidget.HandleResurrectingNow (Underlying native function: HandleResurrectingNow 0xa3a12f8)
