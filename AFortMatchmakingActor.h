...
class AFortMatchmakingActor : public ABuildingActor
{
	...
	// Function /Script/FortniteGame.FortMatchmakingActor.ShouldUseBlueprintMMSCode (Underlying native function: ShouldUseBlueprintMMSCode 0x8718348)
	bool ShouldUseBlueprintMMSCode(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMatchmakingActor.GetMMSCodeForLocalPlayerParty (Underlying native function: GetMMSCodeForLocalPlayerParty 0x8714004)
