...
class UCustomCharacterPart : public UPrimaryDataAsset
{
	...
	// Function /Script/FortniteGame.CustomCharacterPart.ShouldAutoActivate (Underlying native function: ShouldAutoActivate 0x85b4eec)
	bool ShouldAutoActivate(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetSkeletalMesh (Underlying native function: GetSkeletalMesh 0x85b461c)
	class USkeletalMesh* GetSkeletalMesh(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetPartType (Underlying native function: GetPartType 0x85b4214)
	struct TEnumAsByte<EFortCustomPartType> GetPartType(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetMaterialOverridesByIndex (Underlying native function: GetMaterialOverridesByIndex 0x85b44c0)
	struct TMap<int, class UMaterialInterface*> GetMaterialOverridesByIndex(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.CustomCharacterPart.GetIdleFXSocketName (Underlying native function: GetIdleFXSocketName 0x27d4cd4)
	struct FName GetIdleFXSocketName(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetEffectNiagara (Underlying native function: GetEffectNiagara 0x85b4388)
	struct TWeakObjectPtr<class UNiagaraSystem> GetEffectNiagara(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetEffectCascade (Underlying native function: GetEffectCascade 0x85b4250)
	struct TWeakObjectPtr<class UParticleSystem> GetEffectCascade(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.CustomCharacterPart.GetCharacterPartType (Underlying native function: GetCharacterPartType 0x85b4214)
