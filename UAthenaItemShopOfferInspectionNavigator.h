...
class UAthenaItemShopOfferInspectionNavigator : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.AthenaItemShopOfferInspectionNavigator.SetArrowsEnabled (Underlying native function: SetArrowsEnabled 0xa3cdfb8)
	void SetArrowsEnabled(bool& bEnabled); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemShopOfferInspectionNavigator.RequestPreviousOffer (Underlying native function: RequestPreviousOffer 0xa3cdc54)
	void RequestPreviousOffer(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaItemShopOfferInspectionNavigator.RequestNextOffer (Underlying native function: RequestNextOffer 0xa3cdc08)
