...
{
	unsigned char unreflected_5ed4[0x4]; // 0x5ed4 (0x4) 
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x5ed8 (0x8)
	class UFortAthenaAlertStateComponent* FortAthenaAlertState; // 0x5ee0 (0x8)
	class UAudioComponent* VOAudioComponent; // 0x5ee8 (0x8)
	bool UseAlertness; // 0x5ef0 (0x1)
	bool UseVO; // 0x5ef1 (0x1)
	bool UseIdleVO; // 0x5ef2 (0x1)
	bool UseDropExtraLootOnDeath; // 0x5ef3 (0x1)
	bool UseFullBodyHitReact; // 0x5ef4 (0x1)
	enum EAlertLevel AlertLevel; // 0x5ef5 (0x1)
	enum EAlertLevel OldAlertLevel; // 0x5ef6 (0x1)
	unsigned char unreflected_5ef7[0x1]; // 0x5ef7 (0x1) 
	struct FGameplayTag GameplayCueAlertState; // 0x5ef8 (0x4)
	unsigned char unreflected_5efc[0x4]; // 0x5efc (0x4) 
	class UClass* GENPCStatusStressedInfinite; // 0x5f00 (0x8)
	class UClass* GENPCStatusStressedCooldown; // 0x5f08 (0x8)
	double MinDistanceToTargetToPlayCombatAlertAnimation; // 0x5f10 (0x8)
	struct FScalableFloat MinIdleVODelay; // 0x5f18 (0x28)
	struct FScalableFloat MaxIdleVODelay; // 0x5f40 (0x28)
	struct FName LootTierNameToSpawnWhenDead; // 0x5f68 (0x4)
	struct FName LootTierMedium; // 0x5f6c (0x4)
	struct FName LootTierShell; // 0x5f70 (0x4)
	struct FName LootTierHeavy; // 0x5f74 (0x4)
	struct FName LootTierLight; // 0x5f78 (0x4)
	struct FName LootTierRockets; // 0x5f7c (0x4)
	class UFortGameplayDataTrackerComponentManager* DataTrackerComponentManager; // 0x5f80 (0x8)
	struct FGameplayTag AlertLevelUnawareTag; // 0x5f88 (0x4)
	struct FGameplayTag AlertLevelAlertedTag; // 0x5f8c (0x4)
	struct FGameplayTag AlertLevelAggressiveTag; // 0x5f90 (0x4)
	struct FGameplayTag TCDisguiseTag; // 0x5f94 (0x4)
	class UClass* GERemoveDisguise; // 0x5f98 (0x8)
	class UFortAbilitySet* HitReactAbilitySet; // 0x5fa0 (0x8)
	class UAnimMontage* DefaultFullbodyHitReactionMontage; // 0x5fa8 (0x8)
	class UFortPatrolAnimAsset* CurrentPatrolAnimAsset; // 0x5fb0 (0x8)
	class UClass* PatrolLayerAnimBP; // 0x5fb8 (0x8)
	struct TArray<struct FFortPatrolAnimSetWeaponPair> PatrolAnimSetPairs; // 0x5fc0 (0x10)
	bool bShouldDoFullAnimationUpdate; // 0x5fd0 (0x1)
	unsigned char unreflected_5fd1[0x3]; // 0x5fd1 (0x3) 
	struct FActiveGameplayEffectHandle* GEDuelHandle; // 0x5fd4 (0x8)
	unsigned char unreflected_5fdc[0x4]; // 0x5fdc (0x4) 
	class UClass* GEDuelTag; // 0x5fe0 (0x8)
	class AFortPlayerPawn* Challenger; // 0x5fe8 (0x8)
	class UClass* OverrideLayerAnimBP; // 0x5ff0 (0x8)
	class UFortPatrolAnimAsset* FallbackPatrolAnimAsset; // 0x5ff8 (0x8)
	bool QuantizeVOToMusic; // 0x6000 (0x1)
	unsigned char unreflected_6001[0x7]; // 0x6001 (0x7) 
	struct FQuartzQuantizationBoundary QuantizationBoundary; // 0x6008 (0x20)
	struct FName VOQuantizationClockName; // 0x6028 (0x4)
	bool bIsInVehicleThatSupportsNoAlertState; // 0x602c (0x1)
	unsigned char unreflected_602d[0x3]; // 0x602d (0x3) 
	struct FActiveGameplayEffectHandle* GEQuestConvertedHandle; // 0x6030 (0x8)
	class UClass* GEQuestConvertedHireNPC; // 0x6038 (0x8)
	class USoundBase* DeathFXSound; // 0x6040 (0x8)
	class AFortPawn* PawnConverter; // 0x6048 (0x8)
	struct FGameplayTagContainer TagsToApplyOnConvertedPawn; // 0x6050 (0x20)
	struct FGameplayTagContainer TagsToApplyOnConvertingPawn; // 0x6070 (0x20)
	class USoundLibrary* PawnSoundLibrary; // 0x6090 (0x8)
