...
class UAshtonWidgetBase : public ULTMWidgetBase
{
	...
	// Function /Script/FortniteUI.AshtonWidgetBase.UpdateAllUI (Underlying native function: UpdateAllUI 0xa3fcc94)
	void UpdateAllUI(bool& bFirstUpdate); // (Final | Native | Protected)

	// Function /Script/FortniteUI.AshtonWidgetBase.OnVillainRespawnsRemainingChanged (Underlying native function: OnVillainRespawnsRemainingChanged 0xa3fc5e4)
	...
	// Function /Script/FortniteUI.AshtonWidgetBase.OnStoneListChanged (Underlying native function: OnStoneListChanged 0xa3fc5b4)
