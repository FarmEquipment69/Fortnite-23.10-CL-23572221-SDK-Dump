...
{
	struct FPointerToUberGraphFrame* UberGraphFrame; // 0x5600 (0x8)
	class UFortContrailsComponent* FortContrails; // 0x5608 (0x8)
	class UFortUnderwaterDamageComponent* FortUnderwaterDamage; // 0x5610 (0x8)
	float Timeline0BlendWeightA4943458400C3662DB243099F9EAC7E8; // 0x5618 (0x4)
	struct TEnumAsByte<ETimelineDirection> Timeline0DirectionA4943458400C3662DB243099F9EAC7E8; // 0x561c (0x1)
	unsigned char unreflected_561d[0x3]; // 0x561d (0x3) 
	class UTimelineComponent* Timeline0; // 0x5620 (0x8)
	class USkeletalMeshComponent* TargetHead; // 0x5628 (0x8)
	class USkeletalMeshComponent* TargetBody; // 0x5630 (0x8)
	struct TArray<class UMaterialInterface*> PawnHeadMaterials0; // 0x5638 (0x10)
	struct TArray<class UMaterialInterface*> PawnBodyMaterials0; // 0x5648 (0x10)
	struct FGameplayTagContainer TCFlakVest; // 0x5658 (0x20)
	struct FGameplayEventData EventData; // 0x5678 (0xb0)
	struct FGameplayTag EventSpawnEffect; // 0x5728 (0x4)
	bool IsMale; // 0x572c (0x1)
	unsigned char unreflected_572d[0x3]; // 0x572d (0x3) 
	class AFortWeapon* MenuGoingCommandowWeapon; // 0x5730 (0x8)
	class USoundBase* SafeZonePassThroughSound; // 0x5738 (0x8)
	bool bHasBeenOutsideSafeZone; // 0x5740 (0x1)
	unsigned char unreflected_5741[0x3]; // 0x5741 (0x3) 
	struct FLinearColor ThreatColor; // 0x5744 (0x10)
	unsigned char unreflected_5754[0x4]; // 0x5754 (0x4) 
	class USoundBase* PlayerKilledSound; // 0x5758 (0x8)
	class UParticleSystemComponent* WindDebrisParticles; // 0x5760 (0x8)
	class UParticleSystemComponent* FallingRainParticles; // 0x5768 (0x8)
	class UParticleSystemComponent* StormAuraParticles; // 0x5770 (0x8)
	struct FVector LightningSpawnLocation; // 0x5778 (0x18)
	double LightningIntensityMin; // 0x5790 (0x8)
	double LightningIntensityMax; // 0x5798 (0x8)
	class AActor* SafeZoneActor; // 0x57a0 (0x8)
	double LightningIntensity; // 0x57a8 (0x8)
	class UPointLightComponent* RandomLightningLight; // 0x57b0 (0x8)
	double LightningTimelinePlaySpeedMin; // 0x57b8 (0x8)
	double LightningTimelinePlaySpeedMax; // 0x57c0 (0x8)
	double LightningFlashDiameter; // 0x57c8 (0x8)
	double LightningFlashHeight; // 0x57d0 (0x8)
	double LightningFlashRepeatDelayMin; // 0x57d8 (0x8)
	double LightningFlashRepeatDelayMax; // 0x57e0 (0x8)
	class AEmitterCameraLensEffectBase* RainCameraLensParticles; // 0x57e8 (0x8)
	double ChanceOfLightningMesh; // 0x57f0 (0x8)
	bool ShowInvulnerableVisuals; // 0x57f8 (0x1)
	unsigned char unreflected_57f9[0x7]; // 0x57f9 (0x7) 
	class UAudioComponent* StormAudioLoopInst; // 0x5800 (0x8)
	double StormAudioVolume; // 0x5808 (0x8)
	class UAudioComponent* FallingAudioLoopInst; // 0x5810 (0x8)
	bool bIsPlayingFallingSound; // 0x5818 (0x1)
	unsigned char unreflected_5819[0x7]; // 0x5819 (0x7) 
	double PlayerAttributesSpeedWalk; // 0x5820 (0x8)
	double PlayerAttributesSpeedRun; // 0x5828 (0x8)
	double PlayerAttributesSpeedSprint; // 0x5830 (0x8)
	int MaxTrailsLOD; // 0x5838 (0x4)
	unsigned char unreflected_583c[0x4]; // 0x583c (0x4) 
	class UPostProcessComponent* MobilePostProcess; // 0x5840 (0x8)
	bool bIsOutsideSafeZoneCached; // 0x5848 (0x1)
	unsigned char unreflected_5849[0x7]; // 0x5849 (0x7) 
	struct TArray<class UMaterialInstanceDynamic*> ResOutMaterials; // 0x5850 (0x10)
	class ADuplicateResOutMesh_C* RezInFXActor; // 0x5860 (0x8)
	bool bQueueRezIn; // 0x5868 (0x1)
	unsigned char unreflected_5869[0x7]; // 0x5869 (0x7) 
	class ADuplicateResOutMesh_C* RezOutFXActor; // 0x5870 (0x8)
	bool bQueueRezOut; // 0x5878 (0x1)
	bool bWasEverInWarmUp; // 0x5879 (0x1)
	bool bStormAudioCleanedUp; // 0x587a (0x1)
	unsigned char unreflected_587b[0x5]; // 0x587b (0x5) 
	struct FTransform BoxLocalTransform; // 0x5880 (0x60)
	double BoundsRadius; // 0x58e0 (0x8)
	class UPointLightComponent* TeleportationPointLight; // 0x58e8 (0x8)
	double MaxLightIntensity; // 0x58f0 (0x8)
	struct FName SocketMeshTop; // 0x58f8 (0x4)
	struct FName SocketMeshBot; // 0x58fc (0x4)
	struct FName MIDParamTransition; // 0x5900 (0x4)
	struct FName MIDParamDissolvePercent; // 0x5904 (0x4)
	struct FName MIDParamDissolveDirection; // 0x5908 (0x4)
	struct FName MIDParamDissolveBaseLoc; // 0x590c (0x4)
	struct FName MIDParamDissolveDistance; // 0x5910 (0x4)
	struct FName MIDParamDissolveFirstSpawn; // 0x5914 (0x4)
	class UMaterialInterface* MatCharacterDissolve; // 0x5918 (0x8)
	struct TArray<class UMaterialInstanceDynamic*> DissolveMIDs; // 0x5920 (0x10)
	bool bUseNewTeleportFX; // 0x5930 (0x1)
	unsigned char unreflected_5931[0x3]; // 0x5931 (0x3) 
	struct FGameplayTag OutsideSafeZoneGameplayCueTag; // 0x5934 (0x4)
	int SafeZonePhase; // 0x5938 (0x4)
	int WhichSafeZoneTag; // 0x593c (0x4)
	bool bOutsideSafeZoneGameplayCueActive; // 0x5940 (0x1)
	unsigned char unreflected_5941[0x7]; // 0x5941 (0x7) 
	struct FScalableFloat SafeZoneDamageScalableFloat; // 0x5948 (0x28)
	bool bFrontendPartyInProgress; // 0x5970 (0x1)
	bool bLockOnInteractionComplete; // 0x5971 (0x1)
	unsigned char unreflected_5972[0x6]; // 0x5972 (0x6) 
	struct FMulticastInlineDelegate ResIn; // 0x5978 (0x10)
	struct FMulticastInlineDelegate ResOut; // 0x5988 (0x10)
	struct FMulticastInlineDelegate SwingRight; // 0x5998 (0x10)
	struct FMulticastInlineDelegate SwingLeft; // 0x59a8 (0x10)
	bool bSkeletalArrayReady; // 0x59b8 (0x1)
	unsigned char unreflected_59b9[0x3]; // 0x59b9 (0x3) 
	int CurDissolveSetupAttempt; // 0x59bc (0x4)
	class USoundBase* DBNOEnterSound; // 0x59c0 (0x8)
	struct FMulticastInlineDelegate onFadeToWhiteTeleported; // 0x59c8 (0x10)
	bool IsAshton; // 0x59d8 (0x1)
	unsigned char unreflected_59d9[0x7]; // 0x59d9 (0x7) 
	class UParticleSystemComponent* Ashton; // 0x59e0 (0x8)
	struct FMulticastInlineDelegate SwingRightEnd; // 0x59e8 (0x10)
	struct FMulticastInlineDelegate SwingLeftEnd; // 0x59f8 (0x10)
	struct FGameplayTag PhoneGhostCue; // 0x5a08 (0x4)
	struct FGameplayTag WhiteoutCue; // 0x5a0c (0x4)
	struct FGameplayTag OutsideSafeZoneCue; // 0x5a10 (0x4)
	struct FGameplayTag OutsideSafeZone2Cue; // 0x5a14 (0x4)
	struct FGameplayTag OutsideSafeZone3Cue; // 0x5a18 (0x4)
	bool PlayRespawnFXOnSpawn; // 0x5a1c (0x1)
	unsigned char unreflected_5a1d[0x3]; // 0x5a1d (0x3) 
	class AFortPlayerPawnAthena* PlayerPawnAthena; // 0x5a20 (0x8)
	struct FMulticastInlineDelegate SwingRight2; // 0x5a28 (0x10)
	struct FMulticastInlineDelegate SwingLeft2; // 0x5a38 (0x10)
	bool TestProceduralWaterInIsolation; // 0x5a48 (0x1)
	bool NewVar0; // 0x5a49 (0x1)
	bool IsFirstWaterBody; // 0x5a4a (0x1)
	bool IsLastWaterBody; // 0x5a4b (0x1)
	unsigned char unreflected_5a4c[0x4]; // 0x5a4c (0x4) 
	double AccumulatedNormalizedDiveSpeed; // 0x5a50 (0x8)
	struct FGameplayTag WaterSprintBoostTag; // 0x5a58 (0x4)
	unsigned char unreflected_5a5c[0x4]; // 0x5a5c (0x4) 
	struct FMulticastInlineDelegate CCPMisHiddenInProp; // 0x5a60 (0x10)
	struct TMap<class UObject*, struct FPawnHighlight> PawnHighlights; // 0x5a70 (0x50)
	class UObject* CurrentHighlightSource; // 0x5ac0 (0x8)
	double CurrentHighlightPriority; // 0x5ac8 (0x8)
	struct FPawnHighlight InvulnerableHighlight; // 0x5ad0 (0x30)
	bool IsGalileo; // 0x5b00 (0x1)
	unsigned char unreflected_5b01[0x7]; // 0x5b01 (0x7) 
	struct FScalableFloat HotFixSnow; // 0x5b08 (0x28)
	struct TSet<struct FName> NoSnowPlaylists; // 0x5b30 (0x50)
	struct FGameplayTag GalileoPlaylistTag; // 0x5b80 (0x4)
	unsigned char unreflected_5b84[0x4]; // 0x5b84 (0x4) 
	struct TArray<class UMaterialInstanceDynamic*> WeaponMIDs; // 0x5b88 (0x10)
	int AmountOfTimesToAttemptRestoreMats; // 0x5b98 (0x4)
	struct FGameplayTag TCPawnAthenaNPC; // 0x5b9c (0x4)
	double HitGlowBrightnessScalar; // 0x5ba0 (0x8)
	struct TArray<class UMaterialInterface*> CurrentWeaponMaterials; // 0x5ba8 (0x10)
	struct TArray<class USkeletalMeshComponent*> CurrentWeaponMeshes; // 0x5bb8 (0x10)
	struct TArray<class UMaterialInstanceDynamic*> WeaponDissolveMIDs; // 0x5bc8 (0x10)
	double HitGlowBrightnessScalarMobile; // 0x5bd8 (0x8)
	struct FGameplayTag TCPawnAthenaDecoy; // 0x5be0 (0x4)
	unsigned char unreflected_5be4[0x4]; // 0x5be4 (0x4) 
	double ScaleRate; // 0x5be8 (0x8)
	struct FGameplayTagContainer TetherQuestTag; // 0x5bf0 (0x20)
	struct FName FirefliesTag; // 0x5c10 (0x4)
	unsigned char unreflected_5c14[0xc]; // 0x5c14 (0xc) 
	struct FTransform RightSideRimTransform; // 0x5c20 (0x60)
	class USpotLightComponent* RightSideRimLight; // 0x5c80 (0x8)
	double RimlightShadowBias; // 0x5c88 (0x8)
	double RimLightAttenuationRadius; // 0x5c90 (0x8)
	double RimLightIntensity; // 0x5c98 (0x8)
	struct FRotator PlayerAimRotation; // 0x5ca0 (0x18)
	struct FScalableFloat ControlRotationReplicationTickRate; // 0x5cb8 (0x28)
	struct FGameplayTag EliminationRezSequenceGC; // 0x5ce0 (0x4)
	struct FGameplayTag CreativeRespawnTeleportationGC; // 0x5ce4 (0x4)
	struct FGameplayTag TeleportInGC; // 0x5ce8 (0x4)
	unsigned char unreflected_5cec[0x4]; // 0x5cec (0x4) 
	double RimlightDistanceFromCamera; // 0x5cf0 (0x8)
	double RimlightOffsetFromCamera; // 0x5cf8 (0x8)
	struct FLinearColor RimLightColorNight; // 0x5d00 (0x10)
	struct FLinearColor RimLightColorDay; // 0x5d10 (0x10)
	struct FGameplayTag PhoneModeratorModeGameplayCue; // 0x5d20 (0x4)
	struct FGameplayTag PhoneInvulnerableGameplayCue; // 0x5d24 (0x4)
	bool SwingingHandsUp; // 0x5d28 (0x1)
	bool SwingingLockedToHip; // 0x5d29 (0x1)
	unsigned char unreflected_5d2a[0x6]; // 0x5d2a (0x6) 
	double InputDragCoefficient; // 0x5d30 (0x8)
	bool ToggleSwingNativized; // 0x5d38 (0x1)
	unsigned char unreflected_5d39[0x7]; // 0x5d39 (0x7) 
	class UAudioComponent* SwingingSound; // 0x5d40 (0x8)
	class UCurveFloat* SwingingReelingInCurve; // 0x5d48 (0x8)
	class UCurveFloat* SwingingNotReelingInCurve; // 0x5d50 (0x8)
	struct FVector SwingingOriginalVecToTarget; // 0x5d58 (0x18)
	bool SwingingReelingIn; // 0x5d70 (0x1)
	unsigned char unreflected_5d71[0x7]; // 0x5d71 (0x7) 
	double SwingingGoalLength; // 0x5d78 (0x8)
	class UCurveFloat* SwingingReelingTimeCurve; // 0x5d80 (0x8)
	bool SwingingColliderBigger; // 0x5d88 (0x1)
	unsigned char unreflected_5d89[0x7]; // 0x5d89 (0x7) 
	struct TArray<struct FAudioParameter> SoundParams; // 0x5d90 (0x10)
	bool SwingingUseNewRotationAlgorithm; // 0x5da0 (0x1)
	unsigned char unreflected_5da1[0x7]; // 0x5da1 (0x7) 
	struct FVector AttachedWallInverseNormal; // 0x5da8 (0x18)
	double WallCheckDistance; // 0x5dc0 (0x8)
	struct FVector VelocityOnSlideStart; // 0x5dc8 (0x18)
	double SlideStartTime; // 0x5de0 (0x8)
	double MaxSlideTime; // 0x5de8 (0x8)
	class UCurveVector* WallSlidingVelocityMultiplierCurve; // 0x5df0 (0x8)
	class UCurveFloat* WallSlidingAddedDownwardVelocityMultiplierCurve; // 0x5df8 (0x8)
	double WallSlidingAddedDownwardVelocityMax; // 0x5e00 (0x8)
	struct FVector AttachedWallNormal; // 0x5e08 (0x18)
	struct FVector WallSlidingVelocity; // 0x5e20 (0x18)
	double DesiredDistanceToAttachedWall; // 0x5e38 (0x8)
	double MinGroundSlopeToLeaveAttachedWall; // 0x5e40 (0x8)
	struct FFortGameplayAbilityMontageInfo OverrideSearchMontageInfo; // 0x5e48 (0x58)
	struct FMulticastInlineDelegate DisplayHitNotify; // 0x5ea0 (0x10)
	bool IsHiddingCharacterParrts; // 0x5eb0 (0x1)
	unsigned char unreflected_5eb1[0x7]; // 0x5eb1 (0x7) 
	double RimlightMultiplier; // 0x5eb8 (0x8)
	bool RimlightEnabled; // 0x5ec0 (0x1)
	...
	void AttemptToSetRimLight(bool& CallFuncArrayIsValidIndexReturnValue); // (Public | BlueprintCallable | BlueprintEvent)
	...
	// Function /Game/Athena/PlayerPawn_Athena.PlayerPawn_Athena_C.Update Rim Light Location (Has no native function)
	void UpdateRimLightLocation(bool& listTesting, struct TScriptInterface<class IFortTimeOfDayManagerInterface>& CallFuncGetContextualTimeOfDayManagerReturnValue, enum EFortDayPhase& TempbyteVariable, class UObject*& CallFuncConvInterfaceToObjectReturnValue, bool& CallFuncIsValidReturnValue, double& CallFuncMultiplyDoubleDoubleReturnValue, bool& CallFuncIsValidReturnValue1, enum EFortDayPhase& TempbyteVariable1, enum EFortDayPhase& CallFuncGetCurrentDayPhaseReturnValue, struct FLinearColor& K2NodeSelectDefault, enum EFortDayPhase& CallFuncGetCurrentDayPhaseReturnValue1, double& CallFuncMultiplyDoubleDoubleReturnValue1, double& CallFuncMultiplyDoubleDoubleReturnValue2, class APawn*& CallFuncGetPlayerPawnReturnValue, double& K2NodeSelectDefault1, struct FVector& CallFuncK2GetActorLocationReturnValue, double& CallFuncMultiplyDoubleDoubleReturnValue3, class AFortPlayerController*& CallFuncGetFortPlayerControllerFromActorReturnValue, bool& CallFuncIsValidReturnValue2, bool& CallFuncIsValidReturnValue3, struct FVector& CallFuncMakeVectorReturnValue, class APlayerCameraManager*& CallFuncGetPlayerCameraManagerReturnValue, struct FVector& CallFuncGetCameraLocationReturnValue, struct FRotator& CallFuncGetCameraRotationReturnValue, struct FTransform& CallFuncMakeTransformReturnValue, struct FVector& CallFuncTransformLocationReturnValue, struct FHitResult& CallFuncK2SetWorldLocationSweepHitResult, struct FRotator& CallFuncFindLookAtRotationReturnValue, struct FHitResult& CallFuncK2SetWorldRotationSweepHitResult, float& CallFuncSetIntensityNewIntensityImplicitCast, float& CallFuncSetIntensityNewIntensityImplicitCast1); // (Public | HasDefaults | BlueprintCallable | BlueprintEvent)

	// Function /Game/Athena/PlayerPawn_Athena.PlayerPawn_Athena_C.handleCvarsUpdated (Has no native function)
	void handleCvarsUpdated(struct FString& CVarName, struct FString& lcvarName, float& CallFuncGetConsoleVariableFloatValueReturnValue, bool& CallFuncEqualEqualStrStrReturnValue, bool& CallFuncEqualEqualStrStrReturnValue1, bool& CallFuncEqualEqualStrStrReturnValue2, bool& CallFuncBooleanORReturnValue, bool& CallFuncBooleanORReturnValue1, double& K2NodeVariableSetRimlightMultiplierImplicitCast); // (Public | BlueprintCallable | BlueprintEvent)
	...
	// Function /Game/Athena/PlayerPawn_Athena.PlayerPawn_Athena_C.Validate Rim Light (Has no native function)
	void ValidateRimLight(bool& lusePhysicalRimlight, class USpringArmComponent*& lspringArm, int& TempintArrayIndexVariable, int& TempintLoopCounterVariable, int& CallFuncAddIntIntReturnValue, int& TempintLoopCounterVariable1, int& TempintLoopCounterVariable2, int& CallFuncAddIntIntReturnValue1, int& CallFuncAddIntIntReturnValue2, int& TempintArrayIndexVariable1, int& TempintArrayIndexVariable2, int& TempintLoopCounterVariable3, int& CallFuncAddIntIntReturnValue3, int& TempintArrayIndexVariable3, float& CallFuncGetConsoleVariableFloatValueReturnValue, float& CallFuncGetConsoleVariableFloatValueReturnValue1, float& CallFuncGetConsoleVariableFloatValueReturnValue2, int& TempintArrayIndexVariable4, int& CallFuncArrayLengthReturnValue, int& TempintLoopCounterVariable4, class UMaterialInstanceDynamic*& CallFuncArrayGetItem, bool& CallFuncLessIntIntReturnValue, int& CallFuncAddIntIntReturnValue4, int& CallFuncArrayLengthReturnValue1, bool& CallFuncGetConsoleVariableBoolValueReturnValue, class UMaterialInstanceDynamic*& CallFuncArrayGetItem1, int& CallFuncArrayLengthReturnValue2, bool& CallFuncLessIntIntReturnValue1, bool& CallFuncGetConsoleVariableBoolValueReturnValue1, class UMaterialInstanceDynamic*& CallFuncArrayGetItem2, int& CallFuncArrayLengthReturnValue3, bool& CallFuncLessIntIntReturnValue2, class UMaterialInstanceDynamic*& CallFuncArrayGetItem3, int& CallFuncArrayLengthReturnValue4, bool& CallFuncLessIntIntReturnValue3, class UMaterialInstanceDynamic*& CallFuncArrayGetItem4, int& CallFuncArrayLengthReturnValue5, int& TempintLoopCounterVariable5, bool& CallFuncLessIntIntReturnValue4, bool& CallFuncLessIntIntReturnValue5, int& CallFuncAddIntIntReturnValue5, bool& CallFuncIsValidReturnValue, int& TempintArrayIndexVariable5, class UMaterialInstanceDynamic*& CallFuncArrayGetItem5, struct FTimerHandle*& CallFuncK2SetTimerReturnValue, bool& CallFuncIsValidReturnValue1, bool& CallFuncGetConsoleVariableBoolValueReturnValue2, bool& CallFuncIsLocallyControlledReturnValue, class USpotLightComponent*& CallFuncAddComponentReturnValue, float& CallFuncSetScalarParameterValueValueImplicitCast, float& CallFuncSetScalarParameterValueValueImplicitCast1, float& CallFuncSetScalarParameterValueValueImplicitCast2); // (Public | HasDefaults | BlueprintCallable | BlueprintEvent)
