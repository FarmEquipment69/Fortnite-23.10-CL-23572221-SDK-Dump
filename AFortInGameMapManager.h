...
class AFortInGameMapManager : public AActor
{
	...
	// Function /Script/FortniteGame.FortInGameMapManager.ShouldShowMainMap (Underlying native function: ShouldShowMainMap 0x86ebc74)
	bool ShouldShowMainMap(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManager.SetCaptureLocation (Underlying native function: SetCaptureLocation 0x86eb2d0)
	void SetCaptureLocation(struct FVector& Location); // (Final | Native | Public | HasOutParms | HasDefaults | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManager.SetActorBoundaryData (Underlying native function: SetActorBoundaryData 0x86eae74)
	...
	// Function /Script/FortniteGame.FortInGameMapManager.ServerClearAllFog (Underlying native function: ServerClearAllFog 0x273fd14)
	void ServerClearAllFog(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManager.ResetCaptureLocation (Underlying native function: ResetCaptureLocation 0x86ea894)
	void ResetCaptureLocation(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManager.PaintOnFog (Underlying native function: PaintOnFog 0x86e73ac)
	...
	// Function /Script/FortniteGame.FortInGameMapManager.OnRep_MapData (Underlying native function: OnRep_MapData 0x86e714c)
	void OnRepMapData(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortInGameMapManager.OnRep_ClearAllFog (Underlying native function: OnRep_ClearAllFog 0x86e70e4)
	void OnRepClearAllFog(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortInGameMapManager.GetStaticCaptureSetupComplete (Underlying native function: GetStaticCaptureSetupComplete 0x86de2fc)
	bool GetStaticCaptureSetupComplete(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortInGameMapManager.GetHeatmapMaskScale (Underlying native function: GetHeatmapMaskScale 0x86db304)
	float GetHeatmapMaskScale(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortInGameMapManager.GetHeatmapMask (Underlying native function: GetHeatmapMask 0x7067b20)
	class UTexture2D* GetHeatmapMask(); // (Final | Native | Private | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortInGameMapManager.GetCurrent (Underlying native function: GetCurrent 0x86da3f4)
	...
	// Function /Script/FortniteGame.FortInGameMapManager.BroadcastExplorationEvents (Underlying native function: BroadcastExplorationEvents 0x86d14d0)
	...
	// Function /Script/FortniteGame.FortInGameMapManager.BPWorldLocationToMapLocation (Underlying native function: BPWorldLocationToMapLocation 0x86d094c)
	...
	// Function /Script/FortniteGame.FortInGameMapManager.AllowShowMiniMap (Underlying native function: AllowShowMiniMap 0x86cf19c)
	void AllowShowMiniMap(bool& bAllowShow); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortInGameMapManager.AllowShowMainMap (Underlying native function: AllowShowMainMap 0x86cf100)
