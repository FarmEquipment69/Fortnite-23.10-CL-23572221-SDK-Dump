...
class UEntityActorStaticMeshRenderComponent : public UEntityActorComponent
{
	...
	// Function /Script/EntityActor.EntityActorStaticMeshRenderComponent.OnRep_MeshMaterials (Underlying native function: OnRep_MeshMaterials 0x663dd68)
	void OnRepMeshMaterials(); // (Final | Native | Private)

	// Function /Script/EntityActor.EntityActorStaticMeshRenderComponent.OnRep_MaxDrawDistance (Underlying native function: OnRep_MaxDrawDistance 0x663dd4c)
	void OnRepMaxDrawDistance(); // (Final | Native | Private)

	// Function /Script/EntityActor.EntityActorStaticMeshRenderComponent.OnRep_EnableCollision (Underlying native function: OnRep_EnableCollision 0x663dd30)
