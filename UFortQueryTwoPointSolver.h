...
class UFortQueryTwoPointSolver : public UObject
{
	...
	// Function /Script/FortniteAI.FortQueryTwoPointSolver.Start (Underlying native function: Start 0xa1243cc)
	void Start(class UObject*& Querier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortQueryTwoPointSolver.SkipToNextPointA (Underlying native function: SkipToNextPointA 0xa1243b4)
	void SkipToNextPointA(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortQueryTwoPointSolver.SetCustomRotationA (Underlying native function: SetCustomRotationA 0xa12431c)
	...
	// Function /Script/FortniteAI.FortQueryTwoPointSolver.GetRandomRotationOffset (Underlying native function: GetRandomRotationOffset 0xa1240f0)
	struct FRotator GetRandomRotationOffset(); // (Final | Native | Public | HasDefaults | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamB (Underlying native function: AddNamedFloatParamB 0xa123ff4)
	void AddNamedFloatParamB(struct FName& ParamName, float& Value); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamA (Underlying native function: AddNamedFloatParamA 0xa123ef8)
