...
class UAthenaSquadListBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaSquadListBase.UpdateSquadFromMinigameOptionChange (Underlying native function: UpdateSquadFromMinigameOptionChange 0xa311d58)
	void UpdateSquadFromMinigameOptionChange(); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSquadListBase.UpdateIsTeamMiniGameOnMinigameVolumeChanged (Underlying native function: UpdateIsTeamMiniGameOnMinigameVolumeChanged 0xa3118a0)
	void UpdateIsTeamMiniGameOnMinigameVolumeChanged(class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSquadListBase.UpdateIsTeamMiniGameOnGameStateChanged (Underlying native function: UpdateIsTeamMiniGameOnGameStateChanged 0xa3117dc)
	...
	// Function /Script/FortniteUI.AthenaSquadListBase.HandlePlayerUniqueIdReplicated (Underlying native function: HandlePlayerUniqueIdReplicated 0xa310518)
	void HandlePlayerUniqueIdReplicated(struct FUniqueNetIdRepl& UniqueId); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteUI.AthenaSquadListBase.HandlePlayerExitVolume (Underlying native function: HandlePlayerExitVolume 0xa310440)
	void HandlePlayerExitVolume(class APlayerState*& Client, class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSquadListBase.HandlePlayerEnterVolume (Underlying native function: HandlePlayerEnterVolume 0xa31037c)
	void HandlePlayerEnterVolume(class APlayerState*& Client, class AFortVolume*& Volume); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSquadListBase.HandleGameMemberChanged (Underlying native function: HandleGameMemberChanged 0xa30ff80)
