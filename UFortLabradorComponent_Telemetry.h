...
class UFortLabradorComponent_Telemetry : public UFortAIComponent_Telemetry
{
	...
	// Function /Script/LabradorRuntime.FortLabradorComponent_Telemetry.OnWakeUp (Underlying native function: OnWakeUp 0x6ffc920)
	void OnWakeUp(class AActor*& GoalActor); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/LabradorRuntime.FortLabradorComponent_Telemetry.OnTeleport (Underlying native function: OnTeleport 0x6ffc908)
	void OnTeleport(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/LabradorRuntime.FortLabradorComponent_Telemetry.OnDamaged (Underlying native function: OnDamaged 0x6ffc6b4)
