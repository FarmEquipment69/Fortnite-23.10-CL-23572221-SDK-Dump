...
class UAthenaChallengeRecapEntry : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaChallengeRecapEntry.OutroFinished (Underlying native function: OutroFinished 0xa347e80)
	void OutroFinished(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaChallengeRecapEntry.IntroFinished (Underlying native function: IntroFinished 0xa3477fc)
