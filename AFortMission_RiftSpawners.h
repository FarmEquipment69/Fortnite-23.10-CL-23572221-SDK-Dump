...
class AFortMission_RiftSpawners : public AFortMission
{
	...
	// Function /Script/FortniteGame.FortMission_RiftSpawners.SetCalendarAllowsActive (Underlying native function: SetCalendarAllowsActive 0x88ed5e8)
	void SetCalendarAllowsActive(bool& bInCanBeActive); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.OnFinalSpawnUsed (Underlying native function: OnFinalSpawnUsed 0x88ec918)
	void OnFinalSpawnUsed(class UFortAIEncounterInfo*& Encounter); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.OnActiveEventsChanged (Underlying native function: OnActiveEventsChanged 0x88ec834)
	void OnActiveEventsChanged(struct TArray<struct FString>& ActiveEventFlags); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleRiftDamaged (Underlying native function: HandleRiftDamaged 0x88ebbd0)
	...
	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleRampStarted (Underlying native function: HandleRampStarted 0x88ebb50)
	void HandleRampStarted(class UFortAIEncounterInfo*& Encounter); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleEncounterAllBurstEnemiesSpawned (Underlying native function: HandleEncounterAllBurstEnemiesSpawned 0x88eb9ac)
	void HandleEncounterAllBurstEnemiesSpawned(class UFortAIEncounterInfo*& Encounter); // (Final | Native | Private)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleAthenaSafeZonePhaseChanged (Underlying native function: HandleAthenaSafeZonePhaseChanged 0x88eb998)
	void HandleAthenaSafeZonePhaseChanged(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleAthenaGamePhaseChanged (Underlying native function: HandleAthenaGamePhaseChanged 0x88eb918)
	void HandleAthenaGamePhaseChanged(enum EAthenaGamePhase& GamePhase); // (Final | Native | Protected)

	// Function /Script/FortniteGame.FortMission_RiftSpawners.HandleAISpawned (Underlying native function: HandleAISpawned 0x6d23ca0)
