...
class UFortMcpProfileAthena : public UFortMcpProfileSubgame
{
	...
	// Function /Script/FortniteGame.FortMcpProfileAthena.HasPurchasedSeasonBook (Underlying native function: HasPurchasedSeasonBook 0x2886e44)
	bool HasPurchasedSeasonBook(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMcpProfileAthena.HandleActiveEventFlagsChanged (Underlying native function: HandleActiveEventFlagsChanged 0x80cf508)
	void HandleActiveEventFlagsChanged(struct TArray<struct FString>& ActiveEventFlags); // (Final | Native | Private | HasOutParms)

	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonRestedXp (Underlying native function: GetSeasonRestedXp 0x80cf494)
	int GetSeasonRestedXp(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonMatchXpBoost (Underlying native function: GetSeasonMatchXpBoost 0x80cf470)
	int GetSeasonMatchXpBoost(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonLevelUpReward (Underlying native function: GetSeasonLevelUpReward 0x80cf348)
	...
	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonLevelInfo (Underlying native function: GetSeasonLevelInfo 0x80cf264)
	...
	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonFriendMatchXpBoost (Underlying native function: GetSeasonFriendMatchXpBoost 0x80cf240)
	int GetSeasonFriendMatchXpBoost(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMcpProfileAthena.GetSeasonBookLevel (Underlying native function: GetSeasonBookLevel 0x80cf21c)
	int GetSeasonBookLevel(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMcpProfileAthena.GetActiveSeasonDefinition (Underlying native function: GetActiveSeasonDefinition 0x80ced6c)
	...
	// Function /Script/FortniteGame.FortMcpProfileAthena.CanPurchaseSeasonBook (Underlying native function: CanPurchaseSeasonBook 0x80ced00)
