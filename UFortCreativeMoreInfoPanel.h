...
class UFortCreativeMoreInfoPanel : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.OnPublishComplete (Underlying native function: OnPublishComplete 0xa5863c8)
	...
	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.InitializeData (Underlying native function: InitializeData 0xa585ed0)
	void InitializeData(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.HandlePreviewClicked (Underlying native function: HandlePreviewClicked 0xa585900)
	void HandlePreviewClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.HandleClearClicked (Underlying native function: HandleClearClicked 0xa585414)
	void HandleClearClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.HandleAcceptClicked (Underlying native function: HandleAcceptClicked 0xa584ff0)
	void HandleAcceptClicked(); // (Final | Native | Protected)

	// Function /Script/FortniteUI.FortCreativeMoreInfoPanel.GetIslandDescriptionTags (Underlying native function: GetIslandDescriptionTags 0xa584a30)
