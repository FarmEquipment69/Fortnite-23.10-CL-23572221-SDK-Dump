...
class UFortBattlePassTileBase : public UFortHoldableButton
{
	...
	// Function /Script/BattlePassBase.FortBattlePassTileBase.SetState (Underlying native function: SetState 0x6ec7d38)
	void SetState(enum BattlePassTileAvailabilityStates& NewState); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/BattlePassBase.FortBattlePassTileBase.SetSize (Underlying native function: SetSize 0x6ec7c68)
	...
	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsOwned (Underlying native function: IsOwned 0x6ec7b74)
	bool IsOwned(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsLocked (Underlying native function: IsLocked 0x6ec7b58)
	bool IsLocked(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassTileBase.IsAvailable (Underlying native function: IsAvailable 0x6ec7b3c)
	bool IsAvailable(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/BattlePassBase.FortBattlePassTileBase.GetState (Underlying native function: GetState 0x6ec75dc)
