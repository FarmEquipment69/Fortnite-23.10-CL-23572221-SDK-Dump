...
class UFortActivityBrowserRow : public UCommonUserWidget
{
	...
	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRow.GetIsSelected (Underlying native function: GetIsSelected 0x7067aa8)
	bool GetIsSelected(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRow.GetIsInPeekState (Underlying native function: GetIsInPeekState 0x7067a80)
	bool GetIsInPeekState(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/DiscoveryBrowserUI.FortActivityBrowserRow.GetIsActive (Underlying native function: GetIsActive 0x7067a68)
