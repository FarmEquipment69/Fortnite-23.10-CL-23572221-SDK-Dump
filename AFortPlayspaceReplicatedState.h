...
class AFortPlayspaceReplicatedState : public AActor
{
	...
	// Function /Script/FortniteGame.FortPlayspaceReplicatedState.IsLocalPlayerInOwningPlayspace (Underlying native function: IsLocalPlayerInOwningPlayspace 0x8bdc860)
	bool IsLocalPlayerInOwningPlayspace(int& PlayerIndex); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortPlayspaceReplicatedState.GetReplicatedParamHelper (Underlying native function: GetReplicatedParamHelper 0x8bdb9e4)
