...
class UCameraShakeBase : public UObject
{
	...
	// Function /Script/Engine.CameraShakeBase.SetRootShakePattern (Underlying native function: SetRootShakePattern 0x9af1b68)
	void SetRootShakePattern(class UCameraShakePattern*& InPattern); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.CameraShakeBase.GetRootShakePattern (Underlying native function: GetRootShakePattern 0x7aaa7ec)
