...
class UFortMobileActionButtonBehavior_CreativeRotationAxis : public UFortMobileActionButtonBehavior
{
	...
	// Function /Script/FortniteUI.FortMobileActionButtonBehavior_CreativeRotationAxis.HandleWeaponEquipped (Underlying native function: HandleWeaponEquipped 0xa45c728)
	void HandleWeaponEquipped(class AFortWeapon*& NewWeapon, class AFortWeapon*& PreviousWeapon); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortMobileActionButtonBehavior_CreativeRotationAxis.HandleMoveToolRotationAxisChanged (Underlying native function: HandleMoveToolRotationAxisChanged 0xa45c3b8)
