...
class UAthenaSpectatorNameplateLayerBase : public UFortHUDElementWidget
{
	...
	// Function /Script/FortniteUI.AthenaSpectatorNameplateLayerBase.OnTeamColorVisibleChanged (Underlying native function: OnTeamColorVisibleChanged 0xa43ff9c)
	void OnTeamColorVisibleChanged(bool& bVisible); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaSpectatorNameplateLayerBase.OnPlayerDataAdded (Underlying native function: OnPlayerDataAdded 0xa43f864)
	void OnPlayerDataAdded(class UAthenaRemotePlayerViewData*& InPlayerData); // (Final | Native | Public)

	// Function /Script/FortniteUI.AthenaSpectatorNameplateLayerBase.OnArrowTeamColorVisibleChanged (Underlying native function: OnArrowTeamColorVisibleChanged 0xa43f21c)
