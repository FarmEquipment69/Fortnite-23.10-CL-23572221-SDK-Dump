...
class UAthenaEventMatchScoreboardScreenBase : public UAthenaEventScreenBase
{
	...
	// Function /Script/FortniteUI.AthenaEventMatchScoreboardScreenBase.HandleSquadKillScoreChanged (Underlying native function: HandleSquadKillScoreChanged 0x266551c)
	void HandleSquadKillScoreChanged(class UAthenaRemoteSquadViewData*& InSquadData, int& InKillScore); // (Final | Native | Private)

	// Function /Script/FortniteUI.AthenaEventMatchScoreboardScreenBase.HandleSquadEliminated (Underlying native function: HandleSquadEliminated 0x298b52c)
