...
class UFortMulchConfirmationModalWidget : public UFortActivatablePanel
{
	...
	// Function /Script/FortniteUI.FortMulchConfirmationModalWidget.UpdateConfirmationModal (Underlying native function: UpdateConfirmationModal 0xa6c8b40)
	void UpdateConfirmationModal(); // (Final | Native | Private)

	// Function /Script/FortniteUI.FortMulchConfirmationModalWidget.GetMulchWarnings (Underlying native function: GetMulchWarnings 0xa6c5c8c)
	struct TMap<enum EItemRecyclingWarning, int> GetMulchWarnings(); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.FortMulchConfirmationModalWidget.CommitMulch (Underlying native function: CommitMulch 0xa6c4d1c)
