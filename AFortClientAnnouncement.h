...
class AFortClientAnnouncement : public AActor
{
	...
	// Function /Script/FortniteGame.FortClientAnnouncement.StopClientAnnouncement (Underlying native function: StopClientAnnouncement 0x1598df4)
	...
	// Function /Script/FortniteGame.FortClientAnnouncement.GetPriority (Underlying native function: GetPriority 0x2d7ae04)
	int GetPriority(); // (Final | 0x00000002 | BlueprintCosmetic | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortClientAnnouncement.CancelClientAnnouncement (Underlying native function: CancelClientAnnouncement 0x7f964b8)
