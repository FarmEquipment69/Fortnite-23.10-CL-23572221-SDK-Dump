...
class UFortGadgetItemDefinition : public UFortWorldItemDefinition
{
	...
	// Function /Script/FortniteGame.FortGadgetItemDefinition.HasTrackedAttributes (Underlying native function: HasTrackedAttributes 0x881462c)
	bool HasTrackedAttributes(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGadgetItemDefinition.HasChargeUp (Underlying native function: HasChargeUp 0x8814418)
	bool HasChargeUp(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGadgetItemDefinition.GetWeaponItemDefinition (Underlying native function: GetWeaponItemDefinition 0x8814284)
	...
	// Function /Script/FortniteGame.FortGadgetItemDefinition.GetLevelAttribute (Underlying native function: GetLevelAttribute 0x8812ad8)
	struct FGameplayAttribute GetLevelAttribute(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortGadgetItemDefinition.GetGameplayAbility (Underlying native function: GetGameplayAbility 0x8812270)
