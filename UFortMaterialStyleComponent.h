...
class UFortMaterialStyleComponent : public UActorComponent
{
	...
	// Function /Script/FortniteGame.FortMaterialStyleComponent.RequestStyleChange (Underlying native function: RequestStyleChange 0x8868834)
	...
	// Function /Script/FortniteGame.FortMaterialStyleComponent.GetDynamicMaterialInstance (Underlying native function: GetDynamicMaterialInstance 0x2dfcd64)
	class UMaterialInstanceDynamic* GetDynamicMaterialInstance(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortMaterialStyleComponent.GetActiveStyleInfo (Underlying native function: GetActiveStyleInfo 0x8867bf4)
