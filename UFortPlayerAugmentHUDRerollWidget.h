...
class UFortPlayerAugmentHUDRerollWidget : public UCommonUserWidget
{
	...
	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentHUDRerollWidget.StartRerollHoldProgress (Underlying native function: StartRerollHoldProgress 0x5809be0)
	...
	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentHUDRerollWidget.HandleRerollAugments (Underlying native function: HandleRerollAugments 0x71aa0d0)
	void HandleRerollAugments(); // (Final | Native | Private)

	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentHUDRerollWidget.HandleFreeRerollsUpdated (Underlying native function: HandleFreeRerollsUpdated 0x71a9ec8)
	void HandleFreeRerollsUpdated(int& NewNumFreeRerolls); // (Final | Native | Private)

	// Function /Script/PlayerAugmentsUI.FortPlayerAugmentHUDRerollWidget.EndRerollHoldProgress (Underlying native function: EndRerollHoldProgress 0x5809bc0)
