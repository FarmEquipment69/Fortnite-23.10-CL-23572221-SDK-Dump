...
class UCustomizableInstancePrivateData : public UObject
{
	...
	unsigned char unreflected_108[0x80]; // 0x108 (0x80) 
	struct TArray<struct FCustomizableInstanceComponentData> ComponentsData; // 0x188 (0x10)
	struct TArray<class UMaterialInterface*> ReferencedMaterials; // 0x198 (0x10)
	unsigned char unreflected_1a8[0xa0]; // 0x1a8 (0xa0) 
	struct TArray<class UPhysicsAsset*> ClothingPhysicsAssets; // 0x248 (0x10)
	struct TArray<class UClass*> GatheredAnimBPs; // 0x258 (0x10)
	struct FGameplayTagContainer AnimBPGameplayTags; // 0x268 (0x20)
