...
class AFortThreatVisualsManager : public AActor
{
	...
	// Function /Script/FortniteAI.FortThreatVisualsManager.StormsExist (Underlying native function: StormsExist 0xa14eec4)
	bool StormsExist(); // (Final | 0x00000002 | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortThreatVisualsManager.SetMinimumCloudAltitude (Underlying native function: SetMinimumCloudAltitude 0x9af10ec)
	void SetMinimumCloudAltitude(float& NewMinimumAltitude); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortThreatVisualsManager.SetCloudsAreHidden (Underlying native function: SetCloudsAreHidden 0xa14ee04)
	void SetCloudsAreHidden(bool& bHide); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortThreatVisualsManager.ResetMinimumCloudAltitude (Underlying native function: ResetMinimumCloudAltitude 0xa14edec)
	...
	// Function /Script/FortniteAI.FortThreatVisualsManager.OnRep_ThreatLocations (Underlying native function: OnRep_ThreatLocations 0x82aa228)
	void OnRepThreatLocations(); // (Final | Native | Private)

	// Function /Script/FortniteAI.FortThreatVisualsManager.OnRep_StormWinds (Underlying native function: OnRep_StormWinds 0x26b0974)
	void OnRepStormWinds(); // (Final | Native | Private)

	// Function /Script/FortniteAI.FortThreatVisualsManager.OnRep_HideClouds (Underlying native function: OnRep_HideClouds 0x1598df4)
	void OnRepHideClouds(); // (Final | Native | Private)

	// Function /Script/FortniteAI.FortThreatVisualsManager.OnRep_GoalActorLocations (Underlying native function: OnRep_GoalActorLocations 0x1598c88)
	...
	// Function /Script/FortniteAI.FortThreatVisualsManager.GetThreatClouds (Underlying native function: GetThreatClouds 0xa14eccc)
	...
	// Function /Script/FortniteAI.FortThreatVisualsManager.GetThreatCloud (Underlying native function: GetThreatCloud 0xa14ebd8)
	...
	// Function /Script/FortniteAI.FortThreatVisualsManager.GetCloudsAreHidden (Underlying native function: GetCloudsAreHidden 0xa14eb94)
	bool GetCloudsAreHidden(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteAI.FortThreatVisualsManager.BeginThreatVisualsPrecursor (Underlying native function: BeginThreatVisualsPrecursor 0xa14eab8)
