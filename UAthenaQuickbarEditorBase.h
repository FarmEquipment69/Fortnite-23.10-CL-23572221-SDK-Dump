...
class UAthenaQuickbarEditorBase : public UCommonUserWidget
{
	...
	// Function /Script/FortniteUI.AthenaQuickbarEditorBase.SelectPreviousQuickBarSlot (Underlying native function: SelectPreviousQuickBarSlot 0xa311128)
	void SelectPreviousQuickBarSlot(bool& bSetFocus); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteUI.AthenaQuickbarEditorBase.SelectNextQuickBarSlot (Underlying native function: SelectNextQuickBarSlot 0xa31107c)
	...
	// Function /Script/FortniteUI.AthenaQuickbarEditorBase.GetFirstEquipSlotButton (Underlying native function: GetFirstEquipSlotButton 0xa30ff24)
