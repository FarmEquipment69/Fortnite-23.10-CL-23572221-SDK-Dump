...
class ABuildingFlagSpawn : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.BuildingFlagSpawn.SpawnCarriedObject (Underlying native function: SpawnCarriedObject 0x840f794)
	void SpawnCarriedObject(); // (Final | BlueprintAuthorityOnly | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.BuildingFlagSpawn.OnCarriedObjectDetachedEvent (Underlying native function: OnCarriedObjectDetachedEvent 0x7fbd6c0)
	void OnCarriedObjectDetachedEvent(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.BuildingFlagSpawn.OnCarriedObjectAttachedEvent (Underlying native function: OnCarriedObjectAttachedEvent 0x835726c)
	void OnCarriedObjectAttachedEvent(); // (Native | Event | Public | BlueprintEvent)

	// Function /Script/FortniteGame.BuildingFlagSpawn.IsSpawnedObjectAwayFromBase (Underlying native function: IsSpawnedObjectAwayFromBase 0x840f290)
