...
class UFortAudioShapePrimitiveComponent : public UFortAudioShapeComponent
{
	...
	// Function /Script/FortniteGame.FortAudioShapePrimitiveComponent.GetIsPlayerInside (Underlying native function: GetIsPlayerInside 0x8c40d24)
	bool GetIsPlayerInside(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteGame.FortAudioShapePrimitiveComponent.GetInsideAudioComponent (Underlying native function: GetInsideAudioComponent 0x8c40d00)
	class UAudioComponent* GetInsideAudioComponent(); // (Final | Native | Public | BlueprintCallable | BlueprintPure)

	// Function /Script/FortniteGame.FortAudioShapePrimitiveComponent.GetEdgeAudioComponent (Underlying native function: GetEdgeAudioComponent 0x8c409fc)
