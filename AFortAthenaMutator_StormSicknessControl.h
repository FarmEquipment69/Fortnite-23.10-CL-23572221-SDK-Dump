...
class AFortAthenaMutator_StormSicknessControl : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_StormSicknessControl.EnqueueStormSickenessOptions (Underlying native function: EnqueueStormSickenessOptions 0x82624ec)
	void EnqueueStormSickenessOptions(struct FStormSicknessOptions& StormOptions); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/FortniteGame.FortAthenaMutator_StormSicknessControl.DequeueStormSickenessOptions (Underlying native function: DequeueStormSickenessOptions 0x8262424)
