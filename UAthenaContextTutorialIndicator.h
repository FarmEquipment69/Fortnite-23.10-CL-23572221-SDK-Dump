...
class UAthenaContextTutorialIndicator : public UAthenaMarkedActorIndicator
{
	...
	// Function /Script/FortniteUI.AthenaContextTutorialIndicator.SwitchIndicatorSize (Underlying native function: SwitchIndicatorSize 0xa2c852c)
	...
	// Function /Script/FortniteUI.AthenaContextTutorialIndicator.GetMinTreshold (Underlying native function: GetMinTreshold 0xa2c6758)
	float GetMinTreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaContextTutorialIndicator.GetMaxTreshold (Underlying native function: GetMaxTreshold 0xa2c6740)
	float GetMaxTreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaContextTutorialIndicator.GetMaxOffscreenTreshold (Underlying native function: GetMaxOffscreenTreshold 0xa2c6728)
	float GetMaxOffscreenTreshold(); // (Final | Native | Public | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/FortniteUI.AthenaContextTutorialIndicator.GetCurrentDotProduct (Underlying native function: GetCurrentDotProduct 0xa2c6710)
