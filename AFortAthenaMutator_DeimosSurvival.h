...
class AFortAthenaMutator_DeimosSurvival : public AFortAthenaMutator
{
	...
	// Function /Script/FortniteGame.FortAthenaMutator_DeimosSurvival.OnSafezoneChanged (Underlying native function: OnSafezoneChanged 0x81faeb4)
	void OnSafezoneChanged(); // (Final | Native | Public)

	// Function /Script/FortniteGame.FortAthenaMutator_DeimosSurvival.OnPlaylistDataLoaded (Underlying native function: OnPlaylistDataLoaded 0x81fab18)
	...
	// Function /Script/FortniteGame.FortAthenaMutator_DeimosSurvival.OnBuildingActorDestroyed (Underlying native function: OnBuildingActorDestroyed 0x81f9a10)
