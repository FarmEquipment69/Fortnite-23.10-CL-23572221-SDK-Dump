...
class UCustomCharacterPartAnimInstance_BuffetFaceAcc : public UCustomCharacterPartAnimInstance
{
	...
	// Function /Script/FortniteGame.CustomCharacterPartAnimInstance_BuffetFaceAcc.GenerateBackpackAlphas (Underlying native function: GenerateBackpackAlphas 0x85b41d8)
