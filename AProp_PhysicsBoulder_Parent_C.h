...
class AProp_PhysicsBoulder_Parent_C : public ABuildingProp
{
	...
	class UFortSoundIndicatorComponent* SoundIndicator; // 0xf00 (0x8)
	struct FVector LastImpactNormal; // 0xf08 (0x18)
	struct FScalableFloat VerticalImpulseRatio; // 0xf20 (0x28)
	double NextPotentialLaunchTime; // 0xf48 (0x8)
	double LaunchDelay; // 0xf50 (0x8)
	struct TArray<struct FScalableFloat> PlayerImpactTiers; // 0xf58 (0x10)
	struct TArray<struct FScalableFloat> PlayerImpulseTiers; // 0xf68 (0x10)
