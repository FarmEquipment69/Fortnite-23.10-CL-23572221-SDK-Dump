...
class UFortCreativeMatchmakingDetails : public UCommonActivatableWidget
{
	...
	// Function /Script/FortniteUI.FortCreativeMatchmakingDetails.SetupInfo (Underlying native function: SetupInfo 0xa536730)
	void SetupInfo(struct FCreativeLoadedLinkData& LinkData); // (Final | Native | Protected | HasOutParms | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeMatchmakingDetails.Open (Underlying native function: Open 0xa535e88)
	void Open(); // (Final | Native | Protected | BlueprintCallable)

	// Function /Script/FortniteUI.FortCreativeMatchmakingDetails.Close (Underlying native function: Close 0x662c1a4)
