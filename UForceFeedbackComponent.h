...
class UForceFeedbackComponent : public USceneComponent
{
	...
	// Function /Script/Engine.ForceFeedbackComponent.Stop (Underlying native function: Stop 0x8b16764)
	void Stop(); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.ForceFeedbackComponent.SetIntensityMultiplier (Underlying native function: SetIntensityMultiplier 0x9af18dc)
	void SetIntensityMultiplier(float& NewIntensityMultiplier); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.ForceFeedbackComponent.SetForceFeedbackEffect (Underlying native function: SetForceFeedbackEffect 0x9b3b2a4)
	void SetForceFeedbackEffect(class UForceFeedbackEffect*& NewForceFeedbackEffect); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/Engine.ForceFeedbackComponent.Play (Underlying native function: Play 0x9983b58)
	void Play(float& StartTime); // (Native | Public | BlueprintCallable)

	// Function /Script/Engine.ForceFeedbackComponent.BP_GetAttenuationSettingsToApply (Underlying native function: BP_GetAttenuationSettingsToApply 0x9b38aa4)
	...
	// Function /Script/Engine.ForceFeedbackComponent.AdjustAttenuation (Underlying native function: AdjustAttenuation 0x9b38988)
