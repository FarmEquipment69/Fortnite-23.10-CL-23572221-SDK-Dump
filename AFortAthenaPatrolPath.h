...
class AFortAthenaPatrolPath : public AActor
{
	...
	// Function /Script/FortniteAI.FortAthenaPatrolPath.SetPatrolPathEnabled (Underlying native function: SetPatrolPathEnabled 0xa20fd84)
	void SetPatrolPathEnabled(bool& bIsEnabled); // (Final | 0x00000002 | Native | Public | BlueprintCallable)

	// Function /Script/FortniteAI.FortAthenaPatrolPath.PatrolPointReached (Underlying native function: PatrolPointReached 0x5ccb5f0)
	...
	// Function /Script/FortniteAI.FortAthenaPatrolPath.PatrolPointFailedToReach (Underlying native function: PatrolPointFailedToReach 0x5ccb4e0)
	...
	// Function /Script/FortniteAI.FortAthenaPatrolPath.PatrolPathStopped (Underlying native function: PatrolPathStopped 0x5ccb430)
	void PatrolPathStopped(class AAIController*& AIInstigator); // (Final | 0x00000002 | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteAI.FortAthenaPatrolPath.PatrolPathStarted (Underlying native function: PatrolPathStarted 0x5ccb380)
	void PatrolPathStarted(class AAIController*& AIInstigator); // (Final | 0x00000002 | Native | Public | BlueprintCallable | Const)

	// Function /Script/FortniteAI.FortAthenaPatrolPath.OnCurrentPlaylistLoaded (Underlying native function: OnCurrentPlaylistLoaded 0xa20f56c)
	...
	// Function /Script/FortniteAI.FortAthenaPatrolPath.GetPatrolPoints (Underlying native function: GetPatrolPoints 0xa20f2b8)
	...
	// Function /Script/FortniteAI.FortAthenaPatrolPath.CanBeUsed (Underlying native function: CanBeUsed 0xa20f020)
