...
class AAthenaBigBaseWall : public ABuildingGameplayActor
{
	...
	// Function /Script/FortniteGame.AthenaBigBaseWall.OnRep_WallGravity (Underlying native function: OnRep_WallGravity 0x7f98088)
	void OnRepWallGravity(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.AthenaBigBaseWall.OnRep_TimeUntilWallComesDown (Underlying native function: OnRep_TimeUntilWallComesDown 0x7f97f04)
	void OnRepTimeUntilWallComesDown(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.AthenaBigBaseWall.OnRep_ResetBool (Underlying native function: OnRep_ResetBool 0x273fd14)
	void OnRepResetBool(); // (Final | Native | Protected)

	// Function /Script/FortniteGame.AthenaBigBaseWall.OnRep_BarrierState (Underlying native function: OnRep_BarrierState 0x7f97a64)
